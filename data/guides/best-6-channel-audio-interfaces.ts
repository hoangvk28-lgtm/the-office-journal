...
export const guideTitle = "The Best 6-Channel Audio Interfaces for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 6-channel audio interfaces, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 6-Channel Audio Interfaces for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 6-Channel Audio Interfaces";
