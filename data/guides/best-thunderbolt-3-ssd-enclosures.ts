...
export const guideTitle = "The Best Thunderbolt 3 SSD Enclosures for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  ...
  "We verified which products in this cluster are Thunderbolt 3 certified versus 40Gbps USB4 devices that happen to also work on TB3 hosts, since the two are not the same claim."
];
...
export const metaDescription = "A practical comparison of 4 thunderbolt 3 SSD enclosures, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Thunderbolt 3 SSD Enclosures for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-thunderbolt-ssd-raid-enclosures",
    "title": "4 Best Thunderbolt SSD RAID Enclosures in 2026"
  }
];

export const breadcrumbLabel = "Best Thunderbolt 3 SSD Enclosures";
