...
export const guideTitle = "The Best Wireless Interactive Whiteboards for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "Wireless on an interactive whiteboard can mean casting content from a device, wireless touch-back control of that device, or a wireless sensor-to-PC connection in a portable system, three different features often bundled under one marketing term.",
...
export const metaDescription = "A practical comparison of 8 wireless interactive whiteboards, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Wireless Interactive Whiteboards for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Wireless Interactive Whiteboards";
