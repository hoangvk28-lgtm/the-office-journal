...
export const guideTitle = "The Best Glossy 4K Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "ASUS ProArt PA279CRV 27 Inch 4K UHD USB-C HDR Professional Monitor for Mac)",
...
export const metaDescription = "How 6 glossy 4K monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Glossy 4K Monitors for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-dolby-vision-4k-monitors",
    "title": "Best Dolby Vision 4K Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Glossy 4K Monitors";
