...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-standing-desk-for-tall-person";
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-standing-desk-for-tall-person` },
    about: [{"@type":"Thing","name":"Standing Desk for Tall Person"},{"@type":"Thing","name":"High Standing Desk"},{"@type":"Thing","name":"Electric Height Adjustable Desk"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Standing Desks for Tall People", item: `${SITE_URL}/guide/best-standing-desk-for-tall-person` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-standing-desk-for-tall-person#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Standing Desks for Tall People</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Standing Desks for Tall People" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A standing desk for tall people needs a maximum height of at least 50 inches to reach ergonomic standing angles for users 6'2" and above - most standard desks cap at 47 to 48 inches.</p>
          <p>This guide covers eight standing desks for tall users ranked by maximum height (50 to 52 inches), motor stage count (2-stage vs 3-stage), surface width, and price.</p>
          <p>If you are tall and also need a chair sized for your proportions, see our <a href='/guide/best-office-chair-for-tall-person' className='text-brand hover:underline'>best office chairs for tall people</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=standing+desk+tall+person+50+inch+height&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
