export const guideSlug = "best-humidifiers-under-30";
export const guideTitle = "6 Best Humidifiers Under $30 in 2026";
export const metaTitle = "Best Humidifiers Under $30";
export const metaDescription = "We compared humidifier under $30 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "humidifier under $30";
export const introParagraphs = [
  "Best Humidifiers Under $30 carry very different real maintenance needs, which is exactly why a tank-size spec rarely tells the story.",
  "We compared this lineup on verified cleaning requirements, not marketing claims, since this is the real gap to watch."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-humidifiers-under-30-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-humidifiers-under-30-2",
    rank: 2,
  ...
  {
    id: "best-humidifiers-under-30-3",
    rank: 3,
  ...
  {
    id: "best-humidifiers-under-30-4",
    rank: 4,
  ...
  {
    id: "best-humidifiers-under-30-5",
    rank: 5,
  ...
  {
    id: "best-humidifiers-under-30-6",
    rank: 6,
    badge: "Worth a Look",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Larger living space",
          "BREEZOME 6L Humidifier for Bedroom Large Room Smart Humidistat Control"
        ]
      ]
    }
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Mid-range pick",
          "Vicks Warm Steam Vaporizer & Humidifier for Small and Medium Rooms"
        ],
        [
          "Higher budget",
          "BREEZOME 6L Humidifier for Bedroom Large Room Smart Humidistat Control"
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You want a larger tank, quieter operation, and extra features like a hygrometer display, where BREEZOME 6L Humidifier for Bedroom Large Room Smart Humidistat Control justifies the extra cost."
      },
      {
        "label": "Save if",
