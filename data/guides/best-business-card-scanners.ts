...
export const faq = [
  {
    "q": "Will a business card scanner accurately read a dark or foil-accented card?",
    "a": "Not as reliably as a plain white-background card. Standard OCR struggles with decorative fonts, light text on dark backgrounds, and metallic accents, an accuracy gap most reviews don't test because they use plain sample cards."
  },
  {
    "q": "Can I feed a square or oversized business card through these scanners?",
    "a": "5x2 inch size commonly cause feed jams in ADF-based card-scan modes, a real compatibility gap for creative-industry or international cards."
  },
  {
    "q": "Will scanned business cards import cleanly into my CRM?",
    "a": "It depends on the export format. A scanner/app exporting only to a proprietary format or basic CSV without field mapping creates real manual cleanup work importing into Salesforce, HubSpot, or similar platforms, test the export format first."
  },
  {
    "q": "Do these scanners handle duplicate contacts when I re-scan someone's updated card?",
    "a": "This varies significantly by app and isn't independently confirmed for any pick in this guide. Duplicate detection and contact merging quality is a real database-feature gap worth testing directly if you scan repeat contacts often."
  }
];

export const guideSlug = "best-business-card-scanners";

export const guideTitle = "The Best Business Card Scanners for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "OCR accuracy on stylized, dark, and foil-accented cards",
    "description": "Flagged that standard OCR trained on document text struggles with decorative business card fonts and dark/foil designs, an accuracy gap most reviews miss by testing only plain white-background sample cards."
  },
  {
    "title": "",
    "description": "5x2 inch size (square, oversized, rounded corners) commonly cause feed jams in ADF-based card-scan modes, a real compatibility gap for creative-industry or international cards."
  },
  {
    "title": "",
    "description": "Distinguished basic proprietary/CSV export from vCard-compatible export that imports cleanly into Salesforce, HubSpot, or similar CRM platforms without manual cleanup."
  }
];
...
export const introParagraphs = [
  ...
  "Also worth knowing: contact export format compatibility (vCard vs. Proprietary app format) determines real CRM integration usability, a scanner exporting only a proprietary format creates real manual cleanup work importing into Salesforce, HubSpot, or similar platforms."
];
...
export const metaDescription = "A practical comparison of 8 business card scanners, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Business Card Scanners for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B00Z2GDAOK?tag=theofficejournal-20",
    "description": "Highest rating among the dedicated card scanners in this guide, purpose-built for insurance and ID card capture with bundled Scan-ID LITE software. This isn't strictly a business card scanner, but its card-optimized scan path and software translate reasonably to standard business cards too, especially plain-printed ones.\n\nLike every card scanner in this guide, stylized fonts, dark backgrounds, or foil accents on premium business cards will reduce OCR accuracy versus the plain-card conditions this unit is actually tested for.\n\nThe standout detail is that card-optimized scan path. Balancing that out, not specifically marketed for stylized business cards.",
    "specs": [
      "Card-optimized scan path, Scan-ID LITE software",
      "Windows compatible",
      "Highest rating among dedicated card scanners",
      "Built for ID/insurance card capture"
    ],
    "pros": [
      "Highest rating among the dedicated card scanners in this guide",
      "Card-optimized scan path",
      "Bundled Scan-ID LITE software",
      "accurate on plain-printed cards"
    ],
    "cons": [
      "Not specifically marketed for stylized business cards",
      "Windows only",
      "OCR accuracy on foil/dark cards not independently verified"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07VSHQSKW?tag=theofficejournal-20",
    "description": "Built and bundled specifically for business card capture with dedicated AmbirScan Business Card software, for Windows and Mac. Its moderate rating and small review count suggest real-world mixed results, likely reflecting the industry-wide OCR accuracy drop on stylized fonts and dark/foil cards this guide flags across the board.\n\nBefore relying on this for CRM import, test the actual export format (vCard/CSV/proprietary) against your specific CRM platform, since format compatibility varies and creates manual cleanup work if mismatched.",
    "specs": [
      "Dedicated business card scan path",
      "AmbirScan Business Card software",
      "Windows and Mac compatible",
      "Card-specific OCR software bundle"
    ],
    "pros": [
      "purpose-built for business cards",
      "Windows and Mac compatible",
      "Dedicated card-scanning software bundle",
      "Compact card-scanner form factor"
    ],
    "cons": [
      "Lowest rating and smallest review count in this guide",
      "OCR accuracy likely drops on stylized/dark/foil cards, industry-wide limitation",
      "CRM export format compatibility not independently verified"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CC9SRRL3?tag=theofficejournal-20",
    "description": "A vertical, USB-powered card scanner for both ID and business cards, the highest price in this guide's dedicated card-scanner segment. Small review count and moderate rating suggest a niche product with limited real-world validation, weigh that against the dedicated high-speed vertical design.\n\n5x2 inch cards will feed most reliably.\n\nUSB powered, no external adapter. Both are worth keeping in mind before deciding.",
    "specs": [
      "High-speed vertical single-sided scan path",
      "USB powered",
      "For both ID and business cards",
      "Windows and Mac compatible"
    ],
    "pros": [
      "Dedicated vertical high-speed card scan path",
      "USB powered, no external adapter",
      "Windows and Mac compatible",
      "Built for both ID and business card use"
    ],
    "cons": [
      "Smallest review count and lowest confidence in this guide",
      "Highest price among dedicated card scanners",
      "Non-standard card sizes likely to jam"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0075323W8?tag=theofficejournal-20",
    "description": "Verify the specific export format (vCard, CSV, or proprietary WorldCard format) against your CRM before relying on it for bulk imports, format mismatches create real manual cleanup work.",
    "specs": [
      "Contact-management-focused card scanning",
      "Windows/Mac compatible",
      "Bundled WorldCard software"
    ],
    "pros": [
      "Built specifically for contact management workflows",
      "Windows and Mac compatible",
      "Established product line"
    ],
    "cons": [
      "Moderate rating reflects real-world accuracy limitations",
      "CRM export format compatibility needs verification per your specific platform",
      "OCR accuracy drops on stylized/dark cards like every pick here"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0018POCW8?tag=theofficejournal-20",
    "description": "A simplex (single-sided) A6-format card scanner, a reasonable budget-adjacent option among the dedicated card scanners in this guide, though the A6 format is larger than a standard business card, meant to also accommodate small documents and IDs alongside cards.\n\nA6 format also handles small documents and IDs. That said, simplex only, no duplex card scanning.",
    "specs": [
      "Simplex A6-format card scan path",
      "For cards and small documents/IDs",
      "Compact form factor",
      "USB connectivity"
    ],
    "pros": [
      "Reasonable price among the dedicated card scanners",
      "A6 format also handles small documents and IDs",
      "Compact form factor",
      "Simple simplex operation"
    ],
    "cons": [
      "Simplex only, no duplex card scanning",
      "OCR accuracy drops on stylized/dark cards, industry-wide limitation",
      "Non-standard card sizes likely to jam"
    ],
  ...
  },
  {
    ...
    "description": "No dedicated card OCR software bundled specifically for contact extraction.\n\nA better fit for occasional card digitization than a heavy CRM-import workflow, pair it with separate card-recognition software if you need structured contact data extraction.",
    "specs": [
      "General-purpose single-sheet scanner",
      "Handles cards among other document types",
      "Free iPrint&Scan app"
    ],
    "pros": [
      "useful for occasional card digitization",
      "Broad general document scanning capability",
      "Reasonable price"
    ],
    "cons": [
      "Not a dedicated card scanner or CRM-focused software",
      "No structured contact data extraction confirmed",
      "Best for occasional cards, not bulk business-card workflows"
    ],
  ...
  },
  {
    ...
    "description": "ScanSnap Home software explicitly manages business cards alongside documents and photos, with a genuine ADF hopper letting you batch multiple cards at once rather than feeding one card at a time like the dedicated single-card scanners above. Handles thick items and plastic cards specifically per its own marketing.\n\nStill subject to the same stylized-font/dark-card accuracy drop as any OCR-based card reader, and export-format CRM compatibility should be verified for your specific platform.\n\nExplicitly designed to handle cards and thick items.",
    "specs": [
      "ADF hopper, batches multiple cards at once",
      "Explicitly handles thick items and plastic cards",
      "ScanSnap Home card management software",
      "Duplex scanning"
    ],
    "pros": [
      "Real ADF hopper for batching multiple cards at once",
      "Explicitly designed to handle cards and thick items",
      "Broader document scanning capability beyond just cards",
      "Standalone cloud scanning available"
    ],
    "cons": [
      "Higher price than the dedicated card scanners",
      "Same OCR accuracy limitation on stylized/dark cards",
      "CRM export format compatibility not independently verified"
    ],
  ...
  },
  {
    ...
    "description": "An office-class scanner that scans a wide variety of documents including cards, with duplex scanning and direct cloud connectivity. Its small review count reflects a newer, lower-volume listing, weigh that against the genuine office-class capability and cloud connectivity.\n\nA reasonable alternative if you want business card scanning bundled into a broader office document workflow rather than a dedicated single-purpose card scanner.\n\nThe standout detail is that direct cloud connectivity. Balancing that out, smallest review count in this guide alongside the AMBIR PS670ST.",
    "specs": [
      "Office-class duplex scanner, scans various document types including cards",
      "Direct cloud service connectivity",
      "Easy setup",
      "Newer listing"
    ],
    "pros": [
      "Handles cards alongside broader office document scanning",
      "Direct cloud connectivity",
      "Duplex scanning",
      "Easy setup"
    ],
    "cons": [
      "Smallest review count in this guide alongside the AMBIR PS670ST",
      "Not a dedicated card scanner or CRM-focused software",
      "OCR accuracy on stylized/dark cards not independently verified"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-receipt-scanners",
    "title": "Best Receipt Scanners (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Business Card Scanners";
