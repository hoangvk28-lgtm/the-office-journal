...
export const guideTitle = "The Best Portable Studio Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 portable studio monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Portable Studio Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Portable Studio Monitors";
