...
export const faq = [
  {
    "q": "Why isn't there a ranked Echo Show 8 pick in this guide?",
    "a": "We could not independently verify its current price or pull a compliant product image through our research pass this time, so we chose not to publish unverified numbers rather than guess."
  },
  {
    "q": "What's the closest verified alternative to an 8 inch smart display?",
    "a": "1 inch Echo Show 10 sits just above it, both are fully verified in our research pool."
  },
  {
    "q": "Will this guide be updated with a verified 8 inch pick?",
    "a": "Yes, once we can confirm current pricing and imagery for an 8 inch model through our research process, we'll update this guide accordingly."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Declined to publish unverified pricing or imagery",
    "description": "Confirmed an 8 inch Echo Show exists on the market but could not verify its current price or product image through our research pass, and chose not to include it rather than guess."
  },
  {
    "title": "Selected the closest verified alternatives by size",
    "description": "1 inch Echo Show 10 specifically as the nearest confirmed size options bracketing the 8 inch class."
  },
  {
    "title": "Disclosed the category gap directly rather than silently omitting it",
    "description": "Explained plainly why this guide looks different from a typical ranked list, instead of quietly filling gaps with assumptions."
  },
  {
    "title": "Pointed buyers toward the specific product name to search directly",
    "description": "Named the actual Echo Show 8 model so buyers who specifically want that size can search and verify current listing details themselves."
  }
];

export const introParagraphs = [
  "We're being upfront here rather than guessing: an 8 inch class smart display exists on the market, Amazon's Echo Show 8 lineup, but we could not independently confirm current pricing and product imagery for it through our verified research pass this time. Rather than publish an unverified price or a placeholder image, we're not including it as a scored pick in this guide.",
  "1 inch Echo Show 10 just above it. If an 8 inch Echo Show specifically is what you're after, search \"Echo Show 8\" directly on Amazon and check current pricing and reviews there, since we don't want to publish unverified numbers here."
];
...
export const metaDescription = "We could not verify current pricing or imagery for a genuine 8 inch smart display this research pass. Here is what we can honestly recommend.";
