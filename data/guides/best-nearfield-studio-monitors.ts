...
export const guideTitle = "The Best Nearfield Studio Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 8 nearfield studio monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Nearfield Studio Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Nearfield Studio Monitors";
