...
export const guideTitle = "The Best 120Hz VR Headsets for Everyday Desk Work";
...
export const metaDescription = "How 6 120Hz VR headsets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 120Hz VR Headsets for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 120Hz VR Headsets";
