...
export const introParagraphs = [
  "Newline's product range spans the current RS+ series with object-recognition IR touch, the older Lyra line running Android 11, and even a purely passive magnetic whiteboard accessory, three genuinely different products under one brand name.",
...
export const products: GuideProduct[] = [
  {
    ...
    description: "Newline's RS+ series uses superior IR intelligent touch that distinguishes finger, stylus, and palm to automatically react as a marker, pen, or eraser respectively, a genuinely useful object-recognition feature many simpler IR panels lack.\n\nThe built-in Newline Cast app handles wireless screen sharing across iOS, Windows, or Android devices without extra hardware, though the Android 8.0 embedded OS is notably older than the Android 13/14 generation common on newer boards in this comparison.",
    specs: ["75in 4K, IR touch with object recognition","Newline Cast wireless casting","Android 8.0 embedded OS"],
    pros: ["Object recognition (finger/stylus/palm) is genuinely useful IR touch tech","Newline Cast app handles casting without extra hardware","Slim frame design for easier installation"],
    cons: ["Android 8.0 is a notably older OS generation","No EDLA certification mentioned, unlike newer competing boards"],
  ...
  },
  {
    ...
    specs: ["65in, Android 11","Positioned for business/college use"],
    pros: ["Established Newline brand and support infrastructure"],
    cons: ["Android 11 is an older OS generation than current EDLA-certified rivals","Verify current software support before buying given the OS age"],
  ...
  },
  {
    ...
    specs: ["Passive magnetic whiteboard, 40x210x155cm","No electronic/touch features","Multicolor frame options"],
    pros: ["Budget-friendly physical writing surface","No power, setup, or software required"],
    cons: ["Not an electronic/interactive product despite the category name","No touch, casting, or collaboration features whatsoever"],
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "Newline Product Types",
    "table": {
      "headers": [
        "Product",
        "Type",
      ...
      "rows": [
        [
          ...
          "Object-recognition IR touch, Android 8.0"
        ],
        [
          "Lyra",
          "Electronic flat panel (older)",
          "Android 11, verify current support"
        ],
        [
          "Magnetic Whiteboard",
          "Passive accessory",
          "No electronics, no touch"
        ]
      ]
    }
  }
...
export const faq = [
  ...
  },
  {
    ...
    "a": "The RS+ series remains a current Newline product line, though its Android 8.0 embedded OS is notably older than the Android 13/14 generation common on newer competing boards, worth checking against Newline's current-model page for any newer generation before buying."
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-viewsonic-interactive-whiteboards","title":"8 Best ViewSonic Interactive Whiteboards"},{"href":"/guide/best-benq-interactive-whiteboards","title":"7 Best BenQ Interactive Whiteboards"},{"href":"/guide/best-clevertouch-interactive-whiteboards","title":"Best Clevertouch Interactive Whiteboards"}];
