...
export const sixtyVs65Vs75KeyboardGuide: Guide = {
  ...
  description:
    "60% vs 65% vs 75% keyboard: which compact layout fits your desk, gaming, and work needs. Pairwise comparisons and a clear decision guide for each use case.",
...
| Size | Pick | Price | |
|------|------|-------|--|
| 65% | Redragon K631 PRO - triple-mode wireless, hot-swap, dedicated arrows | ~$45-55 | <a href="https://www.amazon.com/dp/B09ZNMRMHD?tag=theofficejournal-20" rel="nofollow sponsored noopener noreferrer" target="_blank" style="display:inline-block;background:#FF9900;color:white;padding:5px 12px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none;white-space:nowrap;">Check price on Amazon</a> |
| 75% | EPOMAKER x AULA F75 - gasket mount, encoder knob, Cherry PBT | ~$60-65 | <a href="https://www.amazon.com/dp/B0CNT61VMZ?tag=theofficejournal-20" rel="nofollow sponsored noopener noreferrer" target="_blank" style="display:inline-block;background:#FF9900;color:white;padding:5px 12px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none;white-space:nowrap;">Check price on Amazon</a> |
