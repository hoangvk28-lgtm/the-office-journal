...
export const guideTitle = "The Best Kali Audio Studio Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "5\" Project Lone Pine Powered Studio Monitor"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "5\" Project Lone Pine Powered Studio Monitor)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5\" Project Lone Pine Powered Studio Monitor is worth checking against its room-control switches before assuming flat response out of the box."
      }
    ]
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5-inch Powered Studio Monitor already covers the job."
      }
    ]
  }
];
...
export const metaDescription = "A practical comparison of 8 kali audio studio monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Kali Audio Studio Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "5-inch Powered Studio Monitor is the most affordable pick here that still clears the capability floor for this category. 5\" powered studio monitor with 1\" soft-dome tweeter. LF/HF trims - white (each).\n\n5\" Project Lone Pine Powered Studio Monitor, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nGo with this pick if you want a capable pick without paying for headroom you won't use. Stands, isolation pads, and cables are usually sold separately, so factor that into the real total cost before buying.",
    "specs": [
      "6.5\" powered studio monitor with 1\" soft-dome",
      "LF/HF trims - white (each)",
  ...
  },
  {
    ...
    "description": "KALI AUDIO LP-UNF Ultra Nearfield Monitor System is a strong alternative worth comparing directly against the top pick. Touch-sensitive volume slider - black (pair). 5\" powered studio monits with 1\" tweeter.\n\n5\" Project Lone Pine Powered Studio Monitor is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Room acoustics and speaker placement affect the sound as much as the monitor itself, so treat the room before blaming the gear.",
    "specs": [
      "Touch-sensitive volume slider - black (pair)",
      "4.5\" powered studio monits with 1\" tweeter",
  ...
  },
  {
    ...
    "specs": [
      "Precision monitoring - engineered for ultra nearfield",
      "Advanced 3d imaging waveguide clarity",
      "Designed for any desk setup - these"
    ],
    "pros": [
      "Precision monitoring - engineered for ultra nearfield",
      "Advanced 3d imaging waveguide clarity",
      "Designed for any desk setup - these",
      "Full range sound with compact power"
    ],
    "cons": [
      "Room acoustics affect the sound more than the speaker",
      "Stands or isolation pads are usually a separate purchase"
...
export const breadcrumbLabel = "Best Kali Audio Studio Monitors";
