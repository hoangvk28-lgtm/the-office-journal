...
export const guideTitle = "The Best 70-Pint Dehumidifiers With Pumps: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "AIRPLUS 4500 Sq Ft Dehumidifier for Bedroom)",
...
export const metaDescription = "How 8 70-pint dehumidifiers with pumps compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 70-Pint Dehumidifiers With Pumps (2026)";
...
export const breadcrumbLabel = "Best 70-Pint Dehumidifiers With Pumps";
