...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-compact-walking-pads-for-small-spaces";
...
export default async function BestCompactWalkingPadsPage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-compact-walking-pads-for-small-spaces` },
    about: [
        {
          "@type": "Thing",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Compact Walking Pads for Small Spaces", item: `${SITE_URL}/guide/best-compact-walking-pads-for-small-spaces` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-compact-walking-pads-for-small-spaces#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Compact Walking Pads for Small Spaces</span>
        </nav>
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-5 pt-5 border-t border-border">
            ...
            <div className="flex items-center gap-1.5 text-xs text-ink-muted">
              ...
              8 compact walking pads evaluated
            </div>
          </div>
        </header>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Compact Walking Pads for Small Spaces" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Compact walking pads solve the space problem of standard treadmills by folding to 4 to 6 inches thin for storage under beds and sofas, or folding in half for closet storage. Many measure under 35 inches long, fitting under desks in alcoves and tight spaces.</p>
          <p>This guide covers eight compact walking pads ranked by folded profile, belt width, noise level, and value for apartment users and small home offices.</p>
          <p>For options specifically designed for use under standing desks during work, see our <a href='/guide/best-walking-pads-for-standing-desks' className='text-brand hover:underline'>best walking pads for standing desks</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=compact+walking+pad+small+spaces&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
