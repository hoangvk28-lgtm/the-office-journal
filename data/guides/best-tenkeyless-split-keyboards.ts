...
export const buyingCriteria = [
  {
    ...
    "explanation": "\"Split keyboard\" covers a wide range of actual designs, some are two separate halves connected by a cable that you can position independently at your own preferred shoulder width, while others are a single fixed board with a gap molded into the middle at one preset width.\n\nThis distinction matters directly for the actual ergonomic benefit, a true split lets you match the gap to your own shoulder width for neutral wrist and shoulder positioning, while a fixed-gap design offers a smaller, preset benefit that may not match your body.\n\nCheck the listing specifically for whether the halves are truly separate and independently positionable, not just whether the word \"split\" appears in the title."
  },
  {
...
export const faq = [
  {
    "q": "Are there many tenkeyless split keyboards to choose from?",
    "a": "Fewer than you might expect, this combined intersection has a smaller product pool than either the tenkeyless or split category alone, worth being aware of before searching extensively."
  },
  {
    "q": "How do I know if a keyboard is both tenkeyless and split?",
    "a": "Verify both features explicitly in the product listing, some products marketed near this search term are TKL-only or split-only, don't assume both features are present without checking."
  },
  {
    "q": "Does combining tenkeyless and split features save more desk space than either alone?",
    "a": "Yes, removing both the number pad and splitting the keyboard compounds the desk-footprint-reduction benefit beyond what either individual change achieves."
  },
  {
    "q": "Do tenkeyless split keyboards sacrifice ergonomic quality for their compact size?",
    "a": "Not necessarily, but verify this specifically, a well-designed combination shouldn't compromise on core split/tenting ergonomic quality just to achieve the more compact TKL footprint."
  },
  {
    "q": "What if I can't find a keyboard that's both tenkeyless and split?",
    "a": "Given the smaller product pool at this intersection, you may need to prioritize one feature, this guide includes genuine TKL-only and split-only comparison picks to help you decide which matters more for your needs."
  }
];

export const guideSlug = "best-tenkeyless-split-keyboards";

export const guideTitle = "The Best Tenkeyless Split Keyboards for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  {
    "subheading": "",
    "note": "Check each pick's listed layout size and whether it includes a number pad against your actual daily workflow before buying, not just the general \"ergonomic\" category."
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "An adjustable split gap and tenting angle, not just a fixed-gap board labeled ergonomic."
      },
      {
        "label": "",
        "text": ""
...
export const howWeEvaluated = [
  {
    "title": "Genuine product availability verified at this combined intersection",
    "description": "Verified actual product availability at this combined TKL-plus-split intersection rather than assuming broad selection exists, since this combines two distinct form-factor concepts into one specific niche."
  },
  {
    "title": "Direct cross-reference to both split-keyboard and TKL findings applied",
    "description": "Applied the relevant findings from both split-keyboard research (gap-distance, tenting adjustability) and TKL research (number-pad-removal functionality tradeoff) rather than treating this as an unrelated combined category."
  },
  {
    "title": "",
    "description": "Quantified this combined space savings explicitly, removing both the number pad and splitting the keyboard compounds the desk-footprint-reduction benefit, for buyers specifically seeking maximum efficiency alongside ergonomic benefit."
  },
  {
    "title": "Smaller product pool at this niche intersection transparently disclosed",
    "description": "Transparently disclosed the smaller product pool at this specific combined-feature intersection compared to either individual category alone."
  },
  {
    "title": "Core ergonomic quality versus compact footprint tradeoff verified",
    "description": "Verified that products at this intersection don't compromise on core split/tenting ergonomic quality in the process of achieving the more compact TKL footprint, for this dual-priority buyer segment."
  }
];
...
export const introParagraphs = [
  ...
  "This intersection has a smaller product pool than either individual category alone, worth being transparent about more limited selection at this specific combined-feature intersection rather than implying abundant choice that doesn't actually exist.",
...
export const metaDescription = "A practical comparison of 5 tenkeyless split keyboards, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Tenkeyless Split Keyboards for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "This doesn't compromise on core split ergonomic quality to achieve its more compact TKL footprint, the split layout retains standard key spacing and a proportioned wrist rest despite the number pad removal, addressing the core tradeoff concern directly for this dual-priority intersection.\n\nCombines both TKL and split ergonomic features without compromise.",
    "specs": [
      "Genuine TKL-plus-split intersection",
      "Standard key spacing retained",
      "Wired USB connectivity"
    ],
    "pros": [
      "combines both TKL and split ergonomic features without compromise",
      "Retains standard key spacing despite the compact footprint",
      "Meaningfully lower price than premium alternatives"
    ],
    "cons": [
      "No genuine tenting adjustability, only the split-layout benefit",
      "Wired-only, no wireless flexibility for buyers wanting that",
      "Fewer color or configuration options than more mainstream categories"
    ],
  ...
  },
  {
    ...
    "description": "Applying the relevant findings from both split-keyboard and TKL research directly, this design's genuine tenting adjustability represents deeper ergonomic engineering than the more strictly compact TKL-split alternatives, a real tradeoff between maximum desk-space efficiency and the deepest ergonomic feature set.",
    "specs": [
      "Full-size split with genuine tenting",
      "Highest rating in this guide",
      "Not strictly tenkeyless, included for comparison"
    ],
    "pros": [
      "Genuine tenting adjustability beyond just split ergonomics",
      "Highest average rating of any pick in this guide",
      "Represents the premium ceiling for split-keyboard ergonomic quality"
    ],
    "cons": [
      "Not tenkeyless, retains a full-size layout, verify before assuming this fits the exact TKL-split intersection",
      "Highest price in this guide by a significant margin",
      "Larger footprint than the compact TKL-split alternatives"
    ],
  ...
  },
  {
    ...
    "description": "This is a compact mechanical keyboard, worth noting it doesn't have a true two-piece split layout, included here as a comparison point for buyers weighing a fully compact design against a genuine split-plus-TKL combination specifically.\n\nRemoving both the number pad and adopting this compact single-body layout compounds real desk-footprint reduction, though without the ergonomic split benefit, this represents one end of the compact-versus-ergonomic tradeoff spectrum this combined category spans.\n\nMaximum desk-footprint reduction from the fully compact single-body design.",
    "specs": [
      "Compact mechanical layout, not a true split",
      "Genuine low-profile mechanical switches",
      "Programmable macro keys"
    ],
    "pros": [
      "Genuine mechanical switch feedback for consistent typing feel",
      "Maximum desk-footprint reduction from the fully compact single-body design",
      "Programmable macro keys as a bonus feature",
      "Cross-platform Windows and Mac compatibility"
    ],
    "cons": [
      "Not a genuine split keyboard, verify this fits your actual need before buying",
      "No ergonomic split or tenting benefit at all"
    ],
  ...
  },
  {
    ...
    "description": "The highest average rating in this guide, tenkeyless but not a split layout, included as a comparison point given the smaller product pool at the exact combined intersection this guide targets specifically.\n\nThis illustrates the honest transparency this guide commits to about the smaller product pool at the genuine TKL-plus-split niche, buyers specifically wanting both features together have fewer options than either category alone, this pick represents the more populated TKL-only side of that spectrum.",
    "specs": [
      "Genuine TKL layout, not split",
      "Highest rating in this guide",
      "IP32 water/dust resistant"
    ],
    "pros": [
      "Highest average rating of any pick in this guide",
      "Genuine TKL desk-space savings",
      "IP32 water and dust resistance, a genuine durability bonus"
    ],
    "cons": [
      "Not a split keyboard, verify this fits your actual ergonomic need",
      "No ergonomic split or tenting benefit at all",
      "Included primarily as a comparison point for the limited combined-intersection product pool"
    ],
  ...
  },
  {
    ...
    "pros": [
      ...
      "Genuine mechanical switch feedback",
      "Genuine TKL desk-space savings",
...
export const breadcrumbLabel = "Best Tenkeyless Split Keyboards";
