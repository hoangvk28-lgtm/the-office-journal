...
export const guideTitle = "The Best VR Headset Cases for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "JSVER Hard Travel Storage Case For Meta Quest 3S Carrying Case for Oculus Quest)",
...
export const metaDescription = "A practical comparison of 6 VR headset cases, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best VR Headset Cases for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Everything ready for the next game",
      "Less worry from home to game night",
      "See at a glance that your setup is packed"
    ],
    "pros": [
      "Everything ready for the next game",
      "Less worry from home to game night",
      "See at a glance that your setup is packed",
      "Extra care for lenses and shared play"
    ],
    "cons": [
  ...
  },
  {
    ...
    "specs": [
      "Large carrying case for quest 3/quest 3s",
      "Sufficient room",
      "Sturdy and secure"
    ],
    "pros": [
  ...
  },
  {
    ...
    "specs": [
      "Small space and large capacity",
      "Fashion and sturdiness",
      "Thoughtful design"
    ],
    "pros": [
      "Small space and large capacity",
      "Fashion and sturdiness",
      "Thoughtful design",
      "High-end linear design, majestic, high-grade"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const breadcrumbLabel = "Best VR Headset Cases";
