...
export const faq = [
  {
    "q": "Will a 2-port PoE extender's extended distance mode still support smooth video from my camera?",
    "a": "It depends on the resolution; the REVODATA pick's extended 250m mode specifically drops to 10Mbps, which the listing itself recommends specifically for surveillance cameras rather than higher-bandwidth devices, so checking your camera's actual bitrate needs against that reduced speed is worth doing."
  },
  {
    "q": "What's the most common mistake buyers make when choosing a 2-port PoE extender?",
    "a": "Assuming both ports on a 2-port extender share identical power limits, when some extenders, like the LINOVISION pick, specifically document different wattage limits on each individual port."
  },
  {
    "q": "Is the LINOVISION pick worth the higher price over the VIMIN extender?",
    "a": "If you specifically need the longest total cascade distance with precise per-port wattage documentation, the LINOVISION's higher price is justified, but for a standard 100m two-device installation, the VIMIN's lower price and full Gigabit speed likely offer better value."
  },
  {
    "q": "Can I use these 2-port extenders with a 24V passive PoE camera?",
    "a": "The LINOVISION pick specifically states it does not support 24V PoE devices, and the NICGIGA pick specifically limits compatibility to 48V devices, so verifying your exact camera's PoE voltage standard against each listing's stated compatibility is important before buying."
  },
  {
    "q": "Do I need outdoor waterproofing if my 2-port extender will be installed in a garage or shed?",
    "a": "A garage or shed with some weather exposure but not full outdoor conditions may still benefit from an IP-rated extender like the VIMIN or REVODATA picks, since dust and humidity can affect unprotected electronics even in a partially sheltered space."
  },
  {
    "q": "How do I properly cascade two PoE extenders together to reach maximum distance?",
    "a": "The LINOVISION listing specifically instructs connecting the second extender's PoE input to the first extender's Out port rather than its Camera port, so following that exact wiring order is necessary to reach the documented maximum cascade distance."
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Full Gigabit speed with outdoor waterproofing",
          "VIMIN 2-Port Outdoor PoE Gigabit Extender"
        ],
        [
          "The strongest warranty and support at the lowest price",
          "NICGIGA 1 in 2 Out Gigabit PoE Extender"
        ],
        [
          "Flexibility to trade bandwidth for extended reach",
          "REVODATA IP67 Waterproof 2 Port PoE Extender"
        ],
        [
          "The longest total cascade distance",
          "LINOVISION Mini 2 Port PoE Extender"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Full Gigabit speed (VIMIN, NICGIGA)",
        "text": "Both maintain 1000Mbps across their fixed 100m range, better suited to devices that need consistent high bandwidth like modern 4K cameras or fast access points."
      },
      {
        "label": "",
        "text": "A physical switch lets you choose 100m at 100Mbps or 250m at a reduced 10Mbps, useful when you need extra reach for a lower-bandwidth device like a basic surveillance camera."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "VIMIN, NICGIGA, or REVODATA in standard mode"
        ],
        [
          "Extended 250m for a lower-bandwidth device",
          "REVODATA IP67 Waterproof (250m toggle mode)"
        ],
        [
          "Maximum 1000ft via 2-level cascade",
          "LINOVISION Mini 2 Port PoE Extender"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "An extender with outdoor waterproofing and enough per-port wattage to support your specific camera models, since two cameras mounted near each other but far from the switch is a very common installation scenario."
      },
      {
        "label": "",
        "text": "The VIMIN pick's IP65 rating and full Gigabit speed make it a strong fit for a typical two-camera outdoor corner installation."
      }
    ]
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "You want full Gigabit speed with outdoor waterproofing, where the VIMIN or NICGIGA picks deliver that around $22, among the lowest prices in this comparison."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Real Bandwidth by Distance Mode",
    "description": "Compared documented speed at both standard and any extended-distance mode."
  },
  {
    "title": "",
    "description": "Compared how specifically each listing discloses individual port power limits."
  },
  {
    "title": "",
    "description": "Compared IP ratings and included weatherproofing accessories for outdoor 2-device installations."
  },
  {
    "title": "",
  ...
  {
    "title": "",
    "description": "Compared documented multi-unit cascade configurations and total achievable distance."
  }
];
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0HDRZSFWV?tag=theofficejournal-20",
    ...
    "specs": [
      "1 in 2 out, Gigabit 1000Mbps, IP65 waterproof",
      "100m (328ft) extension distance",
      "IEEE 802.3af/at compatible, plug-and-play"
    ],
    "pros": [
      "Lowest price in this comparison at $22.49",
      "Full Gigabit speed maintained across the extension range",
      "IP65 waterproof rating suits both indoor and outdoor installations"
    ],
    "cons": [
      "Fixed 100m range without a longer-distance mode like the REVODATA pick",
      "Compact size limits it to powering exactly two devices"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0C1B9X2PF?tag=theofficejournal-20",
    ...
    "specs": [
      "1 in 2 out, Gigabit 1000Mbps",
      "2-3 unit cascade support, auto-detection",
      "1-year warranty, lifetime technical support, 30-day returns"
    ],
    "pros": [
      "Lowest price in this comparison at $21.99",
      "Lifetime technical support and unconditional 30-day returns",
      "Honest disclosure of 48V-only PoE device compatibility"
    ],
    "cons": [
      "Explicitly limited to 48V PoE devices, not a broader voltage range",
      "No outdoor waterproof rating unlike the VIMIN or REVODATA picks"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D7HHWNXL?tag=theofficejournal-20",
    "description": "This extender's listing specifically includes a toggle switch to choose between 100m at 100Mbps for access points and cameras, or 250m at a reduced 10Mbps specifically recommended for surveillance cameras, a flexible dual-mode design not found on the other picks in this comparison. Its IP67 waterproof rating with included waterproof caps for both input and output needs no additional outdoor protection.\n\nCompared to the VIMIN and NICGIGA picks above, this one's higher IP67 rating and dual-distance toggle switch give installers real flexibility to trade bandwidth for reach depending on the specific device being powered.\n\nBest for buyers who want the flexibility to trade bandwidth for extended reach depending on the specific device.",
    "specs": [
      "1 in 2 out, toggle switch for 100m/250m modes",
      "IP67 waterproof, includes waterproof caps",
      "15W max per port, IEEE 802.3af/at compliant"
    ],
    "pros": [
      "Lowest price in this comparison at $20.09",
      "Toggle switch lets you choose bandwidth or reach as needed",
      "IP67 rating is the highest waterproof rating in this comparison"
    ],
    "cons": [
      "Extended 250m mode drops bandwidth to just 10Mbps",
      "Lower per-port wattage (15W max) than some competing extenders"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07HSN5YSK?tag=theofficejournal-20",
    "description": "This extender's listing specifically states a two-level cascade deployment reaching a total of 1000ft, the longest documented total distance among the picks in this comparison, achieved by connecting a second unit's PoE input to the first unit's out port. 1-inch by 2-inch by 1-inch size fits into many junction boxes or outdoor waterproof enclosures.\n\nCompared to the VIMIN, NICGIGA, and REVODATA picks above, this one's specifically documented per-port wattage limits, 8W on the camera port and 15W on the out port, give installers precise power budgeting information the other picks don't disclose in the same detail.\n\nBest for buyers who need the longest total cascade distance with precise per-port wattage documentation.",
    "specs": [
      "1 in 2 out, up to 1000ft via 2-level cascade",
      "8W camera port, 15W out port, 100Mbps max",
      "IEEE 802.3af/at compliant, compact 3.1\"x2\"x1\" size"
    ],
    "pros": [
      "Longest total cascade distance in this comparison at up to 1000ft",
      "Precise per-port wattage documentation aids power budgeting",
      "Compact size fits into many junction boxes and enclosures"
    ],
    "cons": [
      "Highest price in this comparison at $32.99",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-2-port-gigabit-poe-extender",
    "title": "Best 2 Port Gigabit PoE Extenders"
  }
];
