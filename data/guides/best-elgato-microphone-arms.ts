...
export const guideTitle = "The Best Elgato Microphone Arms for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 elgato microphone arms, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Elgato Microphone Arms for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Elgato Microphone Arms";
