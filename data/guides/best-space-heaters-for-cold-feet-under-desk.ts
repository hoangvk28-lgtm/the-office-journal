...
export const introParagraphs = [
  "Best Space Heaters for Cold Feet Under Desk span basic ceramic models to full-room oil-filled radiators, which is exactly why room size changes what you actually need.",
  "We compared this lineup on documented safety features and room size, since this is where the decision gets made."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-space-heaters-for-cold-feet-under-desk-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-space-heaters-for-cold-feet-under-desk-2",
    rank: 2,
  ...
  {
    id: "best-space-heaters-for-cold-feet-under-desk-3",
    rank: 3,
  ...
  {
    id: "best-space-heaters-for-cold-feet-under-desk-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-space-heaters-for-cold-feet-under-desk-5",
    rank: 5,
  ...
  {
    id: "best-space-heaters-for-cold-feet-under-desk-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-space-heaters-for-cold-feet-under-desk-7",
    rank: 7,
