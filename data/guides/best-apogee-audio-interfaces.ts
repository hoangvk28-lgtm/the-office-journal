...
export const guideTitle = "The Best Apogee Audio Interfaces for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Apogee Duet 3 Premium USB-C Audio Interface for Mac)",
...
export const metaDescription = "A practical comparison of 8 apogee audio interfaces, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Apogee Audio Interfaces for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Get the rich, full album-ready sound",
      "Capture every detail and nuance",
...
export const breadcrumbLabel = "Best Apogee Audio Interfaces";
