...
export const guideTitle = "The Best Desk Fans for Office: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 desk fans for office, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Desk Fans for Office (2026)";
...
export const breadcrumbLabel = "Best Desk Fans for Office";
