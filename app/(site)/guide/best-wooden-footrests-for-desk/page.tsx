...
import {
  ...
  relatedGuides,
  type GuideProduct,
} from "@/data/guides/best-wooden-footrests-for-desk";
...
export default async function BestWoodenFootrestsForDeskPage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-wooden-footrests-for-desk` },
    about: [
      { "@type": "Thing", name: "Wooden Footrest" },
      { "@type": "Thing", name: "Ergonomics" },
      { "@type": "Thing", name: "Natural Materials" },
    ],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Wooden Footrests for Desk", item: `${SITE_URL}/guide/best-wooden-footrests-for-desk` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-wooden-footrests-for-desk#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Wooden Footrests for Desk</span>
        </nav>
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-5 pt-5 border-t border-border">
            ...
            <div className="flex items-center gap-1.5 text-xs text-ink-muted">
              ...
              8 wooden footrests for desk evaluated
            </div>
          </div>
        </header>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Wooden Footrests for Desk" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Wood footrests occupy a different position in the market than foam alternatives. The material does not compress over time, provides a firmer rocking surface, and matches the aesthetic of wood desks and natural material desk setups. The trade-off is that wood is harder underfoot, louder when rocking, and not suited for bare-foot use.</p>
          <p>This guide covers eight wooden footrests ranked by Amazon buyer rating and verified review count, including cherry wood rockers, lauan hardwood adjustable platforms, bamboo options, and a premium steel-roller wood rocker.</p>
          <p>For the full footrest category including foam and adjustable models, see our <Link prefetch={false} href='/guide/best-under-desk-footrests' className='text-brand hover:underline'>best under-desk footrests</Link> guide.</p>
        </section>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-ink-secondary">
                <strong className="text-ink">best wood pick:</strong>{" "}
                <a href="#strongtek-cherry" className="font-bold text-ink hover:text-brand transition-colors">StrongTek Ergonomic Wood Foot Rest</a>
                 - 3,135 reviews at 4.7 stars, cherry wood rocker, highest-rated wood footrest.
              </p>
            </div>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=wooden+footrest+for+desk&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
