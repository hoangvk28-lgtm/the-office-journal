...
export const guideTitle = "The Best Audio Interfaces for Mac, Compared";
...
export const metaDescription = "We compared 8 audio interfaces for mac on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Audio Interfaces for Mac (2026)";
...
export const breadcrumbLabel = "Best Audio Interfaces for Mac";
