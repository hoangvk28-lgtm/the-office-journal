export const guideSlug = "best-hardware-video-switchers";
export const guideTitle = "8 Best Hardware Video Switchers in 2026";
export const metaTitle = "Best Hardware Video Switchers";
export const metaDescription = "We compared hardware video switcher models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "hardware video switcher";
export const introParagraphs = [
  "Across best hardware video switchers, range widely in real latency, given that differences show up in the fine print.",
...
export const products: GuideProduct[] = [
  {
    id: "best-hardware-video-switchers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-hardware-video-switchers-2",
    rank: 2,
  ...
  {
    id: "best-hardware-video-switchers-3",
    rank: 3,
    badge: "Best Value",
  ...
  {
    id: "best-hardware-video-switchers-4",
    rank: 4,
  ...
  {
    id: "best-hardware-video-switchers-5",
    rank: 5,
  ...
  {
    id: "best-hardware-video-switchers-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-hardware-video-switchers-7",
    rank: 7,
  ...
  {
    id: "best-hardware-video-switchers-8",
    rank: 8,
