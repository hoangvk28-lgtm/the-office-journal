...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "Sony SAZ1 HI-Res Near Field Powered Speaker System Signature Series (Renewed) is the priciest pick in this lineup. This certified refurbished product is manufacturer refurbished it shows limited or no wear. Includes all original accessories.\n\nSony hi-res near field powered speaker system signature series, a detail worth checking closely before choosing between this and PreSonus Eris 3.5 Powered Studio Monitors.\n\nChoose this if you are willing to spend the most in this comparison for the fuller feature set that comes with it. Stands, isolation pads, and cables are usually sold separately, so factor that into the real total cost before buying.",
    specs: ["Certified refurbished product is manufacturer refurbished", "All original accessories", "Sony hi-res near field powered speaker system"],
    pros: ["Certified refurbished product is manufacturer refurbished", "All original accessories", "Sony hi-res near field powered speaker system", "Coaxial layout drivers work as wide-range single"],
    cons: ["Stands or isolation pads are usually a separate purchase", "Room acoustics affect the sound more than the speaker"],
  ...
  },
  {
    ...
    description: "StudioMan MS3 2-Way Near Field Active Studio Monitor Speaker for Hi-Fi is the most affordable pick here that still clears the capability floor for this category. The speaker 2-way 3.5\" near field studio monitor(palr) is ideal for gaming and home video production. Every monitor-series studio monitor utilizes acustom-woven kevlar low-frequency driver.\n\nWe have a 1 year warranty service for each product, if you encounter quality problems, please contact the account manager, we will solve your problem and provide the perfect solution, a detail worth checking closely before choosing between this and PreSonus Eris 3.5 Powered Studio Monitors.\n\nThis fits best if you want a genuinely capable pick without paying for headroom you won't use. Stands, isolation pads, and cables are usually sold separately, so factor that into the real total cost before buying.",
    specs: ["Near-field studio monitor", "Kelvar woofers", "High end and sweet spot"],
    pros: ["Near-field studio monitor", "Kelvar woofers", "High end and sweet spot", "Three different types of audio inputs, it's"],
    cons: ["Stands or isolation pads are usually a separate purchase", "Room acoustics affect the sound more than the speaker"],
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "You're just starting out and want genuinely capable sound without overspending, where StudioMan MS3 2-Way Near Field Active Studio Monitor Speaker for Hi-Fi already covers the job."
      }
    ]
  }
];
