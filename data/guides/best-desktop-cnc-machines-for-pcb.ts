...
export const faq = [
  {
    ...
    "a": "Fine PCB work benefits from low spindle runout and surface probing specifically, since copper isolation depth is small enough that ordinary machine tolerances can produce broken or incomplete traces."
  },
  {
...
export const guideTitle = "The Best Desktop CNC Machines for PCB, Compared";
...
export const metaDescription = "We compared 6 desktop CNC machines for PCB on compatibility, build, features and price to help you choose the right one for your space.";
...
export const breadcrumbLabel = "Best Desktop CNC Machines for PCB";
