...
export const guideTitle = "The Best 60W Fiber Laser Engravers for a Better Desk Setup";
...
export const metaDescription = "We compared 5 60W fiber laser engravers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 60W Fiber Laser Engravers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "What sold us on SFX 60W Fiber Laser Engraver is simple. Weighing only 9kg, portable laser engraver compact laser engraver is built for mobility. Convenient to use, 7 inch touch screen with built-in ezcad, multi-language support and standalone operation.\n\nBottom line: Intelligent autofocus and red light preview, marking accurately every time. After-sales support - sfx has been manufacturing laser products since 2004. Worth confirming the exact figures on the listing before you buy, but this one earns its spot.",
    "specs": [
      "Truly portable & lightweight, 9kg with handheld marking head.weighing only 9kg,",
      "Convenient to use, 7 inch touch screen with built-in ezcad, multi-language",
...
export const breadcrumbLabel = "Best 60W Fiber Laser Engravers";
