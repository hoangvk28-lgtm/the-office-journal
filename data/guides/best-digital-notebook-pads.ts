...
export const faq = [
  {
    "q": "Is a digital notebook pad an E Ink device?",
    "a": "Based on current search results, no, it's consistently a Rocketbook reusable-paper product. For an E Ink screen device, see our feel-like-paper guide."
  },
  {
    "q": "What's the smallest pad option?",
    "a": "5 inches, which fits a coat pocket."
  },
  {
  ...
  },
  {
    ...
    "a": "Yes, Pilot FriXion pens are required for these to erase correctly."
  },
  {
    "q": "",
    "a": ""
...
export const guideTitle = "The Best Digital Notebook Pads for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "Verified the real product match before ranking",
    "description": "We checked what products actually surface for this search rather than assuming it means E Ink hardware."
  },
  {
    "title": "Page format and size differences",
    "description": "We compared plain dot-grid pages against planner-template pages, and letter size against the more compact formats."
  },
  {
    "title": "Review volume as reliability evidence",
    "description": "Since the erase mechanism is shared across this product family, we weighted established review history heavily."
  },
  {
    "title": "",
    "description": "We compared cost against page count, size, and whether planning templates are included."
  }
];
...
export const introParagraphs = [
  ...
  "If you were picturing a device with an actual screen, see our digital notebooks that feel like paper guide instead, that covers the E Ink tablet category, a different product type from what's ranked here."
];
...
export const metaDescription = "How 5 digital notebook pads compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Digital Notebook Pads for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "On price, it's actually priced above Rocketbook Mini Reusable Smart Notepad, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Full letter size, not compact.",
    "specs": [
      "Letter size",
      "Planner templates plus note pages"
    ],
    "pros": [
      "Largest, highest-rated review base of any pad here"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "A genuine notepad-format product, the smallest in the entire search, fitting a coat pocket without a folio.\n\nOn the other side, Small page limits notes per page before erasing.",
    "specs": [
      "3.5 x 5.5 in",
      "Notepad format"
    ],
    "pros": [
      "Smallest, most pocket-friendly format here",
      "Cheapest option in this comparison"
    ],
    "cons": [
      "Small page limits notes per page before erasing"
    ],
  ...
  },
  {
    ...
    "specs": [
      "8.5 x 11 in",
      "Plain dot-grid pages"
    ],
    "pros": [
      "Full writing area",
      "No pre-built templates if you prefer blank pages"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "The real tradeoff against that pick: Small format limits per-page writing area.\n\nOn the other side, Small format limits per-page writing area.",
    "specs": [
      "Mini spiral-bound"
    ],
    "pros": [
    ...
    "cons": [
      "Small format limits per-page writing area"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Newest template revision available"
    ],
    "cons": [
      "Smaller review base than the standard Fusion Hybrid at the same size"
    ],
...
export const breadcrumbLabel = "Best Digital Notebook Pads";
