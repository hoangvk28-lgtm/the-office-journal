...
export const guideTitle = "The Best Desk Fans Under $30: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 desk fans under $30, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Desk Fans Under $30 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Gaiatop USB Desk Fan is a low-cost pick that doesn't skip the essentials. Classic design and more compact, less than 8 ounces, take up small space; it's very suitable for home, car, office, outside or traveling. The fan is very strong and the noise is less than 50db even when a strong wind is provided; at work and rest, this is a good friend who is quiet and comfortable for you.\n\nTriPole USB Desk Fan Small Portable is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nIt's worth picking this one if you want a capable pick without paying for headroom you won't use. Many listings only quote the DB rating at the lowest speed, so check the noise level at the speed you'll actually run daily before assuming it stays that quiet.",
    "specs": [
  ...
  },
  {
    ...
    "description": "IRIS USA WOOZOO Mini Desk Fan is a strong alternative worth comparing directly against the top pick. Compact tabletop fan with a modern matte finish, well suited to bedrooms, bathrooms, kitchens, or offices. 9\" Deep-pitch blades deliver strong airflow with minimal noise, covering up to 108 sq ft.\n\nThe gap between this and TriPole USB Desk Fan Small Portable isn't in the essentials, it shows up in ultra-quiet performance at just 27 DB on the lowest setting, well suited to sleep or calls.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    "specs": [
      "Great size",
      "Mini & versatile",
      "Aerodynamic design"
...
export const breadcrumbLabel = "Best Desk Fans Under $30";
