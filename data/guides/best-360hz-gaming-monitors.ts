...
export const guideTitle = "The Best 360Hz Gaming Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "5” 1440P QD-OLED Gaming Monitor (XG27ACDNG) -QHD (2560x1440)"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Alienware AW2725DF OLED Gaming Monitor)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "5” 1440P QD-OLED Gaming Monitor (XG27ACDNG) -QHD (2560x1440) justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 6 360Hz gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 360Hz Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Qd-oled technology enables stunningly rich color and clarity, while",
      "360Hz refresh rate translates to superb motion clarity",
      "0.03 Ms gray-to-gray minimum response time** virtually eliminates blurring"
    ],
    "pros": [
      "Qd-oled technology enables stunningly rich color and clarity, while",
      "360Hz refresh rate translates to superb motion clarity",
      "0.03 Ms gray-to-gray minimum response time** virtually eliminates blurring",
      "Infinite contrast ratio and vesa displayhdr true black 400 make for deep blacks and stunning brights"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "description": "AOC 27\" Gaming Monitor QHD 360Hz QD OLED NVIDIA G-SYNC Compatible Q27G40SDE is a strong alternative worth comparing directly against the top pick. 27\" Qhd display: immerse yourself in stunning visuals with a 27-inch qhd (2560x1440) resolution, delivering crisp detail and vibrant colors.\n\nSet next to Samsung 27” Odyssey OLED G6 (G60SD) Series Gaming Monitor with QHD & QD-OLED, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nThis makes sense for anyone who want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
    "specs": [
      "27\" Qhd display",
      "360Hz refresh rate & 0.03ms response time: enjoy smooth",
...
export const breadcrumbLabel = "Best 360Hz Gaming Monitors";
