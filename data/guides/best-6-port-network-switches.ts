...
export const guideTitle = "The Best 6-Port Network Switches for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "6-port switches are a slightly less common size than 5 or 8 ports, but useful when you need just one more port than a basic 5-port model without jumping all the way to 8.",
...
export const metaDescription = "A practical comparison of 5 6-port network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 6-Port Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "5G workstations or access points on the same box.\n\nA durable metal case with 6KV lightning protection and a fanless design keeps it quiet, while double-sided cooling holes handle the heat from running multiple high-speed ports simultaneously.",
    "specs": [
      "2x10G + 4x2.5G ports, 60Gbps capacity",
      "6KV lightning protection",
      "Fanless, wide temp range"
    ],
    "pros": [
      "Mixed 10G/2.5G ports fit real-world upgrade paths",
      "6KV surge protection is a genuine durability plus",
      "Fanless despite the multi-gig port mix"
    ],
    "cons": [
      "Only 2 full 10G ports",
      "Budget brand with shorter track record than TP-Link/NETGEAR"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-6-port-poe-network-switches",
    "title": "5 Best 6-Port PoE Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best 6-Port Network Switches";
