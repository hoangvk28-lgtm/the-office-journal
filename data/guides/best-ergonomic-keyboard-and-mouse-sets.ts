...
export const faq = [
  ...
  {
    "q": "Is a matched keyboard and mouse set better than buying separately?",
  ...
  },
  {
    ...
    "a": "Every mouse in this list is shaped for right-hand use. Left-handed buyers will need to source a separate ergonomic mouse regardless of which keyboard in this list they choose."
  },
  {
    "q": "Which set gives the best value for an ergonomic setup?",
    "a": "99, though you'll still need to pair a mouse separately for a fully ergonomic setup. 99 budget combos are the better starting point."
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Wireless Keyboard and Mouse Combo fits this specifically: sold as a matched keyboard + mouse pair."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want what Logitech Ergo K860 Wireless Ergonomic Split Keyboard with Wrist Rest offers: Only split layout in this list. That's a real functional upgrade over the budget picks here, not just a brand markup."
      },
      {
        "label": "",
        "text": "Wireless Keyboard and Mouse Combo already covers the essentials: sold as a matched keyboard + mouse pair. The main thing you'd be paying extra for elsewhere in this list is adjustability you may not need."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  ...
  {
    "title": "",
    "description": "4GHz USB receiver, and Bluetooth pairing across sets, and noted where a keyboard and mouse share one receiver versus needing separate connections."
  },
  {
    "title": "Matched sets vs standalone keyboards",
...
export const metaDescription = "8 keyboard and mouse sets in 2026, reviewed honestly on which are genuinely ergonomic and which are standard wireless combos sold under an ergonomic label.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Wave Keys is the closest thing in this list to a purpose-built ergonomic keyboard rather than a standard board wearing the label. Its curved key deck and attached rocking palm rest reduce wrist bend compared to a flat keyboard, even though it is a wave curve rather than a true split that separates into two halves.\n\nErgonomic curved design, not just labeled that way. On price, it comes in below Logitech Ergo K860 Wireless Ergonomic Split Keyboard with Wrist Rest, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, No bundled mouse in this specific listing.",
    "specs": [
      "Wave-curved key deck, single-piece frame",
      "Rocking cushioned palm rest",
      "Bluetooth and USB receiver pairing",
      "Compact footprint",
      "Graphite finish"
    ],
    "pros": [
      "ergonomic curved design, not just labeled that way",
      "Rocking palm rest adjusts to wrist angle",
      "Dual wireless connection options",
      "Compact footprint fits smaller desks"
    ],
    "cons": [
      "Costs more than the standard combos in this list",
      "Wave curve, not a true split layout",
      "No bundled mouse in this specific listing"
    ],
  ...
  },
  {
    ...
    "description": "The Ergo K860 uses a separated key layout split into two angled halves, not a single curved wave surface, and it is the only pick in this list built around a true split rather than a curve marketed as one. A dense memory foam palm rest runs the full width of the board.\n\nOn the other side, Wider overall footprint than a wave keyboard.",
    "specs": [
      "True split key layout, not a wave curve",
      "Full-width memory foam palm rest",
      "Multi-device Bluetooth, up to 3 devices",
      "Wireless, Logi Bolt USB receiver included",
      "Reverse tilt keeps wrists in a more neutral angle"
    ],
    "pros": [
      "Only split layout in this list",
      "Dense memory foam rest across the full width",
      "Pairs with up to 3 devices over Bluetooth",
      "Reverse tilt reduces wrist extension"
    ],
    "cons": [
      "Most expensive pick in this list",
      "No bundled mouse in this specific listing",
      "Wider overall footprint than a wave keyboard"
    ],
  ...
  },
  {
    ...
    "description": "The PERIBOARD-512B pairs a split key section with a wired USB connection, the cheapest way in this list to get a real split layout rather than a curved single-piece frame. Its firmer molded plastic wrist rest trades softness for a surface that resists flattening over years of use.\n\nOn the other side, Shortcut row is Windows-specific.",
    "specs": [
      "Genuine split key layout",
      "Molded plastic wrist rest",
      "Wired USB connection",
      "Windows-specific shortcut key row",
      "Natural typing angle"
    ],
    "pros": [
      "Cheapest true split layout in this list",
      "No battery or wireless pairing to manage",
      "Firm wrist rest resists flattening over time",
      "Dedicated Windows shortcut keys"
    ],
    "cons": [
      "No bundled ergonomic mouse",
      "Wired only, no Bluetooth option",
      "Shortcut row is Windows-specific"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DLBD36HL?tag=theofficejournal-20",
    "description": "This set is a matched keyboard and mouse pairing sold together, unlike most of the standalone ergonomic keyboards above. The keyboard has a mildly curved key layout marketed as ergonomic, though it is a much gentler curve than the Wave Keys or true split picks, and the included mouse is a standard sculpted shape rather than anything vertical.\n\nThe real tradeoff against that pick: Curve is much milder than a true wave or split keyboard.\n\nOn the other side, Build quality expectations should match the price.",
    "specs": [
      "Mildly curved full-size key layout",
      "Standard sculpted mouse (not vertical)",
      "2.4G wireless, single USB receiver for both",
      "Quiet/silent key switches",
      "Long battery life claimed"
    ],
    "pros": [
      "sold as a matched keyboard + mouse pair",
      "Cheapest set in this list",
      "Single receiver pairs both devices at once",
      "Quiet typing for shared spaces"
    ],
    "cons": [
      "Curve is much milder than a true wave or split keyboard",
      "Mouse is sculpted, not vertical, minimal pronation relief",
      "Build quality expectations should match the price"
    ],
    "bestFor": "Budget buyers who want a matched set, with modest ergonomic benefit"
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DDT75R2R?tag=theofficejournal-20",
    "description": "This is functionally the same tier of product as the previous pick: a matched wireless keyboard and mouse set with a mildly curved keyboard shape and a standard sculpted mouse, sold here in an Avocado Green finish for buyers who want a colorway beyond black or graphite.\n\nOn the other side, Same modest ergonomic benefit as the black budget option.",
    "specs": [
      "Mildly curved full-size key layout",
      "3-level DPI adjustable mouse",
      "2.4G wireless, single USB receiver for both",
      "Fn multimedia key row",
      "Avocado Green colorway"
    ],
    "pros": [
      "matched keyboard + mouse set",
      "Adjustable mouse DPI",
      "Distinct colorway for desk setups that want it",
      "low-cost price"
    ],
    "cons": [
      "Curve is much milder than a true wave or split keyboard",
      "Mouse is sculpted, not vertical",
      "Same modest ergonomic benefit as the black budget option"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B00QXT5T3U?tag=theofficejournal-20",
    "description": "The MK345 is a standard flat keyboard and mouse combo, not an ergonomic one, and it is included here specifically as a comparison point rather than a recommended ergonomic pick. There is no curve to the key deck and no sculpted shaping to the mouse beyond a basic contour.\n\nOn the other side, Mouse has no real ergonomic shaping.",
    "specs": [
      "Flat, standard key layout",
      "Basic contoured mouse, no ergonomic shaping",
      "2.4GHz wireless, single USB receiver",
      "Spill-resistant keyboard design",
      "Full-size layout with numpad"
    ],
    "pros": [
      "Reliable, established brand hardware",
      "Simple single-receiver wireless pairing",
      "Full-size layout with numpad",
      "Reasonably priced"
    ],
    "cons": [
      "Not ergonomic despite frequently appearing in ergonomic set searches",
      "Flat key deck, no wrist relief",
      "Mouse has no real ergonomic shaping"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CBPNWCVS?tag=theofficejournal-20",
    "description": "Like the MK345, the MK540 is a standard flat combo, not an ergonomic one, despite frequently surfacing in searches for ergonomic keyboard and mouse sets. It adds a spill-resistant design and a slightly more refined mouse shape than the MK345, along with a longer claimed battery life.\n\nThe real tradeoff against that pick: Not ergonomic, priced similarly to a curved keyboard.\n\nOn the other side, Mouse has no real ergonomic shaping.",
    "specs": [
      "Flat, standard key layout",
      "Contoured mouse, no ergonomic shaping",
      "2.4GHz wireless, single USB receiver",
      "Spill-resistant keyboard design",
      "Extended battery life claimed"
    ],
    "pros": [
      "Refined build quality from an established brand",
      "Spill-resistant design",
      "Longer claimed battery life than the MK345",
      "Simple single-receiver setup"
    ],
    "cons": [
      "Not ergonomic, priced similarly to a curved keyboard",
      "Flat key deck, no wrist relief",
      "Mouse has no real ergonomic shaping"
    ],
  ...
  },
  {
    ...
    "cons": [
      ...
      "Priced close to curved budget alternatives",
      "No wrist relief benefit whatsoever"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-ergonomic-keyboards-amazon-best-sellers",
    "title": "Best Ergonomic Keyboards Amazon Best Sellers (2026)"
  },
  {
