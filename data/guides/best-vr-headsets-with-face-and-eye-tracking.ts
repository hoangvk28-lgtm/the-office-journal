...
export const guideTitle = "The Best VR Headsets With Face and Eye Tracking, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "HTC Vive XR Elite with Deluxe Pack, Mixed Reality and PC VR Headset +)",
...
export const metaDescription = "We compared 6 VR headsets with face and eye tracking on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best VR Headsets With Face and Eye Tracking (2026)";
...
export const breadcrumbLabel = "Best VR Headsets With Face and Eye Tracking";
