...
export const guideTitle = "The Best Dual-Mode 4K Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 6 dual-mode 4K monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Dual-Mode 4K Monitors for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-dual-4k-monitors",
    "title": "Best Dual 4K Monitors in 2026"
  },
  {
  ...
  {
    "href": "/guide/best-27-inch-4k-monitors",
    "title": "Best 27-Inch 4K Monitors in 2026"
  }
];

export const breadcrumbLabel = "Best Dual-Mode 4K Monitors";
