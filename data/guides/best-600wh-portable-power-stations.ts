...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm 600wh portable power stations sits within a narrow tolerance of the target Wh figure, and publish that tolerance."
  },
  {
...
export const faq = [
  {
    "q": "Is rated Wh the same as usable energy for a 600wh portable power stations station?",
...
export const guideSlug = "best-600wh-portable-power-stations";

export const guideTitle = "The Best 600Wh Portable Power Stations for a Better Desk Setup";

export const heroImage = "https://m.media-amazon.com/images/I/41MOGpMRJyL._SL500_.jpg";

export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "Require a Narrow Capacity Tolerance",
    "note": "Confirm 600wh portable power stations sits within a narrow tolerance of the target Wh figure, and publish that tolerance."
  },
  {
...
export const introParagraphs = [
  "The real test for 600wh portable power stations comes down to requiring rated battery capacity within a narrow tolerance of the target Wh figure, not a glance at the listing photo.",
  "Rather than trust manufacturer claims, we checked measured usable energy and safety documentation plus requiring rated battery capacity within a narrow tolerance of the target Wh figure for every station on this list."
];

export const lastUpdated = "2026-08-19";

export const mainKeyword = "600wh portable power stations";

export const metaDescription = "We compared 7 600Wh portable power stations on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 600Wh Portable Power Stations for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-600wh-portable-power-stations-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-600wh-portable-power-stations-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-600wh-portable-power-stations-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-600wh-portable-power-stations-4",
    "rank": 4,
  ...
  {
    "id": "best-600wh-portable-power-stations-5",
    "rank": 5,
  ...
  {
    "id": "best-600wh-portable-power-stations-6",
    "rank": 6,
    "badge": "Solid Option",
  ...
  {
    "id": "best-600wh-portable-power-stations-7",
    "rank": 7,
    "badge": "Budget Pick",
...
export const breadcrumbLabel = "Best 600Wh Portable Power Stations";
