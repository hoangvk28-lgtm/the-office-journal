...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm which xp-pen drawing tablets models are currently sold rather than assuming an older listing reflects the current lineup, since driver support and pen generation change between models."
  },
  {
...
export const faq = [
  {
    "q": "Are all xp-pen drawing tablets models currently sold, or does the lineup include discontinued models?",
...
export const guideTitle = "The Best XP-Pen Drawing Tablets for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm which xp-pen drawing tablets models are currently sold rather than assuming an older listing reflects the current lineup, since driver support and pen generation change between models."
  },
  {
...
export const introParagraphs = [
  "Choosing among xp-pen drawing tablets means starting with checking current driver support instead of inheriting older compatibility lists rather than price or star rating.",
  "Every entry on this list was screened for documented pen behavior and driver support plus checking current driver support instead of inheriting older compatibility lists before anything else was weighed."
];
...
export const metaDescription = "A practical comparison of 7 XP-pen drawing tablets, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best XP-Pen Drawing Tablets for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-xp-pen-drawing-tablets-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-xp-pen-drawing-tablets-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-xp-pen-drawing-tablets-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-xp-pen-drawing-tablets-4",
    "rank": 4,
  ...
  {
    "id": "best-xp-pen-drawing-tablets-5",
    "rank": 5,
  ...
  {
    "id": "best-xp-pen-drawing-tablets-6",
    "rank": 6,
    "badge": "Solid Option",
  ...
  {
    "id": "best-xp-pen-drawing-tablets-7",
    "rank": 7,
    "badge": "Budget Pick",
    ...
    "amazonUrl": "https://www.amazon.com/dp/B01BA6XQI0?tag=theofficejournal-20",
    "description": "This ultra-thin 4x3 inch tablet is purpose-built for OSU gameplay specifically, requiring no driver install for that use case, while still handling drawing, signatures, and sketching. At just 2mm thick, the PN01 battery-free stylus delivers 8192 pressure levels at a 266 RPS report rate.\n\nBoth right- and left-hand modes are supported through easy driver access, and Mac compatibility works via the micro USB-to-USB-An interface (an OTG adapter may be needed for Mac systems without USB-A). The box includes ten replacement nibs and a pen clipper alongside the stylus.",
    "specs": [
      "4x3in area, 2mm thick",
      "8192 pressure levels, 266 RPS",
      "No driver needed for OSU gameplay"
    ],
    "pros": [
      "No driver install needed specifically for OSU gameplay",
      "266 RPS report rate keeps fast game input responsive",
      "Both left and right-hand modes supported easily"
    ],
    "cons": [
      "4x3in area is very small for general drawing work",
      "Mac users without USB-A need a separate OTG adapter"
    ],
...
export const breadcrumbLabel = "Best XP-Pen Drawing Tablets";
