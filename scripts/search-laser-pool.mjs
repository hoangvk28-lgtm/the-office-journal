...
const queries = [
  "10W UV laser engraver",
  "fiber laser engraver metal",
  "mini laser engraver desktop",
  "UV laser engraver glass",
  "laser engraver rotary attachment roller",
  "Wainlux laser engraver",
  "diode laser engraver machine",
];
const pool = {};
...
writeFileSync(resolve(ROOT, "/tmp/laser_pool.json"), JSON.stringify(pool, null, 2));
