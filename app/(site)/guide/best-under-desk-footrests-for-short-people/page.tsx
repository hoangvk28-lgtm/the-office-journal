...
import {
  ...
  relatedGuides,
  type GuideProduct,
} from "@/data/guides/best-under-desk-footrests-for-short-people";
...
export default async function BestUnderDeskFootrestsShortPeoplePage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-under-desk-footrests-for-short-people` },
    about: [
      { "@type": "Thing", name: "Under-Desk Footrest" },
      { "@type": "Thing", name: "Ergonomics" },
      { "@type": "Thing", name: "Short User Ergonomics" },
    ],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Under-Desk Footrests for Short People", item: `${SITE_URL}/guide/best-under-desk-footrests-for-short-people` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-under-desk-footrests-for-short-people#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Under-Desk Footrests for Short People</span>
        </nav>
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-5 pt-5 border-t border-border">
            ...
            <div className="flex items-center gap-1.5 text-xs text-ink-muted">
              ...
              8 under-desk footrests for short people evaluated
            </div>
          </div>
        </header>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Under-Desk Footrests for Short People" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Under-desk footrests are not one-size-fits-all products. For shorter users whose feet do not comfortably reach the floor from a standard chair, the footrest height requirement is greater than for average-height users. A footrest that provides 2 inches of lift for a 5-foot-8 user may provide insufficient lift for a 5-foot user on the same chair.</p>
          <p>This guide covers eight footrests selected for suitability with shorter users, evaluated for height range, adjustability, and surface dimensions appropriate for smaller feet. All picks are ranked by Amazon buyer rating and verified review count.</p>
          <p>For the broader under-desk footrest category without height focus, see our <Link prefetch={false} href='/guide/best-under-desk-footrests' className='text-brand hover:underline'>best under-desk footrests</Link> guide.</p>
        </section>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-ink-secondary">
                <strong className="text-ink">best overall for short users:</strong>{" "}
                <a href="#everlasting-comfort" className="font-bold text-ink hover:text-brand transition-colors">Everlasting Comfort Foot Rest</a>
                 - 22,247 reviews at 4.5 stars, memory foam with adjustable height options.
              </p>
            </div>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=under+desk+footrest+short+people&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
