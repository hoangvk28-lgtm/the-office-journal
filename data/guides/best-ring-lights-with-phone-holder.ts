...
export const guideTitle = "The Best Ring Lights with Phone Holder Worth Considering";
...
export const metaDescription = "How 8 ring lights with phone holder compare on brightness, color temperature, adjustability and power, with clear notes on who each one suits.";

export const metaTitle = "Best Ring Lights with Phone Holder (2026)";
...
export const breadcrumbLabel = "Best Ring Lights with Phone Holder";
