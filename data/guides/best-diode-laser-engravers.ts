...
export const guideTitle = "The Best Diode Laser Engravers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 diode laser engravers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Diode Laser Engravers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Diode Laser Engravers";
