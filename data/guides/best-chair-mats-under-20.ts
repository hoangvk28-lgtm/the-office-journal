...
export const faq = [
  {
    "q": "Can I use a hard floor chair mat on top of a thin carpet or rug?",
    "a": "No, hard floor mats in this comparison rely on a flat, smooth surface to sit properly and grip via their backing, so placing one on carpet, even a thin one, causes it to slide around and won't provide proper protection."
  },
  {
    "q": "What's the most common mistake buyers make when choosing a chair mat under $20?",
    "a": "Not checking whether the mat is rated for their specific floor type before ordering, since a mat that looks identical in photos to a carpet mat may actually be designed exclusively for hard floors, or vice versa."
  },
  {
    "q": "Is the GORILLA GRIP pick worth it over the cheaper Wansimoo option?",
    "a": "If you specifically want third-party tested scratch and crack resistance in a more compact footprint, yes, but if you want a larger coverage area with a decorative woven look, the Wansimoo pick delivers that for about $3 less."
  },
  {
    "q": "How long does it take for these mats to flatten out after unpacking?",
    "a": "Most ship rolled and can take anywhere from a few hours to about 72 hours to flatten fully at room temperature, and placing heavy objects on the corners during that time speeds up the process."
  },
  {
    "q": "Can these chair mats be used under a standing desk that changes height?",
    "a": "Yes, since the mat sits on the floor rather than attaching to the desk itself, height adjustments don't affect the mat's function, though a taller chair-and-desk combination may mean your chair rolls further and needs a larger mat size."
  },
  {
    "q": "Do any of these mats work for both hardwood and tile floors?",
    "a": "Yes, all four picks in this comparison are rated for multiple hard floor types including hardwood, tile, laminate, vinyl, and concrete, though none are suitable for carpet use."
  }
];

export const guideSlug = "best-chair-mats-under-20";

export const guideTitle = "The Best Chair Mats Under $20: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "A finished look for a visible home office",
          "Wansimoo Office Chair Mat for Hardwood and Tile Floor"
        ],
        [
          "Third-party tested scratch and crack resistance",
          "GORILLA GRIP Office Chair Mat for Hard Floors"
        ],
        [
          "Your existing floor visible beneath the mat",
          "Azadx Office Chair Mat for Hardwood Floor"
        ],
        [
          "The largest clear coverage area",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Adds a finished decorative look that hides the floor underneath, better if the mat itself should look intentional in a visible space."
      },
      {
        "label": "Clear PVC (GORILLA GRIP, Azadx, Yecaye)",
        "text": "Lets your existing hardwood or tile floor show through completely, better if you want the mat to be functionally invisible."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "GORILLA GRIP (45in x 28in)"
        ],
        [
          "",
          "Wansimoo or Yecaye (both 36in x 48in)"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A fully clear, non-slip mat that protects the floor without altering its appearance, since landlords or roommates may object to a visibly different mat."
      },
      {
        "label": "",
        "text": "The Azadx pick's fully transparent design specifically preserves the visible appearance of your existing hard floor while still protecting it."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want third-party tested durability against scratching and cracking, where the GORILLA GRIP pick backs its claims with actual testing."
      },
      {
        "label": "",
        "text": "You just need basic hard-floor protection without extra testing claims, where the Wansimoo pick covers that for about $3 less."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Checked whether each pick is rated for hard floors, carpet, or both, since this determines basic usability."
  },
  {
    "title": "",
    "description": "Compared anti-slip backing materials and how each pick stays in place during chair movement."
  },
  {
    "title": "",
    "description": "Compared stated dimensions to determine typical single-chair rolling radius coverage."
  },
  {
    "title": "",
    "description": "Checked for third-party testing, scratch resistance, and anti-curl or anti-crack construction."
  },
  {
    "title": "",
    "description": "Compared clear versus opaque woven designs and how each affects the look of the space underneath."
  }
];
...
export const metaDescription = "A practical comparison of 4 chair mats under $20, focused on seat height, adjustment, support and warranty, and the trade-offs between them.";

export const metaTitle = "Best Chair Mats Under $20 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0G1RNTLF2?tag=theofficejournal-20",
    ...
    "specs": [
      "36in x 48in, woven top surface",
      "Rubber anti-slip backing",
      "Waterproof, oil-resistant, noise-reducing"
    ],
    "pros": [
      "Woven top design looks more finished than plain clear mats",
      "Waterproof and oil-resistant for spill protection",
      "Reduces noise from chair wheels rolling on hard floors"
    ],
    "cons": [
      "Not usable on carpet, hard floors only",
      "Opaque design hides the floor underneath unlike clear picks"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GJ7D1YRW?tag=theofficejournal-20",
    ...
    "specs": [
      "45in x 28in, low profile reinforced edges",
      "Third-party tested scratch and crack resistant",
      "100 percent waterproof woven topside"
    ],
    "pros": [
      "Third-party tested for scratch and crack resistance",
      "Reinforced edges resist fraying and curling over time",
      "Compact 45 by 28 inch size fits tighter desk spaces"
    ],
    "cons": [
      "Smaller coverage area than the Wansimoo pick",
      "Not usable on carpet, hard floors only"
    ],
  ...
  },
  {
    ...
    "specs": [
      "30in x 48in, clear PVC construction",
      "Smooth bottom, textured grip top surface",
      "Suitable for wood, laminate, stone, tile, concrete"
    ],
    "pros": [
      "Fully transparent design shows the floor underneath",
      "Dual-sided design combines stability with easy rolling",
      "Easy to clean with just a cloth"
    ],
    "cons": [
      "Smallest coverage area in this comparison at 30x48",
      "Can take time to flatten fully after unpacking"
    ],
  ...
  },
  {
    ...
    "specs": [
      "36in x 48in, clear PVC, hard floors only",
      "Smooth gliding surface",
      "Resists scratches, scuffs, discoloration"
    ],
    "pros": [
      "Largest clear coverage area in this tier at 36x48",
      "Durable PVC resists scratches and discoloration",
      "Smooth surface reduces leg and back strain"
    ],
    "cons": [
      "Most expensive pick in this tier",
      "Hard floors only, explicitly not for carpet"
    ],
...
export const breadcrumbLabel = "Best Chair Mats Under $20";
