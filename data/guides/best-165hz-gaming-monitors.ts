...
export const guideTitle = "The Best 165Hz Gaming Monitors for Everyday Desk Work";
...
export const metaDescription = "How 6 165Hz gaming monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 165Hz Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Remove protective film (with date code) from panel surface before use",
  ...
  },
  {
    ...
    "specs": [
      "180hz refresh rate and adaptive sync help reduce motion blur",
      "Deeper va contrast",
      "Compact fhd display"
    ],
    "pros": [
...
export const breadcrumbLabel = "Best 165Hz Gaming Monitors";
