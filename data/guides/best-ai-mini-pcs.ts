...
export const faq = [
  {
    "q": "Does every 'AI PC' actually have a real NPU?",
    "a": "Not necessarily as capable as marketing suggests, verify the actual TOPS rating rather than trusting an 'AI PC' badge alone."
  },
  {
    "q": "How much RAM do I need for local AI models?",
    "a": "This depends on the model size, larger models require more RAM to load, match the configuration to your intended use case."
  },
  {
    "q": "Is AMD or Intel better for AI mini PCs?",
    "a": "Both offer genuine NPU capability with different strengths, compare based on your specific software runtime and performance needs."
  },
  {
    "q": "Does a higher NPU TOPS rating always mean better AI performance?",
    "a": "Not alone, memory capacity and bandwidth matter just as much for running local AI models, especially larger ones."
  }
];

export const guideSlug = "best-ai-mini-pcs";

export const guideTitle = "The Best AI Mini PCs for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want what GMKtec EVO-X2 AI Mini PC Ryzen Al Max+ 395 offers: Massive 128GB RAM enables running large local AI models. That's a real functional upgrade over the budget picks here, not just a brand markup."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "Genuine NPU TOPS rating verified rather than trusting AI badging",
    "description": "Verified genuine NPU TOPS ratings and actual AI processing capability rather than trusting a generic 'AI PC' marketing badge."
  },
  {
    "title": "Memory capacity and bandwidth weighted for local model size",
    "description": "Weighted memory capacity and bandwidth as much as NPU rating, since larger local AI models require more RAM to load at all."
  },
  {
    "title": "Intel and AMD AI platforms compared on their own merits",
    "description": "Compared Intel's Core Ultra NPU platform and AMD's Ryzen AI platform on their own merits rather than assuming one is universally better."
  },
  {
    "title": "Software runtime compatibility flagged for verification",
    "description": "Flagged that supported AI software runtimes should be verified against your intended use case rather than assumed universal."
  }
];
...
export const introParagraphs = [
  ...
  "Memory capacity and bandwidth matter as much as NPU TOPS rating for running local AI models, since larger models require more RAM to load at all, worth matching RAM configuration to your intended model size rather than assuming any 'AI mini PC' handles your specific use case."
];
...
export const metaDescription = "We compared 5 AI mini PCs on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best AI Mini PCs for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A genuine 80 TOPS NPU rating, a real and verifiable AI processing capability rather than just marketing language, appropriate for buyers wanting genuine local AI acceleration.\n\nGenuine 80 TOPS NPU rating, verifiable rather than just marketing. On price, it comes in below GMKtec EVO-X2 AI Mini PC Ryzen Al Max+ 395, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, RAM configuration should be checked against your intended model size.",
    "specs": [
      "AMD Ryzen AI 9 HX 370, 80 TOPS NPU",
      "Genuine AI processing capability",
      "Strong general performance",
      "Premium price point"
    ],
    "pros": [
      "Genuine 80 TOPS NPU rating, verifiable rather than just marketing",
      "Strong general performance alongside AI capability",
      "Top-tier chip within the mini PC power envelope"
    ],
    "cons": [
      "Highest price in this guide",
      "Verify your intended AI software runtime is actually supported",
      "RAM configuration should be checked against your intended model size"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F53MLYQ6?tag=theofficejournal-20",
    "description": "A massive 128GB LPDDR5 memory configuration, appropriate for buyers wanting to run large local AI models that a typical 16-32GB configuration simply can't load.\n\nOn the other side, Verify current reviews for real-world large-model performance reports.",
    "specs": [
      "AMD Ryzen AI Max+ 395",
      "128GB LPDDR5 RAM",
      "Massive memory for large local models",
      "Premium price point"
    ],
    "pros": [
      "Massive 128GB RAM enables running large local AI models",
      "High-bandwidth LPDDR5 memory for AI workload responsiveness",
      "Powerful Ryzen AI Max+ 395 processor",
      "Purpose-built for demanding local AI model use"
    ],
    "cons": [
      "Very high price reflecting the exceptional memory capacity",
      "Overkill for buyers running smaller, lighter AI models",
      "Verify current reviews for real-world large-model performance reports"
    ],
    "bestFor": "Buyers wanting to run large local AI models requiring exceptional RAM capacity"
  },
  {
    "id": "fkyzf9hl-aimini",
    "rank": 3,
    ...
    "description": "The same powerful Ryzen AI Max+ 395 processor at a lower memory configuration and price than the top pick, appropriate for buyers wanting strong AI performance without the maximum RAM tier.\n\nOn the other side, Still a premium price relative to general mini PCs.",
    "specs": [
      "AMD Ryzen AI Max+ 395",
      "Lower RAM tier than the 128GB flagship",
      "High review rating",
      "More accessible price than the flagship configuration"
    ],
    "pros": [
      "Same powerful Ryzen AI Max+ 395 processor at a lower price",
      "More accessible price than the maximum RAM configuration",
      "Strong AI performance for moderately sized local models"
    ],
    "cons": [
      "Verify the specific RAM configuration against your model size needs",
      "Still a premium price relative to general mini PCs"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Intel Core Ultra platform includes a genuine built-in NPU",
      "48GB DDR5 RAM for moderately sized local AI models",
      "OCuLink connectivity for future EGPU expansion",
      "More accessible price than the flagship Ryzen AI Max+ picks"
    ],
    "cons": [
      "Lower NPU TOPS rating than the AMD Ryzen AI 9 flagship picks",
      "Verify current reviews given limited review data",
      "OCuLink expansion adds further cost if pursued"
    ],
  ...
  },
  {
    ...
    "pros": [
      ...
      "More accessible price than the AMD flagship AI picks",
      "1TB SSD for a substantial local model and software library"
    ],
    "cons": [
      "16GB RAM limits local AI model size compared to higher-RAM picks",
      "Lower NPU TOPS rating than the AMD Ryzen AI flagship",
      "Verify your intended software runtime supports Intel's NPU"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-mini-pcs-for-ai-workloads",
    "title": "Best Mini PCs for AI Workloads (2026)"
  },
  {
...
export const breadcrumbLabel = "Best AI Mini PCs";
