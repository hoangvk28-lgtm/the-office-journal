...
export const guideTitle = "The Best 80mm Label Printers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 80mm label printers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 80mm Label Printers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Phomemo Thermal Labels is the most affordable pick here that still clears the capability floor for this category. 15\"); color: black on white; labels per roll:100. Multipurpose- a wide variety of label sizes are available for use in different applications.\n\nSide by side with iEager M110 Thermal Labels, the real difference worth noting is compatible for- phomemo m110/m221/m220/m120/m200/m110s mini thermal label printer.\n\nThis fits best if you want a capable pick without paying for headroom you won't use. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
    "specs": [
      "Label size- 50x80mm (1.97\"x3.15\"); color: black on white; labels per roll:100",
      "Multipurpose- a wide variety of label sizes are available for use in different applications",
...
export const breadcrumbLabel = "Best 80mm Label Printers";
