...
export const guideTitle = "The Best Laser Engravers for Glass: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 laser engravers for glass, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Laser Engravers for Glass (2026)";
...
export const breadcrumbLabel = "Best Laser Engravers for Glass";
