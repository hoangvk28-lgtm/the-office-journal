...
export const guideTitle = "The Best Rugged Network Switches for Everyday Desk Work";
...
export const introParagraphs = [
  "Rugged switches overlap heavily with industrial switches but emphasize physical durability specifically, vibration and shock resistance, dust and moisture sealing, and extreme temperature tolerance for harsh deployment environments like vehicles, outdoor cabinets, or manufacturing floors.",
...
export const metaDescription = "How 5 rugged network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Rugged Network Switches for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Rugged Network Switches";
