...
export const faq = [
  {
    "q": "How is a stand with fans different from a normal cooling stand?",
    "a": "This guide focuses only on active stands with integrated or attached fans. Our broader Best Mini PC Cooling Stands guide also includes passive designs that rely on elevation and material alone."
  },
  {
    "q": "Why does this guide only have 4 products?",
    "a": "Mini PC-relevant stands that also include an active fan are a narrow category. We'd rather list four verified options than pad the list with generic laptop cooling stands that aren't built for a Mini PC's vent layout."
  },
  {
    "q": "Is adjustable fan speed worth having?",
    "a": "It can be useful when the Mini PC alternates between light office tasks and long heavy workloads. Lower speed can reduce unnecessary noise during lighter use."
  },
  {
    "q": "Can the fan make cooling worse?",
    "a": "Yes, if the stand blocks an intake, pushes air against the wrong vent, or creates recirculation. Vent alignment remains more important than fan count or RPM."
  },
  {
    "q": "What should I check besides cooling?",
    "a": "Check stand rigidity, anti-slip contact, vibration, cable clearance, and whether the active fan can be cleaned over time. Also confirm your specific Mini PC or Mac mini generation matches the stand's stated compatibility."
  }
];

export const guideSlug = "best-mini-pc-stands-with-fans";

export const guideTitle = "The Best Mini PC Stands with Fans, Compared";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We compared whether the fan adds a plausible sustained-load advantage over simple elevation, and excluded any passive-only stand from this narrower list."
  },
  {
    "title": "",
    "description": "We compared fan location and airflow openings against different Mini PC chassis, favoring listings that explicitly name Mac mini or Mini PC compatibility."
  },
  {
    "title": "",
    "description": "We compared fixed and adjustable fan speed and gave more weight to listings publishing a specific DBA figure."
  },
  {
    "title": "",
    "description": "We considered frame rigidity, load rating, and mounting method, including off-desk options, as part of one combined stand system."
  }
];
...
export const metaDescription = "We compared 4 mini PC stands with fans on compatibility, build, features and price to help you choose the right one for your space.";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "On/off switch lets you choose passive or active mode as needed",
      "USB passthrough avoids losing a port",
      "Compact footprint",
      "Replaceable fan design"
    ],
    "cons": [
      "Lowest star rating in this guide, worth reading recent reviews",
  ...
  },
  {
    ...
    "cons": [
      ...
      "Lightweight at 1 lb, benefits from a non-slip desk mat"
    ],
  ...
  },
  {
    ...
    "description": "17 CFM airflow rating, more precise numbers than most competitors in this category offer. It explicitly lists Mac mini, Mac Studio, and Mini PCs as compatible devices.\n\nOn the other side, Hard to differentiate from similar-spec competitors without independent reviews.",
    "specs": [
    ...
    "pros": [
      "Specific DBA and CFM figures instead of vague claims",
  ...
  },
  {
    ...
    "pros": [
      "Frees up desk space entirely via off-desk mounting",
...
export const breadcrumbLabel = "Best Mini PC Stands with Fans";
