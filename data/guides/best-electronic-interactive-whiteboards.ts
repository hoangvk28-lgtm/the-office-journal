...
export const faq = [
  ...
  },
  {
    ...
    "a": "8mm vs 8mm tips) for different input behaviors, verify pressure-sensitivity claims specifically if that matters for your use case."
  },
  {
...
export const guideTitle = "The Best Electronic Interactive Whiteboards for Everyday Desk Work";
...
export const metaDescription = "How 8 electronic interactive whiteboards compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Electronic Interactive Whiteboards for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-digital-interactive-whiteboards",
    "title": "8 Best Digital Interactive Whiteboards"
  },
  {
    "href": "/guide/best-interactive-whiteboards-with-projector",
    "title": "6 Best Interactive Whiteboards With Projector"
  },
  {
...
export const breadcrumbLabel = "Best Electronic Interactive Whiteboards";
