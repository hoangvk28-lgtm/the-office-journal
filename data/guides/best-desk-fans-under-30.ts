...
export const introParagraphs = [
  "Across best desk fans under $30, range widely in real noise output, given that differences show up at your actual desk distance.",
  "What separates these picks is verified dB rating, not marketing claims, since these separate real capability from claims."
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "WHATOOK Small Desk Fan Personal Fans: 5000mah 25 Hours Battery Office Quiet is a strong alternative worth comparing directly against the top pick. 100 Wind speeds to meet a variety of needs.silent gears l1-20,to meet the office, sleep.large air volume l50-100,for outdoor camping cooling, personal travel essentials. Battery 2000mah for 10 hours.5000mah for 25 hours.LED display shows remaining power after airflow adjustment.small desk fans can be used when charging.\n\nWhatook adhering to the purpose of quality products and services, which is the main thing that distinguishes this pick from TriPole USB Desk Fan Small Portable.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Many listings only quote the dB rating at the lowest speed, so check the noise level at the speed you'll actually run daily before assuming it stays that quiet.",
    specs: ["Portable desktop fan", "Long life & battery display", "Pure material & safety"],
    pros: ["Portable desktop fan", "Long life & battery display", "Pure material & safety", "Suitable for bedroom"],
    cons: ["Noise rating usually reflects the lowest speed, not daily use", "USB-powered models cap out at lower airflow than AC-plugged fans"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-desk-fans-under-30-4",
    rank: 4,
  ...
  },
  {
    ...
    description: "Gaiatop USB Desk Fan is a budget-friendly pick that doesn't skip the essentials. Classic design and more compact, less than 8 ounces, take up small space; it's very suitable for home, car, office, outside or traveling. The fan is very strong and the noise is less than 50db even when a strong wind is provided; at work and rest, this is a good friend who is quiet and comfortable for you.\n\nTriPole USB Desk Fan Small Portable is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nIt's worth picking this one if you want a genuinely capable pick without paying for headroom you won't use. Many listings only quote the dB rating at the lowest speed, so check the noise level at the speed you'll actually run daily before assuming it stays that quiet.",
  ...
  {
    id: "best-desk-fans-under-30-8",
    rank: 8,
    badge: "Also Worth Considering",
    name: "IRIS USA WOOZOO Mini Desk Fan",
    price: "$14.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41xD7wqGGyL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0D79TWVQJ?tag=theofficejournal-20",
    description: "IRIS USA WOOZOO Mini Desk Fan is a strong alternative worth comparing directly against the top pick. Compact tabletop fan with a modern matte finish, perfect for bedrooms, bathrooms, kitchens, or offices. 3.9\" Deep-pitch blades deliver strong airflow with minimal noise, covering up to 108 sq ft.\n\nThe gap between this and TriPole USB Desk Fan Small Portable isn't in the essentials, it shows up in ultra-quiet performance at just 27 dB on the lowest setting, perfect for sleep or calls.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    specs: ["Great size", "Mini & versatile", "Aerodynamic design"],
    pros: ["Great size", "Mini & versatile", "Aerodynamic design", "Comfort in quiet"],
    cons: ["USB-powered models cap out at lower airflow than AC-plugged fans", "Noise rating usually reflects the lowest speed, not daily use"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You want stronger airflow, lower noise, and extra features like a remote or timer, where IRIS USA WOOZOO Mini Desk Fan justifies the extra cost."
      },
      {
        "label": "Save if",
