...
export const guideTitle = "The Best Infrared Space Heaters for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Dr Infrared Heater DR-968 Portable Space Heater)",
...
export const metaDescription = "We compared 8 infrared space heaters on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Infrared Space Heaters for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Infrared heat",
      "Heat settings",
      "Portable heaters for indoor use come with cool touch housing"
    ],
    "pros": [
      "Infrared heat",
      "Heat settings",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Thermostat and temperature control",
      "Programmable timer",
      "Remote control with LED indicator"
    ],
    "cons": [
      "Coverage claims assume a well-insulated, average-height room",
      "Running at full wattage all day adds up on the electric bill"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Energy cost savings",
      "Lifetime washable filter included",
      "Cetl approved with comprehensive protection including dual overheat sensors"
    ],
    "cons": [
      "Running at full wattage all day adds up on the electric bill",
      "Coverage claims assume a well-insulated, average-height room"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Over-heat sensor for safety",
      "Adjustable temperature setting",
      "Four infrared heating elements with 750w and 1500w power"
    ],
    "cons": [
      "Coverage claims assume a well-insulated, average-height room",
      "Running at full wattage all day adds up on the electric bill"
  ...
  },
  {
    ...
    "specs": [
      "Powerful 1500w infrared space heater: featuring 6 upgraded quartz infrared heating tubes",
      "Infrared heater for indoor use provides even warmth for large rooms",
...
export const breadcrumbLabel = "Best Infrared Space Heaters";
