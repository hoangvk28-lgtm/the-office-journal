...
export const guideTitle = "The Best Cable Sleeves Under $30 Worth Considering";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Mxlvst 26ft-1/2 inch Expandable Braided Cable Sleeving Black)",
...
export const metaDescription = "How 6 cable sleeves under $30 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cable Sleeves Under $30 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      ...
      "High-quality materials",
      "Spiral design",
      "Cord protectors from pets no chew"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best Cable Sleeves Under $30";
