...
export const guideTitle = "The Best 4-Inch Tape Dispensers for a Better Desk Setup";
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "4 Mil x 55 Yards Heavy Duty Packaging"
        ],
        [
          "",
          "Box USA Tape Logic 4 Inch Heavy-Duty Packing Tape Dispenser Gun"
...
export const metaDescription = "We compared 6 4-inch tape dispensers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 4-Inch Tape Dispensers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Packing tape refills for shipping and storage",
      "Suitable for multiple box sizes",
      "Acrylic adhesive for carton sealing"
    ],
    "pros": [
      "Packing tape refills for shipping and storage",
      "Suitable for multiple box sizes",
      "Acrylic adhesive for carton sealing",
      "Multi-use packaging applications"
    ],
    "cons": [
      "One-handed claims need real base weight to back them up",
      "Core spindle width is sized for a specific tape range"
...
export const breadcrumbLabel = "Best 4-Inch Tape Dispensers";
