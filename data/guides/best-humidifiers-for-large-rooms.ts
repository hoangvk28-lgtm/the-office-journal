...
export const guideTitle = "The Best Humidifiers for Large Rooms: Our Picks";
...
export const metaDescription = "How 8 humidifiers for large rooms compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Humidifiers for Large Rooms (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Large tank no refills",
      "Large humidifier control",
      "Room humidifier with quiet sleep mode"
    ],
    "pros": [
      "Large tank no refills",
      "Large humidifier control",
      "Room humidifier with quiet sleep mode",
      "Auto shut off safe use"
    ],
    "cons": [
      "Ultrasonic models can leave white mineral dust without distilled water",
      "Tank needs cleaning every 2 to 3 days to avoid mold buildup"
...
export const breadcrumbLabel = "Best Humidifiers for Large Rooms";
