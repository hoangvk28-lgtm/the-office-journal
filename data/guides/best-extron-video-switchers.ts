...
export const guideTitle = "The Best Extron Video Switchers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Panlong 8-Way AV Switch RCA Switcher 8 in 1 Out Composite Video L/R Audio)",
        "text": "Simpler and cheaper for short cable runs typical of a home or small studio setup."
      },
      {
        "label": "Tenveo 4K60FPS HDMI Video Switcher Mixer)",
...
export const metaDescription = "How 8 extron video switchers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Extron Video Switchers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Msrp $7,999",
      "Dynamic motion interpolation, dmi technology",
    ...
    "pros": [
      ...
      "Dynamic motion interpolation, dmi technology",
      "Internal test patterns for calibration and setup",
      "Iss 408 can be controlled and monitored"
    ],
    "cons": [
  ...
  },
  {
    ...
    "specs": [
      "8-way av RCA audio video switcher selector",
      "Mechanical design, simple push-button switching",
    ...
    "pros": [
      ...
      "Mechanical design, simple push-button switching",
      "Metal enclosure, excellent stability and longevity",
      "Easy installation and operation, no extra power"
    ],
    "cons": [
      "Input count fills up fast with cameras plus overlays",
      "NDI routing adds real network bandwidth demands"
...
export const breadcrumbLabel = "Best Extron Video Switchers";
