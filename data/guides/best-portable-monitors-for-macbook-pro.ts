...
export const faq = [
  {
    "q": "Does my MacBook Pro support two external displays?",
    "a": "Only if it has a Pro or Max chip tier (M1 Pro/Max through M4 Pro/Max), those support two external displays without clamshell mode. Base M1/M2 13-inch MacBook Pro supports only one external display total."
  },
  {
    "q": "Can any of these monitors match my MacBook Pro's XDR display color?",
    "a": "6\" 4K pick (rank 2) with its 145% SRGB claim comes closest, but none of these panels carry real HDR/XDR certification, so treat all of them as good-enough, not equivalent, for color-critical work."
  },
  {
    "q": "Should I buy a 144Hz portable monitor for my MacBook Pro?",
    "a": "It won't hurt, but it won't help either. MacBook Pro's own ProMotion display adapts up to 120Hz, so a 144Hz-rated external monitor driven from your Mac won't look any smoother than a 120Hz one."
  },
  {
    "q": "Does using a portable monitor use up a Thunderbolt port I need for other things?",
    "a": "MacBook Pro 14/16-inch models have only 2-3 Thunderbolt 4 ports total, and connecting a portable monitor uses one of them, worth planning around if you also run a dock, EGPU, or fast external SSD."
  },
  {
    "q": "Which pick has a full-size HDMI port instead of mini-HDMI?",
    "a": "6\" (rank 8) use full-size HDMI. The KYY uses mini-HDMI and requires its included cable or your own adapter."
  },
  {
    "q": "Can I mount any of these on a monitor arm at my desk?",
    "a": "Most picks in this guide have real VESA mounting holes (75x75mm on several models), letting you attach them to a standard monitor arm instead of relying on a fold-out cover-stand."
  }
];

export const guideSlug = "best-portable-monitors-for-macbook-pro";

export const guideTitle = "The Best Portable Monitors for MacBook Pro, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "6 Inch 4K UHD 145% SRGB fits this specifically: Highest color gamut claim in this guide."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "6 Inch 4K UHD 145% SRGB offers: Highest color gamut claim in this guide. That's a real functional upgrade over the budget picks here, not just a brand markup."
      },
      {
        "label": "",
        "text": "The main thing you'd be paying extra for elsewhere in this list is headroom you may not actually use."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Cross-checked which MacBook Pro chip tiers (base M1/M2 vs. Pro/Max, all generations) actually support a second external display without clamshell mode, since \"MacBook Pro\" alone doesn't guarantee dual-display support."
  },
  {
    "title": "Color gamut versus MacBook Pro's own P3/XDR screen",
    "description": "Compared each panel's stated SRGB/DCI-P3 coverage against MacBook Pro's 100% P3 built-in display, rather than treating any \"wide gamut\" claim as equivalent."
  },
  {
    "title": "",
    "description": ") actually exceeds what MacBook Pro's own 120Hz ProMotion display runs at, since higher numbers don't add visible smoothness beyond that ceiling."
  },
  {
    "title": "HDMI port type and Thunderbolt port usage",
    "description": "Distinguished full-size HDMI from mini-HDMI, and noted that any pick used over Thunderbolt/USB-C consumes one of the MacBook Pro's 2-3 available Thunderbolt ports."
  },
  {
    "title": "VESA mounting and stand design",
    "description": "Verified genuine VESA mounting holes versus fold-out cover-stands only, since a permanent-desk MacBook Pro setup benefits from real monitor-arm compatibility."
  }
];
...
export const metaDescription = "We compared 8 portable monitors for MacBook pro on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Portable Monitors for MacBook Pro (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "5K (2560x1600) 16:10 panel that mirrors the MacBook Pro's own aspect ratio for full-screen use without black bars, plus a full metal chassis and dual VESA mounting holes for a permanent desk setup. The 110% SRGB gamut is a real step above budget 1080p panels, though it's still well short of the MacBook Pro's 100% P3/XDR coverage.\n\n6 Inch 4K UHD 145% SRGB for one main reason. 16:10 ratio matches MacBook Pro's aspect ratio for clean full-screen use. 6 Inch 4K UHD 145% SRGB, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Uses one of your limited Thunderbolt ports.",
    "specs": [
      "16-inch 2.5K QHD (2560x1600), 16:10 ratio",
      "110% SRGB, metal chassis",
      "Dual USB-C + full-size HDMI",
      "Dual VESA mounting holes",
      "1.5 lb"
    ],
    "pros": [
      "16:10 ratio matches MacBook Pro's aspect ratio for clean full-screen use",
      "Full-size HDMI, not mini-HDMI",
      "Metal build with real VESA mount holes"
    ],
    "cons": [
      "110% SRGB is good but well short of the MacBook Pro's 100% P3 XDR coverage",
      "144Hz claim is largely irrelevant since MacBook Pro's ProMotion tops out at 120Hz anyway",
      "Uses one of your limited Thunderbolt ports"
    ],
  ...
  },
  {
    ...
    "description": "5 inches this is the largest screen at this price point in the guide, useful if your priority is raw screen real estate for spreadsheet or multi-window work rather than pixel density. 6-16-inch QHD picks above, text will look softer up close on this one.\n\nOn the other side, 100Hz, not a genuine ProMotion match.",
    "specs": [
      "18.5-inch FHD, 100Hz, 125% SRGB",
      "Full-size HDMI + dual USB-C",
      "75x75mm VESA + built-in kickstand",
      "Metal back panel",
      "2.7 lb"
    ],
    "pros": [
      "Largest, most spacious screen in this guide",
      "Full-size HDMI, no adapter needed",
      "VESA mountable for a permanent setup",
      "Reasonably priced for the screen size"
    ],
    "cons": [
      "Lower pixel density than the 15.6-16-inch QHD/4K picks",
      "1080p will look visibly softer next to MacBook Pro's own Retina display",
      "100Hz, not a genuine ProMotion match"
    ],
  ...
  },
  {
    ...
    "description": "5-inch large-screen footprint with a genuine 2K QHD resolution instead of 1080p stretched over the same size, giving noticeably sharper text and a 120% SRGB gamut that's a real step above budget panels. The 120Hz refresh rate happens to line up closely with MacBook Pro's own 120Hz ProMotion ceiling, making this one of the better refresh-rate matches in this guide rather than an overshoot like the 144Hz picks.\n\nOn the other side, Still short of MacBook Pro's P3/XDR gamut.",
    "specs": [
      "18.5-inch 2K QHD, 120Hz, 120% SRGB",
      "Full-size HDMI + dual USB-C",
      "75x75mm VESA + adjustable kickstand",
      "2.48 lb",
      "500 nits brightness"
    ],
    "pros": [
      "2K resolution avoids the soft-text problem of 1080p-at-18.5-inch panels",
      "120Hz is a close match to MacBook Pro's own ProMotion ceiling",
      "120% SRGB, a genuine step up in color",
      "Full-size HDMI included"
    ],
    "cons": [
      "Heaviest pick in this guide at 2.48 lb",
      "Higher price than the 15.6-inch alternatives",
      "Still short of MacBook Pro's P3/XDR gamut"
    ],
  ...
  },
  {
    ...
    "description": "Buy this for the 120Hz panel and 125% SRGB color, not for FreeSync, which won't do anything meaningful in a MacBook Pro setup.\n\n5 Inch 2K QHD 120Hz 120% SRGB.\n\nOn the other side, Lower rating than the VisionOwl/cocopar premium picks.",
    "specs": [
      "18.5-inch 120Hz, 125% SRGB, 1ms response",
    ...
    "pros": [
      "Lowest price of the 18.5-inch picks",
      "360° adjustable VESA bracket is unusually flexible for the price",
      "120Hz keeps pace with MacBook Pro's ProMotion ceiling"
    ],
    "cons": [
      "FreeSync marketing is irrelevant for MacBook Pro's Apple Silicon graphics",
      "125% SRGB is decent but not verified against MacBook Pro's P3 coverage",
      "Lower rating than the VisionOwl/cocopar premium picks"
    ],
  ...
  },
  {
    ...
    "description": "This is a simpler 1080p, 60Hz panel without the QHD/4K ambitions of the picks above, but it still includes a full-size HDMI port and real VESA mounting holes, features some pricier competitors skip. At 85% SRGB, color accuracy is noticeably behind the premium picks in this guide, fine for email and documents, less so for any color-sensitive MacBook Pro work.\n\nThe real tradeoff against that pick: 85% SRGB is the weakest color gamut of the picks in this guide.\n\n6 inches is a visible step down from MacBook Pro's Retina display.",
    "specs": [
      "15.6-inch 1080P, 60Hz, 85% SRGB",
      "Full-size HDMI + dual USB-C",
      "2 VESA mounting holes",
      "1.5 lb without cover",
      "Smart stand case included"
    ],
    "pros": [
      "Lowest price with a full-size HDMI port and real VESA holes",
      "Highest rating tier of the budget options here",
      "Simple, no-fuss 1080p panel for reference/chat windows",
      "Well under the price of the QHD/4K picks"
    ],
    "cons": [
      "85% SRGB is the weakest color gamut of the picks in this guide",
      "60Hz only, no ProMotion-adjacent refresh rate",
      "1080p at 15.6 inches is a visible step down from MacBook Pro's Retina display"
    ],
...
export const breadcrumbLabel = "Best Portable Monitors for MacBook Pro";
