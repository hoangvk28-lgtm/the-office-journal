...
export const buyingCriteria = [
  {
    "criterion": "",
    "explanation": "Confirm whether electronic drawing tablets is a screenless pen tablet, pen display, or standalone device before comparing specs."
  },
  {
    "criterion": "",
...
export const faq = [
  {
    "q": "What's the biggest mistake buyers make shopping for electronic drawing tablets?",
  ...
  {
    "q": "Should I prioritize price or pen quality when choosing electronic drawing tablets?",
...
export const guideTitle = "The Best Electronic Drawing Tablets for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Confirm whether electronic drawing tablets is a screenless pen tablet, pen display, or standalone device before comparing specs."
  },
  {
    "subheading": "",
...
export const introParagraphs = [
  "Ranking electronic drawing tablets fairly means putting verifying tablet architecture and pen behavior instead of trusting the listing alone ahead of anything the listing photos suggest.",
  "We leaned on documented pen behavior and driver support plus verifying tablet architecture and pen behavior instead of trusting the listing alone to separate capable tablets from well-marketed ones."
];
...
export const metaDescription = "How 6 electronic drawing tablets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Electronic Drawing Tablets for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-electronic-drawing-tablets-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-electronic-drawing-tablets-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-electronic-drawing-tablets-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-electronic-drawing-tablets-4",
    "rank": 4,
  ...
  {
    "id": "best-electronic-drawing-tablets-5",
    "rank": 5,
  ...
  {
    "id": "best-electronic-drawing-tablets-6",
    "rank": 6,
    "badge": "Budget Pick",
...
export const breadcrumbLabel = "Best Electronic Drawing Tablets";
