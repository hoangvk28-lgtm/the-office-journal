...
export const guideTitle = "The Best Fortinet Network Switches for a Better Desk Setup";
...
export const metaDescription = "We compared 5 fortinet network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Fortinet Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BZT6PKGY?tag=theofficejournal-20",
    ...
    "specs": [
      "8 GE + 2 SFP ports, fanless",
      "FortiLink or standalone management",
      "Layer 2 switching"
    ],
    "pros": [
      "Smaller entry point into the FortiSwitch ecosystem",
      "Flexible standalone or FortiLink-integrated management",
      "Fanless silent operation"
    ],
    "cons": [
      "Full value requires FortiGate for unified management",
      "Enterprise pricing above consumer switches"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07HG8ZNBM?tag=theofficejournal-20",
    ...
    "specs": [
      "8 ports + 2 SFP slots",
      "1U rack, desktop, or standalone",
      "Layer 2 manageable"
    ],
    "pros": [
      "Flexible mounting: rack, desktop, or standalone",
      "SFP slots support fiber connectivity",
      "Fits into FortiGate-managed deployments"
    ],
    "cons": [
      "Full value requires existing FortiGate infrastructure",
      "Enterprise pricing above consumer switches"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0C2534G1N?tag=theofficejournal-20",
    ...
    "specs": [
      "Layer 2+ managed switch, 65W PoE",
      "FortiLink integration",
      "SD-Branch deployment focus"
    ],
    "pros": [
      "Converged security/network management via FortiLink",
      "PoE budget appropriate for smaller branch deployments",
      "Part of a cohesive Fortinet security stack"
    ],
    "cons": [
      "Full value requires a FortiGate deployment",
      "Enterprise pricing above consumer alternatives"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BWWWF43C?tag=theofficejournal-20",
    ...
    "specs": [
      "8 GE PoE+ + 2 SFP + 4x 10GE SFP+ uplinks",
      "Zero-Touch Provisioning",
      "Fanless, standalone or FortiLink managed"
    ],
    "pros": [
      "10GE SFP+ uplinks future-proof the backbone",
      "Zero-Touch Provisioning speeds fleet deployment",
      "Fanless entry-level Fortinet option"
    ],
    "cons": [
      "Enterprise pricing above consumer switches",
      "Full security-fabric value needs a FortiGate"
    ],
...
export const breadcrumbLabel = "Best Fortinet Network Switches";
