...
export const faq = [
  {
    ...
    "a": "5 times the screen's diagonal for comfortable text legibility, meaning a 98-inch board suits rooms with 12-20+ feet of depth, closer distances can still work but may strain necks looking up at the full panel."
  },
  {
...
export const guideTitle = "The Best Large Interactive Whiteboards for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "The top corners of an 86-98 inch panel are out of reach for most adults when wall-mounted at standard height. Consider a height-adjustable mobile stand or plan lesson content to avoid requiring frequent top-edge interaction."
  }
];
...
export const introParagraphs = [
  "Large interactive whiteboards, typically 86 inches and above, are heavy hardware requiring professional installation consideration, and 4K pixel density falls as diagonal grows even though the resolution number stays the same.",
...
export const metaDescription = "A practical comparison of 7 large interactive whiteboards, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Large Interactive Whiteboards for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Large Interactive Whiteboards";
