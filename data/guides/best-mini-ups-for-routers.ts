...
export const faq = [
  {
    ...
    "a": "Most of these units offer multiple output rails at different voltages (5V, 9V, 12V), and plugging a router rated for one voltage into an output rated for another can damage the device even if the connector physically fits. Always match the exact voltage printed on your router's original power adapter."
  },
  {
  ...
  },
  {
    ...
    "a": "3af/at active PoE, which negotiates voltage with the connected device. The passive PoE output on units like the CHINTE and ALFOINE sends a fixed voltage regardless of what's plugged in, and is only safe with equipment specifically designed for passive PoE input."
  }
];

export const guideSlug = "best-mini-ups-for-routers";

export const guideTitle = "The Best Mini UPS for Routers: Our Picks";
...
export const metaDescription = "How 7 mini UPS for routers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Mini UPS for Routers (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-mini-dc-ups-for-wifi-routers",
...
export const breadcrumbLabel = "Best Mini UPS for Routers";
