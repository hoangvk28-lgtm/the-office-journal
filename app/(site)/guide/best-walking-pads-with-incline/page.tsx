...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-walking-pads-with-incline";
...
export default async function BestWalkingPadsWithInclinePage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-walking-pads-with-incline` },
    about: [
        {
          "@type": "Thing",
          "name": "Incline Walking Pad"
        },
        {
          "@type": "Thing",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Walking Pads with Incline", item: `${SITE_URL}/guide/best-walking-pads-with-incline` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-walking-pads-with-incline#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Walking Pads with Incline</span>
        </nav>
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-5 pt-5 border-t border-border">
            ...
            <div className="flex items-center gap-1.5 text-xs text-ink-muted">
              ...
              8 incline walking pads evaluated
            </div>
          </div>
        </header>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Walking Pads with Incline" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Incline walking pads burn significantly more calories than flat-belt alternatives at the same walking speed. A 12% incline at 2 mph burns approximately 60% more calories per hour than flat walking, without requiring faster walking that disrupts concentration or typing.</p>
          <p>This guide covers eight incline walking pads ranked by maximum incline grade, incline levels, motor power, and noise level, including auto-incline and manual-incline options.</p>
          <p>For general walking pad recommendations without incline as a primary filter, see our <a href='/guide/best-walking-pads' className='text-brand hover:underline'>best walking pads</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=walking+pad+with+incline&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
