export const guideSlug = "best-zoom-audio-interfaces";
export const guideTitle = "8 Best Zoom Audio Interfaces in 2026";
export const metaTitle = "Best Zoom Audio Interfaces";
export const metaDescription = "We compared audio interface zoom models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "audio interface zoom";
export const introParagraphs = [
  "Best Zoom Audio Interfaces differ more than titles suggest, so price alone misses what matters.",
  "Every pick here was judged on verified specs, not marketing claims, because these separate real capability from claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-zoom-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-zoom-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-zoom-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-zoom-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-zoom-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-zoom-audio-interfaces-6",
    rank: 6,
  ...
  {
    id: "best-zoom-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-zoom-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
