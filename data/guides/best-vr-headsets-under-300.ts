...
export const guideTitle = "The Best VR Headsets Under $300: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 6 VR headsets under $300, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best VR Headsets Under $300 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Keep your experience smooth and seamless"
    ],
    "pros": [
      "Buy meta quest",
      "Get the hit vr rhythm game included when you buy meta quest 2**",
...
export const breadcrumbLabel = "Best VR Headsets Under $300";
