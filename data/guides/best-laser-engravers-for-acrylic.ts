...
export const guideTitle = "The Best Laser Engravers for Acrylic, Compared";
...
export const metaDescription = "We compared 8 laser engravers for acrylic on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Laser Engravers for Acrylic (2026)";
...
export const breadcrumbLabel = "Best Laser Engravers for Acrylic";
