...
export const guideTitle = "The Best UV Laser Engravers for Everyday Desk Work";
...
export const metaDescription = "How 4 UV laser engravers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best UV Laser Engravers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best UV Laser Engravers";
