...
export const faq = [
  {
    ...
    "a": "4GHz connections, like the Logitech G515's Lightspeed receiver, run at roughly 1ms of latency, matching a wired connection."
  },
  {
    "q": "4GHz wireless keyboard use up a USB port I need for something else?",
    "a": "4GHz receiver, like the one on the Logitech G515, occupies a USB-A port for as long as the keyboard is in use, which is a real tradeoff on a port-limited laptop. Bluetooth-only boards, like the Keychron K3 V2 or Logitech MX Mechanical, avoid this by pairing directly without a dongle."
  },
  {
  ...
  {
    "q": "4GHz for a crowded office?",
    "a": "4GHz tends to hold a more stable connection in an open office with many competing Bluetooth speakers, headphones, and phones on the same wireless spectrum. 4GHz connection is the safer choice over a Bluetooth-only board."
  },
  {
...
export const guideTitle = "The Best Wireless Mechanical Keyboards for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "4GHz tends to hold a steadier connection in Bluetooth-crowded offices at the cost of a USB-A port."
  },
  {
    "title": "",
...
export const introParagraphs = [
  "4GHz receiver ties up a limited USB-A port, and how many devices you can realistically switch between. Latency is no longer a real concern on modern hardware, but the other details still separate a convenient board from a frustrating one.",
  "Each pick is matched to a specific connectivity need, port-limited laptops, crowded Bluetooth environments, or multi-device switching, rather than ranked as one universal best."
];
...
export const metaDescription = "How 8 wireless mechanical keyboards compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Wireless Mechanical Keyboards for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "The standard K10 keeps the full 104-key layout with number pad while adding Bluetooth multitasking support, letting you switch between multiple paired devices without unplugging or re-pairing. A USB-C wired mode is also available, giving the same battery fallback flexibility as its 96% sibling.\n\nWhite LED backlighting and brown tactile switches make it a solid general-purpose choice for anyone who specifically needs the full number pad in a wireless mechanical board.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The KN85 is the most affordable wireless option in this list and the only budget pick with hot-swappable switch sockets, letting you replace the stock linear switches later without soldering. 4GHz, or wired USB-C, covering essentially every connection scenario in one board.\n\nA compact 75% layout keeps arrow keys and a few navigation keys while trimming the number pad, and its switch longevity benefits from the hot-swap sockets in a way the sealed budget boards in this category don't offer.",
    "specs": [
      "75% compact layout",
  ...
  },
  {
    ...
    "description": "4GHz wireless, which runs at roughly 1ms of latency, effectively matching a wired connection for gaming and typing alike. Low-profile tactile switches keep the keypress short and relatively quiet compared to a standard-height mechanical switch.\n\n4GHz USB receiver rather than Bluetooth, it holds a more stable connection in offices with many competing Bluetooth devices, at the cost of occupying a USB-A port.\n\n4GHz receiver occupies a USB-A port, a tradeoff on port-limited laptops.",
    "specs": [
...
export const breadcrumbLabel = "Best Wireless Mechanical Keyboards";
