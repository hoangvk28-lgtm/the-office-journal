...
export const guideTitle = "The Best Storage Carts for Nurseries: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 storage carts for nurseries, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Storage Carts for Nurseries (2026)";
...
export const breadcrumbLabel = "Best Storage Carts for Nurseries";
