...
export const guideTitle = "The Best 5-Port PoE Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 5 5-port PoE network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 5-Port PoE Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B076PRM2C5?tag=theofficejournal-20",
    ...
    "specs": [
      "4x PoE+ @67W total, Fast Ethernet",
      "Extend Mode + Priority Mode",
      "Fanless, 3-year warranty"
    ],
    "pros": [
      "Lower price appropriate for basic PoE camera/phone use",
      "Extend and Priority modes carry over from Gigabit models",
      "3-year warranty despite the lower price tier"
    ],
    "cons": [
      "Fast Ethernet only, not Gigabit, a real bottleneck for modern devices",
      "Just 4 PoE ports"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BBLW7DXG?tag=theofficejournal-20",
    "description": "18-inch housing, with 12-48V DC redundant input for flexible power sourcing.\n\nThe industrial-grade aluminum housing handles -40°C to 75°C operation, and DIN-rail plus wall-mount hardware ships included for control cabinet installs.",
    "specs": [
      "5x PoE ports @30W/port, industrial",
      "-40°C to 75°C, 12-48V DC input",
      "DIN-rail + wall mount included"
    ],
    "pros": [
      "30W per port supports higher-draw PoE devices",
      "Wide temperature range suits industrial settings",
      "Redundant DC power input"
    ],
    "cons": [
      "Ultra-small size limits total PoE budget across all 5 ports",
      "Niche industrial brand"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-poe-powered-network-switches",
    "title": "5 Best PoE-Powered Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best 5-Port PoE Network Switches";
