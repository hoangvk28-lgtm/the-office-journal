...
export const faq = [
  {
    ...
    "a": "Several listings in this cluster explicitly note that CAT5 or CAT5e cables cap performance below 1000Mbps. CAT6 or better is required to reliably hit the full Gigabit rating these adapters advertise."
  },
  {
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "When Gigabit Is Enough",
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "5G-capable switch or NAS already owned",
          ""
        ]
      ]
    }
...
export const introParagraphs = [
  "2 Gen 2 or better.",
  "We ranked this cluster by stability, driver-free behavior across operating systems, and cable/build durability rather than theoretical speed, since every product here already tops out at the same 1000Mbps ceiling."
];
