...
export const guideTitle = "The Best Dell Gaming Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 6 dell gaming monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Dell Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Fhd resolution and 1500:1 contrast ratio bring clarity",
      "Hear the audio difference",
      "Eye comfort"
    ],
    "pros": [
...
export const breadcrumbLabel = "Best Dell Gaming Monitors";
