...
export const introParagraphs = [
  "Across best desk pads for home office, range widely in real edge durability, given that differences show up in daily use.",
  "What separates these picks is true size versus your actual keyboard and mouse, since these separate real capability from claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-desk-pads-for-home-office-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-desk-pads-for-home-office-2",
    rank: 2,
  ...
  {
    id: "best-desk-pads-for-home-office-3",
    rank: 3,
  ...
  {
    id: "best-desk-pads-for-home-office-4",
    rank: 4,
  ...
  {
    id: "best-desk-pads-for-home-office-5",
    rank: 5,
    ...
    description: "DAWNTREES Felt Desk Mat is a strong alternative worth comparing directly against the top pick. The desk pad is made of top felt cloth, which is super soft and durable. The correct product dimensions are length 36 inches x width 12 inches.\n\nFelt naturally absorbs water and will return to normal state within no time, a detail worth checking closely before choosing between this and Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
    specs: ["High quality", "Large sized", "Easy to clean and water absorbing"],
    pros: ["High quality", "Large sized", "Easy to clean and water absorbing", "Desk protection"],
    cons: ["Cloth tops show wear faster than a wipeable leather or PU surface", "A too-small size still leaves your mouse hand off the pad"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-desk-pads-for-home-office-6",
    rank: 6,
    ...
    description: "iCasso Desk Mat, Mouse Pad for Office Desk, 35.4x15.7in, Pink Floral is the premium option here, positioned above the rest on price. More than just a mouse pad, this pink floral desk accessory helps create a coordinated and stylish workspace. The mouse pads for desk with comfortable lycra surface and material to the pads.\n\nWeighing this against Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse, the desk protector mat is flexible enough to be rolled up for easy transport ends up being the detail that matters most for most buyers.\n\nGo with this pick if you are willing to spend the most in this comparison for the fuller feature set that comes with it. A desk pad sized just for your keyboard still leaves your mouse hand working off the bare desk, so measure your keyboard and mouse side by side before picking a size.",
  ...
  {
    id: "best-desk-pads-for-home-office-7",
    rank: 7,
    badge: "Best Value",
    ...
    description: "YSAGi Leather Desk Pad Protector is the most affordable pick here that still clears the capability floor for this category. Durable PU leather material adapted, which can protect your desk from scratches, stains, spills, heat and scuffs. With our large desk pad, say goodbye to small extra mouse pad.\n\nAothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse lands in a similar spot overall, but the deciding factor between the two is waterproof leather desk pad.\n\nGo with this pick if you want a genuinely capable pick without paying for headroom you won't use. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
    specs: ["Desk protector", "Large mouse pad", "Easy to clean"],
    pros: ["Desk protector", "Large mouse pad", "Easy to clean", "About brand ysagi"],
    cons: ["Cloth tops show wear faster than a wipeable leather or PU surface", "A too-small size still leaves your mouse hand off the pad"],
  ...
  {
    id: "best-desk-pads-for-home-office-8",
    rank: 8,
    badge: "Also Worth Considering",
    name: "Ralxion Scalloped Desk Mat",
    price: "$13.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/51ik+melnsL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0GQ3B8Z5F?tag=theofficejournal-20",
    description: "Ralxion Scalloped Desk Mat is a strong alternative worth comparing directly against the top pick. Features charming scalloped piping edges that add a cute aesthetic and trendy touch to your workspace, perfect for office, home, gaming setup, or vanity room decor. Crafted from high-quality PU leather with a smooth surface that provides a comfortable writing and working experience while maintaining a professional appearance.\n\nSet next to Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A desk pad sized just for your keyboard still leaves your mouse hand working off the bare desk, so measure your keyboard and mouse side by side before picking a size.",
    specs: ["Elegant scalloped design", "Crafted from high-quality PU leather with a smooth surface", "Generous size"],
    pros: ["Elegant scalloped design", "Crafted from high-quality PU leather with a smooth surface", "Generous size", "Anti-slip backing"],
    cons: ["A too-small size still leaves your mouse hand off the pad", "Cloth tops show wear faster than a wipeable leather or PU surface"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Cloth (e.g. YSAGi Leather Desk Pad Protector)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "You want straightforward daily protection and comfort, where YSAGi Leather Desk Pad Protector already covers the job at the lowest price here."
      }
    ]
  }
];
