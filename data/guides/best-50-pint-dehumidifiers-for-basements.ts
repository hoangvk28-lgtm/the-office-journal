...
export const guideTitle = "The Best 50-Pint Dehumidifiers for Basements: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Ft Dehumidifier for Basement with Drain Hose)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You're covering a large or wet space and want a built-in pump and higher capacity, where Manastin 50 Pint dehumidifier for basement with drain hose justifies the extra cost."
      },
      {
        "label": "",
        "text": "Ft Dehumidifier for Basement with Drain Hose already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "A practical comparison of 8 50-pint dehumidifiers for basements, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 50-Pint Dehumidifiers for Basements (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "50 pint dehumidification for large areas",
      "Easy control panel with child lock",
      "Dehu, dry & sleep modes"
    ],
    "pros": [
      "50 pint dehumidification for large areas",
      "Easy control panel with child lock",
  ...
  },
  {
    ...
    "description": "Ft Dehumidifier for Basement with Drain Hose is the most affordable pick here that still clears the capability floor for this category. Ft, ideal for basements, bedrooms and laundry rooms. Meet your home’s new best friend, a powerful 50 pint dehumidifier that works harder so you don’t have to!\n\nThis dehumidifier supports two flexible drainage solutions, which is the main thing that distinguishes this pick from Frigidaire 50 Pint Dehumidifier w/Wifi.\n\nThis one is the right call if you want a capable pick without paying for headroom you won't use. The tank needs regular emptying unless you're running a continuous drain hose or pump, so factor that into daily upkeep before buying.",
    "specs": [
      "50 pint dehumidifier covers spaces up to 5,000 sq.ft",
      "Stronger, smarter moisture control",
      "Dehumidifier supports two flexible drainage solutions"
    ],
    "pros": [
      "50 pint dehumidifier covers spaces up to 5,000 sq.ft",
      "Stronger, smarter moisture control",
      "Dehumidifier supports two flexible drainage solutions",
      "Advanced compressor technology works hard while sipping energy, using just 0.33 kwh"
    ],
    "cons": [
      "Tank needs regular emptying unless drained continuously",
      "Coverage claims assume ideal conditions, not always real rooms"
...
export const breadcrumbLabel = "Best 50-Pint Dehumidifiers for Basements";
