...
export const guideTitle = "The Best Microphone Arms for Dual Monitor Setups, Compared";
...
export const metaDescription = "We compared 8 microphone arms for dual monitor setups on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Microphone Arms for Dual Monitor Setups (2026)";
...
export const breadcrumbLabel = "Best Microphone Arms for Dual Monitor Setups";
