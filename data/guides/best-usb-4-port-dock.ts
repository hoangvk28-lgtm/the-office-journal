...
export const faq = [
  {
    "q": "Can I connect 4 Thunderbolt SSDs to the CalDigit E5 and get full speed on all of them simultaneously?",
    "a": "You can connect 4 SSDs simultaneously, but since Thunderbolt bandwidth is shared across the dock's total capacity rather than being independently allocated per port, running all 4 at their absolute maximum speed simultaneously may see some bandwidth sharing depending on your host system's own capabilities."
  },
  {
    "q": "What's the most common mistake buyers make when choosing a 4-port USB4 or Thunderbolt dock?",
    "a": "Assuming 4 ports means 4 times the bandwidth of a single-port connection, when Thunderbolt and USB4 bandwidth is actually a shared total pool that gets dynamically allocated based on which devices are connected and what they demand."
  },
  {
    "q": "Is the CalDigit E5 worth the extra cost over the OWC 5-port hub if I only need basic Thunderbolt expansion?",
    "a": "If you only need straightforward Thunderbolt port expansion without networking or card readers, the OWC hub's simpler design and lower price cover that well, but if you want the highest bandwidth, sustained multi-device power, and offline charging, the CalDigit E5's extra cost is justified."
  },
  {
    "q": "Will the Amazon Basics dock work with my M1 MacBook Pro?",
    "a": "No, the listing specifically states this dock is not compatible with M1/M2 chip MacBooks, so M1 or M2 Mac owners should choose a different pick from this comparison, such as the CalDigit E5 or UGREEN pick."
  },
  {
    "q": "How do I avoid the resolution downgrade issue mentioned in the Amazon Basics dock's setup instructions?",
    "a": "The manufacturer specifically recommends connecting your Thunderbolt 4 or USB-C monitor connection before the HDMI port, since connecting HDMI first can trigger a bandwidth allocation that downgrades the resolution of subsequently connected displays."
  },
  {
    "q": "Do these 4-port docks require a separate power adapter, or is one included?",
    "a": "This varies by pick: the UGREEN dock specifically includes a bundled 140W GaN charger, while checking each other specific listing's included accessories is worth doing, since not every dock in this comparison includes a power adapter in the box."
  }
];

export const guideSlug = "best-usb-4-port-dock";

export const guideTitle = "The Best USB4 4-Port Docks for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "The highest per-port bandwidth with sustained power",
          "CalDigit E5 Thunderbolt 5 Element 5 Hub"
        ],
        [
          "A simple 4-port hub without extra peripheral ports",
          ""
        ],
        [
          "A travel-friendly, compact 4-port dock",
          "Amazon Basics Thunderbolt 4 Pro Docking Station"
        ],
        [
          "A complete 8-in-1 solution with a bundled charger",
          "UGREEN 8-in-1 Thunderbolt 4 Docking Station"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Focuses purely on the core Thunderbolt/USB4 expansion without extra peripheral ports, at a lower price."
      },
      {
        "label": "Full-featured dock (CalDigit E5, UGREEN 8-in-1)",
        "text": "Adds Ethernet, card readers, and additional USB-A ports alongside the 4 Thunderbolt/USB4 connections for a more complete desk setup."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Permanent desk setup with maximum bandwidth",
          ""
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "The highest stated per-port PCIe bandwidth figure, since connecting multiple Thunderbolt SSDs simultaneously benefits directly from each port's individual maximum throughput."
      },
      {
        "label": "",
        "text": "The CalDigit E5 specifically states each of its 4 Thunderbolt 5 ports supports up to 6,200MB/s performance for ultra-fast Thunderbolt SSDs."
      }
    ]
  },
  {
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared stated Gb/s figures per individual Thunderbolt/USB4 port across all four docks."
  },
  {
    "title": "",
    "description": "Compared additional peripheral ports beyond the headline 4 Thunderbolt/USB4 connections."
  },
  {
    "title": "",
    "description": "Compared power delivery consistency across all connected devices simultaneously."
  },
  {
    "title": "",
    "description": "Compared compact travel-friendly designs against larger desk-anchored hubs."
  },
  {
    "title": "",
    "description": "Compared bundled chargers and cables against docks requiring separate purchases."
  }
];
...
export const metaDescription = "How 4 USB4 4-port docks compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best USB4 4-Port Docks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "4x Thunderbolt 5/USB4 v2 ports, 80Gb/s + 120Gb/s Bandwidth Boost",
      "90W sustained power delivery across 9 total ports",
      "Offline Charging without a host computer connected"
    ],
    "pros": [
      "Highest per-port bandwidth in this comparison at up to 64Gb/s PCIe",
      "Offline Charging works without a host computer connected",
      "Sustained 90W power delivery across all 9 ports simultaneously"
    ],
    "cons": [
      "Highest price in this comparison at $249.99",
      "Full functionality requires a Thunderbolt 5 or USB4 v2 host"
    ],
  ...
  },
  {
    ...
    "specs": [
      "3x downstream Thunderbolt 4 ports, 40Gbps, up to 8K display",
      "85W charging via included 140W GaN charger",
      "8-in-1 design with Gigabit Ethernet"
    ],
    "pros": [
      "Complete 8-in-1 solution with a bundled 140W charger included",
      "Detailed per-platform and per-chip display support documentation",
      "Gigabit Ethernet adds networking beyond just Thunderbolt ports"
    ],
    "cons": [
      "Explicitly incompatible with the 2018 Intel Mac mini",
      "Full-featured USB-C-only laptops/tablets limited to a single display"
    ],
...
export const breadcrumbLabel = "Best USB4 4-Port Docks";
