...
export const guideTitle = "The Best Under-Desk Space Heaters for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 7 under-desk space heaters, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Under-Desk Space Heaters for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Under-Desk Space Heaters";
