...
export const introParagraphs = [
  "Best NDI Video Switchers cover a wide input-count range. That means marketing copy alone is risky.",
  "This roundup weighs real input count and connector type, given that this is where the decision gets made."
];
...
export const products: GuideProduct[] = [
  ...
  {
    id: "best-ndi-video-switchers-7",
    rank: 7,
    badge: "Best Value",
    name: "CINETREAK Stream 1 Live Streaming Switcher 4 HDMI & AUX Inputs",
    price: "$289.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41Ed67gRDaL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0DNQZM488?tag=theofficejournal-20",
    description: "CINETREAK Stream 1 Live Streaming Switcher 4 HDMI & AUX Inputs is the most affordable pick here that still clears the capability floor for this category. Stream 1 has up to 4 HDMI inputs and one aux channel, which can access the media library. Users can seamlessly integrate any unencrypted video source into the stream switcher, enabling real-time output through the switcher.\n\nHeld up against osee GoStream Deck HDMI Pro Live Streaming Multi Camera Video Mixer Switcher, both cover the basics equally well, what actually separates them is features built-in ptz control for up to 4 cameras via the visca protocol, with support for wireless ip control from a PC or smartphone.\n\nGo with this pick if you want a genuinely capable pick without paying for headroom you won't use. Input count fills up faster than expected once cameras, overlays, and playback sources are all counted, so plan with real margin.",
    specs: ["Rich connection ports", "Down & pull stream", "Ptz camera control & advanced host system"],
    pros: ["Rich connection ports", "Down & pull stream", "Ptz camera control & advanced host system", "Rec, playback & customizable pip"],
    cons: ["Input count fills up fast with cameras plus overlays", "NDI routing adds real network bandwidth demands"],
    bestFor: "buyers who want a genuinely capable pick without paying for headroom you won't use",
  },
  {
    id: "best-ndi-video-switchers-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        [
          ...
          "CINETREAK Stream 1 Live Streaming Switcher 4 HDMI & AUX Inputs"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "HDMI (e.g. CINETREAK Stream 1 Live Streaming Switcher 4 HDMI & AUX Inputs)",
        "text": "Simpler and cheaper for short cable runs typical of a home or small studio setup."
      },
      {
        "label": "SDI (e.g. Osee GoStream Duet Kit All in One Pro Live Streaming Multi-Camera Video Mixer)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "You're running a simple 2-3 camera setup, where CINETREAK Stream 1 Live Streaming Switcher 4 HDMI & AUX Inputs already covers the job at the lowest price here."
      }
    ]
  }
];
