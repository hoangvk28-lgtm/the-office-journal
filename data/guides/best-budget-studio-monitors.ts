export const guideSlug = "best-budget-studio-monitors";
export const guideTitle = "8 Best Budget Studio Monitors in 2026";
export const metaTitle = "Best Budget Studio Monitors";
export const metaDescription = "We compared best budget studio monitor models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "best budget studio monitor";
export const introParagraphs = [
  "Best Budget Studio Monitors carry very different real specs. That means the fine print matters most here.",
...
export const products: GuideProduct[] = [
  {
    id: "best-budget-studio-monitors-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-budget-studio-monitors-2",
    rank: 2,
  ...
  {
    id: "best-budget-studio-monitors-3",
    rank: 3,
  ...
  {
    id: "best-budget-studio-monitors-4",
    rank: 4,
  ...
  {
    id: "best-budget-studio-monitors-5",
    rank: 5,
  ...
  {
    id: "best-budget-studio-monitors-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-budget-studio-monitors-7",
    rank: 7,
  ...
  {
    id: "best-budget-studio-monitors-8",
    rank: 8,
    badge: "Best Value",
