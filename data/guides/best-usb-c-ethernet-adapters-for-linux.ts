...
export const faq = [
  {
    ...
    "a": "It means the chipset has an in-kernel driver already included in a reasonably current Linux distribution. Older distributions or older kernels may need a manual driver install even for chipsets that are technically \"in-kernel\" on newer releases."
  },
  {
    "q": "Which adapter has the most explicit Linux documentation?",
    "a": "TP-Link's UE300C explicitly lists Linux (Ubuntu) as driver-free in its own marketing copy, a level of specificity most competitors don't provide."
  }
];

export const guideSlug = "best-usb-c-ethernet-adapters-for-linux";

export const guideTitle = "The Best USB-C Ethernet Adapters for Linux, Compared";
...
export const metaDescription = "We compared 6 USB-C ethernet adapters for linux on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best USB-C Ethernet Adapters for Linux (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-usb-c-ethernet-adapters-for-chromebooks",
    "title": "7 Best USB-C Ethernet Adapters for Chromebooks"
  },
  {
...
export const breadcrumbLabel = "Best USB-C Ethernet Adapters for Linux";
