...
export const guideTitle = "The Best Desk Fans for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 desk fans, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Desk Fans for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Desk Fans";
