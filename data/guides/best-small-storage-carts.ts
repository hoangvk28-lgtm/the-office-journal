...
export const guideTitle = "The Best Small Storage Carts for Everyday Desk Work";
...
export const metaDescription = "How 8 small storage carts compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Small Storage Carts for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Small Storage Carts";
