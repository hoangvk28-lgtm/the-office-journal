...
export const guideTitle = "The Best JBL Studio Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "You're just starting out and want capable sound without overspending, where JBL Professional 1 Series 104-BT Compact Desktop Reference Monitors with already covers the job."
      }
    ]
  }
];
...
export const metaDescription = "How 8 JBL studio monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best JBL Studio Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "5\" Studio Monitoring Speakers (Pair) is a strong alternative worth comparing directly against the top pick. Updated HF and LF transducers: new design improvements result in optimized damping for superior transient response and impressive deep bass with lower harmonic distortion.\n\nThe gap between this and (2) JBL 305P MkII 5\" 2-Way Active Powered Studio Reference Monitors Speakers isn't in the essentials, it shows up in restores neutral low frequency response when speakers are placed on the work surface and adjacent to walls.\n\nThis one is the right call if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Room acoustics and speaker placement affect the sound as much as the monitor itself, so treat the room before blaming the gear.",
    "specs": [
      "This bundle",
      "Updated HF and LF transducers",
      "New boundary eq"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Dual 56w class-d amplifiers",
      "Low frequency woofer",
      "Neodymium woven-composite tweeter"
    ],
    "cons": [
      "Room acoustics affect the sound more than the speaker",
      "Stands or isolation pads are usually a separate purchase"
...
export const breadcrumbLabel = "Best JBL Studio Monitors";
