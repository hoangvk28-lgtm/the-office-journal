...
export const guideTitle = "The Best OLED Ultrawide Gaming Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "LG 34GS95QE 34-inch Ultragear OLED Curved Gaming Monitor WQHD 1440p 800R 240Hz)",
...
export const metaDescription = "How 6 OLED ultrawide gaming monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best OLED Ultrawide Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Experience the difference with samsung oled",
      "Ultrawide vistas"
    ],
    "pros": [
      "Handpicked by amazon",
      "Experience the difference with samsung oled",
      "Ultrawide vistas",
      "Outmanuever opponents with supreme speed"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const breadcrumbLabel = "Best OLED Ultrawide Gaming Monitors";
