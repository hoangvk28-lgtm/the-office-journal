...
export const guideTitle = "The Best Air Quality Monitors for Home, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Kidde Smart CO Detector + Indoor Air Quality)",
...
export const metaDescription = "We compared 8 air quality monitors for home on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Air Quality Monitors for Home (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-air-quality-monitors-for-mold",
    "title": "Best Air Quality Monitors for Mold in 2026"
  }
];

export const breadcrumbLabel = "Best Air Quality Monitors for Home";
