...
export const guideTitle = "Best Dahua Interactive Whiteboards";
export const metaTitle = "Best Dahua Interactive Whiteboards";
export const metaDescription = "We separated Dahua's current DeepHub Pro Series from discontinued models and paired thin Amazon inventory with genuinely current alternatives.";
...
export const introParagraphs = [
  ...
  "We separated Dahua's current Pro Series from discontinued models per the brand's own documentation, and paired the limited direct Amazon availability with genuinely current EDLA-certified alternatives verified against the same criteria used across this cluster."
];
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-newline-interactive-whiteboards","title":"5 Best Newline Interactive Whiteboards"},{"href":"/guide/best-maxhub-interactive-whiteboards","title":"Best MAXHUB Interactive Whiteboards"},{"href":"/guide/best-electronic-interactive-whiteboards","title":"8 Best Electronic Interactive Whiteboards"}];
