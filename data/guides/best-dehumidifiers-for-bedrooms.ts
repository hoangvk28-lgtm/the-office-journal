...
export const guideTitle = "The Best Dehumidifiers for Bedrooms: Our Picks";
...
export const metaDescription = "How 8 dehumidifiers for bedrooms compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Dehumidifiers for Bedrooms (2026)";
...
export const breadcrumbLabel = "Best Dehumidifiers for Bedrooms";
