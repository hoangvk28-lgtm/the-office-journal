...
export const introParagraphs = [
  "Across best projectors with bluetooth, range widely in real brightness, given that specs matter more than branding.",
...
export const products: GuideProduct[] = [
  {
    id: "best-projectors-with-bluetooth-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-projectors-with-bluetooth-2",
    rank: 2,
  ...
  {
    id: "best-projectors-with-bluetooth-3",
    rank: 3,
  ...
  {
    id: "best-projectors-with-bluetooth-4",
    rank: 4,
  ...
  {
    id: "best-projectors-with-bluetooth-5",
    rank: 5,
  ...
  {
    id: "best-projectors-with-bluetooth-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-projectors-with-bluetooth-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-projectors-with-bluetooth-8",
    rank: 8,
