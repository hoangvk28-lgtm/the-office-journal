...
export const guideTitle = "The Best NDI Video Switchers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "CINETREAK Stream 1 Live Streaming Switcher 4 HDMI & AUX Inputs)",
...
export const metaDescription = "A practical comparison of 8 NDI video switchers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best NDI Video Switchers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Rich connection ports",
      "Down & pull stream",
      "Ptz camera control & advanced host system"
    ],
    "pros": [
      "Rich connection ports",
      "Down & pull stream",
      "Ptz camera control & advanced host system",
      "Rec, playback & customizable pip"
    ],
    "cons": [
      "Input count fills up fast with cameras plus overlays",
      "NDI routing adds real network bandwidth demands"
...
export const breadcrumbLabel = "Best NDI Video Switchers";
