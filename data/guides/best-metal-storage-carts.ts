...
export const guideTitle = "The Best Metal Storage Carts for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 metal storage carts, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Metal Storage Carts for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Rolling cart serves the purposes of kitchen cart, bathroom",
      "Large capacity",
      "Easy to move"
    ],
    "pros": [
...
export const breadcrumbLabel = "Best Metal Storage Carts";
