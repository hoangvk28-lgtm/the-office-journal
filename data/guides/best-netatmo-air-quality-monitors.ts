...
export const guideTitle = "The Best Netatmo Air Quality Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5 H5106 is worth checking against its specific spec sheet before assuming any pick here covers your exact concern."
      }
    ]
  },
  {
...
export const metaDescription = "A practical comparison of 8 netatmo air quality monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Netatmo Air Quality Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Netatmo Air Quality Monitors";
