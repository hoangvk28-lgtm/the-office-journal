...
export const guideTitle = "The Best 27-Inch OLED Gaming Monitors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Msi MAG 274QP QD-OLED X24 27-Inch WQHD Gaming Monitor)",
...
export const metaDescription = "We compared 6 27-inch OLED gaming monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 27-Inch OLED Gaming Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 27-Inch OLED Gaming Monitors";
