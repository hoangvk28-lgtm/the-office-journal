...
export const faq = [
  {
    ...
    "a": "The 5GbE NT-C5GA works on any data-capable USB-C port (with reduced speed on older USB generations), while the 10GbE NT-P10G explicitly requires Thunderbolt 3/4/5 or USB4 and will not function on a standard USB-C port at all."
  }
];

export const guideSlug = "best-sabrent-usb-c-ethernet-adapters";

export const guideTitle = "The Best Sabrent USB-C Ethernet Adapters for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 2 sabrent USB-C ethernet adapters, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Sabrent USB-C Ethernet Adapters for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Sabrent USB-C Ethernet Adapters";
