...
export const guideTitle = "The Best Woven Cable Sleeves for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 woven cable sleeves, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Woven Cable Sleeves for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Features a split design that easily wraps around your wires with 25% overlap",
      "Protect and organize your automotive harness",
      "Soft polypropylene (pp) woven material gives you durable"
    ],
    "pros": [
      "Features a split design that easily wraps around your wires with 25% overlap",
      "Protect and organize your automotive harness",
      "Soft polypropylene (pp) woven material gives you durable",
      "Rated for temperatures up to 150°c (302°f)"
    ],
    "cons": [
      "Fixed-diameter sleeves can't expand for an added cable later",
      "Standard fabric can degrade under sustained heat exposure"
...
export const breadcrumbLabel = "Best Woven Cable Sleeves";
