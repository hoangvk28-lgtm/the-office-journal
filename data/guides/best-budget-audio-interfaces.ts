export const guideSlug = "best-budget-audio-interfaces";
export const guideTitle = "8 Best Budget Audio Interfaces in 2026";
export const metaTitle = "Best Budget Audio Interfaces";
export const metaDescription = "We compared good cheap audio interface models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "good cheap audio interface";
export const introParagraphs = [
  "Across best budget audio interfaces, vary more than the keyword suggests, given that the real gap is in the details.",
...
export const products: GuideProduct[] = [
  {
    id: "best-budget-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-budget-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-budget-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-budget-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-budget-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-budget-audio-interfaces-6",
    rank: 6,
  ...
  {
    id: "best-budget-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-budget-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
