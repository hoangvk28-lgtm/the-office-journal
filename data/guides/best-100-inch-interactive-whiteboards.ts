...
export const faq = [
  {
    "q": "Is there a meaningful difference between a 98-inch and 100-inch interactive whiteboard?",
    "a": "Practically, very little, a 2-inch diagonal difference is barely noticeable in viewing distance or writing reach. The 98-inch tier has substantially deeper current product availability across major brands, worth considering as a functionally equivalent alternative."
  },
  {
    "q": "Does a 100-inch board need professional installation?",
    "a": "At this size, panels commonly weigh well over 100 pounds and require verified wall stud structure or a heavy-duty stand rated for the weight, DIY installation carries real safety and warranty risk at this scale."
  },
  {
...
export const guideTitle = "The Best 100-Inch Interactive Whiteboards for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "True 100-inch interactive whiteboards are a thin current product tier compared to the deeper 86 and 98-inch categories. If you specifically need this exact diagonal, verify current model availability directly with major brands, otherwise the 86-98in alternatives here offer a much deeper verified product pool at comparable capability."
  }
];
...
export const introParagraphs = [
  "Exact 100-inch products are less standardized than the deeper 98-inch and 110-inch tiers, and results at this exact diagonal often drift toward signage displays or projector image-size claims rather than true interactive whiteboards.",
  "We built an exact 100-inch product table verifying each candidate is a genuine current interactive whiteboard rather than ordinary signage, compared actual panel dimensions and weight against nearby 98-inch alternatives, and evaluated 4K pixel density and UI readability at this scale."
];
...
export const metaDescription = "A practical comparison of 5 100-inch interactive whiteboards, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 100-Inch Interactive Whiteboards for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-100-inch-interactive-whiteboards-1",
    "rank": 1,
    "badge": "Best Large-Format Alternative (86in)",
  ...
  {
    "id": "best-100-inch-interactive-whiteboards-2",
    "rank": 2,
    "badge": "Runner-Up Large Alternative (86in)",
  ...
  {
    "id": "best-100-inch-interactive-whiteboards-3",
    "rank": 3,
  ...
  {
    "id": "best-100-inch-interactive-whiteboards-4",
    "rank": 4,
  ...
  {
    "id": "best-100-inch-interactive-whiteboards-5",
    "rank": 5,
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FB3RRXCP?tag=theofficejournal-20",
    "description": "Shiarffe's X5 uses industrial-grade construction with a reinforced chassis specifically designed for daily K-12 use, built to withstand years of constant multi-student interaction with minimal downtime and fewer repairs.\n\nGoogle EDLA certified with zero software subscriptions and simplified licensing, it's available in 55/65/75/86-inch sizes with consistent specs across the range, an 8GB RAM/128GB storage configuration, and a built-in 48MP camera on select models.",
    "specs": [
      "86in 4K, industrial-grade construction",
      "EDLA-certified, no subscription fees",
      "Available in 55/65/75/86in sizes"
    ],
    "pros": [
      "Industrial-grade reinforced chassis built specifically for K-12 durability",
      "Zero-subscription EDLA licensing model",
      "Consistent sizing options (55/65/75/86in) across one product line"
    ],
    "cons": [
      "Integrated camera only on select models, not universal across sizes",
      "Mobile carts sold separately from the included wall mount"
    ],
...
export const breadcrumbLabel = "Best 100-Inch Interactive Whiteboards";
