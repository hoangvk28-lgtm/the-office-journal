...
export const introParagraphs = [
  "Across best bluetooth studio monitors, look similar but differ in practice, given that the spec sheet hides real gaps.",
...
export const products: GuideProduct[] = [
  {
    id: "best-bluetooth-studio-monitors-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-bluetooth-studio-monitors-2",
    rank: 2,
  ...
  {
    id: "best-bluetooth-studio-monitors-3",
    rank: 3,
  ...
  {
    id: "best-bluetooth-studio-monitors-4",
    rank: 4,
  ...
  {
    id: "best-bluetooth-studio-monitors-5",
    rank: 5,
  ...
  {
    id: "best-bluetooth-studio-monitors-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-bluetooth-studio-monitors-7",
    rank: 7,
  ...
  {
    id: "best-bluetooth-studio-monitors-8",
    rank: 8,
    badge: "Best Value",
