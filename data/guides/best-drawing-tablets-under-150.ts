...
export const buyingCriteria = [
  ...
  {
    "criterion": "Define the larger screenless capability floor",
    "explanation": "95 fits; larger area and better ergonomics should lead. Do not expand the list with products that fail the core category definition just to reach a target number of picks. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
...
export const faq = [
  {
    "q": "What should I check before buying from this best drawing tablets under $150 comparison?",
...
export const guideSlug = "best-drawing-tablets-under-150";

export const guideTitle = "The Best Drawing Tablets Under $150, Compared";
...
export const howWeEvaluated = [
  ...
  {
    "title": "",
    "description": "Show the next-lower tier, the larger screenless tier and the next-higher tier so this article has a distinct reason to exist."
  },
  {
    "title": "",
  ...
  {
    "title": "",
    "description": "Judge cables/stand/accessory ecosystem, warranty/support and ownership friction, then explicitly say when a buyer should spend less or exceed $150 for a meaningful upgrade."
  }
];

export const introParagraphs = [
  "Best Drawing Tablets Under $150 listings span a wide range of real capability even within the same price ceiling, and comparing them on price alone misses which picks actually meet the core use case.",
...
export const mainKeyword = "drawing tablets under $150";

export const metaDescription = "We compared 8 drawing tablets under $150 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Drawing Tablets Under $150 (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-drawing-tablets-under-150-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-drawing-tablets-under-150-2",
    "rank": 2,
  ...
  {
    "id": "best-drawing-tablets-under-150-3",
    "rank": 3,
  ...
  {
    "id": "best-drawing-tablets-under-150-4",
    "rank": 4,
  ...
  {
    "id": "best-drawing-tablets-under-150-5",
    "rank": 5,
  ...
  {
    "id": "best-drawing-tablets-under-150-6",
    "rank": 6,
    "badge": "Worth a Look",
  ...
  {
    "id": "best-drawing-tablets-under-150-7",
    "rank": 7,
    "badge": "Best Value",
  ...
  {
    "id": "best-drawing-tablets-under-150-8",
    "rank": 8,
...
export const breadcrumbLabel = "Best Drawing Tablets Under $150";
