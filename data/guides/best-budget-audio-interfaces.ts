...
export const guideTitle = "The Best Budget Audio Interfaces for Everyday Desk Work";
...
export const metaDescription = "How 8 budget audio interfaces compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Budget Audio Interfaces for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Budget Audio Interfaces";
