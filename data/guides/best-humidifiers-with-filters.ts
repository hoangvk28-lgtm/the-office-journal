...
export const introParagraphs = [
  "Best Humidifiers With Filters cover a wide range of mist types and tank sizes. That means marketing copy alone is risky.",
  "This roundup weighs honest mold risk and mineral buildup, given that this is where the decision gets made."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-humidifiers-with-filters-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-humidifiers-with-filters-2",
    rank: 2,
  ...
  {
    id: "best-humidifiers-with-filters-3",
    rank: 3,
  ...
  {
    id: "best-humidifiers-with-filters-4",
    rank: 4,
  ...
  {
    id: "best-humidifiers-with-filters-5",
    rank: 5,
  ...
  {
    id: "best-humidifiers-with-filters-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-humidifiers-with-filters-7",
    rank: 7,
  ...
  {
    id: "best-humidifiers-with-filters-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You want a larger tank, quieter operation, and extra features like a hygrometer display, where Honeywell Cool Moisture Humidifiers for Bedroom justifies the extra cost."
      },
      {
        "label": "Save if",
        "text": "You need basic humidity for a small room and don't mind more frequent refills, where Vicks Filtered Cool Mist Humidifier already covers the job at the lowest price here."
      }
    ]
  }
];
