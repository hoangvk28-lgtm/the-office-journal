...
export const guideTitle = "The Best Power Banks for a Better Desk Setup";
...
export const metaDescription = "We compared 8 power banks on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Power Banks for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Power Banks";
