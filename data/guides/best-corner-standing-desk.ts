...
export const products: GuideProduct[] = [
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0FKSN1WR2?tag=theofficejournal-20",
    description: "The FEZIBO L-Shaped delivers a genuine 63x55 inch corner footprint with a dual-motor frame, 3 memory presets, and an anti-collision sensor at a price most competitors charge for a single straight desk. 5 inches covers most users between 5'2\" and 6'0\". Assembly requires connecting two desktop sections over the corner bracket, which takes roughly 45 minutes. The laminate surface resists scratches and is easy to wipe clean. This is the starting point for anyone shopping corner standing desks on a tight budget. 5\" max height limits taller users.",
  ...
  },
  {
    ...
    description: "The VIVO 63x55 inch L-shaped desk combines a dual-motor frame, 4 memory presets, a digital height display, and a keypad with child-lock in one package. VIVO's 5-year warranty on the motor and frame is among the longest available at this price point, making it a safer long-term investment than cheaper alternatives. The two-panel desktop ships separately and connects at the corner bracket. The steel frame and desktop together weigh roughly 80 lbs, so plan for two people during assembly. VIVO's after-sale support is responsive, and replacement parts are available directly from their US warehouse. 4 memory presets with child lock.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0F2M4G51K?tag=theofficejournal-20",
    description: "The SIAGO 63x55 inch L-shaped desk includes a built-in USB-An and USB-C charging panel on the desktop surface, which eliminates the need for a separate desk clamp charger. 9 inches with 4 memory presets and an anti-collision sensor., and the built-in charging adds value over similarly priced desks without it. The desktop surface has a matte finish that reduces glare from overhead lighting during video calls. The keypad features an LED height display and child-lock function. Cable management clips are included in the box. 9\" max height limits taller users.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0FPFSYXNF?tag=theofficejournal-20",
    description: "The OffiGo is the least expensive electric L-shaped standing desk in this roundup with a dual-motor frame. It provides 3 memory presets, an anti-collision sensor, and a 176 lb capacity across a 63-inch surface. The desktop ships in two panels and connects at the corner bracket in about 40 minutes. At this price the tradeoff is fewer color options and a basic keypad without a digital height display. For a home office where budget is the primary constraint and performance is secondary, the OffiGo delivers a functional standing L-shaped setup at the lowest price available.",
  ...
  },
  {
    ...
    description: "The Acrolix 59x40 inch L-shaped desk is the most compact option in this roundup, fitting into corner spaces that cannot accommodate a full 63-inch span. It uses a dual-motor frame with 3 memory presets and an anti-collision sensor. The smaller footprint is useful in studio apartments or home offices with limited wall space. 2 inches reaches slightly higher than several pricier alternatives. The 59-inch long side fits two 24-inch monitors side by side with minimal clearance, so users who need a third display or a monitor arm should consider a wider option. 2\" max height, higher than some larger desks.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B09B6X4TS6?tag=theofficejournal-20",
    description: "The FEZIBO Triple Motor uses three motors across the L-shaped frame rather than two, distributing the lifting force more evenly and reducing wobble at maximum standing height. The 220 lb capacity is the highest available in this roundup at this price point. It costs a bit more than the single-motor FEZIBO but delivers significantly better stability. The triple-motor configuration lifts the frame in near-well suited sync across both sides of the L-shape. This matters most when the desk is loaded with multiple monitors, a speaker, and other equipment. 4 memory presets and an anti-collision sensor are included. 220 lbs capacity. 5\" max height, same as budget options.",
