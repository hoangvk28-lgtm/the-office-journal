...
export const guideTitle = "The Best Tormach Desktop CNC Machines for a Better Desk Setup";
...
export const metaDescription = "We compared 3 tormach desktop CNC machines on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Tormach Desktop CNC Machines for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Tormach Desktop CNC Machines";
