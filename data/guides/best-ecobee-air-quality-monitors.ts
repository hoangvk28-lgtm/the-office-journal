...
export const guideTitle = "The Best Ecobee Air Quality Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "GoveeLife Smart Air Quality Monitor CO2 Detector H5140)",
...
export const metaDescription = "How 5 ecobee air quality monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Ecobee Air Quality Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Ecobee Air Quality Monitors";
