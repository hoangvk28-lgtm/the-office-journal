...
export const guideTitle = "The Best Underground Cable Sleeves for a Better Desk Setup";
...
export const metaDescription = "We compared 4 underground cable sleeves on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Underground Cable Sleeves for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Underground Cable Sleeves";
