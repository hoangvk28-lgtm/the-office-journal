...
export const guideSlug = "best-storage-carts-for-crafts";

export const guideTitle = "The Best Storage Carts for Crafts: Picks and Trade-offs";
...
export const introParagraphs = [
  "Across best storage carts for crafts, range widely in real durability, given that differences show up in the fine print.",
  "What separates these picks is real load capacity and caster material, since this predicts real daily durability."
];

export const lastUpdated = "2026-08-31";

export const mainKeyword = "storage cart for crafts";

export const metaDescription = "A practical comparison of 8 storage carts for crafts, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Storage Carts for Crafts (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-storage-carts-for-crafts-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-storage-carts-for-crafts-2",
    "rank": 2,
  ...
  {
    "id": "best-storage-carts-for-crafts-3",
    "rank": 3,
  ...
  {
    "id": "best-storage-carts-for-crafts-4",
    "rank": 4,
  ...
  {
    "id": "best-storage-carts-for-crafts-5",
    "rank": 5,
    "badge": "Best Value",
  ...
  {
    "id": "best-storage-carts-for-crafts-6",
    "rank": 6,
    "badge": "Worth a Look",
    "name": "YASONIC 3 Tier Metal Rolling Cart",
    "price": "$32.99",
  ...
  {
    "id": "best-storage-carts-for-crafts-7",
    "rank": 7,
  ...
  {
    "id": "best-storage-carts-for-crafts-8",
    "rank": 8,
    "badge": "Also Worth Considering",
...
export const breadcrumbLabel = "Best Storage Carts for Crafts";
