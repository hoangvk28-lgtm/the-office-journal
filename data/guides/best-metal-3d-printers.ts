...
export const guideTitle = "The Best Metal 3D Printers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Original Prusa CORE One+ DIY Enclosed High-Speed CoreXY 3D Printer Kit)",
...
export const metaDescription = "A practical comparison of 6 metal 3D printers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Metal 3D Printers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      ...
      "Experience a cleaner, safer, and more reliable printing environment",
      "Achieve true multicolor and multi-material printing without color mixing or cross-contamination"
    ],
    "pros": [
      "Break free from environmental limitations",
      "Experience a cleaner, safer, and more reliable printing environment",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-multi-head-3d-printers",
    "title": "Best Multi-Head 3D Printers in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Metal 3D Printers";
