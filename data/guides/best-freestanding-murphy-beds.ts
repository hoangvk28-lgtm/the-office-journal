...
export const faq = [
  {
    ...
    "a": "Freestanding means the cabinet does not require a wall mount bracket, but most freestanding murphy beds still need a floor cleat or wall backing anchor for tipping stability. Confirm the exact anchor requirement with the seller before assuming a freestanding unit needs zero attachment to your floor or wall."
  },
  {
    "q": "Will a freestanding murphy bed avoid lease restrictions in my apartment?",
    "a": "Floor anchoring, which many freestanding units still require, can trigger the same lease restrictions as wall drilling. Get written approval from your landlord before installing any anchored freestanding unit, since the renter-friendly marketing claim is often overstated relative to actual lease terms."
  },
  {
    "q": "Why do 4 of the picks in this guide have no ratings?",
    "a": "The Peanu Queen Bed Frame, Peanu Queen Cabinet, and both roomfitters freestanding cabinets are newer listings without an established rating history yet. We include them because they are relevant freestanding options, but we flag them as unverified and recommend checking for recent buyer photos or questions before ordering."
  },
  {
  ...
  },
  {
    ...
    "a": "Most freestanding units still need wall backing contact plus roughly 85-90 inches of open floor clearance when deployed, so true placement flexibility is more limited than marketing language suggests. Measure your intended location before assuming full freedom of placement."
  },
  {
...
export const guideTitle = "The Best Freestanding Murphy Beds for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    ...
    "description": "Checked whether each listing explicitly uses the term freestanding or free standing, since only 4 of 8 picks in this guide's underlying data confirm it, 2 make no mounting claim either way, and 2 are explicitly wall-mounted hardware kits."
  },
  {
    "title": "Anchor requirement disclosure, even on confirmed freestanding picks",
    "description": "Noted that even confirmed freestanding listings rarely specify whether a floor cleat or wall backing anchor is still required, since freestanding means no wall mount bracket, not necessarily no anchor of any kind."
  },
  {
    "title": "Renter lease compliance reality check",
    "description": "Weighed whether a freestanding claim avoids lease restrictions, since floor anchoring can trigger the same lease terms as wall drilling in many rental agreements."
  },
  {
    "title": "Cabinet base weight as a stability proxy",
    "description": "Considered cabinet base weight and construction as a proxy for tipping stability during mid-deployment, since a freestanding unit relies more on its own base weight and footprint than a wall-anchored cabinet does."
  },
  {
    "title": "Rating maturity, especially on new listings",
    "description": "Distinguished established, rated products from 4 new listings with no rating history at all, treating the newer listings as unverified rather than assigning them the same confidence as rated picks."
  }
];
...
export const introParagraphs = [
  ...
  "This guide focuses on that reality: what freestanding actually means, whether floor anchoring avoids lease issues, cabinet base weight as a stability indicator, and the room clearance a freestanding unit still needs. Below are the 8 picks we compared based on product specs and buyer feedback, including 4 newer listings with no rating history yet, which we call out honestly rather than treating them the same as established picks."
];
...
export const metaDescription = "How 8 freestanding murphy beds compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Freestanding Murphy Beds for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Flagging this honestly: the listing does not claim freestanding design at all, and based on standard farmhouse-style murphy bed construction, it most likely requires a conventional wall mount. It appears in this guide's underlying data because it is commonly cross-shopped, but it is not a verified freestanding pick.\n\nIf freestanding design specifically matters to you, confirm directly with the seller rather than assuming this qualifies.",
    "specs": [
  ...
  },
  {
    ...
    "description": "This listing also makes no freestanding claim, so treat it as a standard wall-mounted cabinet bed rather than a verified freestanding option, despite appearing in freestanding-related searches. It includes a charging station and storage drawers in a rattan finish.\n\nIf avoiding wall mounting for lease reasons is your priority, the confirmed freestanding Peanu or roomfitters picks above are a better fit, provided you also confirm their anchor requirements directly.",
    "specs": [
...
export const relatedGuides = [
  {
    "href": "/guide/best-horizontal-murphy-beds-with-desks",
    "title": "Best Horizontal Murphy Beds with Desks (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Freestanding Murphy Beds";
