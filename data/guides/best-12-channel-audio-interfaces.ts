export const guideSlug = "best-12-channel-audio-interfaces";
export const guideTitle = "8 Best 12-Channel Audio Interfaces in 2026";
export const metaTitle = "Best 12-Channel Audio Interfaces";
export const metaDescription = "We compared 12 channel audio interface models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "12 channel audio interface";
export const introParagraphs = [
  "Best 12-Channel Audio Interfaces look similar but differ in practice, so the spec sheet hides real gaps.",
  "Every pick here was judged on honest gain and connection type, because these details matter more than claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-12-channel-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-12-channel-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-12-channel-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-12-channel-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-12-channel-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-12-channel-audio-interfaces-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-12-channel-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-12-channel-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
