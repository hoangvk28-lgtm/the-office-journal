...
export const guideTitle = "The Best Color Laser Engravers for a Better Desk Setup";
...
export const metaDescription = "We compared 6 color laser engravers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Color Laser Engravers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Dig into the spec sheet and LaserPecker LP5 20W Fiber & Diode Dual Laser Engraver holds up. Start engraving during customer wait times, well suited to mall kiosks. 02kg): half the weight of similar engravers.\n\nLds system creates depth-controlled coins/relief art, turn scrap into $50+ jewelry; 80% less test runs with material test array. Not a bad tradeoff for what you're paying.",
    "specs": [
  ...
  },
  {
    ...
    "specs": [
      "Commarker b6 laser engraving machine uses 20w jpt m7 laser source",
      "Commarker b6 20w fiber laser engraving machine with touch screen",
      "Fiber laser marking engraver supports lightburn and ezcad2 (we provide)"
    ],
    "pros": [
      "Commarker b6 laser engraving machine uses 20w jpt m7 laser source",
...
export const breadcrumbLabel = "Best Color Laser Engravers";
