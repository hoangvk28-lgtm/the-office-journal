...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "9 ounces and pocket-sized dimensions, while a fixed installation cares much less about physical size since the unit stays mounted in one place indefinitely. This matters significantly if the injector needs to travel with a technician between multiple job sites in a single day, and matters little for a unit that gets installed once in a remote cabinet or enclosure and never moved again. Weigh the physical portability of a unit against your actual need to carry and reposition it regularly."
  }
];

export const faq = [
  {
    "q": "Can I power a PoE injector from a cordless drill battery?",
    "a": "Yes, but only a purpose-built unit like the Portable Combo pick in this comparison, which is specifically designed to accept common DeWalt and Milwaukee cordless tool batteries; a standard injector cannot use these batteries directly."
  },
  {
    "q": "What's the difference between a portable and a standard PoE injector?",
    "a": "A portable or battery-powered PoE injector is specifically designed to run from a non-standard power source, like a cordless tool battery, solar panel, or vehicle's 12V system, rather than requiring a standard AC wall outlet."
  },
  {
    "q": "Can I use a car battery to power a PoE injector for a dash cam or dome camera setup?",
    "a": "Yes, a DC-input injector designed for a 12-30V range, like the PoE Texas inline converter in this comparison, specifically accommodates a vehicle's 12V electrical system."
  },
  {
    "q": "Is a wider DC input voltage range always better for a portable injector?",
    "a": "It's more flexible, letting you use the same unit across different power sources, but if you have one known fixed voltage source, a narrower-range unit matched exactly to that voltage works just as well at a potentially lower price."
  },
  {
    "q": "How long does a battery-powered PoE injector run on one charge?",
    "a": "This depends entirely on the specific battery used and the connected device's power draw; a purpose-built unit with an auto-shutdown feature extends usable time by powering down when no device is connected."
  },
  {
    "q": "Can I use a solar-compatible PoE injector for a permanent installation without solar power?",
    "a": "Yes, a wide-range DC input injector designed for solar applications works equally well with any compatible DC power source, including a standard battery bank or DC power supply, not just solar panels specifically."
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "DeWalt or Milwaukee cordless tool battery",
          ""
        ],
        [
          "Solar panel or battery bank, permanent install",
          "Gigabit DC PoE+ Injector 12-48V"
        ],
        [
          "Vehicle 12V system or portable battery pack",
          "PoE Texas 12-30V to PoE Inline Converter"
        ],
        [
          "Variable battery/solar, widest voltage range needed",
          "PoE Texas DC-Powered Gigabit PoE+ Injector 12-60V"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Removable tool battery (Portable Combo)",
        "text": "Ideal for a mobile field technician who needs to move between job sites and swap a depleted battery for a charged one instantly."
      },
      {
        "label": "Continuous DC input (the three other picks)",
        "text": "Better suited to a permanent installation with an ongoing power source like a solar panel, vehicle electrical system, or wired battery bank."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "12-30V (standard battery packs, vehicle)",
          "PoE Texas 12-30V to PoE Inline Converter"
        ],
        [
          "12-48V (solar panels, wider range)",
          ""
        ],
        [
          "12-60V (widest range, mixed sources)",
          "PoE Texas DC-Powered Gigabit PoE+ Injector"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A design that reuses power sources you're already carrying for other equipment, rather than requiring a dedicated battery pack you need to separately charge and carry."
      },
      {
        "label": "",
        "text": "The Portable Combo pick specifically works with common DeWalt and Milwaukee cordless drill batteries a field technician likely already carries for other job site tools."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You're a field technician who wants to reuse existing cordless tool batteries and needs both passive and active PoE support in one unit, where the Portable Combo's $155 price reflects that specific convenience."
      },
      {
        "label": "",
        "text": "66 DC-input picks deliver reliable power conversion at a fraction of the cost."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared cordless tool battery compatibility against DC-barrel input designs for solar, vehicle, or battery pack power."
  },
  {
    "title": "",
    "description": "Compared the width of each listing's stated DC input voltage range."
  },
  {
    "title": "",
    "description": "Compared listings naming specific compatible radio, access point, or camera models."
  },
  {
    "title": "",
    "description": "Compared physical size, weight, and whether the unit uses removable batteries or requires a continuous power connection."
  },
  {
    "title": "",
    "description": "Compared auto-shutdown and diode isolation features across listings."
  }
];
...
export const introParagraphs = [
  ...
  "We compared this lineup on real power source flexibility, since one listing specifically runs on common DeWalt or Milwaukee cordless drill batteries, a different design than the DC-barrel-input units the rest of this comparison uses."
];
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CG7H3PMD?tag=theofficejournal-20",
    "description": "This injector's listing specifically states compatibility with common DeWalt and Milwaukee cordless drill batteries (FlexPower, DCB200, M18), letting a field technician power a PoE device using tool batteries they likely already carry rather than a dedicated battery pack.\n\nCompared to the DC-input picks below, this one's tool-battery compatibility is a unique convenience for technicians who already carry DeWalt or Milwaukee batteries for other job site equipment.\n\nBest for field technicians who already carry DeWalt or Milwaukee cordless tool batteries and want to reuse them for PoE testing or temporary power.",
    "specs": [
      "24V/50V passive or 802.3af/at active PoE",
      "DeWalt/Milwaukee cordless battery compatible",
      "Built-in load detector with auto shutdown"
    ],
    "pros": [
      "Reuses cordless tool batteries technicians likely already carry",
      "Combo algorithm supports both passive and standard PoE",
      "Auto shutdown prevents energy waste when idle"
    ],
    "cons": [
      "Highest price in this comparison by a wide margin",
      "Batteries themselves sold separately"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DZGCPPX8?tag=theofficejournal-20",
    "description": "This injector's listing specifically states named compatibility with ePMP2000/3000, Force400/425, Q61, and other point-to-point radio equipment, along with an environmentally hardened -40C to 80C operating range for outdoor solar deployments.\n\nCompared to the DeWalt-compatible pick above, this one accepts a continuous DC power source like a solar panel or battery bank rather than swappable removable batteries, better suited to a permanent remote installation than a technician's mobile toolkit.\n\nBest for buyers powering point-to-point radios or PoE lighting from a solar panel or battery bank in a permanent remote installation.",
    "specs": [
      "12-48VDC input, 30W 802.3af/at output",
      "Named compatibility: EPMP, Force400/425, Q61",
      "-40C to 80C operating range"
    ],
    "pros": [
      "Wide 12-48VDC input accepts variable solar or battery power",
      "Named compatibility with common point-to-point radio brands",
      "Extreme operating temperature range for outdoor deployment"
    ],
    "cons": [
      "Not a swappable battery-powered design like the DeWalt pick",
      "30W ceiling limits it to lower-draw devices"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07NP2KM3R?tag=theofficejournal-20",
    ...
    "specs": [
      "12-30V DC or PoE input, 48V PoE output",
      "Gigabit data, up to 328ft range",
      "Named compatibility: TP-Link EAP-225"
    ],
    "pros": [
      "Lowest price in this comparison",
      "Specifically suited to 12V vehicle power and portable battery packs",
      "Named real-world device compatibility"
    ],
    "cons": [
      "Lower voltage input ceiling than the 12-48V solar pick",
      "Requires your own compatible battery or 12V power source"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CRVQ4GZ1?tag=theofficejournal-20",
    ...
    "specs": [
      "12-60V DC input, 24V 30W passive PoE output",
      "Gigabit data rate",
      "Diode-isolated RJ45 and DC power inputs"
    ],
    "pros": [
      "Widest DC input voltage range in this comparison",
      "Diode isolation protects against power source cross-feeding",
      "One year replacement warranty with phone support"
    ],
    "cons": [
      "Power supply not included, requires your own DC source",
      "24V passive output only, not standard 802.3af/at negotiation"
    ],
