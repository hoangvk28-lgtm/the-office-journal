...
export const faq = [
  {
    "q": "What makes a desk privacy screen portable?",
    "a": "More than just light weight, genuine portability combines low weight, a small fold-flat footprint, and quick setup/teardown time. Some lightweight panels still take several minutes to configure with bases and clips at each new desk."
  },
  {
    "q": "Which portable privacy screen sets up the fastest?",
    "a": "Quick clamp designs (like the VIVO 24x24) and simple 3-fold screens (like the 2-Pack Testing Dividers) set up in seconds with no bases or clips to configure, faster than foldable felt designs requiring reconfiguration."
  },
  {
    "q": "Do portable privacy screens fit in a standard bag?",
    "a": "Check the specific folded dimensions, not just the 'portable' label. Some foldable panels pack down small, while others remain fairly large even folded, verify against your actual bag or storage space."
  },
  {
    "q": "Is a foldable panel or a clamp-on panel better for moving between desks?",
    "a": "A clamp-on panel sets up faster (seconds vs. Minutes) but requires verifying desk edge compatibility at each new desk. A foldable panel takes longer to configure but doesn't depend on the desk's specific edge thickness."
  }
];

export const guideSlug = "best-portable-desk-privacy-screens";

export const guideTitle = "The Best Portable Desk Privacy Screens for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "Genuine portability: weight, folded size, and setup time together",
    "description": "Evaluated portability as the combination of low weight, small fold-flat footprint, and quick setup/teardown time, not just weight alone, since some lightweight panels still take several minutes to configure at each new desk."
  },
  {
    "title": "Setup time as a real differentiator between designs",
    "description": "Distinguished quick clamp or freestanding designs that set up in seconds from foldable designs requiring bases and clips, since setup time matters more for someone who relocates frequently than for a fixed installation."
  },
  {
    "title": "",
    "description": "Weighed how much desk coverage each pick provides against how easily it packs down for transport, since larger coverage generally means a bulkier item to carry."
  }
];
...
export const metaDescription = "A practical comparison of 5 portable desk privacy screens, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Portable Desk Privacy Screens for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Small and light enough to move between desks, the clamp mechanism sets up in seconds without bases or clips to configure each time, a real advantage for someone who relocates the panel regularly.\n\nQuick clamp setup, no bases or clips to configure. On price, it's actually priced above Poola Voidra Foldable Felt Desk Privacy Panel 16 x 48 Inches, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Not foldable, needs a bag or case to transport cleanly.",
    "specs": [
      "24 x 24 inch panel",
      "Quick clamp mount, no configuration needed",
      "Gray finish",
      "Compact for moving between desks"
    ],
    "pros": [
      "Quick clamp setup, no bases or clips to configure",
      "Compact size, easy to carry",
      "Solid, consistent rating base",
      "Holds up to repeated clamping/unclamping"
    ],
    "cons": [
      "Smaller coverage than a full-width panel",
      "Still requires verifying desk edge thickness at each new desk",
      "Not foldable, needs a bag or case to transport cleanly"
    ],
  ...
  },
  {
    ...
    "description": "Folds flat for easy transport in a bag, though setup does take a few minutes to position the included bases and mini crown clips at each new desk, be honest with yourself about whether that setup time fits your actual routine.\n\nOn the other side, Less rigid than a clamp mount at each new desk.",
    "specs": [
      "16 x 48 inches, felt material, folds flat",
      "4 bases, 8 mini crown clips",
      "Acoustic partition",
      "Lightweight for transport"
    ],
    "pros": [
      "Folds flat, easy to transport in a bag",
      "Felt material adds modest sound absorption",
      "Lightweight",
      "Larger coverage than the compact clamp-on pick"
    ],
    "cons": [
      "Setup with bases/clips takes a few minutes each time",
      "Very limited review history",
      "Less rigid than a clamp mount at each new desk"
    ],
  ...
  },
  {
    ...
    "description": "The 3-fold design sets up and tears down in seconds, no bases, clips, or clamp mechanism to fuss with, a real advantage for quick, frequent relocation. Very lightweight and the most affordable pick in this guide.\n\nOn the other side, Basic construction, not built for heavy daily bumping.",
    "specs": [
      "2-pack, 3-fold design",
      "No setup hardware needed",
      "Very lightweight",
      "Very low-cost"
    ],
    "pros": [
      "Fastest setup/teardown of any pick in this guide",
    ...
    "cons": [
      ...
      "Less rigid than a clamp-mounted panel",
      "Basic construction, not built for heavy daily bumping"
    ],
  ...
  },
  {
    ...
    "description": "Marketed as portable with a fold design, larger coverage than the compact clamp-on pick if you need more than a 24-inch panel while still moving between spaces. Strong early rating on a modest review count.\n\nThe real tradeoff against that pick: Modest review count.\n\nOn the other side, Less rigid than a clamp mount.",
    "specs": [
      "47.3 x 15.7 inches, felt board, portable fold",
      "Retro style",
      "Larger coverage than compact picks",
      "Acoustic material"
    ],
    "pros": [
      "Larger coverage while still portable",
      "Strong early rating",
      "Felt material for modest sound absorption",
      "Retro aesthetic"
    ],
    "cons": [
      "Modest review count",
      "Folded size larger than the compact clamp-on or 3-fold picks",
      "Less rigid than a clamp mount"
    ],
  ...
  },
  {
    ...
    "description": "Freestanding with support feet rather than any mount, the easiest style to relocate across multiple desks since there's no clamp or clip hardware to remove and reinstall. Low-cost per panel if you need several.\n\nOn the other side, Freestanding design less stable than a clamp mount.",
    "specs": [
      "6 panels, 24\" x 16\" each, freestanding",
      "Support feet, no mounting hardware",
      "Acoustic material",
      "low-cost per panel"
    ],
    "pros": [
      "Freestanding, no mount hardware to remove when relocating",
      "low-cost for outfitting multiple desks",
      "Acoustic material for modest noise reduction",
      "Support feet for basic stability"
    ],
    "cons": [
      "Lower rating than other picks in this guide",
      "Freestanding design less stable than a clamp mount"
    ],
...
export const breadcrumbLabel = "Best Portable Desk Privacy Screens";
