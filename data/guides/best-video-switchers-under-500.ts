...
export const guideTitle = "The Best Video Switchers Under $500: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 6 video switchers under $500, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Video Switchers Under $500 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Monitor all four HDMI inputs, program, preview, resolution status",
      "Connect and switch between up to four HDMI video sources with 30",
      "Control up to four compatible ptz cameras through visca over ip"
    ],
    "pros": [
      "Monitor all four HDMI inputs, program, preview, resolution status, and audio",
      "Connect and switch between up to four HDMI video sources",
      "Control up to four compatible ptz cameras through visca over ip,"
    ],
    "cons": [
      "Setup or mounting hardware may be sold separately",
...
export const breadcrumbLabel = "Best Video Switchers Under $500";
