...
export const guideTitle = "The Best Quiet Dehumidifiers for a Better Desk Setup";
...
export const metaDescription = "We compared 8 quiet dehumidifiers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Quiet Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Quiet Dehumidifiers";
