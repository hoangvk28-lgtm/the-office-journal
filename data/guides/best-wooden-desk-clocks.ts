...
export const faq = [
  {
    ...
    "a": "Wood-material desk clocks, confirmed real wood rather than a wood-look plastic finish, are a small category in our verified research. We chose accuracy over padding the list."
  },
  {
    "q": "How do I know if a desk clock is really made of wood?",
    "a": "Check the listing for explicit language like real wood or solid wood construction. A wood-look or wood-style description often means a printed plastic or composite finish instead."
  },
  {
    "q": "Is the FOSA flip clock fully made of wood?",
    "a": "No, only its base is wood, the display housing above it is a separate electronic flip mechanism."
  },
  {
    "q": "What if I want more wood clock options?",
    "a": "Our research didn't turn up additional confirmed wood-material desk clocks at this time, check our modern or marble desk clock guides for other genuine material options."
  }
];

export const guideSlug = "best-wooden-desk-clocks";

export const guideTitle = "The Best Wooden Desk Clocks for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "Verified genuine wood material from listing details before including any product",
    "description": "Confirmed real wood construction claims in the product listing rather than assuming a wood-look finish or wood-toned plastic qualifies."
  },
  {
    "title": "Declined to pad the list with wood-look plastic clocks",
    "description": "Kept this guide to only the two confirmed wood-material products in our research pool rather than stretching wood-toned finishes to inflate the count."
  },
  {
    "title": "Distinguished full wood construction from a wood base or accent",
    "description": "Called out clearly which pick is entirely wood-built versus which uses wood only as a base component."
  },
  {
    "title": "Compared movement type and noise level for both picks",
    "description": "Checked silent movement on both clocks, since a wood-material clock is often sat close to a desk where noise matters."
  }
];

export const introParagraphs = [
  "Many desk clocks marketed with a wood-look or walnut-style finish are actually plastic or composite material printed to resemble wood grain, which makes shopping for a wood-material clock harder than it should be. Rather than pad this guide with wood-look products we couldn't verify as real wood, we're covering only the two clocks in our research pool with confirmed wood construction.",
...
export const metaDescription = "How 2 wooden desk clocks compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Wooden Desk Clocks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "This is a wood-built clock, the listing confirms real wood construction rather than a printed wood-look finish, at a compact 4-3/8 inch diameter. The light brown tone shows real wood grain in a way plastic alternatives cannot replicate.\n\nConfirmed real wood material, not a printed finish. On price, it's priced at an unlisted price you'll need to confirm on Amazon, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Verify current review data on the listing. The price wasn't listed at the time of research, so confirm current cost on Amazon before deciding.",
    "specs": [
      "4-3/8 inch diameter",
    ...
    "pros": [
      "Confirmed real wood material, not a printed finish",
      "Silent movement, no ticking distraction",
      "Compact size for tight desks",
      "Genuine wood grain visible in the finish"
    ],
    "cons": [
      "Small face limits visual impact from a distance",
      "Fewer wood-tone options available at this size",
      "Verify current review data on the listing"
    ],
    "bestFor": "Buyers wanting a wood-built, compact, silent analog clock."
  },
  {
    "id": "b0crbjj6w4-wood",
    "rank": 2,
    ...
    "pros": [
      "Confirmed wood base material",
      "Silent movement, no mechanical click",
      "Combines wood material with flip-clock styling",
      "Distinct look from a fully wood clock"
    ],
    "cons": [
      "Wood covers only the base, not the full housing",
      "Higher price than the fully wood pick above",
      "Verify current review data on the listing"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-modern-desk-clocks",
    "title": "Best Modern Desk Clocks (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Wooden Desk Clocks";
