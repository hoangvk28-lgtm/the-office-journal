...
export const introParagraphs = [
  "Best Oscillating Desk Fans carry very different real airflow, which is exactly why a CFM spec rarely tells the story.",
...
export const heroImage = "https://m.media-amazon.com/images/I/41BXfLuNRZL._SL500_.jpg";
...
export const products: GuideProduct[] = [
  {
    id: "best-oscillating-desk-fans-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-oscillating-desk-fans-2",
    rank: 2,
  ...
  {
    id: "best-oscillating-desk-fans-3",
    rank: 3,
    ...
    description: "Fan for Bedroom, Desk Fans, Air Circulator Fan with Remote is a strong alternative worth comparing directly against the top pick. The desktop fan utilizes turbo-boost technology to deliver powerful yet gentle airflow, reaching a maximum speed of 6.2 m/s for an exceptionally strong blowing effect. 100 Adjustable speed levels for diverse needs.\n\nSet next to Holmes 12\" Oscillating Table Fan 3-Speed Adjustable 15° Tilt Quiet, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Many listings only quote the dB rating at the lowest speed, so check the noise level at the speed you'll actually run daily before assuming it stays that quiet.",
  ...
  {
    id: "best-oscillating-desk-fans-4",
    rank: 4,
    ...
    amazonUrl: "https://www.amazon.com/dp/B004TBARBI?tag=theofficejournal-20",
    description: "Comfort Zone Oscillating Table Fan with Adjustable Tilt is a strong alternative worth comparing directly against the top pick. Experience personalized comfort with this oscillating fan's 3-speed controls. Precise control over the direction & coverage of the airflow with this indoor fan.\n\nHolmes 12\" Oscillating Table Fan 3-Speed Adjustable 15° Tilt Quiet covers similar ground, though this small oscillating table fan is designed with a strong focus on safety and durability is what tips the choice one way or the other.\n\nThis makes sense for anyone who want a genuine alternative to the top pick with a different tradeoff worth comparing directly. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    specs: ["Customizable airflow", "Versatile airflow control", "Noise-free performance"],
    pros: ["Customizable airflow", "Versatile airflow control", "Noise-free performance", "Long-lasting durability"],
    cons: ["USB-powered models cap out at lower airflow than AC-plugged fans", "Noise rating usually reflects the lowest speed, not daily use"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-oscillating-desk-fans-5",
    rank: 5,
  ...
  {
    id: "best-oscillating-desk-fans-6",
    rank: 6,
    badge: "Worth a Look",
    name: "BEYOND BREEZE Oscillating Table Fan for Bedroom",
    price: "$26.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/51CErqhzYSL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B089XY332M?tag=theofficejournal-20",
    description: "BEYOND BREEZE Oscillating Table Fan for Bedroom is a strong alternative worth comparing directly against the top pick. This 3 speed adjustable tilt oscillating fan delivers quiet, powerful, personal cooling in a compact modern design. Boasting a motor that is virtually silent, this quiet office fan will not interrupt your studying or office work with a loud hum or any other annoying noises.\n\nHolmes 12\" Oscillating Table Fan 3-Speed Adjustable 15° Tilt Quiet is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nThis makes sense for anyone who want a genuine alternative to the top pick with a different tradeoff worth comparing directly. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    specs: ["3 speed adjustable tilt oscillating fan delivers quiet", "Quiet operation", "A focus on safety and durability"],
    pros: ["3 speed adjustable tilt oscillating fan delivers quiet", "Quiet operation", "A focus on safety and durability", "Quick and easy assembly"],
    cons: ["USB-powered models cap out at lower airflow than AC-plugged fans", "Noise rating usually reflects the lowest speed, not daily use"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-oscillating-desk-fans-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-oscillating-desk-fans-8",
    rank: 8,
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "Holmes 12\" Oscillating Table Fan 3-Speed Adjustable 15° Tilt Quiet is worth checking against its specific oscillation range before assuming any 'wide coverage' label performs the same."
      }
    ]
  },
  {
