...
export const faq = [
  {
    "q": "Do mini PCs under $300 come with RAM included?",
    "a": "Not always, some are barebone listings requiring separate RAM and storage purchase, verify this before comparing prices."
  },
  {
    "q": "Can a mini PC under $300 handle real work?",
    "a": "For lighter tasks like browsing, email, and document editing, yes, but set realistic expectations for demanding multitasking or content creation."
  },
  {
    "q": "What's the difference between barebone and complete mini PC listings?",
    "a": "Barebone listings exclude RAM and storage, requiring separate purchase and self-installation, complete builds are ready to use out of the box."
  },
  {
    "q": "Is 8GB RAM enough for a budget mini PC?",
    "a": "For lighter everyday tasks, yes, but it may feel tight for heavier multitasking, consider more RAM if your workflow demands it."
  }
];

export const guideSlug = "best-mini-pcs-under-300";

export const guideTitle = "The Best Mini PCs Under $300: Our Picks";
...
export const howWeEvaluated = [
  {
    "title": "RAM and storage inclusion checked over processor branding alone",
    "description": "Checked whether 8GB or more RAM is included rather than assuming a low sticker price automatically means an underpowered machine."
  },
  {
    "title": "Realistic performance expectations set for entry-level chips",
    "description": "Set realistic expectations that entry-level chips at this budget suit lighter tasks well, rather than expecting demanding multitasking performance."
  },
  {
    "title": "Barebone versus complete-build listings distinguished clearly",
    "description": "Distinguished barebone listings requiring separate RAM and storage purchase from complete, ready-to-use builds at this price tier."
  },
  {
    "title": "Intel versus AMD driver maturity considered for budget chips",
    "description": "Considered driver maturity differences between entry-level Intel and AMD chips for everyday budget-tier use."
  }
];

export const introParagraphs = [
  "At this price tier, RAM and storage configuration matters more for real-world usability than processor branding, worth checking that 8GB or more RAM is included rather than assuming a low sticker price automatically means an underpowered machine.",
  "Entry-level chips at this budget suit lighter tasks like browsing, email, and document editing well, worth setting realistic expectations rather than expecting demanding multitasking or content creation performance under $300."
];
...
export const metaDescription = "How 5 mini PCs under $300 compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A genuine Ryzen 5 3500U barebone chassis at a very low starting price, appropriate for buyers wanting to add their own RAM and storage to stay well total. Genuine Ryzen 5 processor tier at a very low barebone price. On value, it comes in below GMKtec G3 Pro Mini PC Barebone Intel Core i3-10110U, which is worth weighing if cost is your deciding factor between the two. On the other side, Requires self-installation of RAM and storage components.",
    "specs": [
      "AMD Ryzen 5 3500U, up to 3.7GHz",
      "Barebone, no RAM/storage included",
      "Very low starting price",
      "Genuine Ryzen processor tier"
    ],
    "pros": [
      "Genuine Ryzen 5 processor tier at a very low barebone price",
      "Flexibility to choose your own RAM and storage capacity",
      "Low sticker price leaves budget room for good components",
      "Compact form factor for a small desk"
    ],
    "cons": [
      "Barebone listing excludes RAM and storage, factor in added cost",
      "Verify current reviews as this is a newer listing",
      "Requires self-installation of RAM and storage components"
    ],
  ...
  },
  {
    ...
    "description": "A genuine Intel Core i3-10110U chip at a low starting price, appropriate for buyers wanting Intel's mature driver ecosystem well. On the other side, Verify current reviews as this is a newer listing.",
    "specs": [
      "Intel Core i3-10110U",
      "Very low starting price",
      "Genuine Intel Core i3 tier",
      "Verify RAM/storage inclusion"
    ],
    "pros": [
      "Genuine Intel Core i3 processor tier at a low starting price",
      "Mature Intel driver support for everyday tasks",
      "Low price leaves budget room for good components if barebone",
      "Compact form factor for a small desk"
    ],
    "cons": [
      "Verify whether RAM and storage are included in this specific listing",
  ...
  },
  {
    ...
    "specs": [
      ...
      "8GB RAM included",
      "Complete, ready-to-use build",
      "low-cost price"
    ],
    "pros": [
      "8GB RAM already included, no separate component sourcing needed",
      "Efficient low-power chip for always-on desktop use",
      "Mature Intel driver support for everyday tasks",
      "Complete build stays comfortably under $300"
    ],
    "cons": [
      "Entry-level N95 processor suits only lighter everyday tasks",
      "8GB RAM may feel tight for heavier multitasking",
      "Verify current reviews as this is a newer listing"
    ],
  ...
  },
  {
    ...
    "description": "A genuine Core i3 chip with 8GB RAM and 256GB SSD already included, appropriate for buyers wanting a complete Intel-based build. The real tradeoff against that pick: 10th-gen Intel is an older chip generation. On the other side, Verify current reviews before purchase.",
    "specs": [
      "Intel Core i3-10110U",
      "8GB DDR4 RAM",
      "256GB SSD",
    ...
    "pros": [
      ...
      "8GB RAM and 256GB SSD already included, no assembly required",
      "Reasonable storage headroom for documents and applications",
      "Competitive complete-build price under $300"
    ],
    "cons": [
      "10th-gen Intel is an older chip generation",
      "8GB RAM may feel tight for heavier multitasking",
  ...
  },
  {
    ...
    "description": "Another efficient N95-based complete build, appropriate for buyers comparing similarly priced entry-level options for lighter everyday tasks. On the other side, Not appropriate for demanding multitasking workflows.",
    "specs": [
    ...
    "cons": [
      "Entry-level N95 processor suits only lighter everyday tasks",
      "Verify current reviews and exact RAM/storage configuration",
      "Not appropriate for demanding multitasking workflows"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-barebones-mini-pcs",
    "title": "Best Barebones Mini PCs (2026)"
  }
];

export const breadcrumbLabel = "Best Mini PCs Under $300";
