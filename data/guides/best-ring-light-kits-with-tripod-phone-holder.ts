...
export const introParagraphs = [
  "Across best ring light kits (with tripod & phone holder), range widely in real color accuracy, given that differences show up at your actual distance.",
...
export const products: GuideProduct[] = [
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-2",
    rank: 2,
  ...
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-3",
    rank: 3,
  ...
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-5",
    rank: 5,
  ...
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-6",
    rank: 6,
    ...
    description: "NEEWER 55W 18\"/45cm Ring Light Kit is the premium option here, positioned above the rest on price. Features 240 quality leds for professional lighting with wide coverage and an impressive brightness of 5500 lux at 0.5m. This big circle ring light includes orange and white filters to enable two color temperatures of 3200k & 5600k, contributing to different photography and video recording tones for optimal results.\n\nUBeesize 12\" LED Ring Light with 62\" Tripod Stand is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nThis one is the right call if you are willing to spend the most in this comparison for the fuller feature set that comes with it. A larger diameter doesn't automatically mean brighter or more even light, a well-engineered smaller ring can outperform a cheap oversized one, so check independent lux measurements when they're available.",
  ...
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-7",
    rank: 7,
  ...
  {
    id: "best-ring-light-kits-with-tripod-phone-holder-8",
    rank: 8,
    badge: "Also Worth Considering",
    ...
    specs: ["Adjustable lighting", "Crafted from top-quality aluminum alloy and metal", "Stable & easy installation"],
    pros: ["Adjustable lighting", "Crafted from top-quality aluminum alloy and metal", "Stable & easy installation", "2*Phone holder & wireless remote"],
    cons: ["Larger diameter alone doesn't guarantee brighter, more even light", "Listed lux ratings are often inflated 2 to 3x by the brand"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
