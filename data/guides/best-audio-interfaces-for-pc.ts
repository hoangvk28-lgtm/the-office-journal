...
export const introParagraphs = [
  "Best Audio Interfaces for PC differ more than titles suggest, so price alone misses what matters.",
  "Every pick here was judged on true latency and bit-depth support, because these details matter more than claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-audio-interfaces-for-pc-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-audio-interfaces-for-pc-2",
    rank: 2,
  ...
  {
    id: "best-audio-interfaces-for-pc-3",
    rank: 3,
  ...
  {
    id: "best-audio-interfaces-for-pc-4",
    rank: 4,
  ...
  {
    id: "best-audio-interfaces-for-pc-5",
    rank: 5,
  ...
  {
    id: "best-audio-interfaces-for-pc-6",
    rank: 6,
  ...
  {
    id: "best-audio-interfaces-for-pc-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-audio-interfaces-for-pc-8",
    rank: 8,
    badge: "Also Worth Considering",
