...
export const guideTitle = "The Best 240Hz IPS 4K Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "5 Inch 240Hz Gaming Monitor)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5 Inch 240Hz Gaming Monitor already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "A practical comparison of 6 240Hz IPS 4K monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 240Hz IPS 4K Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 240Hz IPS 4K Monitors";
