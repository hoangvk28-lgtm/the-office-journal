...
export const faq = [
  {
    ...
    "a": "Smart managed switches offer a subset of fully managed features through a simplified web GUI, generally sufficient for small business networks. Fully managed Layer 2/3 switches add deeper protocol support and routing capability most small networks never need."
  }
];

export const guideSlug = "best-smart-network-switches";

export const guideTitle = "The Best Smart Network Switches for a Better Desk Setup";
...
export const metaDescription = "We compared 8 smart network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Smart Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07PJ7XZ7X?tag=theofficejournal-20",
  ...
  },
  {
    ...
    "specs": [
      "24 ports, 9K jumbo frames",
      "Port mirroring + cable diagnostics",
      "3-year warranty"
    ],
    "pros": [
      "Jumbo frame support aids large-scale NAS transfers",
      "Diagnostics tools scale well to 24-port networks",
      "Consistent 3-year TP-Link warranty"
    ],
    "cons": [
      "No PoE on this model",
      "Easy Smart software required to unlock VLANs"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D954PJBM?tag=theofficejournal-20",
    ...
    "specs": [
      "24 ports + 2 SFP, smart managed",
      "1 year NETGEAR Insight included",
      "Fanless, SNMP support"
    ],
    "pros": [
      "Included year of remote cloud management",
      "SFP expansion ports for fiber uplinks",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-layer-2-network-switches",
    "title": "6 Best Layer 2 Network Switches in 2026"
  },
  {
    "href": "/guide/best-8-port-managed-network-switches",
    "title": "8 Best 8-Port Managed Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best Smart Network Switches";
