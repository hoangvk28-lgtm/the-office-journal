...
export const introParagraphs = [
  ...
  "Acer's monitor lineup, spanning budget and gaming-adjacent models, is predominantly 16:9 across 21.5, 23.8, and 24 inch sizes. We matched picks to these common sizes and flagged where a specific model's dimensions need direct verification.",
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "A strong review base at 21.5 inch, a common size for Acer's entry-level budget monitors.\n\nOne spot below Peslv [2-Pack] 24 Inch Privacy Screen for Computer Monitor in this ranking, it's priced lower than Peslv [2-Pack] 24 Inch Privacy Screen for Computer Monitor. The compromise here is straightforward: Does not specifically name Acer. What you gain in return: Strong review base at a common Acer entry-level monitor size. Whether that trade is worth it depends on which side matters more for your setup.\n\nWorth knowing before you decide: Strong review base at a common Acer entry-level monitor size. On the other side, Does not specifically name Acer. That's the main tradeoff to weigh against everything above.",
    specs: ["21.5 inch, 16:9 aspect ratio","Single unit"],
    pros: ["Strong review base at a common Acer entry-level monitor size"],
    cons: ["Does not specifically name Acer"],
    bestFor: "Buyers with a 21.5 inch entry-level Acer monitor.",
  },
  {
    ...
    description: "Acer's 23.8 inch monitors are common in mid-range home-office configurations, and this filter is specifically sized for that exact dimension rather than rounded to 24 inch.\n\nSitting just under SightPro 21.5 Inch 16:9 Computer Privacy Screen Filter for Monitor, it costs more than SightPro 21.5 Inch 16:9 Computer Privacy Screen Filter for Monitor. Here's the honest tradeoff: Does not specifically name Acer. And here's what it gets you instead: Specifically sized for 23.8 inch, not rounded to 24 inch. That's the real difference between the two picks, not just a ranking number.\n\nWorth knowing before you decide: Specifically sized for 23.8 inch, not rounded to 24 inch. On the other side, Does not specifically name Acer. That's the main tradeoff to weigh against everything above.",
    specs: ["23.8 inch, 16:9 aspect ratio","Single unit"],
    pros: ["Specifically sized for 23.8 inch, not rounded to 24 inch"],
    cons: ["Does not specifically name Acer"],
    bestFor: "Buyers with a 23.8 inch Acer monitor, a size distinct from standard 24 inch.",
  },
  {
    ...
    cons: ["Does not specifically name Acer"],
    bestFor: "Buyers with a 23.8 inch Acer monitor who also want blue-light reduction.",
  },
  {
...
export const howWeEvaluated: HowWeEvaluatedItem[] = [
  { title: "Verified Acer does not manufacture privacy filters", description: "We confirmed all results here are third-party filters and did not imply Acer branding or certification unless the listing explicitly and specifically claimed it." },
  { title: "Matched picks to Acer's common monitor sizes and aspect ratios", description: "We organized picks around Acer's most common 21.5, 22, 23.8, and 24 inch monitor sizes, including the 16:10 aspect ratio used on some older or compact models." },
  { title: "Flagged the 23.8 versus standard 24 inch distinction", description: "Acer sells both sizes, and we included filters specifically sized for each rather than rounding one to the other." },
...
export const faq: FaqItem[] = [
  { q: "Does Acer make its own monitor privacy screens?", a: "No, we found no Acer-branded privacy filter. Every product in this category is a third-party filter sized to fit common Acer monitor dimensions." },
  { q: "Are all Acer monitors 16:9?", a: "No. Most current Acer monitors are 16:9, but some older or compact models use a 16:10 aspect ratio. Check your exact model before ordering." },
  { q: "Is 23.8 inch the same as 24 inch on Acer monitors?", a: "No, they're close but different sizes. Use a filter specifically sized for 23.8 inch if that's your exact Acer model." },
  { q: "What's the best option for a 21.5 inch Acer monitor?", a: "The SightPro 21.5 Inch 16:9 Computer Privacy Screen Filter, common on Acer's entry-level budget monitors." },
  { q: "How do I know my Acer monitor's exact dimensions?", a: "Check the model number on the rear label or Acer's support site and look up the active display width and height directly." },
];
