...
export const guideTitle = "The Best ShopBot Desktop CNC Machines for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 1 ShopBot desktop CNC machines, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best ShopBot Desktop CNC Machines for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0H55LCQ6M?tag=theofficejournal-20",
    ...
    "specs": [
      "Dual-drive Y-axis eliminates gantry flex",
      "T-slot or vacuum deck configurations",
      "VCarve Pro included, Aspire upgrade path"
    ],
    "pros": [
      "Dual-drive Y-axis specifically prevents gantry flex on hard cuts",
      "Runs on a standard 120VAC wall outlet, no special power",
      "Lifetime phone support and documentation included"
    ],
    "cons": [
      "Higher price reflects the shop-grade construction",
      "Vacuum deck option requires the separate Fein Turbo II kit"
    ],
...
export const breadcrumbLabel = "Best ShopBot Desktop CNC Machines";
