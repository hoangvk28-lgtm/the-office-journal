...
export const guideTitle = "The Best Inkjet Label Printers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "5-Inch Print Height with Fast Dry Ink (Black)"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "5-Inch Print Height with Fast Dry Ink (Black))",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "5-Inch Print Height with Fast Dry Ink (Black) justifies the extra cost."
      },
      {
        "label": "",
        "text": "5-Inch Print Height with Fast Dry Ink (Black) already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "A practical comparison of 6 inkjet label printers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Inkjet Label Printers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Inkjet Label Printers";
