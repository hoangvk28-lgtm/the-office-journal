...
export const guideTitle = "The Best Microphone Arms for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 microphone arms, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Microphone Arms for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Microphone Arms";
