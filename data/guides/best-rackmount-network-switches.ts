...
export const guideTitle = "The Best Rackmount Network Switches for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "7-inch dimensions as a standard 1U fit. Several other switches in this list work in a rack but weren't purpose-designed for one; check exact dimensions against your rack's available depth before ordering."
  }
];
...
export const metaDescription = "We compared 8 rackmount network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Rackmount Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B006KAP4EG?tag=theofficejournal-20",
    ...
    "specs": [
      "16 Gigabit ports, 10K jumbo frames",
      "32Gbps switching capacity",
      "6KV lightning protection"
    ],
    "pros": [
      "10K jumbo frame support aids large file transfers",
      "6KV protection across all ports, not just select ones",
      "Full-steel housing for improved heat dissipation"
    ],
    "cons": [
      "Tenda has a smaller US support footprint than TP-Link/NETGEAR",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B004UBUJZG?tag=theofficejournal-20",
    "description": "The TL-SG1048 packs 48 Gigabit ports into a rackmount unmanaged switch with a 96Gbps non-blocking switching capacity and an 8K MAC address table, scalability that matters for large networks rather than desk-scale deployments.\n\nIt stays fanless despite the port count, and TP-Link backs it with the same 3-year warranty as its smaller SG-series switches.",
    "specs": [
      "48 Gigabit ports, rackmount",
      "96Gbps non-blocking, 8K MAC table",
      "Fanless, 3-year warranty"
    ],
    "pros": [
      "Fanless at 48 ports is a real engineering feat",
      "8K MAC table scales to large networks",
      "Non-blocking architecture avoids throughput bottlenecks"
    ],
    "cons": [
      "No management features despite the scale",
      "Rackmount-only, not desk-friendly"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0G4CKXNTQ?tag=theofficejournal-20",
    ...
    "specs": [
      "24 Gigabit ports, rackmount",
      "4 switchable working modes",
      "6KV surge protection, fanless"
    ],
    "pros": [
      "Link aggregation up to 2Gbps without software",
      "4 switchable modes cover diverse deployment needs",
      "6KV surge protection"
    ],
    "cons": [
      "Newer brand with less US track record than TP-Link/NETGEAR",
      "No true VLAN tagging, just port isolation"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0G4CLYSYQ?tag=theofficejournal-20",
    ...
    "specs": [
      "16 Gigabit ports, rackmount",
      "4 switchable working modes",
      "6KV surge protection, fanless"
    ],
    "pros": [
      "Same feature set as UGREEN's 24-port model in a smaller unit",
      "Link aggregation and port isolation without software",
      "Fanless with real cooling engineering"
    ],
    "cons": [
...
export const relatedGuides = [
  {
    "href": "/guide/best-network-switches-for-10-inch-racks",
    "title": "7 Best Network Switches for 10-Inch Racks"
  },
  {
  ...
  {
    "href": "/guide/best-24-port-network-switches",
    "title": "6 Best 24-Port Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best Rackmount Network Switches";
