...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DD3H377C?tag=theofficejournal-20",
    "description": "7-inch fans handling the added thermal load of six simultaneously-running drives, and a daisy-chain port that scales to a stated 360TB across 3 chained units.\n\nHot-swap and tool-free installation carry over from CENMATE's smaller enclosures, and the company again discloses fan noise in the 40-50 decibel range, worth planning for in a quiet office.",
    "specs": [
      "6-bay, up to 120TB total",
      "Daisy-chain up to 360TB combined",
      "USB A/C 3.0, 5Gbps"
    ],
    "pros": [
      "Daisy-chain scales to a stated 360TB across 3 units",
      "Dual 2.7in fans for 6-bay thermal load",
      "Hot-swap without powering down the enclosure"
    ],
    "cons": [
      "5Gbps USB 3.0 ceiling, not the newer 10Gbps tier",
      "No RAID, individual disks only"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GJ3DD7XJ?tag=theofficejournal-20",
    "description": "7-inch fan cooling as the 5Gbps version.\n\n2 plus Thunderbolt 3/4 host compatibility, and it keeps the same daisy-chain expansion (up to 120TB combined across 3 devices) and hot-swap tray design.",
    "specs": [
      "6-bay, up to 10Gbps",
    ...
    "pros": [
      "Real 10Gbps upgrade over CENMATE's 5Gbps 6-bay model",
      "Broad host compatibility including Thunderbolt 3/4",
      "Dual fans manage heat across 6 active bays"
    ],
    "cons": [
...
export const relatedGuides = [
  {
    "href": "/guide/best-5-bay-direct-attached-storage",
    "title": "6 Best 5-Bay Direct-Attached Storage"
  },
  {
  ...
  {
    "href": "/guide/best-6-drive-das-storage",
    "title": "6 Best 6-Drive DAS Storage Options"
  }
];
