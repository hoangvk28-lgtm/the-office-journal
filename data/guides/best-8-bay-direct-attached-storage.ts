...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FC6BW78H?tag=theofficejournal-20",
    "description": "9-inch fans and a DC 12V/20A power adapter sized for the higher combined draw of 8 simultaneously-spinning drives.\n\nCENMATE includes a specific troubleshooting note for this model: if one of the 8 drives is faulty, load and power on drives one at a time to isolate which bay has the problem, since a single failure can otherwise hide among 7 working drives. Daisy-chaining scales to a stated 480TB across 3 units.",
    "specs": [
      "8-bay, up to 160TB total",
      "DC 12V/20A power, daisy-chain to 480TB",
      "USB A/C 3.0, 5Gbps under UASP"
    ],
    "pros": [
      "Highest single-enclosure capacity in the CENMATE line at 160TB",
      "Documented one-at-a-time troubleshooting workflow for isolating a bad drive",
      "20A power adapter sized correctly for 8-drive simultaneous load"
    ],
    "cons": [
      "5Gbps ceiling is a real bottleneck across 8 active drives",
  ...
  },
  {
    ...
    "reviews": null,
    "imageUrl": "https://m.media-amazon.com/images/I/41my4UJmQ3L._SL500_.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0GRTBGCCR?tag=theofficejournal-20",
    "description": "9-inch fans, and 20A power adapter as the 5Gbps version.\n\nThe same single-drive-isolation troubleshooting method applies here for locating a faulty drive among 8, and the daisy-chain feature scales to the same stated 480TB across 3 chained units, with Thunderbolt 3/4 host compatibility via the USB Type-C interface.",
    "specs": [
      "8-bay, up to 10Gbps, 160TB total",
      "USB 3.2 Gen 2, Thunderbolt 3/4 compatible",
      "Daisy-chain to 480TB combined"
    ],
    "pros": [
      "10Gbps is a real upgrade over CENMATE's 5Gbps 8-bay sibling",
      "Thunderbolt 3/4 compatibility broadens host support",
      "20A power adapter properly sized for 8-drive load"
    ],
    "cons": [
      "Fan noise around 40-50 decibels per CENMATE's disclosure",
      "No RAID, individual disks only"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FHSPQGK8?tag=theofficejournal-20",
    "description": "5-inch SATA drives up to 24TB each with removable trays and independent per-drive power buttons.\n\nIt explicitly does not support RAID or NAS functionality, individual disks only, but a smart fan with a built-in thermal sensor runs across 3 auto/manual speed levels to keep 8 simultaneously-active drives cool.",
    "specs": [
      "8-bay, up to 40Gbps USB4",
      "Thunderbolt 3/4/5 compatible",
      "Removable trays, per-drive power buttons"
    ],
    "pros": [
      "40Gbps USB4 is the fastest link speed in this 8-bay comparison set",
      "Thunderbolt 3/4/5 compatibility future-proofs the host connection",
      "Removable trays simplify drive organization"
    ],
    "cons": [
      "No RAID or NAS function despite the high-speed link",
      "24TB per-drive cap limits total capacity versus some rivals"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-12-bay-direct-attached-storage",
    "title": "5 Best 12-Bay Direct-Attached Storage"
  },
  {
