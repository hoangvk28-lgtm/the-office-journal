...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "K-12 classroom",
          "Durability, simple login, EDLA",
          "EDLA-certified NEWORK NewBoard series"
        ],
        [
          "Higher ed lecture hall",
          "Larger size, BYOD support",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-interactive-whiteboards-for-classroom","title":"8 Best Interactive Whiteboards for Classroom"},{"href":"/guide/best-interactive-whiteboards-for-kindergarten","title":"7 Best Interactive Whiteboards for Kindergarten"},{"href":"/guide/best-interactive-whiteboards-for-school","title":"8 Best Interactive Whiteboards for School"}];
