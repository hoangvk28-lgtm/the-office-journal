...
export const guideTitle = "The Best Space Heaters for Office: Our Picks";
...
export const metaDescription = "How 6 space heaters for office compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Space Heaters for Office (2026)";
...
export const breadcrumbLabel = "Best Space Heaters for Office";
