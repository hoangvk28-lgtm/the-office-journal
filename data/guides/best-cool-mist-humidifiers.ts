...
export const guideTitle = "The Best Cool Mist Humidifiers for Everyday Desk Work";
...
export const metaDescription = "How 8 cool mist humidifiers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cool Mist Humidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Cool Mist Humidifiers";
