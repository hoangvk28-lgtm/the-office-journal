...
export const guideTitle = "The Best Frigidaire Dehumidifiers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You're covering a large or wet space and want a built-in pump and higher capacity, where Waykar 34 Pints 2000 Sq. 2025 Energy Star Dehumidifier for Home justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 8 frigidaire dehumidifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Frigidaire Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Frigidaire Dehumidifiers";
