...
export const guideTitle = "The Best GE Dehumidifiers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 GE dehumidifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best GE Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best GE Dehumidifiers";
