...
export const guideTitle = "The Best Production Video Switchers for a Better Desk Setup";
...
export const metaDescription = "We compared 8 production video switchers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Production Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Production Video Switchers";
