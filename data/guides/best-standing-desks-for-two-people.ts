...
export const faq = [
  ...
  },
  {
    ...
    "a": "A dual monitor stand, like the one on the VIVO converter in this guide, supports two screens for one person's setup, not two separate users. It is a common point of confusion in search results but a different feature entirely from genuine two-person desk design."
  },
  {
...
export const guideTitle = "The Best Standing Desks for Two People: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to HUANUO 32 unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const introParagraphs = [
  ...
  "If you and a partner are setting up side by side, the details that matter most are per-person surface width, independent versus shared height presets when you differ in height, and whether the desk has enough cable management capacity for two full workstations instead of one. Below we rank 8 options with an honest read on which ones suit two people and which ones are single desks that happen to be wide enough to consider."
];
...
export const metaDescription = "A practical comparison of 8 standing desks for two people, focused on size, height range, stability and features, and the trade-offs between them.";

export const metaTitle = "Best Standing Desks for Two People (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "This converter's dual monitor stand supports two displays for one person, not two separate users, and it is worth clarifying that distinction since dual monitor and two-person are easy to conflate in a search. It sits on top of an existing desk rather than being a standalone two-person surface.\n\nAt 42 inches wide with a single riser platform, it has no independent space for a second person's keyboard and mouse. This is a useful single-user upgrade for someone who wants two screens, not a shared-desk solution.",
    "specs": [
  ...
  },
  {
    ...
    "description": "This 24x48 inch desk is another single-user design that surfaces in two-person searches due to its width, but at 48 inches it offers the same tight per-person split as the similarly sized ErGear and FEZIBO picks above. The rustic brown finish gives it a warmer look than plain black or white options.\n\nWith one shared preset set and no doubled cable channel, it is best treated as a solid single-user desk at a reasonable price rather than a two-person recommendation. Two people would each get about 24 inches, workable only for the lightest of setups.\n\nReasonable price for the size.",
    "specs": [
  ...
  },
  {
    ...
    "description": "6 inches deep, this is the widest and deepest single-user desk in this guide, which puts it closest to workable two-person dimensions among the non-purpose-built options. It is still marketed as a single-user desk, not a shared design, and includes only one set of height presets.\n\n6-inch depth, better than the other single-user picks here for fitting two keyboards and monitors. It remains a compromise compared to the purpose-built HSH desk, but the extra depth helps.",
    "specs": [
...
export const breadcrumbLabel = "Best Standing Desks for Two People";
