...
export const introParagraphs = [
  "Across best frigidaire dehumidifiers, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is verified capacity, not marketing claims, since this predicts real moisture removal."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-frigidaire-dehumidifiers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-frigidaire-dehumidifiers-2",
    rank: 2,
    ...
    description: "Frigidaire 22-Pint Portable Dehumidifier with Wi-Fi and Energy Star is a strong alternative worth comparing directly against the top pick. Effortlessly control your dehumidifier from anywhere with the frigidaire app or connect it to your amazon alexa or google home devices for smart, hands-free humidity management. This energy star-certified dehumidifier uses less energy to deliver powerful humidity control, helping you reduce energy usage and lower your utility bills.\n\nChoose between two hassle-free water drainage methods, use the easy-carry water bucket for quick manual removal or the continuous drain option to skip emptying the bucket, which is the main thing that distinguishes this pick from Frigidaire 50 Pint Dehumidifier w/Wifi.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Coverage figures assume ideal AHAM test conditions, not always your actual room's humidity and airflow, so treat the pint rating as a starting point.",
  ...
  {
    id: "best-frigidaire-dehumidifiers-5",
    rank: 5,
  ...
  {
    id: "best-frigidaire-dehumidifiers-6",
    rank: 6,
    badge: "Best Value",
  ...
  {
    id: "best-frigidaire-dehumidifiers-7",
    rank: 7,
    ...
    description: "4500 Sq. Ft Dehumidifier for Basement Quilt Compressor Dehumidifiers for Home is a strong alternative worth comparing directly against the top pick. Massive capacity + wide coverage. At just 40 dB, quieter than a library, this unit lets you work, rest, or sleep without distraction.\n\nWeighing this against Frigidaire 50 Pint Dehumidifier w/Wifi, dehumidifier built-in intelligence monitors coil frosting and system stress in real time ends up being the detail that matters most for most buyers.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The tank needs regular emptying unless you're running a continuous drain hose or pump, so factor that into daily upkeep before buying.",
  ...
  {
    id: "best-frigidaire-dehumidifiers-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You're covering a large or genuinely wet space and want a built-in pump and higher capacity, where Waykar 34 Pints 2000 Sq. Ft. 2025 Energy Star Dehumidifier for Home justifies the extra cost."
      },
      {
        "label": "Save if",
