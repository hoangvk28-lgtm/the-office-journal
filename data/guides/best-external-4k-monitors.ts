...
export const guideTitle = "The Best External 4K Monitors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "6\" 4K UHD Portable External Monitor"
        ],
        [
          "",
          ""
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "6\" 4K UHD IPS HDR USB-C HDMI Monitor)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "6\" 4K UHD IPS HDR USB-C HDMI Monitor already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "We compared 6 external 4K monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best External 4K Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "1200 Nits true brightness: this 4K portable monitor is designed specifically for high light environments",
      "4K-145%srgb true color immersion: the 4K uhd (3840x2400) ultra-high",
    ...
    "pros": [
      ...
      "4K-145%srgb true color immersion: the 4K uhd (3840x2400) ultra-high",
      "Recyclable aluminum material",
      "2000:1 High contrast ratio: white is 2000 times brighter than the darkest black"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
...
export const breadcrumbLabel = "Best External 4K Monitors";
