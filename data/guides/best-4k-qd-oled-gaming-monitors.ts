...
export const guideTitle = "The Best 4K QD-OLED Gaming Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "ASUS ROG PG32UCDM 32 Inch 4K 240Hz OLED Gaming Monitor QD-OLED)",
...
export const metaDescription = "A practical comparison of 6 4K QD-OLED gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4K QD-OLED Gaming Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 4K QD-OLED Gaming Monitors";
