...
const queries = [
  "budget studio monitor speakers pair",
  "5 inch studio monitor speakers",
  "professional studio monitor speakers",
  "powered studio monitor speakers desktop",
  "premium studio monitor speakers reference",
];
const pool = {};
...
writeFileSync(resolve(ROOT, "/tmp/studiomon_pool.json"), JSON.stringify(pool, null, 2));
