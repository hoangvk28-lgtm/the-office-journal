...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-walking-pads-for-standing-desks";
...
export default async function BestWalkingPadsForStandingDesksPage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-walking-pads-for-standing-desks` },
    about: [
        {
          "@type": "Thing",
          "name": "Walking Pad"
        ...
        {
          "@type": "Thing",
          "name": "Standing Desk Accessories"
        }
      ],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Walking Pads for Standing Desks", item: `${SITE_URL}/guide/best-walking-pads-for-standing-desks` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-walking-pads-for-standing-desks#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Walking Pads for Standing Desks</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Walking Pads for Standing Desks" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A walking pad under a standing desk lets you accumulate steps and burn calories during the work day without dedicated gym time. At 1.5 mph you can type accurately and join video calls while covering 3 to 5 miles over a full work day.</p>
          <p>This guide covers eight walking pads for standing desks ranked by motor power, incline capability, noise level, and weight capacity, covering budget options under $150 and premium 2-in-1 models up to $400.</p>
          <p>For compact options suited to small apartments and tight desk spaces, see our <a href='/guide/best-compact-walking-pads-for-small-spaces' className='text-brand hover:underline'>best compact walking pads for small spaces</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=walking+pad+for+standing+desk&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
