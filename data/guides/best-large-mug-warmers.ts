...
export const guideTitle = "The Best Large Mug Warmers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 large mug warmers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Large Mug Warmers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Large Mug Warmers";
