...
export const guideTitle = "8 Best Power Banks Under $100 in 2026";
export const metaTitle = "Best Power Banks Under $100";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "Portable Charger Power Bank 40800mAh with 3 Built-in Cables, 25W Fast Phone is a strong alternative worth comparing directly against the top pick. A massive 40,800mAh capacity with over 2,000 charge cycles and cables tested for 30,000+ bends, this portable charger provides multiple full charges for your devices and is built to last for years of reliable service. 150*68*30Mm (5.90*2.67*1.18in), weight about 410g/14.5oz<1lb.\n\nSide by side with OHOVIV Portable Charger Power Bank 50000mAh, PD 22.5W Battery Pack, the real difference worth noting is no more choosing which device to charge first.\n\nThis makes sense for anyone who want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The mAh figure on the box is measured at the battery's internal voltage, not the 5V your phone actually charges at, so the real usable charge is meaningfully lower than the advertised number suggests.",
    specs: ["Massive 40,800mAh capacity with over 2,000 charge cycles and cables tested for 30,000+ bends", "Warm tip", "25W power bank super fast charging"],
    pros: ["Massive 40,800mAh capacity with over 2,000 charge cycles and cables tested for 30,000+ bends", "Warm tip", "25W power bank super fast charging", "Charge 5 devices simultaneously"],
  ...
  },
  {
    ...
    specs: ["Huge capacity 60000mAh power bank: zzi portable charger", "22.5W super fast charging & battery protection: the battery", "Massive 60,000mAh capacity, zzi battery bank provides long-lasting power without feeling bulky"],
    pros: ["Huge capacity 60000mAh power bank: zzi portable charger", "22.5W super fast charging & battery protection: the battery", "Massive 60,000mAh capacity, zzi battery bank provides long-lasting power without feeling bulky", "Reliable 5-layer safety protection"],
    cons: ["Capacity above 100Wh needs airline approval or can't fly at all", "Real-world output is usually lower than the advertised mAh figure"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    specs: ["Widely compatibility power bank with built-in cables", "All in one portable charger", "35,000mAh huge capacity with remarkable compact design: must the high-capacity charger be big"],
    pros: ["Widely compatibility power bank with built-in cables", "All in one portable charger", "35,000mAh huge capacity with remarkable compact design: must the high-capacity charger be big", "3X faster 22.5w pd fast charging output: the n6 portable battery supports 22.5w pd fast charging"],
    cons: ["Real-world output is usually lower than the advertised mAh figure", "Capacity above 100Wh needs airline approval or can't fly at all"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
  ...
  },
  {
    ...
    description: "DIAMUAR Portable Charger 30000mAh is a strong alternative worth comparing directly against the top pick. 4.0 Fast charging + triple ports:our portable charger delivers 30w power delivery fast charging, capable of 100% charging for iphone 16 in just 60 minutes. This portable battery pack features a clear digital display for real-time power monitoring.\n\nSet next to OHOVIV Portable Charger Power Bank 50000mAh, PD 22.5W Battery Pack, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nThis makes sense for anyone who want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The mAh figure on the box is measured at the battery's internal voltage, not the 5V your phone actually charges at, so the real usable charge is meaningfully lower than the advertised number suggests.",
    specs: ["4.0 Fast charging + triple ports:our portable charger delivers 30w power delivery fast charging", "Portable battery pack features a clear digital display for real-time power monitoring", "30000mAh & 5+ phone charges:packed with 30000mAh high-capacity battery"],
    pros: ["4.0 Fast charging + triple ports:our portable charger delivers 30w power delivery fast charging", "Portable battery pack features a clear digital display for real-time power monitoring", "30000mAh & 5+ phone charges:packed with 30000mAh high-capacity battery", "Upgraded portable battery pack is crafted with premium top-grade materials"],
    cons: ["Real-world output is usually lower than the advertised mAh figure", "Capacity above 100Wh needs airline approval or can't fly at all"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Lower capacity (e.g. 45W Fast Charging Portable Charger)",
