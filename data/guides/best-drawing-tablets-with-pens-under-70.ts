export const guideSlug = "best-drawing-tablets-with-pens-under-70";
export const guideTitle = "8 Best Drawing Tablets With Pens Under $70 in 2026";
export const metaTitle = "Best Drawing Tablets With Pens Under $70 in 2026";
export const metaDescription = "We compared best drawing tablets with pens under $70 by verified current price and real capability, not just the price ceiling alone.";
export const mainKeyword = "drawing tablets with pens under $70";
export const introParagraphs = [
  "Best Drawing Tablets With Pens Under $70 listings span a wide range of real capability even within the same price ceiling, and comparing them on price alone misses which picks actually meet the core use case.",
...
export const products: GuideProduct[] = [
  {
    id: "best-drawing-tablets-with-pens-under-70-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-drawing-tablets-with-pens-under-70-2",
    rank: 2,
  ...
  {
    id: "best-drawing-tablets-with-pens-under-70-3",
    rank: 3,
  ...
  {
    id: "best-drawing-tablets-with-pens-under-70-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-drawing-tablets-with-pens-under-70-5",
    rank: 5,
  ...
  {
    id: "best-drawing-tablets-with-pens-under-70-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-drawing-tablets-with-pens-under-70-7",
    rank: 7,
  ...
  {
    id: "best-drawing-tablets-with-pens-under-70-8",
    rank: 8,
...
export const howWeEvaluated = [
  ...
  },
  {
    ...
    "description": "show the next-lower tier, the screenless + Bluetooth crossover / included-pen focus tier and the next-higher tier so this article has a distinct reason to exist."
  },
  {
...
export const faq = [
  {
    "q": "What should I check before buying from this best drawing tablets with pens under $70 comparison?",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-drawing-tablets-under-60","title":"Best Drawing Tablets Under $60"},{"href":"/guide/best-drawing-tablets-under-70","title":"Best Drawing Tablets Under $70"},{"href":"/guide/best-drawing-tablets-with-screens-under-70","title":"Best Drawing Tablets With Screens Under $70"}];
