...
export const guideTitle = "The Best PlayStation VR Headsets for Everyday Desk Work";
...
export const metaDescription = "How 6 PlayStation VR headsets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best PlayStation VR Headsets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Ever expanding library of games - playstation is committed",
      "Plug and play - getting into playstationvr couldn't be easier",
      "Lightweight headset design - the playstationvr headset will make you forget that you are wearing one"
    ],
    "pros": [
      "Ever expanding library of games - playstation is committed",
      "Plug and play - getting into playstationvr couldn't be easier",
  ...
  },
  {
    ...
    "specs": [
      ...
      "Games come first - with gamers in mind",
      "Just plug and play - getting into playstation vr couldn't be easier"
    ],
    "pros": [
      "Playstation vr headset",
      "Games come first - with gamers in mind",
      "Just plug and play - getting into playstation vr couldn't be easier",
      "Advanced vr display - seamless visuals keep you connected"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-pimax-vr-headsets",
    "title": "Best Pimax VR Headsets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best PlayStation VR Headsets";
