...
export const faq = [
  ...
  },
  {
    ...
    "a": "5G hardware you can't use with Gigabit-only network gear buys you nothing extra."
  }
];

export const guideSlug = "best-plugable-usb-c-ethernet-adapters";

export const guideTitle = "The Best Plugable USB-C Ethernet Adapters for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "5Gb Ethernet, including a hybrid USB-C/USB-A dual-connector design and a 100W PD charging model, all backed by the same 2-year warranty and lifetime North America-based support.",
  "5G tier, since the right pick depends on both your network speed and whether Switch compatibility matters to you."
];
...
export const metaDescription = "A practical comparison of 4 plugable USB-C ethernet adapters, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Plugable USB-C Ethernet Adapters for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B011DDXGVC?tag=theofficejournal-20",
    "description": "Positioned by Plugable as faster and more stable than most Wi-Fi networks, with straightforward setup requiring no downloads or installations.",
    "specs": [
      "Gigabit Ethernet, plug-and-play",
      "Nintendo Switch compatible",
      "Windows 10+/macOS 10.15+/Linux 3.9+"
    ],
    "pros": [
      "Explicitly compatible with Nintendo Switch handheld",
      "No downloads or driver installation required",
      "Broad OS support including older Linux kernels",
      "Plugable's standard 2-year coverage with lifetime support"
    ],
    "cons": [
      "1Gbps ceiling only, no multi-gig option in this specific model",
      "Basic single-purpose design with no extra ports"
    ],
...
export const breadcrumbLabel = "Best Plugable USB-C Ethernet Adapters";
