...
export const buyingCriteria = [
  {
    "criterion": "VIA and QMK Programmability Provides Deeper Customization Than a Manufacturer's Proprietary Software",
...
export const faq = [
  {
    "q": "Does the K10 Pro's VIA programmability work if I only ever use the keyboard on wireless mode?",
    "a": "You need to connect via wired USB-C mode to initially configure your key remapping and macros, but once set, the resulting keymap works on both wireless and wired modes going forward without needing to reconnect the cable each time."
  },
  {
    "q": "What's the most common mistake buyers make when comparing battery life figures across wireless keyboards?",
    "a": "Comparing two stated battery life numbers without checking whether they were measured under the same backlight conditions, since a figure measured with the backlight off isn't directly comparable to one measured at a low brightness setting."
  },
  {
    "q": "Is the Keychron K10 Pro worth it over the cheaper standard K10?",
    "a": "If you specifically want VIA programmability and refined sound dampening, yes, but if maximum battery life matters more and you don't need advanced remapping, the standard K10 covers that for about $7 less with significantly longer battery life."
  },
  {
    "q": "How durable is the GravaStar's transparent chassis compared to a standard plastic case?",
    "a": "The listing specifically states the polycarbonate construction maintains structural stability for everyday competitive play, though a transparent chassis generally has somewhat different structural properties than a solid aluminum or reinforced case."
  },
  {
    "q": "Can the Keychron K8's silent switches still be heard at all, or are they completely quiet?",
    "a": "They're meaningfully quieter than standard clicky or linear switches due to internal dampeners reducing bottom-out noise, but no genuine mechanical switch eliminates typing sound entirely, so expect noticeably quieter rather than completely silent operation."
  },
  {
    "q": "Do any of these keyboards support connecting to a phone or tablet in addition to a computer?",
    "a": ""
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Full VIA programmability with refined sound",
        ...
        [
          "A visually distinctive design with fast gaming switches",
          "GravaStar Mercury K1 Lite 75% Wireless Mechanical Keyboard"
        ],
        [
          "Quiet switches for shared spaces or late-night use",
          "Keychron K8 Wireless Mechanical Keyboard, Silent Red Switch"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "VIA/QMK programmable (Keychron K10 Pro)",
        "text": "Lets you remap any key and create custom macros through an open standard, worth it if you want deep customization."
      },
      {
        "label": "No remapping (K10 standard, GravaStar, K8)",
        "text": "Skips advanced customization in favor of simplicity and, in the K10's case, dramatically better battery life."
      }
    ],
    "note": "If deep key customization matters to your workflow, the K10 Pro's VIA support justifies its premium over the standard K10. If you just want reliable typing without remapping, the other three picks work fine without that added complexity."
  },
  {
    "subheading": "",
    "table": {
      ...
      "rows": [
        ...
        [
          "Fast linear switches for competitive gaming",
          ""
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Switches specifically marketed as 'silent' rather than just standard linear switches, since standard linear switches are quieter than clicky ones but still produce audible bottom-out noise."
      },
      {
        "label": "",
        "text": "The Keychron K8's Silent K Pro Red switches are specifically engineered for quiet operation, unlike the standard linear or tactile switches on the other three picks."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want full VIA programmability combined with refined sound dampening, where the Keychron K10 Pro delivers both at the top of this tier."
      },
      {
        "label": "",
        "text": "You want maximum battery life without needing advanced remapping, where the standard Keychron K10 covers that for about $7 less."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared stated battery capacity and hours of use across wireless picks in this tier."
  },
  {
    "title": "",
    "description": "Compared full VIA/QMK remapping against proprietary or no remapping support."
  },
  {
    "title": "",
    "description": "Compared linear, tactile, and silent switch categories along with sound dampening design."
  },
  {
    "title": "",
    "description": "Compared full-size, TKL, and 75% layouts against their respective feature tradeoffs."
  },
  {
    "title": "",
    "description": "Checked for unique visual or material design elements beyond standard keyboard aesthetics."
  }
];
...
export const introParagraphs = [
  ...
  "We compared this lineup on battery capacity, remapping method, and switch lubrication quality, since these details determine whether a board serves daily multi-device use or is simply a pricier variant of a smaller keyboard's feature set."
];
...
export const metaDescription = "How 4 mechanical keyboards under $100 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Mechanical Keyboards Under $100 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0B2DP88SD?tag=theofficejournal-20",
    ...
    "specs": [
      "100% layout, VIA/QMK programmable, hot-swappable",
      "4000mAh battery, 3-device Bluetooth",
      "Sound-absorbing foam, steel plate"
    ],
    "pros": [
      "Full VIA and QMK programmability for complete key remapping",
      "One of the largest batteries in the mechanical keyboard category",
      "Sound-absorbing foam and steel plate refine the typing sound"
    ],
    "cons": [
      "Key remapping requires wired mode to configure",
      "Pricier than the standard K10 without the Pro sound upgrades"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08MKSNYJD?tag=theofficejournal-20",
    "description": "This board's 4000mAh battery lasts up to 240 hours with the backlight off, a battery life figure the pricier K10 Pro doesn't match at 100 hours even at its lowest brightness setting. Its Keychron Super switches carry the same 50 million click lifespan rating as other Keychron boards in this comparison series, with dedicated Screenshot, Siri, and Screen Lock keys for Mac users.\n\nCompared to the K10 Pro above, this standard version skips the sound-absorbing foam, silicone dampening pad, and VIA programmability in exchange for a meaningfully lower price and dramatically longer battery life between charges. 1 with a wired USB-C fallback mode.\n\nBest for buyers who prioritize maximum battery life over sound refinement and VIA programmability.",
    "specs": [
      "104 keys, full-size, Bluetooth/USB-C",
      "Up to 240 hours battery life, backlight off",
      "Dedicated Mac shortcut keys included"
    ],
    "pros": [
      "Up to 240 hours of battery life, longest in this comparison",
      "Dedicated Mac shortcut keys work out of the box",
      "Cheapest full-size wireless pick in this tier"
    ],
    "cons": [
      "No VIA or QMK programmability like the K10 Pro",
      "No sound-dampening foam or steel plate refinement"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DFXWQWB8?tag=theofficejournal-20",
    "description": "This board's fully transparent PC chassis with clear keycaps creates a distinct exoskeleton aesthetic none of the other picks in this comparison offer, while custom GravaStar x BSUN linear switches with 40gf actuation and 2mm pre-travel deliver rapid, controlled keystrokes for competitive gaming. Its gasket-mounted structure with 5-layer foam dampening refines keystroke impact for stability during long sessions.\n\nCompared to the two Keychron K10 picks, this one uses a more compact 75% layout at 80 keys rather than a full 100% layout, trading a number pad for desk space savings and a more distinctive visual design. 4GHz wireless for flexible multi-device use.\n\nBest for buyers who want a visually distinctive transparent design with competitive gaming switches.",
    "specs": [
      "75% layout, 80 keys, transparent chassis",
      "40gf actuation switches, gasket-mounted",
      "Tri-mode connectivity, 4000mAh battery"
    ],
    "pros": [
      "Transparent chassis and clear keycaps offer a distinctive look",
      "Custom switches with fast 40gf actuation for competitive gaming",
      "Gasket-mount design with 5-layer foam dampening"
    ],
    "cons": [
      "Smaller 75% layout lacks a dedicated number pad",
      "Newer brand without the established track record of Keychron"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DT3F35D4?tag=theofficejournal-20",
    "description": "This board's factory pre-lubed Keychron Silent K Pro Red switches deliver a soft, quiet typing feel specifically engineered for shared spaces or late-night use, a distinct switch category from the standard linear or tactile switches on the other three picks in this comparison. Its TKL 87-key layout with white LED shine-through keycaps balances desk space savings with visibility.\n\n1 or a wired USB-C mode with a 1000Hz polling rate, matching the connectivity flexibility while specifically prioritizing quiet operation over competitive gaming switch speed. Optimized native macOS multimedia keys with included Windows keycaps round out its cross-platform support.\n\nBest for buyers who specifically need quiet switches for shared spaces or late-night typing.",
    "specs": [
      "87 keys, TKL, silent red switches",
      "Bluetooth 5.1, wired USB-C, 1000Hz polling",
      "Native macOS keys, Windows keycaps included"
    ],
    "pros": [
      "Silent switches specifically engineered for quiet operation",
      "TKL layout balances desk space with full functionality",
      "Native macOS optimization with included Windows keycaps"
    ],
    "cons": [
      "No hot-swap or VIA programmability like the K10 Pro",
      "Fewer keys than the full-size K10 picks in this tier"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-mechanical-keyboards-under-150",
...
export const breadcrumbLabel = "Best Mechanical Keyboards Under $100";
