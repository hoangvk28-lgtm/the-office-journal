...
export const faq = [
  {
    "q": "Do I need any tools beyond a screwdriver to install these mounts?",
    "a": "No, every pick in this comparison installs with basic hand tools, typically just a screwdriver, and all include the necessary screws in the box."
  },
  {
    "q": "What's the most common mistake buyers make when choosing a mount at this price?",
    "a": "Buying an extension-plate-only product like the HumanCentric pick without realizing they still need their mini PC's original factory bracket, resulting in an incomplete mounting solution."
  },
  {
    "q": "Is the Bedycoon bracket worth it over the HumanCentric extension plate for an Intel NUC?",
    "a": "If you no longer have your NUC's original factory bracket, yes, the Bedycoon's all-in-one design eliminates that requirement, but if you already have the factory bracket, the HumanCentric plate is a perfectly functional and slightly cheaper option."
  },
  {
    "q": "How do I know if my monitor's VESA port is already occupied by its stand?",
    "a": "Check the back of your monitor where the four VESA screw holes are located; if your monitor's own stand or arm is currently screwed into that pattern, it's occupied, and you'd need a workaround solution like the IFCASE extension plate."
  },
  {
    "q": "Can I use the JINGCHENGMEI mount for a mini PC brand other than Dell or Lenovo?",
    "a": "No, it's specifically built for Dell OptiPlex Micro and Lenovo ThinkCentre Tiny form factors, so a different brand's mini PC would need a differently sized or patterned mount instead."
  },
  {
    "q": "Do these mounts work if I want to switch from under-desk mounting to behind-monitor mounting later?",
    "a": "The JINGCHENGMEI, Bedycoon, and IFCASE picks all support multiple mounting scenarios using the same hardware, so switching locations later is possible without buying a new mount, though the HumanCentric plate specifically requires your NUC's factory bracket regardless of mounting location."
  }
];

export const guideSlug = "best-mini-pc-mounts-under-15";

export const guideTitle = "The Best Mini PC Mounts Under $15: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "An Intel NUC with its factory bracket",
          "HumanCentric Mounting Bracket for Intel NUC"
        ],
        [
          "A specific NUC 13/12/11/10/8/7/6/5 generation",
          "Bedycoon Mounting Bracket for Intel NUC"
        ],
        [
          "A monitor with an occupied VESA port",
          "IFCASE Metal VESA Extension Plate"
        ],
        [
          "A Dell OptiPlex Micro or Lenovo ThinkCentre Tiny",
          "JINGCHENGMEI Mini PC Wall Mount"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Complete kits (Bedycoon, IFCASE, JINGCHENGMEI)",
        "text": "Work as standalone mounting solutions without needing an additional factory bracket from your PC's manufacturer."
      },
      {
        "label": "",
        "text": "Requires you already have your NUC's original factory mounting bracket, since this plate only bridges that bracket to a VESA arm."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Intel NUC (any recent generation)",
          "Bedycoon or HumanCentric NUC brackets"
        ],
        [
          "Dell OptiPlex Micro or Lenovo ThinkCentre Tiny",
          "JINGCHENGMEI Mini PC Wall Mount"
        ],
        [
          "Any brand behind an already-mounted monitor",
          "IFCASE Metal VESA Extension Plate"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A VESA extension solution that works around an already-occupied monitor mount point rather than requiring a free VESA port."
      },
      {
        "label": "",
        "text": "The IFCASE Metal VESA Extension Plate is specifically designed to solve this exact occupied-port problem."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want direct maker support and confirmed compatibility for a specific NUC generation, where the HumanCentric or Bedycoon picks both offer detailed compatibility documentation."
      },
      {
        "label": "",
        "text": "You own a Dell OptiPlex Micro or Lenovo ThinkCentre Tiny and want the lowest price, where the JINGCHENGMEI pick covers 3 mounting scenarios for under $10."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Checked whether each pick supports the standard 75x75mm and 100x100mm VESA hole patterns used by most monitor arms."
  },
  {
    "title": "",
    "description": "Compared which exact mini PC models and generations each mount is verified to fit."
  },
  {
    "title": "",
    "description": "Checked what screws, straps, and installation aids ship in the box versus what buyers must source separately."
  },
  {
    "title": "",
    "description": "Compared how many distinct mounting locations, wall, under desk, or behind a monitor, each pick supports."
  },
  {
    "title": "",
    "description": "Noted stated installation time and tool requirements across the lineup."
  }
];
...
export const metaDescription = "How 4 mini PC mounts under $15 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Mini PC Mounts Under $15 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "VESA extension plate, 75x75mm and 100x100mm",
      "For Intel NUC, requires the NUC's factory bracket",
      "Includes screws, screwdriver installation"
    ],
    "pros": [
      "Supports both common VESA hole patterns in one plate",
      "Fast, tool-light installation in minutes",
      "Direct maker support if fit issues arise"
    ],
    "cons": [
      "Requires the NUC's original bracket, not a complete kit alone",
      "Not compatible with Hades Canyon, Skull Canyon NUC variants"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CRQNNT6H?tag=theofficejournal-20",
    ...
    "specs": [
      "Solid steel, 9 oz, 75mm and 100mm VESA",
      "Built-in threads, no loose nuts needed",
      "Compatible with Intel NUC, HP Mini, and similar"
    ],
    "pros": [
      "Solves the specific problem of an occupied VESA port",
      "Lightest pick in this comparison at 9 ounces",
      "Under 2-minute installation with built-in threads"
    ],
    "cons": [
      "Steel construction only, no adjustable width for varied device sizes",
      "Best suited to devices already matching its screw pattern"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CSP97C75?tag=theofficejournal-20",
    "description": "At under $10, this is the least expensive pick in this comparison, yet it still covers three different mounting scenarios, wall, under desk, or VESA behind a monitor, using the same 75x75mm or 100x100mm four-hole pattern the pricier picks rely on. It's built specifically for Dell OptiPlex Micro and Lenovo ThinkCentre Tiny form factors rather than a universal fit.\n\nIts button screw mounting system uses a black hand screw for Dell units and a white hand screw for Lenovo units, a small detail that shows real attention to matching each brand's hardware color scheme, and three sets of mounting holes per VESA pattern add flexibility for awkward hole positioning.\n\nBest for buyers with a Dell OptiPlex Micro or Lenovo ThinkCentre Tiny who want the lowest price without sacrificing mounting flexibility.",
    "specs": [
      "Fits Dell OptiPlex Micro and Lenovo ThinkCentre Tiny",
      "75x75mm and 100x100mm VESA, 3 mounting hole sets",
      "Wall, under-desk, or VESA mounting options"
    ],
    "pros": [
      "Lowest price in this comparison by a wide margin",
      "Covers 3 distinct mounting scenarios in one bracket",
      "Color-matched hand screws for Dell versus Lenovo hardware"
    ],
    "cons": [
      "Limited to Dell OptiPlex Micro and Lenovo ThinkCentre Tiny only",
      "Doesn't fit OptiPlex tower or small form factor models"
    ],
...
export const breadcrumbLabel = "Best Mini PC Mounts Under $15";
