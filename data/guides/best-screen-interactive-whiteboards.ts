...
export const faq = [
  {
    ...
    "a": "Several boards in this list support touch on external HDMI/USB-C sources through a USB touch cable connection, letting you write directly on content from a connected laptop, while others require a separate USB touch connection to enable this. Verify per-model before assuming universal external-source touch support."
  },
  {
...
export const guideTitle = "The Best Screen Interactive Whiteboards for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 screen interactive whiteboards, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Screen Interactive Whiteboards for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Screen Interactive Whiteboards";
