export const guideSlug = "best-compact-audio-interfaces";
export const guideTitle = "8 Best Compact Audio Interfaces in 2026";
export const metaTitle = "Best Compact Audio Interfaces";
export const metaDescription = "We compared compact audio interface models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "compact audio interface";
export const introParagraphs = [
  "Across best compact audio interfaces, range widely in real latency, given that differences show up in the fine print.",
  "What separates these picks is verified specs, not marketing claims, since these details matter more than claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-compact-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-compact-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-compact-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-compact-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-compact-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-compact-audio-interfaces-6",
    rank: 6,
  ...
  {
    id: "best-compact-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-compact-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
