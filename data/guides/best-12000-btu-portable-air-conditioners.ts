...
export const guideTitle = "The Best 12,000 BTU Portable Air Conditioners for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "Temprium 12,000 BTU Portable AC with Smart Control up to 600 Sq."
        ],
        [
          "",
          "BLACK+DECKER Smart Portable Air Conditioner"
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "How 8 12,000 BTU portable air conditioners compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 12,000 BTU Portable Air Conditioners for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "3-in-1 operation",
      "All window kits included",
      "12,000 BTU SACC/cec compact portable air conditioner will keep"
    ],
    "pros": [
      "3-in-1 operation",
      "All window kits included",
  ...
  },
  {
    ...
    "specs": [
      "Midea 12,000 BTU ASHRAE (8,000 BTU doe/SACC) portable air",
    ...
    "pros": [
      ...
      "Control your portable ac from anywhere using the smarthome",
      "Effortless operation",
      "Unit is easy to install so you can"
    ],
    "cons": [
      "SACC cooling is usually lower than the headline BTU number",
      "Single-hose models lose efficiency from negative room pressure"
...
export const breadcrumbLabel = "Best 12,000 BTU Portable Air Conditioners";
