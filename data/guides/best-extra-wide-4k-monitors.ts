...
export const guideTitle = "The Best Extra-Wide 4K Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 extra-wide 4K monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Extra-Wide 4K Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Immersive 49-inch ultra-wide curved monitor: the 49-inch display",
      "144Hz/165hz refresh rate with amd freesync: experience ultra-smooth, fluid gameplay with a rapid 144hz/165hz refresh rate",
      "120% Srgb wide color gamut: boasting extensive 120% srgb color coverage"
    ],
    "pros": [
      "Immersive 49-inch ultra-wide curved monitor: the 49-inch display",
      "144Hz/165hz refresh rate with amd freesync: experience ultra-smooth, fluid gameplay with a rapid 144hz/165hz refresh rate",
      "120% Srgb wide color gamut: boasting extensive 120% srgb color coverage",
      "Flexible ergonomic setup & connectivity"
    ],
    "cons": [
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-ips-4k-monitors",
    "title": "Best IPS 4K Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Extra-Wide 4K Monitors";
