...
export const faq = [
  {
    "q": "Do any digital notebooks have a removable microSD card slot?",
    "a": "Not as a standard feature on the leading current devices we checked, Kindle Scribe, reMarkable, XPPen, and BOOX all use fixed internal storage."
  },
  {
    "q": "What's the best way to get more storage?",
    "a": "Choose the largest fixed storage tier at purchase, since you generally can't add capacity afterward. The 64GB configurations are the largest we found."
  },
  {
    "q": "Is refurbished a good way to get more storage for less?",
    "a": "Yes, the Like-New 64GB Kindle Scribe costs less than half the price of the new Colorsoft for the same storage tier."
  },
  {
    "q": "Does Android help with storage limitations?",
    "a": "Indirectly, the BOOX Note Air 5 C's Android base allows more flexible cloud storage app options, which can supplement fixed on-device capacity."
  },
  {
    "q": "How much storage do I actually need?",
    "a": "Handwritten notes use very little space. If you plan to store a large PDF or book library, prioritize the 64GB tier over 16GB or 32GB options."
  }
];

export const guideSlug = "best-digital-notebooks-with-expandable-storage";

export const guideTitle = "The Best Digital Notebooks with Expandable Storage: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    "title": "Honest disclosure of no removable storage",
    "description": "We verified no current leading E Ink notebook ships with a user-accessible microSD or removable card slot as standard, and said so directly."
  },
  {
    "title": "Fixed storage tier as the real lever",
    "description": "We ranked by the largest available fixed storage configuration for each product line, since that's what buyers actually control."
  },
  {
    "title": "",
    "description": "We compared refurbished versus new pricing at the same storage tier, since the value gap can be significant."
  },
  {
    "title": "Cloud/Android flexibility as a partial substitute",
    "description": "We noted where Android-based devices offer more flexible cloud storage app options that can extend practical usable capacity."
  }
];
...
export const metaDescription = "A practical comparison of 5 digital notebooks with expandable storage, focused on compatibility, build, features and price, and the trade-offs between them.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "64GB is the largest fixed capacity in this comparison, not expandable via removable card but the most storage you can buy in a single configuration.\n\nLargest fixed storage tier in this comparison. On price, it's actually priced above BOOX Note Air 5 C, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Not truly expandable, capacity is fixed at purchase, no removable card slot.",
    "specs": [
      "64GB fixed storage",
      "Color E Ink display",
      "No removable card slot"
    ],
    "pros": [
      "Largest fixed storage tier in this comparison"
    ],
    "cons": [
      "Not truly expandable, capacity is fixed at purchase, no removable card slot"
    ],
  ...
  },
  {
    ...
    "description": "64GB fixed storage matched with Android's cloud-storage app flexibility, you can offload files to cloud services more easily than on closed ecosystems, effectively extending usable capacity even without a physical expansion slot.\n\nOn the other side, Still no physical removable card slot.",
    "specs": [
      "64GB fixed storage, 6GB RAM",
      "Runs Android for cloud storage app flexibility"
    ],
    "pros": [
      "Same top-tier fixed storage as the Kindle Scribe Colorsoft",
      "Android cloud app flexibility extends practical usable capacity"
    ],
    "cons": [
      "Still no physical removable card slot"
    ],
  ...
  },
  {
    ...
    "description": "Same 64GB fixed capacity as the new Colorsoft above, in Like-New refurbished condition at less than half the price.\n\nOn the other side, Like-New condition means light cosmetic wear is possible.",
    "specs": [
      "64GB fixed storage, Like-New condition"
    ],
    "pros": [
      "Same top storage tier as the new Colorsoft at a fraction of the price"
    ],
    "cons": [
      "Like-New condition means light cosmetic wear is possible"
    ],
  ...
  },
  {
    ...
    "description": "A quarter of the storage of the top picks above at a higher price than the refurbished 64GB option, included so buyers can see this isn't the best value if storage is the priority.\n\nThe real tradeoff against that pick: Least storage of any pick here, at a higher price than the refurbished 64GB option.\n\nOn the other side, Least storage of any pick here, at a higher price than the refurbished 64GB option.",
    "specs": [
      "16GB fixed storage",
    ...
    "cons": [
      "Least storage of any pick here, at a higher price than the refurbished 64GB option"
    ],
  ...
  },
  {
    ...
    "description": "On the other side, No removable storage expansion, same limitation as the rest of the lineup.",
    "specs": [
      "Fixed storage tier, check current spec",
    ...
    "cons": [
      "No removable storage expansion, same limitation as the rest of the lineup"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-refurbished-digital-notebooks",
    "title": "Best Refurbished Digital Notebooks (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Digital Notebooks with Expandable Storage";
