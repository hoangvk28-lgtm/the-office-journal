...
export const guideTitle = "6 Best Gaming Monitors for Xbox Series X in 2026";
export const metaTitle = "Best Gaming Monitors for Xbox Series X";
export const metaDescription = "We compared gaming monitors for xbox series x models by verified specs and real-world tradeoffs, not marketing claims alone.";
export const mainKeyword = "gaming monitors for xbox series x";
export const introParagraphs = [
  "Best Gaming Monitors for Xbox Series X carry real hidden gaps, exactly why gaming monitors for xbox series x, details stay hidden.",
  "gaming monitors for xbox series x: we weighed honest pixel density, since the same resolution looks softer on a bigger screen."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-gaming-monitors-for-xbox-series-x-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-gaming-monitors-for-xbox-series-x-2",
    rank: 2,
  ...
  {
    id: "best-gaming-monitors-for-xbox-series-x-3",
    rank: 3,
  ...
  {
    id: "best-gaming-monitors-for-xbox-series-x-4",
    rank: 4,
  ...
  {
    id: "best-gaming-monitors-for-xbox-series-x-5",
    rank: 5,
    badge: "Best Value",
  ...
  {
    id: "best-gaming-monitors-for-xbox-series-x-6",
    rank: 6,
    badge: "Worth a Look",
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "Samsung 27\" Odyssey G3 (G30D) Series FHD Gaming Monitor"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "Samsung 27\" Odyssey G3 (G30D) Series FHD Gaming Monitor is worth checking against its specific spec sheet before assuming any pick here covers your exact need."
      }
    ]
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-gaming-monitors","title":"Best Gaming Monitors in 2026"},{"href":"/guide/best-gaming-monitors-for-xbox-series-s","title":"Best Gaming Monitors for Xbox Series S in 2026"},{"href":"/guide/best-qd-oled-gaming-monitors","title":"Best QD-OLED Gaming Monitors in 2026"},{"href":"/guide/best-1440p-144hz-gaming-monitors","title":"Best 1440p 144Hz Gaming Monitors in 2026"}];
