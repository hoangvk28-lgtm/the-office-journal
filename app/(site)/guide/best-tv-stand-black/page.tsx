...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-tv-stand-black";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-tv-stand-black",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-tv-stand-black` },
    about: [{"@type":"Thing","name":"Best Black TV Stands for Small Living Rooms"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Black TV Stands for Small Living Rooms", item: `${SITE_URL}/guide/best-tv-stand-black` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-tv-stand-black#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Black TV Stands for Small Living Rooms</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Black TV Stands for Small Living Rooms" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Black is the most versatile TV stand color on the market. It pairs with almost any wall color, flooring, or sofa fabric, and it visually anchors a TV setup better than lighter wood tones that can look busy against a patterned rug or textured wall.</p>
          <p>The finish matters more than the color itself. A high-gloss black surface photographs well online but shows dust, fingerprints, and pet hair within days of daily use, while a matte or textured black finish hides the same marks and needs far less upkeep. Buyers furnishing a small living room or bedroom should also weigh how a solid black stand affects the room visually, since a large dark block of furniture can make a compact space feel smaller than the same stand in a lighter finish.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=tv+stand+black&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
