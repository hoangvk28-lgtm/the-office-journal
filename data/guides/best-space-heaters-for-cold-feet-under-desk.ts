...
export const guideTitle = "The Best Space Heaters for Cold Feet Under Desk: Our Picks";
...
export const metaDescription = "How 7 space heaters for cold feet under desk compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Space Heaters for Cold Feet Under Desk (2026)";
...
export const breadcrumbLabel = "Best Space Heaters for Cold Feet Under Desk";
