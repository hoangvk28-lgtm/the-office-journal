export const guideSlug = "best-hdmi-video-switchers";
export const guideTitle = "8 Best HDMI Video Switchers in 2026";
export const metaTitle = "Best HDMI Video Switchers";
export const metaDescription = "We compared hdmi video switcher models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage floor.";
export const mainKeyword = "hdmi video switcher";
export const introParagraphs = [
  "Across best hdmi video switchers, range widely in real latency, given that differences show up in the fine print.",
  "What separates these picks is real input count and connector type, since this predicts real production reliability."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-hdmi-video-switchers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-hdmi-video-switchers-2",
    rank: 2,
  ...
  {
    id: "best-hdmi-video-switchers-3",
    rank: 3,
    badge: "Best Value",
  ...
  {
    id: "best-hdmi-video-switchers-4",
    rank: 4,
  ...
  {
    id: "best-hdmi-video-switchers-5",
    rank: 5,
  ...
  {
    id: "best-hdmi-video-switchers-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-hdmi-video-switchers-7",
    rank: 7,
  ...
  {
    id: "best-hdmi-video-switchers-8",
    rank: 8,
