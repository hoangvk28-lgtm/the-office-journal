...
export const faq = [
  {
    "q": "Is the Echo Show 10 the only 10 inch smart display available?",
    "a": "It's the only one we could verify in our research pool this pass. The broader smart display market clusters more around 7 to 8 inches or 15 inches, with fewer 10 inch class options overall."
  },
  {
    "q": "What makes the Echo Show 10 different from other Echo Show models?",
    "a": "Its motorized rotating base actively follows you around a room during calls, a feature unique to this model in our entire research pool regardless of screen size."
  },
  {
    "q": "Should I get the Echo Show 10 or a larger Echo Show 15?",
    "a": "Choose the Echo Show 10 for a more desk-appropriate footprint with motion tracking, or the Echo Show 15 if you want the largest possible screen for a shared space and don't need the motorized base."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Applied a strict 10 inch class size definition",
    "description": "6 inch Echo Show 15 down or an 8 inch model up to pad this specific guide."
  },
  {
    "title": "Confirmed the 10 inch category is thin on the market",
    "description": "Verified that most competing smart displays cluster around 7 to 8 inches or jump to 15 inches, with few landing specifically in the 10 inch range."
  },
  {
    "title": "Motorized base assessed as the defining feature of this pick",
    "description": "Weighed the Echo Show 10's motorized rotating base heavily, since it's a distinctive feature not found on any other display in our research pool."
  },
  {
    "title": "Reviewed the single confirmed pick in depth",
    "description": "Chose a thorough single-product writeup over including a size-mismatched display just to lengthen the guide."
  }
];

export const introParagraphs = [
  "1 inches, is the only 10 inch class smart display in our verified research pool. It's a somewhat thin category on its own merits, most competing displays sit either around 7 to 8 inches or jump up to 15 inches, with relatively few landing specifically in the 10 inch range.",
  "Rather than round up a smaller display or round down a 15 inch one to pad this list, we're giving the Echo Show 10 a thorough single-product review, since its motorized rotating base is the most distinctive feature in this entire product category regardless of size class."
];
...
export const metaDescription = "The Echo Show 10 is the only verified genuine 10 inch class smart display we found this pass. Here is a detailed, honest look at it.";
...
export const relatedGuides = [
  {
    "href": "/guide/best-8-inch-smart-displays",
    "title": "Best 8 Inch Smart Displays (2026)"
  },
  {
