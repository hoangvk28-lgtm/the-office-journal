...
export const guideTitle = "4 Best Mini UPS for Routers Under $50 in 2026";
export const metaTitle = "Best Mini UPS for Routers Under $50 in 2026";
export const metaDescription = "We compared best mini ups for routers under $50 by verified current price and real capability, not just the price ceiling alone.";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Most buyers should default to 10400mAh Mini UPS Battery Backup USB 5V2A 5.5x2.5mm 9V1A 12V1A Portable unless your specific use case points toward 13500mAh Battery Power Supply for Router Modem Backup Ensuring Double Voltages's particular tradeoffs."
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-mini-ups-for-routers-under-75","title":"Best Mini UPS for Routers Under $75"},{"href":"/guide/best-mini-ups-for-routers-under-100","title":"Best Mini UPS for Routers Under $100"},{"href":"/guide/best-mini-ups-for-routers-under-150","title":"Best Mini UPS for Routers Under $150"}];
