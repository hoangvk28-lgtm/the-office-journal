...
export const faq = [
  {
    "q": "Do all of these have genuine wheels?",
    "a": "Yes, we verified confirmed wheels in each listing, not just a carrying handle mistaken for rolling capability."
  },
  {
  ...
  {
    "q": "Which has real review data to reference?",
    "a": ""
  },
  {
    "q": "Is there an option that also carries a laptop?",
    "a": "6 inch laptop alongside files."
  },
  {
    "q": "Why does the Storex pick have a lower rating?",
    "a": "5-star rating, the lowest in this comparison. Read current reviews for specific complaints before choosing it."
  }
];

export const guideSlug = "best-portable-file-totes-on-wheels";

export const guideTitle = "The Best Portable File Totes on Wheels: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to dbest Products Quik Cart Sport Collapsible Rolling Crate on Wheels for Teachers unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We only included products with wheels explicitly confirmed in the listing, not just a carrying handle mistaken for rolling capability."
  },
  {
    "title": "",
    "description": "We noted where a rolling tote collapses for storage versus staying rigid, since that affects storage footprint when not in use."
  },
  {
    "title": "Rating and review volume weighed honestly",
    "description": "We flagged the Storex pick's lower rating directly rather than omitting it, since it's a real product with real review data worth considering alongside its drawback."
  },
  {
    "title": "Capacity and combined-use features noted",
    "description": "We highlighted the Prokva pick's ability to carry a laptop alongside files as a genuine differentiator."
  }
];

export const introParagraphs = [
  "We required confirmed wheels in the product description, not just a carrying handle, to qualify for this comparison. Rolling totes solve a different problem than a lift-and-carry box: moving a heavy loaded file collection without lifting it.",
...
export const metaDescription = "How 5 portable file totes on wheels compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "From an established rolling-cart brand",
  ...
  },
  {
    ...
    "pros": [
      "Same proven design as the blue-lid version, slightly cheaper"
    ],
    "cons": [
      "No review history available yet on this specific listing"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CFDCLJ3G?tag=theofficejournal-20",
    ...
    "specs": [
      "Compact collapsible rolling crate"
    ],
    "pros": [
      "Cheapest of the dbest Products options"
    ],
    "cons": [
      "More compact size than the standard crates, less total capacity"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D4DDSWXH?tag=theofficejournal-20",
    "description": "6 inch laptop together, useful for buyers who need one rolling bag for their entire workday kit.",
    "specs": [
      "Rolling bag with wheels",
      "Fits 15.6 inch laptop plus files"
    ],
    "pros": [
      "Combines laptop and file storage in one rolling bag"
    ],
    "cons": [
  ...
  },
  {
    ...
    "pros": [
      "Larger dimensions than the compact options"
    ],
    "cons": [
      "Lowest rating in this comparison, check current specific complaints"
    ],
...
export const breadcrumbLabel = "Best Portable File Totes on Wheels";
