...
export const faq = [
  ...
  },
  {
    ...
    "a": "If you don't need to travel with it, a larger fixed-desk tablet often gives more active area and features for a similar price."
  },
  {
...
export const guideTitle = "The Best Small Drawing Tablets for a Better Desk Setup";
...
export const metaDescription = "We compared 5 small drawing tablets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Small Drawing Tablets for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-portable-drawing-tablets",
    "title": "Best Portable Drawing Tablets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Small Drawing Tablets";
