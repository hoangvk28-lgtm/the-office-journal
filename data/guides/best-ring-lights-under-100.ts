...
export const guideTitle = "The Best Ring Lights Under $100 Worth Considering";
...
export const metaDescription = "How 8 ring lights under $100 compare on brightness, color temperature, adjustability and power, with clear notes on who each one suits.";

export const metaTitle = "Best Ring Lights Under $100 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Bi-color temperature ring light variables from a warm 3000k",
      "Lcd display",
    ...
    "pros": [
      ...
      "Lcd display",
      "High color rendering",
      "Multiple compatibility & built-in 2.4ghz receiver"
    ],
    "cons": [
      "Larger diameter alone doesn't guarantee brighter, more even light",
      "Listed lux ratings are often inflated 2 to 3x by the brand"
...
export const breadcrumbLabel = "Best Ring Lights Under $100";
