...
export const guideTitle = "The Best NAS Hard Drives for Home Office Storage: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 NAS hard drives for home office storage, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best NAS Hard Drives for Home Office Storage (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "The DXP4800 Plus is a diskless 4-bay enclosure built around an Intel Pentium Gold 5-core CPU, giving it enough headroom for transcoding, virtualization, or running several services at once alongside file storage. Like every enclosure in this list it ships with no drives, so budget for 4 NAS-rated drives on top of the enclosure price.\n\nFour bays open up RAID 5 or RAID 10 configurations that balance capacity against redundancy far better than a 2-bay unit can, which matters if you're storing home office data you can't afford to lose.\n\n4 bays enable RAID 5/10 for better redundancy math.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The DH2300 is a lower-cost diskless 2-bay enclosure supporting up to 64TB total once you install your own drives. It's a straightforward entry point for a home office that wants basic NAS redundancy without paying for the extra CPU horsepower of a media-server-focused unit.\n\nAs with every diskless enclosure here, the drives are a separate purchase, budget for 2 NAS-rated drives on top of this price, and check whether SMR or CMR drives are being used before committing them to a RAID array.",
    "specs": [
...
export const breadcrumbLabel = "Best NAS Hard Drives for Home Office Storage";
