...
export const faq = [
  {
    "q": "Is the Echo Show 5 the only 5 inch smart display available?",
    "a": "It's the only one we could verify with confirmed pricing and imagery in our research pool this pass. Other compact options may exist but we could not confirm their current listings."
  },
  {
    "q": "How big is the Echo Show 5's screen exactly?",
    "a": "5 inches diagonally, placing it in the 5 inch size class along with a low price point relative to larger Echo Show models."
  },
  {
    "q": "Should I get a 5 inch display or go slightly bigger?",
    "a": "If desk space is very tight, the 5 inch class works well. If you have a bit more room, a 7 inch Nest Hub shows meaningfully more information at a glance."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Applied a strict 5 inch class size definition",
    "description": "5 inch range, rather than rounding a 7 inch display down to fit this guide's search term."
  },
  {
    "title": "Searched for a second genuine 5 inch option before finalizing",
    "description": "Looked specifically for smaller compact smart displays like a Lenovo Smart Clock-style device but could not verify current pricing or imagery this research pass."
  },
  {
    "title": "Reviewed the single confirmed pick in depth rather than padding the list",
    "description": "Chose to give the Echo Show 5 a thorough, detailed writeup instead of including unrelated larger displays to reach a longer list."
  },
  {
    "title": "Cross-referenced against our other size-specific guides",
    "description": "Pointed toward our 7 and 10 inch guides for buyers whose actual need is a small display broadly, not specifically 5 inches."
  }
];

export const introParagraphs = [
  "We looked for a second true 5 inch option, including a Lenovo Smart Clock Essential-style device, but could not confirm current pricing or imagery for one this research pass, so we're not padding this guide with an unverified product.",
...
export const metaDescription = "Only one genuinely 5 inch class smart display exists in our verified research pool, the Echo Show 5. Here is an honest, detailed look at it.";
