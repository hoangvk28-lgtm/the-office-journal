...
const raw = readFileSync(resolve(ROOT, "scripts", "unique_asins_privacy_screens.txt"), "utf-8");
...
writeFileSync(resolve(ROOT, "scripts", "data-privacy-screens.json"), JSON.stringify(allItems, null, 2), "utf8");
...
console.log("Saved to scripts/data-privacy-screens.json and scripts/lookup-privacy-screens.json");
