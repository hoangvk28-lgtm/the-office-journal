...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "5W through a single USB cable with no separate power adapter, making it usable anywhere a laptop is, while a scanner requiring a dedicated wall outlet effectively becomes fixed-location equipment regardless of its physical size. If you need to move a scanner between rooms or locations regularly, prioritize genuine USB-only power over a scanner that happens to be physically small but still needs its own outlet. Check the listed power requirements explicitly rather than assuming compact size implies portability."
  }
];

export const faq = [
  {
    "q": "Does the Canon imageFORMULA R40II work with third-party scanning software like TWAIN-based document management systems?",
    "a": "No, it's designed exclusively for Canon's included CaptureOnTouch software and explicitly does not support TWAIN or ISIS drivers, so confirm your existing software workflow is compatible before buying."
  },
  {
    "q": "What's the most common mistake buyers make when comparing desktop and portable duplex scanners?",
    "a": "Assuming any duplex scanner delivers similar speed, when in reality a desktop model like the Canon R40II can scan nearly four times faster than a portable duplex model like the Canon R10 due to its larger, more powerful internal mechanism."
  },
  {
    "q": "Is the ScanSnap iX1300 worth the price premium over the Canon R40II?",
    "a": "If wireless scanning and a smaller desk footprint matter more to you than raw speed, yes, but if maximum duplex throughput at 45ppm and a larger 60-sheet feeder matter more, the Canon R40II offers more scanning power for a lower price."
  },
  {
    "q": "Can the ScanSnap iX1300 be used without connecting it to a computer at all?",
    "a": "Yes, its Wi-Fi connectivity lets it send scans directly to mobile devices or cloud services without a computer in the loop, a capability none of the other picks in this comparison offer."
  },
  {
    "q": "How often will I need to refill the feeder on the Canon R40II versus the Canon R10?",
    "a": "The R40II's 60-sheet feeder holds three times as many pages as the R10's 20-sheet feeder, so for the same document stack you'll refill the R10 roughly three times as often."
  },
  {
    "q": "Is the Epson ES-50 still a reasonable choice at this price tier, or should I upgrade to a duplex model?",
    "a": "If you mostly scan single-sided pages occasionally and want to save money, the ES-50 remains a solid, fast choice, but if you regularly handle two-sided documents, any of the duplex picks in this comparison will save real time over manually re-scanning the back of each page."
  }
];

export const guideSlug = "best-document-scanners-under-300";

export const guideTitle = "The Best Document Scanners Under $300, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Maximum duplex throughput at a desk",
          "Canon imageFORMULA R40II Office Document Scanner"
        ],
        [
          "Wireless scanning with a compact footprint",
          "ScanSnap iX1300 Wireless Double-Sided Color Document Scanner"
        ],
        [
          "Duplex scanning in a portable body",
          "Canon imageFORMULA R10 Portable Document Scanner"
        ],
        [
          "The lowest price for occasional single-page scans",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Desktop duplex (Canon R40II, ScanSnap iX1300)",
        "text": "Delivers 30-45ppm duplex speed with 60-sheet or wireless features, built for regular multi-page scanning sessions at a fixed location."
      },
      {
        "label": "",
        "text": "Scans both sides at a much more modest 12ppm with a 20-sheet feeder, but stays lightweight and USB-powered for travel."
      }
    ],
    "note": "If you scan in one location regularly, a desktop duplex model's speed and feeder capacity save real time. If you need duplex on the go, the R10 is the only portable option here that still captures both sides."
  },
  {
    "subheading": "",
    "table": {
      ...
      "rows": [
        ...
        [
          "Small stacks up to 20 sheets",
          ""
        ],
        [
          "Larger stacks up to 60 sheets",
          ""
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Genuine Wi-Fi connectivity that lets multiple devices scan without a direct cable connection to one computer."
      },
      {
        "label": "",
        "text": "The ScanSnap iX1300 is the only pick with real wireless scanning, letting it work without being tethered to a single PC."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You regularly scan large stacks of two-sided documents, where the Canon R40II's 60-sheet, 45ppm duplex feeder saves real time over the portable options."
      },
      {
        "label": "",
        "text": "You mostly scan single pages occasionally, where the Epson ES-50 covers that need at less than half the price of any duplex pick here."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared real stated pages-per-minute figures for duplex, two-sided scanning across the desktop and portable picks."
  },
  {
    "title": "",
    "description": "Compared sheet capacity of automatic document feeders, from 20-sheet portable designs to 60-sheet desktop units."
  },
  {
    "title": "",
    "description": "Checked which picks offer genuine Wi-Fi scanning versus USB-only connections."
  },
  {
    "title": "",
    "description": "Noted which scanners support only proprietary software versus broader TWAIN/ISIS driver compatibility."
  },
  {
    "title": "",
    "description": "Weighed genuine portability against raw scan speed and feeder capacity across the lineup."
  }
];
...
export const metaDescription = "We compared 4 document scanners under $300 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Document Scanners Under $300 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "45ppm duplex speed, nearly 4x faster than the portable Canon R10",
      "60-sheet feeder handles much larger stacks per load",
      "One-touch operation with a simple LCD status display"
    ],
    "cons": [
      "No TWAIN or ISIS driver support, CaptureOnTouch only",
      "Not wireless, requires a direct USB-C connection"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Only pick here with genuine Wi-Fi wireless scanning",
      "Automatic de-skew and blank page removal need no manual cleanup",
      "Compact, space-saving footprint despite full duplex capability"
    ],
    "cons": [
      "Slower duplex speed than the Canon R40II's 45ppm",
  ...
  },
  {
    ...
    "description": "It's built-in software requires no separate installation and handles receipts, business cards, plastic or embossed cards, and legal documents.\n\nIt remains the lowest-priced duplex-capable pick across this comparison, undercutting both the R40II and iX1300 by a wide margin while still capturing both sides of a page in one pass.\n\nBest for buyers who want duplex scanning in a portable body and don't need desktop-class throughput.",
    "specs": [
    ...
    "pros": [
      "Lowest-priced duplex pick in this comparison",
      "portable and USB powered, no adapter needed",
      "Built-in software requires no separate installation"
    ],
    "cons": [
      "Much slower duplex speed than the desktop picks above",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Fastest single-page scan speed of any pick here",
      "Handles extra-long pages up to 72 inches"
    ],
    "cons": [
      "Simplex only, no duplex or automatic feeder",
      "Best suited to occasional single-page scanning, not volume"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-document-scanners-under-500",
    "title": "Best Document Scanners Under $500"
  },
  {
...
export const breadcrumbLabel = "Best Document Scanners Under $300";
