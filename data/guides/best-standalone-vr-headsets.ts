...
export const guideTitle = "The Best Standalone VR Headsets for Everyday Desk Work";
...
export const metaDescription = "How 6 standalone VR headsets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Standalone VR Headsets for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-8k-standalone-vr-headsets",
    "title": "Best 8K Standalone VR Headsets in 2026"
  },
  {
    "href": "/guide/best-vr-headsets-for-pc",
    "title": "Best VR Headsets for PC in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Standalone VR Headsets";
