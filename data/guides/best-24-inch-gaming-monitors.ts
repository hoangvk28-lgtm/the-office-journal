...
export const guideTitle = "The Best 24-Inch Gaming Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 6 24-inch gaming monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 24-Inch Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Dell 24 240Hz Gaming Monitor is the strongest all-around choice here. 5ms response time provide crisp visuals and fluid movement with less input lag. Freesync premium and HDMI vrr eliminate tearing for smooth, responsive PC and console gameplay.\n\n5ms response with excellent color accuracy across wide ips viewing angles ends up being the detail that matters most for most buyers.\n\nGo with this pick if you want the strongest all-around pick in this comparison and would rather not keep shopping around. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    "specs": [
      "Smooth motion",
      "Seamless gaming",
      "Fast ips"
...
export const breadcrumbLabel = "Best 24-Inch Gaming Monitors";
