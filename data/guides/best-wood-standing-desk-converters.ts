...
export const faq = [
  {
    "q": "What's the difference between MDF wood and bamboo converters?",
    "a": "MDF is a dense engineered wood composite; bamboo is a distinct plant material often chosen for its faster renewability. Both are genuine materials, not just cosmetic finishes."
  },
  {
    "q": "Which wood converter has the most reviews?",
    "a": ""
  },
  {
    "q": "Is there a genuine bamboo option?",
    "a": "Yes, both the VIVO Real Bamboo 32 inch Standing Desk Converter and the more compact Amazer 22 inch Bamboo Desk Riser confirm real bamboo construction."
  },
  {
    "q": "What's the cheapest confirmed wood or bamboo option?",
    "a": ""
  },
  {
    "q": "Are all wood-branded converters actually solid wood?",
    "a": "No, some use a wood-look laminate finish over composite materials; we only included products explicitly confirming MDF wood or real bamboo construction."
  }
];

export const guideSlug = "best-wood-standing-desk-converters";

export const guideTitle = "The Best Wood Standing Desk Converters for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Distinguished confirmed MDF wood from confirmed bamboo construction",
    "description": "These are different materials with different weight, scratch resistance, and moisture behavior, and we did not treat them as interchangeable."
  },
  {
    "title": "Required explicit material confirmation in the product listing",
    "description": "We prioritized products stating \"MDF wood\" or \"bamboo\" directly rather than assuming any converter with wood-adjacent branding uses solid material."
  },
  {
    "title": "Flagged one pick's unconfirmed material honestly",
    "description": "Where our specific data pull didn't confirm wood construction for a strong corner-desk option, we disclosed this rather than assuming it matched the other picks."
  },
  {
    "title": "Compared price within each confirmed material category separately",
    "description": "We noted value within the MDF wood group and the bamboo group separately, since these represent different cost structures."
  }
];

export const introParagraphs = [
  "\"Wood\" converter listings span different construction: MDF wood composite, real bamboo, and standard laminate finishes marketed with wood-adjacent branding. We checked what each product's listing actually confirms rather than assuming any wood-branded name means solid material.",
...
export const metaDescription = "We compared 5 wood standing desk converters on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Wood Standing Desk Converters for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Explicitly confirms MDF wood construction. On price, it's actually priced above TechOrbits Standing Desk Converter, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, MDF is heavier than metal-frame alternatives.",
    "specs": [
      "37 inch platform, confirmed MDF wood construction"
    ],
    "pros": [
      "Explicitly confirms MDF wood construction"
    ],
    "cons": [
      "MDF is heavier than metal-frame alternatives"
    ],
    "bestFor": "Buyers who want confirmed genuine MDF wood construction."
  },
  {
    "id": "b077z3gcdl-wood",
    "rank": 2,
    ...
    "description": "On the other side, Smaller platform than the 37 inch alternative.",
    "specs": [
      "32 inch platform, confirmed MDF wood construction"
    ],
    "pros": [
      "Lower price for confirmed MDF wood construction"
    ],
    "cons": [
      "Smaller platform than the 37 inch alternative"
    ],
  ...
  },
  {
    ...
    "description": "Explicitly labeled real bamboo rather than a wood-look laminate, a different material category from the MDF wood options.\n\nOn the other side, Bamboo has different scratch and moisture behavior than MDF wood.",
    "specs": [
      "32 inch platform, confirmed real bamboo construction"
    ],
    "pros": [
      "Confirmed real bamboo, not a laminate finish"
    ],
    "cons": [
      "Bamboo has different scratch and moisture behavior than MDF wood"
    ],
  ...
  },
  {
    ...
    "description": "This corner-desk converter's construction material was not explicitly confirmed as wood in our specific data pull; verify the exact material on the current listing before assuming it matches the wood options above.\n\nOn the other side, Construction material not explicitly confirmed as wood in our data, verify on listing.",
    "specs": [
      "38 inch corner platform",
      "Material composition not confirmed in our specific data"
    ],
    "pros": [
      "Strong review base for a corner-desk design"
    ],
    "cons": [
      "Construction material not explicitly confirmed as wood in our data, verify on listing"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-techorbits-standing-desk-converters",
    "title": "Best TechOrbits Standing Desk Converters (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Wood Standing Desk Converters";
