...
export const faq = [
  {
    "q": "Why does this guide only have two products?",
    "a": "Genuine marble desk clocks, confirmed real stone rather than a marble-look finish, are a narrow category. Our verified research found exactly two confirmed products, and we chose accuracy over padding the list."
  },
  {
    "q": "How do I know if a marble clock is real stone or just marble-look?",
    "a": "Check the listing for explicit language like real marble, natural stone, or hand carved. A marble-look or marble-style description often means a printed or resin finish instead."
  },
  {
    "q": "Which marble clock is the better value?",
    "a": "The Deluxe Round Black Marble Desk Mantle Clock offers genuine marble material at a lower price, while the Luxurious Marble Desk Clock offers higher craftsmanship."
  },
  {
    "q": "What if I want more premium material options than marble alone?",
    "a": "See our luxury desk clocks guide, which includes both marble picks here alongside glass and crystal options, or our crystal desk clocks guide for our verified crystal pick."
  }
];

export const guideSlug = "best-marble-desk-clocks";

export const guideTitle = "The Best Marble Desk Clocks for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Confirmed genuine marble material for both picks before including them",
    "description": "Verified real stone construction from listing details for both products, rather than including marble-look resin or printed-finish clocks that only resemble marble visually."
  },
  {
    "title": "Declined to pad this narrow category with marble-look alternatives",
    "description": "Kept this guide to exactly two confirmed genuine marble products rather than stretching the list with unverified or marble-printed items."
  },
  {
    "title": "Compared price and finish directly between the two verified picks",
    "description": "Placed the hand-carved premium piece and the more accessible round design side by side so buyers can weigh genuine material against price directly."
  },
  {
    "title": "Pointed toward the broader luxury guide for buyers wanting more material variety",
    "description": "Directed readers who want options beyond marble specifically to our luxury desk clocks guide, which includes both these picks alongside glass and crystal choices."
  }
];
...
export const metaDescription = "We compared 2 marble desk clocks on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Marble Desk Clocks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "This is a hand-carved marble piece, confirmed real stone construction rather than a marble-look finish, with a polished modern design that gives it real weight and presence. It's the clear premium choice between our two verified marble picks. On value, which is worth weighing if cost is your deciding factor between the two. On the other side, Verify current review data on the listing.",
    "specs": [
    ...
    "pros": [
      "Confirmed genuine hand-carved marble",
      "Substantial premium weight and presence",
      "Timeless polished design",
      "Strong gift or investment-piece quality"
    ],
    "cons": [
      "Higher price than the budget pick below",
      "Heavier, less practical to relocate often",
  ...
  },
  {
    ...
    "pros": [
      "Confirmed genuine marble material",
      "More accessible price than the premium pick",
      "Distinct round mantel-clock silhouette",
      "Gift-appropriate presentation"
    ],
    "cons": [
      "Less premium finish than the hand-carved pick",
      "Verify current price and review data on the listing",
      "Narrower selection since this category has few verified options"
    ],
...
export const breadcrumbLabel = "Best Marble Desk Clocks";
