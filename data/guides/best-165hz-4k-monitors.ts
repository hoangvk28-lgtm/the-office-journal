export const guideSlug = "best-165hz-4k-monitors";
export const guideTitle = "6 Best 165Hz 4K Monitors in 2026";
export const metaTitle = "Best 165Hz 4K Monitors";
export const metaDescription = "We compared 165hz 4k monitors models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage floor.";
export const mainKeyword = "165hz 4k monitors";
export const introParagraphs = [
  "Across best 165hz 4k monitors, span a wider range, given 165hz 4k monitors, few listings admit limits.",
  "165hz 4k monitors is judged here on true stand adjustability, because panel type sets real contrast and color."
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "New! Sceptre Curved 34-inch Prime Gaming Monitor 3440 x 1440 up to 240Hz 1500R is a budget-friendly pick that doesn't skip the essentials. Seamlessly link your devices to our two HDMI ports and two displayport providing up to 240hz refresh rate, ensuring not only versatile connectivity but also a buttery-smooth visual experience for both work and play. Whether you're at work or in the midst of an intense gaming session, our built-in speakers provide rich and seamless audio, all while keeping your desk clutter-free.\n\nProtect your eyes and enhance your comfort with blue-light shift technology, a detail worth checking closely before choosing between this and Dell 27 Monitor S2725QS.\n\nReach for this pick if you want a genuinely capable pick without paying for headroom you won't use. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "IPS (e.g. New! Sceptre Curved 34-inch Prime Gaming Monitor 3440 x 1440 up to 240Hz 1500R)",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-4k-monitors","title":"Best 4K Monitors in 2026"},{"href":"/guide/best-dual-4k-monitors","title":"Best Dual 4K Monitors in 2026"},{"href":"/guide/best-usb-c-4k-monitors","title":"Best USB-C 4K Monitors in 2026"},{"href":"/guide/best-hdr-4k-monitors","title":"Best HDR 4K Monitors in 2026"}];
