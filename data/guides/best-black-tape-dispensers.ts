...
export const guideTitle = "The Best Black Tape Dispensers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 black tape dispensers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Black Tape Dispensers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Built as a premium tape dispenser for desk with a stable heavy anti-skid base",
      "Works with tape rolls up to 1-1/8 inch wide",
      "Interchangeable 1 inch and 3 inch cores"
    ],
    "pros": [
      "Built as a premium tape dispenser for desk with a stable heavy anti-skid base",
      "Works with tape rolls up to 1-1/8 inch wide",
      "Interchangeable 1 inch and 3 inch cores",
      "Large weighted base helps reduce sliding"
    ],
    "cons": [
      "One-handed claims need real base weight to back them up",
      "Core spindle width is sized for a specific tape range"
...
export const breadcrumbLabel = "Best Black Tape Dispensers";
