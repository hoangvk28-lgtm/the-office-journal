...
export const faq = [
  {
    "q": "Does the display remain usable as a normal monitor if the embedded OS becomes outdated?",
    "a": "Most interactive displays with an HDMI or USB-C input can function as a standard external monitor for a connected computer even if the embedded Android system ages out of support, check the specific model's external-input behavior before assuming this fallback works."
  },
  {
    "q": "What's a good brightness level for a classroom or office interactive display?",
    "a": "Look for at least 350-400 nits for rooms with typical overhead lighting; rooms with significant natural window light benefit from 500+ nits or a strong anti-glare coating to stay readable without dimming the lights."
  },
  {
...
export const guideTitle = "The Best Display Interactive Whiteboards for Everyday Desk Work";
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "",
          "JASZDOT and JAV boards document over 400 nits"
        ],
        [
          "",
          "",
          "Common on NEWORK and similar current-gen boards"
        ],
        [
          "",
          "",
          "BIG VUE Plus documents this explicitly"
        ]
      ]
    }
  }
...
export const introParagraphs = [
  "The word display shifts focus to panel quality itself: brightness, contrast, viewing angle, and source-switching behavior, metrics generic interactive whiteboard comparisons often skip in favor of touch-point counts alone.",
  "We published brightness (in nits), documented viewing angle, and anti-glare treatment for every product here, and verified source switching between USB-C video/touch/power, HDMI plus USB touch, OPS input, and wireless casting as distinct display paths."
];
...
export const metaDescription = "How 8 display interactive whiteboards compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Display Interactive Whiteboards for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-display-interactive-whiteboards-1",
    "rank": 1,
    "badge": "Best Display Quality",
  ...
  {
    "id": "best-display-interactive-whiteboards-2",
    "rank": 2,
    "badge": "Best Viewing Angle (178-Degree)",
  ...
  {
    "id": "best-display-interactive-whiteboards-3",
    "rank": 3,
  ...
  {
    "id": "best-display-interactive-whiteboards-4",
    "rank": 4,
    "badge": "Best Camera-Integrated Display",
  ...
  {
    "id": "best-display-interactive-whiteboards-5",
    "rank": 5,
    "badge": "Budget Display Pick",
  ...
  {
    "id": "best-display-interactive-whiteboards-6",
    "rank": 6,
    "badge": "Best Large-Format Display",
  ...
  {
    "id": "best-display-interactive-whiteboards-7",
    "rank": 7,
    "badge": "Best Low-Latency Display",
  ...
  {
    "id": "best-display-interactive-whiteboards-8",
    "rank": 8,
    "badge": "Best High-Color Display (10.7B Colors)",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-touch-screen-interactive-whiteboards",
    "title": "8 Best Touch Screen Interactive Whiteboards"
  }
];

export const breadcrumbLabel = "Best Display Interactive Whiteboards";
