...
export const faq = [
  ...
  },
  {
    ...
    "a": "A 600dpi laser printer often produces sharper-looking text than a 1200dpi inkjet, because how toner sits on the page matters more for text clarity than the raw dot count. DPI is a more reliable comparison point for photo quality than for plain text."
  },
  {
...
export const guideTitle = "The Best Printers for Documents: Picks and Trade-offs";
...
export const introParagraphs = [
  ...
  "Below are 8 printers we compared specifically for document output, spanning a dedicated monochrome laser, several color laser and inkjet all-in-ones with document-friendly features like auto document feeders and duplex printing. We explain honestly why laser text tends to look sharper than inkjet even at a lower stated resolution, and which picks are the better long-term fit for legal or archival paperwork."
];
...
export const metaDescription = "A practical comparison of 8 printers for documents, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Printers for Documents (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "The PIXMA TR4720 brings an auto document feeder and built-in fax to a budget price, useful for a household that occasionally needs to scan or send a signed multi-page form without paying for a pricier office machine. Text quality is standard inkjet, fine for everyday paperwork but not the crispest option on this list.\n\nFor matte paper and standard letter documents it performs reliably; glossy finishes and heavy color coverage aren't its strength, so keep it to plain text and light color documents rather than anything archival or client-facing.\n\nBuilt-in fax for households that still need it.",
    "specs": [
      "Auto document feeder",
      "Built-in fax",
  ...
  },
  {
    ...
    "description": "42-inch OLED display and duplex printing for a household that only needs light, occasional document output. It won't match a laser's text sharpness, but for everyday letters, forms, and school paperwork the difference isn't noticeable at typical reading distance.\n\nMatte paper is the better choice for legibility with this or any inkjet in this list; glossy finishes introduce glare that makes dense text harder to read under overhead lighting.",
    "specs": [
      "1.42\" OLED display",
      "Duplex printing",
...
export const breadcrumbLabel = "Best Printers for Documents";
