...
const raw = readFileSync(resolve(ROOT, "scripts", "unique_asins_sdc.txt"), "utf-8");
...
writeFileSync(resolve(ROOT, "scripts", "data-sdc.json"), JSON.stringify(allItems, null, 2), "utf8");
...
writeFileSync(resolve(ROOT, "scripts", "lookup-sdc.json"), JSON.stringify(lookup, null, 2), "utf8");
console.log("Saved to scripts/data-sdc.json and scripts/lookup-sdc.json");
