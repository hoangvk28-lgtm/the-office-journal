export const guideSlug = "best-drawing-tablets-under-80";
export const guideTitle = "8 Best Drawing Tablets Under $80 in 2026";
export const metaTitle = "Best Drawing Tablets Under $80 in 2026";
export const metaDescription = "We compared best drawing tablets under $80 by verified current price and real capability, not just the price ceiling alone.";
export const mainKeyword = "drawing tablets under $80";
export const introParagraphs = [
  "Best Drawing Tablets Under $80 listings span a wide range of real capability even within the same price ceiling, and comparing them on price alone misses which picks actually meet the core use case.",
...
export const products: GuideProduct[] = [
  {
    id: "best-drawing-tablets-under-80-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-drawing-tablets-under-80-2",
    rank: 2,
  ...
  {
    id: "best-drawing-tablets-under-80-3",
    rank: 3,
  ...
  {
    id: "best-drawing-tablets-under-80-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-drawing-tablets-under-80-5",
    rank: 5,
  ...
  {
    id: "best-drawing-tablets-under-80-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-drawing-tablets-under-80-7",
    rank: 7,
  ...
  {
    id: "best-drawing-tablets-under-80-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howWeEvaluated = [
  {
    ...
    "description": "every primary recommendation must be new, in stock and up to $80 on the refresh date; expired sale pricing automatically disqualifies it."
  },
  {
    "title": "Budget-ladder map",
    "description": "show the next-lower tier, the upper-value screenless tier and the next-higher tier so this article has a distinct reason to exist."
  },
  {
  ...
  },
  {
    ...
    "description": "judge cables/stand/accessory ecosystem, warranty/support and ownership friction, then explicitly say when a buyer should spend less or exceed $80 for a meaningful upgrade."
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "By Priority Up to $80",
    "table": {
      "headers": [
        "If you mainly need",
        "Recommended pick"
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Ugee Drawing Tablet 6.5x4 Inches Computer Graphics Tablets with 10 Hot",
    ...
    "note": "Most buyers should default to Wacom Intuos Small unless your specific use case points toward Ugee Drawing Tablet 6.5x4 Inches Computer Graphics Tablets with 10 Hot's particular tradeoffs."
  },
  {
...
export const buyingCriteria = [
  {
    "criterion": "Build a dated US-new-retail qualifying pool at up to $80",
    "explanation": "Build a dated US-new-retail qualifying pool at up to $80. Separate normal price, sale/coupon price, refurbished/used listings and out-of-stock historical prices; include mandatory setup accessories in the minimum usable cost. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
    "criterion": "Define the upper-value screenless capability floor",
    "explanation": "Define the upper-value screenless capability floor: The tier should buy wireless, larger active area or better shortcuts rather than just a higher list price. Do not expand the list with products that fail the core category definition just to reach a target number of picks. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
    "criterion": "Make tablet architecture/active area + pen activation/line",
    "explanation": "Make tablet architecture/active area + pen activation/line stability the primary threshold-specific comparison. Explain what capability becomes newly available at $80 versus the next-lower budget. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
    "criterion": "Verify display quality if present + driver/OS/app support",
    "explanation": "Verify display quality if present + driver/OS/app support through current first-party documentation and repeatable measurements; explicitly identify which compromises are caused by staying under $80. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
    "criterion": "Evaluate cables/stand/accessory ecosystem and run this",
    "explanation": "Evaluate cables/stand/accessory ecosystem and run this protocol: Run slow diagonals/curves and edge accuracy with the same brush settings, verify driver install/mapping/sleep-wake, and for displays test color/parallax/cable requirements. Use the result to tell the reader whether spending close to $80 is justified or whether a cheaper tier already solves the same use case. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  }
];

export const faq = [
  {
    "q": "What should I check before buying from this best drawing tablets under $80 comparison?",
