...
export const guideTitle = "The Best Cheap TV Stands for Everyday Use";
export const metaTitle = "Best Cheap TV Stands for Home Offices (2026)";
export const metaDescription =
  "A practical comparison of 8 cheap TV stands, focused on features, build and practical fit, and the trade-offs between them.";
export const mainKeyword = "tv stand cheap";
export const introParagraphs = [
  "A cheap TV stand doesn't have to mean a flimsy one.",
  "Every pick below sits close to or under the $50 mark, so the differences that matter come down to weight capacity, TV size rating, storage style, and small extras like LED lighting or built-in outlets, not price. We compared the specs and buyer feedback for each to help you pick the right budget stand for your TV size and room.",
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "2 inches, which lets it fit TVs up to 55 inches, the largest screen size supported among the cheapest picks in this roundup. It keeps the same three open-tier layout, tool-free 10-minute assembly, and FSC-certified construction as the other Furinno stands here.\n\nAt 30 lbs of weight capacity it's built for a lighter flat-panel TV rather than an older, heavier set.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0CZMNHXLZ?tag=theofficejournal-20",
    description: "3 inches, and it carries the highest weight capacity among the Furinno lineup at 50 lbs, giving it more headroom for a TV plus accessories stacked on the open shelves. CARB-grade composite wood construction meets stricter formaldehyde emission standards than standard composite wood.\n\nThe clean white finish and 32-inch TV size rating make it a natural fit for a smaller bedroom or dorm TV setup that wants a lighter, brighter look than the brown or espresso finishes.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0D1C1X7R3?tag=theofficejournal-20",
    description: "The JARHETUN stand adds app-controlled LED lighting with 22 colors and 22 modes, the most customizable lighting in this entire roundup, none of the plainer Furinno or Furologee picks offer anything comparable. A single fabric drawer plus two open shelves round out the storage, and it's rated for TVs up to 55 inches. An anti-tip kit is included, a safety feature worth having if kids or pets are around the TV stand, and adjustable feet help it sit level on uneven flooring. It's the most expensive pick in this roundup, right at the edge of what most buyers would still call cheap, but the LED feature set justifies the small premium for buyers who want it. Anti-tip kit included for safety.",
...
export const faq: FaqItem[] = [
  {
    ...
    a: "4 stars, one of the most reviewed budget TV stands on Amazon. It's rated for TVs up to 50\", making it a solid fit for most bedroom and living room setups.",
  },
  {
    q: "Are cheap TV stands under $50 actually good quality?",
    a: "Several of them are, based on review volume. 5 stars, which is a large enough sample to trust the average. Budget stands do generally use composite wood rather than solid hardwood, so expect a lighter-duty build than a $300-plus solid wood stand.",
  },
  {
    q: "Can a cheap TV stand support a large TV?",
    a: "In this roundup, several picks including the Furinno wide Turn-S-Tube, the espresso 3-tier Furinno, and the Furologee soundbar-shelf stand are all rated for TVs up to 55\". Always check the specific size rating rather than assuming, since not every budget pick supports the largest screens.",
  },
  {
    q: "Do budget TV stands come with any warranty?",
    a: "Most picks in this roundup don't advertise a specific warranty beyond Amazon's standard return policy, so check the individual listing if warranty coverage matters to your decision.",
  },
  {
