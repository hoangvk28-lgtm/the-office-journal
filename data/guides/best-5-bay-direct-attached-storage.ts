...
export const introParagraphs = [
  ...
  "We compared ORICO's non-RAID and RAID 5-bay lines against Sabrent's dedicated-controller 5-bay dock, since these represent different engineering approaches to the same bay count."
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FH16Z53L?tag=theofficejournal-20",
    "description": "A 12V/10A power supply, notably higher-current than ORICO's other 5-bay models, supports simultaneous read/write across all 5 drives at up to 5Gbps (260MB/s real-world), with an 80mm quiet fan for cooling and extended device longevity.",
    "specs": [
      "5-bay, push-to-open design, up to 110TB",
      "12V/10A power supply",
      "5Gbps, 260MB/s real-world"
    ],
    "pros": [
      "Push-to-open design is more compact and modern-looking than magnetic covers",
      "Higher-current 12V/10A supply for stable 5-drive simultaneous operation",
      "260MB/s documented real-world speed, not just link-rate claim"
    ],
    "cons": [
      "Still capped at 5Gbps USB 3.1 Gen 1, not the newer 10Gbps tier",
      "Same Linux one-drive-at-a-time limitation as ORICO's other multi-bay units"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-4-bay-das-storage",
    "title": "8 Best 4-Bay DAS Storage Options"
  },
  {
    "href": "/guide/best-6-bay-direct-attached-storage",
    "title": "6 Best 6-Bay Direct-Attached Storage"
  },
  {
