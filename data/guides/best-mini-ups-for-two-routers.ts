...
export const faq = [
  {
    ...
    "a": "You can, but a splitter divides one rail's current between two devices rather than giving each router its own independent supply. If either router draws current close to the rail's rated maximum, splitting it can leave both routers underpowered. A unit with two separate rails is safer."
  }
];

export const guideSlug = "best-mini-ups-for-two-routers";

export const guideTitle = "The Best Mini UPS for Two Routers: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Simpler and covers standard router power needs without PoE complexity. 2Wh, VISLONE Mini UPS Battery Backup 13500mAh."
      }
    ],
...
export const introParagraphs = [
  "Running two routers off a single mini UPS is possible, but only if the unit provides independent simultaneous outputs at sufficient combined wattage, a splitter cable on a single rail doesn't guarantee either router gets the current it needs, especially if both routers draw current near the rail's maximum rating.",
...
export const metaDescription = "How 6 mini UPS for two routers compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const breadcrumbLabel = "Best Mini UPS for Two Routers";
