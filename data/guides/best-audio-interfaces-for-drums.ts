...
export const guideTitle = "The Best Audio Interfaces for Drums: Our Picks";
...
export const metaDescription = "How 8 audio interfaces for drums compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Audio Interfaces for Drums (2026)";
...
export const breadcrumbLabel = "Best Audio Interfaces for Drums";
