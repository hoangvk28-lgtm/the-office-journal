...
export const guideTitle = "The Best Arista Network Switches for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  ...
  "New Arista units are primarily sold through Arista's direct enterprise channel; the renewed listings here represent a different price point for buyers who specifically want Arista EOS software and data-center-grade build quality."
];
...
export const metaDescription = "A practical comparison of 3 arista network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Arista Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CC9XGQVX?tag=theofficejournal-20",
    ...
    "specs": [
      "48x 10G SFP+ ports, renewed",
      "Data-center-class Arista EOS",
      "Rack-mount chassis"
    ],
    "pros": [
      "48 ports of true 10G at renewed pricing",
      "Genuine Arista EOS enterprise software",
      "Data-center-grade build quality"
    ],
    "cons": [
      "Power and cooling demands built for data centers, not offices",
      "Licensing/support needs verification on renewed units"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0C9Y7C2BQ?tag=theofficejournal-20",
    ...
    "specs": [
      "52x 10GbE SFP+, Layer 3, renewed",
      "Dual PSU redundancy",
      "Back-to-front airflow"
    ],
    "pros": [
      "Layer 3 routing at full 10GbE across 52 ports",
      "Dual power supply redundancy",
      "Data-center-grade airflow design"
    ],
    "cons": [
      "Loud active cooling built for data center environments",
      "Significant power draw for home use"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-juniper-network-switches",
    "title": "5 Best Juniper Network Switches in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Arista Network Switches";
