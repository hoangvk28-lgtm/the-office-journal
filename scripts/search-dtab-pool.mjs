...
const queries = [
  "budget drawing tablet with screen under 100",
  "drawing tablet with screen pen display",
  "cheap small drawing tablet with screen",
];
const pool = {};
...
writeFileSync(resolve(ROOT, "/tmp/dtab_pool.json"), JSON.stringify(pool, null, 2));
