...
export const guideTitle = "The Best Wacom Drawing Tablets for a Better Desk Setup";
...
export const metaDescription = "We compared 5 wacom drawing tablets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Wacom Drawing Tablets for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-huion-drawing-tablets",
    "title": "Best Huion Drawing Tablets in 2026"
  }
];

export const breadcrumbLabel = "Best Wacom Drawing Tablets";
