...
export const faq = [
  {
    "q": "Is a 600VA UPS enough to protect a full desktop computer?",
    "a": "Generally not on its own with a monitor and peripherals attached. A 600VA rating typically provides only 325-360W of real usable capacity, appropriate for a single low-power PC, router, or NAS, size up to 850VA or 1000VA for a full desktop setup."
  },
  {
    "q": "How long will a 600VA UPS keep my equipment running during an outage?",
    "a": "Expect a few minutes of runtime under real load, enough to save your work and shut down cleanly, not to keep working through an extended outage."
  },
  {
    "q": "Do 600VA UPS units include AVR?",
    "a": "Some budget picks are standby-only, while others (like the Tripp Lite AVR550U in this guide) include AVR for in-line brownout correction, check the specific model rather than assuming all 600VA units are equivalent."
  },
  {
    "q": "What's the difference between 600VA and 850VA UPS units?",
    "a": "The real usable wattage difference is meaningful, roughly 325-360W at 600VA versus 450-510W at 850VA, enough to matter if you're protecting anything beyond a single low-power device."
  }
];

export const guideSlug = "best-600va-ups-battery-backups";

export const guideTitle = "The Best 600VA UPS Battery Backups for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Real watts, not the 600VA label, as the sizing baseline",
    "description": "Checked the actual watt rating on each pick, since a 600VA rating typically translates to around 325-360W of real usable capacity depending on the specific design's power factor."
  },
  {
    "title": "Appropriate use-case matching for this capacity tier",
    "description": "Confirmed each pick is suited to a single low-power device (router, NAS, basic PC) rather than a full desktop, since 600VA is an entry tier, not a general-purpose capacity."
  },
  {
    "title": "AVR and outlet count as real differentiators at the budget tier",
    "description": "Distinguished picks offering AVR brownout correction or above-average outlet counts from basic standby-only designs, since these are genuine feature differences even within the same capacity class."
  }
];

export const introParagraphs = [
  "A 600VA rating typically translates to around 330-360W of real usable capacity due to the power factor of most UPS designs, appropriate for a single low-power PC, router, or NAS device, not a full desktop with a monitor and peripherals.",
...
export const metaDescription = "We compared 5 600VA UPS battery backups on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 600VA UPS Battery Backups for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      ...
      "Standard replaceable battery",
      "Well-suited to a single low-power device"
    ],
    "cons": [
      "330W real capacity, not for a full desktop with monitor",
      "Short runtime under any real load",
      "Not pure sine wave"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B00DBAAJQ6?tag=theofficejournal-20",
    "description": "CyberPower's 'Ecologic' line focuses on reduced standby power draw, worth considering if you're optimizing for 24/7 energy cost at this capacity tier rather than just upfront price. LCD display shows load and runtime.\n\nSame realistic capacity expectation as every 600VA pick here, enough for a single low-power device, not a full desktop.",
    "specs": [
      "600VA class, Ecologic reduced standby draw",
      "LCD display",
      "Surge protection",
      "Compact"
    ],
    "pros": [
      "Reduced standby power draw versus standard designs",
    ...
    "cons": [
      "Not pure sine wave",
      "Real capacity still modest at this tier",
      "Fewer outlets than higher-capacity picks"
    ],
  ...
  },
  {
    ...
    "pros": [
      "10 outlets, more than most competitors at this capacity",
      "3-year warranty with substantial connected-equipment insurance",
      "Solid rating base",
      "Reasonable price"
    ],
    "cons": [
      "325W real capacity, appropriate only for low-power devices",
      "Not pure sine wave",
      "Short runtime under real load"
    ],
  ...
  },
  {
    ...
    "description": "An affordable standby-topology option at this capacity, appropriate if your only need is basic outage protection for a router or single low-power device rather than a PC with any real headroom.\n\nStandby topology means it switches to battery on any sag rather than correcting voltage in-line, a real limitation to understand at this budget tier.",
    "specs": [
      "625VA class, standby topology",
      "Surge protection",
      "Compact",
      "low-cost"
    ],
    "pros": [
      "Very affordable at this capacity tier",
      "Solid rating base",
      "Compact footprint",
      "Adequate for basic router/device protection"
    ],
    "cons": [
      "Standby topology only, no AVR or in-line correction",
      "Least real headroom among the 600VA picks",
      "Not suited to any device with real power demands"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B000BMBT4I?tag=theofficejournal-20",
    "description": "AVR included at this budget capacity tier, correcting minor brownouts in-line without draining the battery, useful over the ST625U's basic standby-only design. 8 outlets and dataline protection round out a well-equipped budget pick.\n\n8 outlets, dataline protection included.",
    "specs": [
      "550VA class, AVR included",
      "8 outlets, dataline protection",
      "3-Year warranty with insurance",
      "Compact"
    ],
    "pros": [
      "AVR included, a real step up from basic standby designs at this price",
      "8 outlets, dataline protection included",
      "Warranty with connected-equipment insurance",
      "Reasonable price"
    ],
    "cons": [
      "Lowest capacity among the 600VA-class picks",
      "Not pure sine wave"
    ],
...
export const breadcrumbLabel = "Best 600VA UPS Battery Backups";
