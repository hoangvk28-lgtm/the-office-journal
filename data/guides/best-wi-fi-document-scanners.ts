...
export const faq = [
  {
    "q": "Do Wi-Fi scanners work standalone, or do I need a computer on?",
    "a": "It depends on the destination. Scan-to-cloud typically works standalone; scan-to-folder generally requires a host PC running scanning software to remain on and network-discoverable. Verify which destination type your workflow needs."
  },
  {
    "q": "Will my Wi-Fi scanner work on my company's corporate network?",
    "a": "1X) networks using certificate-based authentication are frequently unsupported by consumer-grade Wi-Fi scanners, none of the picks in this guide explicitly confirm this compatibility, check with IT."
  },
  {
    "q": "Does Wi-Fi 6 make a real difference for a document scanner?",
    "a": "Yes, in crowded wireless environments. 4GHz-only scanners in busy home or office networks."
  },
  {
    "q": "Where should I place a Wi-Fi scanner for the best connection?",
    "a": "Avoid closets, behind monitors, or low shelves. Consumer scanner Wi-Fi antennas are weaker than router-grade hardware, and placement meaningfully affects real-world range and reliability."
  }
];

export const guideSlug = "best-wi-fi-document-scanners";

export const guideTitle = "The Best Wi-Fi Document Scanners for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Distinguished picks that operate standalone for cloud destinations from the likely requirement that scan-to-folder needs a host PC to remain on and network-discoverable, a distinction Wi-Fi marketing rarely clarifies."
  },
  {
    "title": "",
    "description": ""
  ...
  {
    "title": "",
    "description": "Flagged that none of the picks in this guide explicitly confirm compatibility with enterprise authentication (certificate-based, not just a shared password), a real gap for corporate/university network buyers."
  }
];
...
export const introParagraphs = [
  ...
  "1X) corporate/university networks are frequently unsupported by consumer-grade Wi-Fi scanners, requiring IT-assisted workarounds or a dedicated guest network, an environment-specific compatibility gap worth verifying before buying for an office setting."
];
...
export const metaDescription = "A practical comparison of 7 wi-fi document scanners, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Wi-Fi Document Scanners for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "4GHz environment than single-band scanners, useful in a busy home or office Wi-Fi setup. Scans to cloud services standalone, no destination computer needs to stay on for that path specifically.\n\n1X) corporate network compatibility isn't explicitly confirmed, verify with IT if you're deploying this on a university or corporate network with certificate-based authentication.\n\nStandalone scan-to-cloud doesn't require a host PC to stay on. 1X compatibility not explicitly confirmed.",
    "specs": [
      "Wi-Fi 6, dual-band capable",
      "Standalone scan-to-cloud",
      "Touchscreen with personalized profiles",
      "USB-C fallback available"
    ],
    "pros": [
      "Wi-Fi 6 handles crowded wireless environments better than single-band",
      "Standalone scan-to-cloud doesn't require a host PC to stay on",
      "Touchscreen for on-device destination selection",
      "USB-C fallback for large batches"
    ],
    "cons": [
      "WPA2-Enterprise/802.1X compatibility not explicitly confirmed",
      "Smaller review count, newer listing",
      "Scan-to-folder (vs. cloud) likely still requires a host PC on"
    ],
  ...
  },
  {
    ...
    "description": "The same Wi-Fi 6 iX2500 under a separate listing. Same standalone cloud scanning, same corporate-network caveat, and same USB-C fallback. Compare current pricing against the rank-1 listing before buying.",
    "specs": [
      "Wi-Fi 6, dual-band capable",
      "Standalone scan-to-cloud",
      "Touchscreen with personalized profiles",
    ...
    "pros": [
      "Same Wi-Fi 6 capability as the rank-1 listing",
      "Standalone cloud scanning",
      "Touchscreen control",
      "USB-C fallback"
    ],
    "cons": [
      "Smallest review count in this guide",
      "Same unconfirmed 802.1X compatibility",
      "Same likely host-PC requirement for folder scanning"
    ],
  ...
  },
  {
    ...
    "description": "Home-network Wi-Fi with genuine standalone operation for cloud destinations, and Chromebook scanning via the mobile app, a real plus for Chromebook-heavy Wi-Fi networks like classrooms. If you're scanning to a network folder rather than cloud, expect the destination computer to need to stay on and network-discoverable.\n\nSame WPA2-Enterprise caveat as every pick in this guide, verify with IT for corporate/university deployment.\n\nChromebook support via mobile app. Both are worth keeping in mind before deciding.",
    "specs": [
      "Home-network Wi-Fi",
      "Standalone scan-to-cloud, Chromebook support",
      "30ppm duplex",
      "Auto de-skew, color optimization"
    ],
    "pros": [
      "Standalone cloud scanning without a host PC",
      "Chromebook support via mobile app",
      "30ppm duplex speed",
      "Reasonable price for the capability"
    ],
    "cons": [
      "Scan-to-folder likely requires host PC to stay on and be discoverable",
      "802.1X enterprise network compatibility unconfirmed",
      "Single-band Wi-Fi, more interference-prone than Wi-Fi 6"
    ],
  ...
  },
  {
    ...
    "description": "Identical Wi-Fi capability to the rank-3 pick in a black finish, same standalone cloud scanning and Chromebook support, same scan-to-folder host-PC caveat and unconfirmed 802.1X compatibility.",
    "specs": [
      "Home-network Wi-Fi",
      "Standalone scan-to-cloud, Chromebook support",
      "30ppm duplex",
    ...
    "pros": [
      "Same standalone cloud scanning as the white version",
      "Chromebook support via mobile app",
      "Black finish option",
      "30ppm duplex speed"
    ],
    "cons": [
      "Same scan-to-folder host-PC requirement",
      "Same unconfirmed 802.1X compatibility",
      "Single-band Wi-Fi"
    ],
  ...
  },
  {
    ...
    "description": "Whether this scans standalone to cloud or requires a host PC for folder destinations isn't explicitly broken out in the listing, verify your specific workflow's destination type before assuming standalone operation.\n\nA reasonable choice if desktop-class throughput matters more than the standalone-vs-host-PC distinction to your specific use case.\n\nHost-PC-required scan destinations not explicitly broken out.",
    "specs": [
      "Home-network Wi-Fi + USB desktop scanner",
      "TWAIN driver, searchable PDF OCR",
      "Auto crop, blank-page removal"
    ],
    "pros": [
      "Desktop-class throughput over Wi-Fi",
      "TWAIN driver for document management compatibility",
      "Searchable PDF OCR included"
    ],
    "cons": [
      "Standalone vs. host-PC-required scan destinations not explicitly broken out",
      "Highest price in this guide",
      "802.1X enterprise compatibility unconfirmed"
    ],
  ...
  },
  {
    ...
    "description": "Included as an honest reference: this is USB-powered only, no Wi-Fi, despite surfacing in general scanner search results touching on this topic. If Wi-Fi specifically is your requirement, look to the ScanSnap or Epson picks above instead.\n\nA capable compact scanner if wired USB actually suits your workflow better, sidestepping every Wi-Fi caveat in this guide entirely.\n\nThat said, not actually a Wi-Fi scanner.",
    "specs": [
      "USB-powered only, no Wi-Fi",
      "Broad Windows/Mac/Linux driver support",
      "Color scan speed matches black-and-white",
      "Compact, 1.5 lb"
    ],
    "pros": [
      "No Wi-Fi means no host-PC or network-compatibility questions at all",
      "Broad OS driver support",
      "compact"
    ],
    "cons": [
      "Not actually a Wi-Fi scanner",
      "Single-sheet feed limits batch capability",
      "Included only as an honest wired alternative"
    ],
  ...
  },
  {
    ...
    "description": "Another honest wired reference: this desktop scanner has no Wi-Fi at all, a genuine option if you'd rather sidestep every Wi-Fi network compatibility question and just connect directly via USB. Highest rating in this guide.\n\nIf your priority shifted to wired reliability while reading this guide, this is a strong desktop-class alternative.",
    "specs": [
      "USB-powered only, no Wi-Fi",
      "TWAIN driver, searchable PDF OCR",
      "50-sheet ADF, duplex",
    ...
    "pros": [
      "Highest rating in this guide",
      "No Wi-Fi network compatibility questions at all",
      "Genuine duplex ADF for sustained batch work",
      "TWAIN driver for document management"
    ],
    "cons": [
      "Not actually a Wi-Fi scanner",
      "Included only as an honest wired alternative",
      "Desktop footprint, no Wi-Fi flexibility"
    ],
...
export const breadcrumbLabel = "Best Wi-Fi Document Scanners";
