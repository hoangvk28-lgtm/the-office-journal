...
export const guideTitle = "The Best Budget Gaming Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 budget gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Budget Gaming Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Budget Gaming Monitors";
