...
export const faq = [
  {
    "q": "How secure are these locks really?",
    "a": "These are deterrent-level locks appropriate for preventing casual access, not safe-grade security against a determined person with tools. For truly sensitive documents, consider a dedicated fireproof safe instead."
  },
  {
    "q": "What happens if I lose the key to a lockable file box?",
    "a": "You'll generally need to replace the entire lock mechanism, since these boxes don't typically offer a backup key or professional locksmith reset process like a home lock would."
  },
  {
    "q": "Is a combination lock better than a key lock?",
    "a": "It avoids lost-key risk since you set your own code, but a forgotten combination requires its own reset process. Neither is meaningfully more secure than the other against determined tampering."
  },
  {
    "q": "Is a 'lockable' file box actually locked, or just a secure latch?",
    "a": "Some listings use 'lockable' loosely for a secure double-latch closure rather than a genuine key or combination lock. Check the specific product description to confirm."
  },
  {
    "q": "Which pick offers the most security against prying?",
    "a": "The Vaultz Dual Lock pick uses two separate locking points, more resistant to prying open at a single weak point than a single-lock design."
  }
];

export const guideSlug = "best-lockable-portable-file-boxes";

export const guideTitle = "The Best Lockable Portable File Boxes for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We identified whether each pick uses a genuine key lock, combination lock, or basic latch marketed loosely as 'lockable,' since these represent very different actual security levels."
  },
  {
    "title": "",
    "description": "We were explicit that these are deterrent-level locks appropriate for casual access prevention, not safe-grade security against determined tampering."
  },
  {
    "title": "",
    "description": "We considered the practical risk of a lost key or forgotten combination, and whether a backup or reset process exists."
  },
  {
    "title": "Lock durability under repeated use",
    "description": "We noted lock placement and mechanism durability under repeated locking and unlocking cycles for long-term reliability."
  }
];
...
export const metaDescription = "A practical comparison of 5 lockable portable file boxes, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Lockable Portable File Boxes for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Vaultz specializes in locking storage products, and this box's key lock mechanism is more robust than a basic latch, appropriate for deterring casual access to sensitive documents at home or in a shared office.\n\nGenuine key lock, not just a latch. On price, it comes in below Vaultz Portable File Box with Handle, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Key loss requires a replacement lock, not a simple reset.",
    "specs": [
      "Key lock mechanism",
      "Letter size",
    ...
    "pros": [
      "Genuine key lock, not just a latch",
    ...
    "cons": [
      ...
      "Key loss requires a replacement lock, not a simple reset"
    ],
  ...
  },
  {
    ...
    "description": "This premium Vaultz box uses two separate locking points rather than one, more resistant to prying open at a single weak point than a single-lock design, at the highest price in this comparison.\n\nOn the other side, Heavier overall construction.",
    "specs": [
      "Dual lock mechanism",
    ...
    "pros": [
      "Dual locking points more prying-resistant",
  ...
  },
  {
    ...
    "pros": [
      "No lost-key risk with a combination lock",
      "You set your own code",
      "Dual combination points",
      "Reasonable price"
    ],
    "cons": [
      "Smaller review count than the Vaultz picks",
      "Forgotten combination requires a reset process",
      "Not safe-grade security"
    ],
  ...
  },
  {
    ...
    "cons": [
      "Not a genuine key or combination lock",
      "Only deters accidental opening, not intentional access",
      "Misleading if you specifically need real security"
    ],
  ...
  },
  {
    ...
    "description": "Honesty note: also not a genuine lock, this double-latch closure is more secure against accidental opening than a single latch, but doesn't restrict deliberate access the way a key or combination lock does.\n\nOn the other side, Doesn't restrict deliberate access.",
    "specs": [
      "Double latch, not a genuine lock",
      "Hinged lid",
      "Letter size",
      "Strong rating"
    ],
    "pros": [
      "Double latch more secure than a single closure",
      "Strong rating",
      "Hinged lid can't be lost",
      "Genuine hanging file rails"
    ],
    "cons": [
      "Not a genuine key or combination lock",
      "Letter size only",
      "Doesn't restrict deliberate access"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-portable-file-boxes-with-lockable-lids",
    "title": "Best Portable File Boxes with Lockable Lids (2026)"
  }
];

export const breadcrumbLabel = "Best Lockable Portable File Boxes";
