...
export const buyingCriteria = [
  ...
  {
    "criterion": "Mode An and Mode B Passive PoE Pin Configurations Can Matter Even for a Simple Budget Injector",
  ...
  },
  {
    ...
    "explanation": "This matters if your specific device's power draw is uncertain or near the upper end of what a basic passive injector provides, and matters less if you've already confirmed your device draws well within either ceiling. Check your device's actual stated power draw against the specific wattage ceiling of a budget injector before assuming any budget pick provides equivalent headroom."
  }
];

export const faq = [
  {
    "q": "Is the cheapest PoE injector always the best value?",
    "a": "Not necessarily; the lowest-priced pick in this comparison caps at 100Mbps while other budget options offer full Gigabit speed for just a few dollars more, so check the port speed before assuming the lowest price is the best deal."
  },
  {
    "q": "What certifications should I look for on a budget PoE injector?",
    "a": "UL, CE, and FCC are the most commonly cited independent certification marks, and a listing that names all three provides more documented safety assurance than one with no stated certification."
  },
  {
  ...
  {
    "q": "Can a budget PoE injector power a Gigabit IP camera?",
    "a": "Yes, as long as the specific injector states Gigabit port speed rather than 100Mbps, which most budget options in this comparison do at only a modest price premium over the cheapest 100Mbps alternative."
  },
  {
    "q": "Is a recognized brand name worth paying more for at the budget tier?",
    "a": "A recognized brand like TP-Link often provides more consistent quality control and support availability, though several lesser-known brands in this comparison still deliver reliable performance at a similar or lower price."
  },
  {
    "q": "Do I need a higher wattage budget injector if my device's power draw is uncertain?",
    "a": ""
  }
];
...
export const guideTitle = "The Best Budget PoE Injectors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Recognized brand, higher power ceiling",
          ""
        ],
        [
          "",
          "PoE Texas Single-Port Mode A 48V 15W"
        ],
        [
          "",
          "PoE Texas Single-Port Mode B 48V 15W"
        ],
        [
          "",
          "15V 1A Passive PoE Injector 2-Port"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Gigabit (TP-Link, both PoE Texas picks)",
        "text": "Worth the modest price premium for most standard-definition to mid-resolution IP cameras and access points at this budget tier."
      },
      {
        "label": "",
        "text": "Acceptable only for a low-bandwidth device where the absolute lowest price outweighs the speed limitation."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "UL, CE, and FCC certification named",
          "PoE Texas Single-Port Mode A 48V 15W"
        ],
        [
          "",
          "TP-Link TL-PI4818G or the ultra-budget pick"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A stated Gigabit port speed and at minimum a named brand or basic electrical protection list, since the very cheapest options can sacrifice both speed and certification to hit the lowest possible price."
      },
      {
        "label": "",
        "text": "The TP-Link pick balances a recognized brand name, Gigabit speed, and a competitive budget price, a reasonable default for a first-time buyer."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want documented UL/CE/FCC certification or Mode B negotiation for a specific device, where the PoE Texas picks near $14-17 justify their price with those specific features."
      },
      {
        "label": "",
        "text": "09 ultra-budget pick covers that specific need."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared Gigabit versus 100Mbps port speeds across similarly priced budget listings."
  },
  {
    "title": "",
    "description": "Compared listings naming specific UL, CE, or FCC certification against those with no stated certification."
  },
  {
    "title": "",
    "description": "Compared stated wattage output relative to price across the budget tier."
  },
  {
    "title": "",
    "description": "Compared integrated wall-mount designs against separate power brick designs."
  },
  {
    "title": "",
    "description": "Compared price against the combination of speed, certification, and power ceiling rather than price alone."
  }
];
...
export const metaDescription = "A practical comparison of 4 budget PoE injectors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Budget PoE Injectors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DZHDY4DK?tag=theofficejournal-20",
    ...
    "specs": [
      "48V, 18W passive PoE",
      "Gigabit input/output ports",
      "Up to 328ft (100m) range"
    ],
    "pros": [
      "Recognized TP-Link brand at a budget price",
      "18W power ceiling, higher than most similarly priced picks",
      "Gigabit speed avoids a Fast Ethernet bottleneck"
    ],
    "cons": [
      "Passive PoE only, no standard 802.3af/at negotiation",
      "No stated UL/CE/FCC certification marks"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B01MXX79ZI?tag=theofficejournal-20",
    ...
    "specs": [
      "48V, 15W passive PoE",
      "UL, CE, FCC certified",
      "Gigabit data, compact single-outlet form factor"
    ],
    "pros": [
      "Only pick in this comparison with UL, CE, and FCC certification named",
      "Compact form factor fits a single electrical outlet space",
      "Gigabit speed at a budget price"
    ],
    "cons": [
      "Slightly lower power ceiling than the TP-Link pick",
      "Passive PoE only, no standard negotiation"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B086DWNV9G?tag=theofficejournal-20",
    ...
    "specs": [
      "48V, 15W passive PoE, Mode B negotiation",
      "Gigabit data, up to 328ft range",
      "One year replacement warranty"
    ],
    "pros": [
      "Integrated wall-mount design avoids a separate dangling power brick",
      "Gigabit speed at a budget price",
      "One year warranty with phone support"
    ],
    "cons": [
      "Highest price among the single-port budget picks",
      "No stated UL/CE/FCC certification unlike the Mode A pick"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0C77P61LT?tag=theofficejournal-20",
    ...
    "specs": [
      "15V 1A output, 100Mbps only",
      "Multiple stated electrical protections",
      "ABS fire retardant shell"
    ],
    "pros": [
      "Lowest price in this comparison by a wide margin",
      "Multiple stated electrical protections despite the low price",
      "Fire retardant ABS shell construction"
    ],
    "cons": [
      "100Mbps only, not Gigabit like the other three picks",
      "15V output, not the standard 48V most PoE devices expect"
    ],
...
export const breadcrumbLabel = "Best Budget PoE Injectors";
