...
const allAsins = [
"B0F1NFXV1H","B08FCGM12Y","B0F9L5D9R2","B0FJLK2894","B08F9MPCKR","B09TVK5GN6","B0BN434Q85","B0H4ZGPJJK",
"B01469DJLM","B0C2QF44J5","B0DDSZP449","B09CYK6C93","B0B5QT3197","B0C69BVWGB","B07JJTMR7R",
"B08ZY7X4CR","B071JB9WYB","B07R659J8Z","B07CNJ4DYX","B0FJ24T3KM","B0FQMP5ZF8","B07V2KVQB7","B0GJJ6P1FT",
"B0788H4TG1","B0FJ7Y31NN",
];
...
writeFileSync(resolve(ROOT, "scripts", "data-mini-pc-cooling.json"), JSON.stringify(allItems, null, 2), "utf8");
...
writeFileSync(resolve(ROOT, "scripts", "lookup-mini-pc-cooling.json"), JSON.stringify(lookup, null, 2), "utf8");
console.log("Saved to scripts/data-mini-pc-cooling.json and scripts/lookup-mini-pc-cooling.json");
