...
export const guideTitle = "The Best Desk Fans Under $150: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "KONSIDEN Bladeless Desk Fan for Office)",
...
export const metaDescription = "How 6 desk fans under $150 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Desk Fans Under $150 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Bladeless for maximum safety",
      "90° Swing and 8 wind speeds : our bladeless fan efficiently distributes sufficient air circulation",
      "35Db noise and 9-hour timer : this oscillating fan is very quiet and smooth"
    ],
    "pros": [
      "Bladeless for maximum safety",
      "90° Swing and 8 wind speeds : our bladeless fan efficiently distributes sufficient air circulation",
...
export const breadcrumbLabel = "Best Desk Fans Under $150";
