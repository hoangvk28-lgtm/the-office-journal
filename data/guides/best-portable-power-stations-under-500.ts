...
export const buyingCriteria = [
  ...
  {
    "criterion": "Define the mid-capacity capability floor",
    "explanation": "Define the mid-capacity capability floor: Current Explorer 600 v2 around $429 fits; ~600Wh-class storage and 500W-class output become plausible. Do not expand the list with products that fail the core category definition just to reach a target number of picks. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
...
export const faq = [
  {
    "q": "What should I check before buying from this best portable power stations under $500 comparison?",
