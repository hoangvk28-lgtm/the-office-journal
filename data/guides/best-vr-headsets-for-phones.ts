...
export const guideTitle = "The Best VR Headsets for Phones: Our Picks";
...
export const metaDescription = "How 6 VR headsets for phones compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best VR Headsets for Phones (2026)";
...
export const breadcrumbLabel = "Best VR Headsets for Phones";
