...
export const guideTitle = "The Best Oak Floating Shelves for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "RICHFOCUS 72Inch Floating Shelves for Wall 2Pack)",
        "text": "Highest weight capacity, but requires drilling into a wall stud."
      },
      {
        "label": "Fun Memories Floating Shelves for Wall)",
...
export const metaDescription = "How 5 oak floating shelves compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Oak Floating Shelves for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Heavy-duty floating wood shelf",
      "Wide wooden wall shelves"
    ],
    "pros": [
      "Solid wood floating shelves",
      "Heavy-duty floating wood shelf",
      "Wide wooden wall shelves",
      "Wall mount floating wall shelves"
    ],
    "cons": [
      "Drywall anchors alone only safely hold up to 20 to 25 lbs",
      "Real weight capacity depends on stud spacing, not the shelf itself"
...
export const breadcrumbLabel = "Best Oak Floating Shelves";
