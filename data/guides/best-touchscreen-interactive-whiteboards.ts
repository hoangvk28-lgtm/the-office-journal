...
export const guideTitle = "The Best Touchscreen Interactive Whiteboards for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 touchscreen interactive whiteboards, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Touchscreen Interactive Whiteboards for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Touchscreen Interactive Whiteboards";
