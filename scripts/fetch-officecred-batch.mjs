...
const allAsins = JSON.parse(readFileSync(resolve(ROOT, "scripts", "unique_asins_officecred.txt"), "utf8"));
...
writeFileSync(resolve(ROOT, "scripts", "data-officecred.json"), JSON.stringify(allItems, null, 2), "utf8");
console.log("Saved to scripts/data-officecred.json");
