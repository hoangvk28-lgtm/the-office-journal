...
export const introParagraphs = [
  "Compactness genuinely varies across this category: TP-Link's UE300C measures a specific 2.8 x 1.0 x 0.6in and folds flat, while several competitors don't publish exact dimensions at all, making direct size comparison difficult without physically measuring.",
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "Published Dimensions Matter",
    "intro": "TP-Link's UE300C is the only adapter in this comparison with explicit published dimensions (2.8 x 1.0 x 0.6in), letting you confirm it fits your travel bag or laptop sleeve exactly. Other adapters describe themselves as \"compact\" without a number to verify."
  }
];
...
export const faq = [
  {
    ...
    "a": "Not necessarily for Gigabit-tier adapters, they're simple enough that size doesn't meaningfully affect thermal performance. It becomes more relevant at 2.5G/5G/10G speeds, where a larger aluminum body can help dissipate heat during sustained transfers."
  }
];

export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-usb-c-ethernet-adapters-for-macbook-air","title":"8 Best USB-C Ethernet Adapters for MacBook Air"},{"href":"/guide/best-usb-c-to-gigabit-ethernet-adapters","title":"8 Best USB-C to Gigabit Ethernet Adapters"},{"href":"/guide/best-usb-c-to-ethernet-adapters","title":"8 Best USB-C to Ethernet Adapters in 2026"}];
