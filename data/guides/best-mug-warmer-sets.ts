...
export const guideTitle = "The Best Mug Warmer Sets for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Cosori Coffee Mug Warmer & Mug Set)",
...
export const metaDescription = "A practical comparison of 6 mug warmer sets, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Mug Warmer Sets for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Mug Warmer Sets";
