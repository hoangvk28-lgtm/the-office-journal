...
export const guideTitle = "The Best Dangbei Projectors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Dangbei MP1 MAX Triple Laser Projector 4K)",
...
export const metaDescription = "How 8 dangbei projectors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Dangbei Projectors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Ultra-bright 4K visuals",
      "Ultimate smart integration with google tv",
    ...
    "pros": [
      ...
      "Ultimate smart integration with google tv",
      "Immersive 3d entertainment",
      "Cinematic sound & versatile connectivity"
    ],
    "cons": [
      "Throw ratio needs checking against your room distance",
      "Marketed lumens and true ANSI lumens often differ"
  ...
  },
  {
    ...
    "specs": [
      ...
      "Flexible placement with built-in adjustable stand"
    ],
    "pros": [
      "True 4K integration",
      "Adaptive ai optimization",
  ...
  },
  {
    ...
    "specs": [
      "Experience stunning 4K uhd (3840x2160) clarity",
      "Google tv streaming hub",
      "Instanpro ai setup - well suited image automatically"
    ],
    "pros": [
      "Experience stunning 4K uhd (3840x2160) clarity",
      "Google tv streaming hub",
      "Instanpro ai setup - well suited image automatically",
      "Dolby audio & dual 12w theater sound"
    ],
    "cons": [
      "Throw ratio needs checking against your room distance",
      "Marketed lumens and true ANSI lumens often differ"
  ...
  },
  {
    ...
    "specs": [
      "Built on the exclusive vidaa os",
      "Powered by true 1000 iso lumens",
      "Sealed optical engine & high-efficiency cooling"
    ],
    "pros": [
      "Built on the exclusive vidaa os",
      "Powered by true 1000 iso lumens",
      "Sealed optical engine & high-efficiency cooling",
      "Instanpro ai smart setup with eye care"
    ],
    "cons": [
      "Marketed lumens and true ANSI lumens often differ",
      "Throw ratio needs checking against your room distance"
  ...
  },
  {
    ...
    "specs": [
      "190° tilt freedom, zero clutter: this mini",
      "Netflix ready, stream with a click",
      "True 1080p, up to 120\" large screen"
    ],
    "pros": [
      "190° tilt freedom, zero clutter: this mini",
      "Netflix ready, stream with a click",
      "True 1080p, up to 120\" large screen",
      "Ai image setup, effortless viewing"
    ],
    "cons": [
      "Throw ratio needs checking against your room distance",
      "Marketed lumens and true ANSI lumens often differ"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Advanced alpd technology",
      "Smart screen adjustment",
      "Dual 10w speakers, dolby audio&dts HD"
    ],
    "cons": [
      "Marketed lumens and true ANSI lumens often differ",
      "Throw ratio needs checking against your room distance"
...
export const breadcrumbLabel = "Best Dangbei Projectors";
