...
export const introParagraphs = [
  "Best Dimmable Ring Lights cover a wide range of sizes and brightness claims. That means marketing copy alone is risky.",
  "This roundup weighs true size versus your actual distance, given that this is the real gap to watch."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-dimmable-ring-lights-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-dimmable-ring-lights-2",
    rank: 2,
  ...
  {
    id: "best-dimmable-ring-lights-3",
    rank: 3,
    ...
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/417M7DXgPUL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0F2STBC5P?tag=theofficejournal-20",
    description: "Desk Ring Light with Stand for Computer is the priciest pick in this lineup. Uniform & eye-caring soft ring light. Fully adjustable brightness & color temperature.\n\nUBeesize 12\" LED Ring Light with 62\" Tripod Stand covers similar ground, though ergonomic height & flexible rotation is what tips the choice one way or the other.\n\nChoose this if you are willing to spend the most in this comparison for the fuller feature set that comes with it. Many brands inflate their listed lux rating by 2 to 3 times what the light actually outputs at a standardized distance, so treat the number on the box as a starting point, not a guarantee.",
    specs: ["Uniform & eye-caring soft ring light", "Fully adjustable brightness & color temperature", "Ergonomic height & flexible rotation"],
    pros: ["Uniform & eye-caring soft ring light", "Fully adjustable brightness & color temperature", "Ergonomic height & flexible rotation", "Stable anti-scratch base"],
    cons: ["Listed lux ratings are often inflated 2 to 3x by the brand", "Larger diameter alone doesn't guarantee brighter, more even light"],
    bestFor: "buyers who are willing to spend the most in this comparison for the fuller feature set that comes with it",
  },
  {
    id: "best-dimmable-ring-lights-4",
    rank: 4,
  ...
  {
    id: "best-dimmable-ring-lights-5",
    rank: 5,
  ...
  {
    id: "best-dimmable-ring-lights-6",
    rank: 6,
    badge: "Best Value",
  ...
  {
    id: "best-dimmable-ring-lights-7",
    rank: 7,
    badge: "Great Alternative",
    name: "NEEWER Basics 7\" Desk Ring Light for Video Recording",
    price: "$20.87",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41Je8Kj4QzL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0DG2XCHQ2?tag=theofficejournal-20",
    description: "NEEWER Basics 7\" Desk Ring Light for Video Recording is a strong alternative worth comparing directly against the top pick. Simple and practical, Neewer basic is an economical product line that focuses on essential functions and designs, without unnecessary extras and materials. Get bright and soft lighting with our 7\" LED panel video light.\n\nWeighing this against UBeesize 12\" LED Ring Light with 62\" Tripod Stand, press the mode button to cycle color temperature from 3000k, 3500k, 4400k, 5600k to 6500k ends up being the detail that matters most for most buyers.\n\nThis one is the right call if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Many brands inflate their listed lux rating by 2 to 3 times what the light actually outputs at a standardized distance, so treat the number on the box as a starting point, not a guarantee.",
    specs: ["Introducing Neewer basics", "Full screen ring light kit for desk", "Adjustable lighting & height"],
    pros: ["Introducing Neewer basics", "Full screen ring light kit for desk", "Adjustable lighting & height", "Easy charging via USB"],
    cons: ["Listed lux ratings are often inflated 2 to 3x by the brand", "Larger diameter alone doesn't guarantee brighter, more even light"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-dimmable-ring-lights-8",
    rank: 8,
    badge: "Also Worth Considering",
