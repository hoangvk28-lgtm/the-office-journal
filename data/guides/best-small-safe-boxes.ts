...
export const faq = [
  {
    "q": "What's the best overall mountable safe box?",
    "a": "The Yuanshikj Small Steel Security Safe Box, with genuine mounting hardware and a magnetic auto-locking door."
  },
  {
    "q": "Is there a portable lockbox rather than a mountable safe?",
    "a": "Yes, the KYODOLED Small Metal Lock Box is a true portable lockbox offering basic privacy rather than anchored security, at the lowest price in this comparison."
  },
  {
    "q": "Which pick has the largest mountable capacity?",
    "a": ""
  },
  {
    "q": "Is there an option with a dead-battery backup?",
    "a": "Yes, the Bonsaii Small Safe Box confirms a USB-C interface supporting an external power bank if the internal battery dies."
  },
  {
    "q": "What happens if I lose the physical key?",
    "a": "The [UPGRADED] Small Safes for Home pick offers a serial-number-based backup key replacement service; most other picks require keeping a spare key stored separately from the safe."
  }
];

export const guideSlug = "best-small-safe-boxes";

export const guideTitle = "The Best Small Safe Boxes for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "Classified mountable security boxes separately from portable lockboxes",
    "description": "Seven picks here are mountable steel security boxes with included hardware; one is a true portable lockbox. We labeled the distinction directly rather than ranking them on one undifferentiated scale."
  },
  {
    "title": "Verified mounting hardware inclusion, not just door locking",
    "description": "We checked whether pre-drilled holes and expansion bolts ship in the box, since an unanchored box, however well locked, can simply be carried away."
  },
  {
    "title": "Compared access-recovery methods across picks",
    "description": "Several picks confirm USB-C or external battery backup for dead-battery scenarios; others rely on key-only backup. We noted which offers a genuine recovery path versus which requires finding a physical key."
  },
  {
    "title": "Distinguished genuine theft deterrence from basic privacy",
    "description": "The one true portable lockbox here offers basic privacy, not anchored security. We labeled it honestly rather than implying equivalent protection to the mountable steel boxes."
  }
];
...
export const introParagraphs = [
  ...
  "We also checked whether each pick includes mounting hardware directly in the box, since a safe box that's anchorable is a meaningfully different purchase from one that only locks its door."
];
...
export const metaDescription = "A practical comparison of 8 small safe boxes, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Small Safe Boxes for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Genuine mountable security box with included hardware, not just a lockbox",
      "Magnetic auto-locking door prevents accidental unlocked storage"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "71-inch steel reinforcement bolts and hidden hinges back a mountable steel design, but the real differentiator is the USB-C interface that supports an external power bank if the internal battery dies, avoiding a full lockout. Personal password or emergency key both work for daily or backup access.\n\n61 inches of usable interior.\n\nUSB-C emergency power backup, unique dead-battery solution among the safe boxes here.",
    "specs": [
  ...
  },
  {
    ...
    "description": "6 liters to fit a closet, drawer, or under a table. It accepts two separate access codes for multi-user access, useful if two household members each want an independent code rather than sharing one.\n\nHidden pry-resistant hinges back up the code system with physical resistance, and the package includes an anti-scratch carpet liner to protect the mounting surface plus a full printed manual.\n\nSupports two independent codes for multi-user households. Both are worth keeping in mind before deciding.",
    "specs": [
  ...
  },
  {
    ...
    "pros": [
      "Auto interior light helps in dim storage locations",
      "Low-battery warning avoids a surprise lockout"
    ],
    "cons": [
      "Compact interior similar to the other budget mountable options"
    ],
  ...
  },
  {
    ...
    "description": "6 cubic feet, this is the largest mountable box in this comparison, with a removable shelf for splitting valuables into layers and a felt-lined bottom to prevent scratching. Two 18mm steel locking bolts back the mounting holes and two included expansion screws.\n\nThree access methods, personal code, an emergency override key, or a Type-C cable into the battery box, mean no single point of failure locks you out, useful for a box holding more than the compact budget options here.\n\nThree independent access methods including dead-battery recovery. That said, highest price among the mountable steel box options here.",
    "specs": [
    ...
    "cons": [
      "Highest price among the mountable steel box options here"
    ],
  ...
  },
  {
    ...
    "specs": [
      "0.3 cu ft, mountable, 42mm door",
      "Toggleable silent alarm on wrong entry",
      "Serial-number backup key replacement service"
    ],
    "pros": [
      "Serial-number key replacement service if the physical key is lost",
      "Toggleable silent alarm for discreet placement"
    ],
    "cons": [
      "Manufacturer explicitly states it's not built for bulkier items"
    ],
  ...
  },
  {
    ...
    "description": "A mountable design with pre-drilled holes and two expansion screws included, and the listing carries a useful explicit warning: never store the emergency keys inside the box itself. Two solid anti-pry bolts and a corrosion-resistant coating back the physical construction.\n\n7 inches for a drawer, cabinet, or nightstand.\n\nFull accessory bundle at a lower price than comparable picks.",
    "specs": [
    ...
    "cons": [
      "Compact capacity similar to the other budget mountable options"
    ],
...
export const breadcrumbLabel = "Best Small Safe Boxes";
