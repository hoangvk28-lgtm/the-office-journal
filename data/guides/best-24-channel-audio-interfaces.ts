export const guideSlug = "best-24-channel-audio-interfaces";
export const guideTitle = "8 Best 24-Channel Audio Interfaces in 2026";
export const metaTitle = "Best 24-Channel Audio Interfaces";
export const metaDescription = "We compared 24 channel audio interface models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "24 channel audio interface";
export const introParagraphs = [
  "Best 24-Channel Audio Interfaces cover a wide input-count range. That means marketing copy alone is risky.",
...
export const products: GuideProduct[] = [
  {
    id: "best-24-channel-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-24-channel-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-24-channel-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-24-channel-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-24-channel-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-24-channel-audio-interfaces-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-24-channel-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-24-channel-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
