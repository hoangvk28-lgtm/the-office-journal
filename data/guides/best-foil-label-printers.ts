...
export const guideTitle = "The Best Foil Label Printers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Avery® Printable Return Address Labels)",
...
export const metaDescription = "How 6 foil label printers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Foil Label Printers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Each label measures 3/4\" x 2 1/4\"",
      "30 Labels per 8 1/2\" x 11\" sheet"
    ],
    "pros": [
      "Silver foil labels for laser printers",
      "Each label measures 3/4\" x 2 1/4\"",
      "30 Labels per 8 1/2\" x 11\" sheet",
      "10 Sheets / 30 labels per pack"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
  ...
  },
  {
    ...
    "specs": [
      "Metallic gold foil label stock",
      "Standard 80-up format, 1/2\" x 1 3/4\" labels",
  ...
  },
  {
    ...
    "specs": [
      "Silver foil return address labels",
      "Each label measures 1/2\" x 1 3/4\"",
      "80 Labels per 8 1/2\" x 11\" sheet"
    ],
    "pros": [
      "Silver foil return address labels",
      "Each label measures 1/2\" x 1 3/4\"",
      "80 Labels per 8 1/2\" x 11\" sheet",
      "10 Sheets / 800 labels per pack"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
  ...
  },
  {
    ...
    "specs": [
      "Metallic silver foil label stock",
      "Standard 10-up format, 4\" x 2\" labels",
    ...
    "pros": [
      ...
      "Standard 10-up format, 4\" x 2\" labels",
      "Trusted quality, made in the usa",
      "Free templates & online designer"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-label-printers-for-small-businesses",
    "title": "Best Label Printers for Small Businesses in 2026"
  },
  {
    "href": "/guide/best-jewelry-label-printers",
    "title": "Best Jewelry Label Printers in 2026"
  }
];

export const breadcrumbLabel = "Best Foil Label Printers";
