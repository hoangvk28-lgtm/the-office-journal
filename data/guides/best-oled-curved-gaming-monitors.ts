...
export const guideTitle = "The Best OLED Curved Gaming Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 6 OLED curved gaming monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best OLED Curved Gaming Monitors for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-4k-qd-oled-gaming-monitors",
    "title": "Best 4K QD-OLED Gaming Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best OLED Curved Gaming Monitors";
