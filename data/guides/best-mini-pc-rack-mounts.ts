...
export const faq = [
  {
    "q": "Can I use an under-desk Mini PC mount in a 19-inch rack instead?",
    "a": "Under-desk mounts do not match rack rail dimensions or rack unit (U) height, and will not install in a standard 19-inch or 10-inch rack cabinet. We removed two such products from our original candidate list for this guide for exactly that reason."
  },
  {
    "q": "How many Mini PCs fit in one rack unit?",
    "a": "Most trays in this guide hold one Mini PC per 1U slot. The 19in 1U Mini PC Rack Mount for 2 Units is the exception, fitting two Mini PCs side by side in a single rack unit."
  },
  {
    "q": "Do these mounts fit any Mini PC brand?",
    "a": "Two picks here are brand-specific, built for named HP or Lenovo ThinkCentre models. The other two support a wider named list including Dell OptiPlex Micro, Lenovo ThinkCentre, and HP Desktop Mini within a stated size range."
  },
  {
    "q": "Is a 10-inch rack the same as a 19-inch rack, just smaller?",
    "a": "No, they use different rail widths and hardware is not interchangeable between them. Confirm your cabinet's actual rail width before ordering any rack mount, including the picks in this guide."
  },
  {
    "q": "Why does this guide only have 4 picks compared to your other Mini PC mount guides?",
    "a": "Genuine rack-mount hardware for Mini PCs is a narrow, specialized category compared to under-desk or wall mounting. We would rather show four verified rack-format products than pad the list with under-desk mounts that do not actually fit a rack."
  }
];

export const guideSlug = "best-mini-pc-rack-mounts";

export const guideTitle = "The Best Mini PC Rack Mounts for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We checked each candidate against actual 19-inch or 10-inch rack dimensions and rack unit (U) height, and removed two initially considered under-desk mounts that do not fit a rack cabinet at all rather than stretch the list with a mismatch."
  },
  {
    "title": "Rack unit height and cabinet compatibility",
    "description": "We compared stated U height and cabinet width against standard 19-inch and 10-inch rack specs, since a mount that does not match those dimensions simply will not install."
  },
  {
    "title": "",
    "description": "We compared whether each tray's ventilation and cabling design suits a continuous home-server workload with more persistent cabling than a desk PC typically carries."
  },
  {
    "title": "Rack density and dense-cable management",
    "description": "We looked at how many Mini PCs fit per rack unit and whether front-panel port passthrough or hinged rear access simplifies cabling in a densely packed rack."
  }
];

export const introParagraphs = [
  "Rack mounting is a specialized use case, most common for home server setups and small IT deployments, and it is different from the under-desk and wall mounting covered in our other Mini PC mount guides. A rack mount has to fit a standard rack unit (U) height, work inside a 19-inch or 10-inch cabinet, and hold up under the kind of continuous workload and denser cabling a home server or small server closet involves.",
...
export const metaDescription = "We compared 4 mini PC rack mounts on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Mini PC Rack Mounts for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GYD33WJ5?tag=theofficejournal-20",
    "description": "A hinged design on both sides gives access to network connections, ports, and cables without removing the whole tray from the rack.\n\nHighest rack density in this guide, two units in one 1U space. On price, it's actually priced above JINGCHENGMEI 1U Hinged Mini Rack Mount for HP Mini PC, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Perforated base helps airflow but a densely packed rack still needs its own overall ventilation plan.",
    "specs": [
      "19\" wide, 1U rack height",
      "Fits 2 Mini PCs simultaneously",
      "Compatible with Dell Micro, Lenovo Tiny, HP Mini form factors up to 7.8\"x7.8\"x1.7\"",
      "75 lb load capacity",
      "Adjustable depth extender, 11\" to 26\""
    ],
    "pros": [
      "Highest rack density in this guide, two units in one 1U space",
      "75 lb capacity is well above what two Mini PCs and power supplies need",
      "Hinged both sides for easy rear access",
      "Adjustable depth fits standard network cabinets"
    ],
    "cons": [
      "Highest price in this guide",
      "Two Mini PCs in one U means more cable density to manage carefully",
      "Perforated base helps airflow but a densely packed rack still needs its own overall ventilation plan"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DLGJNQ1M?tag=theofficejournal-20",
    "description": "A hinged design on both sides allows convenient access to the ports and connections at the rear of the mounted Mini PC, useful in a rack where reaching around the back is otherwise awkward.\n\nOn the other side, No stated weight capacity in the listing.",
    "specs": [
      "19\" wide x 6.53\" deep x 1.75\" high, 1U space",
      "Purpose-built for named HP Mini PC models",
      "Hinged both sides for rear access",
      "Ventilated, no top panel",
      "Includes zip ties for power supply management"
    ],
    "pros": [
      "Precise fit for named HP Mini PC models",
      "Hinged design simplifies rear cable access in a rack",
      "Ventilated housing supports airflow",
      "Includes cable management zip ties"
    ],
    "cons": [
      "Only fits HP Mini PC models, not other brands",
      "Single-unit density, less space-efficient than the 2-unit pick above",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0G4CZGRT7?tag=theofficejournal-20",
    "description": "6 inches deep for a named list of Lenovo ThinkCentre Tiny desktop models. Dual-sided hinged access lets you flip it open for network connections, ports, and cables, simplifying maintenance in a 19-inch rack without pulling the whole tray.\n\nOn the other side, No stated weight capacity.",
    "specs": [
      "19\" wide x 6.6\" deep, 1U rack height",
      "Purpose-built for named Lenovo ThinkCentre Tiny models",
      "Dual-sided hinged access",
      "High-strength steel, perforated base",
      "Tool-less hand-twist screw locking"
    ],
    "pros": [
      "Precise fit for named Lenovo ThinkCentre Tiny models",
      "Tool-less screws simplify repeated servicing",
      "Steel construction, not plastic, for long-term reliability",
      "Perforated base supports airflow"
    ],
    "cons": [
      "Only fits listed Lenovo ThinkCentre models",
      "Single-unit density",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GZ655GDQ?tag=theofficejournal-20",
    "description": "This is the only pick in this guide built for compact 10-inch racks rather than a full 19-inch cabinet, which matters for a smaller home lab setup that does not need full-size rack hardware. 7 inches, with a 20 pound load capacity per shelf.\n\nThe real tradeoff against that pick: Does not fit a standard 19-inch rack cabinet.\n\nOn the other side, Passthrough ports only cover Ethernet and HDMI, other cables still route normally.",
    "specs": [
      "10\" wide, 1U rack height (non-19\" racks)",
      "2-pack, fits Dell Micro, Lenovo Tiny, HP Mini up to 7.8\"x7.8\"x1.7\"",
      "20 lb load capacity per shelf",
      "Front-panel RJ45 and HDMI passthrough",
      "Cold-rolled steel, powder-coated finish"
    ],
    "pros": [
      "Only 10-inch rack option in this guide, fits smaller home lab setups",
      "2-pack value for a dual-Mini-PC home server",
      "Front RJ45 and HDMI passthrough simplifies dense-rack cabling",
      "Corrosion-resistant steel construction"
    ],
    "cons": [
      "Does not fit a standard 19-inch rack cabinet",
      "20 lb capacity is lower than the 19-inch dual-unit pick in this guide",
      "Passthrough ports only cover Ethernet and HDMI, other cables still route normally"
    ],
...
export const breadcrumbLabel = "Best Mini PC Rack Mounts";
