...
export const faq = [
  {
    "q": "Does any current E Ink notebook come with a keyboard?",
    "a": "None of the leading options, Kindle Scribe, reMarkable, XPPen, currently ship with a bundled first-party keyboard."
  },
  {
    "q": "Can I pair a Bluetooth keyboard with any of these?",
    "a": "More realistic on open, Android-based devices like the XPPen. Closed ecosystems like Kindle Scribe don't support general Bluetooth keyboard pairing for notes."
  },
  {
    "q": "Does reMarkable sell a keyboard accessory?",
    "a": "ReMarkable sells a Type Folio keyboard for some models in its lineup, but compatibility varies, confirm it works with the specific reMarkable model you're buying."
  },
  {
    "q": "Should I buy one of these expecting to type on it regularly?",
    "a": "Not recommended as your primary plan. If regular typing is essential, a standard tablet with a keyboard case is likely a better fit than an E Ink notebook."
  },
  {
    "q": "Why include Kindle Scribe if it has no keyboard support?",
    "a": "To give an honest, complete picture, buyers should know explicitly that this device has no keyboard path, not just see it omitted without explanation."
  }
];

export const guideSlug = "best-digital-notebooks-with-keyboards";

export const guideTitle = "The Best Digital Notebooks with Keyboards: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "95\" fits this specifically: Lowest price in this comparison."
      }
    ]
  },
  {
...
export const howWeEvaluated = [
  {
    "title": "Honest disclosure of missing keyboard hardware",
    "description": "We did not find a current E Ink notebook that ships with a bundled first-party keyboard, and said so directly rather than forcing a false top-5 keyboard-notebook narrative."
  },
  {
    "title": "OS openness to a paired keyboard",
    "description": "We distinguished closed ecosystems (Kindle, reMarkable's core OS) from more open ones (XPPen), since that determines whether typing is realistically possible at all."
  },
  {
    "title": "Official accessory availability, verified per model",
    "description": "Where a brand (reMarkable) sells an official keyboard folio for some models, we flagged that compatibility needs confirming for the specific model rather than assuming it applies across the whole lineup."
  },
  {
    "title": "",
    "description": "We still weighted established review history for overall device quality, even though it doesn't speak directly to keyboard support."
  }
];
...
export const metaDescription = "A practical comparison of 5 digital notebooks with keyboards, focused on compatibility, build, features and price, and the trade-offs between them.";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      ...
      "More open software ecosystem than Kindle or reMarkable"
    ],
    "cons": [
      "No official keyboard accessory currently bundled or sold",
      "Bluetooth keyboard support should be verified on the current listing before buying for that purpose"
    ],
  ...
  },
  {
    ...
    "description": "Same core hardware as the pick above at a slightly higher price. Neither XPPen listing includes a keyboard; check the current listing for exact accessory bundle differences.\n\nOn the other side, No official keyboard bundled.",
    "specs": [
      "10.95 inch color display",
      "16384 pressure levels"
    ],
    "pros": [
      "Same underlying hardware as the lower-priced XPPen option"
    ],
    "cons": [
      "Costs more with a lower rating than the other XPPen listing",
      "No official keyboard bundled"
    ],
  ...
  },
  {
    ...
    "description": "Same closed ecosystem and lack of keyboard support as the Colorsoft above, at a lower price without color display or extra storage.\n\nThe real tradeoff against that pick: No keyboard support, same as the Colorsoft model.\n\nOn the other side, No keyboard support, same as the Colorsoft model.",
    "specs": [
      "16GB storage",
    ...
    "pros": [
      "Lower cost entry into the Kindle Scribe lineup"
    ],
    "cons": [
      "No keyboard support, same as the Colorsoft model"
    ],
  ...
  },
  {
    ...
    "description": "ReMarkable's Type Folio keyboard accessory exists for other models in their lineup, but check the current listing to confirm compatibility with this specific reMarkable 2 configuration before assuming it will work.\n\nOn the other side, Keyboard accessory sold separately, not bundled.",
    "specs": [
      "Marker Plus stylus included",
      "reMarkable Type Folio may be compatible, verify current model support"
    ],
    "pros": [
      "reMarkable does sell an official keyboard folio accessory for some models in its lineup"
    ],
    "cons": [
      "Keyboard folio compatibility varies by specific reMarkable model, confirm before buying",
      "Keyboard accessory sold separately, not bundled"
    ],
...
export const breadcrumbLabel = "Best Digital Notebooks with Keyboards";
