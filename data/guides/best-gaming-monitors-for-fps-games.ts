...
export const guideTitle = "The Best Gaming Monitors for FPS Games: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 6 gaming monitors for FPS games, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Gaming Monitors for FPS Games (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "32-Inch 4K (3840 x 2160) woled gaming monitor",
      "Helps reduce the flicker during refresh-rate fluctuations for more comfortable viewing during extended gaming sessions",
      "Provides dynamic ai crosshair"
    ],
    "pros": [
      "32-Inch 4K (3840 x 2160) woled gaming monitor",
      "Helps reduce the flicker during refresh-rate fluctuations for more comfortable viewing during extended gaming sessions",
...
export const breadcrumbLabel = "Best Gaming Monitors for FPS Games";
