...
export const faq = [
  {
    "q": "What's the best overall office safe?",
    "a": "The Amazon Basics Steel Security Safe and Lock Box, with an adjustable interior shelf and included mounting hardware."
  },
  {
    "q": "Is there a safe that fits inside a desk drawer?",
    "a": "Yes, the Amazon Basics Small Slim Desk Drawer Security Safe is specifically designed for that placement."
  },
  {
    "q": "Which pick supports multiple staff members with separate codes?",
    "a": "The Digital Electronic Money Safe, which supports two independent access codes."
  },
  {
    "q": "Is there an option that fits a laptop?",
    "a": "Yes, the SentrySafe Shelf Safe with Digital Keypad Lock has the widest interior in this comparison, rated for laptops alongside documents."
  },
  {
    "q": "How do I change the code after an employee leaves?",
    "a": "Most picks here use a reprogrammable digital keypad. Verify the reset process directly and update the code whenever staff access changes."
  }
];

export const guideSlug = "best-small-safes-for-offices";

export const guideTitle = "The Best Small Safes for Offices: Our Picks";
...
export const howWeEvaluated = [
  {
    "title": "Prioritized multi-user access for genuine office use",
    "description": "Several picks here support two independent codes, relevant for offices with more than one staff member needing access without sharing credentials."
  },
  {
    "title": "Checked desk-drawer and under-desk mounting compatibility specifically",
    "description": "One pick is specifically slim enough to fit and mount inside a desk drawer, a different placement than a shelf-mounted home safe."
  },
  {
    "title": "Compared capacity against realistic office contents",
    "description": "We weighed capacity against contracts, cash, small devices, and USB drives rather than assuming home-safe capacity translates directly to office needs."
  },
  {
    "title": "Verified anchoring hardware for shared office spaces",
    "description": "An unanchored safe in a shared office is a genuine theft risk from anyone with access to the room. We checked mounting hardware inclusion across all eight picks."
  }
];
...
export const metaDescription = "How 8 small safes for offices compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "5 cubic feet with three operation indicator lights confirming keypad status. Two emergency override keys back up the keypad if batteries die during a busy workday.\n\nA carpeted floor protects devices from scratches, and pre-drilled mounting holes with four included expansion bolts let you mount to a wall, floor, or under a desk for genuine office anchoring.\n\nMounting hardware included for genuine desk or wall anchoring.",
    "specs": [
      "0.5 cu ft, adjustable removable interior shelf",
      "3 operation indicator lights, carpeted floor",
      "4 expansion bolts included, mountable"
    ],
    "pros": [
      "Adjustable interior shelf reconfigures for varied office storage needs",
      "Mounting hardware included for genuine desk or wall anchoring"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "Two separate access codes work simultaneously, useful for an office where two staff members each need independent access without sharing one credential, and codes can be changed if staff turnover occurs.\n\nHidden pry-resistant hinges reinforce the code system, and the package includes an anti-scratch carpet liner to protect a desk or cabinet surface plus a full manual walking staff through the two-code setup.\n\nTwo independent codes support multi-staff office access.",
    "specs": [
  ...
  },
  {
    ...
    "description": "A removable shelf splits contracts, cash, and small devices onto separate layers, at the largest capacity in this comparison, useful for an office storing a mix of items rather than just cash. Two 18mm steel locking bolts back the mounting holes and two included expansion screws.\n\nThree access methods, personal code, emergency override key, or Type-C emergency power, mean multiple recovery paths if a staff member is locked out during business hours.",
    "specs": [
    ...
    "pros": [
      "Largest capacity in this comparison for varied office storage",
      "Three independent access methods reduce workday lockout risk"
    ],
    "cons": [
  ...
  },
  {
    ...
    "pros": [
      "Lockout cooldown deters code-guessing in a shared office setting"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "9\" H specifically accommodates a laptop alongside cash and documents, useful for an office securing devices, not just paper and cash. An interior light helps locate items without hauling the safe into better lighting.\n\nBolt-down hardware is included for floor or under-desk anchoring, though this is explicitly stated as not a fireproof or waterproof safe, a security deterrent rather than disaster protection for office equipment.",
    "specs": [
      "16.8×11.6×6.9 in interior, widest here, laptop-rated",
      "Confirmed interior light",
      "Bolt-down hardware, NOT fireproof"
    ],
    "pros": [
      "Widest interior in this comparison, fits a laptop alongside documents",
      "Confirmed interior light for locating items quickly"
    ],
    "cons": [
      "Explicitly not fireproof or waterproof",
      "Heaviest and largest footprint among these picks"
    ],
  ...
  },
  {
    ...
    "cons": [
      "Compact capacity among the smallest office-appropriate options here"
    ],
...
export const breadcrumbLabel = "Best Small Safes for Offices";
