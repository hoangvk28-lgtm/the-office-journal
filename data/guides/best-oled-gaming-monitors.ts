...
export const guideTitle = "The Best OLED Gaming Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "03ms already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "A practical comparison of 6 OLED gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best OLED Gaming Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best OLED Gaming Monitors";
