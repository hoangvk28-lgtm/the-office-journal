...
export const introParagraphs = [
  ...
  "We compared these eight TV stand and coffee table sets based on product specs and buyer feedback, ranking them by piece count, storage and charging features, and overall value across budget, mid-range, and premium price points.",
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0FP2B4V21?tag=theofficejournal-20",
    description: "The SAVOR LIFE 4-piece set brings the same farmhouse aesthetic as the AMERLIFE sets in this guide, with a matching TV stand, coffee table, and end tables in a coordinated rustic finish. It sits in the upper-middle price range of this guide, positioned above the AMERLIFE 3 and 4-piece sets. Buyers who like the farmhouse look of the AMERLIFE sets but want a different brand's take on the style have a comparable alternative here at a higher price point. 4 stars in early reviews.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0G7GV193L?tag=theofficejournal-20",
    description: "4-inch TV console with an oval coffee table, the longest TV stand of any set in this guide, making it well suited to larger living rooms with generous wall space. The oval coffee table shape offers a softer, more rounded alternative to the rectangular tables found in the farmhouse sets on this list. The larger console offers ample storage and surface area for media components and decor. 9 stars, lowest rating in this guide.",
...
export const faq: FaqItem[] = [
  { q: "Is it cheaper to buy a matching TV stand and coffee table set instead of separate pieces?", a: "Sets like the AMERLIFE 3-piece bundle a TV stand, coffee table, and end table for less than buying each piece separately from the same brand, and they guarantee a matching finish, which individually sourced furniture often doesn't." },
  { q: "How do I know what size TV stand I need in a set?", a: "Measure your television's width and choose a TV stand that is roughly equal to or slightly wider than the TV for proportional support. 4-inch console, so match the stand length to both your TV size and available wall space." },
  { q: "Do TV stand and coffee table sets with charging stations require an outlet nearby?", a: "Built-in charging stations on end tables or TV stands, like the ones on the AMERLIFE sets, still need to be plugged into a wall outlet via an included cord. They eliminate the need for a separate power strip but not the need for a nearby outlet." },
