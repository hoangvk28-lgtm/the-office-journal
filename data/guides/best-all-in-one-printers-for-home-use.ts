...
export const faq = [
  {
    ...
    "a": "Most home buyers only regularly use print and occasional scan, which makes a 2-in-1 or 3-in-1 like the HP DeskJet 4355 or Canon PIXMA TS4320 enough. Reserve a 4-in-1 with ADF and fax for households that scan multi-page documents often or still need fax."
  },
  {
  ...
  },
  {
    ...
    "a": "AIO flatbed scanners commonly run around 1200dpi resolution suitable for photos and fine detail, while ADF scanning is typically lower resolution, closer to 300dpi, and built for speed on text documents rather than image quality."
  },
  {
...
export const guideTitle = "The Best All-in-One Printers for Home Use: Our Picks";
...
export const howWeEvaluated = [
  ...
  },
  {
    ...
    "description": "Assessed whether the price scales reasonably with the number of useful features included, rather than assuming a higher price always means a better all-in-one for a given household."
  }
];
...
export const introParagraphs = [
  ...
  "Below are 8 all-in-one printers we compared on which combination of features they actually deliver well, from bare-bones 2-in-1 units built for straightforward print-and-scan use to fuller 4-in-1 machines with automatic document feeders and fax lines still included for households that need them."
];
...
export const metaDescription = "How 8 all-in-one printers for home use compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best All-in-One Printers for Home Use (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "The DeskJet 4355 covers the core all-in-one trio, print, scan, and copy, without piling on features most home buyers skip. Setup is quick over wireless, and the included 3-month Instant Ink trial removes the guesswork around cartridge buying for someone new to the printer.\n\nThis is a 3-in-1, not a 4-in-1, there's no automatic document feeder or fax line, so multi-page scanning means placing one sheet at a time on the flatbed glass. For most home buyers who scan the occasional single document, that's a fair trade for the lower price and simpler unit.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The PIXMA TS4320 packs print, scan, and copy plus built-in duplex printing into a single compact tray, a real convenience for two-sided documents without a fax line or ADF adding bulk. Easy setup and a 1-year limited warranty round out a straightforward home printer.\n\nThe flatbed scanner is fine for the occasional single-page scan or photo, but without an ADF, scanning a multi-page document means feeding pages one at a time, worth knowing before buying if you regularly scan longer stacks.",
    "specs": [
  ...
  },
  {
    ...
    "description": "42-inch OLED display and intuitive control panel that make daily use noticeably easier than a printer relying on indicator lights alone. Copy scaling and basic scan options are easy to find without digging through menus.\n\nLike the TS4320, there's no automatic document feeder, so this is a better fit for occasional single-page scanning than for digitizing stacks of paper regularly.",
    "specs": [
      "Print, scan, copy with duplex printing",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CT8ZJ7ZC?tag=theofficejournal-20",
    "description": "The OfficeJet Pro 8125e steps up to a full print, scan, copy setup with both an automatic document feeder and duplex printing, aimed at home-office use rather than occasional home printing. A 3-month Instant Ink trial softens the entry cost of ongoing ink.\n\nThis is the pick for a household that uses every feature on the box, ADF for scanning receipts and contracts, duplex for reports, and steady wireless printing from multiple devices. It costs more upfront than the simpler 3-in-1 picks in this list, which is worth it only if you'll use the extra capability.\n\nInstant Ink trial reduces early ink cost.",
    "specs": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09TRZLPXP?tag=theofficejournal-20",
    "description": "The TR8620a is the fullest 4-in-1 in this list, print, copy, scan, fax, plus an automatic document feeder, AirPrint support, and Alexa compatibility for voice-triggered print jobs. It's also the most expensive pick here, so it only makes sense if you'll actually use most of that feature list.\n\nFor a household that wants photo printing quality alongside document handling and doesn't mind paying more for the full set of capabilities, this covers nearly everything a home all-in-one can do. Buyers who only need 2 or 3 of these features are better served by a cheaper pick above.",
    "specs": [
  ...
  },
  {
    ...
    "bestFor": "Buyers who want ADF and duplex printing"
  }
];
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-wireless-printers-for-home-offices",
    "title": "Best Wireless Printers for Home Offices (2026)"
  },
  {
    "href": "/guide/best-printers-with-automatic-document-feeders",
    "title": "Best Printers with Automatic Document Feeders (2026)"
  },
  {
    "href": "/guide/best-duplex-printers-for-home-offices",
    "title": "Best Duplex Printers for Home Offices (2026)"
  }
];

export const breadcrumbLabel = "Best All-in-One Printers for Home Use";
