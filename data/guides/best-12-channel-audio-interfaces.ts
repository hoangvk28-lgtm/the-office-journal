...
export const guideTitle = "The Best 12-Channel Audio Interfaces for a Better Desk Setup";
...
export const metaDescription = "We compared 8 12-channel audio interfaces on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 12-Channel Audio Interfaces for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 12-Channel Audio Interfaces";
