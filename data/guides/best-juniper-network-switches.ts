...
export const guideTitle = "The Best Juniper Network Switches for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 5 juniper network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Juniper Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B085PQV5RW?tag=theofficejournal-20",
    ...
    "specs": [
      "24 Gigabit PoE+ ports, renewed",
      "Enterprise Junos OS",
      "Rack-mountable chassis"
    ],
    "pros": [
      "Enterprise-grade Junos routing and switching",
      "Significant cost savings vs new Juniper hardware",
      "Established Juniper build quality"
    ],
    "cons": [
      "Renewed condition, no manufacturer warranty typically",
      "May require a separate support contract for updates"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B085PN1SNB?tag=theofficejournal-20",
    ...
    "specs": [
      "12 PoE+ ports + SFP+ uplinks, renewed",
      "Compact EX2300-C chassis",
      "Junos OS"
    ],
    "pros": [
      "Smaller form factor than full-size Juniper switches",
      "SFP+ uplinks for fiber backbone connections",
      "Genuine Junos OS capability"
    ],
    "cons": [
      "No mounting kit included",
      "Renewed condition, verify warranty terms before buying"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09R3RDRGR?tag=theofficejournal-20",
    ...
    "specs": [
      "48 PoE ports, renewed",
      "Amazon-inspected and tested",
      "Junos OS"
    ],
    "pros": [
      "Amazon inspection process adds quality assurance",
      "Large 48-port PoE density at renewed pricing",
      "Consistent Junos OS across a Juniper deployment"
    ],
    "cons": [
      "Generic packaging, not original retail box",
      "Renewed condition despite testing"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07SN193Q6?tag=theofficejournal-20",
    "description": "The EX4300-48P steps up to Juniper's EX4300 line with dual power supplies for redundancy, a real reliability feature for buyers running critical infrastructure where a single PSU failure shouldn't take the switch offline.\n\n2 pounds it's a substantial rack-mount unit, renewed and refurbished, aimed at data closets and small data centers rather than desk or home use.",
    "specs": [
      "48 PoE ports, dual PSU, renewed",
      "22.2lb rack-mount chassis",
      "Junos OS"
    ],
    "pros": [
      "Dual power supply adds real redundancy",
      "EX4300 line offers more headroom than EX2300",
      "Solid choice for critical always-on infrastructure"
    ],
    "cons": [
      "Heavy, rack-committed hardware",
      "Renewed condition, verify support/licensing before buying"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BGKJDPDH?tag=theofficejournal-20",
    ...
    "specs": [
      "8-port security gateway, renewed",
      "Firewall + VPN + routing",
      "Junos OS (SRX series)"
    ],
    "pros": [
      "Combines firewall/VPN with basic switching in one box",
      "Compact metal case for edge deployment",
      "Genuine Juniper SRX software stack"
    ],
    "cons": [
      "Not a pure switch, different use case than the rest of this list",
      "Renewed condition, licensing needs verification"
    ],
...
export const breadcrumbLabel = "Best Juniper Network Switches";
