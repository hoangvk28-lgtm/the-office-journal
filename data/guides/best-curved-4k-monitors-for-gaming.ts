...
export const introParagraphs = [
  "Best Curved 4K Monitors for Gaming aren't always interchangeable. That means curved 4k monitors for gaming, one spec isn't enough.",
  "curved 4k monitors for gaming is judged here on real HDR certification, because HDR labels vary wildly in real brightness."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-curved-4k-monitors-for-gaming-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-curved-4k-monitors-for-gaming-2",
    rank: 2,
  ...
  {
    id: "best-curved-4k-monitors-for-gaming-3",
    rank: 3,
    badge: "Best Value",
  ...
  {
    id: "best-curved-4k-monitors-for-gaming-4",
    rank: 4,
  ...
  {
    id: "best-curved-4k-monitors-for-gaming-5",
    rank: 5,
  ...
  {
    id: "best-curved-4k-monitors-for-gaming-6",
    rank: 6,
    badge: "Worth a Look",
    ...
    description: "ZZA 32 Inch Curved Gaming Monitor 4K 160HZ Computer Monitor UHD 3840 * 2160P VA is a strong alternative worth comparing directly against the top pick. 32Inch 4K curved display: enjoy breathtaking clarity and depth with the zza 32-inch 4K uhd curved monitor (3840x2160). 32 Inch monitor 160hz refresh rate: dominate every match with up to 160hz refresh rate and amd freesync support.\n\nSet next to LG 32GS60QC-B Ultragear 32-inch Curved Gaming Monitor QHD (2560x1440) 180Hz 1ms, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
    specs: ["32 Inch monitor 160hz refresh rate: dominate every match", "120% Srgb color accuracy : featuring 100% srgb", "Customer support team is ready to help you with setup or technical issues"],
    pros: ["32 Inch monitor 160hz refresh rate: dominate every match", "120% Srgb color accuracy : featuring 100% srgb", "Customer support team is ready to help you with setup or technical issues"],
    cons: ["Check compatibility with your exact setup before buying", "Marketed specs and real-world specs often differ"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Mid-range pick",
          "ZZA 32 Inch 4K Curved Gaming Monitor 165Hz"
        ],
        [
          "Higher budget",
          "ZZA 32 Inch Curved Gaming Monitor 4K 160HZ Computer Monitor UHD 3840 * 2160P VA"
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You need the strongest real-world performance and sturdiest build, where ZZA 32 Inch Curved Gaming Monitor 4K 160HZ Computer Monitor UHD 3840 * 2160P VA justifies the extra cost."
      },
      {
        "label": "Save if",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-4k-monitors","title":"Best 4K Monitors in 2026"},{"href":"/guide/best-144hz-4k-monitors-for-gaming","title":"Best 144Hz 4K Monitors for Gaming in 2026"},{"href":"/guide/best-oled-4k-monitors-for-gaming","title":"Best OLED 4K Monitors for Gaming in 2026"},{"href":"/guide/best-60hz-4k-monitors-for-gaming","title":"Best 60Hz 4K Monitors for Gaming in 2026"}];
