...
export const faq = [
  ...
  },
  {
    ...
    "a": "A larger woofer reproduces more low-frequency detail but can also overload a small, untreated room with bass buildup, making 5-inch monitors the safer, more accurate choice for most home studio desk setups rather than an 8-inch pair."
  },
  {
...
export const guideTitle = "The Best Studio Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "You're just starting a home setup and want capable sound without overspending, where PreSonus Eris 5BT Bluetooth Studio Monitors, Pair already covers the job."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  ...
  {
    "title": "",
    "description": "Wattage describes how loud a monitor can play before the amplifier starts distorting, and for most home studio use 50 to 75 watts per channel is sufficient, since mixing at reasonable volume rarely demands more."
  },
  {
    "title": "",
...
export const metaDescription = "How 6 studio monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Studio Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B016ZHLN7K?tag=theofficejournal-20",
    ...
    "specs": [
      "Incredibly versatile powered nearfield studio monitor great",
      "Soft-dome tweeter with optimized waveguide provides smooth",
      "Lightweight glass-aramid composite woofer delivers clear midrange"
    ],
    "pros": [
      "Incredibly versatile powered nearfield studio monitor great",
      "Soft-dome tweeter with optimized waveguide provides smooth",
      "Lightweight glass-aramid composite woofer delivers clear midrange",
      "Flat low frequency adjustment adding versatility"
    ],
    "cons": [
      "Stands or isolation pads are usually a separate purchase",
      "Room acoustics affect the sound more than the speaker"
...
export const breadcrumbLabel = "Best Studio Monitors";
