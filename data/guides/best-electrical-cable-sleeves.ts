...
export const guideTitle = "The Best Electrical Cable Sleeves for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Alex Tech 25ft - 1/2 inch Cord Protector Wire Loom Tubing Cable Sleeve Split)",
...
export const metaDescription = "How 4 electrical cable sleeves compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Electrical Cable Sleeves for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "1/4\", 3/8\", 1/2\", 3/4 Inch x 30 ft, black",
...
export const breadcrumbLabel = "Best Electrical Cable Sleeves";
