...
export const guideTitle = "The Best Vertical Gaming Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "3ms justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "How 6 vertical gaming monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Vertical Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "27-Inch wqhd (2560 x 1440) @ 200hz fast ips rotating gaming monitor",
      "Od 1ms response time丨mprt low motion blur technology丨noise reduction丨 adaptive sync丨400nits brightness丨crosshair/rts/fps game assistant",
      "Screen colors"
    ],
    "pros": [
      "27-Inch wqhd (2560 x 1440) @ 200hz fast ips rotating gaming monitor",
      "Od 1ms response time丨mprt low motion blur technology丨noise reduction丨 adaptive sync丨400nits brightness丨crosshair/rts/fps game assistant",
      "Screen colors",
      "90°~+90°/L25°~r25°/0~130mm丨tilt / kensington lock:-5°~20°(+/-2°) / yes丨vesa compatible (100x100mm)"
    ],
    "cons": [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Discover enemies in the shadows with better visibility"
    ],
    "pros": [
      "React in real time",
      "Stay in sync with the action",
  ...
  },
  {
    ...
    "specs": [
      "1440p gaming monitor employs a fast ips panel",
    ...
    "pros": [
      ...
      "Cinema-grade colour performance",
      "Built-in speakers",
      "Comfortable and healthy gaming experience"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
  ...
  },
  {
    ...
    "specs": [
      ...
      "Fast ips monitor fhd",
      "131% srgb color gamut area"
    ],
    "pros": [
      "Smooth gaming performance",
      "Fast ips monitor fhd",
...
export const breadcrumbLabel = "Best Vertical Gaming Monitors";
