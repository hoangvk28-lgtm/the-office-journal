...
export const guideTitle = "The Best Apple VR Headsets for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 apple VR headsets, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Apple VR Headsets for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-bigscreen-vr-headsets",
    "title": "Best Bigscreen VR Headsets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Apple VR Headsets";
