...
export const guideTitle = "The Best VR Headsets for Drones, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "DJI Avata 2 Fly More Combo (1 Battery))",
...
export const metaDescription = "We compared 6 VR headsets for drones on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best VR Headsets for Drones (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Immersive fpv drone with vr goggles & dual cameras",
      "Powered by a durable brushless motor delivering quiet",
      "Engineered with comprehensive propeller guards for maximum collision resistance and safety"
    ],
    "pros": [
      "Immersive fpv drone with vr goggles & dual cameras",
      "Powered by a durable brushless motor delivering quiet",
      "Engineered with comprehensive propeller guards for maximum collision resistance and safety",
      "Unlock endless fun with 360° stunts"
    ],
    "cons": [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Brushless motors & speed control",
      "Capture stunning aerial footage with dual cameras"
    ],
    "pros": [
      "Immersive vr experience",
      "Brushless motors & speed control",
      "Capture stunning aerial footage with dual cameras",
      "Experience stable and smooth hovering thanks to optical flow positioning"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
  ...
  },
  {
    ...
    "specs": [
      "First-person fpv experience with head-mounted vr glasses",
      "Dual cameras & 150° adjustable electric tilt camera: capture",
      "Optical flow hovering & brushless motor for stable flight"
    ],
    "pros": [
      "First-person fpv experience with head-mounted vr glasses",
      "Dual cameras & 150° adjustable electric tilt camera: capture",
      "Optical flow hovering & brushless motor for stable flight",
      "High-intensity night lights & 360° flip: fly confidently"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "specs": [
      ...
      "Intelligent, stable, and easy to control",
      "Multifunctional shooting fun"
    ],
    "pros": [
      "Immersive flight experience",
      "Intelligent, stable, and easy to control",
      "Multifunctional shooting fun",
      "Safe, durable, and worry-free flight"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
  ...
  },
  {
    ...
    "specs": [
      "Dronemask 1 is not just another fpv vr headset",
    ...
    "pros": [
      ...
      "Versatile compatibility",
      "Comfortable and user-friendly design",
      "Dronemask 1 HD fpv goggles are designed to provide a distraction-free flight"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-apple-vr-headsets",
    "title": "Best Apple VR Headsets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best VR Headsets for Drones";
