...
export const guideTitle = "The Best Brother Label Printers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Brother PT-M95 P-Touch Monochrome Label Maker Bundle)",
...
export const metaDescription = "How 3 brother label printers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Brother Label Printers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Brother Label Printers";
