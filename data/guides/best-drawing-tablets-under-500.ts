...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "Define the prosumer tablet/display capability floor: Intuos Pro Large $499.95 and Artist Pro 16-class products fit; professional pen behavior and workflow controls should rise. Do not expand the list with products that fail the core category definition just to reach a target number of picks. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
