...
export const guideTitle = "The Best Creality Laser Engravers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 creality laser engravers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Creality Laser Engravers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Creality Falcon A1C 10W AI Laser Engraver punches above its price tier. Create stunning engravings in just a few clicks with falcon a1c's intelligent AI workflow.\n\n1 mm positioning accuracy, helping reduce setup time and improve engraving precision. Complete more projects in less time with engraving speeds up to 15,000 mm/min. Small detail, but it's the kind of thing that separates a good pick from a forgettable one.",
    "specs": [
      "Create stunning engravings in just a few clicks with falcon a1c's",
      "Designed for long-term creativity, falcon a1c features an interchangeable laser platform",
      "Built-in AI HD camera quickly captures your material and automatically positions"
...
export const breadcrumbLabel = "Best Creality Laser Engravers";
