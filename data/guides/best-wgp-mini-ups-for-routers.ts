...
export const faq = [
  {
    "q": "Why does WGP publish watt-hours when most competitors only list mAh?",
    "a": "Watt-hours account for both capacity and voltage, giving a true energy figure. Publishing it lets buyers compare battery packs that use different cell voltages fairly, which a bare mAh number cannot do on its own."
  }
];

export const guideSlug = "best-wgp-mini-ups-for-routers";

export const guideTitle = "The Best WGP Mini UPS for Routers: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Can back up a router and a PoE camera off one unit over a single Ethernet run, worth checking passive vs active PoE compatibility. In this comparison: CHINTE Mini UPS 16000mAh with Passive PoE."
      },
      {
        "label": "",
        "text": "Simpler and covers standard router power needs without PoE complexity. 2Wh, Mini UPS Battery Backup 20000mAh 74Wh."
      }
    ],
...
export const metaDescription = "How 5 WGP mini UPS for routers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best WGP Mini UPS for Routers (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-wgp-mini-ups-for-routers-1",
    "rank": 1,
    ...
    "bestFor": "Closest match to WGP's multi-rail, documented-spec approach"
  },
  {
    "id": "best-wgp-mini-ups-for-routers-2",
    "rank": 2,
    "badge": "Best with AVR",
    ...
    "bestFor": "Regulated output similar to WGP's stability claims"
  },
  {
    "id": "best-wgp-mini-ups-for-routers-3",
    "rank": 3,
    "badge": "Best with PoE",
    ...
    "bestFor": "matches WGP's router+ONU/CCTV positioning"
  },
  {
    "id": "best-wgp-mini-ups-for-routers-4",
    "rank": 4,
    "badge": "Highest Verified Capacity",
    ...
    "bestFor": "For buyers who want the most runtime regardless of brand"
  },
  {
    "id": "best-wgp-mini-ups-for-routers-5",
    "rank": 5,
    "badge": "Best Dual 12V Rail",
    ...
    "bestFor": "Router + second device, mirroring WGP's two-output models"
  }
];
...
export const breadcrumbLabel = "Best WGP Mini UPS for Routers";
