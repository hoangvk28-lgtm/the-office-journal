...
export const guideTitle = "The Best Leather Desk Pads for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "Best Leather Desk Pads span budget cloth pads to premium leather versions, which is exactly why your peripherals change what you actually need.",
  "We compared this lineup on honest surface material and stitching quality, since this is where the decision gets made."
];
...
export const metaDescription = "A practical comparison of 8 leather desk pads, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Leather Desk Pads for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-leather-desk-pads-1",
    "rank": 1,
    "badge": "Best Overall",
...
export const breadcrumbLabel = "Best Leather Desk Pads";
