export const guideSlug = "best-production-video-switchers";
export const guideTitle = "8 Best Production Video Switchers in 2026";
export const metaTitle = "Best Production Video Switchers";
export const metaDescription = "We compared production video switcher models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "production video switcher";
export const introParagraphs = [
  "Best Production Video Switchers cover a wide input-count range. That means marketing copy alone is risky.",
...
export const products: GuideProduct[] = [
  {
    id: "best-production-video-switchers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-production-video-switchers-2",
    rank: 2,
  ...
  {
    id: "best-production-video-switchers-3",
    rank: 3,
    badge: "Best Value",
  ...
  {
    id: "best-production-video-switchers-4",
    rank: 4,
  ...
  {
    id: "best-production-video-switchers-5",
    rank: 5,
  ...
  {
    id: "best-production-video-switchers-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-production-video-switchers-7",
    rank: 7,
  ...
  {
    id: "best-production-video-switchers-8",
    rank: 8,
