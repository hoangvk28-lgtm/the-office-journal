...
export const guideTitle = "The Best Screw-Free Microphone Arms for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "FIFINE CS1 Scissor Microphone Boom Arm Stand for Gaming Recording)",
...
export const metaDescription = "How 8 screw-free microphone arms compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Screw-Free Microphone Arms for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Screw-Free Microphone Arms";
