...
export const buyingCriteria = [
  ...
  {
    "criterion": "Define the prosumer tablet/display capability floor",
    "explanation": "95 and Artist Pro 16-class products fit; professional pen behavior and workflow controls should rise. Do not expand the list with products that fail the core category definition just to reach a target number of picks. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
  ...
  },
  {
    ...
    "explanation": "Evaluate cables/stand/accessory ecosystem and run this protocol: Run slow diagonals/curves and edge accuracy with the same brush settings, verify driver install/mapping/sleep-wake, and for displays test color/parallax/cable requirements. Use the result to tell the reader whether spending close to $500 is justified or whether a cheaper tier already solves the same use case. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  }
];

export const faq = [
  {
    "q": "What should I check before buying from this best drawing tablets under $500 comparison?",
...
export const guideTitle = "The Best Drawing Tablets Under $500: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  {
    "subheading": "Wacom Intuos Small vs HUION Inspiroy H640P",
    "cards": [
      {
        "label": "",
      ...
      {
        "label": "HUION Inspiroy H640P 6x4 inch Drawing Tablet 8192 Pen Pressure",
    ...
    "note": "Most buyers should default to Wacom Intuos Small unless your specific use case points toward HUION Inspiroy H640P 6x4 inch Drawing Tablet 8192 Pen Pressure's particular tradeoffs."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  ...
  {
    "title": "",
    "description": "Show the next-lower tier, the prosumer tablet/display tier and the next-higher tier so this article has a distinct reason to exist."
  },
  {
    "title": "",
  ...
  {
    "title": "",
    "description": "Judge cables/stand/accessory ecosystem, warranty/support and ownership friction, then explicitly say when a buyer should spend less or exceed $500 for a meaningful upgrade."
  }
];

export const introParagraphs = [
  "Best Drawing Tablets Under $500 listings span a wide range of real capability even within the same price ceiling, and comparing them on price alone misses which picks actually meet the core use case.",
...
export const metaDescription = "How 8 drawing tablets under $500 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Drawing Tablets Under $500 (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-drawing-tablets-under-500-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-drawing-tablets-under-500-2",
    "rank": 2,
  ...
  {
    "id": "best-drawing-tablets-under-500-3",
    "rank": 3,
    "badge": "Best Value",
    ...
    "specs": [
      ...
      "Graphic design tablet h420x is only 7mm",
      "H420x huion drawing tablet is compatible"
    ],
    "pros": [
      "New upgraded version",
      "Graphic design tablet h420x is only 7mm",
  ...
  {
    "id": "best-drawing-tablets-under-500-4",
    "rank": 4,
  ...
  {
    "id": "best-drawing-tablets-under-500-5",
    "rank": 5,
  ...
  {
    "id": "best-drawing-tablets-under-500-6",
    "rank": 6,
    "badge": "Worth a Look",
  ...
  {
    "id": "best-drawing-tablets-under-500-7",
    "rank": 7,
  ...
  {
    "id": "best-drawing-tablets-under-500-8",
    "rank": 8,
    "badge": "Also Worth Considering",
...
export const breadcrumbLabel = "Best Drawing Tablets Under $500";
