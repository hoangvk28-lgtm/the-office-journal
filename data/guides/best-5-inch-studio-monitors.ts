...
export const introParagraphs = [
  "Best 5-Inch Studio Monitors range widely in real accuracy, so price alone misses what matters.",
  "Every pick here was judged on near-field distance and woofer size, because this is the real gap to watch."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-5-inch-studio-monitors-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-5-inch-studio-monitors-2",
    rank: 2,
  ...
  {
    id: "best-5-inch-studio-monitors-3",
    rank: 3,
  ...
  {
    id: "best-5-inch-studio-monitors-4",
    rank: 4,
  ...
  {
    id: "best-5-inch-studio-monitors-5",
    rank: 5,
  ...
  {
    id: "best-5-inch-studio-monitors-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-5-inch-studio-monitors-7",
    rank: 7,
  ...
  {
    id: "best-5-inch-studio-monitors-8",
    rank: 8,
    badge: "Best Value",
