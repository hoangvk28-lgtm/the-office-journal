...
export const faq = [
  {
    "q": "Are any of these office pods actually foldable?",
    "a": "No, we checked all verified listings in this niche and found none described as foldable, collapsible, or hinge-based, every product uses \"portable\" or \"mobile\" language instead."
  },
  {
    "q": "Does \"portable\" mean the pod folds for storage?",
    "a": "Not based on current listings, \"portable\" here generally means the assembled structure can be repositioned or was shipped in parts, not that it folds flat."
  },
  {
    "q": "Which pick is easiest to move once assembled?",
    "a": "The mobile pod with wheels is the most repositionable option in this pool, though it is still not described as foldable."
  },
  {
    "q": "Should I still expect freight delivery for a \"portable\" pod?",
    "a": "Yes, portable in this niche doesn't mean parcel shipping, expect a freight delivery appointment and on-site assembly regardless of the portable labeling."
  }
];

export const guideSlug = "best-foldable-office-pods";

export const guideTitle = "The Best Portable Office Pods for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Checked for explicit foldable language and found none",
    "description": "Reviewed all nine verified listings in this niche for foldable, collapsible, or hinge-based language and found none, every product is described as \"portable\" or \"mobile\" instead, and we did not extend a foldable claim beyond what the titles state."
  },
  {
    "title": "\"Portable\" used accurately per actual title language",
    "description": "Described each pick using the actual portable/mobile language from its listing rather than a stronger foldable claim the manufacturer doesn't make."
  },
  {
    "title": "Assembly and handling weight flagged as unknowns",
    "description": "Flagged that fold-joint durability, assembly time, and real handling weight are not addressed in any listing, since no product is actually foldable, these specific concerns don't apply, but general assembly logistics still do."
  },
  {
    "title": "",
...
export const metaDescription = "We compared 3 portable office pods on compatibility, build, features and price to help you choose the right one for your space.";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-modular-office-pods",
    "title": "Best Modular Office Pods (2026)"
  },
  {
