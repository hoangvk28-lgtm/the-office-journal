...
export const faq = [
  {
    ...
    "a": "25 inches are what actually determine fit. Listings rarely state both to the inch, so treat the label as a first filter, not a final confirmation."
  },
  {
...
export const guideTitle = "The Best Filing Cabinets for Legal-Size Documents, Compared";
...
export const howWeEvaluated = [
  {
    ...
    "description": "Separated cabinets that state letter, legal, and A4 compatibility directly from ones that only confirm letter and A4, since a legal claim is not something we assume from cabinet size alone."
  },
  {
    "title": "",
    "description": "Weighed whether a cabinet's stated drawer style suggests standard legal rail spacing versus letter-only rails that would need a separate adapter for legal folders."
  },
  {
    "title": "Drawer slide durability under heavier legal-paper loads",
    "description": "Considered assembly type and stated build material as a rough proxy for slide durability, since legal paper adds roughly 27 percent more weight per sheet than letter paper across a full drawer."
  },
  {
    "title": "Lateral vs vertical fit for legal-size folders",
    "description": "Evaluated each cabinet's orientation against the extra side-to-side room legal folders typically need, noting where a lateral design may serve legal-size storage better than a vertical one."
  },
  {
    "title": "Value for price across confirmed and unconfirmed legal fit",
    "description": "Weighed price against both stated legal-size compatibility and buyer feedback volume, flagging any pick where legal-size support was not confirmed in the listing."
  }
];

export const introParagraphs = [
  "A listing that says a cabinet fits legal-size paper is not the same as a cabinet built to hang legal-size files without a fight. 25 inches of spacing between hooks, roughly two inches wider than the letter-size standard. Several cabinets marketed toward general home office use only confirm letter and A4 compatibility, leaving legal-size buyers to guess whether their files will hang correctly or just sit loose in the drawer.",
  "This guide compares 6 cabinets we compared based on product specs and buyer feedback, prioritizing which ones explicitly state legal-size hanging file support versus which ones only confirm it for letter and A4. Legal paper is also roughly 27 percent heavier per sheet once a drawer is loaded with a full run of hanging folders, so drawer slide quality matters more here than it does for a lighter letter-only cabinet. 99 for a fully assembled two-drawer model."
];
...
export const metaDescription = "We compared 6 filing cabinets for legal-size documents on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Filing Cabinets for Legal-Size Documents (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Lateral cabinets are a rarely suggested but often better option for legal-size storage, since the wider drawer body gives hanging files more side-to-side room without needing extra front-to-back depth. 35 inches it needs more side clearance than a vertical cabinet of similar capacity.\n\n2 stars, feedback is solid though slightly below the top two picks. Confirm your hanging files will orient correctly in a lateral drawer, since not every lateral cabinet supports both front-to-back and side-to-side rail configurations for legal-size folders.\n\nThe standout detail is that lateral design suits legal-size files needing side-to-side room. Balancing that out, needs more side clearance than vertical cabinets.",
    "specs": [
  ...
  },
  {
    ...
    "description": "This is the lowest-priced pick in this list and one of the narrower vertical cabinets, listing letter, A4, and legal compatibility together. 25 inches of internal drawer width regardless of how compact the outer shell looks.\n\nEasy assembly is noted in the listing, so factor in a short setup step, and verify hanging rail spacing once assembled if you plan to load it exclusively with legal folders.\n\nLowest price in this list.",
    "specs": [
  ...
  },
  {
    ...
    "description": "Honesty check: this listing only confirms A4 and letter size fit, not legal, so it is included here as a lower-cost alternative rather than a verified legal-size pick. The 24-inch extended desktop on top adds a useful printer stand surface, and its fabric drawer fronts trade some durability for lighter overall weight compared to the all-metal picks above. Both are worth keeping in mind before deciding.",
    "specs": [
...
export const breadcrumbLabel = "Best Filing Cabinets for Legal-Size Documents";
