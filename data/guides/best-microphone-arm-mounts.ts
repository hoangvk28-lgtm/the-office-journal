export const guideSlug = "best-microphone-arm-mounts";
export const guideTitle = "8 Best Microphone Arm Mounts in 2026";
export const metaTitle = "Best Microphone Arm Mounts";
export const metaDescription = "We compared microphone arm mount models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "microphone arm mount";
export const introParagraphs = [
  "Best Microphone Arm Mounts cover a wide weight range. That means marketing copy alone is risky.",
...
export const products: GuideProduct[] = [
  {
    id: "best-microphone-arm-mounts-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-microphone-arm-mounts-2",
    rank: 2,
  ...
  {
    id: "best-microphone-arm-mounts-3",
    rank: 3,
  ...
  {
    id: "best-microphone-arm-mounts-4",
    rank: 4,
  ...
  {
    id: "best-microphone-arm-mounts-5",
    rank: 5,
  ...
  {
    id: "best-microphone-arm-mounts-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-microphone-arm-mounts-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-microphone-arm-mounts-8",
    rank: 8,
