...
export const guideTitle = "The Best Premium Microphone Arms for a Better Desk Setup";
...
export const metaDescription = "We compared 8 premium microphone arms on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Premium Microphone Arms for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Premium Microphone Arms";
