export const guideSlug = "best-storage-carts-under-20";
export const guideTitle = "8 Best Storage Carts Under $20 in 2026";
export const metaTitle = "Best Storage Carts Under $20";
export const metaDescription = "We compared storage cart under $20 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "storage cart under $20";
export const introParagraphs = [
  "Across best storage carts under $20, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is documented weight rating and casters, since these details matter more than claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-storage-carts-under-20-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-storage-carts-under-20-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-storage-carts-under-20-3",
    rank: 3,
  ...
  {
    id: "best-storage-carts-under-20-4",
    rank: 4,
  ...
  {
    id: "best-storage-carts-under-20-5",
    rank: 5,
  ...
  {
    id: "best-storage-carts-under-20-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-storage-carts-under-20-7",
    rank: 7,
  ...
  {
    id: "best-storage-carts-under-20-8",
    rank: 8,
