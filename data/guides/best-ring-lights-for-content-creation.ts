...
export const guideTitle = "The Best Ring Lights for Content Creation: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 ring lights for content creation, focused on brightness, color temperature, adjustability and power, and the trade-offs between them.";

export const metaTitle = "Best Ring Lights for Content Creation (2026)";
...
export const breadcrumbLabel = "Best Ring Lights for Content Creation";
