...
export const guideTitle = "6 Best Huawei 4K Monitors in 2026";
export const metaTitle = "Best Huawei 4K Monitors";
export const metaDescription = "We compared huawei 4k monitors models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage floor.";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "IPS (e.g. Gawfolk 4K Curved Monitor 32 Inch)",
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "Anyuse 15.6\" 4K UHD IPS HDR USB-C HDMI Monitor is worth checking against its specific spec sheet before assuming any pick here covers your exact need."
      }
    ]
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-4k-monitors","title":"Best 4K Monitors in 2026"},{"href":"/guide/best-32-inch-curved-4k-monitors","title":"Best 32-Inch Curved 4K Monitors in 2026"},{"href":"/guide/best-4k-monitors-with-hdmi-2-1","title":"Best 4K Monitors With HDMI 2.1 in 2026"},{"href":"/guide/best-benq-4k-monitors","title":"Best BenQ 4K Monitors in 2026"}];
