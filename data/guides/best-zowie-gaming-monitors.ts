...
export const guideTitle = "The Best ZOWIE Gaming Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "1 280Hz Fast TN Gaming Monitor for Esports"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "1 280Hz Fast TN Gaming Monitor for Esports justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 6 ZOWIE gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best ZOWIE Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "pros": [
      ...
      "At the resolutions most commonly used by pro players",
      "Latest panel design improves electrical conductivity",
      "Automatically switches color modes among different games and use scenarios"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-koorui-gaming-monitors",
    "title": "Best KOORUI Gaming Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best ZOWIE Gaming Monitors";
