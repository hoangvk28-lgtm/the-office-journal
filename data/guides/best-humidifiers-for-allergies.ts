...
export const introParagraphs = [
  "Best Humidifiers for Allergies aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
...
export const products: GuideProduct[] = [
  {
    id: "best-humidifiers-for-allergies-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-humidifiers-for-allergies-2",
    rank: 2,
  ...
  {
    id: "best-humidifiers-for-allergies-3",
    rank: 3,
  ...
  {
    id: "best-humidifiers-for-allergies-4",
    rank: 4,
  ...
  {
    id: "best-humidifiers-for-allergies-5",
    rank: 5,
  ...
  {
    id: "best-humidifiers-for-allergies-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-humidifiers-for-allergies-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Larger living space",
          "Everlasting Comfort 6L Humidifiers for Bedroom"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You want a larger tank, quieter operation, and extra features like a hygrometer display, where Everlasting Comfort 6L Humidifiers for Bedroom justifies the extra cost."
      },
      {
        "label": "Save if",
