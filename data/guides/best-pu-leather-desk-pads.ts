...
export const guideSlug = "best-pu-leather-desk-pads";

export const guideTitle = "The Best PU Leather Desk Pads for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Elizo Real Leather Desk Mat Set (32x16) Large Desk Cover Desk Blotter Protector is worth checking against its specific edge construction before assuming any desk pad holds up the same."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want a wipeable, longer-lasting surface with a more polished look, where YSAGi Leather Desk Protector justifies the extra cost."
      },
      {
        "label": "",
...
export const introParagraphs = [
  "Best PU Leather Desk Pads aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
  "This roundup weighs documented size and backing material, given that marketing copy tends to obscure this."
];
...
export const metaDescription = "We compared 8 PU leather desk pads on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best PU Leather Desk Pads for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-pu-leather-desk-pads-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-pu-leather-desk-pads-2",
    "rank": 2,
  ...
  {
    "id": "best-pu-leather-desk-pads-3",
    "rank": 3,
  ...
  {
    "id": "best-pu-leather-desk-pads-4",
    "rank": 4,
  ...
  {
    "id": "best-pu-leather-desk-pads-5",
    "rank": 5,
  ...
  {
    "id": "best-pu-leather-desk-pads-6",
    "rank": 6,
    "badge": "Worth a Look",
  ...
  {
    "id": "best-pu-leather-desk-pads-7",
    "rank": 7,
    "badge": "Best Value",
    ...
    "description": "Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse is a low-cost pick that doesn't skip the essentials. 7 inch size is large enough to accommodate your laptop, mouse and keyboard. We are dedicated to providing our customers with high quality products and superior service..\n\nSet next to Elizo Real Leather Desk Mat Set (32x16) Large Desk Cover Desk Blotter Protector, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nIt's worth picking this one if you want a capable pick without paying for headroom you won't use. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
    "specs": [
      "Protect your desk",
      "Multifunctional desk pad",
      "Special non-slip design"
  ...
  {
    "id": "best-pu-leather-desk-pads-8",
    "rank": 8,
    "badge": "Also Worth Considering",
...
export const breadcrumbLabel = "Best PU Leather Desk Pads";
