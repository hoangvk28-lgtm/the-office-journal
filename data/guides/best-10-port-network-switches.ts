...
export const guideTitle = "The Best 10-Port Network Switches for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "5G and 10G ports for homelab bandwidth upgrades.",
  "We compared this cluster across both use cases, since a search for \"10-port switch\" covers two different buyer intents depending on whether speed or PoE power is the priority."
];
...
export const metaDescription = "A practical comparison of 4 10-port network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 10-Port Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0G6CWFVB8?tag=theofficejournal-20",
    "description": "5GbE ports with 2 x 10GbE ports for fast home office or NAS networking, supporting 12KB jumbo frames and an 80Gbps switching capacity for non-blocking data transmission under load.\n\nThe fanless metal design supports both desktop and wall mounting, and clear LED indicators for power, link, and speed status make at-a-glance diagnostics easy without opening a management console.",
    "specs": [
      "8x 2.5GbE + 2x 10GbE ports",
      "12KB jumbo frames, 80Gbps capacity",
      "Fanless, desktop/wall mount"
    ],
    "pros": [
      "10GbE uplinks avoid an 8-port 2.5G bottleneck",
      "12KB jumbo frame support unusually generous",
      "Fanless despite the multi-gig port mix"
    ],
    "cons": [
      "Smaller, less established brand",
      "Unmanaged, no VLAN/QoS controls"
    ],
    "bestFor": "5gbe + 2x 10gbe ports"
  }
];
...
export const breadcrumbLabel = "Best 10-Port Network Switches";
