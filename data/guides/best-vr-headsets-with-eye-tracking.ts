...
export const guideTitle = "The Best VR Headsets With Eye Tracking: Our Picks";
...
export const metaDescription = "How 6 VR headsets with eye tracking compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best VR Headsets With Eye Tracking (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Consistent, accurate eye movement tracking and analysis for creative and commercial purposes",
      "Uncover actionable insights about your users experience in vr using heatmapping",
      "Optimize graphic fidelity in the user's line of sight reducing rendering workloads on gpus"
    ],
    "pros": [
      "Consistent, accurate eye movement tracking and analysis for creative and commercial purposes",
      "Uncover actionable insights about your users experience in vr using heatmapping",
      "Optimize graphic fidelity in the user's line of sight reducing rendering workloads on gpus",
      "Deliver breathtaking graphics, text & textures in simulations"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const breadcrumbLabel = "Best VR Headsets With Eye Tracking";
