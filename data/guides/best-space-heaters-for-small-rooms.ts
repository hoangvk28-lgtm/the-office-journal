...
export const guideTitle = "The Best Space Heaters for Small Rooms: Our Picks";
...
export const metaDescription = "How 6 space heaters for small rooms compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Space Heaters for Small Rooms (2026)";
...
export const breadcrumbLabel = "Best Space Heaters for Small Rooms";
