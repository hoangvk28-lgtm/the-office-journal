...
export const faq = [
  ...
  },
  {
    ...
    "a": "3 inches wide, the widest in this list, making it the best fit for open-concept rooms where a standard 4-panel screen wouldn't stretch far enough. Most other picks here use 4 panels and top out around 63-72 inches wide."
  }
];

export const guideSlug = "best-room-divider-screens";

export const guideTitle = "The Best Room Divider Screens for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to RHF 4 unless your specific needs call for the pricier pick."
  },
  {
    "subheading": "",
...
export const introParagraphs = [
  ...
  "Below are 8 room divider screens we compared on panel material, how much light and sound they actually block, and folding hinge quality, ranging from a $34 handmade rattan weave to a $140 frosted acrylic panel that outlasts glass without the weight."
];
...
export const metaDescription = "We compared 8 room divider screens on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Room Divider Screens for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B00A7YV51C?tag=theofficejournal-20",
    "description": "Its printed plum-blossom pattern in red and black over a translucent rice paper panel gives it the most distinctive look here, closer to wall art than a plain divider.\n\nHardwood framing keeps it sturdy despite being the lightest pick in this list at just 11 lbs, and it needs no assembly, so it goes from box to standing divider in minutes.\n\nMost distinctive printed shoji pattern.",
    "specs": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B01LYKP60O?tag=theofficejournal-20",
    "description": "The Giyano trades the traditional shoji look for an intricate white mosaic chip-themed frame, the most refined and modern design among the group. Pine and MDF construction is wrapped in non-woven fabric panels rather than rice paper, giving it a slightly different texture and feel.\n\nAt 70\"H x 70\"W it's sized to match most standard shoji screens, and like the rest of the Roundhill lineup it needs no assembly out of the box.",
    "specs": [
  ...
  },
  {
    ...
    "description": "This cherry-finish screen is the most authentic traditional shoji design in this list, built from real cherry wood with translucent rice paper panels that let natural light filter through rather than blocking it entirely. Two-way hinges let the panels fold in either direction for flexible placement.\n\nAt 15 lbs it's the lightest wood-framed shoji pick here, and it arrives fully assembled. Traditional rice paper shoji does need gentler care than synthetic panels; expect to touch up or replace the paper every couple of years in sun-exposed spots.\n\nTranslucent panels let natural light through.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The FDW wood mesh screen has more reviews than any other pick in this list at over 7,600, driven by its distinctive hand-woven lattice look that stands apart from both shoji paper and rattan weave designs. Eco wood construction paired with metal hinges keeps it foldable and lightweight.\n\nThe open mesh pattern trades privacy for airflow and light, more of a visual softener between spaces than a true opaque barrier, which is worth knowing before you buy.",
    "specs": [
  ...
  },
  {
    ...
    "description": ", the RHF rattan screen is the cheapest pick in this list without sacrificing craftsmanship, its handmade 5-medallion diamond weave gives it a distinctly boho look that the modern acrylic and shoji picks don't offer. Two-way hinges make it flexible to position around furniture or corners. Rattan and wood construction keeps it lightweight, and like most picks here it arrives needing no assembly, straight out of the box and ready to unfold.",
    "specs": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CNP8K3GC?tag=theofficejournal-20",
    "description": "JOSTYLE uses stainless steel 180-degree hinges instead of the standard metal hinges found on most screens in this list, a detail that matters since repeated folding is usually where screen hinges wear out first. Handmade pine framing keeps the natural wood look intact without paint or heavy stain.\n\nNon-woven fabric panels are odor-free out of the box, and like the rest of the shoji-style picks here, it arrives fully assembled and ready to unfold.",
    "specs": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DL95KY4S?tag=theofficejournal-20",
    "description": "3 inches wide, the widest screen in this list, built for rooms where a standard 4-panel screen wouldn't stretch far enough to fully divide the space. Durable tung wood framing holds up better against humidity than typical pine.\n\n360-degree bidirectional hinges are the most flexible in this list, letting panels fold either direction freely, and waterproof fabric panels add some resilience the paper-based shoji screens don't have.\n\nMost flexible 360° bidirectional hinges. 9\" height than most other picks.",
    "specs": [
...
export const relatedGuides = [
  {
    "href": "/guide/best-room-divider-with-storage",
    "title": "Best Room Dividers with Storage (2026)"
  },
  {
  ...
  {
    "href": "/guide/best-room-divider-freestanding",
    "title": "Best Freestanding Room Dividers (2026)"
  }
];

export const breadcrumbLabel = "Best Room Divider Screens";
