...
export const faq = [
  {
    "q": "Why does only the Gigabit model support Wake-on-LAN and PXE?",
    "a": "5G and 5G models don't mention WoL/PXE support in their published specs, so don't assume the higher-speed models include them."
  },
  {
    "q": "Do any Cable Matters adapters work with Android?",
    "a": "5G and 5G adapters do not support Android devices. Check a different brand if Android compatibility at multi-gig speeds is required."
  }
];

export const guideSlug = "best-cable-matters-usb-c-ethernet-adapters";

export const guideTitle = "The Best Cable Matters USB-C Ethernet Adapters for a Cleaner, More Useful Desk";

export const heroImage = "https://m.media-amazon.com/images/I/411fuyCdRqL._SL500_.jpg";

export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "A Current Cable Matters Model Map",
    "table": {
      "headers": [
        "",
        "",
      ...
      "rows": [
        ...
        [
          "",
          "",
          "Chromecast with Google TV compatible"
        ],
        [
          "",
          "",
        ...
        [
          "",
          "",
          "MacBook Pro 16in charging validated"
        ],
        [
          "",
          "",
        ...
        [
          "",
          "",
          "Highest speed plus highest charging in this brand lineup"
        ]
      ]
    }
  }
...
export const introParagraphs = [
  "5G with 140W charging, and 5Gb with 140W charging, all built around Realtek controllers with detailed real-world performance documentation.",
  "We mapped the current lineup from 1GbE through 5GbE and separated the PD-charging variants, since Cable Matters' Gigabit model uniquely adds Wake-on-LAN, PXE, and MAC cloning, features most of its own higher-speed siblings don't mention."
];
...
export const metaDescription = "A practical comparison of 6 cable matters USB-C ethernet adapters, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Cable Matters USB-C Ethernet Adapters for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-cable-matters-usb-c-ethernet-adapters-1",
    "rank": 1,
    "badge": "Best 5GbE",
  ...
  {
    "id": "best-cable-matters-usb-c-ethernet-adapters-2",
    "rank": 2,
    "badge": "Best 2.5GbE",
  ...
  {
    "id": "best-cable-matters-usb-c-ethernet-adapters-3",
    "rank": 3,
    "badge": "Best 2.5GbE with 140W Charging",
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FC61NLVD?tag=theofficejournal-20",
    "description": "1 charging, specifically calling out MacBook Pro 16\" compatibility for high-wattage charging needs.\n\n5G Ethernet Controller driver on older OS versions or certain Linux kernels, with wide compatibility across MacBook, iMac, Dell XPS, iPad Pro, Surface, NAS systems, routers, and switches.",
    "specs": [
      "2.5Gbps Ethernet + 140W PD 3.1",
      "Explicit MacBook Pro 16\" charging compatibility",
      "Aluminum housing, braided pigtail cable"
    ],
    "pros": [
      "140W PD 3.1 charging explicitly validated for MacBook Pro 16\"",
      "2.5Gbps is a solid middle ground between 1G and 5G/10G pricing",
      "Aluminum housing and braided cable for long-term durability",
      "Wide compatibility across Thunderbolt 3/4/5 and USB4 hosts"
    ],
    "cons": [
      "Requires a separately-purchased 140W-capable charger to use full PD",
      "2.5Gbps ceiling, no path to 5G without buying a different model"
    ],
    "bestFor": "buyers prioritizing 2.5gbps ethernet + 140w pd 3.1"
  },
  {
    "id": "best-cable-matters-usb-c-ethernet-adapters-4",
    "rank": 4,
    "badge": "Best Gigabit (WoL + PXE)",
    "name": "Cable Matters USB-C to Gigabit Ethernet Adapter",
    "price": "$14.99",
    "rating": null,
    "reviews": null,
    "imageUrl": "https://m.media-amazon.com/images/I/41yhx+F7n-L._SL500_.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0F8B7143W?tag=theofficejournal-20",
    ...
    "specs": [
      "Gigabit Ethernet with WoL, PXE, MAC cloning",
      "Aluminum housing, braided pigtail cable",
      "Not for Nintendo Switch"
    ],
    "pros": [
      "Supports Wake-on-LAN, PXE booting, and MAC address cloning, real IT-manageability features",
      "Plug-and-play with no drivers needed for standard use",
      "Aluminum housing with braided cable for durability",
      "Works across five major operating systems including IOS"
    ],
    "cons": [
      "Explicitly not compatible with Nintendo Switch",
      "No PD charging on this specific model"
    ],
    "bestFor": "Buyers prioritizing gigabit ethernet with wol, pxe, mac cloning"
  },
  {
    "id": "best-cable-matters-usb-c-ethernet-adapters-5",
    "rank": 5,
    "badge": "Best Gigabit with 140W Charging",
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F8TDL49F?tag=theofficejournal-20",
    ...
    "specs": [
      "Gigabit Ethernet + 140W PD (28V/5A)",
      "Chromecast with Google TV compatible",
      "Aluminum housing, braided pigtail cable"
    ],
    "pros": [
      "140W Power Delivery is enough for high-performance laptop charging",
      "Explicit Chromecast with Google TV compatibility",
      "Works across Windows, macOS, iPadOS, ChromeOS, and Linux",
      "Aluminum housing with flexible braided pigtail cable"
    ],
    "cons": [
      "140W charging requires a compatible high-wattage charger, sold separately",
      "Higher price than basic Gigabit-only adapters"
    ],
    "bestFor": "Buyers prioritizing gigabit ethernet + 140w pd (28v/5a)"
  },
  {
    "id": "best-cable-matters-usb-c-ethernet-adapters-6",
    "rank": 6,
    "badge": "Best 5GbE with 140W Charging",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-usb-c-ethernet-adapters-with-100w-charging",
    "title": "7 Best USB-C Ethernet Adapters With 100W Charging"
  }
];

export const breadcrumbLabel = "Best Cable Matters USB-C Ethernet Adapters";
