...
export const guideTitle = "The Best 2-Way Studio Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 2-way studio monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 2-Way Studio Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 2-Way Studio Monitors";
