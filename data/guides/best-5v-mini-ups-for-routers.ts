...
export const guideTitle = "The Best 5V Mini UPS for Routers, Compared";
...
export const metaDescription = "We compared 6 5V mini UPS for routers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 5V Mini UPS for Routers (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "bestFor": "6A, more headroom than most competitors' 5V/2A rating"
  }
];
...
export const breadcrumbLabel = "Best 5V Mini UPS for Routers";
