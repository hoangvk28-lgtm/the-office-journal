...
export const guideTitle = "The Best Compact Storage Carts for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 compact storage carts, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Compact Storage Carts for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Compact Storage Carts";
