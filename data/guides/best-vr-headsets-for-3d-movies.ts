...
export const guideTitle = "The Best VR Headsets for 3D Movies: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "3D Virtual Reality Headset for Adults and Kids 3D VR Games Movies Play)",
...
export const metaDescription = "A practical comparison of 6 VR headsets for 3D movies, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best VR Headsets for 3D Movies (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Light & comfortable",
      "Eye-care & crystal clear",
      "Immersive & game-ready"
    ],
    "pros": [
      "Light & comfortable",
      "Eye-care & crystal clear",
      "Immersive & game-ready",
      "Glasses-friendly & easy focus"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const breadcrumbLabel = "Best VR Headsets for 3D Movies";
