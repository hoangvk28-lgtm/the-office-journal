...
export const faq = [
  {
    "q": "Is a Rocketbook an electronic digital notebook?",
    "a": "No, a Rocketbook has no battery, screen, or onboard electronics, it's a specially coated reusable paper notebook that relies on your phone's camera to scan and digitize pages."
  },
  {
    "q": "What counts as an electronic digital notebook?",
    "a": "A standalone e-ink tablet with a screen and battery, or a smart pen set with onboard electronics that syncs handwriting in real time, both have confirmed rechargeable components."
  },
  {
    "q": "Do electronic digital notebooks need charging?",
    "a": "Yes, whether the electronics live in a tablet screen or a smart pen, a rechargeable battery is a defining feature of this category."
  },
  {
    "q": "Are electronic digital notebooks more expensive than paper ones?",
    "a": "Generally yes, the added hardware, whether a full e-ink screen or a sensor-equipped pen, costs more than a specially coated paper notebook with no electronics."
  }
];

export const guideSlug = "best-electronic-digital-notebooks";

export const guideTitle = "The Best Electronic Digital Notebooks for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "3in Note Air 5 C offers: Confirmed onboard RAM and storage. That's a real functional upgrade over the budget picks here, not just a brand markup."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "Excluded non-electronic paper notebooks entirely",
    "description": "Rocketbook-style reusable paper notebooks have no battery or onboard electronics and were intentionally excluded from this specific guide, despite being marketed under the same \"digital notebook\" search term."
  },
  {
    "title": "Confirmed a battery or rechargeable component per pick",
    "description": "Every product here has a stated rechargeable battery, either in a tablet or in a smart pen, verified from the listing."
  },
  {
    "title": "Onboard processing and storage noted where stated",
    "description": "Checked for stated RAM, storage, or processing specs as evidence of genuine electronic hardware rather than a passive writing surface."
  },
  {
    "title": "Price weighed against confirmed electronic functionality",
    "description": "Compared cost against the actual electronic features delivered, such as real-time sync or onboard OCR, not against paper-based alternatives."
  }
];

export const introParagraphs = [
  "\" A Rocketbook has no battery and no screen, it's a specially coated paper product you scan with your own phone.",
  "Every pick in this guide is real electronic hardware, either a standalone e-ink tablet or a smart pen set with onboard electronics. We compared stated specs and features rather than claiming hands-on testing."
];
...
export const metaDescription = "A practical comparison of 7 electronic digital notebooks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Electronic Digital Notebooks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "3 is genuine electronic hardware, running Android 10 on a rechargeable battery with an e-ink screen. This is a true e-ink digital notebook device (a standalone tablet with an e-paper screen you write on directly with a stylus, with files stored and synced digitally).\n\n3in Note Air 5 C for one main reason. Genuine electronic hardware with a rechargeable battery. 3in Note Air 5 C, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Android interface has some learning curve.",
    "specs": [
      "E-ink digital notebook device, Type 2",
      "10.3 inch ePaper display",
      "Android 10, rechargeable battery",
      "Front light and G-sensor"
    ],
    "pros": [
      "Genuine electronic hardware with a rechargeable battery",
      "Android 10 for app flexibility",
    ...
    "cons": [
      ...
      "Android interface has some learning curve"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Confirmed onboard RAM and storage",
      "Color ePaper display",
    ...
    "cons": [
      ...
      "Color e-ink trades some contrast versus black-and-white",
      "Premium price relative to non-electronic notebooks"
    ],
  ...
  },
  {
    ...
    "specs": [
      ...
      "Rechargeable battery, weeks per charge",
      "Digital file storage"
    ],
    "pros": [
      "Genuine rechargeable electronic hardware",
      "Long battery life measured in weeks",
      "Marker Plus included",
      "Distraction-free electronic interface"
    ],
    "cons": [
      "Higher price than non-electronic paper notebooks",
  ...
  },
  {
    ...
    "pros": [
      "Confirmed onboard electronics in the pen",
      "OCR and audio recording, genuine electronic functions",
      "Lowest price among electronic picks here",
  ...
  },
  {
    ...
    "pros": [
      "Genuine rechargeable pen electronics",
      "Real-time sync and cloud storage",
      "Pen and folio included",
      "Mid-range price for electronic functionality"
    ],
    "cons": [
      "Pen requires periodic charging",
  ...
  },
  {
    ...
    "pros": [
      "Confirmed onboard pen electronics",
      "States real-time text conversion",
      "Compatible with Android and IOS",
...
export const breadcrumbLabel = "Best Electronic Digital Notebooks";
