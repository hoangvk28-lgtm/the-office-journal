...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "2Pcs 34\" Heavy Duty Floating Shelf Brackets with Complete Installation Kit)",
        "text": "Highest weight capacity, but requires drilling into a wall stud."
      },
      {
        "label": "8pcs Floating Shelf Bracket Heavy Duty, Hidden Shelf Brackets Wall)",
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "These floating tv shelf mounting brackets are made of ultra-durable heavy-duty alloy steel",
  ...
  },
  {
    ...
    "specs": [
      "Complete all-in-one pro kit",
      "Achieve the ultimate clean, minimalist aesthetic for your home decor",
      "Universal wall stud alignment"
    ],
    "pros": [
      "Complete all-in-one pro kit",
      "Achieve the ultimate clean, minimalist aesthetic for your home decor",
      "Universal wall stud alignment",
      "Built for industrial-grade strength and long-term stability"
    ],
    "cons": [
      "Drywall anchors alone only safely hold up to 20 to 25 lbs",
      "Real weight capacity depends on stud spacing, not the shelf itself"
  ...
  },
  {
    ...
    "description": "4pcs Wall Shelf Brackets Heavy Duty Floating Shelf Bracket Hidden, Invisible is a strong alternative worth comparing directly against the top pick. Note: the board thickness we refer to is the actual (not nominal) size. Say goodbye to bulky l shaped or pipe brackets.\n\nAgainst 8pcs Wall Shelf Brackets Heavy Duty Floating Shelf Bracket Hidden, Invisible, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nThis one is the right call if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    "specs": [
      "Bracket has a 1\" backplate and is designed for use with boards 1.5\" thick",
      "Say goodbye to bulky l shaped or pipe brackets",
      "Constructed from durable galvanized steel with 1 inch height and 5mm thick backplate"
  ...
  },
  {
    ...
    "specs": [
      "Create modern floating shelves your way",
      "Engineered specifically for thin floating shelves",
      "True floating look with completely hidden hardware"
    ],
    "pros": [
      "Create modern floating shelves your way",
      "Engineered specifically for thin floating shelves",
      "True floating look with completely hidden hardware",
      "Made from premium gr1045 steel with a corrosion-resistant black finish"
    ],
    "cons": [
      "Real weight capacity depends on stud spacing, not the shelf itself",
      "Drywall anchors alone only safely hold up to 20 to 25 lbs"
  ...
  },
  {
    ...
    "specs": [
      "What you get",
      "Heavy duty fireplace mantel brackets",
