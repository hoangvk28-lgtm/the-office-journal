...
export const faq = [
  {
    "q": "What's the best-rated true 30-device cart?",
    "a": "The Pearington 30 Device Mobile Charging/Storage Cart, with the highest rating among confirmed 30-device carts in this comparison."
  },
  {
    "q": "What's the cheapest confirmed 30-device cart?",
    "a": "99, also explicitly rated for mixed Chromebook, iPad, and laptop fleets."
  },
  {
    "q": "Are any of these actually larger than 30 devices?",
    "a": "Yes, the ARTMAN pick is rated for 30+2 bays, one storage cart is rated for up to 36 units, and the Tripp Lite pick is a 42-port enterprise unit."
  },
  {
    "q": "Is there an open-access option for faster daily handout?",
    "a": "Yes, the POCHAR 30 Devices Open Laptop Charging Cart uses an open, non-locking design."
  },
  {
    "q": "Which pick has the least review history?",
    "a": "The ARTMAN 30+2 Bay Storage Cabinet has no confirmed rating or review history in our data pull."
  }
];

export const guideSlug = "best-30-laptop-charging-carts";

export const guideTitle = "The Best 30-Laptop Charging Carts for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "True 30-device carts separated from near-30 alternatives",
    "description": "We clearly distinguished carts confirmed at exactly 30 devices from those rated for 30+2, up to 36, or 42, so buyers searching specifically for 30-device capacity aren't misled by a larger unit."
  },
  {
    "title": "Price per bay compared across the true 30-device tier",
    "description": "We compared the range of price points in this comparison of confirmed 30-device carts directly, since price varied significantly for the same stated capacity."
  },
  {
    "title": "Open versus locking design noted as a workflow factor",
    "description": "Where a listing confirms open (non-locking) construction, we flagged it as generally faster for daily access rather than a downside by default."
  },
  {
    "title": "",
    "description": ""
...
export const metaDescription = "A practical comparison of 8 30-laptop charging carts, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 30-Laptop Charging Carts for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Highest rating among the true 30-device carts here",
      "32 simultaneous charging outlets while only 30 occupy locked storage"
    ],
    "cons": [
      "Highest price among the true 30-device options"
    ],
  ...
  },
  {
    ...
    "description": "The lowest price of any confirmed 30-device cart here, a bit less than the Pearington pick, explicitly rated for mixed Chromebook, iPad, and laptop fleets. A strong price-to-capacity ratio if mixed-device support matters to your fleet. Explicitly supports mixed device types.",
    "specs": [
      "30-device capacity, mixed-fleet rated"
    ],
    "pros": [
      "Lowest price among confirmed 30-device carts",
      "Explicitly supports mixed device types"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "A reasonable middle option if you specifically want a K-12-marketed listing rather than a general mixed-fleet one.\n\nBoth are worth keeping in mind before deciding.",
    "specs": [
      "30-device capacity",
      "K-12 classroom oriented"
    ],
    "pros": [
      "Purpose-built for K-12 use"
    ],
    "cons": [
      "Slightly lower rating than the sibling POCHAR listing"
    ],
  ...
  },
  {
    ...
    "specs": [
      "30-bay capacity",
      "School-oriented mobile cart"
    ],
    "pros": [
      "Largest review base among true 30-device carts here"
    ],
    "cons": [
      "Lowest rating among the true 30-device carts here"
    ],
  ...
  },
  {
    ...
    "specs": [
      "42-port AC charging (exceeds 30-device target)"
    ],
    "pros": [
      "Room to grow past a 30-device fleet"
    ],
    "cons": [
      "Far higher price than the true 30-device options",
      "Exceeds the stated 30-device target"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0B2PB8LK1?tag=theofficejournal-20",
    "description": "Rated for up to 36 units rather than exactly 30, priced close to the true 30-device carts, worth considering if your fleet is closer to the mid-30s.\n\nRoom for growth past 30 devices at a similar price to the true 30-device carts.",
    "specs": [
      "Up to 36-unit capacity (exceeds 30-device target)"
    ],
    "pros": [
      "Room for growth past 30 devices at a similar price to the true 30-device carts"
    ],
    "cons": [
      "Exceeds the stated 30-device target, verify actual bay count fits your fleet"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Small buffer above the exact 30-device target"
    ],
    "cons": [
      "No review history or confirmed rating available yet",
      "Highest price among the near-30-device options"
    ],
...
export const breadcrumbLabel = "Best 30-Laptop Charging Carts";
