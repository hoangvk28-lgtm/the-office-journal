...
export const faq = [
  {
    "q": "How small is a 'small' portable file box?",
    "a": "This varies by product, so check the specific listing's disclosed dimensions rather than relying on the relative 'small' label alone."
  },
  {
    "q": "How many folders can a small file box actually hold?",
    "a": "Meaningfully fewer than a standard-size box. Plan for a modest personal document collection rather than an active, larger filing system's full folder count."
  },
  {
    "q": "Is a small file box a good value?",
    "a": "It depends on your realistic needs. A small box isn't automatically cheaper per document stored than a standard-size box, so compare based on your actual capacity requirements."
  },
  {
    "q": "Is cardboard durable enough for a small file box?",
    "a": "For lighter-use, archived documents, yes. For frequently accessed or long-term storage, a plastic box like the Pendaflex pick offers more durability worth the price premium."
  },
  {
    "q": "What's the best use case for a small file box?",
    "a": "A modest personal document collection, like a single year's tax records or a small project's files, rather than an active larger filing system with many ongoing categories."
  }
];

export const guideSlug = "best-small-portable-file-boxes";

export const guideTitle = "The Best Small Portable File Boxes for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We favored picks with disclosed specific dimensions rather than a vague 'small' relative descriptor."
  },
  {
    "title": "",
    "description": "We noted that a smaller box holds meaningfully fewer hanging folders than buyers might assume, and disclosed this honestly for each pick."
  },
  {
    "title": "Genuine best-fit use case framing",
    "description": "We identified the realistic best-fit use case for this size tier as a modest personal document collection, not an active larger filing system."
  },
  {
    "title": "",
    "description": "We compared value against a standard-size box, since a small box isn't automatically cheaper per document stored."
  }
];
...
export const metaDescription = "A practical comparison of 5 small portable file boxes, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Small Portable File Boxes for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "This compact cardboard box is the most affordable pick in this comparison, sold as a 2-pack, appropriate for a modest personal document collection like tax records or a small project's files rather than an active larger filing system.\n\nOn price, it comes in below Pendaflex Portable File Box, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, No lid seal or lock.",
    "specs": [
      "Compact cardboard construction",
      "2-pack",
      "Carrying handle",
      "Very affordable"
    ],
  ...
  },
  {
    ...
    "pros": [
      "More durable than cardboard alternatives",
      "Double latch closure for security",
      "Strong rating",
      "Genuine hanging file rails"
    ],
    "cons": [
      "Higher price than the cardboard picks",
      "Larger than the most compact options here",
      "Letter size only"
    ],
  ...
  },
  {
    ...
    "cons": [
      "Reduced capacity versus standard-size boxes",
      "No lock",
      "Mesh may not fully contain the smallest items"
    ],
  ...
  },
  {
    ...
    "cons": [
      "Not the most compact option here",
...
export const relatedGuides = [
  {
    "href": "/guide/best-slim-portable-file-boxes",
    "title": "Best Slim Portable File Boxes (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Small Portable File Boxes";
