...
export const guideTitle = "The Best Projectors With Bluetooth: Our Picks";
...
export const metaDescription = "How 8 projectors with bluetooth compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Projectors With Bluetooth (2026)";
...
export const breadcrumbLabel = "Best Projectors With Bluetooth";
