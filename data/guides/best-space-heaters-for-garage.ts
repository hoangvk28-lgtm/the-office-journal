...
export const guideTitle = "The Best Space Heaters for Garage, Compared";
...
export const metaDescription = "We compared 6 space heaters for garage on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Space Heaters for Garage (2026)";
...
export const breadcrumbLabel = "Best Space Heaters for Garage";
