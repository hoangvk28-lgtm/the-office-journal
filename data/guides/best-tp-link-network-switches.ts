...
export const guideTitle = "The Best TP-Link Network Switches for a Better Desk Setup";
...
export const metaDescription = "We compared 8 TP-link network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best TP-Link Network Switches for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-netgear-network-switches",
    "title": "8 Best NETGEAR Network Switches in 2026"
  },
  {
    "href": "/guide/best-ugreen-network-switches",
    "title": "best-ugreen-network-switches"
  },
  {
...
export const breadcrumbLabel = "Best TP-Link Network Switches";
