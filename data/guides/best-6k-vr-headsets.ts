...
export const guideTitle = "The Best 6K VR Headsets for Everyday Desk Work";
...
export const metaDescription = "How 6 6K VR headsets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 6K VR Headsets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Immersive HD experience",
      "Unleash your full potential with our cutting-edge nine axes body sensing technology",
      "Versatile otg connectivity"
    ],
    "pros": [
      "Immersive HD experience",
      "Unleash your full potential with our cutting-edge nine axes body sensing technology",
...
export const breadcrumbLabel = "Best 6K VR Headsets";
