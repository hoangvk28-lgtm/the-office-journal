export const guideSlug = "best-under-desk-space-heaters";
export const guideTitle = "7 Best Under-Desk Space Heaters in 2026";
export const metaTitle = "Best Under-Desk Space Heaters";
export const metaDescription = "We compared space heater under desk models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "space heater under desk";
export const introParagraphs = [
  "Best Under-Desk Space Heaters aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
...
export const products: GuideProduct[] = [
  {
    id: "best-under-desk-space-heaters-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-under-desk-space-heaters-2",
    rank: 2,
  ...
  {
    id: "best-under-desk-space-heaters-3",
    rank: 3,
  ...
  {
    id: "best-under-desk-space-heaters-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-under-desk-space-heaters-5",
    rank: 5,
    badge: "Best Premium Pick",
    name: "WHISPERHEAT Under Desk Warmer",
    price: "$79.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/418Is9jV7CL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0DDMKWKMS?tag=theofficejournal-20",
    description: "WHISPERHEAT Under Desk Warmer is the top-tier pick in this comparison. Enjoy quiet, fanless warmth for your legs and feet, perfect for comfort at work, home office, or any personal space. Features 3 simple buttons to change heating levels and an auto-shutoff timer.\n\nSlim, lightweight, and foldable design, a detail worth checking closely before choosing between this and DREO Space Heater.\n\nIt's worth picking this one if you are willing to spend the most in this comparison for the fuller feature set that comes with it. The manufacturer's square-footage coverage assumes a reasonably insulated room, so a drafty or high-ceiling space may need more wattage than the listing suggests.",
    specs: ["Silent radiant heat", "Customizable warmth", "Safe & energy efficient"],
    pros: ["Silent radiant heat", "Customizable warmth", "Safe & energy efficient", "Portable & compact"],
    cons: ["Coverage claims assume a well-insulated, average-height room", "Running at full wattage all day adds up on the electric bill"],
    bestFor: "buyers who are willing to spend the most in this comparison for the fuller feature set that comes with it",
  },
  {
    id: "best-under-desk-space-heaters-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-under-desk-space-heaters-7",
    rank: 7,
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You're heating a larger room and want a thermostat and multiple heat settings, where WHISPERHEAT Under Desk Warmer justifies the extra cost."
      },
      {
        "label": "Save if",
