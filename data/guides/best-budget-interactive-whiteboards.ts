...
export const guideTitle = "The Best Budget Interactive Whiteboards for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Add a wall mount or mobile stand ($100-300), any needed cables, and factor in that most panels ship without a stand at all. A $600 panel plus a $200 stand is a different budget decision than the panel price alone suggests."
  }
];
...
export const metaDescription = "We compared 7 budget interactive whiteboards on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Budget Interactive Whiteboards for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-das-storage",
    "title": "best-das-storage"
  },
  {
    "href": "/guide/best-interactive-whiteboards-for-home",
    "title": "7 Best Interactive Whiteboards for Home"
  },
  {
...
export const breadcrumbLabel = "Best Budget Interactive Whiteboards";
