...
export const guideTitle = "The Best Tape Dispensers Under $30, Compared";
...
export const metaDescription = "We compared 6 tape dispensers under $30 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Tape Dispensers Under $30 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Medlot is a sub-brand of lotfancy",
  ...
  },
  {
    ...
    "specs": [
      "Easy to cut",
      "well suited to making flat lightweight items magnetic",
      "Many applications"
    ],
    "pros": [
      "Easy to cut",
...
export const breadcrumbLabel = "Best Tape Dispensers Under $30";
