...
export const guideTitle = "The Best CO2 Laser Engravers for Everyday Desk Work";
...
export const metaDescription = "How 8 CO2 laser engravers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best CO2 Laser Engravers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "OMTech K40+ 45W Desktop CO2 Laser Engraver & Cutter doesn't just check boxes. Our 24/7 global support team delivers expert assistance, including technical guidance and local demos by appointment. 31\" (8mm) wood with ease.\n\nOn top of that, Engrave at speeds up to 300 mm/s, ideal for complex designs and bulk orders. A compact 12\"×8\" workspace supports both standard and irregular materials. A strong contender once you look past the headline spec.",
    "specs": [
...
export const breadcrumbLabel = "Best CO2 Laser Engravers";
