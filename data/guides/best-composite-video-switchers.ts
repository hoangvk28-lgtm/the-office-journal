...
export const guideTitle = "The Best Composite Video Switchers for a Better Desk Setup";
...
export const metaDescription = "We compared 8 composite video switchers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Composite Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Composite Video Switchers";
