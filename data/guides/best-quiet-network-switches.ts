...
export const guideTitle = "The Best Quiet Network Switches for Everyday Desk Work";
...
export const introParagraphs = [
  "A network switch living in a bedroom, home office, or media console needs to be silent, not just quieter than a server rack. Every switch in this list is fanless, but there's a real distinction between completely passive designs and switches with a fan that only spins under heavy thermal load.",
...
export const metaDescription = "How 7 quiet network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Quiet Network Switches for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-desktop-network-switches",
    "title": "8 Best Desktop Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best Quiet Network Switches";
