...
export const guideTitle = "The Best Desk Fans for Home Office: Our Picks";
...
export const metaDescription = "How 8 desk fans for home office compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Desk Fans for Home Office (2026)";
...
export const breadcrumbLabel = "Best Desk Fans for Home Office";
