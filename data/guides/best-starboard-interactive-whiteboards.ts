...
export const guideTitle = "Best StarBoard Interactive Whiteboards";
export const metaTitle = "Best StarBoard Interactive Whiteboards";
export const metaDescription = "We separated current Android StarBoard displays from legacy FX-series boards and included genuinely current alternatives.";
...
export const introParagraphs = [
  ...
  "We verified current sales status separately from support-page availability, mapped current versus legacy StarBoard generations where documentation allows, and included genuinely current-generation alternatives from actively competing brands."
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "Verify Current Generation",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-ricoh-interactive-whiteboards","title":"Best Ricoh Interactive Whiteboards"},{"href":"/guide/best-iqboard-interactive-whiteboards","title":"Best IQBoard Interactive Whiteboards"},{"href":"/guide/best-electronic-interactive-whiteboards","title":"8 Best Electronic Interactive Whiteboards"}];
