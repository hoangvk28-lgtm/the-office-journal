...
export const guideTitle = "The Best XLR Audio Interfaces for Streaming: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 XLR audio interfaces for streaming, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best XLR Audio Interfaces for Streaming (2026)";
...
export const breadcrumbLabel = "Best XLR Audio Interfaces for Streaming";
