...
export const guideTitle = "The Best 4-Port Network Switches for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "Standalone dedicated 4-port unmanaged switches are uncommon in the current market, most manufacturers build 5-port as their smallest unmanaged unit, so most 4-port options you'll find are actually PoE switches or specialized appliances rather than a pure basic switch.",
...
export const metaDescription = "A practical comparison of 4 4-port network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4-Port Network Switches for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 4-Port Network Switches";
