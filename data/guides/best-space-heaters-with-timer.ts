...
export const guideTitle = "The Best Space Heaters With Timer, Compared";
...
export const metaDescription = "We compared 6 space heaters with timer on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Space Heaters With Timer (2026)";
...
export const breadcrumbLabel = "Best Space Heaters With Timer";
