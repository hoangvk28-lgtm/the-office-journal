...
export const guideTitle = "The Best Bluetooth Projectors for a Better Desk Setup";
...
export const metaDescription = "We compared 8 bluetooth projectors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Bluetooth Projectors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Bluetooth Projectors";
