...
export const faq = [
  {
    "q": "Does any student desk actually come with a built-in cup holder?",
    "a": "No, we found none in our research. What's available are clip-on cup holder accessories for desks and chairs, sold individually or in classroom bulk packs."
  },
  {
    "q": "What's the cheapest way to outfit a full classroom?",
    "a": ""
  },
  {
    "q": "Is there an option for a single dorm room desk?",
    "a": "Yes, the KDD 4-in-1 Desk Organizer is sold as a single unit rather than a bulk classroom pack."
  },
  {
    "q": "Which pack is best for a large classroom?",
    "a": "The gisgfim 24 Pcs Water Bottle Holder, which also works out to a competitive per-unit price for larger orders."
  },
  {
    "q": "Do any of these include mounting hardware for chairs?",
    "a": "Yes, the 12 Pcs Water Bottle Holder with 50 Pcs Zip Ties pack includes hardware specifically for chair-frame mounting."
  }
];

export const guideSlug = "best-student-desks-with-cup-holders";

export const guideTitle = "The Best Student Desks with Cup Holders, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to Ferrochef 12 Pcs Classroom Adjustable Water Bottle Holder for Desk unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "Disclosed that no student desk ships with a built-in cup holder",
    "description": "We verified this directly and identified the genuine clip-on accessory market instead of forcing an inaccurate integrated-product framing."
  },
  {
    "title": "Compared per-unit cost across different pack sizes",
    "description": "We calculated the effective per-holder price across 12-packs, 24-packs, and single units to compare real value for different buyer needs."
  },
  {
    "title": "Distinguished classroom bulk buyers from single-desk buyers",
    "description": "A teacher outfitting 24 desks has different needs than a parent buying one holder for a dorm room desk, and we ranked accordingly."
  },
  {
    "title": "",
    "description": "We flagged which packs include hardware (zip ties) for chair-frame mounting versus desk-edge-only clip designs."
  }
];

export const introParagraphs = [
  "We need to be direct here: we found no classroom or student desk that ships with a factory-built-in cup holder. What exists, and what most classrooms and dorm setups actually use, is a clip-on water bottle or cup holder that attaches to an existing desk or chair edge.",
...
export const metaDescription = "We compared 4 student desks with cup holders on compatibility, build, features and price to help you choose the right one for your space.";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GQMLXYV6?tag=theofficejournal-20",
    ...
    "specs": [
      "12-pack, adjustable sizing, desk clip"
    ],
    "pros": [
      "Lowest price per unit in this comparison",
      "Adjustable to fit different bottle and cup sizes"
    ],
    "cons": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F82XP4MR?tag=theofficejournal-20",
    ...
    "specs": [
      "12-pack, anti-spill design, includes 50 zip ties"
    ],
    "pros": [
      "Zip ties included for chair-frame mounting",
      "Anti-spill design feature"
    ],
    "cons": [
      "Slightly higher price than the Ferrochef 12-pack"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FMFKJH4D?tag=theofficejournal-20",
    ...
    "specs": [
      "24-pack, 360-degree rotation, desk or chair mount"
    ],
    "pros": [
      "Largest pack size for outfitting bigger classrooms",
      "Rotating design and dual desk/chair compatibility"
    ],
    "cons": [
      "Higher total cost than the smaller packs if you only need 12 units",
...
export const relatedGuides = [
  {
    "href": "/guide/best-rolling-desks-with-cup-holders",
    "title": "Best Rolling Desks with Cup Holders (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Student Desks with Cup Holders";
