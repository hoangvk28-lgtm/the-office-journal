...
export const guideTitle = "The Best 2D Barcode Label Printers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Rollo Direct Thermal 2x1 Barcode Labels)",
...
export const metaDescription = "How 6 2D barcode label printers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 2D Barcode Label Printers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "X 1: our 2\" x 1\" (51mm x 25mm)",
      "2X1 thermal label roll",
      "Crystal clear print"
    ],
    "pros": [
      "X 1: our 2\" x 1\" (51mm x 25mm)",
      "2X1 thermal label roll",
      "Crystal clear print",
      "1000 Sticker label roll: the roll of 2x1 thermal"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "specs": [
      "Cut costs, not options",
      "One printer, endless labels",
      "Crisp barcodes, zero ink"
    ],
    "pros": [
      "Cut costs, not options",
      "One printer, endless labels",
      "Crisp barcodes, zero ink",
      "\"Clabel trade\" app goes from download to your first label in under 2 minutes"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
...
export const breadcrumbLabel = "Best 2D Barcode Label Printers";
