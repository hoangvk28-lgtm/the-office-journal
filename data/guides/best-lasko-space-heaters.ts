...
export const guideTitle = "The Best Lasko Space Heaters for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Lasko Portable Indoor Ceramic Space Heater)",
...
export const metaDescription = "A practical comparison of 7 lasko space heaters, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Lasko Space Heaters for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "120° Heat distribution: the ellipse 18\" space heater is ideal for medium sized to large rooms",
      "Use 50% less energy"
    ],
    "pros": [
      "Brilliantly designed",
  ...
  },
  {
    ...
    "specs": [
      "Brilliantly designed",
      "120° Heat distribution: the ellipse 12\" space heater is ideal for medium sized rooms",
      "Use 50% less energy"
    ],
    "pros": [
      "Brilliantly designed",
...
export const breadcrumbLabel = "Best Lasko Space Heaters";
