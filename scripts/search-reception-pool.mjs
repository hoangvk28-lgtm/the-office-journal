...
const queries = [
  "large reception desk office counter",
  "small reception desk office counter",
  "reception desk with wheels mobile",
  "portable folding reception desk",
  "reception desk stone quartz top",
  "L-shaped reception desk office",
  "modern reception desk salon",
  "budget reception desk under 300",
  "reception desk with storage cabinet",
];
const pool = {};
...
writeFileSync(resolve(ROOT, "/tmp/reception_pool.json"), JSON.stringify(pool, null, 2));
