...
const raw = readFileSync(resolve(ROOT, "scripts", "unique_asins_laptop-locks.txt"), "utf-8");
...
writeFileSync(resolve(ROOT, "scripts", "data-laptop-locks.json"), JSON.stringify(allItems, null, 2), "utf8");
...
writeFileSync(resolve(ROOT, "scripts", "lookup-laptop-locks.json"), JSON.stringify(lookup, null, 2), "utf8");
console.log("Saved to scripts/data-laptop-locks.json and scripts/lookup-laptop-locks.json");
