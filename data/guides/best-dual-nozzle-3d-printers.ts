...
export const guideTitle = "The Best Dual-Nozzle 3D Printers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 dual-nozzle 3D printers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Dual-Nozzle 3D Printers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Dual-Nozzle 3D Printers";
