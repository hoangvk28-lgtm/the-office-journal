...
export const guideTitle = "The Best Small Bookshelves for a Better Workspace";
export const metaTitle = "Best Small Bookshelves for Home Offices (2026)";
export const metaDescription =
  "How 9 small bookshelves compare on features, build and practical fit, with clear notes on who each one suits.";
...
export const introParagraphs = [
  ...
  "Below are 8 small bookshelves we compared on footprint, weight capacity, and standout features like removable drawers or built-in lighting, ranging from ultra-low end tables to slim tree-style units under 8 inches wide.",
];
...
export const products: GuideProduct[] = [
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0CDFTGTHC?tag=theofficejournal-20",
    description:
      "An X-frame with cross bars and a backboard keeps it rigid despite the compact size.\n\n7 inches wide and rated for 50 lbs total, it's small but sturdy, and its low profile doubles as an end table or nightstand rather than just being marketed that way.\n\n6\" profile fits the foot of a bed or sofa side.",
    specs: [
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B074NHRZQX?tag=theofficejournal-20",
    description:
      "FSC-certified composite wood is E1 certified for low emissions, and a closed back panel adds a bit of extra rigidity most open-back cube shelves lack. At just 13 lbs, it's light enough to move around easily, and its tiny footprint makes it the easiest pick here to squeeze into the tightest corner or a narrow gap between furniture.",
    specs: [
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B08XX3XYBB?tag=theofficejournal-20",
    description:
      "FSC-certified composite wood forms 3 open shelves backed by a solid panel, rated for 80 lbs total.\n\n7 inches across, it sits nicely under a window or along a low wall in a small room, offering more shelf surface area than the narrower LUDER pick while keeping the same compact height.\n\n5\" profile fits under a window.",
    specs: [
  ...
  },
  {
    ...
    description:
      "6 inches deep, delivering more storage per square foot than any other pick in this list. Engineered wood and metal construction is backed by a backboard for stability, and the drawer gives you a spot for smaller items you'd rather keep hidden.\n\n46 lbs, it's easy to move if you need to rearrange, and rated for 30 lbs per shelf, 150 lbs total, it handles a genuine mix of books and decor across its 5 tiers.\n\nMost storage per square foot in this list.",
    specs: [
...
export const faq: FaqItem[] = [
  {
    ...
    a: "8 stars and a low profile that doubles as an end table or nightstand.",
  },
  {
  ...
  },
  {
    ...
    a: "1 inches deep, both suited to tucking behind a sofa or beside a bed.",
  },
  {
