...
export const faq = [
  {
    "q": "Should I mount my power strip to the standing desk frame or the moving desktop?",
    "a": "Mounting to the fixed frame while cables run to moving desktop devices creates repeated flex and strain at connector points every height change. Mounting to the moving desktop avoids this but requires sufficient cord slack for the full height range."
  },
  {
    "q": "How much cord slack do I need for a desktop-mounted power strip?",
    "a": "Measure your standing desk's full height-adjustment range and plan slack accordingly, not just enough for the desk's lowest position, to avoid tension at maximum height."
  },
  {
    "q": "Does the weight of a power strip matter for a standing desk?",
    "a": "Yes, especially for lower-capacity standing desk motors. Additional weight from the strip, cables, and adapters mounted to the moving surface adds to the desk's dynamic load, choose a lighter pick if your motor has a lower lift capacity."
  },
  {
    "q": "Can I use my existing cable management chain for the power strip's cord too?",
    "a": "Verify it accommodates the extra cable. Standing desk cable management systems are usually designed around device cables, the power strip's own cord to the wall outlet needs slack management through the same vertical range."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Cable strain across a full height-adjustment cycle",
    "description": "Considered how fixed-position mounting versus desktop mounting affects cable flex and strain at connector points as a standing desk moves through its height range."
  },
  {
    "title": "Weight and dynamic load for desktop-mounted placement",
    "description": "Weighed each pick's weight against the added dynamic load it contributes if mounted to a moving desktop, relevant for lower-capacity standing desk motors."
  },
  {
    "title": "Cord length and slack planning for desktop mounting",
    "description": "Noted that desktop-mounted strips need sufficient cord slack to avoid tension at maximum desk height, a specific length consideration based on a desk's height-adjustment range."
  }
];
...
export const metaDescription = "How 5 power strips for standing desks compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Power Strips for Standing Desks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "12 outlets and 2100 joules from an established brand, enough capacity for a standing desk's full equipment load. Solid build quality helps withstand the repeated flex a desktop-mounted strip experiences through height changes.\n\nEstablished brand build quality for repeated flex tolerance. On price, it's actually priced above Power Strip, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, No dedicated cable-chain compatibility feature.",
    "specs": [
    ...
    "pros": [
      "Established brand build quality for repeated flex tolerance",
      "High outlet count for a standing desk's full load",
      "Strong rating base",
      "Reasonable joule rating"
    ],
    "cons": [
      "Requires planning cord slack for desktop-mounted placement",
      "Higher price than budget alternatives",
      "No dedicated cable-chain compatibility feature"
    ],
  ...
  },
  {
    ...
    "description": "12 outlets, 4 USB ports, and 2700 joules, real capacity for a standing desk with a PC, monitors, and charging devices all moving with the desktop.\n\nOn the other side, No individual outlet switches.",
    "specs": [
    ...
    "pros": [
      "High outlet and USB capacity for a full standing desk setup",
      "Explicit surge protection",
      "ETL listed"
    ],
    "cons": [
      "6ft cord may need extra slack planning for desktop mounting",
      "Larger footprint on a moving surface",
  ...
  },
  {
    ...
    "description": "A lightweight, compact option that adds minimal dynamic load if mounted to the moving desktop of a lower-capacity standing desk motor.\n\nOn the other side, Still requires cord slack planning for desktop mounting.",
    "specs": [
    ...
    "pros": [
      "Lightweight, adds minimal dynamic load to the desk motor",
      "Braided cord resists repeated flex wear",
      "Very affordable"
    ],
    "cons": [
      "Fewer outlets than higher-capacity picks",
      "No USB ports",
      "Still requires cord slack planning for desktop mounting"
    ],
  ...
  },
  {
    ...
    "description": "6 outlets and 3 USB ports at 1680 joules, a solid middle-capacity option for a standing desk with a PC, monitor, and USB-charged devices.\n\nThe real tradeoff against that pick: Fewer outlets than the 12-outlet picks.\n\nOn the other side, Standard cord length may need slack planning.",
    "specs": [
    ...
    "pros": [
      "Solid middle-capacity option for a standing desk",
      "3 USB ports included",
      "ETL listed"
    ],
    "cons": [
      "Fewer outlets than the 12-outlet picks",
      "No USB-C port",
      "Standard cord length may need slack planning"
    ],
  ...
  },
  {
    ...
    "description": "An affordable 6-outlet surge protector with an LED indicator, appropriate for a standard standing desk setup on a budget.\n\nOn the other side, 6 outlets may be tight for a full standing desk setup.",
    "specs": [
    ...
    "pros": [
      ...
      "Lightweight for desktop mounting"
    ],
    "cons": [
      "Lower joule rating than higher-capacity picks",
      "No USB ports",
      "6 outlets may be tight for a full standing desk setup"
    ],
...
export const breadcrumbLabel = "Best Power Strips for Standing Desks";
