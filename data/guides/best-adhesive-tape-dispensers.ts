...
export const guideTitle = "The Best Adhesive Tape Dispensers for a Better Desk Setup";
...
export const metaDescription = "We compared 4 adhesive tape dispensers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Adhesive Tape Dispensers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "E-z permanent refillable adhesive strips are designed for scrapbooks",
      "Easily customizable adhesive with foils or glitter",
      "Unbreakable release liner provides a consistent"
    ],
    "pros": [
      "E-z permanent refillable adhesive strips are designed for scrapbooks",
      "Easily customizable adhesive with foils or glitter",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-tabletop-tape-dispensers",
    "title": "Best Tabletop Tape Dispensers in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Adhesive Tape Dispensers";
