...
export const guideTitle = "The Best 90Hz VR Headsets for a Better Desk Setup";
...
export const metaDescription = "We compared 6 90Hz VR headsets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 90Hz VR Headsets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Pimax Crystal Super VR Headset, 57PPD & 3840x3840 Resolution per Eye, Ultra-Sharp is a strong alternative worth comparing directly against the top pick. Purchasing from unofficial sources may void warranty and compromise product authenticity. With 3840x3840 resolution per eye and 57ppd qled+miniled display enhanced, you can get unparalleled depth and contrast by local dimming, experience breathtaking clarity.\n\nAgainst Pimax Crystal Super VR Headset & VR Glasses with Micro-OLED, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    "specs": [
      "Please make sure to confirm your order is purchase",
      "3840x3840 resolution per eye and 57ppd qled+miniled display enhanced",
      "Rate-delivers 106° horizontal field of view and variable refresh rates of 72hz and 90hz"
    ],
    "pros": [
      "Please make sure to confirm your order is purchase",
      "3840x3840 resolution per eye and 57ppd qled+miniled display enhanced",
      "Rate-delivers 106° horizontal field of view and variable refresh rates of 72hz and 90hz",
      "Flexible tracking-benefit from available tracker support (lighthouse solution limited)"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-steamvr-headsets",
    "title": "Best SteamVR Headsets in 2026"
  },
  {
  ...
  {
    "href": "/guide/best-htc-vive-vr-headsets",
    "title": "Best HTC Vive VR Headsets in 2026"
  }
];

export const breadcrumbLabel = "Best 90Hz VR Headsets";
