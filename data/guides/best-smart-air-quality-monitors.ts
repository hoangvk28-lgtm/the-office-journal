...
export const guideTitle = "The Best Smart Air Quality Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 smart air quality monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Smart Air Quality Monitors for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-air-quality-monitors-with-co2-sensors",
    "title": "Best Air Quality Monitors With CO2 Sensors in 2026"
  }
];

export const breadcrumbLabel = "Best Smart Air Quality Monitors";
