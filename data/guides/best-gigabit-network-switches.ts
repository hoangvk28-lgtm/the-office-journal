...
export const faq = [
  {
    ...
    "a": "Online gaming needs low latency far more than high bandwidth, and a wired Gigabit connection typically adds under 1ms of switch latency, well below what matters for competitive play."
  },
  {
    "q": "Do all the ports on a Gigabit switch run at full speed simultaneously?",
    "a": ", a 24-port Gigabit switch needs at least 48Gbps to run every port at full duplex simultaneously without oversubscription)."
  }
];

export const guideSlug = "best-gigabit-network-switches";

export const guideTitle = "The Best Gigabit Network Switches for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "5G or faster, a multi-gig switch is worth the premium. Otherwise a Gigabit switch performs identically for a lower price."
  }
];
...
export const metaDescription = "How 7 gigabit network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Gigabit Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B000BCC0LO?tag=theofficejournal-20",
    "description": "1p QoS traffic classes, IGMP Snooping for clean 4K/8K multicast streaming, and jumbo frame support up to 9KB for large NAS transfers.\n\nBuilt-in surge and ESD protection rated to ±4kV guards against everyday power spikes, and D-Link backs it with Limited Lifetime Protection, meaning they'll repair or replace it for as long as you own it.",
    "specs": [
      "8 Gigabit ports, QoS + IGMP snooping",
      "9KB jumbo frame support",
      "±4kV surge protection, lifetime warranty"
    ],
    "pros": [
      "Lifetime warranty rare at this price point",
      "Jumbo frame support aids large NAS transfers",
      "Surge protection adds real durability"
    ],
    "cons": [
      "No web management despite QoS features",
      "Plastic components less rugged than full-metal rivals"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-network-switches",
    "title": "8 Best Network Switches in 2026"
  },
  {
    "href": "/guide/best-unmanaged-network-switches",
    "title": "7 Best Unmanaged Network Switches in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Gigabit Network Switches";
