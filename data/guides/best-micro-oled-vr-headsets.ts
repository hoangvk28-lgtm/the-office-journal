...
export const guideTitle = "The Best Micro-OLED VR Headsets for a Better Desk Setup";
...
export const metaDescription = "We compared 6 micro-OLED VR headsets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Micro-OLED VR Headsets for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Micro-OLED VR Headsets";
