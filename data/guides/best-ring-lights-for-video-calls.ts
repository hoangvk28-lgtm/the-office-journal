...
export const guideTitle = "The Best Ring Lights for Video Calls, Compared";
...
export const metaDescription = "We compared 8 ring lights for video calls on brightness, color temperature, adjustability and power to help you choose the right one for your space.";

export const metaTitle = "Best Ring Lights for Video Calls (2026)";
...
export const breadcrumbLabel = "Best Ring Lights for Video Calls";
