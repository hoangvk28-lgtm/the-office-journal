...
export const guideTitle = "The Best 27-Inch Gaming Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 27-inch gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 27-Inch Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "200hz refresh rate speeds up the frames per second to deliver an ultra-smooth 2D motion scene"
    ],
    "pros": [
      "Quality visuals",
      "Say “goodbye” to stuttering and tearing",
...
export const breadcrumbLabel = "Best 27-Inch Gaming Monitors";
