export const guideSlug = "best-budget-4k-monitors";
export const guideTitle = "6 Best Budget 4K Monitors in 2026";
export const metaTitle = "Best Budget 4K Monitors";
export const metaDescription = "We compared budget 4k monitors models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage floor.";
export const mainKeyword = "budget 4k monitors";
export const introParagraphs = [
  "Best Budget 4K Monitors vary more than expected. That means budget 4k monitors, few listings admit limits.",
  "budget 4k monitors is judged here on honest scaling behavior, because small panels need OS scaling."
];
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-4k-monitors","title":"Best 4K Monitors in 2026"},{"href":"/guide/best-qd-oled-4k-monitors","title":"Best QD-OLED 4K Monitors in 2026"},{"href":"/guide/best-ktc-4k-monitors","title":"Best KTC 4K Monitors in 2026"},{"href":"/guide/best-4k-monitors-with-hdmi-2-1","title":"Best 4K Monitors With HDMI 2.1 in 2026"}];
