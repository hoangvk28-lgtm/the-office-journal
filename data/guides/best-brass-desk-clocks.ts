...
export const faq = [
  {
    "q": "Are these solid brass or brass-colored?",
    "a": "Verify the current listing for each product, most are metal with a brass-toned finish rather than confirmed solid brass construction."
  },
  {
    "q": "Which is the most proven option?",
    "a": ""
  },
  {
    "q": "",
  ...
  {
    "q": "Is there a non-traditional clock mechanism available?",
    "a": "Yes, the mooas Flip Desk Clock uses an auto-flip display mechanism instead of a standard dial."
  },
  {
    "q": "How does this overlap with your gold desk clocks guide?",
    "a": "Substantially, brass and gold finishes are visually similar and often made by the same manufacturers, so check both guides for the full range of options."
  }
];

export const guideSlug = "best-brass-desk-clocks";

export const guideTitle = "The Best Brass Desk Clocks for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "1in offers: Largest, most substantial piece in this comparison. That's a real material or craftsmanship upgrade over the budget picks here, not just a brand markup."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We checked each product's described construction and flagged where confirmation of solid brass versus a brass-colored finish wasn't clear."
  },
  {
    "title": "",
    "description": "We compared value from basic budget-tier metal clocks up to premium mantel-style pieces."
  },
  {
    "title": "",
    "description": "We noted where a clock uses a distinctive mechanism (like the auto-flip mooas pick) versus a standard dial."
  },
  {
    "title": "Review volume and rating together",
    "description": "We weighted both metrics, since some budget options have far larger, more proven review histories than pricier alternatives."
  }
];
...
export const metaDescription = "A practical comparison of 5 brass desk clocks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Brass Desk Clocks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "On price, it comes in below HZDHCLH Vintage Table Clock Battery Operated on price, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Verify current listing for exact brass vs.",
    "specs": [
      "Metal body, gold/brass-toned finish",
      "Non-ticking movement"
    ],
    "pros": [
      "Non-ticking movement for quiet work"
    ],
    "cons": [
      "Verify current listing for exact brass vs. brass-toned finish"
    ],
  ...
  },
  {
    ...
    "pros": [
      "More substantial mantel-style design than basic table clocks"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "On the other side, Basic design compared to the mantel-style options.",
    "specs": [
      "Metal body",
      "Retro analog design"
    ],
    "pros": [
      "Cheapest option with a genuine metal body"
    ],
    "cons": [
      "Basic design compared to the mantel-style options"
    ],
  ...
  },
  {
    ...
    "specs": [
      "8.3 x 9.1 in, mantel style",
      "Silent movement"
    ],
    "pros": [
      "Largest, most substantial piece in this comparison",
      "Silent movement"
    ],
    "cons": [
      "Highest price and smallest review base"
    ],
  ...
  },
  {
    ...
    "description": "On the other side, Same price tier as the mantel-style option above without the same substantial size.",
    "specs": [
      "Auto-flip mechanism",
      "Retro vintage design"
    ],
    "pros": [
      "Distinctive flip mechanism, not just another traditional dial"
    ],
    "cons": [
      "Same price tier as the mantel-style option above without the same substantial size"
    ],
    "bestFor": "Buyers who want a different flip-clock mechanism in a vintage brass-toned aesthetic."
  }
];
...
export const relatedGuides = [
  {
    "href": "/guide/best-gold-desk-clocks",
    "title": "Best Gold Desk Clocks (2026)"
  },
  {
    "href": "/guide/best-bronze-desk-clocks",
    "title": "Best Bronze Desk Clocks (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Brass Desk Clocks";
