...
export const guideTitle = "The Best ELEPHAS Projectors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "4K Projector with WiFi and Bluetooth for Home Cinema)",
...
export const metaDescription = "We compared 8 ELEPHAS projectors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best ELEPHAS Projectors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "ELEPHAS Smart 4K Projector with WiFi and Bluetooth for Indoor Outdoor is a strong alternative worth comparing directly against the top pick. 2m+ content built-in ditch the stick and complex wiring. 0, we've stripped away the lag for a truly fluid experience.\n\nMini Projector for iPhone lands in a similar spot overall, but the deciding factor between the two is cinema-grade visuals, high brightness meets 98% ntsc color don't let daylight stop the show.\n\nThis one is the right call if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Marketed lumens and true ANSI lumens are often two different numbers, so confirm which one is quoted before comparing brightness.",
    "specs": [
      "Smarter all-in-one system, live tv & 1.2m+",
      "Intuitive smart os 2.0, instant-on & lag-free",
      "Cinema-grade visuals, high brightness meets 98% ntsc"
    ],
    "pros": [
      "Smarter all-in-one system, live tv & 1.2m+",
      "Intuitive smart os 2.0, instant-on & lag-free",
      "Cinema-grade visuals, high brightness meets 98% ntsc",
      "270° rotational freedom & lightweight portability, project"
    ],
    "cons": [
      "Marketed lumens and true ANSI lumens often differ",
      "Throw ratio needs checking against your room distance"
  ...
  },
  {
    ...
    "specs": [
      "Experience peak visual quality with elephas’ latest",
      "Built-in apps, compatible with netflix",
      "Ultra fast dual band WiFi and bluetooth"
    ],
    "pros": [
      "Experience peak visual quality with elephas’ latest",
      "Built-in apps, compatible with netflix",
      "Ultra fast dual band WiFi and bluetooth",
      "Auto focus projector + auto keystone"
    ],
    "cons": [
      "Marketed lumens and true ANSI lumens often differ",
      "Throw ratio needs checking against your room distance"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Big screen & tiny space",
      "Sharp enough for streaming",
      "Portable design & universal mounting"
    ],
    "cons": [
      "Marketed lumens and true ANSI lumens often differ",
      "Throw ratio needs checking against your room distance"
...
export const breadcrumbLabel = "Best ELEPHAS Projectors";
