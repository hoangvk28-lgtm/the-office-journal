...
export const introParagraphs = [
  "Best Portable Video Switchers span basic to broadcast-grade rigs, which is exactly why connection type changes real performance.",
  "We compared this lineup on documented latency and connectivity, since marketing copy tends to obscure this."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-portable-video-switchers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-portable-video-switchers-2",
    rank: 2,
  ...
  {
    id: "best-portable-video-switchers-3",
    rank: 3,
  ...
  {
    id: "best-portable-video-switchers-4",
    rank: 4,
  ...
  {
    id: "best-portable-video-switchers-5",
    rank: 5,
  ...
  {
    id: "best-portable-video-switchers-6",
    rank: 6,
    badge: "Best Value",
  ...
  {
    id: "best-portable-video-switchers-7",
    rank: 7,
  ...
  {
    id: "best-portable-video-switchers-8",
    rank: 8,
    badge: "Also Worth Considering",
    ...
    specs: ["All-in-one device", "Streaming flexibility", "Versatile inputs"],
    pros: ["All-in-one device", "Streaming flexibility", "Versatile inputs", "Enhanced performance"],
    cons: ["NDI routing adds real network bandwidth demands", "Input count fills up fast with cameras plus overlays"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
