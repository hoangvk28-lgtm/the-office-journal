...
export const products: GuideProduct[] = [
  {
    ...
    description: "The largest review base of any confirmed 36 inch converter, sharing VIVO's massive K Series review pool.\n\nIt earns the top spot in this comparison over FITUEYES Height Adjustable Standing Desk 36 Inch Wide Sit to Stand Converter for one main reason. Largest review base of any confirmed 36 inch converter. On price, it comes in below FITUEYES Height Adjustable Standing Desk 36 Inch Wide Sit to Stand Converter, which is worth weighing if cost is your deciding factor between the two.\n\nWorth knowing before you decide: Largest review base of any confirmed 36 inch converter. On the other side, None significant at this price and review level. That's the main tradeoff to weigh against everything above.",
    specs: ["36 inch platform"],
    pros: ["Largest review base of any confirmed 36 inch converter"],
  ...
  },
  {
    ...
    description: "The same 36 inch FITUEYES design and review pool as the alternative pick, listed separately.\n\nSitting just under FITUEYES Height Adjustable Standing Desk 36 Inch Wide Sit to Stand Converter, it costs more than FITUEYES Height Adjustable Standing Desk 36 Inch Wide Sit to Stand Converter. Here's the honest tradeoff: Duplicate of the other FITUEYES listing, check stock. And here's what it gets you instead: Same proven design and review pool as the alternative listing. That's the real difference between the two picks, not just a ranking number.\n\nWorth knowing before you decide: Same proven design and review pool as the alternative listing. On the other side, Duplicate of the other FITUEYES listing, check stock. That's the main tradeoff to weigh against everything above.",
    specs: ["36 inch platform"],
    pros: ["Same proven design and review pool as the alternative listing"],
  ...
  },
  {
    ...
    description: "The lowest price for a confirmed 36 inch converter in this comparison, marketed specifically for its effortless lift mechanism.\n\nRanked just behind FITUEYES Height Adjustable Standing Desk 36 Inch Wide Sit to Stand Converter Stand Up Desk Tabletop, it's priced lower than FITUEYES Height Adjustable Standing Desk 36 Inch Wide Sit to Stand Converter Stand Up Desk Tabletop. The real tradeoff against that pick: Smaller review base than the more established alternatives. In exchange, it offers this instead: Lowest price for a confirmed 36 inch converter. That's the swap that decides whether this pick or the one above it is the better fit for your desk.\n\nWorth knowing before you decide: Lowest price for a confirmed 36 inch converter. On the other side, Smaller review base than the more established alternatives. That's the main tradeoff to weigh against everything above.",
    specs: ["36 inch platform, effortless lift mechanism"],
    pros: ["Lowest price for a confirmed 36 inch converter"],
    cons: ["Smaller review base than the more established alternatives"],
  ...
  },
  {
    ...
    description: "A budget-friendly 36 inch platform from FlexiSpot, a well-established standing-desk brand, at a similarly low price to the SANODESK alternative.\n\nOne spot below SANODESK 36 inch Standing Desk Converter in this ranking, it costs more than SANODESK 36 inch Standing Desk Converter. The compromise here is straightforward: Smaller review base than the more established VIVO and FITUEYES picks. What you gain in return: Budget-friendly price from an established standing-desk brand. Whether that trade is worth it depends on which side matters more for your setup.\n\nWorth knowing before you decide: Budget-friendly price from an established standing-desk brand. On the other side, Smaller review base than the more established VIVO and FITUEYES picks. That's the main tradeoff to weigh against everything above.",
    specs: ["36 inch platform"],
    pros: ["Budget-friendly price from an established standing-desk brand"],
    cons: ["Smaller review base than the more established VIVO and FITUEYES picks"],
...
export const howWeEvaluated: HowWeEvaluatedItem[] = [
  { title: "Required confirmed 36 inch platform width for every pick", description: "We verified this exact dimension rather than including nearby sizes rounded loosely in marketing copy." },
  { title: "Compared review volume across established and budget brands at this size", description: "We noted where VIVO and FITUEYES have much larger review bases than the budget SANODESK and FlexiSpot alternatives at this specific size." },
  { title: "Flagged duplicate listings sharing identical specs", description: "We noted where the same FITUEYES design appears across multiple listings, useful for buyers checking current stock." },
  { title: "Weighed price against review history within this specific size tier", description: "36 inch converters here range across a range of price points, and we compared value across that range." },
];
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "VIVO Black 36 in Standing Desk Converter fits this specifically: Largest review base of any confirmed 36 inch converter."
      }
    ]
  },
  {
...
export const faq: FaqItem[] = [
  { q: "Which 36 inch converter has the most reviews?", a: "The VIVO Black 36 in Standing Desk Converter, sharing VIVO's massive K Series review pool of 15,583." },
  { q: "What's the cheapest confirmed 36 inch converter?", a: "The SANODESK 36 inch Standing Desk Converter at $115.99." },
  { q: "Is 36 inches enough for dual monitors?", a: "Generally yes, this is a genuine sweet spot size that comfortably fits two standard monitors with keyboard and mouse space." },
  { q: "Is there a FlexiSpot option at 36 inches?", a: "Yes, the FLEXISPOT Standing Desk Converter 36 Inch Desk Riser at a budget-friendly price." },
  { q: "Why do two FITUEYES listings look identical?", a: "The same product sometimes appears across multiple Amazon listings; check both for current stock and pricing before ordering." },
];
