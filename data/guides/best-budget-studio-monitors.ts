...
export const guideTitle = "The Best Budget Studio Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 budget studio monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Budget Studio Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Budget Studio Monitors";
