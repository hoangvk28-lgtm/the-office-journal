...
const asins = [
  "B0D9Y839DD", // WAMPAT Modern Metal Base 94.5" for 75-110" TVs
  "B011ZZO34M", // BDI Corridor 8173 79.25" for up to 85"
  "B0CTZZ9BCX", // CreekT 82.6" for 80/85/90"
  "B0C8THRN6S", // BAMACAR LED 82.7" for 70-90"
  "B0CJC74PMH", // WAMPAT Charging Station 102.2" for 85-100"
  "B0CJNGSM4N", // Aquzee 75.2" for 70-85"
  "B01N6BUEKU", // BDI Corridor 8179 79.25" for up to 85"
];
