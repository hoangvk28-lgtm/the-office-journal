...
export const guideTitle = "The Best Electric Space Heaters for Everyday Desk Work";
...
export const metaDescription = "How 7 electric space heaters compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Electric Space Heaters for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Electric Space Heaters";
