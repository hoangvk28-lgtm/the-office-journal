...
export const faq = [
  {
    "q": "Is the older StarBoard FX series still a good purchase today?",
    "a": "Verify current software and OS support status directly with StarBoard before purchasing legacy FX-series hardware, since older generations typically carry more long-term support risk than current-generation boards from actively competing brands."
  },
  {
    "q": "Does StarBoard offer EDLA certification on its current models?",
    "a": "Check StarBoard's current product documentation directly for EDLA certification status, since this varies by exact model generation and isn't guaranteed across the entire product line."
  },
  {
...
export const guideSlug = "best-starboard-interactive-whiteboards";

export const guideTitle = "The Best StarBoard Interactive Whiteboards for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Check StarBoard's own current product page directly for the latest Android generation and current sales status before assuming any specific StarBoard model found in search results is still a current, purchasable product."
  }
];
...
export const introParagraphs = [
  "StarBoard's current lineup has moved to newer Android generations, distinct from the legacy FX-series boards and older software still findable in search results, a real current-versus-legacy distinction worth checking before buying.",
  "We verified current sales status separately from support-page availability, mapped current versus legacy StarBoard generations where documentation allows, and included current-generation alternatives from actively competing brands."
];

export const lastUpdated = "2026-08-15";

export const mainKeyword = "starboard interactive whiteboard";

export const metaDescription = "We compared 8 StarBoard interactive whiteboards on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best StarBoard Interactive Whiteboards for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-starboard-interactive-whiteboards-1",
    "rank": 1,
  ...
  {
    "id": "best-starboard-interactive-whiteboards-2",
    "rank": 2,
  ...
  {
    "id": "best-starboard-interactive-whiteboards-3",
    "rank": 3,
  ...
  {
    "id": "best-starboard-interactive-whiteboards-4",
    "rank": 4,
  ...
  {
    "id": "best-starboard-interactive-whiteboards-5",
    "rank": 5,
  ...
  {
    "id": "best-starboard-interactive-whiteboards-6",
    "rank": 6,
  ...
  {
    "id": "best-starboard-interactive-whiteboards-7",
    "rank": 7,
    "badge": "Best Large-Room Alternative",
  ...
  {
    "id": "best-starboard-interactive-whiteboards-8",
    "rank": 8,
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-iqboard-interactive-whiteboards",
    "title": "Best IQBoard Interactive Whiteboards"
  },
  {
...
export const breadcrumbLabel = "Best StarBoard Interactive Whiteboards";
