...
export const guideTitle = "The Best Storage Carts for Bathroom, Compared";
...
export const metaDescription = "We compared 8 storage carts for bathroom on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Storage Carts for Bathroom (2026)";
...
export const breadcrumbLabel = "Best Storage Carts for Bathroom";
