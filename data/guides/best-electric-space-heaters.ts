...
export const introParagraphs = [
  "Across best electric space heaters, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is true wattage versus actual room coverage, since this predicts real winter running cost."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-electric-space-heaters-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-electric-space-heaters-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-electric-space-heaters-3",
    rank: 3,
  ...
  {
    id: "best-electric-space-heaters-4",
    rank: 4,
  ...
  {
    id: "best-electric-space-heaters-5",
    rank: 5,
  ...
  {
    id: "best-electric-space-heaters-6",
    rank: 6,
    ...
    description: "Dr Infrared Heater DR-968 Portable Space Heater is the top-tier pick in this comparison. Can heat up a large room with auto energy saving model with high and low feature. Dual heating systems featuring infrared quartz tube + ptc with 12-hour automatic shut-off timer.\n\nDREO Space Heater covers similar ground, though ir remote control, high pressure low noise blower with noise level 39 dB super quiet is what tips the choice one way or the other.\n\nIt's worth picking this one if you are willing to spend the most in this comparison for the fuller feature set that comes with it. Running any 1,500-watt heater for hours a day costs real money, roughly $0.12 to $0.23 per hour at average electricity rates, so a genuine low-wattage setting and working thermostat matter for the season's total cost.",
  ...
  {
    id: "best-electric-space-heaters-7",
    rank: 7,
