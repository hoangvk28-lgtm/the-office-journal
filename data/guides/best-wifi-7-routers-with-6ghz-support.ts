...
export const faq = [
  {
    "q": "Is 6GHz available everywhere on any Wi-Fi 7 router?",
    "a": "No, 6GHz channel and power level availability is regulated differently by country, verify what's permitted in your specific region."
  },
  {
    "q": "Why does my 6GHz connection briefly drop sometimes?",
    "a": "This is likely a DFS-related channel vacate, a real reliability quirk on some 6GHz channels rarely disclosed alongside speed marketing."
  },
  {
    "q": "Will 6GHz stay less congested than 5GHz long term?",
    "a": "Not indefinitely, the 'less congested' advantage is accurate today but will erode as more devices adopt 6GHz over time."
  },
  {
    "q": "Does 6GHz help or hurt in a dense apartment building?",
    "a": "It can help, its shorter range reduces interference from neighboring networks compared to an overcrowded 5GHz band in dense settings."
  }
];

export const guideSlug = "best-wifi-7-routers-with-6ghz-support";

export const guideTitle = "The Best Wi-Fi 7 Routers with 6GHz Support, Compared";
...
export const howWeEvaluated = [
  {
    "title": "Genuine 6GHz radio presence confirmed per model",
    "description": "Verified each router includes a real 6GHz radio rather than accepting the Wi-Fi 7 label alone as proof of 6GHz support."
  },
  {
    "title": "DFS interruption behavior disclosed as a real reliability quirk",
    "description": "Noted that DFS requirements on some 6GHz channels can cause routers to temporarily vacate a channel, a rarely disclosed reliability quirk."
  },
  {
    "title": "Congestion-trajectory expectations set realistically over time",
    "description": "Set realistic expectations that 6GHz's 'less congested' advantage is accurate today but will erode as more 6GHz devices enter the market."
  },
  {
    "title": "Dense-living range tradeoff framed as a genuine benefit where relevant",
    "description": "Noted that 6GHz's shorter range can reduce interference from neighboring networks in dense apartment settings, a real upside there."
  }
];
...
export const metaDescription = "We compared 4 wi-fi 7 routers with 6GHz support on compatibility, build, features and price to help you choose the right one for your space.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "5G ports avoid a wired bottleneck against the 6GHz radio's speed, and MLO's cross-band benefit still requires a Wi-Fi 7 MLO-capable client device even with this genuine 6GHz support.\n\n1-star rating, verify recent reviews.",
    "specs": [
      "Genuine 6GHz radio, tri-band",
      "BE9300 combined rating, 6-stream",
      "Full 2.5G ports",
      "6 internal antennas"
    ],
    "pros": [
      "Genuine 6GHz radio confirmed, not just a Wi-Fi 7 label",
      "Full 2.5G LAN ports avoid a wired bottleneck",
      "Solid mid-range price for genuine tri-band 6GHz"
    ],
    "cons": [
      "6GHz's shorter range still applies compared to 5GHz or 2.4GHz",
      "DFS-related brief interruptions possible on some 6GHz channels"
    ],
    "bestFor": "Buyers wanting confirmed genuine 6GHz capability"
  },
  {
    "id": "f76pq2t8-6ghz",
    "rank": 2,
    ...
    "description": "320MHz channel width support on the 6GHz band gives this router genuine wide-channel headroom, appropriate for buyers in less-dense environments wanting maximum 6GHz throughput.\n\nWide 6GHz channels perform best in standalone houses with cleaner spectrum, worth knowing that dense apartment settings may not fully realize this headroom regardless of the router's capability.\n\nGenuine 10G port pairs well with high 6GHz throughput. That said, 320MHz channel width is less reliably usable in dense apartment settings.",
    "specs": [
      "Genuine 6GHz radio, 320MHz channel width",
      "Tri-band, 10G + 2.5G ports",
      "6-stream, BE9700 combined rating"
    ],
    "pros": [
      "320MHz 6GHz channel width for genuine wide-channel headroom",
      "Genuine 10G port pairs well with high 6GHz throughput",
      "Strong pick for standalone houses with cleaner spectrum"
    ],
    "cons": [
      "320MHz channel width is less reliably usable in dense apartment settings",
      "Verify which 6GHz sub-bands like UNII-4 are permitted in your region",
      "Higher price than the BE550 for buyers who don't need the wider channel"
    ],
  ...
  },
  {
    ...
    "description": "A newer Wi-Fi 7 chipset generation with genuine 6GHz radio support, appropriate for buyers wanting the latest 6GHz implementation within TP-Link's tri-band lineup.\n\n3-star rating despite a smaller review sample.",
    "specs": [
      "Genuine 6GHz radio, tri-band",
    ...
    "pros": [
      "Newer chipset generation for the 6GHz radio implementation",
      "Genuine tri-band 6GHz radio included",
      "Positioned above the BE9700 in TP-Link's own lineup"
    ],
    "cons": [
      "Higher price than the BE550 for a chipset-generation upgrade",
      "6GHz's less-congested advantage will erode over time as more devices adopt it"
    ],
  ...
  },
  {
    ...
    "description": "A genuine tri-band mesh system carrying the 6GHz radio across whole-home coverage, appropriate for buyers wanting full 6GHz capability throughout a larger home rather than a single router's more limited 6GHz range.\n\n6GHz's shorter range makes mesh a good pairing for this band specifically, since multiple nodes compensate for the range 6GHz alone would struggle to cover in a larger home.",
    "specs": [
      "Genuine 6GHz radio, tri-band mesh",
      "BE10000 combined rating, 6-stream",
      "Whole-home mesh coverage"
    ],
    "pros": [
      "Genuine 6GHz radio carried across whole-home mesh coverage",
      "Mesh design compensates for 6GHz's shorter single-unit range",
      "6-stream configuration for strong total household capacity"
    ],
    "cons": [
      "Higher price than a single tri-band router with 6GHz support",
      "Verify whether 6GHz backhaul between nodes is dedicated or shared"
    ],
...
export const breadcrumbLabel = "Best Wi-Fi 7 Routers with 6GHz Support";
