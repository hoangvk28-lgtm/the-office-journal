...
const raw = readFileSync(resolve(ROOT, "scripts", "unique_asins_271_360.txt"), "utf-8");
...
writeFileSync(resolve(ROOT, "scripts", "data-271-360.json"), JSON.stringify(allItems, null, 2), "utf8");
...
console.log("Saved to scripts/data-271-360.json and scripts/lookup-271-360.json");
