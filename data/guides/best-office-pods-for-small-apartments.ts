...
export const faq = [
  {
    "q": "Can my apartment floor support an office pod?",
    "a": "Check with your building or a structural professional before ordering, these structures are heavy and concentrate that weight in a small footprint, which can exceed typical residential floor-load assumptions, especially on upper floors."
  },
  {
    "q": "Do I need landlord approval to install an office pod?",
    "a": "Likely yes for a structure this size, check your lease and get approval in writing before ordering rather than after a large freight delivery."
  },
  {
    "q": "How does delivery work for an apartment building?",
    "a": "Coordinate with building management for elevator reservations, stairwell clearance, or freight-crew access well ahead of your delivery date, this differs meaningfully from a ground-floor house delivery."
  },
  {
    "q": "Will my neighbors hear noise even with a \"soundproof\" pod?",
    "a": "Possibly, vibration and impact noise can transmit through a shared floor regardless of acoustic panel marketing, consider placement relative to shared walls and floors."
  }
];

export const guideSlug = "best-office-pods-for-small-apartments";

export const guideTitle = "The Best Office Pods for Small Apartments: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    "title": "Floor loading centered as the primary feasibility question",
    "description": "Weighted floor-load verification above all other criteria for this guide specifically, given how much these structures weigh relative to standard apartment furniture."
  },
  {
    "title": "Doorway, elevator, and stairwell logistics flagged",
    "description": "Flagged that delivery to an apartment unit involves doorway, elevator, or stairwell clearance planning that a ground-floor or house delivery wouldn't require."
  },
  {
    "title": "Lease and landlord restrictions raised as a real consideration",
    "description": "Raised lease terms and landlord or property management approval as a genuine pre-purchase step, since a semi-permanent structure this size may violate standard lease language."
  },
  {
    "title": "Neighbor sound transmission noted as a courtesy consideration",
    "description": "Noted that even a soundproof-marketed pod concentrates vibration and impact noise on a shared apartment floor, worth considering for neighbor relations even though it's not a formal spec any listing addresses."
  }
];
...
export const metaDescription = "A practical comparison of 3 office pods for small apartments, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Office Pods for Small Apartments (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-small-office-pods",
    "title": "Best Small Office Pods (2026)"
  },
  {
    "href": "/guide/best-mini-portable-offices",
    "title": "Best Mini Portable Offices (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Office Pods for Small Apartments";
