...
export const guideTitle = "The Best 4-Port PoE Network Switches for a Better Desk Setup";
...
export const metaDescription = "We compared 5 4-port PoE network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 4-Port PoE Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F99HKVD3?tag=theofficejournal-20",
    ...
    "specs": [
      "4x PoE ports @65W total, 3 switch modes",
      "820ft extended transmission mode",
      "4KV lightning protection"
    ],
    "pros": [
      "3 switchable modes cover different deployment needs",
      "Honest disclosure about 24V passive PoE incompatibility",
      "4KV lightning protection included"
    ],
    "cons": [
      "Does not support 24V passive PoE devices without a splitter",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-3-port-network-switches",
    "title": "best-3-port-network-switches"
  }
];

export const breadcrumbLabel = "Best 4-Port PoE Network Switches";
