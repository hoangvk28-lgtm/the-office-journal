...
export const guideTitle = "The Best Studio Monitors for PC Desks: Our Picks";
...
export const metaDescription = "How 8 studio monitors for PC desks compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Studio Monitors for PC Desks (2026)";
...
export const breadcrumbLabel = "Best Studio Monitors for PC Desks";
