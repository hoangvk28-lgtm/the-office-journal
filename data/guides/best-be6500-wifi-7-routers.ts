...
export const faq = [
  {
    "q": "Does every BE6500 router have a 6GHz radio?",
    "a": "' Always verify the specific model's radio configuration before buying."
  },
  {
    "q": "If my BE6500 router has 6GHz, is it as fast as a flagship BE9300's 6GHz?",
    "a": "The 6GHz channel width at this mid-tier is often capped below the 320MHz available on flagship tiers, commonly limited to 160MHz, meaningfully reducing peak throughput."
  },
  {
    "q": "Is BE6500 a good value tier, or should I just get BE9300?",
    "a": "BE6500 is often a genuine value sweet spot, but BE9300 can offer disproportionately more real capability for a modest price increase, compare the specific price gap against your needs."
  },
  {
    "q": "Does MLO work well on a dual-band BE6500 router?",
    "a": "Its cross-band benefit is limited the same way as entry-tier BE3600 routers, since dual-band units lack the second high-speed band MLO is designed to aggregate with."
  }
];

export const guideSlug = "best-be6500-wifi-7-routers";

export const guideTitle = "The Best BE6500 Wi-Fi 7 Routers for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Genuine 6GHz radio presence verified per product",
    "description": "Checked whether each BE6500-labeled router actually includes a genuine 6GHz radio or represents another dual-band unit, since numbering alone doesn't confirm tri-band presence at this mid-tier."
  },
  {
    "title": "6GHz channel width cap disclosed where applicable",
    "description": "Noted that where a 6GHz radio is present, its channel width is likely capped below the 320MHz available on flagship tiers, meaningfully reducing peak 6GHz throughput versus BE9300+ products."
  },
  {
    "title": "Decoded '6500' number into realistic per-device speed",
    "description": "Decoded the '6500' number into its per-band theoretical split and translated that into realistic achievable single-device speed, consistent with the decoding approach used across this research."
  },
  {
    "title": "Value-tier comparison against BE9300 considered",
    "description": "Assessed whether BE6500 represents a genuine value sweet spot or whether stepping up to BE9300 offers disproportionately more real capability for a modest price increase."
  }
];
...
export const metaDescription = "We compared 5 BE6500 wi-fi 7 routers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best BE6500 Wi-Fi 7 Routers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "5G ports and a quad-core CPU at a low price for this device-count rating.\n\nLow price for a 90-device rating.",
    "specs": [
    ...
    "cons": [
      "No 6GHz radio despite the BE6500 designation",
      "MLO's cross-band benefit doesn't apply without a second high-speed band",
      "Not a tri-band option for buyers specifically wanting 6GHz"
    ],
  ...
  },
  {
    ...
    "description": "Also confirmed dual-band despite the BE6500 designation, this Broadcom-chipset router includes VPN client and server functionality useful for privacy-conscious buyers at this price.\n\nThe standout detail is that broadcom quad-core CPU for solid routing performance.",
    "specs": [
      "Dual-band only, no 6GHz radio",
      "VPN client and server support",
      "Broadcom 2GHz quad-core CPU",
      "Cudy Mesh compatible"
    ],
    "pros": [
      "VPN client and server functionality included",
      "Broadcom quad-core CPU for solid routing performance",
      "Cudy Mesh app compatibility for future expansion",
      "Competitive price"
    ],
    "cons": [
      "No 6GHz radio despite the BE6500 designation",
  ...
  },
  {
    ...
    "description": "TP-Link's own listing explicitly states 'No 6 GHz' for this gaming-focused variant, an honest disclosure worth crediting, with a dedicated gaming port and game acceleration features for a gaming-priority buyer.\n\nDedicated gaming port with game acceleration.",
    "specs": [
      "Dual-band only, explicitly 'No 6 GHz' per listing",
      "Dedicated gaming port and panel",
      "Game acceleration features",
      "RGB lighting"
    ],
    "pros": [
      "Explicit 'No 6 GHz' disclosure directly in the product listing",
      "Dedicated gaming port with game acceleration",
      "2×2.5G + 3×1G port configuration",
      "RGB lighting for gaming aesthetics"
    ],
    "cons": [
      "Highest price among dual-band BE6500 picks in this guide",
      "No 6GHz for buyers specifically wanting tri-band"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FX9C5QVJ?tag=theofficejournal-20",
    "description": "INet's router-focused brand, well known among more technical buyers for open firmware flexibility and VPN configuration options beyond typical consumer router interfaces.\n\nINet's more technical audience may find firmware documentation clarifying this more directly than mainstream brands.\n\nBoth are worth keeping in mind before deciding.",
    "specs": [
      "Dual-band, verify 6GHz radio presence per current listing",
      "VPN-focused firmware",
      "More technical/advanced configuration options"
    ],
    "pros": [
      "Open firmware flexibility appeals to technical buyers",
      "Strong VPN configuration options",
      "Genuine focus on home and gaming use cases"
    ],
    "cons": [
      "Higher price than mainstream consumer alternatives",
  ...
  },
  {
    ...
    "description": "5GbE ports is a genuine step up from the typical dual-port configuration at this tier, appropriate for a buyer with multiple wired multi-gig devices to connect.\n\nASUS lists MLO support here, but this remains dual-band, meaning MLO's structural cross-band benefit is limited the same way as other BE6500 picks in this guide, verify firmware documentation for actual MLO behavior on this specific model.",
    "specs": [
      "Dual-band only",
      "Four full 2.5GbE ports",
      "Game Accelerator feature",
      "ASUS TUF Gaming brand"
    ],
    "pros": [
      "Four 2.5GbE ports, more than typical for this tier",
      "ASUS TUF Gaming brand reliability",
      "Game Accelerator feature for gaming priority",
      "Mesh and VPN compatible"
    ],
    "cons": [
      "Highest price in this guide",
      "Dual-band limitation still applies despite premium pricing"
    ],
...
export const breadcrumbLabel = "Best BE6500 Wi-Fi 7 Routers";
