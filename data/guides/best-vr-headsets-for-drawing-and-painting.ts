...
export const introParagraphs = [
  "Across best vr headsets for drawing and painting, differ more than expected, given vr headsets for drawing and painting, marketing skips the rest.",
  "vr headsets for drawing and painting is judged here on real standalone-vs-PC fit, because standalone caps real graphics power."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-vr-headsets-for-drawing-and-painting-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-vr-headsets-for-drawing-and-painting-2",
    rank: 2,
  ...
  {
    id: "best-vr-headsets-for-drawing-and-painting-3",
    rank: 3,
  ...
  {
    id: "best-vr-headsets-for-drawing-and-painting-4",
    rank: 4,
  ...
  {
    id: "best-vr-headsets-for-drawing-and-painting-5",
    rank: 5,
    badge: "Runner-Up Pick",
    name: "COCERKET Smartphone VR Headset with Built‐in Headphones",
    price: "$49.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41lMTS6hA2L._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0H5PRPW1R?tag=theofficejournal-20",
    description: "COCERKET Smartphone VR Headset with Built‐in Headphones is a strong alternative worth comparing directly against the top pick. This vr headset is the latest version, offering significantly improved comfort and focus accuracy. Compared to vr goggles on the market, it is the best feature of having high quality headphones.\n\nTECKNET VR Headset for Phone with Bluetooth Controller covers similar ground, though vr glasses do not require a bluetooth controller is what tips the choice one way or the other.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
  ...
  {
    id: "best-vr-headsets-for-drawing-and-painting-6",
    rank: 6,
    badge: "Worth a Look",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Standalone (e.g. 3D VR Headset for Kids + Android Remote)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "You want straightforward everyday use without paying for headroom you won't need, where 3D VR Headset for Kids + Android Remote already covers the job at the lowest price here."
      }
    ]
  }
];
