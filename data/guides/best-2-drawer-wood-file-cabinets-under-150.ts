...
export const guideTitle = "The Best 2-Drawer Wood File Cabinets Under $150: Our Picks";
export const metaTitle = "Best 2-Drawer Wood File Cabinets Under $150 (2026)";
export const metaDescription =
  "How 8 2-drawer wood file cabinets under $150 compare on features, build and practical fit, with clear notes on who each one suits.";
...
export const products: FileCabinet[] = [
  {
    ...
    whyItWorks:
      "99, this is the default recommendation for most buyers. Clean white finish works in most home office styles. For a small desk setup, it fits neatly beside or under a desk without dominating the space. 0 stars holds across 3,200+ purchases means the quality is consistent and well-documented.",
    tradeoffs: [
  ...
  },
  {
    ...
    skipIf:
      "Skip if you do not need document security - the non-locking VASAGLE CUSTOS (Pick 1) is the better value. Skip if you want a rustic finish with a lock at the same budget - the VINGLI Rustic Gray (Pick 3) offers a lock.",
    pros: [
  ...
  },
  {
    ...
    whyItWorks:
      "The honey brown farmhouse version fills a gap that white and gray models leave open. Warm brown tone is rare in this price category and pairs naturally with medium-brown wood desks, reclaimed wood accents, and earthy decor. 0 stars confirms consistent quality at an accessible price. For buyers furnishing a farmhouse-style, boho, or eclectic home office, this is the only pick on the list that matches that aesthetic at under $150.",
    tradeoffs: [
...
export const metalAlternative: FileCabinet = {
  ...
  amazonUrl: "https://www.amazon.com/dp/B08B68KQX9?tag=theofficejournal-20",
  whyItWorks:
...
export const faq: { q: string; a: string }[] = [
  {
    ...
    a: "All picks in this guide are built from engineered wood (MDF or particleboard) with a laminate surface. Solid wood file cabinets cost considerably more than $150. We call this out clearly for each pick.",
  },
  {
    q: "Which 2-drawer wood file cabinet under $150 has the best reviews?",
    a: "For locking options, the VINGLI Rustic Gray had the highest combined rating and review count at the time of research. The DEVAISE Gray Oak has a higher star rating but fewer total reviews.",
  },
  {
    q: "Which 2-drawer file cabinet under $150 includes a lock?",
    a: "Three picks in this guide include locks: the VASAGLE CUSTOS Locking White, the VINGLI Rustic Gray, and the DEVAISE Gray Oak. The VINGLI offers the best value - a lock point with strong buyer ratings. The metal alternative, the DEVAISE Metal White, also includes a lock and has the highest overall rating on the page.",
  },
  {
