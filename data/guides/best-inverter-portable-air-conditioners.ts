...
export const guideTitle = "The Best Inverter Portable Air Conditioners for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 inverter portable air conditioners, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Inverter Portable Air Conditioners for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Inverter Portable Air Conditioners";
