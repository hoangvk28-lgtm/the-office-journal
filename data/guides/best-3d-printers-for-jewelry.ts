...
export const guideTitle = "The Best 3D Printers for Jewelry: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "5\" 2K LCD Curing Screen justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "How 6 3D printers for jewelry compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 3D Printers for Jewelry (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-carbon-fiber-3d-printers",
    "title": "Best Carbon-Fiber 3D Printers in 2026"
  },
  {
...
export const breadcrumbLabel = "Best 3D Printers for Jewelry";
