...
export const guideTitle = "The Best Smart Portable Air Conditioners for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 smart portable air conditioners, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Smart Portable Air Conditioners for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Smart Portable Air Conditioners";
