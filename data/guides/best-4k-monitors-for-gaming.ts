...
export const guideTitle = "The Best 4K Monitors for Gaming: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 6 4K monitors for gaming, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4K Monitors for Gaming (2026)";
...
export const breadcrumbLabel = "Best 4K Monitors for Gaming";
