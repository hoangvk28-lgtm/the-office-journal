...
export const introParagraphs = [
  "Best Ultrasonic Humidifiers aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
  "This roundup weighs honest mold risk and mineral buildup, given that marketing copy tends to obscure this."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-ultrasonic-humidifiers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-ultrasonic-humidifiers-2",
    rank: 2,
  ...
  {
    id: "best-ultrasonic-humidifiers-3",
    rank: 3,
  ...
  {
    id: "best-ultrasonic-humidifiers-4",
    rank: 4,
  ...
  {
    id: "best-ultrasonic-humidifiers-5",
    rank: 5,
  ...
  {
    id: "best-ultrasonic-humidifiers-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-ultrasonic-humidifiers-7",
    rank: 7,
  ...
  {
    id: "best-ultrasonic-humidifiers-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You want a larger tank, quieter operation, and extra features like a hygrometer display, where Levoit Classic300S Ultrasonic Smart Top Fill Humidifier justifies the extra cost."
      },
      {
        "label": "Save if",
