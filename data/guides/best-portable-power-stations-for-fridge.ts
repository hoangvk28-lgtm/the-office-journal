...
export const buyingCriteria = [
  {
    "criterion": "",
    "explanation": "Check portable power stations for fridge's documented startup surge and running draw against the actual refrigerator or a representative compressor load."
  },
  {
...
export const guideSlug = "best-portable-power-stations-for-fridge";

export const guideTitle = "The Best Portable Power Stations for Fridge: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Check portable power stations for fridge's documented startup surge and running draw against the actual refrigerator or a representative compressor load."
  },
  {
...
export const introParagraphs = [
  "Ranking portable power stations for fridge fairly means putting measuring compressor startup surge and duty cycle instead of trusting nameplate running watts ahead of anything the listing photos suggest.",
  "We leaned on measured usable energy and safety documentation plus measuring compressor startup surge and duty cycle instead of trusting nameplate running watts to separate capable stations from well-marketed ones."
];

export const lastUpdated = "2026-08-19";

export const mainKeyword = "portable power stations for fridge";

export const metaDescription = "How 8 portable power stations for fridge compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Portable Power Stations for Fridge (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-portable-power-stations-for-fridge-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-portable-power-stations-for-fridge-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-portable-power-stations-for-fridge-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-portable-power-stations-for-fridge-4",
    "rank": 4,
  ...
  {
    "id": "best-portable-power-stations-for-fridge-5",
    "rank": 5,
  ...
  {
    "id": "best-portable-power-stations-for-fridge-6",
    "rank": 6,
    "badge": "Solid Option",
  ...
  {
    "id": "best-portable-power-stations-for-fridge-7",
    "rank": 7,
    "badge": "Another Pick",
  ...
  {
    "id": "best-portable-power-stations-for-fridge-8",
    "rank": 8,
    "badge": "Budget Pick",
...
export const relatedGuides = [
  {
    "href": "/guide/best-portable-power-stations-for-refrigerator",
    "title": "Best Portable Power Stations for Refrigerator in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Portable Power Stations for Fridge";
