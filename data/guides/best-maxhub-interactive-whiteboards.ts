...
export const guideTitle = "Best MAXHUB Interactive Whiteboards";
export const metaTitle = "Best MAXHUB Interactive Whiteboards";
export const metaDescription = "We mapped MAXHUB's current XBoard V7 and Teams Rooms variants and paired thin Amazon inventory with genuinely current alternatives.";
export const mainKeyword = "maxhub interactive whiteboard";
export const introParagraphs = [
  "MAXHUB's current XBoard V7 series spans 55/65/75/86-inch sizes with dedicated Microsoft Teams Rooms variants, though direct current Amazon inventory is thin, so this comparison pairs MAXHUB-adjacent search intent with genuinely current alternatives.",
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "The P Series steps up NEWORK's line with a genuine 48MP CMOS sensor 4K camera with a 100-degree field of view, auto exposure, auto focus, and white balance for clear video even in backlit or low-light rooms.\n\nAn 8-microphone array picks up voice up to 12 meters away, filtering keyboard typing, paper shuffling, and ambient room noise for genuinely clear audio, and a front-facing USB-C port handles video, audio, touch, and 65W charging in one cable.",
    specs: ["65in 4K, 48MP CMOS camera, 100-degree FOV","8-mic array, 12m pickup range","Front USB-C: video/audio/touch/65W charging"],
    pros: ["48MP camera with genuine low-light/backlit performance tuning","12-meter mic pickup range filters common office noise sources","Single front USB-C cable handles video, audio, touch, and charging"],
    cons: ["Premium camera/audio hardware reflected in price versus base NewBoard models","64GB storage on the Android side, modest for heavy app use"],
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-interactive-whiteboards-for-teams","title":"6 Best Interactive Whiteboards for Teams"},{"href":"/guide/best-interactive-whiteboards-for-zoom","title":"7 Best Interactive Whiteboards for Zoom"},{"href":"/guide/best-interactive-whiteboards-for-business","title":"7 Best Interactive Whiteboards for Business"}];
