...
export const guideTitle = "The Best USB-C 4K Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Philips 27\" Computer Monitor 4K UHD IPS USB-C Charging HDR400)",
...
export const metaDescription = "A practical comparison of 6 USB-C 4K monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best USB-C 4K Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Samsung’s 32\" viewfinity s8 (s80uh) high-resolution monitor",
      "USB-C port",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-90w-usb-c-4k-monitors",
    "title": "Best 90W USB-C 4K Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best USB-C 4K Monitors";
