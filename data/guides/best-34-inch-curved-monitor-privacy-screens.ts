...
export const faq = [
  {
    "q": "Which curved 34 inch privacy screen has the most reviews?",
    "a": ""
  },
  {
    "q": "What's the cheapest curved 34 inch option?",
    "a": ""
  },
  {
    "q": "Will a flat 34 inch filter work on my curved monitor?",
    "a": "Confirm your monitor is curved 21:9 before ordering; a flat filter will not fit properly."
  },
  {
    "q": "Is there a value 2-pack option?",
    "a": "99, a lower price than the top-reviewed 2-pack."
  },
  {
    "q": "Do these bundle anti-glare or blue-light filtering?",
    "a": "Several do, including the Mamol and 2026 New picks, which also add anti-scratch or blue-light features alongside privacy."
  }
];

export const guideSlug = "best-34-inch-curved-monitor-privacy-screens";

export const guideTitle = "The Best 34-Inch Curved Monitor Privacy Screens for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "Required explicit 21:9 curved compatibility for eligibility",
    "description": "We only included filters that specifically confirm curved 34 inch, 21:9 compatibility, since a flat or standard-ratio filter will not fit this shape."
  },
  {
    "title": "Compared value across a real price range",
    "description": "Curved 34 inch filters span across a range of price points in our research, and we compared value across that full range."
  },
  {
    "title": "Flagged very small review counts appropriately",
    "description": ""
  },
  {
    "title": "Noted bundled anti-glare, blue-light, and anti-scratch features",
    "description": "We flagged which picks include these extras, since not every curved 34 inch filter bundles the same feature set."
  }
];
...
export const metaDescription = "How 5 34-inch curved monitor privacy screens compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 34-Inch Curved Monitor Privacy Screens for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Largest review base of any curved 34 inch filter in our research"
    ],
    "cons": [
  ...
  },
  {
    ...
    "pros": [
      "Lower price than the top pick for a matched 2-pack"
    ],
    "cons": [
      "Smaller review base than the top pick"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Similar bundled features to the Mamol pick at a comparable price"
    ],
    "cons": [
  ...
  },
  {
    ...
    "cons": [
      "Only 2 reviews on this specific listing, far too few for a confident rating"
    ],
...
export const breadcrumbLabel = "Best 34-Inch Curved Monitor Privacy Screens";
