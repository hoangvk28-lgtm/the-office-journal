...
export const guideTitle = "The Best 4K Laser Projectors for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "Best 4K Laser Projectors cover a broad performance range, so price alone misses what matters.",
...
export const metaDescription = "A practical comparison of 8 4K laser projectors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4K Laser Projectors for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-4k-laser-projectors-1",
    "rank": 1,
    "badge": "Best Overall",
...
export const breadcrumbLabel = "Best 4K Laser Projectors";
