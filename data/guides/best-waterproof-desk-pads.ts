...
export const introParagraphs = [
  "Best Waterproof Desk Pads cover a wide range of materials and sizes. That means marketing copy alone is risky.",
  "This roundup weighs true size versus your actual keyboard and mouse, given that this is the real gap to watch."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-waterproof-desk-pads-1",
    rank: 1,
    badge: "Best Overall",
    ...
    description: "Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse is the strongest all-around choice here. Made of durable PU leather material, which protects your desk from scratches, stains, spills, heat and scuffs. 23.6 X 13.7 inch size is large enough to accommodate your laptop, mouse and keyboard.\n\nHeld up against YSAGi Leather Office Desk Pad Protector, both cover the basics equally well, what actually separates them is we are dedicated to providing our customers with high quality products and superior service.\n\nReach for this pick if you want the strongest all-around pick in this comparison and would rather not keep shopping around. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
  ...
  {
    id: "best-waterproof-desk-pads-2",
    rank: 2,
  ...
  {
    id: "best-waterproof-desk-pads-3",
    rank: 3,
  ...
  {
    id: "best-waterproof-desk-pads-4",
    rank: 4,
    ...
    description: "Aothia Leather Office Desk Pad Protector is a strong alternative worth comparing directly against the top pick. X 15.7 inch size is large enough to accommodate your laptop, mouse and keyboard. We are dedicated to providing our customers with high quality products and superior service..\n\nAgainst Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A desk pad sized just for your keyboard still leaves your mouse hand working off the bare desk, so measure your keyboard and mouse side by side before picking a size.",
    specs: ["Protect your desk", "Multifunctional desk pad", "Special non-slip design"],
    pros: ["Protect your desk", "Multifunctional desk pad", "Special non-slip design", "Waterproof and easy to clean"],
    cons: ["A too-small size still leaves your mouse hand off the pad", "Cloth tops show wear faster than a wipeable leather or PU surface"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  ...
  {
    id: "best-waterproof-desk-pads-5",
    rank: 5,
  ...
  {
    id: "best-waterproof-desk-pads-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-waterproof-desk-pads-7",
    rank: 7,
    badge: "Best Value",
    name: "Non-Slip Desk Pad, Mouse Pad, Waterproof PU Leather Desk Protector, Ultra Thin",
    price: "$8.54",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41bcOkzyvzL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0CSDP89FR?tag=theofficejournal-20",
    description: "Non-Slip Desk Pad, Mouse Pad, Waterproof PU Leather Desk Protector, Ultra Thin is a budget-friendly pick that doesn't skip the essentials. Crafted with suede material for a non-slip back, this pad stays put. Measuring 23.6\" x 13\", it accommodates your laptop, mouse, and keyboard.\n\nAothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse covers similar ground, though waterproof, oil-proof, protect your glass/wooden desktop from scratches, stains, and spills is what tips the choice one way or the other.\n\nThis one is the right call if you want a genuinely capable pick without paying for headroom you won't use. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
    specs: ["Anti-slip back side", "Multifunctional desk pad", "Waterproof and easy to clean"],
    pros: ["Anti-slip back side", "Multifunctional desk pad", "Waterproof and easy to clean", "Protect your desk"],
    cons: ["Cloth tops show wear faster than a wipeable leather or PU surface", "A too-small size still leaves your mouse hand off the pad"],
    bestFor: "buyers who want a genuinely capable pick without paying for headroom you won't use",
  },
  {
    id: "best-waterproof-desk-pads-8",
    rank: 8,
    ...
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41XfPupbdRL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B08LG8GW47?tag=theofficejournal-20",
    description: "Oterri Clear Writing Desk Pad is the priciest pick in this lineup. Our desk pad is made of PVC material, protects your desk from scratches, scuffs, stains. Easy to clean, you can use a dishcloth to wipe stains or clean the plastic desk pad with water.\n\nThe gap between this and Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse isn't in the essentials, it shows up in the round edge design also protect your hands from scratches.\n\nThis makes sense for anyone who are willing to spend the most in this comparison for the fuller feature set that comes with it. A desk pad sized just for your keyboard still leaves your mouse hand working off the bare desk, so measure your keyboard and mouse side by side before picking a size.",
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        [
          ...
          "Non-Slip Desk Pad, Mouse Pad, Waterproof PU Leather Desk Protector, Ultra Thin"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Cloth (e.g. Non-Slip Desk Pad, Mouse Pad, Waterproof PU Leather Desk Protector, Ultra Thin)",
        "text": "Softer feel, absorbs spills, shows staining faster."
      },
      {
        "label": "Leather/PU (e.g. Oterri Clear Writing Desk Pad)",
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse is worth checking against its specific edge construction before assuming any desk pad holds up the same."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You want a wipeable, longer-lasting surface with a more polished look, where Oterri Clear Writing Desk Pad justifies the extra cost."
      },
      {
        "label": "Save if",
        "text": "You want straightforward daily protection and comfort, where Non-Slip Desk Pad, Mouse Pad, Waterproof PU Leather Desk Protector, Ultra Thin already covers the job at the lowest price here."
      }
    ]
  }
];
