...
export const guideTitle = "The Best VR Headsets for Xbox: Our Picks";
...
export const metaDescription = "How 6 VR headsets for xbox compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best VR Headsets for Xbox (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-7k-vr-headsets",
    "title": "Best 7K VR Headsets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best VR Headsets for Xbox";
