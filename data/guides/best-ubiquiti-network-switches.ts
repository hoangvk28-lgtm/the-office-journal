...
export const guideTitle = "The Best Ubiquiti Network Switches for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 ubiquiti network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Ubiquiti Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B085TLT6Z4?tag=theofficejournal-20",
    "description": "3af PoE ports and 8Gbps of non-blocking switching capacity, managed entirely through the UniFi application alongside your other UniFi gear.\n\nIt includes a 60W AC/DC power adapter and integrates cleanly with UniFi access points for a unified network dashboard, making it a natural starting point for a first UniFi deployment.",
    "specs": [
      "8 ports, 4x PoE (802.3af)",
      "8Gbps non-blocking switching",
      "UniFi app managed"
    ],
    "pros": [
      "Unified management with other UniFi hardware",
      "Non-blocking switch fabric at this port count",
      "Included 60W power adapter"
    ],
    "cons": [
      "PoE limited to older 802.3af standard, not PoE+",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CPT3K48S?tag=theofficejournal-20",
    "description": "Like the rest of the UniFi Flex series it's designed for flexible mounting and integrates into the UniFi controller ecosystem for unified network management alongside APs and other switches.",
    "specs": [
      "5x 2.5GbE ports",
      "Compact Flex form factor",
      "UniFi controller managed"
    ],
    "pros": [
      "True 2.5GbE across all 5 ports",
      "Compact enough for flexible mounting",
      "Fits into existing UniFi deployments"
    ],
    "cons": [
      "Small port count limits standalone use",
      "Best value only inside a UniFi ecosystem"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08PMDVS6F?tag=theofficejournal-20",
    "description": "3at PoE+ sensing for up to 45W total PoE power, wall-mountable with an included mounting kit for out-of-the-way installs.\n\nConfiguration and monitoring happen through the UniFi network controller and mobile app, giving a graphical view of every switch feature rather than a command-line-only interface.",
    "specs": [
      "16 ports, 8x PoE+ @45W total",
      "Wall-mount kit included",
      "UniFi controller/app managed"
    ],
    "pros": [
      "Wall-mount kit included out of the box",
      "Graphical UniFi app management, no CLI required",
      "Layer 2 managed features at a mid-tier price"
    ],
    "cons": [
      "45W PoE budget modest for 8 PoE ports",
      "Requires UniFi controller for configuration"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B082NRZFSD?tag=theofficejournal-20",
    ...
    "specs": [
      "24-port Layer 3 managed",
      "UniFi controller integration",
      "PoE-capable"
    ],
    "pros": [
      "True Layer 3 routing, not just VLAN tagging",
      "Deep UniFi ecosystem integration",
      "Strong PoE budget for camera/AP fleets"
    ],
    "cons": [
      "Requires UniFi controller for full feature set",
      "Steeper learning curve than smart-managed switches"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08222RLCG?tag=theofficejournal-20",
    ...
    "specs": [
      "48-port Layer 3 managed, PoE",
      "UniFi controller integration",
      "Rack-mount, ~17lb"
    ],
    "pros": [
      "Enterprise port density in one unit",
      "Full Layer 3 routing support",
      "Unified management alongside other UniFi gear"
    ],
    "cons": [
      "Significant weight and rack space commitment",
      "Best value only within an existing UniFi setup"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F926J46M?tag=theofficejournal-20",
    "description": "5GbE PoE++ ports at 64W and 12 x GbE PoE+ ports at 32W, backed by 2 x 10G SFP+ uplinks and 84Gbps of switching capacity for serious homelab or small-business fiber backbones.\n\n3-inch touchscreen shows real-time port and VLAN status without opening a laptop, and DHCP, inter-VLAN routing, and static routing round out genuine Layer 3 capability rather than just VLAN tagging.",
    "specs": [
      "16 ports, 2.5GbE PoE++ + GbE PoE+ mix",
      "2x 10G SFP+ uplinks",
      "Built-in touchscreen display"
    ],
    "pros": [
      "Multi-gig PoE++ ports are rare at this tier",
      "Touchscreen adds real-time diagnostics without a laptop",
      "Full Layer 2/3 routing feature set"
    ],
    "cons": [
      "Premium price for the port count",
      "180W PoE budget still finite for a mixed high-draw fleet"
    ],
    "bestFor": "5gbe poe++ + gbe poe+ mix"
  }
];
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-layer-3-network-switches",
    "title": "3 Best Layer 3 Network Switches in 2026"
  },
  {
    "href": "/guide/best-managed-network-switches",
    "title": "8 Best Managed Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best Ubiquiti Network Switches";
