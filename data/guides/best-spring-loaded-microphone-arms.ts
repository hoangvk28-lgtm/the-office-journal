...
export const introParagraphs = [
  "Best Spring-Loaded Microphone Arms aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
...
export const products: GuideProduct[] = [
  {
    id: "best-spring-loaded-microphone-arms-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-spring-loaded-microphone-arms-2",
    rank: 2,
    ...
    description: "RØDE PSA1+ Professional Studio Boom Arm with Spring Damping is a strong alternative worth comparing directly against the top pick. Clamps to desks up to 70mm thick and holds microphones from 0.25kg to 1.2kg including shock mounts. Internal spring damping moves the arm mid-recording without creaks or handling noise.\n\nInnoGear Boom Arm Microphone Mic Stand for Blue Yeti Fifine HyperX covers similar ground, though degree rotation with full extension, integrated cable management keeps XLR runs hidden is what tips the choice one way or the other.\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A cheaper internal spring can sag under a heavier microphone over time, so check that the arm's rated weight limit exceeds your mic's actual weight by a real margin, not just barely clears it.",
    specs: ["Fits your desk and mic", "Silent on air", "Full reach, clean look"],
    pros: ["Fits your desk and mic", "Silent on air", "Full reach, clean look", "Broadcast standard"],
  ...
  {
    id: "best-spring-loaded-microphone-arms-3",
    rank: 3,
    badge: "Solid Alternative",
    name: "FIFINE CS1 Scissor Microphone Boom Arm Stand for Gaming Recording",
    price: "$19.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41mTwWPCQmL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B09BQQTLC8?tag=theofficejournal-20",
    description: "FIFINE CS1 Scissor Microphone Boom Arm Stand for Gaming Recording is a strong alternative worth comparing directly against the top pick. Of mic stand- in comparison to other versions, this metal desk clamp is built with anti-scratch pad and wider mouth up to 2\" to fit most desktop. Angle adjustment-the suspension boom arm stand provides 180° up and down rotation adjustment.\n\nWeighing this against InnoGear Boom Arm Microphone Mic Stand for Blue Yeti Fifine HyperX, material-made of sturdy metal, the mic arm stand is attached with strong and elastic springs to upgrade the stability and durability of the suspension arm stand ends up being the detail that matters most for most buyers.\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Most clamps handle roughly 15 to 60mm of desk thickness, so measure your desk's edge before assuming any arm's included clamp will actually fit.",
    specs: ["Of mic stand- in comparison to other versions, this", "Angle adjustment-the suspension boom arm stand provides 180°", "Material-made of sturdy metal, the mic arm stand"],
    pros: ["Of mic stand- in comparison to other versions, this", "Angle adjustment-the suspension boom arm stand provides 180°", "Material-made of sturdy metal, the mic arm stand", "Portable-the arm stand can be folded to save"],
    cons: ["Requires a desk edge thin enough for the included clamp", "Cheaper springs can sag over time with heavier microphones"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-spring-loaded-microphone-arms-4",
    rank: 4,
  ...
  {
    id: "best-spring-loaded-microphone-arms-5",
    rank: 5,
  ...
  {
    id: "best-spring-loaded-microphone-arms-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-spring-loaded-microphone-arms-7",
    rank: 7,
    badge: "Best Value",
    ...
    description: "InnoGear Microphone Stand Mic Boom Arm for Blue Yeti HyperX QuadCast S SoloCast is the best-value option in this roundup, priced lowest without a real capability gap. The extra strong spring of the boom arm prevents the microphone from accidental dropping, noise generation and shaking. The first screen blocks air blasts as any pop filter normally would.\n\nSet next to InnoGear Boom Arm Microphone Mic Stand for Blue Yeti Fifine HyperX, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nGo with this pick if you want a genuinely capable pick without paying for headroom you won't use. Most clamps handle roughly 15 to 60mm of desk thickness, so measure your desk's edge before assuming any arm's included clamp will actually fit.",
  ...
  {
    id: "best-spring-loaded-microphone-arms-8",
    rank: 8,
    ...
    description: "Elgato Wave Mic Arm Pro is the top-tier pick in this comparison. Supports up to 3 kg/6.6 lbs, including accessories. Smooth, silent adjustments without loosening screws.\n\nInnoGear Boom Arm Microphone Mic Stand for Blue Yeti Fifine HyperX lands in a similar spot overall, but the deciding factor between the two is strong magnetic covers keep cables out of sight.\n\nReach for this pick if you are willing to spend the most in this comparison for the fuller feature set that comes with it. A cheaper internal spring can sag under a heavier microphone over time, so check that the arm's rated weight limit exceeds your mic's actual weight by a real margin, not just barely clears it.",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Lightweight USB mic",
          "InnoGear Microphone Stand Mic Boom Arm for Blue Yeti HyperX QuadCast S SoloCast"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Clamp mount (e.g. InnoGear Microphone Stand Mic Boom Arm for Blue Yeti HyperX QuadCast S SoloCast)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "Your setup stays off-camera and you have a lightweight mic, where InnoGear Microphone Stand Mic Boom Arm for Blue Yeti HyperX QuadCast S SoloCast already covers the job at the lowest price here."
      }
    ]
  }
];
