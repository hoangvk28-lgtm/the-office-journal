...
export const guideTitle = "The Best Jumbo Tape Dispensers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Officemate 2-in-1 Heavy Duty Tape Dispenser)",
...
export const metaDescription = "How 6 jumbo tape dispensers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Jumbo Tape Dispensers for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-freezer-tape-dispensers",
    "title": "Best Freezer Tape Dispensers in 2026"
  }
];

export const breadcrumbLabel = "Best Jumbo Tape Dispensers";
