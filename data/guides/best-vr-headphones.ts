...
export const products: GuideProduct[] = [
  {
    ...
    description: "SARLAR VR Gaming Headphones for Quest 2/Quest 3 Increase VR Immersion is our overall pick in this lineup. 3.5Mm custom-length cable designed for the oculus quest 2 and quest 3 gaming headset, provides minimal latency for optimal realism for optimal realism. 45Mm large-aperture drivers provide you with great audio quality no matter what the occasion.\n\nRIG Plantronics 4VR covers similar ground, though lightweight fuselage with superior protein ear pads and headband, lets you enduring vr enjoyment is what tips the choice one way or the other.\n\nChoose this if you want the strongest all-around pick in this comparison and would rather not keep shopping around. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    specs: ["3.5Mm custom-length cable designed for the oculus quest 2 and quest 3 gaming", "45Mm large-aperture drivers provide you with great audio quality no matter what the occasion", "Enlarge protein ear pads for complete noise isolation"],
    pros: ["3.5Mm custom-length cable designed for the oculus quest 2 and quest 3 gaming", "45Mm large-aperture drivers provide you with great audio quality no matter what the occasion", "Enlarge protein ear pads for complete noise isolation", "Lightweight fuselage with superior protein ear pads and headband"],
  ...
  },
  {
    ...
    specs: ["Detachable audio speakers", "Transparent shell reveals the internal motherboard with built-in RGB lighting", "Built-in 10000mAh battery helps extend playtime by approximately 2-4 hours"],
    pros: ["Detachable audio speakers", "Transparent shell reveals the internal motherboard with built-in RGB lighting", "Built-in 10000mAh battery helps extend playtime by approximately 2-4 hours", "Carbon fiber texture finish"],
    cons: ["Marketed specs and real-world specs often differ", "Check compatibility with your exact setup before buying"],
  ...
  },
  {
    ...
    specs: ["More comfortable", "More convenient", "Looks tidy"],
    pros: ["More comfortable", "More convenient", "Looks tidy", "Sound quality"],
    cons: ["Check compatibility with your exact setup before buying", "Marketed specs and real-world specs often differ"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    specs: ["Enhanced vr experience", "Earphones are marked with \"l\" and \"r\"", "Humanized design"],
    pros: ["Enhanced vr experience", "Earphones are marked with \"l\" and \"r\"", "Humanized design", "Material & characteristics"],
    cons: ["Marketed specs and real-world specs often differ", "Check compatibility with your exact setup before buying"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
