...
export const buyingCriteria = [
  ...
  {
    "criterion": "An 8-Level Lumbar Micro-Adjust System Offers Finer Control Than a Continuous Two-Direction Range Alone",
    "explanation": "More discrete levels can make it easier to find and remember your exact preferred setting, especially if multiple people share the same chair and need to reset it to their own preference repeatedly. Consider whether stepped, memorable adjustment levels matter more to your use case than a continuous but less clearly marked range."
  },
  {
    "criterion": "A Multi-Year Warranty With Complimentary Part Replacements Is a Different Commitment Than a Standard Return Window",
...
export const faq = [
  {
    "q": "1 certification meaningfully better than SGS certification for an office chair?",
    "a": "1 covers the complete structural assembly's durability under repeated stress, while SGS typically verifies specific components or safety aspects, so BIFMA offers more comprehensive structural assurance, though SGS is still a legitimate third-party credential."
  },
  {
    "q": "What's the most common mistake buyers make when comparing weight capacity across office chairs?",
    "a": "Choosing a chair rated barely above their actual body weight rather than one with meaningful headroom, since operating near a chair's rated maximum accelerates wear on the gas lift and frame compared to staying comfortably within the rated range."
  },
  {
    "q": "Is the CAPOT chair worth the price premium over the Marsail or HUANUO picks?",
    "a": "If you want the highest weight capacity, the most granular 8-level lumbar adjustment, and a documented 5-year warranty with part replacements, yes, but if precise 3D armrest adjustment at a much lower price is your priority, the Marsail or HUANUO deliver comparable ergonomic fundamentals for significantly less."
  },
  {
    "q": "How important is a multi-year warranty for an office chair in this price range?",
    "a": "Given that gas lifts, casters, and mesh materials all wear gradually over years of daily use, a documented multi-year warranty like the CAPOT's 5-year coverage provides real protection beyond the standard 30 to 90-day return window most competitors offer."
  },
  {
    "q": "Does the FelixKing chair's lack of a stated weight capacity mean it's less durable?",
    "a": "Not necessarily, since it does specify other durability features like an explosion-proof base plate and a three-stage air rod, but the absence of a specific weight capacity figure does make it harder to directly compare its load-bearing performance against the other picks in this comparison."
  },
  {
    "q": "Can I get similar lumbar precision to the CAPOT's 8-level system from a cheaper chair?",
    "a": "16 inch adjustment range that provides comparable functional precision, even without the CAPOT's specifically stepped 8-level system, at a significantly lower price."
  }
];

export const guideSlug = "best-office-chairs-under-200";

export const guideTitle = "The Best Office Chairs Under $200, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Maximum weight capacity and BIFMA certification",
          "CAPOT Ergonomic Mesh Office Chair, 400lbs"
        ],
        [
          "Precise 3D armrests and lumbar adjustment",
          "Marsail Ergonomic Office Chair with 3D Armrests"
        ],
        [
          "The lowest price with SGS certification",
          "HUANUO Ergonomic Office Chair with 3D Armrests"
        ],
        [
          "Comprehensive 5-point support with FSC sourcing",
  ...
  {
    "subheading": "1 Structural Certification vs SGS Component Certification",
    "cards": [
      {
        "label": "",
        "text": "A comprehensive structural durability standard covering the whole chair's frame and mechanism, the most thorough certification in this comparison."
      },
      {
        "label": "",
        "text": "A component-level third-party safety and quality certification, still a genuine credential but narrower in scope than full structural BIFMA testing."
      }
    ],
    "note": "1 certification offers the most comprehensive documented assurance in this comparison."
  },
  {
    "subheading": "",
    "table": {
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A specific stated warranty length and whether it includes complimentary part replacements, not just a general satisfaction guarantee."
      },
      {
        "label": "",
        "text": "The CAPOT pick's 5-year warranty with complimentary part replacements is the most extensive documented coverage here."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want the highest weight capacity, most granular lumbar adjustment, and longest warranty, where the CAPOT's BIFMA certification and 5-year coverage justify its higher price."
      },
      {
        "label": "",
        "text": "You want precise 3D armrests and documented SGS certification without the full BIFMA structural testing, where the HUANUO pick delivers that for roughly $90 less."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "1 structural certification versus a component-level SGS certification."
  },
  {
    "title": "",
    "description": "Compared stated maximum supported weight, ranging from 300 to 400 lbs across the lineup."
  },
  {
    "title": "",
    "description": "Compared stated warranty duration and part-replacement policies where documented."
  },
  {
    "title": "",
    "description": "Compared specific stated lumbar adjustment ranges and number of discrete adjustment levels."
  },
  {
    "title": "Armrest and Support Point Design",
    "description": "Compared 3D armrest movement and named body support points across the lineup."
  }
];
...
export const metaDescription = "We compared 4 office chairs under $200 on seat height, adjustment, support and warranty to help you choose the right one for your space.";

export const metaTitle = "Best Office Chairs Under $200 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Highest weight capacity in this comparison at 400 lbs",
      "8-level lumbar micro-adjust offers unusually precise tuning",
      "5-year warranty with complimentary part replacements"
    ],
    "cons": [
      "Priciest pick in this comparison",
      "Larger enlarged cushion may feel bulky for smaller users"
    ],
  ...
  },
  {
    ...
    "description": "16 inches up and down to match individual spine shapes. Its 2D headrest and fully 3D adjustable armrests support multiple distinct work postures throughout the day.\n\n14 inch thick high-density foam seat and 330 lb weight capacity provide solid durability for the price, and independently moving armrests that swivel left or right add precision the flip-up-only designs at lower tiers don't offer.\n\nBest for buyers who want precisely adjustable 3D armrests and lumbar support at a meaningfully lower price than the top pick.",
    "specs": [
    ...
    "pros": [
      ...
      "Significantly lower price than the BIFMA-certified top pick",
      "Lumbar support adjusts in two directions with specific measurements"
    ],
    "cons": [
      "No formal BIFMA structural certification like the CAPOT pick",
      "Lower weight capacity than the CAPOT's 400 lbs"
    ],
  ...
  },
  {
    ...
    "description": "Its 300 lb weight capacity comfortably covers most users.\n\n96 inches and swivel 15 degrees, and the breathable mesh backrest keeps airflow moving during extended sitting sessions, matching the ergonomic fundamentals of the pricier picks in this comparison.\n\nBest for buyers who want documented SGS certification and precise 3D adjustment at the lowest price in this comparison.",
    "specs": [
    ...
    "cons": [
      ...
      "No BIFMA structural certification like the CAPOT top pick"
    ],
  ...
  },
  {
    ...
    "pros": [
      "5-point support system covers more zones than armrest-focused competitors",
      "Explosion-proof base plate adds a real safety margin",
      "FSC-certified wood frame, an uncommon environmental disclosure"
    ],
    "cons": [
      "No stated weight capacity figure in the listing",
      "Less granular lumbar adjustment than the CAPOT's 8-level system"
    ],
...
export const breadcrumbLabel = "Best Office Chairs Under $200";
