...
export const guideTitle = "The Best 5,000 BTU Portable Air Conditioners for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Frigidaire 5,000 BTU Window-Mounted Air Conditioner)",
...
export const metaDescription = "We compared 8 5,000 BTU portable air conditioners on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 5,000 BTU Portable Air Conditioners for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Shiny series portable ac offers 9,700 BTU ASHRAE (5000",
      "Free gree+ app, allows for easy and convenient control",
      "Additional dehumidifier and fan functions, this ac unit helps"
    ],
    "pros": [
      "Shiny series portable ac offers 9,700 BTU ASHRAE (5000",
      "Free gree+ app, allows for easy and convenient control",
  ...
  },
  {
    ...
    "specs": [
      "3 modes (cooling, fan, dehumidifier) for versatile comfort",
      "Drain-free design -- no need to manually remove water",
    ...
    "pros": [
      ...
      "Drain-free design -- no need to manually remove water",
      "Compact size is ideal for smaller spaces",
      "Remote control for easy, convenient operation - easily adjust"
    ],
    "cons": [
      "Single-hose models lose efficiency from negative room pressure",
      "SACC cooling is usually lower than the headline BTU number"
...
export const breadcrumbLabel = "Best 5,000 BTU Portable Air Conditioners";
