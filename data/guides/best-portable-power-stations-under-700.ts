...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "8kW capability becomes a strong floor. Do not expand the list with products that fail the core category definition just to reach a target number of picks. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
...
export const guideTitle = "The Best Portable Power Stations Under $700: Our Picks";
...
export const metaDescription = "How 8 portable power stations under $700 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Portable Power Stations Under $700 (2026)";
...
export const breadcrumbLabel = "Best Portable Power Stations Under $700";
