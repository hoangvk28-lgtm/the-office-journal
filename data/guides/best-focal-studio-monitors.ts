...
export const guideTitle = "The Best Focal Studio Monitors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Focal Alpha 50 Evo, 5\" Active 2-Way Studio Monitor)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5-Channel Studio Monitor already covers the job."
      }
    ]
  }
];
...
export const metaDescription = "We compared 8 focal studio monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Focal Studio Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "pros": [
      ...
      "Wide dispersion enabling the same sound",
      "Slatefiber cone manufactured in france",
      "Identical tonal balance at both low"
    ],
    "cons": [
      "Stands or isolation pads are usually a separate purchase",
      "Room acoustics affect the sound more than the speaker"
  ...
  },
  {
    ...
    "specs": [
      "High-output precision, 8\" slatefiber woofer and 1\"",
      "Flexible connectivity, TRS, XLR, and RCA inputs",
      "Custom room tuning, adjustable LF and HF"
    ],
    "pros": [
      "High-output precision, 8\" slatefiber woofer and 1\"",
      "Flexible connectivity, TRS, XLR, and RCA inputs",
      "Custom room tuning, adjustable LF and HF",
      "Powerful bi-amp design, 80w LF and 35w"
    ],
    "cons": [
      "Room acoustics affect the sound more than the speaker",
      "Stands or isolation pads are usually a separate purchase"
  ...
  },
  {
    ...
    "description": "5\" Active 2-Way Studio Monitor is a strong alternative worth comparing directly against the top pick. 5\" slatefiber woofer and 1\" aluminum tweeter deliver consistent tonal balance at any volume. Flexible input options, TRS, XLR, and RCA inputs allow connection of up to three audio sources.\n\nHeld up against Focal Alpha 50 Evo, 5\" Active 2-Way Studio Monitor, both cover the basics equally well, what actually separates them is room-tuned performance, adjustable LF/HF shelving and sensitivity controls for optimal sound in any studio space.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Room acoustics and speaker placement affect the sound as much as the monitor itself, so treat the room before blaming the gear.",
    "specs": [
      "Accurate, neutral sound, 6.5\" slatefiber woofer",
      "Flexible input options, TRS, XLR, and RCA",
      "Room-tuned performance, adjustable LF/HF shelving and sensitivity"
    ],
    "pros": [
      "Accurate, neutral sound, 6.5\" slatefiber woofer",
      "Flexible input options, TRS, XLR, and RCA",
      "Room-tuned performance, adjustable LF/HF shelving and sensitivity",
      "Dynamic, low-distortion output, 55w LF and 30w"
    ],
    "cons": [
      "Room acoustics affect the sound more than the speaker",
      "Stands or isolation pads are usually a separate purchase"
  ...
  },
  {
    ...
    "specs": [
      "Low directivity tweeter for a flexible listening",
      "Designed without a port allowing",
      "Numerous settings for optimal integration & accurate"
    ],
    "pros": [
      "Low directivity tweeter for a flexible listening",
      "Designed without a port allowing",
  ...
  },
  {
    ...
    "specs": [
      "Precise low-end control, dual 8\" slatefiber woofers",
      "Powerful output, 200w rms class d amplification",
      "Versatile integration, lfe, left/right inputs, and outputs"
    ],
    "pros": [
      "Precise low-end control, dual 8\" slatefiber woofers",
      "Powerful output, 200w rms class d amplification",
      "Versatile integration, lfe, left/right inputs, and outputs",
      "Customizable response, adjustable low-pass, high-pass, phase"
    ],
    "cons": [
      "Room acoustics affect the sound more than the speaker",
      "Stands or isolation pads are usually a separate purchase"
  ...
  },
  {
    ...
    "specs": [
      "450w 3-way studio reference monitor with 10\"",
      "1\" tweeter (each)"
    ],
    "pros": [
      "450w 3-way studio reference monitor with 10\"",
...
export const breadcrumbLabel = "Best Focal Studio Monitors";
