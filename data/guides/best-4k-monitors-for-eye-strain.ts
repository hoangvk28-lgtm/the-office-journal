...
export const guideTitle = "The Best 4K Monitors for Eye Strain: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Philips 27\" Computer Monitor 4K UHD IPS HDR Built-in Speakers)",
...
export const metaDescription = "A practical comparison of 6 4K monitors for eye strain, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4K Monitors for Eye Strain (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-144hz-4k-monitors",
    "title": "Best 144Hz 4K Monitors in 2026"
  }
];

export const breadcrumbLabel = "Best 4K Monitors for Eye Strain";
