...
export const guideTitle = "The Best White Floating Shelves for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "7\" Floating Shelves for Wall Decor & Storage"
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Sorbus Floating Shelves for Wall Storage (48 Inch, 2 Pack, White))",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5in already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "We compared 8 white floating shelves on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best White Floating Shelves for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "7\" Floating Shelves for Wall Decor & Storage is the strongest all-around choice here. Our white floating shelves for wall are made of mdf laminate. 2\"h and offers more space to store more items.\n\n5in, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nThis makes sense for anyone who want the strongest all-around pick in this comparison and would rather not keep shopping around. A standard drywall anchor alone safely holds only 10 to 25 lbs, so anything heavier needs to land on a wall stud or a toggle bolt rated for more weight.",
    "specs": [
  ...
  },
  {
    ...
    "pros": [
      ...
      "Spacious & functional size",
      "Strong load capacity",
      "Easy to install hanging shelves"
    ],
    "cons": [
      "Real weight capacity depends on stud spacing, not the shelf itself",
      "Drywall anchors alone only safely hold up to 20 to 25 lbs"
  ...
  },
  {
    ...
    "description": "7in is a strong alternative worth comparing directly against the top pick. Modern & minimalist style - featuring clean lines and a crisp white finish, these small floating shelves bring modern scandinavian and minimalist charm to any space. 1\"h, these mini wall shelves are ideal for smaller walls, small bathroom wall shelf setups, and tight spaces where you want organization without bulk.\n\n7\" Floating Shelves for Wall Decor & Storage, material and color notice - not solid wood ends up being the detail that matters most for most buyers.\n\nThis makes sense for anyone who want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    "specs": [
      "Modern & minimalist style - featuring clean lines and a crisp white finish",
      "Space-saving & functional size - at 6.7\"d x 15.7\"w x 1.1\"h",
  ...
  },
  {
    ...
    "specs": [
      "Invisible brackets",
      "White floating shelves are an ideal choice for utilizing vertical space",
      "Sturdy & durable"
    ],
    "pros": [
      "Invisible brackets",
...
export const breadcrumbLabel = "Best White Floating Shelves";
