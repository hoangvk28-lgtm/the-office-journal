...
export const guideTitle = "The Best Nylon Cable Sleeves for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Sdidzad Heat Shield Hose Sleeve)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5 Inch Id is worth checking against its specific spec sheet before assuming any pick here covers your exact need."
      }
    ]
  },
  {
...
export const metaDescription = "How 6 nylon cable sleeves compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Nylon Cable Sleeves for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Nylon Cable Sleeves";
