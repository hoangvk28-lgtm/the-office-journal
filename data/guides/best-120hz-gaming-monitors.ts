...
export const guideTitle = "The Best 120Hz Gaming Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "5 Inch Gaming Curved Monitor 3000R 120Hz PC Screen Full HD 1080P"
        ]
      ]
    }
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "8in FHD 1920x1080 IPS 120Hz Office Monitor KB242Y G0BI"
        ],
        [
          "",
          "5 Inch Gaming Curved Monitor 3000R 120Hz PC Screen Full HD 1080P"
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "SANSUI 24 Inch Curved 160Hz Gaming Monitor, 1500R Curved Gaming Monitor)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "5 Inch Gaming Curved Monitor 3000R 120Hz PC Screen Full HD 1080P justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 6 120Hz gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 120Hz Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "8in FHD 1920x1080 IPS 120Hz Office Monitor KB242Y G0BI is a strong alternative worth comparing directly against the top pick. 8\" monitor with 1920 x 1080 full HD resolution in a 16:9 aspect ratio presents stunning, high-quality images with excellent detail. Get fast refresh rates thanks to the adaptive-sync support (freesync compatible) product that matches the refresh rate of your monitor with your graphics card.\n\n: fast response time of 1ms enhances the experience.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    "specs": [
      "images",
  ...
  },
  {
    ...
    "description": "5 Inch Gaming Curved Monitor 3000R 120Hz PC Screen Full HD 1080P is a strong alternative worth comparing directly against the top pick. 5-inch curved (3000r) va panel with full HD 1920x1080 resolution. 5 Inch curved computer monitor equipped with HDMI ports and vga port, easy access to your favorite devices with 1 cable solution, compatible with most laptop and PC.\n\nAgainst ArcticPro 27 Inch Monitor 120Hz, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
    "specs": [
      "Experience lifelike visuals on a 24.5-inch curved (3000r) va panel with full HD 1920x1080 resolution",
      "120 Hz PC monitor - game confrontation depends on the reaction speed of each operation",
      "24.5 Inch curved computer monitor equipped with HDMI ports and vga port"
    ],
    "pros": [
      "Experience lifelike visuals on a 24.5-inch curved (3000r) va panel with full HD 1920x1080 resolution",
      "120 Hz PC monitor - game confrontation depends on the reaction speed of each operation",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-1440p-120hz-gaming-monitors",
    "title": "Best 1440p 120Hz Gaming Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best 120Hz Gaming Monitors";
