...
export const guideTitle = "8 Best Network Switches Under $300 in 2026";
export const metaTitle = "Best Network Switches Under $300 in 2026";
export const metaDescription = "We compared best network switches under $300 by verified current price and real capability, not just the price ceiling alone.";
...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "Define the strong SMB access capability floor: The tier should buy better PoE, more ports, 2.5GbE access or 10G uplinks. Reject products that meet the price ceiling but fail the core use-case minimum. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
