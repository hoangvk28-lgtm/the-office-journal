...
export const guideTitle = "The Best SteamVR Headsets for Everyday Desk Work";
...
export const metaDescription = "How 6 SteamVR headsets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best SteamVR Headsets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Controllers and base station purchased seperately",
...
export const breadcrumbLabel = "Best SteamVR Headsets";
