...
export const guideTitle = "The Best Laser Engravers for Hobby: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 7 laser engravers for hobby, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Laser Engravers for Hobby (2026)";
...
export const breadcrumbLabel = "Best Laser Engravers for Hobby";
