...
export const guideTitle = "The Best 32-Inch 4K Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "LG 32UR550K-B 32-inch Ultrafine 4K UHD (3840 x 2160) Computer Monitor)",
...
export const metaDescription = "How 6 32-inch 4K monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 32-Inch 4K Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Samsung’s 32\" viewfinity s7 (s70h) high-resolution monitor",
...
export const breadcrumbLabel = "Best 32-Inch 4K Monitors";
