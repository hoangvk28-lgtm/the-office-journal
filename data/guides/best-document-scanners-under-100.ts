...
export const faq = [
  {
    "q": "Can the HP HPPS100 scan both sides of a page automatically?",
    "a": "No, it's a simplex, one-sided scanner, so you'll need to manually flip the page and run it through a second time to capture both sides."
  },
  {
    "q": "What's the most common mistake buyers make when choosing between a wand and a sheet-fed scanner at this price?",
    "a": "Assuming a handheld wand will be as fast as automatic sheet feeding, when in reality a wand requires a steady manual pass per page and is meaningfully slower for scanning multiple documents in one sitting."
  },
  {
    "q": "Is the HP HPPS100 worth the price jump over the Canon Canoscan Lide 300 flatbed?",
    "a": "If you regularly scan multi-page stacks and want automatic feeding, yes, but if you mostly scan single pages or photos occasionally, the Canon flatbed's lower price and evenly lit scan quality make more sense."
  },
  {
    "q": "How do I get the best results from a handheld wand scanner like the Hczrc or AOZBZ?",
    "a": "Drag the wand across the page at a slow, steady, even pace in one continuous motion, since inconsistent speed is the most common cause of warped or streaky scans."
  },
  {
    "q": "Do I need to buy anything extra to use the Hczrc or AOZBZ scanners out of the box?",
    "a": "Yes, both require 2 AA batteries that aren't included, though both do ship with a micro SD card for storage already included."
  },
  {
    "q": "Can I use the AOZBZ wand scanner to digitize an open book without damaging the spine?",
    "a": "Yes, since you drag the wand by hand across the open page rather than feeding it through rollers, it avoids the strain a sheet-fed or flatbed scanner could put on a book's binding."
  }
];

export const guideSlug = "best-document-scanners-under-100";

export const guideTitle = "The Best Document Scanners Under $100: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "A reliable flatbed scan at the lowest price",
          "Canon Canoscan Lide 300 Scanner"
        ],
        [
          "Automatic sheet feeding without manual dragging",
          "HP HPPS100 Mobile Document & Photo Scanner"
        ],
        [
          "The cheapest possible portable option",
          ""
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Pulls a single page through the scanner mechanically at 15ppm, faster and more consistent than manual technique, but simplex only."
      },
      {
        "label": "Manual scanning (Canon flatbed, Hczrc, AOZBZ)",
        "text": "Either lays a page flat under a lid or requires a hand-dragged wand pass, both slower per page but cheaper."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Quick reference copies of receipts",
          "Hczrc or AOZBZ at 300 DPI mode"
        ],
        [
          "Documents needing clear detail later",
          "HP HPPS100 at 1200 DPI"
        ],
        [
          "General desk-based document and photo scanning",
          "Canon Canoscan Lide 300 Scanner"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Automatic sheet feeding rather than a manual flatbed or wand process that requires handling each page individually."
      },
      {
        "label": "",
        "text": "The HP HPPS100 is the only pick with true automatic sheet feeding at 15 pages per minute."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want faster, hands-off multi-page scanning, where the HP HPPS100's automatic feed justifies its higher price over the manual picks."
      },
      {
        "label": "",
        "text": "You mainly scan single pages occasionally, where the Canon Canoscan Lide 300 delivers a reliable flatbed scan for under $70."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Distinguished flatbed, handheld wand, and automatic sheet-fed designs, since each handles paper very differently."
  },
  {
    "title": "",
    "description": "Compared automatic sheet feeding against manual, hand-operated scanning approaches."
  },
  {
    "title": "",
    "description": "Checked maximum DPI, selectable resolution modes, and output file formats across the lineup."
  },
  {
    "title": "",
    "description": "Compared weight, size, and whether each scanner runs on batteries or USB power."
  },
  {
    "title": "",
    "description": "Noted memory card capacity where applicable and whether companion software is required or optional."
  }
];
...
export const metaDescription = "A practical comparison of 4 document scanners under $100, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Document Scanners Under $100 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Cheapest pick in this comparison despite being a flatbed",
    ...
    "cons": [
      ...
      "Single-page scanning only, no automatic document feeder"
    ],
  ...
  },
  {
    ...
    "description": "Unlike the handheld wand scanners in the lower price tier, this is a true sheet-fed scanner: you feed a single page in and it pulls the sheet through automatically at up to 15 pages per minute, a meaningfully faster and more hands-off process than dragging a wand.\n\nIts free HP WorkScan software adds auto-scan and size detection along with cropping and background cleanup, features none of the flatbed or wand scanners in this comparison offer.\n\nBest for buyers who want automatic sheet feeding rather than manual page handling, even at a simplex, single-sided scan.",
    "specs": [
      "Sheet-fed, 15ppm, up to 1200 DPI",
      "One-sided simplex scanning, USB 2.0 powered",
      "HP WorkScan software with auto-crop and cleanup"
    ],
    "pros": [
      "Automatic sheet feeding, no manual page dragging needed",
      "15ppm scan speed, faster than any wand scanner",
      "Free WorkScan software adds auto-crop and cleanup"
    ],
    "cons": [
      "Simplex only, can't scan both sides in one pass",
      "Priciest pick in this comparison at $139.99"
    ],
  ...
  },
  {
    ...
    "pros": [
      ...
      "No software installation, standalone SD card operation",
      "Three resolution modes for size versus detail tradeoffs"
    ],
    "cons": [
      "Requires steady hand-dragging technique for clean scans",
      "No automatic sheet feeding like the HP pick above"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Only pick here designed for scanning bound book pages",
      "Supports larger 32GB SD cards for bulk scanning",
      "Very lightweight at 0.31 lb for travel"
    ],
    "cons": [
      "Same manual hand-steadying skill as any wand scanner",
      "No automatic feeding, unlike the HP sheet-fed pick"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-document-scanners-under-75",
    "title": "Best Document Scanners Under $75"
  },
  {
...
export const breadcrumbLabel = "Best Document Scanners Under $100";
