...
const queries = [
  "ergonomic kneeling chair office",
  "kneeling chair with wheels office",
  "budget kneeling chair under 100",
];
const pool = {};
...
writeFileSync(resolve(ROOT, "/tmp/kneeling_pool.json"), JSON.stringify(pool, null, 2));
