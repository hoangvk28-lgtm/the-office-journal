...
export const guideTitle = "The Best Carbon-Fiber 3D Printers for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Creality K2 Combo (A) 3D Printer)",
...
export const metaDescription = "We compared 6 carbon-fiber 3D printers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Carbon-Fiber 3D Printers for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-qidi-3d-printers",
    "title": "Best QIDI 3D Printers in 2026"
  }
];

export const breadcrumbLabel = "Best Carbon-Fiber 3D Printers";
