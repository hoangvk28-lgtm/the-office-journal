export const guideSlug = "best-audio-interfaces-for-mac";
export const guideTitle = "8 Best Audio Interfaces for Mac in 2026";
export const metaTitle = "Best Audio Interfaces for Mac";
export const metaDescription = "We compared audio interface for mac models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "audio interface for mac";
export const introParagraphs = [
  "Across best audio interfaces for mac, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is real input count and preamp gain, since this predicts real recording reliability."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-audio-interfaces-for-mac-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-audio-interfaces-for-mac-2",
    rank: 2,
  ...
  {
    id: "best-audio-interfaces-for-mac-3",
    rank: 3,
  ...
  {
    id: "best-audio-interfaces-for-mac-4",
    rank: 4,
  ...
  {
    id: "best-audio-interfaces-for-mac-5",
    rank: 5,
  ...
  {
    id: "best-audio-interfaces-for-mac-6",
    rank: 6,
  ...
  {
    id: "best-audio-interfaces-for-mac-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-audio-interfaces-for-mac-8",
    rank: 8,
    badge: "Also Worth Considering",
