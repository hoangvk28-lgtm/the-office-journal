...
export const guideTitle = "The Best NETGEAR Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 8 NETGEAR network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best NETGEAR Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F1GG2DC8?tag=theofficejournal-20",
    "description": "3az energy efficiency as the smaller GS-series models.\n\nIt's a straightforward port-count expansion with no VLAN or monitoring capability, ideal for buyers who've outgrown an 8-port switch but still want true plug-and-play simplicity.",
    "specs": [
      "16 Gigabit ports, fanless",
      "802.3az energy-efficient",
      "Desktop or wall mount"
    ],
    "pros": [
      "16 ports without adding a fan",
      "Zero configuration required",
      "Consistent NETGEAR build quality"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best NETGEAR Network Switches";
