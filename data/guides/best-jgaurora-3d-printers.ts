...
export const guideTitle = "The Best JGAurora 3D Printers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Flashforge Adventurer 5M 3D Printer for Beginners)",
...
export const metaDescription = "A practical comparison of 6 JGAurora 3D printers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best JGAurora 3D Printers for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-raise3d-3d-printers",
    "title": "Best Raise3D 3D Printers in 2026"
  }
];

export const breadcrumbLabel = "Best JGAurora 3D Printers";
