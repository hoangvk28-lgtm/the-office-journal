...
export const guideTitle = "The Best Wall-Mount Microphone Arms for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 wall-mount microphone arms, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Wall-Mount Microphone Arms for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Wall-Mount Microphone Arms";
