export const guideSlug = "best-small-dehumidifiers-for-bathrooms";
export const guideTitle = "8 Best Small Dehumidifiers for Bathrooms in 2026";
export const metaTitle = "Best Small Dehumidifiers for Bathrooms";
export const metaDescription = "We compared small dehumidifier for bathroom models by verified specs and real-world tradeoffs, not marketing claims alone.";
export const mainKeyword = "small dehumidifier for bathroom";
export const introParagraphs = [
  "Best Small Dehumidifiers for Bathrooms aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
...
export const products: GuideProduct[] = [
  {
    id: "best-small-dehumidifiers-for-bathrooms-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-small-dehumidifiers-for-bathrooms-2",
    rank: 2,
  ...
  {
    id: "best-small-dehumidifiers-for-bathrooms-3",
    rank: 3,
    ...
    specs: ["Efficient dehumidification", "Small dehumidifier is tailored for smaller spaces", "Mini dehumidifier low quiet at 30db, lets you sleep"],
    pros: ["Efficient dehumidification", "Small dehumidifier is tailored for smaller spaces", "Mini dehumidifier low quiet at 30db, lets you sleep", "Auto shut off & 7 colorful night lights"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-small-dehumidifiers-for-bathrooms-4",
    rank: 4,
  ...
  {
    id: "best-small-dehumidifiers-for-bathrooms-5",
    rank: 5,
    ...
    specs: ["Gentle control, low energy", "Compact & portable for small spaces", "Auto defrost & auto shut-off"],
    pros: ["Gentle control, low energy", "Compact & portable for small spaces", "Auto defrost & auto shut-off", "4 time setting & 3 modes"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-small-dehumidifiers-for-bathrooms-6",
    rank: 6,
    badge: "Best Value",
  ...
  {
    id: "best-small-dehumidifiers-for-bathrooms-7",
    rank: 7,
  ...
  {
    id: "best-small-dehumidifiers-for-bathrooms-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Mid-range pick",
          "Windangel 44oz(1.3L) Small Dehumidifier for Home Auto-Off Quiet Portable"
        ],
        [
          "Higher budget",
          "BEDRED Dehumidifier"
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Continuous drain (e.g. TABYIK 35 OZ Dehumidifier for Bedroom RV)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You're covering a large or genuinely wet space and want a built-in pump and higher capacity, where BEDRED Dehumidifier justifies the extra cost."
      },
      {
        "label": "Save if",
