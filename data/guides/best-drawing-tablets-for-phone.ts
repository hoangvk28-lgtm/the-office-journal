...
export const guideTitle = "6 Best Drawing Tablets for Phone in 2026";
export const metaTitle = "Best Drawing Tablets for Phone 2026";
export const metaDescription = "We compared drawing tablets for phone by tablet architecture, pen behavior, and driver support rather than ranking by pressure-level count alone.";
...
export const introParagraphs = [
  ...
  "We leaned on documented pen behavior and driver support plus checking exact phone compatibility, portrait/landscape mapping, and pressure support in real mobile apps to separate genuinely capable tablets from well-marketed ones."
];
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-drawing-tablets-for-android","title":"Best Drawing Tablets for Android in 2026"},{"href":"/guide/best-drawing-tablets-for-mobile","title":"Best Drawing Tablets for Mobile in 2026"},{"href":"/guide/best-drawing-tablets","title":"Best Drawing Tablets in 2026"}];
