...
export const guideTitle = "The Best Storage Carts for RVs, Compared";
...
export const metaDescription = "We compared 8 storage carts for RVs on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Storage Carts for RVs (2026)";
...
export const breadcrumbLabel = "Best Storage Carts for RVs";
