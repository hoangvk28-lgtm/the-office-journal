...
export const introParagraphs = [
  "Best HDR 4K Monitors cover more ground, exactly why hdr 4k monitors, one spec isn't enough.",
  "hdr 4k monitors is judged here on true HDMI bandwidth, because panel type sets real contrast and color."
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "IPS (e.g. Dell 27 Monitor S2725QC)",
