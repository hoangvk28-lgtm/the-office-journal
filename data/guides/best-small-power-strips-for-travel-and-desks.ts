...
export const faq = [
  {
    "q": "Can one power strip work well for both travel and everyday desk use?",
    "a": "It involves genuine compromises on both ends. Lighter weight for travel typically means a less stable base for daily desk use, and vice versa, products marketed as suitable for both rarely excel at either compared to a purpose-built option."
  },
  {
    "q": "Do travel power strips have surge protection?",
    "a": "Travel-oriented compact strips often cut surge protection entirely to save size and weight, verify this specifically if the strip will also serve as your daily desk protector."
  },
  {
    "q": "Why don't some travel power strips have surge protection?",
    "a": "Some are explicitly designed this way for cruise-line compliance, most cruise lines prohibit surge protectors and traditional power strips with internal circuitry, cruise-approved picks omit this component by policy."
  },
  {
    "q": "Can I use a US travel power strip internationally?",
    "a": "Only if it's explicitly voltage-compatible. Many power strips are voltage-locked to 120V and are not safe or functional on 230V international circuits, even with a simple plug-shape adapter, verify voltage compatibility before international travel."
  }
];

export const guideSlug = "best-small-power-strips-for-travel-and-desks";

export const guideTitle = "The Best Small Power Strips for Travel and Desks: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    "title": "Honest dual-use tradeoff disclosed, not a seamless win-win claim",
    "description": "Distinguished lighter, travel-optimized picks from more stable, desk-optimized picks explicitly, rather than presenting any single product as excelling equally at both use cases."
  },
  {
    "title": "Surge protection presence verified for daily desk reliance",
    "description": "Checked whether each travel-oriented pick retains genuine surge protection, since a strip designed primarily for size/weight savings may cut this component entirely."
  },
  {
    "title": "Cruise-line compliance verified where explicitly marketed",
    "description": "Noted which picks are explicitly designed without surge protection for cruise-line compliance, a real design tradeoff distinct from a basic manufacturing cost-cut."
  }
];

export const introParagraphs = [
  "A dual-purpose travel-and-desk strip involves compromises on both ends, lighter weight for travel typically means a less stable base for stationary desk use, and vice versa, products marketed as suitable for both use cases rarely excel at either.",
...
export const metaDescription = "A practical comparison of 5 small power strips for travel and desks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Small Power Strips for Travel and Desks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A compact, ultra-thin design that packs easily for travel while remaining stable enough for daily desk use, a reasonable middle ground rather than an extreme compromise toward either use case.\n\nGenuine middle ground between travel-light and desk-stable. On price, it's actually priced above Travel Essentials, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Not the lightest option for pure travel use.",
    "specs": [
    ...
    "pros": [
      "Genuine middle ground between travel-light and desk-stable",
      "Strong rating base",
      "Packs easily for travel",
      "Flat plug for wall clearance"
    ],
    "cons": [
      "Verify surge protection level for daily desk use",
      "Fewer outlets than dedicated desk strips",
      "Not the lightest option for pure travel use"
    ],
    "bestFor": "Buyers who need one strip for both occasional travel and daily desk use"
  },
  {
    ...
    "description": "5W USB output for charging on the go.\n\nOn the other side, 6ft cord longer than needed for pure travel.",
    "specs": [
      "Travel-focused design, 22.5W USB",
      "6ft cord, flat plug",
      "Lightweight for packing"
    ],
    "pros": [
      "Explicitly travel-optimized with real packability",
      "22.5W USB output",
      "Very affordable"
    ],
    "cons": [
      "Travel-first design may be less stable for daily desk use",
      "Verify surge protection level",
      "6ft cord longer than needed for pure travel"
    ],
  ...
  },
  {
    ...
    "description": "Marketed as cruise approved, meaning it's designed without the surge-protection circuitry most cruise lines prohibit, useful if travel occasionally includes cruises alongside desk use.\n\nOn the other side, Less ideal as a primary daily desk surge protector.",
    "specs": [
    ...
    "pros": [
      "Cruise-approved design avoids confiscation risk",
      "Strong rating base",
      "Compact for travel packing",
      "Reasonable price"
    ],
    "cons": [
      "No surge protection at all, by design",
      "Verify current policy with your specific cruise line",
      "Less ideal as a primary daily desk surge protector"
    ],
  ...
  },
  {
    ...
    "description": "Explicitly no surge protector by design for cruise compliance, at a lower price than the ORICO alternative, with 6 outlets for more capacity. ETL listed for basic electrical safety.\n\nThe real tradeoff against that pick: No surge protection at all, by design.\n\nOn the other side, Verify current cruise line policy before travel.",
    "specs": [
    ...
    "pros": [
      ...
      "6 outlets, more capacity than the ORICO alternative",
      "ETL listed for basic safety"
    ],
    "cons": [
      "No surge protection at all, by design",
      "Less ideal as a primary daily desk protector",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DPKKMPBD?tag=theofficejournal-20",
    "description": "8 outlets and 4 USB ports (including USB-C) with a long 10ft cord, more desk-first capacity than the travel-optimized picks in this guide, still packable if needed occasionally.\n\nOn the other side, Higher price relative to travel-only alternatives.",
    "specs": [
      "8 outlets, 4 USB ports (1 USB-C)",
      "10ft cord, flat plug",
      "3-sided outlet design",
      "Strong rating base"
    ],
    "pros": [
      "Genuine desk-first capacity with 8 outlets",
      "10ft cord for placement flexibility",
      "USB-C port included",
      "Still packable for occasional travel"
    ],
    "cons": [
      "Bulkier than the dedicated travel-first picks",
      "10ft cord adds bulk for pure travel packing",
      "Higher price relative to travel-only alternatives"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-cruise-approved-power-strips",
    "title": "Best Cruise-Approved Power Strips (2026)"
  },
  {
    "href": "/guide/best-compact-power-strips-for-small-desks",
    "title": "Best Compact Power Strips for Small Desks (2026)"
  }
];

export const breadcrumbLabel = "Best Small Power Strips for Travel and Desks";
