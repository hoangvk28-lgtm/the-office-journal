...
export const guideTitle = "The Best Oscillating Desk Fans for a Better Desk Setup";
...
export const metaDescription = "We compared 8 oscillating desk fans on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Oscillating Desk Fans for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "3 speed adjustable tilt oscillating fan delivers quiet",
      "Quiet operation",
...
export const breadcrumbLabel = "Best Oscillating Desk Fans";
