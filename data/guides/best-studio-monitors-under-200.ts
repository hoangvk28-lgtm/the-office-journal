...
export const guideTitle = "The Best Studio Monitors Under $200: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  {
    "subheading": "5\" vs PreSonus Eris E7",
    "cards": [
      {
    ...
    "note": "5\" Wired Studio Monitors Pair unless your specific use case points toward PreSonus Eris E7 XT 2-Way Active Studio Monitor with EBM Waveguide (Pack of 1)'s particular tradeoffs."
  },
  {
    "subheading": "",
    "table": {
...
export const metaDescription = "A practical comparison of 7 studio monitors under $200, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Studio Monitors Under $200 (2026)";
...
export const breadcrumbLabel = "Best Studio Monitors Under $200";
