...
export const guideTitle = "The Best Power Bank + Wireless Charger Combos for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "LYAOAO for MagSafe Power Bank 10000mAh)",
        "text": "More charges before a recharge, but heavier and bulkier to carry."
      },
      {
        "label": "Podoru for MagSafe Power Bank 5000mAh)",
...
export const metaDescription = "We compared 8 power bank + wireless charger combos on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Power Bank + Wireless Charger Combos for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Ideal for travel & daily carry ditch the brick-like chargers",
      "15W wireless + 20w pd fast charge",
      "Heat-proof & fire-resistant safety first"
    ],
    "pros": [
      "Ideal for travel & daily carry ditch the brick-like chargers",
      "15W wireless + 20w pd fast charge",
...
export const breadcrumbLabel = "Best Power Bank + Wireless Charger Combos";
