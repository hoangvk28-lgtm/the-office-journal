...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "3 lb weight are both notably light for stand-equipped screens, making a real difference if you plan frequent setup and teardown for events, camping, or regularly rotating between rooms, versus a heavier screen you'd rather leave semi-permanently assembled. This matters less if the screen will live in one fixed location indefinitely, where weight becomes largely irrelevant after the initial setup. Consider your actual frequency of moving or repositioning the screen before treating a lighter weight as a meaningfully important factor over other specs like size or gain rating."
  }
];

export const faq = [
  {
    "q": "Does a higher gain rating always mean a better picture regardless of room setup?",
    "a": "No, a higher gain screen reflects more light back but typically has a narrower optimal viewing angle, so it's better for a room with seating positioned relatively centrally, while a wider seating arrangement benefits more from a standard or lower gain rating for even brightness across the room."
  },
  {
    "q": "What's the most common mistake buyers make when comparing screen sizes across different aspect ratios in this tier?",
    "a": "Comparing the diagonal size numbers directly between a 4:3 screen like the Pyle pick and a 16:9 screen like the others, when the actual viewing area shape differs significantly, so the same diagonal measurement doesn't represent the same width or height between the two ratios."
  },
  {
    "q": "Is the Fiberglass 80in pick worth it over the cheaper Wootfairy 100in option?",
    "a": ""
  },
  {
    "q": "How do I know if the Aluminium Frame pick's 60 inch size is large enough for my room?",
    "a": "Measure your intended viewing distance and compare it against general projector screen sizing guidelines, since a 60 inch screen suits closer viewing distances typical of smaller rooms, while larger rooms with more distance between viewer and screen benefit from the bigger sizes in this tier."
  },
  {
    "q": "Can the Pyle 40-Inch screen's 4:3 ratio still display widescreen movies, just with black bars?",
    "a": "Yes, widescreen 16:9 content will display with black bars on a 4:3 screen, which works fine functionally but doesn't maximize the screen's usable area for that specific content type, so a 16:9 pick is the better match if movies are your primary use."
  },
  {
    "q": "Do any of these screens require specific projector brightness levels to look good?",
    "a": "Higher gain screens like the Fiberglass 80in pick can work well with lower-lumen projectors since they reflect more light, while standard gain screens generally benefit from a brighter projector, so checking your specific projector's stated lumen output against the screen's gain rating helps ensure a good match."
  }
];

export const guideSlug = "best-projector-screens-under-75";

export const guideTitle = "The Best Projector Screens Under $75, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "The lightest, most portable screen with a high gain rating",
          "Projector Screen with Stand, 60 Inch, Aluminium Frame"
        ],
        [
          "Genuine fiberglass construction with a stated gain rating",
          ""
        ],
        [
          "The largest viewing area at this price point",
          "Wootfairy 100inch Projector Screen with Stand"
        ],
        [
          "An established brand with precise alignment features",
          "Pyle 40-Inch Portable Projector Screen with Tripod Stand"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Prioritizes maximum viewing area, without a specifically stated gain rating."
      },
      {
        "label": "Higher gain rating (Fiberglass 80in, Aluminium Frame 60in)",
        "text": "Prioritizes a stated, checkable gain figure for brightness and color reproduction, in smaller sizes."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "Fiberglass 80in, Wootfairy 100in, or Aluminium Frame 60in (16:9)"
        ],
        [
          "",
          ""
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "2 gain) stated in the listing, since gain directly affects brightness and viewing angle tradeoffs in a checkable way that generic quality claims don't."
      },
      {
        "label": "",
        "text": "2 gain rating gives you a specific, comparable figure that the Wootfairy and Pyle picks don't provide in their listings."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want the lightest, most portable screen with a stated high gain rating, where the Aluminium Frame pick delivers that at the top of this tier."
      },
      {
        "label": "",
        "text": "You want an established brand with precise alignment features without needing a large diagonal size, where the Pyle 40-Inch pick covers that for about $13 less."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared stated gain figures and frame material, fiberglass versus polyester, across the lineup."
  },
  {
    "title": "",
    "description": "Compared stand weight and setup time across all four picks."
  },
  {
    "title": "",
    "description": "Compared diagonal size and aspect ratio suited to different use cases."
  },
  {
    "title": "",
    "description": "Checked for masking borders and other alignment-focused design details."
  },
  {
    "title": "",
    "description": "Checked for established brand presence in the projector accessory category."
  }
];
...
export const metaDescription = "We compared 4 projector screens under $75 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Projector Screens Under $75 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09JCSYWVV?tag=theofficejournal-20",
    "description": "This screen's four aluminum tubes with spring tension at the ends maintain a flat surface, and the listing specifically states its fabric carries a high gain factor for a superior picture compared to standard budget fabric. 6 lbs, it's the lightest stand-equipped screen in this comparison, easy for one person to carry anywhere.\n\nCompared to the fiberglass pick below, this one prioritizes lightweight portability and quick 2-minute setup over the larger diagonal sizes found elsewhere in this tier. The sturdy tripod stand stretches, folds, and adjusts with the same spring-tensioned aluminum tubes providing stability especially for outdoor use.\n\nBest for buyers who want the lightest, most portable stand-equipped screen with a high gain rating.",
    "specs": [
      "60in, aluminum frame, high gain fabric",
      "8.6 lbs, 2-minute setup",
      "Adjustable, foldable tripod stand"
    ],
    "pros": [
      "Lightest stand-equipped screen in this comparison at 8.6 lbs",
      "High gain fabric factor for a superior picture",
      "2-minute setup is among the fastest in this tier"
    ],
    "cons": [
      "Slightly over this tier's stated ceiling at $77.86",
      "Smallest diagonal size in this comparison at 60 inches"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CQLVD4NS?tag=theofficejournal-20",
    "description": "2 times gain effect, delivering highly reproducible vibrant colors that naturally display 4K Ultra HD images with realistic viewing quality. Its sturdy metal tripod with a thick main pole and 4 diagonal poles, plus 4 aluminum tubes with spring tension, keeps the structure stable, solid, and height-adjustable.\n\n2 gain rating and 4K reproduction quality. Setup takes less than 3 minutes, and the 10 lb screen rolls up into a storage tube for easy transport.",
    "specs": [
      "80in, fiberglass with black coated back",
      "1.2 gain, 4K Ultra HD capable",
      "10 lbs, rolls into storage tube"
    ],
    "pros": [
      "Genuine fiberglass construction with black coated back for 1.2 gain",
      "Specifically rated for 4K Ultra HD image reproduction",
      "Rolls into a compact storage tube for easy transport"
    ],
    "cons": [
      "Smaller viewing area than the Wootfairy pick's 100 inch size",
      "Height adjustment range may not suit every setup"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0C619FDHZ?tag=theofficejournal-20",
    "description": "This screen's 100 inch diagonal with double-sided projection support offers the largest viewing area in this comparison at the same price as the fiberglass pick above, made from thicker polyester milk silk for a wrinkle-free viewing experience. Its detachable crossbar and tripod assemble easily without tools, staying lightweight and resistant to bending or deforming.\n\nCompared to the fiberglass pick, this one trades material sophistication for meaningfully larger screen size, positioning it for buyers who prioritize viewing area over gain rating specifics. 3 lbs including the carry bag, it fits easily in a car trunk for outdoor events.\n\nBest for buyers who want the largest viewing area at the same price as smaller specialized alternatives.",
    "specs": [
      "100in diagonal, double-sided projection",
      "Polyester milk silk, wrinkle-free",
      "8.3 lbs, tool-free assembly"
    ],
    "pros": [
      "Largest viewing area in this comparison at 100 inches",
      "Double-sided projection support adds setup flexibility",
      "Lightweight at 8.3 lbs with included carry bag"
    ],
    "cons": [
      "No stated gain rating like the fiberglass pick",
      "Standard polyester rather than specialized fiberglass material"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B01953VT2U?tag=theofficejournal-20",
    "description": "5mm matte fabric with a black masking border specifically improves image focus and alignment, a detail-oriented feature the other picks in this comparison don't call out as precisely. Its fold-out steel tripod legs adjust from a minimum height of 20 inches to a maximum of 46 inches, giving you real height flexibility.\n\nCompared to the other three picks, this one is the cheapest in this tier while coming from Pyle, an established brand in the projector accessory category. The manual auto-locking pull feature makes setup straightforward, and the 4:3 aspect ratio suits classroom or office presentation use specifically.\n\nBest for buyers who want an established brand with precise image alignment features at the lowest price.",
    "specs": [
      "40in, 4.5mm matte fabric, black masking border",
      "20-46in adjustable height",
      "4:3 aspect ratio, auto-locking pull"
    ],
    "pros": [
      "Cheapest pick in this tier from an established brand",
      "Black masking border improves image focus and alignment",
      "20 to 46 inch height adjustment provides real flexibility"
    ],
    "cons": [
      "Smallest diagonal size in this comparison at 40 inches",
...
export const breadcrumbLabel = "Best Projector Screens Under $75";
