...
export const guideTitle = "The Best 32-Inch Gaming Monitors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Sceptre New 32-inch 2K QHD 2560 x 1440 Prime Gaming Monitor up to 210Hz USB)",
...
export const metaDescription = "We compared 6 32-inch gaming monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 32-Inch Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Gawfolk 32 Inch Curved Gaming Monitor 240Hz is the strongest all-around choice here. Build-in amd freesync for reducing motion blur to prevent tearing and lagging for crisp video play. 7 million color gamut, a dynamic 4000:1 contrast ratio, and full coverage of the 100% srgb.\n\nSceptre New 32-inch 2K QHD 2560 x 1440 Prime Gaming Monitor up to 210Hz USB is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nThis fits best if you want the strongest all-around pick in this comparison and would rather not keep shopping around. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    "specs": [
      "240Hz curved gaming monitor - gawfolk 32 inch gaming",
      "Build-in amd freesync for reducing motion blur to prevent tearing and lagging for crisp video play",
      "Vivid color - the curved computer monitor offers a vibrant visual experience with 8-bit color depth"
    ],
    "pros": [
      "240Hz curved gaming monitor - gawfolk 32 inch gaming",
      "Build-in amd freesync for reducing motion blur to prevent tearing and lagging for crisp video play",
      "Vivid color - the curved computer monitor offers a vibrant visual experience with 8-bit color depth",
      "Flexible connectivity - gawfolk curved gaming monitor supports video"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best 32-Inch Gaming Monitors";
