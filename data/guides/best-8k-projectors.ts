...
export const guideSlug = "best-8k-projectors";

export const guideTitle = "The Best 8K Projectors for a Better Desk Setup";
...
export const introParagraphs = [
  "Across best 8k projectors, aren't identical under the hood, given that differences show up in the fine print.",
  "What separates these picks is true brightness and mounting distance, since this is what specs won't show."
];

export const lastUpdated = "2026-08-31";

export const mainKeyword = "8k projector";

export const metaDescription = "We compared 8 8K projectors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 8K Projectors for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-8k-projectors-1",
    "rank": 1,
    "badge": "Best Overall",
...
export const breadcrumbLabel = "Best 8K Projectors";
