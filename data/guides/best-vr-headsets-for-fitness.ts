...
export const guideTitle = "The Best VR Headsets for Fitness: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 6 VR headsets for fitness, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best VR Headsets for Fitness (2026)";
...
export const breadcrumbLabel = "Best VR Headsets for Fitness";
