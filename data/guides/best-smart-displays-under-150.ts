...
export const buyingCriteria = [
  ...
  {
    "criterion": "Certified Refurbished Condition on a Smart Display Carries the Same Warranty as New, Making It a Lower-Risk Way to Save Money",
  ...
  {
    "criterion": "A Round Alarm Clock Form Factor Serves a Different Purpose Than a Flat Rectangular Display",
...
export const faq = [
  {
    "q": "Will a Google Nest Hub work with my existing Alexa-compatible smart home devices?",
    "a": "Not reliably for voice control, since the Nest Hub runs Google Assistant, and many Alexa-specific smart home devices aren't designed to respond to Google Assistant voice commands, so check your existing devices' actual ecosystem compatibility before switching."
  },
  {
    "q": "What's the most common mistake buyers make when choosing between the Echo Show 5 and Echo Show 8?",
    "a": "Assuming the smaller, cheaper Echo Show 5 is always the better value, when a certified refurbished Echo Show 8 like the Like-New pick in this comparison can offer a meaningfully larger screen and built-in smart home hub for only about $35 more than the new Echo Show 5."
  },
  {
    "q": "Is a certified refurbished Echo Show 8 as reliable as buying new?",
    "a": "Yes, Amazon's Like-New program specifically tests and certifies these units to look and work like new, backing them with the same limited warranty a new device receives, making it a lower-risk way to access a larger screen at a reduced price."
  },
  {
    "q": "Does the Echo Spot's WiFi extender feature require a separate eero device to work?",
    "a": "Yes, it specifically extends an existing eero mesh WiFi network, so you'd need to already have or set up an eero system for this bonus feature to provide additional coverage."
  },
  {
    "q": "How do I decide if I need a smart display with a built-in camera or one without?",
    "a": "If video calling or home monitoring matters to you, choose a camera-equipped pick like the Echo Show 5 or Echo Show 8, but if you're mainly interested in voice control and glanceable information without video capability, the Echo Spot's lack of a full touchscreen camera view may still suit basic needs."
  },
  {
    "q": "Can I use the Echo Show 5's privacy shutter and still receive video call notifications?",
    "a": "Yes, closing the physical camera shutter only blocks the camera from capturing video, so you'll still see and hear incoming call notifications on the display and can choose to open the shutter before answering if you want to enable video."
  }
];

export const guideSlug = "best-smart-displays-under-150";

export const guideTitle = "The Best Smart Displays Under $150: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "A larger 8-inch screen at a lower price",
          "Like-New Amazon Echo Show 8"
        ],
        [
          "",
          "Google Nest Hub (1st Gen), 7-inch Display"
        ],
        [
          "A nightstand-focused alarm clock with WiFi extension",
          "Amazon Echo Spot, Smart Alarm Clock"
        ],
        [
          "The most affordable new Alexa smart display",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Alexa (Echo Show 5, Echo Show 8, Echo Spot)",
        "text": "Integrates with Amazon's broader Alexa smart home ecosystem, ideal if you already own other Echo devices or Alexa-compatible smart home gear."
      },
      {
        "label": "",
        "text": "Integrates with Google's ecosystem instead, the better fit if your smart home devices already work with Google Home or Google Assistant."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "General browsing, video calls, recipes",
          "Like-New Echo Show 8 (8 in) or Nest Hub (7 in)"
        ],
        [
          "Compact bedside or desk use",
          ""
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A larger screen with a higher-resolution camera and auto-framing technology for a more natural calling experience."
      },
      {
        "label": "",
        "text": "The Like-New Echo Show 8's 13 MP auto-framing camera offers the most capable video calling experience here."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want a larger screen and built-in smart home hub, where the Like-New Echo Show 8 delivers both at a price still under $135."
      },
      {
        "label": "",
        "text": "You just want a basic, affordable entry into smart displays, where the Echo Show 5 covers that for under $100."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Distinguished Alexa-based picks from the Google Assistant-based Nest Hub, since ecosystem compatibility affects existing smart home integration."
  },
  {
    "title": "Screen Size and Use Case",
    "description": "Compared display size and form factor, from compact bedside clocks to larger general-purpose touchscreens."
  },
  {
    "title": "",
    "description": "Compared built-in camera presence and physical privacy controls like mic/camera off buttons and shutters."
  },
  {
    "title": "",
    "description": "Checked which picks include a built-in smart home hub versus relying on a separate hub device."
  },
  {
    "title": "",
    "description": "Compared recycled material content across the lineup where specifically stated."
  }
];
...
export const metaDescription = "A practical comparison of 4 smart displays under $150, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Smart Displays Under $150 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "8 in HD touchscreen, spatial audio, Alexa built-in",
      "Built-in Zigbee/Matter/Thread smart home hub",
      "13 MP auto-framing camera, certified refurbished"
    ],
    "pros": [
      "Larger 8-inch screen at a price close to smaller models",
      "Built-in smart home hub skips needing a separate hub device",
      "Certified refurbished with the same warranty as new"
    ],
    "cons": [
      "Refurbished condition may not suit buyers wanting factory-sealed new",
      "Limited color options compared to buying new"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FDD9R644?tag=theofficejournal-20",
    ...
    "specs": [
      "7 in touchscreen, 1024x600, Google Assistant built-in",
      "Compatible with 200+ devices from 50+ brands",
      "Voice Match for personalized routines"
    ],
    "pros": [
      "Only genuine Google Assistant pick in this comparison",
      "Broad compatibility across 200+ smart home devices and 50+ brands",
      "Voice Match personalizes responses per household member"
    ],
    "cons": [
      "No camera for video calling, unlike the Echo Show picks",
      "Lower resolution display than the Echo Show 8"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BFCBKXWL?tag=theofficejournal-20",
    "description": "This is a different form factor from the flat-screen picks in this comparison, a round smart alarm clock specifically designed for nightstands, offices, and kitchens rather than general-purpose viewing. Its customizable clock face lets you personalize the display with different colors and styles, and it shows time, weather, and song titles at a glance.\n\nIts built-in eero technology doubles as a mesh WiFi extender, adding up to 1,000 square feet of coverage to an existing eero network, a unique bonus feature no other pick in this comparison offers. Alexa routines can gently wake you with music and gradual light, and it's made from 36 percent recycled materials.\n\nBest for buyers who specifically want a nightstand-focused smart alarm clock rather than a general-purpose flat display.",
    "specs": [
      "Round smart alarm clock design, customizable clock face",
      "Built-in eero mesh WiFi extender (1,000 sq ft)",
      "Alexa built-in, gradual wake-up routines"
    ],
    "pros": [
      "Only pick in this comparison doubling as a mesh WiFi extender",
      "Purpose-built round design suits nightstand use specifically",
      "Customizable clock face personalizes the bedside experience"
    ],
    "cons": [
      "No touchscreen video viewing like the flat-panel picks",
      "Smaller display less suited to browsing photos or recipes"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09B2SBHQK?tag=theofficejournal-20",
    "description": "5 inch display showing news, weather, and song titles at a glance, plus 2x the bass and clearer sound than earlier generations for streaming music and shows from Amazon Music, Spotify, and Prime Video. Its built-in camera supports video calling and home monitoring, including compatible video doorbells.\n\nIts privacy controls include a dedicated mic/camera off button and a built-in camera shutter, and the device's fabric is made from 100 percent post-consumer recycled polyester yarn with 100 percent recycled aluminum, a genuine sustainability commitment.\n\nBest for buyers who want a compact, affordable entry point into the Alexa smart display ecosystem.",
    "specs": [
      "5.5 in display, Alexa built-in, 2 MP camera",
      "Mic/camera off button, built-in camera shutter",
      "100% recycled polyester fabric and aluminum"
    ],
    "pros": [
      "Lowest price for a new (not refurbished) smart display in this comparison",
      "Dedicated privacy controls including a physical camera shutter",
      "Fully recycled fabric and aluminum construction"
    ],
    "cons": [
      "Smallest screen in this comparison at 5.5 inches",
      "No built-in smart home hub like the pricier Echo Show 8"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-smart-displays-under-200",
    "title": "Best Smart Displays Under $200"
  },
  {
...
export const breadcrumbLabel = "Best Smart Displays Under $150";
