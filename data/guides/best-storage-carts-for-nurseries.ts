export const guideSlug = "best-storage-carts-for-nurseries";
export const guideTitle = "8 Best Storage Carts for Nurseries in 2026";
export const metaTitle = "Best Storage Carts for Nurseries";
export const metaDescription = "We compared storage cart nursery models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "storage cart nursery";
export const introParagraphs = [
  "Best Storage Carts for Nurseries aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
...
export const products: GuideProduct[] = [
  {
    id: "best-storage-carts-for-nurseries-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-storage-carts-for-nurseries-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-storage-carts-for-nurseries-3",
    rank: 3,
  ...
  {
    id: "best-storage-carts-for-nurseries-4",
    rank: 4,
  ...
  {
    id: "best-storage-carts-for-nurseries-5",
    rank: 5,
  ...
  {
    id: "best-storage-carts-for-nurseries-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-storage-carts-for-nurseries-7",
    rank: 7,
  ...
  {
    id: "best-storage-carts-for-nurseries-8",
    rank: 8,
