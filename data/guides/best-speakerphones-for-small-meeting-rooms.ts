...
export const faq = [
  {
    "q": "How much pickup radius do I need for a small meeting room?",
    "a": "Buy more than your room's actual dimensions suggest. Stated pickup radius figures assume near-ideal acoustic conditions, a room with hard surfaces or glass walls will perform somewhat below that stated figure in practice."
  },
  {
    "q": "Does mic count matter more than pickup radius for a small room?",
    "a": "Mic count drives how well a device isolates individual voices from each other around a table, pickup radius measures how far away it can hear sound at all. A small room with several people needs both."
  },
  {
    "q": "What pickup pattern works best for a small meeting room?",
    "a": "360° omni pickup suits a small round table, while a more directional pickup pattern can perform better across a narrow rectangular table, match the pattern to your room's actual table shape."
  },
  {
    "q": "Do I need a platform-certified speakerphone for a small meeting room?",
    "a": "If the room is dedicated to one video platform, a certified device offers a stronger tested guarantee. If it hosts calls on multiple platforms, a dual-certified pick like the Jabra Speak2 40 offers more flexibility."
  }
];

export const guideSlug = "best-speakerphones-for-small-meeting-rooms";

export const guideTitle = "The Best Speakerphones for Small Meeting Rooms: Our Picks";
...
export const howWeEvaluated = [
  {
    "title": "Pickup radius as a planning spec, not a guarantee",
    "description": "Noted that stated pickup radius figures assume near-ideal acoustic conditions, and recommended buying with real margin above your room's actual dimensions for rooms with hard surfaces or glass."
  },
  {
    "title": "Mic count for voice isolation, distinct from raw pickup distance",
    "description": "Weighed physical mic count for handling several people around a small table, a different challenge from simply hearing sound from further away, which pickup radius alone measures."
  },
  {
    "title": "Platform certification for whichever software the room actually uses",
    "description": "Checked which picks carry Zoom, Google Meet, or dual certification, relevant to matching a small meeting room's speakerphone to the platform it will actually run."
  }
];

export const introParagraphs = [
  ", 13ft) assumes close-to-ideal acoustic conditions, small meeting rooms with hard surfaces, glass walls, or minimal sound absorption will perform worse in practice, buy a device rated for more radius than your room's actual size to build in real margin.",
...
export const metaDescription = "How 5 speakerphones for small meeting rooms compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Speakerphones for Small Meeting Rooms (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "6 physical microphones handle voice isolation across a small meeting table with several people, a different challenge from simply picking up sound from a distance.\n\nWell-suited to a small dedicated meeting room rather than an open desk, the mic array is built for a table setting.",
    "specs": [
      "6 microphones, Zoom certified",
      "Echo cancellation, background noise reduction",
      "Bluetooth and USB connectivity",
      "Table-centered design"
    ],
    "pros": [
      "6 mics handle a small meeting table with several people",
      "Zoom certified",
      "Strong echo and noise handling"
    ],
    "cons": [
      "Higher price than budget alternatives",
      "Not certified for other platforms beyond Zoom",
      "Bluetooth range may need testing in rooms with interference"
    ],
  ...
  },
  {
    ...
    "description": "An explicit 13ft pickup radius spec, useful for planning around a small meeting room's actual dimensions, remember this assumes near-ideal conditions, so a room with hard surfaces or glass will perform somewhat below that stated figure.\n\n360° omni mic and full-duplex speaker at an affordable price for a dedicated small-room device.",
    "specs": [
      "13ft pickup radius, 360° omni mic",
      "AI noise cancellation, full-duplex",
      "20H call time, Bluetooth 5.3",
      "low-cost"
    ],
    "pros": [
      "Explicit pickup radius spec aids room-size planning",
      "Very affordable for a dedicated small-room device",
      "AI noise cancellation",
      "Long call time"
    ],
    "cons": [
      "Stated radius assumes near-ideal acoustic conditions, build in margin for hard-surface rooms",
      "360° pickup may capture hallway noise near a door"
    ],
  ...
  },
  {
    ...
    "description": "4 noise-cancelling mics suited to a small meeting room's table size, certified for both Zoom and Google Meet if your small room hosts calls on either platform. Full-range 50mm speaker for clear audio playback in an enclosed space.\n\nDual platform certification for Zoom and Google Meet.",
    "specs": [
      "4 noise-cancelling mics, certified for Zoom and Google Meet",
      "USB-An and USB-C connections",
      "Full-range 50mm speaker",
      "Portable design"
    ],
    "pros": [
      "4 mics fit a small meeting room's table size",
      "Dual platform certification for Zoom and Google Meet",
      "Full-range speaker for clear playback in an enclosed room",
      "Both USB-An and USB-C connections"
    ],
    "cons": [
      "Fewer mics than the 6-mic option",
  ...
  },
  {
    ...
    "description": "360° pickup pattern suits a small round table specifically, verify your room's table shape before buying.",
    "specs": [
    ...
    "pros": [
      "Very affordable for a 4-mic small-room design",
    ...
    "cons": [
      ...
      "Fewer premium features than certified alternatives"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B00AQUO5RI?tag=theofficejournal-20",
    "description": "Portable wireless design if the room doubles for other uses.\n\nCertified for both Zoom and Google Meet, flexible for whatever platform your small room's calls run on.",
    "specs": [
      "Wireless Bluetooth, certified for Zoom and Google Meet",
      "Portable conference speaker",
      "Established sound quality reputation",
      "Long track record"
    ],
    "pros": [
      "Highest rating of any pick in this guide",
      "Certified for both Zoom and Google Meet",
      "Portable if the room serves multiple purposes"
    ],
    "cons": [
      "Fewer physical mics than the 6-mic Anker pick",
      "Older design than 2025-edition alternatives",
      "Wireless-only, no wired USB fallback confirmed"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-speakerphones-for-two-person-offices",
    "title": "Best Speakerphones for Two-Person Offices (2026)"
  },
  {
    "href": "/guide/best-noise-canceling-speakerphones",
    "title": "Best Noise-Canceling Speakerphones (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Speakerphones for Small Meeting Rooms";
