...
export const guideTitle = "The Best Network Switches for 10-Inch Racks, Compared";
...
export const introParagraphs = [
  "True 10-inch rack-native switches are rare, most switches are sized for standard 19-inch racks. The practical path for a 10-inch mini rack setup is pairing a compact desktop switch with a purpose-built mounting bracket or shelf.",
...
export const metaDescription = "We compared 7 network switches for 10-inch racks on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Network Switches for 10-Inch Racks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08QDVSWX4?tag=theofficejournal-20",
    ...
    "specs": [
      "24 Gigabit ports, fanless",
      "Desktop, wall, or rack mount",
      "Auto-negotiating with EEE"
    ],
    "pros": [
      "High port count stays fully fanless",
      "Rack-mount option adds real deployment flexibility",
      "Simple zero-touch setup"
    ],
    "cons": [
      "No management, VLANs, or port monitoring",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0779R9LJ3?tag=theofficejournal-20",
    "description": "7 inches to fit a 1U rackmount slot, while its all-metal casing improves heat dissipation and EMI protection over cheaper plastic-cased switches.\n\nIt remains a fully unmanaged, fanless design despite the port count, so it's whisper-quiet even in an enclosed rack. TP-Link backs it with the same 3-year warranty and free technical support as its smaller SG-series models.",
    "specs": [
      "24 Gigabit ports, 1U rackmount",
      "11.6 x 7.1 x 1.7in metal case",
      "Fanless, EMI-shielded"
    ],
    "pros": [
      "True 1U rack fit, not just rack-adjacent",
      "Fanless even at 24 ports",
      "Metal casing improves EMI protection"
    ],
    "cons": [
      "No management features at 24-port scale",
      "Rack ears/kit sold separately on some listings"
    ],
  ...
  },
  {
    ...
    "description": "The TL-SG116 brings TP-Link's Gigabit unmanaged line to 16 ports in the same sturdy fanless metal case, rated for a 0 to 40 degree Celsius operating range that's wider than most desktop switches bother to publish.\n\n1p/DSCP QoS and IGMP Snooping carry over from the smaller models, giving basic multicast and voice/video prioritization without a management interface. Backed by the same 3-year warranty as the rest of the TP-Link SG line.",
    "specs": [
      "16 Gigabit ports, QoS + IGMP snooping",
      "0-40°C rated operation",
      "3-year warranty"
    ],
    "pros": [
      "Wide temperature rating for closets/garages",
      "QoS and IGMP snooping despite unmanaged design",
      "Consistent 3-year warranty across the line"
    ],
    "cons": [
      "No VLAN or web management",
      "Larger footprint than 8-port models"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F4JZ9YJW?tag=theofficejournal-20",
    ...
    "specs": [
      "10-inch, 6U mini rack enclosure",
      "Steel + acrylic construction",
      "Open-frame with translucent panels"
    ],
    "pros": [
      "Purpose-built for 10-inch switches and small networking gear",
      "Open-frame design balances airflow and dust protection",
      "Complete accessory kit included"
    ],
    "cons": [
      "This is an enclosure, not a switch itself",
      "Adds real cost/footprint beyond just buying a switch"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F9DWKZN3?tag=theofficejournal-20",
    "description": "This is a purpose-built mounting bracket, not a switch, designed specifically to fit TP-Link's TL-SG108 into a 10-inch rack, made from 3D-printed PETG plastic with an open design for airflow.\n\n75 inches tall (1U), and 4 inches deep with the switch installed, it's a simple, affordable way to rack-mount an otherwise desktop-only 8-port switch.",
    "specs": [
      "1U rack mount for TL-SG108 specifically",
      "PETG plastic, open design",
      "10in wide x 1.75in tall x 4in deep"
    ],
    "pros": [
      "Purpose-fit for the popular TL-SG108 switch",
      "Affordable way to rack a desktop switch",
      "Open design promotes airflow"
    ],
    "cons": [
      "This is a mounting bracket, not a switch itself",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0H4YRQG38?tag=theofficejournal-20",
    "description": "5G, and Easy Smart variants sharing that same physical form factor.\n\nHeavy-duty powder-coated steel construction outperforms plastic mounts on durability, with tool-free installation and the same standard 10-inch, 1U dimensions for compatibility with any 10-inch mini rack.",
    "specs": [
      "1U metal rack mount, fits TL-SG108 family",
      "Powder-coated steel",
      "Tool-free installation"
    ],
    "pros": [
      "Metal construction outlasts plastic 3D-printed mounts",
      "Fits an entire family of TP-Link switch models, not just one",
      "Tool-free installation with hardware included"
    ],
    "cons": [
      "This is a mounting bracket, not a switch itself",
      "Higher price than the PETG plastic alternative"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-network-switches-for-homelabs",
    "title": "8 Best Network Switches for Homelabs"
  },
  {
    "href": "/guide/best-mini-network-switches",
    "title": "8 Best Mini Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best Network Switches for 10-Inch Racks";
