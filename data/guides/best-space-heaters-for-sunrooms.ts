...
export const guideTitle = "The Best Space Heaters for Sunrooms, Compared";
...
export const metaDescription = "We compared 8 space heaters for sunrooms on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Space Heaters for Sunrooms (2026)";
...
export const breadcrumbLabel = "Best Space Heaters for Sunrooms";
