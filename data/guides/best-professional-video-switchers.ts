export const guideSlug = "best-professional-video-switchers";
export const guideTitle = "8 Best Professional Video Switchers in 2026";
export const metaTitle = "Best Professional Video Switchers";
export const metaDescription = "We compared professional video switcher models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "professional video switcher";
export const introParagraphs = [
  "Best Professional Video Switchers carry very different real specs, which is exactly why an input count rarely tells the story.",
...
export const products: GuideProduct[] = [
  {
    id: "best-professional-video-switchers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-professional-video-switchers-2",
    rank: 2,
  ...
  {
    id: "best-professional-video-switchers-3",
    rank: 3,
    badge: "Best Value",
  ...
  {
    id: "best-professional-video-switchers-4",
    rank: 4,
  ...
  {
    id: "best-professional-video-switchers-5",
    rank: 5,
  ...
  {
    id: "best-professional-video-switchers-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-professional-video-switchers-7",
    rank: 7,
  ...
  {
    id: "best-professional-video-switchers-8",
    rank: 8,
