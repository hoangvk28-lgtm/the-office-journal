export const guideSlug = "best-drawing-tablets-under-90";
export const guideTitle = "8 Best Drawing Tablets Under $90 in 2026";
export const metaTitle = "Best Drawing Tablets Under $90 in 2026";
export const metaDescription = "We compared best drawing tablets under $90 by verified current price and real capability, not just the price ceiling alone.";
export const mainKeyword = "drawing tablets under $90";
export const introParagraphs = [
  "Best Drawing Tablets Under $90 listings span a wide range of real capability even within the same price ceiling, and comparing them on price alone misses which picks actually meet the core use case.",
...
export const products: GuideProduct[] = [
  {
    id: "best-drawing-tablets-under-90-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-drawing-tablets-under-90-2",
    rank: 2,
  ...
  {
    id: "best-drawing-tablets-under-90-3",
    rank: 3,
  ...
  {
    id: "best-drawing-tablets-under-90-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-drawing-tablets-under-90-5",
    rank: 5,
  ...
  {
    id: "best-drawing-tablets-under-90-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-drawing-tablets-under-90-7",
    rank: 7,
  ...
  {
    id: "best-drawing-tablets-under-90-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "Define the upper-value screenless capability floor: Demand stronger active area/shortcuts/wireless; branded pen displays still remain far above. Do not expand the list with products that fail the core category definition just to reach a target number of picks. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
...
export const faq = [
  {
    "q": "What should I check before buying from this best drawing tablets under $90 comparison?",
