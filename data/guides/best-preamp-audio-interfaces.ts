...
export const introParagraphs = [
  "Across best preamp audio interfaces, range widely in real latency, given that differences show up in the fine print.",
...
export const products: GuideProduct[] = [
  {
    id: "best-preamp-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-preamp-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-preamp-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-preamp-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-preamp-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-preamp-audio-interfaces-6",
    rank: 6,
  ...
  {
    id: "best-preamp-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-preamp-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
