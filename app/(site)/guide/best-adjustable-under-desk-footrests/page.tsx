...
import {
  ...
  relatedGuides,
  type GuideProduct,
} from "@/data/guides/best-adjustable-under-desk-footrests";
...
export default async function BestAdjustableUnderDeskFootrestsPage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-adjustable-under-desk-footrests` },
    about: [
      { "@type": "Thing", name: "Adjustable Footrest" },
      { "@type": "Thing", name: "Ergonomics" },
      { "@type": "Thing", name: "Height Adjustment" },
    ],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Adjustable Under-Desk Footrests", item: `${SITE_URL}/guide/best-adjustable-under-desk-footrests` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-adjustable-under-desk-footrests#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Adjustable Under-Desk Footrests</span>
        </nav>
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-5 pt-5 border-t border-border">
            ...
            <div className="flex items-center gap-1.5 text-xs text-ink-muted">
              ...
              8 adjustable under-desk footrests evaluated
            </div>
          </div>
        </header>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Adjustable Under-Desk Footrests" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A fixed-height footrest works well when the desk and chair height never change. For users who adjust their desk height throughout the day, share a desk with another person, or switch between a standard office chair and a drafting stool, a fixed footrest creates a different ergonomic problem every time the setup changes.</p>
          <p>This guide covers eight adjustable under-desk footrests ranked by Amazon buyer rating and verified review count, focusing on models with meaningful height or angle adjustment rather than fixed single-position designs.</p>
          <p>For the full footrest category including fixed-height options, see our <Link prefetch={false} href='/guide/best-under-desk-footrests' className='text-brand hover:underline'>best under-desk footrests</Link> guide.</p>
        </section>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-ink-secondary">
                ...
                <a href="#huanuo-adjustable" className="font-bold text-ink hover:text-brand transition-colors">HUANUO Under Desk Footrest</a>
                 - 10,825 reviews at 4.4 stars, two height settings with massage surface.
              </p>
            </div>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=adjustable+under+desk+footrest&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
