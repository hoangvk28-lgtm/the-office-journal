...
export const faq = [
  {
    "q": "Do individual switches on a power strip control fully independent outlets?",
    "a": "Some budget models group two outlets per switch despite implying full independence, verify the specific product's wiring rather than assuming from the visual presence of multiple switches."
  },
  {
    "q": "Does turning off an individually switched outlet eliminate all standby power?",
    "a": "The strip's own indicator LEDs and any always-on smart or surge-protection circuitry still draw minimal standby power regardless of individual outlet switch states."
  },
  {
    "q": "Are power strip individual switches reliable long-term?",
    "a": "It varies by build quality."
  },
  {
    "q": "Does a switched-off outlet still have surge protection?",
    "a": "It depends on the design. Some strips maintain surge protection on a switched-off outlet, others cut protection along with power, verify this distinction if you plan to leave sensitive equipment plugged into a switched-off outlet."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Verified independent per-outlet switching, not grouped pairs",
    "description": "Checked whether each pick's individual switches control independent outlets rather than budget designs that group two outlets per switch despite implying full independence."
  },
  {
    "title": "Standby phantom power disclosed for the strip's own circuitry",
    "description": "Noted that switched outlets still draw standby power for the strip's own indicator LEDs and any always-on smart or surge-protection circuitry, individual switches don't fully eliminate phantom load for the whole unit."
  },
  {
    "title": "Outlet count and smart ecosystem compatibility compared together",
    "description": "Weighed the number of individually controlled outlets against smart home ecosystem compatibility, since buyers have different priorities between maximum control granularity and ecosystem breadth."
  }
];
...
export const metaDescription = "How 5 power strips with individual switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Power Strips with Individual Switches (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "4 individually smart-controlled outlets alongside 4 always-on outlets, useful for turning off specific devices without cutting power to everything, like a router you want always powered. Works with Alexa and Google Home.\n\nGenuine mix of individually controlled and always-on outlets. On price, it's actually priced above kasa smart Plug Power Strip KP303, which is worth weighing if cost is your deciding factor between the two.",
    "specs": [
      "4 individually controlled outlets, 4 always-on",
      "4 USB ports",
      "Alexa and Google Home compatible",
      "8 outlets total"
    ],
    "pros": [
      "Genuine mix of individually controlled and always-on outlets",
      "Works with Alexa and Google Home",
      "8 total outlets plus 4 USB ports",
      "Reasonable price for the feature set"
    ],
    "cons": [
      "Only half the outlets have individual control",
      "WiFi circuitry itself draws some standby power"
    ],
  ...
  },
  {
    ...
    "specs": [
      "3 fully independent smart outlets",
      "2 USB ports",
    ...
    "pros": [
      ...
      "Established, reliable design"
    ],
    "cons": [
      "Only 3 outlets, fewer than some alternatives",
      "Smart circuitry draws minor standby power regardless",
      "No USB-C port"
    ],
  ...
  },
  {
    ...
    "description": "6 individually controlled outlets, more than the 3-outlet alternatives, from an established brand. Includes a USB-C port among 3 total USB ports.\n\nOn the other side, Standby power for smart circuitry persists regardless of switch states.",
    "specs": [
    ...
    "pros": [
      "6 individually controlled outlets, more than the 3-outlet alternatives",
    ...
    "cons": [
      ...
      "Standby power for smart circuitry persists regardless of switch states"
    ],
  ...
  },
  {
    ...
    "description": "3 individually controlled smart outlets with broad compatibility across Apple HomeKit, Alexa, and Google Home, useful if your household uses a mix of ecosystems. 18W fast USB-C charging included.\n\nThe real tradeoff against that pick: Fewer outlets than the 6-outlet alternatives.\n\nOn the other side, Standby power still draws for smart circuitry.",
    "specs": [
    ...
    "cons": [
      ...
      "Standby power still draws for smart circuitry"
    ],
  ...
  },
  {
    ...
    "description": "6 individually controlled outlets with Matter compatibility, future-proofing your individual switch control across multiple smart home ecosystems. Energy monitoring lets you see draw per switched outlet.\n\nOn the other side, Standby power for smart circuitry persists regardless.",
    "specs": [
      "6 individually controlled outlets",
    ...
    "pros": [
      "6 individually controlled outlets with Matter compatibility",
      "Energy monitoring per switched outlet",
      "Broad smart home ecosystem support",
      "Surge protection included"
    ],
    "cons": [
      "Highest price in this guide",
      "Standby power for smart circuitry persists regardless"
    ],
...
export const breadcrumbLabel = "Best Power Strips with Individual Switches";
