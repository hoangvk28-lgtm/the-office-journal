...
export const guideTitle = "The Best Drawing Tablets for Windows, Compared";
...
export const metaDescription = "We compared 5 drawing tablets for windows on compatibility, build, features and price to help you choose the right one for your space.";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "This is explicitly not a standalone tablet and must connect to a computer, laptop, or Android phone to work. A 10x6 inch active area pairs with a battery-free pen at 8192 pressure levels, and 20 replacement nibs ship included, a generous spare-parts count.\n\nTwelve customizable shortcut keys plus 10 multimedia keys (Windows-only) cover a broad range of workflow shortcuts. Mac users need to grant specific Accessibility, Input Monitoring, and Full Disk Access permissions after installation, a setup detail worth knowing before buying, and it works with Word, Excel, PowerPoint, and major creative software like Photoshop and SAI.",
    "specs": [
      "10x6in area, 8192 pressure levels",
      "12 shortcut keys + 10 multimedia keys (Win only)",
      "20 replacement nibs included"
    ],
    "pros": [
      "20 replacement nibs included is unusually generous",
      "12 shortcut keys plus 10 multimedia keys is a deep set",
      "Works with everyday office apps like Word and Excel too"
    ],
    "cons": [
      "Mac setup requires granting several specific system permissions",
      "Multimedia keys work on Windows only, not Mac"
    ],
...
export const breadcrumbLabel = "Best Drawing Tablets for Windows";
