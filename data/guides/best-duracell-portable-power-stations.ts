...
export const guideTitle = "The Best Duracell Portable Power Stations for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 2 duracell portable power stations, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Duracell Portable Power Stations for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Duracell Portable Power Stations";
