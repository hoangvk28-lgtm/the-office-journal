...
export const guideTitle = "The Best Xiaomi 4K Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 xiaomi 4K monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Xiaomi 4K Monitors for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-4k-monitors-with-webcams",
    "title": "Best 4K Monitors With Webcams in 2026"
  },
  {
    "href": "/guide/best-acer-4k-monitors",
    "title": "Best Acer 4K Monitors in 2026"
  }
];

export const breadcrumbLabel = "Best Xiaomi 4K Monitors";
