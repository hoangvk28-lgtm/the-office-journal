...
export const faq = [
  {
    "q": "How should a school district budget for spare units when deploying interactive whiteboards fleet-wide?",
    "a": "A common approach is keeping 1-2 spare units per building or per 10-15 deployed boards to enable rapid swap during repairs without disrupting classroom schedules, adjust based on your district's repair turnaround time and budget."
  },
  {
    "q": "Does Google Workspace for Education integration require EDLA-certified hardware specifically?",
    "a": "For the most reliable, officially supported integration with stable app-store access and updates, yes, EDLA certification is Google's own enterprise device program specifically designed for this kind of institutional deployment."
  },
  {
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "For district-scale procurement, prioritize boards with documented onsite support contracts (Promethean's 3-year onsite coverage is a genuine standout), EDLA certification for stable long-term Google service access, and standardized specs across the size range you're deploying."
  }
];
...
export const introParagraphs = [
  "School district procurement involves fleets and long refresh cycles, and a single-panel review rarely captures the onboarding, spare-unit strategy, and repair logistics that matter at institutional scale.",
  "We scored district-wide management capability, compared identity ecosystem fit against Google Workspace for Education or Microsoft 365 Education, published warranty and spare-unit strategy considerations, and audited security update and end-of-support policy across this cluster."
];
...
export const metaDescription = "How 8 interactive whiteboards for school compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Interactive Whiteboards for School (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-interactive-whiteboards-for-school-1",
    "rank": 1,
    "badge": "Best Overall School Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-school-2",
    "rank": 2,
    "badge": "Best EDLA-Certified for Google for Education",
  ...
  {
    "id": "best-interactive-whiteboards-for-school-3",
    "rank": 3,
    "badge": "Best Large-Room School Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-school-4",
    "rank": 4,
    "badge": "Best High-Storage School Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-school-5",
    "rank": 5,
    "badge": "Best Value School Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-school-6",
    "rank": 6,
    "badge": "Best for Onsite Support Contracts",
  ...
  {
    "id": "best-interactive-whiteboards-for-school-7",
    "rank": 7,
    "badge": "Best Security Features for Shared Devices",
  ...
  {
    "id": "best-interactive-whiteboards-for-school-8",
    "rank": 8,
    "badge": "Best All-In-One for Budget-Constrained Schools",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-interactive-whiteboards-for-kindergarten",
    "title": "7 Best Interactive Whiteboards for Kindergarten"
  }
];

export const breadcrumbLabel = "Best Interactive Whiteboards for School";
