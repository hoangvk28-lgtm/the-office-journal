...
export const guideTitle = "The Best Thunderbolt SSD RAID Enclosures for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to ACASIS 40Gbps Mac mini M4 Dock with Dual unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const introParagraphs = [
  "Thunderbolt-class RAID enclosures are a professional multi-drive category, where RAID level support, external power, active cooling, and aggregate host-link bandwidth all matter more than on a simple single-bay enclosure.",
...
export const metaDescription = "A practical comparison of 3 thunderbolt SSD RAID enclosures, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Thunderbolt SSD RAID Enclosures for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Thunderbolt SSD RAID Enclosures";
