...
export const guideTitle = "The Best Projectors for Everyday Desk Work";
...
export const metaDescription = "How 6 projectors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Projectors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0H3NHLCJ3?tag=theofficejournal-20",
    ...
    "specs": [
      "Skip the hassle of connecting a tv",
      "Experience exceptional brightness with true 2500 ANSI",
      "Enjoy immersive entertainment on a screen"
    ],
    "pros": [
      "Skip the hassle of connecting a tv",
      "Experience exceptional brightness with true 2500 ANSI",
      "Enjoy immersive entertainment on a screen",
      "Enjoy sharp full HD visuals with support"
    ],
    "cons": [
      "Marketed lumens and true ANSI lumens often differ",
      "Throw ratio needs checking against your room distance"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-4k-projectors",
    "title": "Best 4K Projectors"
  }
];

export const breadcrumbLabel = "Best Projectors";
