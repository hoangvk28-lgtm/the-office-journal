...
export const guideTitle = "The Best 100W Docking Stations for Charging a Laptop Through One Cable";

export const breadcrumbLabel = "Best Docking Stations with 100W Power Delivery";

export const metaTitle = "Best Docking Stations with 100W Power Delivery (2026)";

export const metaDescription = "A 100W dock doesn't always pass 100W to your laptop. We compared eight docks on charging, display outputs, ports and certification, from a compact hub to a Thunderbolt 4 dock.";

export const mainKeyword = "docking station 100w power delivery";

export const introParagraphs = [
  "A dock rated for 100W power delivery is the upper limit of standard USB-C charging to a single laptop, but the rating isn't always what reaches the laptop. Some of the power budget runs the dock itself and any peripherals charging from it, so check whether the listing gives a separate laptop-charging figure.",
  "That makes 100W docks a comfortable match for many thin-and-light laptops, and a compromise for larger laptops whose own chargers are rated well above 100W: they may charge slowly, or not keep up, under heavy load.",
  "Beyond charging, the eight docks here differ in how many displays they drive and at what resolution and refresh rate, in port count, and in whether they are Thunderbolt certified. Our comparison is based on published specifications, not hands-on testing."
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "The Anker Prime is the dock for a desk full of devices: 14 ports and 160W of total output, so a laptop and several USB devices can charge together.\n\nIt supports dual 4K displays, 10Gbps data, Ethernet and audio, and Anker lists compatibility with Dell, HP, Lenovo and other laptops.\n\nThe 160W is a total budget: standard USB-C charging to a single laptop is capped at 100W unless both sides support the newer extended power range. It is large, and costs more than most docks here.",
    "specs": [
      "Total output: 160W",
      "Ports: 14",
      "Displays: dual 4K",
    ...
    "pros": [
      "Most ports here",
      "Headroom for charging peripherals",
      "Dual 4K"
    ],
    "cons": [
      "Laptop charging still limited by USB PD",
      "Large",
      "Costs more than most here"
    ],
    "bestFor": "Charging a laptop plus phones, tablets and accessories at one desk.",
    "summary": "A 14-port dock with 160W total output, dual 4K, 10Gbps data, Ethernet and audio.",
    "skipIf": "You only connect a few devices; the UGREEN 10-in-1 covers the basics for far less."
  },
  {
    "id": "wavlink-13in1-130w-displaylink",
    "rank": 3,
    "badge": "Best for Dual Displays on Base M-Series Macs",
  ...
  },
  {
    ...
    "rank": 4,
    "badge": "Three Displays with Caveats",
  ...
  },
  {
    "id": "acer-11in1-100w",
    "rank": 7,
    "badge": "Best Low-Cost Triple-Display Dock",
    ...
    "description": "The Acer 11-in-1 offers three-monitor support for about $50 at the time of writing, with an 8K DisplayPort output and 4K 60Hz HDMI, plus 100W charging.\n\nIt adds 10Gbps data, Gigabit Ethernet and an SD/TF card reader.\n\nAs with the other USB-C docks, multi-display support depends on your laptop, and it is not Thunderbolt certified.",
    "specs": [
      "Charging: 100W",
      "Displays: 3 (8K DP, 4K@60Hz HDMI)",
      "Data: 10Gbps",
      "Ethernet: Gigabit",
      "Card reader: SD/TF"
    ],
    "pros": [
      "Three displays at a low price",
      "8K DisplayPort output",
      "Ethernet and card reader"
    ],
    "cons": [
      "Not Thunderbolt",
      "Display support depends on laptop",
      "Less established than Plugable or Anker"
    ],
    "bestFor": "A three-monitor setup on a tight budget.",
    "summary": "An 11-in-1 dock with 100W, three monitor outputs including 8K DisplayPort, Ethernet and SD/TF.",
    "skipIf": "You want certified bandwidth; the Plugable Thunderbolt 4 dock provides it."
  },
  {
    "id": "ugreen-7in1-revodok-100w",
    "rank": 8,
    "badge": "Lowest Price, Most Compact",
    ...
    "description": "The UGREEN Revodok Pro is the least expensive option here, about $27 at the time of writing: a compact aluminum 7-in-1 hub with 100W passthrough charging and dual HDMI at 4K 60Hz.\n\nIts USB-A and USB-C data ports run at 10Gbps, and its size suits a small desk or travel bag.\n\nIt has the fewest ports here, with no SD reader or Ethernet.",
    "specs": [
      "Charging: 100W",
      "Displays: dual HDMI 4K@60Hz",
      "Data: 10Gbps USB-A/C",
      "Build: aluminum",
      "7-in-1"
    ],
    ...
    "bestFor": "Travel or a minimal desk with two monitors.",
    "summary": "A compact aluminum 7-in-1 hub with 100W and dual 4K@60Hz HDMI, the lowest price here.",
    "skipIf": "You need wired networking; the UGREEN 10-in-1 adds Ethernet for about $13 more."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Charging",
    "description": "We compared listed power delivery ratings and noted where totals are shared across ports."
  },
  {
    "title": "Displays",
    "description": "We compared output counts, resolution and refresh rate per port, and DisplayLink use."
  },
  {
    "title": "Ports and certification",
    "description": "We compared data speeds, Ethernet, card readers and Thunderbolt certification."
  },
  {
    "title": "Price",
...
export const buyingCriteria = [
  {
    "criterion": "Match charging to your laptop",
    "explanation": "Compare your laptop's charger wattage with the dock's laptop-charging figure. Laptops with chargers well above 100W may charge slowly on any standard 100W dock."
  },
  {
    "criterion": "Check display output per port",
    "explanation": "Look at resolution and refresh rate for each output. The Plugable triple dock, for example, runs one display at 4K 30Hz and two at 1080p."
  },
  {
    "criterion": "Confirm your laptop's display support",
    "explanation": "Many base M-series Macs support one external display natively; DisplayLink docks like the WAVLINK work around that with software."
  },
  {
    "criterion": "Thunderbolt or USB-C",
    "explanation": "Only the Plugable TBT-UDM here is Thunderbolt 4 certified. Its full bandwidth needs a Thunderbolt or USB4 laptop port."
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Two monitors on a base M-series Mac",
          "WAVLINK DisplayLink"
        ],
        [
          "Everyday value",
...
export const faq = [
  {
    "q": "Does a 100W dock charge my laptop at 100W?",
    "a": "Not necessarily. Some of the budget powers the dock and any connected devices. Check whether the listing states a separate laptop-charging figure."
  },
  {
    "q": "Is 100W enough for a large laptop?",
    "a": "It depends on the laptop. If its own charger is rated well above 100W, a 100W dock may charge it slowly or not keep up under heavy load."
  },
  {
    "q": "Can a 160W dock charge a laptop faster?",
    "a": "Not beyond standard USB PD's 100W per device, unless both dock and laptop support the extended power range. A higher total mainly helps charge several devices at once."
  },
  {
    "q": "Why does charging slow with other devices plugged in?",
    "a": "The dock shares its power budget between the laptop and downstream devices."
  },
  {
    "q": "Does the dock's power adapter matter?",
    "a": "Yes. Use the adapter supplied or one rated at least as high as the dock requires; a smaller adapter limits what the dock can deliver."
  }
];

export const bottomLine = [
  "For most USB-C laptops, the UGREEN 10-in-1 covers charging, two 4K displays, Ethernet and a card reader for little money; the Acer 11-in-1 adds a third display, and the Revodok Pro is the compact, lowest-cost option.",
  "For a Thunderbolt laptop, the Plugable TBT-UDM is worth paying more for its certification. The WAVLINK suits base M-series Macs that need two monitors, the Anker Prime a desk full of devices, and the Anker Nano anyone who wants a travel hub too."
];
