...
export const faq = [
  {
    "q": "Will VPN speed match my router's rated Wi-Fi speed?",
    "a": "No, router-based VPN throughput is CPU-limited and frequently far below the rated Wi-Fi or WAN speed, benchmark realistic expectations instead."
  },
  {
    "q": "What's the difference between site-to-site and client VPN support?",
    "a": "Site-to-site lets you securely access your home network remotely, client VPN routing sends your outbound traffic through a commercial VPN provider, they're different features."
  },
  {
    "q": "Does my router need to support a specific VPN protocol?",
    "a": "Yes, verify your VPN provider is compatible with whichever protocol, like WireGuard or OpenVPN, your router supports before buying."
  },
  {
    "q": "What is a VPN kill-switch and do I need one?",
    "a": "It blocks all internet traffic if the VPN connection drops, a relevant privacy feature worth checking for if VPN reliability matters to you."
  }
];

export const guideSlug = "best-wifi-7-routers-with-vpn-support";

export const guideTitle = "The Best Wi-Fi 7 Routers with VPN Support: Our Picks";
...
export const howWeEvaluated = [
  {
    "title": "VPN throughput expectations benchmarked as CPU-limited, not a checkbox",
    "description": "Treated router-based VPN throughput as CPU-limited and frequently below rated Wi-Fi speed, not a simple feature checkbox."
  },
  {
    "title": "Site-to-site vs client VPN routing distinguished explicitly",
    "description": "Distinguished secure remote access into the home network from client VPN routing through a commercial provider, two different use cases."
  },
  {
    "title": "Protocol compatibility checked against common VPN providers",
    "description": "Noted that supported protocols like WireGuard or OpenVPN vary by router and must match a buyer's specific VPN provider."
  },
  {
    "title": "Kill-switch feature availability disclosed where relevant",
    "description": "Flagged kill-switch availability, a relevant privacy spec that blocks traffic if the VPN connection drops, rarely disclosed by competitors."
  }
];
...
export const metaDescription = "How 4 wi-fi 7 routers with VPN support compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Explicitly marketed for VPN compatibility, appropriate for buyers specifically prioritizing router-level VPN support alongside dual-band Wi-Fi 7 and mesh compatibility.\n\nVerify whether your specific commercial VPN provider supports this router's built-in protocol before buying, since 'VPN support' can mean either client routing or site-to-site remote access depending on the feature set.\n\nBalancing that out, router-based VPN throughput is CPU-limited, verify realistic speed expectations.",
    "specs": [
    ...
    "pros": [
      "Explicitly marketed VPN compatibility, not an ambiguous checkbox feature",
      "Mesh compatible for future expansion",
      "Reasonable price for a VPN-focused router"
    ],
    "cons": [
      "Router-based VPN throughput is CPU-limited, verify realistic speed expectations",
      "Verify whether this supports client VPN routing, site-to-site access, or both"
    ],
  ...
  },
  {
    ...
    "description": "An affordable router appropriate for buyers wanting basic VPN client functionality without paying for hardware-accelerated encryption they may not need at typical home usage levels.\n\nWithout hardware VPN acceleration, expect sustained VPN speeds meaningfully below this router's rated Wi-Fi speed under real load, worth confirming this tradeoff matches your expectations before buying.",
    "specs": [
      "Basic VPN client support",
      "Dual-band, no 6GHz radio",
      "4-stream configuration",
      "2x2.5G + 3x1G ports"
    ],
    "pros": [
      "Very affordable for basic VPN client functionality",
      "Adequate for light, occasional VPN use",
      "Keeps 2.4GHz for broader device compatibility"
    ],
    "cons": [
      "Likely lacks hardware VPN acceleration, expect CPU-limited throughput under load",
      "No 6GHz radio limits full Wi-Fi 7 feature set",
      "Verify specific VPN protocol support against your provider before buying"
    ],
  ...
  },
  {
    ...
    "pros": [
      "More CPU headroom than entry-tier budget routers for sustained VPN use",
      "Dual 2.5Gbps ports support faster wired VPN gateway setups",
      "Reasonable mid-range price"
    ],
    "cons": [
      "No 6GHz radio limits full Wi-Fi 7 feature set",
      "Still CPU-limited for VPN throughput, verify real-world speeds",
      "Verify kill-switch feature availability if that matters to your privacy needs"
    ],
  ...
  },
  {
    ...
    "description": "5G ports support a fast wired VPN gateway setup, though as with any router, actual VPN throughput remains CPU-limited rather than determined by the wireless radio's speed.\n\n1-star rating, verify recent reviews.",
    "specs": [
      "VPN client support",
    ...
    "pros": [
      "Genuine tri-band 6GHz radio alongside VPN client functionality",
      "Full 2.5G LAN ports support a fast wired VPN gateway setup",
      "Good option for buyers wanting VPN plus full Wi-Fi 7 wireless capability"
    ],
    "cons": [
      "VPN throughput remains CPU-limited regardless of the wireless radio's speed",
      "Verify supported VPN protocols match your specific provider"
    ],
...
export const breadcrumbLabel = "Best Wi-Fi 7 Routers with VPN Support";
