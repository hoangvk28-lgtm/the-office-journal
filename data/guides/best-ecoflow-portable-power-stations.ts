...
export const guideTitle = "The Best EcoFlow Portable Power Stations for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "EF ECOFLOW Portable Power Station 3600Wh DELTA Pro)",
        "text": "More charges before a recharge, but heavier and bulkier to carry."
      },
      {
        "label": "EF ECOFLOW Portable Power Station RIVER 2)",
...
export const metaDescription = "A practical comparison of 8 EcoFlow portable power stations, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best EcoFlow Portable Power Stations for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      ...
      "80% In just 45 minutes with x-stream ac charging",
      "10Ms ups"
    ],
    "pros": [
      "Power for every scenario",
  ...
  },
  {
    ...
    "specs": [
      "Full charge in 56 min",
      "Flexible expansion up to 5kwh",
      "Durable and reliable for 10 years"
    ],
    "pros": [
      "Full charge in 56 min",
      "Flexible expansion up to 5kwh",
  ...
  },
  {
    ...
    "specs": [
      "3600wh lfp battery capacity",
      "Single delta pro unit packs a 3600w ac output",
  ...
  },
  {
    ...
    "description": "EF ECOFLOW Portable Power Station Delta 2 is a strong alternative worth comparing directly against the top pick. With up to 500w of solar panel input, delta 2 is a solar generator that can be charged while camping, on an RV trip or off-grid.\n\nAgainst EF ECOFLOW Portable Power Station Delta 3 Classic, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The mAh figure on the box is measured at the battery's internal voltage, not the 5V your phone actually charges at, so the real usable charge is meaningfully lower than the advertised number suggests.",
    "specs": [
      "7 X faster charging",
    ...
    "pros": [
      ...
      "Expandable capacity from 1-3kwh",
      "Power almost anything",
      "Up to 500w of solar panel input"
    ],
    "cons": [
      "Real-world output is usually lower than the advertised mAh figure",
      "Capacity above 100Wh needs airline approval or can't fly at all"
  ...
  },
  {
    ...
    "specs": [
      "Groundbreaking x-ganpower, river 3 230 revolutionizes energy efficiency, delivering",
...
export const breadcrumbLabel = "Best EcoFlow Portable Power Stations";
