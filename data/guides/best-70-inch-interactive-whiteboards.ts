...
export const faq = [
  {
    "q": "Are there any current 70-inch interactive whiteboards from major brands?",
    "a": "Verified current 70-inch options are limited compared to the deeper 65 and 75-inch tiers; most major brands standardize their size lineup around those two diagonals instead, leaving 70 inches as a narrower specialty gap."
  },
  {
    "q": "Should I choose 65 or 75 inches if 70-inch options are limited?",
    "a": "Base this on room depth: 65 inches suits rooms under roughly 20 feet deep, while 75 inches better serves rooms from 20-30 feet. Either sits close enough to a hypothetical 70-inch panel that the choice matters more than the exact unavailable diagonal."
  },
  {
...
export const guideTitle = "The Best 70-Inch Interactive Whiteboards for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Current major flat-panel portfolios have standardized around 65 and 75-inch sizes rather than 70 inches specifically. The alternatives here at 65/75 inches offer deeper current product availability and feature selection while covering nearly identical room-fit requirements."
  }
];
...
export const introParagraphs = [
  "70-inch interactive whiteboard searches surface a genuine mix of older interactive-board products and current alternatives, since major current flat-panel portfolios have standardized around the nearby 65 and 75-inch tiers instead.",
  "We created a current-versus-legacy 70-inch product inventory where verifiable, separated older architectures from current 4K self-contained flat panels, and compared exact active area, resolution, and embedded compute against modern 65 and 75-inch alternatives."
];
...
export const metaDescription = "How 7 70-inch interactive whiteboards compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 70-Inch Interactive Whiteboards for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-70-inch-interactive-whiteboards-1",
    "rank": 1,
  ...
  {
    "id": "best-70-inch-interactive-whiteboards-2",
    "rank": 2,
    "badge": "Runner-Up 75-Inch Alternative",
  ...
  {
    "id": "best-70-inch-interactive-whiteboards-3",
    "rank": 3,
    "badge": "Best Value 65-Inch Alternative",
    "name": "65in 4K Smart Board (20-Point Touch)",
    "price": "$1,549.00",
    "rating": null,
    "reviews": null,
    "imageUrl": "https://m.media-amazon.com/images/I/51tREqASFRL._SL500_.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0GQZMFVPV?tag=theofficejournal-20",
    ...
    "pros": [
      "Straightforward 20-point touch without unnecessary complexity",
      "Built-in camera and mic cover conferencing without extras",
  ...
  {
    "id": "best-70-inch-interactive-whiteboards-4",
    "rank": 4,
    "badge": "Best Dual-OS 75-Inch Alternative",
  ...
  {
    "id": "best-70-inch-interactive-whiteboards-5",
    "rank": 5,
    "badge": "Best Overall 65-Inch Alternative",
  ...
  {
    "id": "best-70-inch-interactive-whiteboards-6",
    "rank": 6,
    "badge": "Best AI Camera 55-Inch Alternative",
  ...
  {
    "id": "best-70-inch-interactive-whiteboards-7",
    "rank": 7,
    "badge": "Best Security-Focused 55-Inch Alternative",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-75-inch-interactive-whiteboards",
    "title": "7 Best 75-Inch Interactive Whiteboards"
  },
  {
...
export const breadcrumbLabel = "Best 70-Inch Interactive Whiteboards";
