...
export const metaDescription = "How 3 standing desk converters under $300 compare on size, height range, stability and features, with clear notes on who each one suits.";

export const metaTitle = "Best Standing Desk Converters Under $300 (2026)";
...
export const breadcrumbLabel = "Best Standing Desk Converters Under $300";
