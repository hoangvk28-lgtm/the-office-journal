...
export const guideTitle = "The Best Dyson Desk Fans for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Dyson HushJet Mini Bladeless Personal Fan (Ink/Cobalt))",
...
export const metaDescription = "A practical comparison of 7 dyson desk fans, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Dyson Desk Fans for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Dyson hushjet mini personal fan engineered with hushjet technology for powerful",
      "Delivers airflow speeds up to 25 m/s (55 mph)1 with a high-speed 65,000 rpm",
      "Quiet comfort"
    ],
    "pros": [
      "Dyson hushjet mini personal fan engineered with hushjet technology for powerful",
  ...
  },
  {
    ...
    "description": "Dyson Purifier Cool PC2 De-NOx is the premium option here, positioned above the rest on price.\n\n9, a detail worth checking closely before choosing between this and Dyson Purifier Cool PC1.\n\nThis one is the right call if you are willing to spend the most in this comparison for the fuller feature set that comes with it. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    "specs": [
      "Advanced air purification automatically captures 50% more no2.8",
      "Fully sealed, 3-stage HEPA h13 grade filtration captures 99.97% of particles as small as 0.3 microns.3",
  ...
  },
  {
    ...
    "specs": [
      ...
      "Remote control is curved and magnetized to store neatly on your Dyson cool tower fan"
    ],
    "pros": [
      "Air multiplier technology amplifies the surrounding air, giving an uninterrupted stream of smooth airflow",
      "10 precise airflow settings",
      "Remote control is curved and magnetized to store neatly on your Dyson cool tower fan",
      "Sleep timer can be programmed to turn off after pre-set intervals"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
  ...
  },
  {
    ...
    "description": "Dyson Hot+CoolTM HF1 Rapid React heater fan (White/Silver) is a strong alternative worth comparing directly against the top pick. Dyson's quietest, most powerful heater and cooling fan for all season comfort. 1 increases your whole room temperature by one degree in as little as 3 minutes.\n\nSide by side with Dyson Purifier Cool PC1, the real difference worth noting is safe for you, your family and your pets.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    "specs": [
      "Dyson's quietest, most powerful heater and cooling fan for all season comfort",
      "Precisely monitors and reacts for faster whole room heating.1",
    ...
    "pros": [
      ...
      "Precisely monitors and reacts for faster whole room heating.1",
      "Safe for you, your family and your pets",
      "Quieter than a whisper at only 26db in sleep mode"
    ],
    "cons": [
      "USB-powered models cap out at lower airflow than AC-plugged fans",
      "Noise rating usually reflects the lowest speed, not daily use"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Lightweight and portable",
      "Multiple speeds",
      "Bladeless design for enhanced user safety"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
...
export const breadcrumbLabel = "Best Dyson Desk Fans";
