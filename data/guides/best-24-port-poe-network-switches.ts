...
export const guideTitle = "The Best 24-Port PoE Network Switches for a Better Desk Setup";
...
export const metaDescription = "We compared 5 24-port PoE network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 24-Port PoE Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07Z8P4JZ2?tag=theofficejournal-20",
    ...
    "specs": [
      "24 ports, 16x PoE+ @190W total",
      "Dynamic PoE allocation",
      "Desktop or rack mount"
    ],
    "pros": [
      "190W budget solid for 16 PoE+ ports",
      "Mix of PoE and non-PoE ports fits real deployments",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B082KNP2Y6?tag=theofficejournal-20",
    "description": "3af/at, supporting bandwidth up to 16Gbps, with each port capable of delivering up to 30W simultaneously across the fleet.\n\nVLAN isolation across ports 1-24 reduces network traffic and improves security, while a rack-mountable design with industrial fan cooling and bilateral heat dissipation handles the thermal load of the higher power budget.",
    "specs": [
      "24x PoE ports @400W total, 2 uplinks",
      "VLAN isolation on all PoE ports",
      "Rack-mountable, industrial fan cooling"
    ],
    "pros": [
      "400W budget is substantial for 24 ports",
      "VLAN isolation baked into an unmanaged switch",
      "Rack-mountable for closet or server room installs"
    ],
    "cons": [
      "Active fan cooling, not silent",
      "Does not support passive PoE devices"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08CQPGXZB?tag=theofficejournal-20",
    "description": "The GS524PP delivers a 300W PoE+ budget across 24 ports in NETGEAR's familiar fanless zero-configuration design, appropriate for larger camera or AP fleets that need real power headroom without a management interface.\n\n3az energy efficiency reducing running costs on non-PoE traffic.",
    "specs": [
      "24x PoE+ ports @300W total",
      "Desktop or rack mount",
      "Fanless, unmanaged"
    ],
    "pros": [
      "300W budget comfortably covers 24 PoE+ ports",
      "Fanless despite the high power delivery",
      "Zero configuration required"
    ],
    "cons": [
      "No management interface for troubleshooting",
      "Premium price for the PoE budget"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-16-port-poe-network-switches",
    "title": "5 Best 16-Port PoE Network Switches in 2026"
  },
  {
    "href": "/guide/best-48-port-poe-network-switches",
    "title": "4 Best 48-Port PoE Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best 24-Port PoE Network Switches";
