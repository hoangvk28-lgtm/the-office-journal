...
export const guideTitle = "The Best Oscillating Space Heaters for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Space Heater, WINHL Portable Electric Heaters for Indoor Use, 70°Oscillation)",
...
export const metaDescription = "How 8 oscillating space heaters compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Oscillating Space Heaters for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Oscillating Space Heaters";
