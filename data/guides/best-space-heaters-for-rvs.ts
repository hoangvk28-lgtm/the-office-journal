...
export const guideTitle = "The Best Space Heaters for RVs, Compared";
...
export const metaDescription = "We compared 7 space heaters for RVs on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Space Heaters for RVs (2026)";
...
export const breadcrumbLabel = "Best Space Heaters for RVs";
