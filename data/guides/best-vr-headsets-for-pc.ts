...
export const guideTitle = "The Best VR Headsets for PC: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 6 VR headsets for PC, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best VR Headsets for PC (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-12k-vr-headsets",
    "title": "Best 12K VR Headsets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best VR Headsets for PC";
