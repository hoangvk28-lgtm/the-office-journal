...
export const guideTitle = "The Best Office Tape Dispensers for a Better Desk Setup";
...
export const metaDescription = "We compared 6 office tape dispensers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Office Tape Dispensers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Features a black",
      "Dispenser includes a non-skid base to hold in place",
    ...
    "pros": [
      ...
      "Dispenser includes a non-skid base to hold in place",
      "Tape sold separately",
      "Try other quality products from scotch brand for all your needs in the home and office"
    ],
    "cons": [
      "One-handed claims need real base weight to back them up",
      "Core spindle width is sized for a specific tape range"
...
export const breadcrumbLabel = "Best Office Tape Dispensers";
