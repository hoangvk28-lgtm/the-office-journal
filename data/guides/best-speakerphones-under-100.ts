...
export const buyingCriteria = [
  ...
  {
    "criterion": "A Built-In USB Hub Solves a Different Problem Than a Speakerphone's Core Audio Function",
...
export const faq = [
  {
    "q": "Can the Anker PowerConf's device-charging feature charge a laptop, or just smaller devices like a phone?",
    "a": "The PowerIQ charging technology is generally optimized for smaller devices like phones rather than laptops, which typically require higher power delivery than a speakerphone's charging port can provide."
  },
  {
    "q": "What's the most common mistake buyers make when choosing between corded and wireless speakerphones at this tier?",
    "a": "Paying extra for battery-powered wireless portability on a speakerphone that will realistically never leave one desk, when a corded pick like the Jabra Speak 410 delivers the same call quality for a similar or lower price without any charging maintenance."
  },
  {
    "q": "Is the Anker PowerConf worth it over the cheaper Jabra Speak 510?",
    "a": "If you specifically need the largest mic array, longest battery life, or device-charging capability, yes, but if lightweight portability and fast setup matter more, the Jabra Speak 510 covers that for about $11 less."
  },
  {
    "q": "Does the Q95mini's built-in USB hub slow down data transfer to connected devices?",
    "a": "For typical peripherals like a mouse or keyboard, no noticeable slowdown occurs, though checking the hub's specific USB version in the listing is worth doing if you plan to transfer large files through a connected drive."
  },
  {
    "q": "Can the Jabra Speak 410's corded design still be used while traveling?",
    "a": "Yes, its slim design with integrated cable management and included carrying case supports travel use, though it still requires an available USB port at your destination since it has no battery-powered standalone mode."
  },
  {
    "q": "Do any of these picks support connecting to more than one device at the same time?",
    "a": "The Anker PowerConf and Jabra Speak 510 support Bluetooth pairing alongside their wired options, giving more multi-device flexibility than the fully corded Jabra Speak 410 or Q95mini, which are limited to their single wired connection."
  }
];

export const guideSlug = "best-speakerphones-under-100";

export const guideTitle = "The Best Speakerphones Under $100: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "The largest mic array and longest battery life",
          "Anker PowerConf Speakerphone, Zoom Certified with 6 Mics"
        ],
        [
          "A lightweight, fast-setup travel speakerphone",
          "Jabra Speak 510 (2025 Edition) Portable USB or Bluetooth"
        ],
        [
          "Zero battery or pairing concerns with wired reliability",
          "Jabra Speak 410 Corded Speakerphone"
        ],
        [
          "Built-in USB hub functionality for limited ports",
          "Q95mini Conference Speaker with Built-in USB Hub"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Corded (Jabra Speak 410, Q95mini)",
        "text": "Removes battery and pairing concerns entirely, staying reliably connected as long as a USB port is available, ideal for a fixed desk setup."
      },
      {
        "label": "Battery-powered wireless (Anker PowerConf, Jabra Speak 510)",
        "text": "Adds portability and freedom from cables, better for a speakerphone that moves between rooms or travels with you."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Larger room needing maximum mic coverage",
          ""
        ],
        [
          "",
        ...
        [
          "Fixed desk with Skype for Business use",
          ""
        ],
        [
          "Desk setup low on available USB ports",
          ""
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A speakerphone with a built-in USB hub, letting it double as a port expander rather than consuming one of your limited available ports."
      },
      {
        "label": "",
        "text": "The Q95mini pick's built-in USB hub specifically solves the limited-port problem by letting you connect additional peripherals through the speakerphone itself."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You need the largest mic array, longest battery life, and the ability to charge other devices, where the Anker PowerConf delivers all three at the top of this tier."
      },
      {
        "label": "",
        "text": "You just need reliable wired connectivity without wireless features, where the Jabra Speak 410 covers that for about $10 less."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared mic count and pickup pattern across the lineup, from single-mic to 6-mic arrays."
  },
  {
    "title": "",
    "description": "Distinguished always-connected corded designs from battery-powered Bluetooth options."
  },
  {
    "title": "",
    "description": "Compared stated battery capacity, call time, and any device-charging capabilities."
  },
  {
    "title": "",
    "description": "Checked for established brand names and formal platform certifications like Zoom or Teams."
  },
  {
    "title": "",
    "description": "Compared standout features like built-in USB hubs or device charging not found on every pick."
  }
];
...
export const metaDescription = "A practical comparison of 4 speakerphones under $100, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Speakerphones Under $100 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07ZNT7PRL?tag=theofficejournal-20",
    "description": "0 technology uses AI deep learning to reduce noise, cancel echo, and detect multiple speakers simultaneously. Its 5,200mAh battery delivers 24 hours of call time, the longest stated battery life in this tier.\n\nCompared to the Jabra picks below, this one adds Zoom certification specifically alongside broad platform compatibility, and its built-in Anker PowerIQ technology lets you charge other devices through the speakerphone itself, a dual-purpose feature none of the other picks offer. Automatic voice balancing compensates for volume and distance differences between speakers.\n\nBest for buyers who want the largest mic array and longest battery life in this tier.",
    "specs": [
      "6-mic array, 360 degree pickup",
      "5,200mAh battery, 24 hour call time",
      "Zoom certified, PowerIQ device charging"
    ],
    "pros": [
      "Largest 6-microphone array in this comparison",
      "24 hour battery life, longest in this tier",
      "Can charge other devices via built-in PowerIQ technology"
    ],
    "cons": [
      "No corded option like the Jabra Speak 410",
      "Larger size than the compact Jabra Speak 510"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FC33QDMX?tag=theofficejournal-20",
    ...
    "specs": [
      ...
      "Portable, travel-focused design",
      "Works with Microsoft Teams and other platforms"
    ],
    "pros": [
      "Portable design built specifically for travel and on-the-go use",
      "Works with Microsoft Teams and other major platforms",
      "Setup takes seconds with no complex configuration"
    ],
    "cons": [
      "Fewer stated microphones than the Anker PowerConf's 6-mic array",
      "No stated battery capacity figure like the Anker pick"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B004ELA7TA?tag=theofficejournal-20",
    "description": "This unit's integrated USB cable eliminates any battery or Bluetooth pairing concerns entirely, connecting directly and reliably to any available USB port, a different approach from the wireless-focused picks in this comparison. Its 360 degree microphone picks up sound at all angles with outstanding stated sound quality for softphone use.\n\nCompared to the Jabra Speak 510 pick above, this one skips Bluetooth entirely in favor of a simpler, always-connected corded design optimized specifically for Microsoft Skype for Business. The slim, compact design with integrated cable management and a carrying case still supports occasional travel despite being corded.\n\nBest for buyers who want zero battery or pairing concerns with an always-reliable wired connection.",
    "specs": [
      "360 degree mic, integrated USB cable",
      "Optimized for Microsoft Skype for Business",
      "Slim design with cable management, carrying case"
    ],
    "pros": [
      "Corded design eliminates battery and pairing concerns entirely",
      "Always-on connection with no charging required",
      "Slim, compact design still travels well despite being corded"
    ],
    "cons": [
      "No wireless Bluetooth option, unlike the other three picks",
      "Requires an available USB port at all times to function"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-speakerphones-under-75",
    "title": "Best Speakerphones Under $75"
  },
  {
...
export const breadcrumbLabel = "Best Speakerphones Under $100";
