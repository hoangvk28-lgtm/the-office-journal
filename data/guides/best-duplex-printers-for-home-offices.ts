...
export const faq = [
  ...
  },
  {
    ...
    "a": "The automatic duplex mechanism on most printers is built for standard weight paper, roughly 20-24 lb, and cardstock or heavier stock typically can't go through that path without jamming."
  },
  {
...
export const guideTitle = "The Best Duplex Printers for Home Offices: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to monochrome for text-heavy home office use unless color output matters."
  },
  {
    "subheading": "",
    "table": {
...
export const introParagraphs = [
  ...
  "Below are 8 printers we compared specifically for duplex print capability, distinguishing confirmed duplex printing from picks where the listing doesn't explicitly state it, so you're not guessing at a feature that may not be there."
];
...
export const metaDescription = "How 8 duplex printers for home offices compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Duplex Printers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "This is the only confirmed duplex laser printer in this list, its listing explicitly names duplex printing alongside copy and scan. Laser duplex mechanisms tend to handle sustained two-sided printing more reliably at volume than inkjet duplex paths.\n\nAs a monochrome-only printer, it's built for text-heavy home office documents rather than color output. A Refresh Subscription toner trial is included, and it works with Alexa for voice-triggered print jobs.",
    "specs": [
      "Confirmed duplex printing",
  ...
  },
  {
    ...
    "description": "The standard OfficeJet Pro 8125 shares the confirmed duplex printing and ADF combination of the 8125e above at a similar price point. A 3-month Instant Ink trial is included, and it's built for consistent home-office print volume rather than occasional use.\n\nExpect the same real-world duplex speed penalty as any two-sided printing on this platform, the printer pauses to flip each sheet, so budget more time for a large duplex job than the single-sided rated speed suggests.\n\nADF included for document scanning too.",
    "specs": [
      "Confirmed duplex printing",
      "Automatic document feeder",
      "3-month Instant Ink trial included",
    ...
    "bestFor": "Home offices wanting confirmed duplex printing"
  },
  {
  ...
  },
  {
    ...
    "description": "8-inch color display and manual feed slot for envelopes and cardstock, but doesn't explicitly confirm duplex printing in the title. Its ink-tank system and Refresh Subscription trial are solid features on their own.\n\nWe're including it as a secondary alternative given its manual feed slot flexibility, not as a confirmed duplex pick. If two-sided printing is a useful, verify this specific spec on the full product listing before purchasing.\n\nInk-tank system reduces per-page cost over time.",
    "specs": [
  ...
  },
  {
    ...
    "description": "7-inch color touchscreen, a useful feature for double-sided documents. It's worth noting that duplex printing and duplex scanning are different capabilities, and the title here specifically confirms the scan and copy side rather than stating duplex printing outright.\n\nIf duplex printing specifically is your requirement, confirm that spec on the full product page rather than assuming it from the 2-sided copy and scan claim alone. The confirmed duplex scan and copy feature on its own is still a real time-saver for double-sided paperwork.",
    "specs": [
...
export const relatedGuides = [
  {
    "href": "/guide/best-all-in-one-printers-for-home-use",
...
export const breadcrumbLabel = "Best Duplex Printers for Home Offices";
