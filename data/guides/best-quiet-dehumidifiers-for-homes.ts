...
export const guideTitle = "The Best Quiet Dehumidifiers for Homes: Our Picks";
...
export const metaDescription = "How 8 quiet dehumidifiers for homes compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Quiet Dehumidifiers for Homes (2026)";
...
export const breadcrumbLabel = "Best Quiet Dehumidifiers for Homes";
