...
export const guideTitle = "The Best Curved Gaming Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Sceptre Curved 24-inch Gaming Monitor 1080p R1500 98% SRGB HDMI x2 VGA Build-in)",
...
export const metaDescription = "A practical comparison of 6 curved gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Curved Gaming Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Curved Gaming Monitors";
