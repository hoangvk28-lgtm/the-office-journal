...
export const guideTitle = "The Best Dell Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 1 dell network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Dell Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CM9N3FTL?tag=theofficejournal-20",
    ...
    "specs": [
      "32x 40Gb QSFP+ ports, renewed",
      "Dual power supply redundancy",
      "Data-center-class switching"
    ],
    "pros": [
      "Massive 40Gb port density at renewed pricing",
      "Dual PSU redundancy for critical infrastructure",
      "Genuine Dell enterprise hardware"
    ],
    "cons": [
      "Renewed condition, verify support/licensing",
      "Overkill and power-hungry for typical SMB or home use"
    ],
...
export const breadcrumbLabel = "Best Dell Network Switches";
