...
export const guideTitle = "The Best Dimmable Ring Lights for a Better-Lit Workspace";
...
export const metaDescription = "We compared 8 dimmable ring lights on brightness, color temperature, adjustability and power to help you choose the right one for your space.";

export const metaTitle = "Best Dimmable Ring Lights for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Uniform & eye-caring soft ring light",
      "Fully adjustable brightness & color temperature",
      "Ergonomic height & flexible rotation"
    ],
    "pros": [
      "Uniform & eye-caring soft ring light",
      "Fully adjustable brightness & color temperature",
      "Ergonomic height & flexible rotation",
      "Stable anti-scratch base"
    ],
    "cons": [
      "Listed lux ratings are often inflated 2 to 3x by the brand",
      "Larger diameter alone doesn't guarantee brighter, more even light"
  ...
  },
  {
    ...
    "specs": [
      ...
      "Full screen ring light kit for desk",
...
export const breadcrumbLabel = "Best Dimmable Ring Lights";
