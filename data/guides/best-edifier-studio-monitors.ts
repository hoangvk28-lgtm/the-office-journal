...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    specs: ["Based on the highly rated edifier bookshelf", "1\" silk dome tweeter and 4\" composite", "1/4\" balanced TRS input, an unbalanced RCA"],
    pros: ["Based on the highly rated edifier bookshelf", "1\" silk dome tweeter and 4\" composite", "1/4\" balanced TRS input, an unbalanced RCA", "Thoughtful dual mode design - freely switch"],
    cons: ["Room acoustics affect the sound more than the speaker", "Stands or isolation pads are usually a separate purchase"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
  ...
  },
  {
    ...
    description: "Edifier MR4.5 Bi-Amped Studio Monitor is a strong alternative worth comparing directly against the top pick. 80w rms total power (30w×2 + 10w×2) with 4.5\" mid-bass drivers and 1\" silk dome tweeters. Independent high control (±6db above 10khz) and low control (±6db below 125hz).\n\nMultiple inputs & bluetooth 6.0: balanced XLR, balanced TRS, RCA, aux, plus front headphone jack, a detail worth checking closely before choosing between this and Edifier MR3 Powered Studio Monitor Speakers.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Room acoustics and speaker placement affect the sound as much as the monitor itself, so treat the room before blaming the gear.",
    specs: ["Studio-grade sound accuracy", "Precision tuning controls", "Multiple inputs & bluetooth 6.0: balanced XLR"],
    pros: ["Studio-grade sound accuracy", "Precision tuning controls", "Multiple inputs & bluetooth 6.0: balanced XLR", "Compact size for any placement"],
    cons: ["Room acoustics affect the sound more than the speaker", "Stands or isolation pads are usually a separate purchase"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
  ...
  },
  {
    ...
    description: "Edifier MR4.5 Bi-Amped Studio Monitor is a strong alternative worth comparing directly against the top pick. 80w rms total power (30w×2 + 10w×2) with 4.5\" mid-bass drivers and 1\" silk dome tweeters. Independent high control (±6db above 10khz) and low control (±6db below 125hz).\n\nHeld up against Edifier MR3 Powered Studio Monitor Speakers, both cover the basics equally well, what actually separates them is multiple inputs & bluetooth 6.0: balanced XLR, balanced TRS, RCA, aux, plus front headphone jack.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Room acoustics and speaker placement affect the sound as much as the monitor itself, so treat the room before blaming the gear.",
    specs: ["Studio-grade sound accuracy", "Precision tuning controls", "Multiple inputs & bluetooth 6.0: balanced XLR"],
    pros: ["Studio-grade sound accuracy", "Precision tuning controls", "Multiple inputs & bluetooth 6.0: balanced XLR", "Compact size for any placement"],
    cons: ["Room acoustics affect the sound more than the speaker", "Stands or isolation pads are usually a separate purchase"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Powered (e.g. Edifier MR3 Powered Studio Monitor Speakers)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You're mixing professionally and need maximum headroom and detail, where Edifier MR5 2.0 Studio Monitor Bookshelf Speakers justifies the higher price."
      },
      {
        "label": "Save if",
        "text": "You're just starting out and want genuinely capable sound without overspending, where Edifier R1280T Powered Bookshelf Speakers already covers the job."
      }
    ]
  }
];
