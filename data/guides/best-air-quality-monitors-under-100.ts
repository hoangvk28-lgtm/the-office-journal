...
export const guideTitle = "The Best Air Quality Monitors Under $100: Our Picks";
...
export const metaDescription = "How 6 air quality monitors under $100 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Air Quality Monitors Under $100 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "ZEMEOLLO Air Quality Monitor Indoor is the most affordable pick here that still clears the capability floor for this category. 5 and pm10 with an error margin of less than ±5%. The monitor is equipped with a high-definition color display screen, which presents real-time detection data in a clear and intuitive layout.\n\nAir Quality Monitor Indoor is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nIt's worth picking this one if you want a capable pick without paying for headroom you won't use. 5 sensors typically run a few micrograms off from reference-grade lab monitors and can drift further after a year or two of use, so treat the number as a useful trend, not a lab-certified reading.",
    "specs": [
  ...
  },
  {
    ...
    "description": "BREATHE Airmonitor Plus Indoor Air Quality Monitor w/CO2 is the premium option here, positioned above the rest on price. & 6-Hour battery: the latest breathe airmonitor plus gen 2 features upgraded battery performance with up to 6 hours of portable use, plus 90-day app data history and data export. 5, pm10, tvoc, formaldehyde (hcho), temperature and humidity in real time.\n\nAir Quality Monitor Indoor is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nThis makes sense for anyone who are willing to spend the most in this comparison for the fuller feature set that comes with it. A VOC or TVOC reading tells you total volatile compound levels rose or fell, not which specific chemical caused it, so don't expect it to identify the actual source the way a dedicated formaldehyde or CO sensor can.",
    "specs": [
...
export const breadcrumbLabel = "Best Air Quality Monitors Under $100";
