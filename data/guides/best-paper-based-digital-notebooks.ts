...
export const faq = [
  {
    "q": "Is this different from your \"feels like paper\" guide?",
    "a": "That guide covers E Ink tablets with a screen. This one covers real paper pages captured with a scanning app, which is a different product category."
  },
  {
    "q": "How reliable is the scan-to-app capture?",
    "a": "We used review count as the best evidence available, since that's where quirks in this workflow would surface."
  },
  {
    "q": "Do I need a special pen?",
    "a": "Yes, Pilot FriXion pens are required for the pages to erase correctly."
  },
  {
  ...
  {
    "q": "Can I get planner templates with real-paper capture?",
    "a": "Yes, the Fusion and Fusion Plus lines include built-in planner and calendar templates alongside capture pages."
  }
];

export const guideSlug = "best-paper-based-digital-notebooks";

export const guideTitle = "The Best Paper-Based Digital Notebooks for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "Real paper as the writing surface",
    "description": "We only included products where the actual pages are physical paper, captured via a scanning app, rather than E Ink tablets that merely visually resemble paper."
  },
  {
    "title": "Capture reliability via review volume",
    "description": "Since the app-based scan step is where real-paper capture can fail (missed pages, poor OCR), we weighted review count heavily as the best available evidence."
  },
  {
    "title": "",
    "description": "We noted which products are Fusion (built-in planner templates) versus Core (plain dot-grid), since that changes what kind of capture workflow each is suited for."
  },
  {
    "title": "Price against proven track record",
    "description": ""
  }
];

export const introParagraphs = [
  "\"Paper-based digital notebook\" is a different product category from the E Ink tablets in our feel-like-paper guide: these use real paper pages, and the \"digital\" part comes from scanning the page into an app, not from a screen. Every current result for this search is a Rocketbook.",
...
export const metaDescription = "A practical comparison of 5 paper-based digital notebooks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Paper-Based Digital Notebooks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Letter size, real paper pages",
      "Scan-to-app capture via Rocketbook app"
    ],
    "pros": [
      "Combines planner templates with free-write capture pages"
    ],
    "cons": [
      "Requires the Rocketbook app and a FriXion pen to work as intended",
  ...
  },
  {
    ...
    "description": "On the other side, Smaller page means less capture area before you need to erase.",
    "specs": [
      "6 x 8.8 in",
      "Scan-to-app capture via Rocketbook app"
    ],
    ...
    "cons": [
      "Smaller page means less capture area before you need to erase"
    ],
  ...
  },
  {
    ...
    "description": "On the other side, No planner templates, plain pages only.",
    "specs": [
      "Mini spiral-bound",
      "Scan-to-app capture via Rocketbook app"
    ],
    ...
    "cons": [
      "Small page limits how much can be captured per page",
      "No planner templates, plain pages only"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Full-size writing area",
      "No pre-built templates if you want a blank canvas"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "The newer template revision of the Fusion line at Executive size, with real-paper capture and updated page layouts.\n\nOn the other side, Costs more than the standard Fusion Hybrid.",
    "specs": [
      "6 x 8.8 in",
      "Fusion Plus template revision"
    ],
    "pros": [
      "Newest template set in the lineup",
      "Same proven capture technology as the rest of the Fusion line"
    ],
    "cons": [
      "Costs more than the standard Fusion Hybrid"
    ],
...
export const breadcrumbLabel = "Best Paper-Based Digital Notebooks";
