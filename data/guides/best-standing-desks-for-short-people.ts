...
export const faq = [
  {
    "q": "How do I calculate the right standing desk height for a short person?",
    "a": "5 and add 1, which estimates the desk height that keeps your elbows near 90 degrees while typing standing. 3 as the result of that formula, used as a starting point for the desk's typing surface height. Fine-tune from there based on how it feels."
  },
  {
    "q": "Do all standing desks go low enough for shorter users?",
    "a": "Many standard standing desks have a minimum height around 28 to 29 inches, which can still feel too high for users under about 5'2\". Desks with a 3-stage frame, or dedicated low-height models, reach lower minimum settings than typical 2-stage electric desks."
  },
  {
    "q": "Why does my keyboard tray feel too low when my desk is set for my height?",
    "a": "At a desk set near its lowest setting, around 22 inches, a keyboard tray mounted underneath can drop to 18 to 20 inches, below the roughly 23-inch height that's comfortable for typing. If you're using a desk set unusually low, consider skipping the tray and typing directly on the desktop instead."
  },
  {
    "q": "Do I need a monitor arm if I'm short and my desk is set low?",
    "a": "When the desk surface sits low to match a shorter user's ergonomic typing height, a monitor resting directly on the desktop can end up below eye level, forcing the neck to bend down. A monitor arm raises the screen independently of the desk height and avoids that strain."
  },
  {
    "q": "Can I just use a desk converter instead of buying a new standing desk?",
    "a": "Yes, if your existing desk is already at a comfortable seated height for you. A converter sits on top of your current desk and lifts a monitor or laptop for standing use, which avoids the problem of a full standing-desk frame not reaching low enough, since your existing desk sets the base height."
  }
];

export const guideSlug = "best-standing-desks-for-short-people";

export const guideTitle = "The Best Standing Desks for Short People, Compared";

export const heroImage = "/images/guides/best-standing-desks-for-short-people/hero.webp";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to Techni Mobili Sit unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We prioritized desks and converters with the lowest stated minimum height, since that's the binding constraint for shorter users, not maximum standing height."
  },
  {
    "title": "",
    "description": "Electric desks were assessed on memory preset count for shared-desk convenience; manual desks were assessed on adjustment ease."
  },
  {
    "title": "",
    "description": "We weighed desktop width against typical small-room space, since compact desks suited to short users often trade surface area for a lower frame."
  },
  {
    "title": "",
    "description": "Dual-motor and 3-stage frames were favored for steadier lift at low settings versus single-motor 2-stage frames."
  },
  {
    "title": "",
    "description": "Price was weighed against verified Amazon rating volume and consistency across each listing."
  }
];

export const lastUpdated = "2026-07-25";

export const metaDescription = "We compared 8 standing desks for short people on size, height range, stability and features to help you choose the right one for your space.";

export const metaTitle = "Best Standing Desks for Short People (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "imageUrl": "/images/guides/best-standing-desks-for-short-people/ergear-low-height-kids.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0GDDH14P5?tag=theofficejournal-20",
    ...
    "pros": [
      "Lowest minimum height in this guide",
      "Electric height adjustment",
      "Compact top for tight rooms"
    ],
    "cons": [
      "Small review count so far",
      "Compact top limits dual-monitor setups",
      "Lower weight capacity than full-size desks"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-standing-desks-for-short-people/huanuo-32-small-electric.jpg",
    ...
    "pros": [
      "4 memory presets for shared use",
      "Strong review count",
      "Compact 32-inch top",
      "low-cost price"
    ],
    "cons": [
      "Narrow top limits multi-monitor setups",
      "Not the absolute lowest minimum height",
      "Single motor on a small frame"
    ],
    "bestFor": "Short users who want a proven, low-cost compact desk with saved height presets."
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-standing-desks-for-short-people/topsky-dual-motor-frame.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B08C2LC3H2?tag=theofficejournal-20",
    "description": "5 inches, and dual motors keep the lift even at low heights where single-motor desks can feel less stable. Since you supply the desktop, you can choose a thinner top to shave a bit more off the effective minimum sitting height.\n\nBuying frame-only means an extra purchase and assembly step for the desktop, and you'll want to measure the frame's minimum height with your chosen desktop thickness added on top before assuming it reaches low enough for you.",
    "specs": [
      "Frame only",
      "Dual motor",
      "Fits tops up to 70.8x31.5 in",
      "225 lb capacity"
    ],
    "pros": [
      "Pair with any desktop for a custom fit",
    ...
    "cons": [
      ...
      "Final sitting height depends on desktop thickness chosen",
      "Higher total cost once desktop is added"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-standing-desks-for-short-people/flexispot-e6-standard.jpg",
    ...
    "pros": [
      "3-stage frame reaches lower minimum height",
      "Full-size 55x28 in top",
      "220 lb capacity",
      "Memory presets for shared use"
    ],
    "cons": [
      "Higher price than compact picks",
      "Ships in 2 boxes, longer assembly",
      "Larger footprint than compact desks"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-standing-desks-for-short-people/flexispot-e6-bamboo.jpg",
    ...
    "pros": [
      "3-stage frame for a lower minimum height",
      "Solid bamboo desktop",
      "220 lb capacity",
      "Memory presets"
    ],
    "cons": [
      "Higher price than the laminate E6",
      "Bamboo thickness adds slightly to sitting height",
      "Ships in 2 boxes"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-standing-desks-for-short-people/qzmdsm-rolling-desk.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0BVR3RKLZ?tag=theofficejournal-20",
    ...
    "pros": [
      ...
      "Rolls for easy repositioning",
      "Includes storage shelves",
      "Compact 32-inch top"
    ],
    "cons": [
      "Manual adjustment, no memory presets",
      "Lower weight capacity than electric desks",
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-standing-desks-for-short-people/techni-mobili-laptop-cart.jpg",
    ...
    "pros": [
      ...
      "Rolls between rooms easily",
      "Compact for tight spaces"
    ],
    "cons": [
      "Small top fits laptop only",
      "Manual adjustment, no presets",
      "Not suited to dual monitors"
    ],
...
export const relatedGuides = [
  ...
  },
  {
    ...
    "title": "Best 4-Leg Standing Desks (2026)"
  },
  {
    "href": "/guide/best-small-standing-desk",
    "title": "Best Small Standing Desks (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Standing Desks for Short People";
