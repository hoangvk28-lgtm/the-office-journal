...
export const guideTitle = "The Best Sticker Label Printers for Everyday Desk Work";
...
export const metaDescription = "How 6 sticker label printers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Sticker Label Printers for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-bottle-label-printers",
    "title": "Best Bottle Label Printers in 2026"
  }
];

export const breadcrumbLabel = "Best Sticker Label Printers";
