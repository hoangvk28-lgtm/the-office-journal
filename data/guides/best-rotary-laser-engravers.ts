...
export const guideTitle = "The Best Rotary Laser Engravers for a Better Desk Setup";
...
export const metaDescription = "We compared 5 rotary laser engravers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Rotary Laser Engravers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Rotary Laser Engravers";
