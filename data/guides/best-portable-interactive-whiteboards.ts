...
export const introParagraphs = [
  "A genuinely portable interactive whiteboard is a sensor/bar system that converts an existing surface plus projector, not a large flat panel placed on a rolling cart, which is movable but still requires two people and real setup time to relocate.",
...
export const faq = [
  {
    ...
    "a": "Not necessarily. The IPEVO IW2 explicitly works without Wi-Fi using its included Interactive Pen, connecting directly to a computer. Other portable systems may require a wireless connection for casting features specifically."
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-ipevo-interactive-whiteboards","title":"Best IPEVO Interactive Whiteboards"},{"href":"/guide/best-mimio-interactive-whiteboards","title":"Best Mimio Interactive Whiteboards"},{"href":"/guide/best-interactive-whiteboards-with-projector","title":"6 Best Interactive Whiteboards With Projector"}];
