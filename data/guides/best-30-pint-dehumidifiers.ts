...
export const guideTitle = "The Best 30-Pint Dehumidifiers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Waykar 34 Pints 2000 Sq. 2025 Energy Star Dehumidifier for Home is worth checking against its specific auto-restart and humidistat spec before assuming any unit handles unattended operation well."
      }
    ]
  },
  {
...
export const metaDescription = "How 7 30-pint dehumidifiers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 30-Pint Dehumidifiers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Waykar 34 Pints 2000 Sq. 2025 Energy Star Dehumidifier for Home is the top pick in this comparison. Removes up to 34 pints of moisture per day (95°f, 90% RH), ideal for basements, whole homes, garages, and commercial spaces. This unit features a manual 90° airflow adjustment that allows you to direct dry air where it’s needed most.\n\nFt Max 32 Pints Dehumidifier for Basement with Drain Hose.\n\nChoose this if you want the strongest all-around pick in this comparison and would rather not keep shopping around. The tank needs regular emptying unless you're running a continuous drain hose or pump, so factor that into daily upkeep before buying.",
    "specs": [
...
export const breadcrumbLabel = "Best 30-Pint Dehumidifiers";
