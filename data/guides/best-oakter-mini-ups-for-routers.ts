...
export const faq = [
  {
    "q": "Is Oakter's AirFiber mini UPS the same as its router UPS?",
    "a": "Ubiquiti AirFiber radios use point-to-point PoE at voltages and power levels that differ from a typical home router, so a UPS built for AirFiber gear is a distinct product from Oakter's standard router-focused mini UPS line, not a version of the same unit."
  }
];

export const guideSlug = "best-oakter-mini-ups-for-routers";

export const guideTitle = "The Best Oakter Mini UPS for Routers, Compared";
...
export const metaDescription = "We compared 4 oakter mini UPS for routers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Oakter Mini UPS for Routers (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-oakter-mini-ups-for-routers-1",
    "rank": 1,
    "badge": "Best Overall",
    ...
    "bestFor": "The most straightforward multi-rail option verified for this brand comparison"
  },
  {
    "id": "best-oakter-mini-ups-for-routers-2",
    "rank": 2,
    ...
    "bestFor": "Buyers who need two 12V rails"
  },
  {
    "id": "best-oakter-mini-ups-for-routers-3",
    "rank": 3,
    "badge": "Best with PoE",
    ...
    "bestFor": "ONU or camera gear that needs passive PoE"
  },
  {
    "id": "best-oakter-mini-ups-for-routers-4",
    "rank": 4,
    "badge": "Best with AVR",
    ...
    "bestFor": "Buyers who want regulated output"
  }
];
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-cuzor-mini-ups-for-routers",
    "title": "5 Best Cuzor Mini UPS for Routers in 2026"
  }
];

export const breadcrumbLabel = "Best Oakter Mini UPS for Routers";
