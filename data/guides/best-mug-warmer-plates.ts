...
export const guideSlug = "best-mug-warmer-plates";

export const guideTitle = "The Best Mug Warmer Plates for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "Across best mug warmer plates, carry real hidden gaps, given mug warmer plates, marketing skips the rest.",
  "Mug warmer plates picks split on real display feedback, since insulated mugs resist heat."
];

export const lastUpdated = "2026-08-31";

export const mainKeyword = "mug warmer plates";

export const metaDescription = "A practical comparison of 6 mug warmer plates, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Mug Warmer Plates for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-mug-warmer-plates-1",
    "rank": 1,
    "badge": "Best Overall",
...
export const breadcrumbLabel = "Best Mug Warmer Plates";
