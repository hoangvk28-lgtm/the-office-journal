...
export const guideTitle = "6 Best Affordable Drawing Tablets in 2026";
export const metaTitle = "Best Affordable Drawing Tablets 2026";
export const metaDescription = "We compared affordable drawing tablets by tablet architecture, pen behavior, and driver support rather than ranking by pressure-level count alone.";
...
export const faq = [
  {
    "q": "Are budget affordable drawing tablets genuinely usable, or do they cut corners that matter?",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-budget-drawing-tablets","title":"Best Budget Drawing Tablets in 2026"},{"href":"/guide/best-cheap-drawing-tablets","title":"Best Cheap Drawing Tablets in 2026"},{"href":"/guide/best-drawing-tablets-under-100","title":"Best Drawing Tablets Under $100 in 2026"}];
