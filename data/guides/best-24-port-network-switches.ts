...
export const guideTitle = "The Best 24-Port Network Switches for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  ...
  "We compared this cluster across unmanaged, PoE, and smart-managed tiers, since 24-port switches at this scale benefit from at least basic management most buyers should consider even if they'd skip it on a smaller switch."
];
...
export const metaDescription = "A practical comparison of 6 24-port network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 24-Port Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DT7S2JBP?tag=theofficejournal-20",
    ...
    "pros": [
      "Lifetime warranty on a 24-port unmanaged switch",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-24-port-gigabit-network-switches",
    "title": "best-24-port-gigabit-network-switches"
  },
  {
...
export const breadcrumbLabel = "Best 24-Port Network Switches";
