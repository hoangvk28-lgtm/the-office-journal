export const guideSlug = "best-storage-carts-under-30";
export const guideTitle = "8 Best Storage Carts Under $30 in 2026";
export const metaTitle = "Best Storage Carts Under $30";
export const metaDescription = "We compared storage cart under $30 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "storage cart under $30";
export const introParagraphs = [
  "Best Storage Carts Under $30 span budget to heavy-duty designs, which is exactly why floor type changes what you need.",
  "We compared this lineup on real load capacity and caster material, since this is the real gap to watch."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-storage-carts-under-30-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-storage-carts-under-30-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-storage-carts-under-30-3",
    rank: 3,
  ...
  {
    id: "best-storage-carts-under-30-4",
    rank: 4,
  ...
  {
    id: "best-storage-carts-under-30-5",
    rank: 5,
  ...
  {
    id: "best-storage-carts-under-30-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-storage-carts-under-30-7",
    rank: 7,
  ...
  {
    id: "best-storage-carts-under-30-8",
    rank: 8,
