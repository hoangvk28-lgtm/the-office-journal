...
export const faq = [
  ...
  },
  {
    ...
    "a": "Diode lasers in this power range (3W to 10W) can mark or engrave coated or painted metal surfaces but cannot cut through bare metal; that requires a fiber laser, a different technology entirely. Wood, acrylic, leather, and similar organic materials are what these machines are built to cut."
  },
  {
...
export const guideTitle = "The Best Laser Engravers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Woxcker, Twotrees TS1, ATOMSTACK P1)",
...
export const howWeEvaluated = [
  {
    ...
    "description": "72W) rather than the smaller actual laser output that determines cutting performance."
  },
  {
    "title": "",
...
export const metaDescription = "How 7 laser engravers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Laser Engravers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Creality builds this around a Class IIIa module rated for 72,000mW of input and a genuine 10W output, enough to cut a 5mm basswood board or 3mm black acrylic in a single pass rather than requiring the multiple passes cheaper diode engravers need.\n\nThe 17\" x 16\" open frame is large enough for full sign blanks and cutting boards, and it works with both LightBurn and the free LaserGRBL, so new users are not locked into paid software just to get started. An anti-UV acrylic shield filters most of the UV output during operation.",
    "specs": [
      "10W output, 72W machine power, Class IIIa",
      "17\" x 16\" open-frame work area",
      "0.06mm spot, 0.004in accuracy, up to 10,000mm/min",
      "Compatible with LightBurn and LaserGRBL"
    ],
    "pros": [
      "Genuine one-pass cutting on 5mm wood and 3mm dark acrylic",
      "Large 17x16in bed handles full sign blanks",
      "Assembles in 10-20 minutes with a tool-free focus plate"
    ],
    "cons": [
      "Open frame needs a dedicated ventilated space and eye protection",
      "No enclosure means fumes and stray beam exposure are on the user to manage"
    ],
  ...
  },
  {
    ...
    "description": "Woxcker's case for this machine is safety first: a fully enclosed 360-degree cover with a lid interlock that halts the laser the moment it's opened, a flame sensor that stops the job on unusual heat, an emergency stop button, and a 15-degree tilt cutoff. That combination of physical safeguards is uncommon at this power level, where most competitors ship an open frame and leave containment to the buyer.\n\n01mm compressed focus point and a 300mm working area, rated at 20,000mm/min, roughly twice the speed of comparable open-frame machines in this lineup. It also supports Wi-Fi, USB, app, and offline TF card control, and pairs with LightBurn, LaserGRBL, and Cutlabx.",
    "specs": [
      "10W output, fully enclosed with lid interlock",
      "300mm x 300mm working area, 0.01mm focus",
      "20,000mm/min max speed",
      "Flame sensor, e-stop, 15° tilt cutoff, WiFi/USB/app/TF card control"
    ],
    "pros": [
      "Genuine full enclosure with lid interlock, not a partial shield",
      "Flame sensor and tilt cutoff add real hardware safety layers",
      "20,000mm/min speed is roughly double most open-frame peers here"
    ],
    "cons": [
      "Costs more than comparable open-frame machines in this lineup",
      "300mm bed is smaller than the largest open-frame options"
    ],
  ...
  },
  {
    ...
    "description": "The K15 Pro's pitch is that it removes the two biggest first-machine obstacles: software and setup. CutLabX, its free companion app, runs from a phone, tablet, or computer and can generate a design from a typed prompt or a photo, and offline batch jobs load straight from a TF card without a PC in the loop. Assembly is six screws and a claimed three minutes.\n\n58W output rather than an inflated marketing number, and pairs it with dual cooling fans aimed at cutting heat buildup on long runs. 9\" bed is A4-sized, small enough to tuck under a desk but rated to cut 12mm plywood and 8mm acrylic cleanly.",
    "specs": [
      "Verified 10.36-10.58W output, dual-fan cooling",
      "11.8\" x 7.9\" (A4) work area",
      "0.01mm precision, 15,000mm/min",
      "CutLabX free app with AI design generation, offline TF card control"
    ],
    "pros": [
      "Verified real-world power output instead of an inflated spec sheet number",
      "CutLabX app removes the software learning curve for a first machine",
      "Compact A4 bed fits under a desk without giving up cutting power"
    ],
    "cons": [
      "11.8x7.9in bed is too small for large sign or panel projects",
      "Four heightening columns are needed separately for tall objects"
    ],
  ...
  },
  {
    ...
    "description": "5\" touch screen so basic jobs can run without opening a laptop.\n\nSafety features include an emergency stop, vibration-triggered motion protection, heat protection, and a hidden active cooling system, and it connects over USB, TF card, Wi-Fi, or app in addition to LightBurn and LaserGRBL support.",
    "specs": [
      "10W laser, 240MHz ESP32 controller, 3.5in touchscreen",
      "400mm x 400mm working area",
      "0.06mm spot, 0.01mm precision, 10,000mm/min",
      "Cuts up to 0.8in wood, 1.2in acrylic"
    ],
    "pros": [
      "3.5in touchscreen runs simple jobs without a connected computer",
      "400x400mm bed is the largest working area in this lineup",
      "Motion, heat, and vibration protection built into the controller"
    ],
    "cons": [
      "Larger footprint needs more dedicated desk or shop space",
      "Faster ESP32 controller adds cost versus simpler 8-bit boards"
    ],
  ...
  },
  {
    ...
    "description": "The TS1 trades cutting power for footprint and safety: a fully enclosed acrylic cover, included safety goggles, and true plug-and-play setup with no assembly beyond unboxing, aimed squarely at classrooms and family use under adult supervision. At 157mm x 157mm x 167mm and about 1kg, it's small enough to store in a drawer between projects.\n\nControl runs through the MKSLaser Bluetooth app or a wired LightBurn connection, and it takes plywood, MDF, bamboo, paper, and leather.",
    "specs": [
      "3W adjustable laser, fully enclosed, no assembly required",
      "80mm x 80mm work area, 30mm object height clearance",
      "0.1mm positioning accuracy, up to 3000mm/min",
      "Bluetooth app (MKSLaser) or USB with LightBurn"
    ],
    "pros": [
      "no-assembly plug-and-play setup out of the box",
      "1kg and a small footprint make it easy to store between uses",
      "Fully enclosed housing suits supervised classroom or family use"
    ],
    "cons": [
      "80mm x 80mm bed limits it to small objects and detail work",
      "3W power is not enough for cutting anything beyond thin material"
    ],
  ...
  },
  {
    ...
    "description": "2W IR module (sold separately) as a project's needs change, rather than buying a separate machine for each power level. A built-in HD camera gives a real-time preview for design alignment, and auto focus removes the manual height calibration most diode engravers still require.\n\nCreality rates it for 15,000mm/min and backs the enclosure with a Class 1 eye-safe rating plus automatic flame detection that halts the job and alerts the connected app. The portable, lightweight build is aimed at moving between rooms rather than staying fixed in one shop location.",
    "specs": [
      "5W diode (10W/1.2W IR modules available separately), Class 1 enclosed",
      "15-second quick-swap laser module system",
      "Built-in HD camera with real-time preview, auto focus",
      "Up to 15,000mm/min"
    ],
    "pros": [
      "Quick-swap modules let one machine scale up in power later",
      "Built-in camera and auto focus cut real setup time per job",
      "Class 1 enclosed rating means no goggles needed in normal use"
    ],
    "cons": [
      "Base 5W module is the lowest cutting power of the enclosed machines here",
      "Higher-power module swaps are an added purchase, not included"
    ],
  ...
  },
  {
    ...
    "description": "2W infrared laser in one unibody frame, letting it cover both standard organic-material engraving and applications the IR module handles better, inside a fully enclosed Class 1 housing with auto-shutdown on tilt and enclosure detection. Atomstack markets it as the first entry-level Class 1 safety machine in its category, meaning no goggles are required for normal operation.\n\nThe bundled AtomStack software includes a 1000+ material library with automatic accessory recognition.",
    "specs": [
      "5W diode + 1.2W infrared, dual-laser unibody, Class 1 enclosed",
      "110mm x 110mm work area, 50mm max object height",
      "0.06mm engraving, 0.1mm positioning accuracy",
      "AtomStack app with 1000+ material library"
    ],
    "pros": [
      "Dual diode plus IR laser covers more material types than a single-laser machine",
      "Class 1 enclosed rating means no goggles required in normal use",
      "CoreXY dual-motor drive keeps a compact frame accurate"
    ],
    "cons": [
      "110mm x 110mm bed is small relative to its price point",
      "Dual-laser design costs more than comparable single-laser machines here"
    ],
...
export const breadcrumbLabel = "Best Laser Engravers";
