...
export const guideTitle = "The Best Microphone Boom Arms for a Better Desk Setup";
...
export const metaDescription = "We compared 8 microphone boom arms on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Microphone Boom Arms for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Microphone Boom Arms";
