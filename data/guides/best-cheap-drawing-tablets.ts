...
export const faq = [
  {
    "q": "Are budget cheap drawing tablets usable, or do they cut corners that matter?",
...
export const guideTitle = "The Best Cheap Drawing Tablets for Everyday Desk Work";
...
export const metaDescription = "How 5 cheap drawing tablets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cheap Drawing Tablets for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Cheap Drawing Tablets";
