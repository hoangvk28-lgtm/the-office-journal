...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "VR Headset 3D VR Glasses Universal Virtual Reality Goggles Support 360°Panorama is the most affordable pick here that still clears the capability floor for this category. 360-Degree panoramic view, bringing more shocking visual experience and immersive visual impa-ct.gaming and watching movies with virtual reality headsets work best when your eyes properly align with the screen box. Suitable for 4.7-7 inch mobile phones, compatible with more types of large-screen mobile phones.\n\nTECKNET VR Headset for Phone covers similar ground, though this premium vr headset is the perfect present for father's day, halloween, easter, or christmas is what tips the choice one way or the other.\n\nIt's worth picking this one if you want a genuinely capable pick without paying for headroom you won't use. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
    specs: ["Support for myopia users", "360-Degree panoramic view", "Adjustable interpupillary distance"],
    pros: ["Support for myopia users", "360-Degree panoramic view", "Adjustable interpupillary distance", "More portable, more comfortable, more lightweight"],
    cons: ["Check compatibility with your exact setup before buying", "Marketed specs and real-world specs often differ"],
