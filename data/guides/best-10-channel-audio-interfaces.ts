export const guideSlug = "best-10-channel-audio-interfaces";
export const guideTitle = "8 Best 10-Channel Audio Interfaces in 2026";
export const metaTitle = "Best 10-Channel Audio Interfaces";
export const metaDescription = "We compared 10 channel audio interface models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "10 channel audio interface";
export const introParagraphs = [
  "Across best 10-channel audio interfaces, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is honest gain and connection type, since this predicts real recording reliability."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-10-channel-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-10-channel-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-10-channel-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-10-channel-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-10-channel-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-10-channel-audio-interfaces-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-10-channel-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-10-channel-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
