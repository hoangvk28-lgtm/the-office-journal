...
export const faq = [
  {
    "q": "Does a portable interactive whiteboard need Wi-Fi to work?",
    "a": "The IPEVO IW2 explicitly works without Wi-Fi using its included Interactive Pen, connecting directly to a computer. Other portable systems may require a wireless connection for casting features specifically."
  },
  {
    "q": "How long does calibration take after moving a portable system to a new room?",
    "a": "Systems with automatic calibration, like several portable sensor systems in this comparison, typically recalibrate in under a minute. Older or manual-calibration systems can take several minutes and require a steady hand to align the projected image with the sensor."
  },
  {
...
export const guideTitle = "The Best Portable Interactive Whiteboards for a Better Desk Setup";

export const heroImage = "https://m.media-amazon.com/images/I/31XwL44tfoL._SL500_.jpg";

export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "True Portable vs Movable Flat Panel",
    "note": "The IPEVO IW2 and similar sensor systems weigh a few pounds and pack into a bag; a 55-inch flat panel on a rolling stand still weighs 40-70+ pounds and needs two people to safely relocate between floors or buildings."
  }
];
...
export const introParagraphs = [
  "A portable interactive whiteboard is a sensor/bar system that converts an existing surface plus projector, not a large flat panel placed on a rolling cart, which is movable but still requires two people and real setup time to relocate.",
  "We defined portable by realistic one-person transport and setup time, listed every required component for the sensor-based systems in this cluster, and timed calibration expectations after moving rooms."
];
...
export const metaDescription = "We compared 5 portable interactive whiteboards on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Portable Interactive Whiteboards for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-portable-interactive-whiteboards-1",
    "rank": 1,
  ...
  {
    "id": "best-portable-interactive-whiteboards-2",
    "rank": 2,
    "badge": "Best Auto-Calibration",
  ...
  {
    "id": "best-portable-interactive-whiteboards-3",
    "rank": 3,
  ...
  {
    "id": "best-portable-interactive-whiteboards-4",
    "rank": 4,
    "badge": "Runner-Up Flat-Panel Alternative",
  ...
  {
    "id": "best-portable-interactive-whiteboards-5",
    "rank": 5,
    "badge": "Budget Flat-Panel Alternative",
...
export const breadcrumbLabel = "Best Portable Interactive Whiteboards";
