...
const raw = readFileSync(resolve(ROOT, "scripts", "unique_asins_safes.txt"), "utf-8");
...
writeFileSync(resolve(ROOT, "scripts", "data-safes.json"), JSON.stringify(allItems, null, 2), "utf8");
...
writeFileSync(resolve(ROOT, "scripts", "lookup-safes.json"), JSON.stringify(lookup, null, 2), "utf8");
console.log("Saved to scripts/data-safes.json and scripts/lookup-safes.json");
