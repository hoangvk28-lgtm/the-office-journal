...
export const guideTitle = "The Best Outdoor Projectors for a Better Desk Setup";
...
export const metaDescription = "We compared 8 outdoor projectors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Outdoor Projectors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Outdoor Projectors";
