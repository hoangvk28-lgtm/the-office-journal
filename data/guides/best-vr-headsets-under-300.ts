export const guideSlug = "best-vr-headsets-under-300";
export const guideTitle = "6 Best VR Headsets Under $300 in 2026";
export const metaTitle = "Best VR Headsets Under $300";
export const metaDescription = "We compared vr headsets under $300 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "vr headsets under $300";
export const introParagraphs = [
  "Best VR Headsets Under $300 aren't always interchangeable, exactly why vr headsets under $300, details stay hidden.",
  "vr headsets under $300 picks split on true per-eye resolution, since combined resolution numbers overstate per-eye clarity."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-vr-headsets-under-300-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-vr-headsets-under-300-2",
    rank: 2,
    ...
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/21q8yPP8m1L._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0973RP7H3?tag=theofficejournal-20",
    description: "Meta Quest 2, Advanced All-In-One Virtual Reality Headset, 128 GB is the priciest pick in this lineup. Get the hit vr rhythm game included when you buy meta quest 2**. Keep your experience smooth and seamless, even as high-speed action unfolds around you, with a super-fast processor and high-resolution display.\n\nAgainst Meta Quest 3S 128GB, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nIt's worth picking this one if you are willing to spend the most in this comparison for the fuller feature set that comes with it. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
    specs: ["Buy meta quest", "Get the hit vr rhythm game included when you buy meta quest 2**", "Keep your experience smooth and seamless"],
    pros: ["Buy meta quest", "Get the hit vr rhythm game included when you buy meta quest 2**", "Keep your experience smooth and seamless", "Experience total immersion with 3D positional audio"],
  ...
  {
    id: "best-vr-headsets-under-300-3",
    rank: 3,
  ...
  {
    id: "best-vr-headsets-under-300-4",
    rank: 4,
  ...
  {
    id: "best-vr-headsets-under-300-5",
    rank: 5,
  ...
  {
    id: "best-vr-headsets-under-300-6",
    rank: 6,
    badge: "Best Value",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You need the strongest real-world performance and sturdiest build, where Meta Quest 2, Advanced All-In-One Virtual Reality Headset, 128 GB justifies the extra cost."
      },
      {
        "label": "Save if",
