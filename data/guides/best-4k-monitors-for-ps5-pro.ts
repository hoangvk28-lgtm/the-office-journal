...
export const guideTitle = "The Best 4K Monitors for PS5 Pro, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "6 inch 4K UHD 3840X2160 145% SRGB IPS HDR HDMI"
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "6 inch 4K UHD 3840X2160 145% SRGB IPS HDR HDMI)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "6 inch 4K UHD 3840X2160 145% SRGB IPS HDR HDMI already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "We compared 6 4K monitors for PS5 pro on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 4K Monitors for PS5 Pro (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "LG 37G800A-B 37-Inch Ultragear 4K UHD (3840 x 2160) Curved Gaming Monitor is the strongest all-around choice here. Speed meets clarity - ultragear's 37-inch 4K uhd curved gaming monitor delivers stunning native resolution with clarity. Breathtaking uhd clarity, bold colors, and displayhdr 600 brilliance - stunning 4K uhd on a 37” display with up to 95% dci-p3 color coverage.\n\n6 inch 4K UHD 3840X2160 145% SRGB IPS HDR HDMI, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nGo with this pick if you want the strongest all-around pick in this comparison and would rather not keep shopping around. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    "specs": [
      "Speed meets clarity - ultragear's 37-inch 4K uhd curved",
      "Breathtaking uhd clarity",
      "Experience smooth motion with 165hz - with a fast 165hz refresh rate"
    ],
    "pros": [
      "Speed meets clarity - ultragear's 37-inch 4K uhd curved",
      "Breathtaking uhd clarity",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Portable monitor for laptops",
      "4K portable monitor",
      "Experience superior durability with our upgraded aluminum alloy chassis"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "description": "32\" 4K UHD IPS Monitor is a strong alternative worth comparing directly against the top pick. Designed for native 4K@60hz gameplay on ps5 and xbox series x.\n\n4, a detail worth checking closely before choosing between this and LG 37G800A-B 37-Inch Ultragear 4K UHD (3840 x 2160) Curved Gaming Monitor.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    "specs": [
      "32-Inch 4K canvas for productivity",
      "Console-ready 60hz with freesync",
      "Tüv-style eye care for wfh"
    ],
    "pros": [
      "32-Inch 4K canvas for productivity",
      "Console-ready 60hz with freesync",
      "Tüv-style eye care for wfh",
      "Versatile connectivity hub"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-4k-monitors-for-macbook-pro",
    "title": "Best 4K Monitors for MacBook Pro in 2026"
  },
  {
...
export const breadcrumbLabel = "Best 4K Monitors for PS5 Pro";
