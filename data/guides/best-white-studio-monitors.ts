export const guideSlug = "best-white-studio-monitors";
export const guideTitle = "8 Best White Studio Monitors in 2026";
export const metaTitle = "Best White Studio Monitors";
export const metaDescription = "We compared studio monitor white models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "studio monitor white";
export const introParagraphs = [
  "Best White Studio Monitors cover a wide sound-quality range, which is exactly why marketing copy alone is risky.",
...
export const products: GuideProduct[] = [
  {
    id: "best-white-studio-monitors-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-white-studio-monitors-2",
    rank: 2,
  ...
  {
    id: "best-white-studio-monitors-3",
    rank: 3,
  ...
  {
    id: "best-white-studio-monitors-4",
    rank: 4,
  ...
  {
    id: "best-white-studio-monitors-5",
    rank: 5,
  ...
  {
    id: "best-white-studio-monitors-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-white-studio-monitors-7",
    rank: 7,
  ...
  {
    id: "best-white-studio-monitors-8",
    rank: 8,
    badge: "Best Value",
