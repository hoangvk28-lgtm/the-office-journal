...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "RGBlink Mini-pro Video Switcher with 4X 4K HDMI Inputs is a strong alternative worth comparing directly against the top pick. Church live streaming ready, rgblink mini-pro video mixer switcher is perfect for church live streaming.stream 6-picture preview or program from 4x 4K HDMI inputs and dual HDMI outputs in 1080p. Volunteer-friendly interface - designed for ease-of-use, especially for single-operator live streaming setsup .\n\nSide by side with osee GoStream Deck HDMI Pro Live Streaming Multi Camera Video Mixer Switcher, the real difference worth noting is effortless ptz control switcher- control movement, focus and zoom without extra crew.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Input count fills up faster than expected once cameras, overlays, and playback sources are all counted, so plan with real margin.",
    specs: ["Church live streaming ready, rgblink mini-pro video", "Volunteer-friendly interface - designed for ease-of-use, especially", "Effortless ptz control switcher- control movement, focus"],
    pros: ["Church live streaming ready, rgblink mini-pro video", "Volunteer-friendly interface - designed for ease-of-use, especially", "Effortless ptz control switcher- control movement, focus", "Pro visual effects with chroma key"],
    cons: ["Input count fills up fast with cameras plus overlays", "NDI routing adds real network bandwidth demands"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
  ...
  },
  {
    ...
    description: "RGBlink Mini Video Mixer Switcher with 4 x HDMI Inputs 2K Input/Output Real is the most affordable pick here that still clears the capability floor for this category. Elevate your live production - the rgblink mini is more than just a video switcher. Solo streaming simplified - designed with simplicity in mind, the mini packs a punch for solo streamers.\n\nosee GoStream Deck HDMI Pro Live Streaming Multi Camera Video Mixer Switcher lands in a similar spot overall, but the deciding factor between the two is connectivity that counts - the USB 3.0 output of rgblink mini connects to any computer and is identified as a webcam, so it can work for all streaming software of social media platforms!.\n\nThis fits best if you want a genuinely capable pick without paying for headroom you won't use. NDI routing adds real network bandwidth and latency considerations, so plan your network setup before assuming NDI just works out of the box.",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "HDMI (e.g. RGBlink Mini Video Mixer Switcher with 4 x HDMI Inputs 2K Input/Output Real)",
