...
export const guideTitle = "The Best Audio Video Switchers for Everyday Desk Work";
...
export const metaDescription = "How 8 audio video switchers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Audio Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Audio Video Switchers";
