...
export const guideTitle = "The Best Desk Fans Under $80, Compared";
...
export const metaDescription = "We compared 8 desk fans under $80 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Desk Fans Under $80 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Leo ensures optimum air distribution by swinging from left",
      "Wide range",
      "Easy to use"
    ],
    "pros": [
  ...
  },
  {
    ...
    "specs": [
      "Airplane office decor & executive desk toy",
      "Unique fathers day gifts from daughter wife",
      "Engineered with a premium 8000mah high-capacity battery, this cordless"
    ],
    "pros": [
      "Airplane office decor & executive desk toy",
      "Unique fathers day gifts from daughter wife",
      "Engineered with a premium 8000mah high-capacity battery, this cordless",
      "well suited to pilots, boss, boyfriend & students"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
  ...
  },
  {
    ...
    "specs": [
      "Upgrade from cheap",
      "3D airflow & foldable design",
      "23Db whisper-quiet cooling"
    ],
    "pros": [
      "Upgrade from cheap",
      "3D airflow & foldable design",
      "23Db whisper-quiet cooling",
      "10-Speed turbo power & ev-grade battery"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
...
export const breadcrumbLabel = "Best Desk Fans Under $80";
