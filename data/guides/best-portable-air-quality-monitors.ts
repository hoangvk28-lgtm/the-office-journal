...
export const guideTitle = "The Best Portable Air Quality Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 8 portable air quality monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Portable Air Quality Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Portable design",
      "Handheld air quality meter equipped with a gas sensitive semiconductor sensor",
      "Wide application"
    ],
    "pros": [
      "Portable design",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-commercial-air-quality-monitors",
    "title": "Best Commercial Air Quality Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Portable Air Quality Monitors";
