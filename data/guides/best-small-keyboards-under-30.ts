...
export const faq = [
  ...
  {
    "q": "4GHz USB dongle keyboard better than a Bluetooth one?",
    "a": "Neither is universally better; they suit different situations. 4GHz dongle needs a free USB-A port but often has a very reliable, low-latency connection. Bluetooth needs no extra port and works with more device types, including tablets, but check that your target device actually has Bluetooth support first."
  },
  {
  ...
  },
  {
    ...
    "a": "Backlighting requires additional power beyond the keyboard's basic wireless signal, so a backlit wireless keyboard typically has shorter battery life between charges or battery swaps than an otherwise similar non-backlit model. If maximizing battery life matters most, a non-backlit pick is the safer choice."
  },
  {
...
export const guideTitle = "The Best Small Keyboards Under $30: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "A documented switch mechanism and certified safety",
        ...
        [
          "A matched keyboard and mouse combo",
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "TECKNET (36 months) or Macally (up to 2 years)"
        ],
        [
          "",
          ""
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "83) is the only pick here with named switch technology."
      },
      {
        "label": "",
        "text": "99) covers the core function at the lowest price in this comparison."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "4GHz USB-dongle wireless and wired USB connections, since each has real, different tradeoffs for device compatibility and setup."
  },
  {
...
export const introParagraphs = [
  ...
  "4GHz USB dongle versus true Bluetooth), key travel style, and battery arrangement, since these three details vary more between picks in this price range than the small footprint itself does."
];
...
export const metaDescription = "A practical comparison of 6 small keyboards under $30, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Small Keyboards Under $30 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Cherry SX scissor switch technology",
      "GS \"Tested Safety\" certified",
      "Wired USB, integrated metal stability plate"
    ],
    "pros": [
      "Documented Cherry SX switch mechanism",
      "Independently certified for safety testing",
      "Metal plate and fold-out feet add stability"
    ],
    "cons": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B072N471V4?tag=theofficejournal-20",
    "description": "4 ounces) directly in the listing, one of the smaller and lighter footprints in this comparison, plus a stated 36-month warranty with registration, longer than most competitors here mention.\n\nThe listing is upfront about a real tradeoff worth knowing before buying: this keyboard uses a different Enter key layout than standard full-size keyboards, meaning touch typists accustomed to a standard layout may need an adjustment period.\n\nBest for buyers who prioritize the smallest physical footprint and a longer stated warranty, and who don't mind a short adjustment period for a non-standard Enter key layout.",
    "specs": [
      "11.5 x 4.9 inches, 10.4 ounces",
      "2.4GHz USB connection, no Bluetooth",
      "36-month warranty with registration"
    ],
    "pros": [
      "compact stated dimensions",
      "36-month warranty, longest in this comparison",
      "Quiet, low key travel typing feel"
    ],
    "cons": [
      "Non-standard Enter key layout needs adjustment",
      "USB-A receiver required, no Bluetooth option"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B081549BN2?tag=theofficejournal-20",
    ...
    "specs": [
      "78-key compact layout plus matching mouse",
      "Single USB dongle for both devices",
      "Up to 2-year warranty, lifetime support"
    ],
    "pros": [
      "Keyboard and mouse in one matched purchase",
      "Single dongle powers both devices",
      "Long stated warranty and support terms"
    ],
    "cons": [
      "Most compressed key layout in this comparison",
      "Priciest pick here, though it includes a mouse"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07THJFXJN?tag=theofficejournal-20",
    ...
    "specs": [
      "87-key compact layout, wired USB",
      "Adjustable rainbow LED backlighting",
      "12 multimedia shortcut keys (F1-F12)"
    ],
    "pros": [
      "Adjustable backlighting, rare at this price",
      "12 dedicated multimedia shortcut keys",
      "Simple plug-and-play, no driver needed"
    ],
    "cons": [
      "Wired only, no wireless option",
      "Backlight adds a small amount of power draw over USB"
    ],
    "bestFor": "Buyers who want backlit keys for low-light typing at a low price"
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BXNGJ2LD?tag=theofficejournal-20",
    "description": "Rii's RK907 is the cheapest pick in this entire comparison at under $10, using low-profile keys for a quieter, more comfortable keystroke than a taller-key design, with a splash-resistant desktop-centric build for everyday office use.\n\nAgainst the pricier Lumsburry and Cherry picks, this skips backlighting and any certified switch technology, keeping things to the essential plug-and-play function at the lowest possible price in this comparison.\n\nBest for buyers who want the absolute lowest price for a compact, quiet-typing keyboard without any extra features beyond the core function.",
    "specs": [
      "Low-profile keys, splash-resistant design",
      "Simple USB plug-and-play, wired",
      "Cheapest pick in this comparison"
    ],
    "pros": [
      "Lowest price in this comparison",
      "Low-profile keys feel quiet and comfortable",
      "Splash-resistant build for everyday office use"
    ],
    "cons": [
      "No backlighting or certified switch tech",
      "Basic feature set compared to pricier picks"
    ],
    "bestFor": "Buyers who want the lowest possible price for a compact, comfortable-typing keyboard"
  }
];
...
export const relatedGuides = [
  ...
  },
  {
    ...
    "title": "Best Ergonomic Keyboards"
  }
];

export const breadcrumbLabel = "Best Small Keyboards Under $30";
