...
export const products: GuideProduct[] = [
  {
    ...
    description: "The highest-rated genuine 3M filter in our research, at a confirmed 24 inch, 16:9 fit, roughly 50 percent more expensive than the SightPro non-3M alternative of the same size.\n\nIt earns the top spot in this comparison over SightPro 24 Inch 16:9 Computer Privacy Screen Filter for Monitor for one main reason. Highest rating among confirmed genuine 3M SKUs. On price, it's actually priced above SightPro 24 Inch 16:9 Computer Privacy Screen Filter for Monitor, which is worth weighing if cost is your deciding factor between the two.\n\nWorth knowing before you decide: Brand with decades of privacy-filter manufacturing history. On the other side, Premium price over non-3M alternatives. That's the main tradeoff to weigh against everything above.",
    specs: ["24 inch, 16:9 aspect ratio","Genuine 3M optical film"],
    pros: ["Highest rating among confirmed genuine 3M SKUs","Brand with decades of privacy-filter manufacturing history"],
    cons: ["Small review base makes the rating less statistically certain","Premium price over non-3M alternatives"],
  ...
  },
  {
    ...
    description: "Not a 3M product, included directly for comparison: roughly a third cheaper than the equivalent 24 inch 3M filter, with a dramatically larger review base of 4,087 versus 3M's 21.\n\nOne spot below 3M Privacy Filters for 24 Inch Widescreen Monitor in this ranking, it's priced lower than 3M Privacy Filters for 24 Inch Widescreen Monitor. The compromise here is straightforward: Not a 3M product, if brand specifically matters to your purchase. What you gain in return: Roughly a third cheaper than the equivalent 3M filter. Whether that trade is worth it depends on which side matters more for your setup.\n\nWorth knowing before you decide: Far larger review base than the 3M alternative. On the other side, Not a 3M product, if brand specifically matters to your purchase. That's the main tradeoff to weigh against everything above.",
    specs: ["24 inch, 16:9 aspect ratio","Non-3M, for direct price and review comparison"],
    pros: ["Roughly a third cheaper than the equivalent 3M filter","Far larger review base than the 3M alternative"],
    cons: ["Not a 3M product, if brand specifically matters to your purchase"],
  ...
  },
  {
    ...
    description: "3M's magnetic-attach system, branded 3M Comply, at a confirmed 24 inch, 16:9 full-screen fit, the most expensive genuine 3M SKU we found in this size.\n\nSitting just under SightPro 24 Inch 16:9 Computer Privacy Screen Filter for Monitor, it costs more than SightPro 24 Inch 16:9 Computer Privacy Screen Filter for Monitor. Here's the honest tradeoff: Very small review count, treat the rating cautiously. And here's what it gets you instead: Genuine 3M magnetic mount for faster daily removal. That's the real difference between the two picks, not just a ranking number.\n\nWorth knowing before you decide: Genuine 3M magnetic mount for faster daily removal. On the other side, Highest price of the confirmed 3M SKUs. That's the main tradeoff to weigh against everything above.",
    ...
    cons: ["Very small review count, treat the rating cautiously","Highest price of the confirmed 3M SKUs"],
  ...
  },
  {
    ...
    description: "The most reviewed genuine 3M filter in our research at 310 reviews, giving more confidence in its 4.2 rating than the smaller-sample 24 inch 3M picks.\n\nRanked just behind 3M Privacy Filter for 24in Full Screen Monitor with 3M Comply Magnetic Attach, it costs more than 3M Privacy Filter for 24in Full Screen Monitor with 3M Comply Magnetic Attach. The real tradeoff against that pick: Highest price of any pick in this comparison. In exchange, it offers this instead: Most reviewed genuine 3M filter in our research. That's the swap that decides whether this pick or the one above it is the better fit for your screen.\n\nWorth knowing before you decide: Larger size for 27 inch monitors. On the other side, Highest price of any pick in this comparison. That's the main tradeoff to weigh against everything above.",
    specs: ["27 inch, 16:9 aspect ratio","Genuine 3M optical film"],
    pros: ["Most reviewed genuine 3M filter in our research","Larger size for 27 inch monitors"],
    cons: ["Highest price of any pick in this comparison"],
  ...
  },
  {
    ...
    description: "Not a 3M product, included for direct comparison: this is a matched 2-pack that costs roughly half the price of a single 3M 27 inch filter, and adds blue-light filtering on top.\n\nOne spot below 3M Privacy Filter for 27 Inch Widescreen Monitor in this ranking, it's priced lower than 3M Privacy Filter for 27 Inch Widescreen Monitor. The compromise here is straightforward: Not a 3M product, if brand specifically matters to your purchase. What you gain in return: Roughly half the price of a single 3M 27 inch filter. Whether that trade is worth it depends on which side matters more for your setup.\n\nWorth knowing before you decide: 2-pack with blue-light filtering included. On the other side, Not a 3M product, if brand specifically matters to your purchase. That's the main tradeoff to weigh against everything above.",
    specs: ["27 inch, 16:9 aspect ratio","Non-3M, 2-pack, blue-light filtering"],
    pros: ["Roughly half the price of a single 3M 27 inch filter","2-pack with blue-light filtering included"],
    cons: ["Not a 3M product, if brand specifically matters to your purchase"],
...
export const howWeEvaluated: HowWeEvaluatedItem[] = [
  { title: "Disclosed the actual size of 3M's current lineup honestly", description: "We confirmed only three genuine 3M SKUs with current listings in our research and said so directly, rather than implying a broader brand roundup than what actually exists." },
  { title: "Paired each 3M pick with a matched-size alternative", description: "For every 3M filter, we included a non-3M product at the same size so buyers can directly compare the brand premium against price and review volume." },
  { title: "Treated small 3M review counts cautiously", description: "Several genuine 3M SKUs have very few reviews; we noted this explicitly rather than treating a high rating on 7 or 21 reviews with the same confidence as thousands." },
  { title: "Distinguished 3M's magnetic Comply system from its standard filters", description: "We flagged the magnetic-attach 3M SKU separately, since it's a different mounting technology at a different price than 3M's standard filters." },
];
...
export const faq: FaqItem[] = [
  { q: "How many genuine 3M monitor privacy filters are currently available?", a: "We confirmed three current 3M SKUs in our research: a 24 inch magnetic-attach model, a standard 24 inch widescreen filter, and a 27 inch widescreen filter." },
  { q: "Is 3M worth the price premium?", a: "It depends on your priorities. 3M has decades of manufacturing history in this category, but the non-3M alternatives we compared have far larger review bases at a lower price." },
  { q: "What's the cheapest genuine 3M option?", a: "The 3M Privacy Filters for 24 Inch Widescreen Monitor at $53.72, also the highest-rated 3M SKU in our research." },
  { q: "Does 3M make a magnetic-attach filter?", a: "Yes, the 3M Privacy Filter with 3M Comply Magnetic Attach, though it has a very small review count in our research." },
  { q: "Is there a 3M option for 27 inch monitors?", a: "Yes, the 3M Privacy Filter for 27 Inch Widescreen Monitor, the most reviewed genuine 3M SKU we found." },
];
