...
export const guideTitle = "The Best Dehumidifiers for Laundry Rooms: Our Picks";
...
export const metaDescription = "How 8 dehumidifiers for laundry rooms compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Dehumidifiers for Laundry Rooms (2026)";
...
export const breadcrumbLabel = "Best Dehumidifiers for Laundry Rooms";
