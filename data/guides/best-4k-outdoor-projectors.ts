...
export const guideTitle = "The Best 4K Outdoor Projectors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 4K outdoor projectors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4K Outdoor Projectors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 4K Outdoor Projectors";
