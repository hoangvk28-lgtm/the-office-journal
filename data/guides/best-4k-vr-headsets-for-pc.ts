...
export const guideTitle = "The Best 4K VR Headsets for PC: Our Picks";
...
export const metaDescription = "How 6 4K VR headsets for PC compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 4K VR Headsets for PC (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-vr-headsets-for-nintendo-switch",
    "title": "Best VR Headsets for Nintendo Switch in 2026"
  }
];

export const breadcrumbLabel = "Best 4K VR Headsets for PC";
