...
export const guideTitle = "The Best Power Banks with Multiple USB Ports: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Portable Charger 70000mAh Power Bank Fast Charging)",
        "text": "More charges before a recharge, but heavier and bulkier to carry."
      },
      {
        "label": "Evopow 2 Pack Portable Charger)",
...
export const metaDescription = "A practical comparison of 7 power banks with multiple USB ports, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Power Banks with Multiple USB Ports (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      ...
      "22.5W ultra-fast charging : come with the 3.0 qc3.0/4.0 intelligent fast charge technologies",
      "Charge 6 devices at once",
      "50000mAh massive power : yilans portable charger power bank"
    ],
    "cons": [
  ...
  },
  {
    ...
    "pros": [
      ...
      "Built-in 4 cables",
      "20W pd fast charging & dual USB-C",
      "Measuring 6.33 × 2.85 × 0.74 in and weighing 0.73 lb"
    ],
    "cons": [
      "Real-world output is usually lower than the advertised mAh figure",
      "Capacity above 100Wh needs airline approval or can't fly at all"
  ...
  },
  {
    ...
    "description": "Portable Charger 70000mAh Power Bank Fast Charging is a strong alternative worth comparing directly against the top pick. 0,featuring 2×30w USB output ports and 1×20w USB c port. Multiple charging ports 5 outputs and 2 inputs: the large power bank features 2×30w USB ports, 2×15w USB ports, 1×micro USB input, 1×20w USB-C output and 18w input.\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Airlines cap carry-on power banks at 100 watt-hours without prior approval, and 160Wh is the hard ceiling even with permission, so check the Wh rating, not just the mAh number, before flying with one.",
    "specs": [
      "High capacity power bank",
      "30W quick charge battery pack",
      "Multiple charging ports 5 outputs and 2 inputs"
    ],
    "pros": [
      "High capacity power bank",
      "30W quick charge battery pack",
      "Multiple charging ports 5 outputs and 2 inputs",
      "Reliable charging bank for multiple devices"
    ],
    "cons": [
      "Capacity above 100Wh needs airline approval or can't fly at all",
      "Real-world output is usually lower than the advertised mAh figure"
...
export const breadcrumbLabel = "Best Power Banks with Multiple USB Ports";
