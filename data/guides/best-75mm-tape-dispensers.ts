...
export const guideTitle = "6 Best 75mm Tape Dispensers in 2026";
export const metaTitle = "Best 75mm Tape Dispensers";
export const metaDescription = "We compared 75mm tape dispensers models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    specs: ["Only fits 3 inch wide tape", "Fast tape replacing", "Super durability from thicker plate and strong riveted design for heavy duty use"],
    pros: ["Only fits 3 inch wide tape", "Fast tape replacing", "Super durability from thicker plate and strong riveted design for heavy duty use", "Ergonomic design provides you comfortable grasp"],
    cons: ["One-handed claims need real base weight to back them up", "Core spindle width is sized for a specific tape range"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-tape-dispensers","title":"Best Tape Dispensers in 2026"},{"href":"/guide/best-vhb-tape-dispensers","title":"Best VHB Tape Dispensers in 2026"},{"href":"/guide/best-shipping-tape-dispensers","title":"Best Shipping Tape Dispensers in 2026"},{"href":"/guide/best-25mm-tape-dispensers","title":"Best 25mm Tape Dispensers in 2026"}];
