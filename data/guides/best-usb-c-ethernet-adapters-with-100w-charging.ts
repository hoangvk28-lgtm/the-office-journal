...
export const introParagraphs = [
  "100W is a meaningful Power Delivery threshold, enough to charge most laptops including a 13-15in MacBook Pro under normal use, but the adapter's rated input isn't automatically what reaches your host device after the adapter's own power consumption.",
  "We specifically compared this 100W tier against Cable Matters' and Cable Matters' own 140W models, since the wattage difference only matters if you're charging a high-draw device like a 16-inch MacBook Pro under sustained heavy load."
];
...
export const metaDescription = "How 7 USB-C ethernet adapters with 100W charging compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best USB-C Ethernet Adapters With 100W Charging (2026)";
...
export const breadcrumbLabel = "Best USB-C Ethernet Adapters With 100W Charging";
