...
export const faq = [
  ...
  },
  {
    ...
    "a": "5G\" headline number to sell the product. It's not an automatic dealbreaker, but it means you can't verify driver maturity on your specific OS ahead of time the way you can with a named Realtek chipset."
  },
  {
  ...
  },
  {
    ...
    "a": "Most work as true plug-and-play on Windows and macOS with the Realtek chipset covered here. 5G Ethernet Controller driver installed manually for full performance."
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "A USB-A port on an older desktop or dock",
          "5Gbps USB C to Ethernet Adapter"
        ],
        [
          "A Dell laptop under an active Dell warranty",
          ""
        ],
        [
          "A MacBook, iPad, or recent iPhone",
          ""
        ],
        [
          "A Linux workstation or Chromebook",
          ""
        ]
      ]
    }
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "Any pick in this list works equally well"
        ],
        [
          "Linux or ChromeOS as a daily driver",
          ""
        ],
        [
          "A mix of Apple laptops, tablets, and phones",
          ""
        ]
      ]
    }
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "95) charges your laptop and carries ethernet through one cable, worth the extra $12 over the base Plugable model if you're tired of two separate cords."
      },
      {
        "label": "",
        "text": "99 uses the same chipset as every pricier option here and skips only the charging feature."
      }
    ]
  }
];
...
export const introParagraphs = [
  "5GbE label on the box only tells half the story. 5Gbps\" and still land in very different desk setups once you check the connector type, the chipset driving it, and whether your own router can actually push past 1Gbps in the first place.",
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "It's also the only pick here with both a USB-A and a USB-C connector built into one adapter, so it works whether your laptop still has a USB-A port or has moved to USB-C only.\n\nAgainst the UGREEN and Cable Matters picks below, the chipset and top speed are identical on paper. The real difference is that dual connector: if you're mixing an older USB-A desktop with a newer USB-C laptop, this is the only adapter here that covers both without buying two separate cables.\n\nBest for anyone who isn't fully committed to USB-C yet, or who wants a single adapter that moves between an older USB-A dock and a newer USB-C laptop.",
    "specs": [
      "Realtek RTL8156BG chipset",
      "USB-An and USB-C dual connector",
      "Aluminum housing, braided cable"
    ],
    "pros": [
      "Works with both USB-An and USB-C ports",
      "Cheapest 2.5GbE pick with a name-brand chipset",
      "Aluminum shell stays cool under sustained transfers"
    ],
    "cons": [
      "No power delivery passthrough",
      "Requires a 2.5GbE-capable router to hit full speed"
    ],
  ...
  },
  {
    ...
    "specs": [
      "Foldable connector for travel",
      "Broad OS support incl. Chrome OS, Linux",
      "CISA Secure-by-Design pledge signatory"
    ],
    "pros": [
      "Foldable design survives daily bag use",
      "Wide device list incl. ThinkPad and Chromebook",
      "Indicator lights for quick status checks"
    ],
    "cons": [
      "No power delivery passthrough",
      "Aluminum shell adds a bit of pocket bulk vs bare cable adapters"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CZYSGKS6?tag=theofficejournal-20",
    "description": "This is the only adapter in this price tier that adds a USB-C Power Delivery passthrough port, rated up to 100W, so it can charge a laptop and carry the ethernet connection through the same single cable. 5GbE adapters, which is a rare third-party callout for a product at this price.\n\nAgainst the base Plugable model above, this is $12 more for that PD passthrough alone, since the chipset and rated speed are otherwise the same. 100W covers most ultrabooks and 13-14\" MacBooks, but a 16\" MacBook Pro's included charger is rated higher, so check your laptop's actual charging wattage before assuming full-speed charging.\n\nBest for anyone who wants to cut down desk cable clutter by combining ethernet and charging into one USB-C run, as long as their laptop's charging needs fit within 100W.",
    "specs": [
      "100W USB-C Power Delivery passthrough",
      "Realtek chipset, 2.5Gbps rated",
      "MacWorld-recognized budget 2.5GbE pick"
    ],
    "pros": [
      "Charges your laptop and carries ethernet on one cable",
      "100W covers most ultrabooks and 13-14\" MacBooks",
      "Third-party MacWorld pick, not just a marketing claim"
    ],
    "cons": [
      "100W may not fully fast-charge larger 16\" laptops",
...
export const relatedGuides = [
  {
    "href": "/guide/best-usb-c-to-2-5gbe-ethernet-adapters-under-50",
    "title": "Best USB-C to 2.5GbE Ethernet Adapters Under $50"
  },
  {
  ...
  },
  {
    ...
    "title": "Best Thunderbolt 4 Docking Stations"
  }
];
