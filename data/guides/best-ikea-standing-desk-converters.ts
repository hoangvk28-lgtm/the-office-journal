...
export const faq = [
  {
    "q": "Does IKEA make a standing desk converter?",
    "a": "We found no clear current IKEA standing desk converter product line. IKEA's catalog currently emphasizes full sit-stand desks and laptop tables instead."
  },
  {
    "q": "What's the best alternative to an IKEA converter?",
    "a": "The VIVO 32 inch Desk Converter, K Series, the most proven converter in our broader research."
  },
  {
    "q": "Does IKEA sell any sit-stand furniture?",
    "a": "Yes, full standing desks like the BEKANT and TROTTEN lines, though these are complete desks rather than converters for an existing desk."
  },
  {
    "q": "What's the cheapest alternative option?",
    "a": ""
  },
  {
    "q": "Should I check IKEA's site directly?",
    "a": "Yes, product lineups change; verify directly with IKEA whether a converter has been introduced since this research was conducted."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Disclosed the lack of a current IKEA converter product line honestly",
    "description": "We confirmed IKEA's current catalog emphasizes full sit-stand desks and laptop tables, not a dedicated converter line, and said so directly rather than mislabeling other brands as IKEA products."
  },
  {
    "title": "Selected strong alternatives rather than padding a nonexistent product pool",
    "description": "We chose well-reviewed converters from other brands and were transparent that none of them are actually IKEA products."
  },
  {
    "title": "Prioritized products in a similar spirit to IKEA's minimal, budget-conscious design",
    "description": "Where relevant, we noted which alternative leans toward IKEA's typical simple, functional aesthetic and price point."
  },
  {
    "title": "Weighed review volume and rating for each honest alternative",
    "description": "We applied the same evaluation standard to these alternatives as we would to any converter comparison."
  }
];
...
export const metaDescription = "Honest finding: IKEA does not currently sell a clear standing desk converter product line. We compared the strongest non-IKEA alternatives instead.";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "pros": [
      "Well-reviewed alternative to the top pick at a similar price"
    ],
    "cons": [
      "Not an IKEA product"
    ],
  ...
  },
  {
    ...
    "specs": [
      "Adjustable height keyboard riser"
    ],
    "pros": [
