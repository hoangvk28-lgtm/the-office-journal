...
export const faq = [
  {
    "q": "Do interactive whiteboards come with wall mount hardware included?",
    "a": "Most flat panels in this comparison do include a basic wall mount bracket in the box, though several manufacturers note that a mobile stand is sold separately if you need that flexibility instead of a fixed wall installation."
  },
  {
    "q": "How do I access cable ports after a panel is wall-mounted?",
    "a": "Check whether the specific model has front-facing or side-accessible ports (several JASZDOT and JAV boards document front-panel USB/HDMI specifically for this reason) versus rear-only ports that become difficult to reach once flush-mounted against a wall."
  },
  {
...
export const guideTitle = "The Best Wall-Mount Interactive Whiteboards for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Confirm the included wall mount's VESA pattern matches your panel, verify wall stud locations rather than relying on drywall anchors alone for panels over 60 pounds, and set mounting height to keep the bottom third of the screen within comfortable reach for your typical user height."
  }
];
...
export const introParagraphs = [
  "Wall mounting is the standard installation method for most interactive whiteboards, but VESA compatibility and weight vary by model, and mounting height directly affects both writing reach and accessibility for younger or shorter users.",
  "We required exact panel weight and VESA specification for every pick, matched fastener and backing requirements to typical wall structure, set height guidance for writing reach and accessibility, and confirmed cable service access isn't trapped behind an installed panel."
];
...
export const metaDescription = "How 8 wall-mount interactive whiteboards compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Wall-Mount Interactive Whiteboards for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-wall-mount-interactive-whiteboards-1",
    "rank": 1,
    "badge": "Best Overall Wall-Mount Board",
  ...
  {
    "id": "best-wall-mount-interactive-whiteboards-2",
    "rank": 2,
    "badge": "Best EDLA-Certified Wall-Mount",
  ...
  {
    "id": "best-wall-mount-interactive-whiteboards-3",
    "rank": 3,
    "badge": "Best Large Wall-Mount (75in)",
  ...
  {
    "id": "best-wall-mount-interactive-whiteboards-4",
    "rank": 4,
    "badge": "Best High-Storage Wall-Mount",
  ...
  {
    "id": "best-wall-mount-interactive-whiteboards-5",
    "rank": 5,
    "badge": "Best Value Wall-Mount",
  ...
  {
    "id": "best-wall-mount-interactive-whiteboards-6",
    "rank": 6,
    "badge": "Best Security-Focused Wall-Mount",
  ...
  {
    "id": "best-wall-mount-interactive-whiteboards-7",
    "rank": 7,
    "badge": "Best All-In-One Wall-Mount",
  ...
  {
    "id": "best-wall-mount-interactive-whiteboards-8",
    "rank": 8,
    "badge": "Best AI Camera Wall-Mount",
...
export const relatedGuides = [
  {
    "href": "/guide/best-interactive-whiteboards-with-stand",
    "title": "7 Best Interactive Whiteboards With Stand"
  },
  {
...
export const breadcrumbLabel = "Best Wall-Mount Interactive Whiteboards";
