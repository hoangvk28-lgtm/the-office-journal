...
export const guideTitle = "The Best Invisible-Tape Dispensers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 4 invisible-tape dispensers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Invisible-Tape Dispensers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Invisible-Tape Dispensers";
