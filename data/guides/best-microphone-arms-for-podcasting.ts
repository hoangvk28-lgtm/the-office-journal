...
export const guideTitle = "The Best Microphone Arms for Podcasting: Our Picks";
...
export const metaDescription = "How 8 microphone arms for podcasting compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Microphone Arms for Podcasting (2026)";
...
export const breadcrumbLabel = "Best Microphone Arms for Podcasting";
