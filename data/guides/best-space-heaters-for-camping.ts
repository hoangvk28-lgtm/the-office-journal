...
export const guideTitle = "The Best Space Heaters for Camping, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Heater 9,000 BTU Portable Buddy Radiant Propane Heater)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Heater 9,000 BTU Portable Buddy Radiant Propane Heater is worth checking against its specific safety certifications before assuming any 'safe' label performs the same."
      }
    ]
  },
  {
...
export const metaDescription = "We compared 8 space heaters for camping on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Space Heaters for Camping (2026)";
...
export const breadcrumbLabel = "Best Space Heaters for Camping";
