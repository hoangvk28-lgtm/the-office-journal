export const guideSlug = "best-humidifiers-under-100";
export const guideTitle = "8 Best Humidifiers Under $100 in 2026";
export const metaTitle = "Best Humidifiers Under $100";
export const metaDescription = "We compared humidifier under $100 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "humidifier under $100";
export const introParagraphs = [
  "Best Humidifiers Under $100 carry very different real maintenance needs, which is exactly why a tank-size spec rarely tells the story.",
...
export const products: GuideProduct[] = [
  {
    id: "best-humidifiers-under-100-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-humidifiers-under-100-2",
    rank: 2,
  ...
  {
    id: "best-humidifiers-under-100-3",
    rank: 3,
  ...
  {
    id: "best-humidifiers-under-100-4",
    rank: 4,
  ...
  {
    id: "best-humidifiers-under-100-5",
    rank: 5,
  ...
  {
    id: "best-humidifiers-under-100-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-humidifiers-under-100-7",
    rank: 7,
  ...
  {
    id: "best-humidifiers-under-100-8",
    rank: 8,
    badge: "Also Worth Considering",
