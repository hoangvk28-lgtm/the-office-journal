...
export const faq = [
  {
    "q": "Which device has the best pressure sensitivity?",
    "a": "The XPPen 3 in 1 Color Digital Notebook, with 16384 pressure levels, the highest in this comparison, at the lowest price."
  },
  {
    "q": "Is E Ink color as vibrant as a normal screen?",
    "a": "Color E Ink (BOOX Note Air 5 C, reMarkable Paper Pro) is visibly less saturated than the XPPen's LCD-based color display."
  },
  {
    "q": "Can I use third-party drawing apps?",
    "a": "Yes, on the BOOX Note Air 5 C, since it runs Android."
  },
  {
    "q": "Which is the most proven device for sketching?",
    "a": ""
  },
  {
    "q": "What's the most affordable good sketching option?",
    "a": "98, which also has the highest pressure sensitivity in this comparison."
  }
];

export const guideSlug = "best-digital-notebooks-for-sketching";

export const guideTitle = "The Best Digital Notebooks for Sketching: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "95\" already covers the essentials: Highest pressure sensitivity in this comparison. The main thing you'd be paying extra for elsewhere in this list is features or storage you may not need."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We only prioritized devices with confirmed pressure-level specs, not devices where drawing is a secondary, unconfirmed feature."
  },
  {
    "title": "Color as a real sketching factor",
    "description": "We distinguished full-color LCD-based displays (XPPen) from color E Ink (BOOX, reMarkable Paper Pro), since they look meaningfully different for colored sketches."
  },
  {
    "title": "",
    "description": "We noted that the highest pressure sensitivity in this comparison comes at the lowest price, not the highest."
  },
  {
    "title": "Review volume for drawing-feel confidence",
    "description": "We weighted established review history for evidence on how the stylus actually performs during sustained drawing use."
  }
];
...
export const metaDescription = "How 5 digital notebooks for sketching compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      ...
      "Full color, not the muted color of E Ink alternatives"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "Same pressure-sensitive drawing hardware as the pick above at a higher price, verify accessory differences on the current listing.\n\nOn the other side, Costs more with a slightly lower rating.",
    "specs": [
      "16384 pressure levels",
      "Full color display"
    ],
    "pros": [
      "Same core sketching hardware as the cheaper XPPen listing"
    ],
    "cons": [
      "Costs more with a slightly lower rating"
    ],
  ...
  },
  {
    ...
    "description": "The only genuine color E Ink option for sketching in this comparison, though color E Ink still looks less saturated than the XPPen's LCD-based color display.\n\nOn the other side, More expensive than the XPPen options.",
    "specs": [
      "Color E Ink display",
      "Runs Android for third-party drawing apps"
    ],
    "pros": [
      "Only color E Ink option here for a paper-like sketching feel",
      "Android support for third-party drawing apps"
    ],
    "cons": [
      "Color E Ink is visibly less saturated than the XPPen's LCD color display",
      "More expensive than the XPPen options"
    ],
  ...
  },
  {
    ...
    "description": "ReMarkable's flagship color device, bundling an upgraded pen and folio, at the highest price in this comparison.\n\nThe real tradeoff against that pick: Highest price in this comparison, nearly double the XPPen options.\n\nOn the other side, Highest price in this comparison, nearly double the XPPen options.",
    "specs": [
      "Color E Ink display",
      "Marker Plus stylus and folio included"
    ],
    "pros": [
      "Bundles accessories sold separately for other reMarkable models"
    ],
    "cons": [
      "Highest price in this comparison, nearly double the XPPen options"
    ],
  ...
  },
  {
    ...
    "description": "On the other side, No color at all, a real limitation for many sketching use cases.",
    "specs": [
    ...
    "cons": [
      "No color at all, a real limitation for many sketching use cases"
    ],
...
export const breadcrumbLabel = "Best Digital Notebooks for Sketching";
