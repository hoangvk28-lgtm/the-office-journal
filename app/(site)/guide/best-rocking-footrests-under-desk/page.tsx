...
import {
  ...
  relatedGuides,
  type GuideProduct,
} from "@/data/guides/best-rocking-footrests-under-desk";
...
export default async function BestRockingFootrestsUnderDeskPage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-rocking-footrests-under-desk` },
    about: [
      { "@type": "Thing", name: "Rocking Footrest" },
      { "@type": "Thing", name: "Ergonomics" },
      { "@type": "Thing", name: "Active Sitting" },
    ],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Rocking Footrests Under Desk", item: `${SITE_URL}/guide/best-rocking-footrests-under-desk` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-rocking-footrests-under-desk#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Rocking Footrests Under Desk</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Rocking Footrests Under Desk" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Static footrests reduce the fatigue of dangling feet but do not address the circulation issue that comes from holding the feet in one position for hours. Rocking footrests introduce a gentle back-and-forth movement that activates calf muscles and improves blood flow during sedentary work sessions.</p>
          <p>This guide covers eight rocking footrests ranked by Amazon buyer rating and verified review count, including wood balance boards, foam rockers, and three-position designs that include a flat static mode.</p>
          <p>For the full footrest category including non-rocking models, see our <Link prefetch={false} href='/guide/best-under-desk-footrests' className='text-brand hover:underline'>best under-desk footrests</Link> guide.</p>
        </section>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-ink-secondary">
                <strong className="text-ink">best rocking pick:</strong>{" "}
                <a href="#strongtek-wood" className="font-bold text-ink hover:text-brand transition-colors">StrongTek Ergonomic Wood Foot Rest</a>
                 - 3,135 reviews at 4.7 stars, highest-rated rocking footrest.
              </p>
            </div>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=rocking+footrest+under+desk&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
