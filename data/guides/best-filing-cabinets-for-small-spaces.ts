...
export const faq = [
  {
    "q": "How much clearance does a filing cabinet actually need in a small room?",
  ...
  {
    "q": "Will a filing cabinet fit under my standing desk?",
    "a": "It depends on your desk's clearance at its lowest sitting height, typically 23 to 28 inches, and the cabinet's stated height, commonly 24 to 28 inches for rolling pedestals. Measure your desk's minimum sitting clearance first, then compare it against the cabinet's exact listed height rather than assuming any 'under desk' cabinet will fit."
  },
  {
    "q": "Are rolling filing cabinets stable, or do they tip over?",
    "a": "Stability depends on the caster setup. Cabinets with a single small caster set can tip forward when rolled onto a rug edge or floor transition. Locking front casters or a 5-caster arrangement reduce that risk. Once positioned, lock the wheels if the cabinet has that option."
  },
  {
    "q": "Do all small filing cabinets support standard hanging file folders?",
    "a": "Some compact cabinets only accept front-to-back hanging files rather than the side-to-side rail most standard hanging folders use. Check the listing's hanging rail specification before assuming a cabinet marked 'letter/legal' works with your existing folders."
  },
  {
    "q": "What's the difference between vertical and lateral cabinets for small spaces?",
    "a": "Vertical cabinets open forward and need more floor depth in front of them but take up less wall width. Lateral cabinets open sideways, trading depth requirements for wall width. Choose based on which dimension is actually scarce in your room."
  }
];

export const guideSlug = "best-filing-cabinets-for-small-spaces";

export const guideTitle = "The Best Filing Cabinets for Small Spaces: Our Picks";

export const heroImage = "/images/guides/best-filing-cabinets-for-small-spaces/hero.webp";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We compared closed and open-drawer footprints against typical small-room and under-desk constraints, prioritizing cabinets that don't require excessive front clearance to use."
  },
  {
    "title": "",
    "description": "For cabinets marketed as under-desk, we checked stated height against common sitting-height desk clearance ranges (23 to 28 in)."
  },
  {
    "title": "",
    "description": "Cabinets with casters were assessed for caster count, locking ability, and reported tipping issues in buyer feedback."
  },
  {
    "title": "",
    "description": "Fabric drawer construction, lock presence, and reported durability across verified buyer feedback."
  },
  {
    "title": "",
    "description": "Price was assessed relative to storage capacity per square foot of floor space used, not price alone."
  }
];

export const lastUpdated = "2026-07-25";

export const metaDescription = "How 8 filing cabinets for small spaces compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Filing Cabinets for Small Spaces (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "imageUrl": "/images/guides/best-filing-cabinets-for-small-spaces/letaya-3-drawer-mobile.jpg",
    ...
    "cons": [
      "Needs nearly 3 ft of front clearance when open",
      "Casters are small, less ideal on thick carpet",
      "Black finish only"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-filing-cabinets-for-small-spaces/devaise-2-drawer-under-desk.jpg",
    ...
    "pros": [
      "Sized for sitting-height desk clearance",
      "Fully assembled",
      "Locking drawers",
      "Solid metal build"
    ],
    "cons": [
      "Only 2 drawers limits capacity",
      "May not clear a standing desk at its lowest sit position",
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-filing-cabinets-for-small-spaces/gyiiyuo-2-drawer-desktop.jpg",
    ...
    "cons": [
      "Fabric drawers less durable than metal",
      "No lock",
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-filing-cabinets-for-small-spaces/devaise-3-drawer-mobile.jpg",
    ...
    "pros": [
      "Most storage per footprint here",
      "Mobile casters included",
      "Distinct rustic brown finish option",
      "Strong review count"
    ],
    "cons": [
      "Loaded weight makes repositioning harder",
      "Wider footprint than 2-drawer options",
      "No stated lock"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-filing-cabinets-for-small-spaces/vasagle-custos-small-rolling.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0BQJ5WL24?tag=theofficejournal-20",
    "description": "6 inches, this is one of the smallest true footprints in this guide, and VASAGLE markets it explicitly as a printer stand alternative, which fits the small-space brief well. The narrow width means it slots into gaps beside a desk that a wider lateral cabinet cannot use.\n\n6 inches tall, it clears most sitting-height desk aprons, but check your specific desk's under-surface clearance since a few standing desks sit lower than this at their minimum height.",
    "specs": [
      "2 drawers",
    ...
    "pros": [
      "One of the smallest footprints in this guide",
      "Doubles as printer stand",
      "Very high review count for the price",
      "Rolling casters"
    ],
    "cons": [
      "Small drawer capacity",
      "Lightweight build vs. all-steel options",
      "May not clear the lowest standing-desk heights"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-filing-cabinets-for-small-spaces/bynsoe-2-drawer-vertical.jpg",
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-filing-cabinets-for-small-spaces/steeloong-2-drawer.jpg",
...
export const breadcrumbLabel = "Best Filing Cabinets for Small Spaces";
