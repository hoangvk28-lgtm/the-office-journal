...
export const guideTitle = "The Best Floating Shelves with LED Lights: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "IAE Floating Wall Shelves 24 inch, Bathroom Shelving Wall Mounted, Teak)",
        "text": "Highest weight capacity, but requires drilling into a wall stud."
      },
      {
        "label": "Furrnook Floating Wall Shelves with Built-in LED Lights)",
...
export const metaDescription = "How 8 floating shelves with LED lights compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Floating Shelves with LED Lights (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "16 Million dreamy colors",
      "Music sync, dynamic lights that dance to the beat",
      "Easy control, customize your light in seconds"
    ],
    "pros": [
      "16 Million dreamy colors",
      "Music sync, dynamic lights that dance to the beat",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Sound music sync, dynamic rhythm lighting",
      "Durable solid wood",
      "Seamless black battery box cordless floating look"
    ],
    "cons": [
      "Drywall anchors alone only safely hold up to 20 to 25 lbs",
      "Real weight capacity depends on stud spacing, not the shelf itself"
...
export const breadcrumbLabel = "Best Floating Shelves with LED Lights";
