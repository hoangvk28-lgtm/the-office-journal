...
export const guideTitle = "The Best PICO VR Headsets for a Better Desk Setup";
...
export const metaDescription = "We compared 6 PICO VR headsets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best PICO VR Headsets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Original motion controllers for pico 4 all-in-one 3D vr"
    ],
    "pros": [
      "Original motion controllers for pico 4 all-in-one 3D vr",
  ...
  },
  {
    ...
    "specs": [
      ...
      "Ultra lightweight headphones, adjustable knob, panoramic 3D space, visual freedom to move"
    ],
    "pros": [
      "Long battery life",
      "Faster internet speed",
...
export const breadcrumbLabel = "Best PICO VR Headsets";
