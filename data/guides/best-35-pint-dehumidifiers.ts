...
export const guideTitle = "The Best 35-Pint Dehumidifiers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Midea Cube 35 Pint Dehumidifier for Basement)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You're covering a large or wet space and want a built-in pump and higher capacity, where Midea 35 Pint Dehumidifier for Basement justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 8 35-pint dehumidifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 35-Pint Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 35-Pint Dehumidifiers";
