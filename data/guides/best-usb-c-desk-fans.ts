...
export const introParagraphs = [
  "Across best usb-c desk fans, vary more than the keyword suggests, given that the real gap is in the details.",
...
export const products: GuideProduct[] = [
  ...
  {
    id: "best-usb-c-desk-fans-2",
    rank: 2,
    badge: "Also Worth Considering",
    name: "Gaiatop Desktop Fan",
    price: "$16.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41jaa1mwocL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0GS1QK4Q6?tag=theofficejournal-20",
    description: "Gaiatop Desktop Fan is a strong alternative worth comparing directly against the top pick. Operate your quiet desk fan with simple, tactile buttons. Enjoy true portability with this USB c rechargeable table fan.\n\nKoonie USB Desk Fan is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    specs: ["Intuitive button control & LED display", "Enjoy true portability with this USB c rechargeable table fan", "Experience powerful and refined airflow with our innovative dual-stage system"],
    pros: ["Intuitive button control & LED display", "Enjoy true portability with this USB c rechargeable table fan", "Experience powerful and refined airflow with our innovative dual-stage system", "Designed for focus and relaxation"],
  ...
  },
  {
    ...
    description: "Desk Fan, Rechargeable Battery Operated, 3 Speeds Ultra Quiet Strong Wind is a strong alternative worth comparing directly against the top pick. This 6.8-inch desk fan from tevelecin has a dual power source: battery powered and USB! Unique upgrade blade design engineered to be 25% quieter.\n\nKoonie USB Desk Fan lands in a similar spot overall, but the deciding factor between the two is 180°Tilt adjustable:desktop fan with a 180-degree swivel stand that can stand or hang.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Many listings only quote the dB rating at the lowest speed, so check the noise level at the speed you'll actually run daily before assuming it stays that quiet.",
    specs: ["Battery & USB powered fan", "Unique upgrade blade design engineered to be 25% quieter", "180°Tilt adjustable:desktop fan with a 180-degree swivel stand that can stand or hang"],
    pros: ["Battery & USB powered fan", "Unique upgrade blade design engineered to be 25% quieter", "180°Tilt adjustable:desktop fan with a 180-degree swivel stand that can stand or hang", "3-Stage adjustable wind speed & quietness"],
    cons: ["Noise rating usually reflects the lowest speed, not daily use", "USB-powered models cap out at lower airflow than AC-plugged fans"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-usb-c-desk-fans-4",
    rank: 4,
    ...
    description: "Warmco D3 10000mAh Portable Travel Fan is the premium option here, positioned above the rest on price. 10,000Mah battery powers 24h on low / 10h on high, all-day cooling without recharging: this warmco rechargeable desk fan runs a full workday on low speed and overnight camping sessions on a single charge. 1.61\" Slim, 7\"w × 8.4\"h, 5.1\" blade at 0.89 lbs, slides into any backpack: slim and light enough to slide into any backpack ready for commutes, camping, and cruise travel.\n\nSet next to Koonie USB Desk Fan, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nChoose this if you are willing to spend the most in this comparison for the fuller feature set that comes with it. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
  ...
  },
  {
    ...
    specs: ["Compact size", "USB powered fan", "Stable base"],
    pros: ["Compact size", "USB powered fan", "Stable base", "Adjustable angle"],
    cons: ["USB-powered models cap out at lower airflow than AC-plugged fans", "Noise rating usually reflects the lowest speed, not daily use"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-usb-c-desk-fans-7",
    rank: 7,
    badge: "Best Value",
