...
export const guideTitle = "The Best Dehumidifiers for Everyday Desk Work";
...
export const metaDescription = "How 8 dehumidifiers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Dehumidifiers";
