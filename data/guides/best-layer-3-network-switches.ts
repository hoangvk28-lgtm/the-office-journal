...
export const guideTitle = "The Best Layer 3 Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 2 layer 3 network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Layer 3 Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FSCS1DZX?tag=theofficejournal-20",
    "description": "5G/1000M/100M, supporting IPv4/IPv6 routing, ARP, and loopback interfaces alongside Layer 2 features like VLAN, ACL, and QoS.\n\n1X authentication, DoS anti-attack, dynamic ARP inspection, and DHCP Snooping, an enterprise-grade feature set packed into a desktop or wall-mountable industrial-grade fan-cooled metal case.",
    "specs": [
      "5x 10G auto-adaptive ports, L3 managed",
      "IPv4/IPv6 routing, ARP, loopback",
      "AAA/802.1X, DHCP Snooping security"
    ],
    "pros": [
      "Real Layer 3 IPv4/IPv6 routing in a 5-port unit",
      "Enterprise security features rare at this port count",
      "Telnet/SSH/SNMP management options"
    ],
    "cons": [
      "CLI/web management adds real learning curve",
      "Smaller brand than TP-Link/NETGEAR/Ubiquiti"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FVSNKX62?tag=theofficejournal-20",
    "description": "This 8-port SFP+ switch offers Layer 3 web management supporting VLAN, QoS, LACP, ACL, OSPF, RIP, and BGP through an intuitive interface that doesn't require CLI knowledge, targeting IT admins and prosumers who want real routing without command-line complexity.\n\n5G modules for backward compatibility, letting you reuse existing SFP optics while gradually upgrading a network to full 10G, with a console port included for deeper troubleshooting when the web UI isn't enough.",
    "specs": [
      "8x 10G SFP+, L3 managed via web UI",
      "OSPF/RIP/BGP routing",
      "Backward compatible with 1G/2.5G SFP modules"
    ],
    "pros": [
      "OSPF/BGP routing accessible without CLI expertise",
      "Reuses existing SFP optics during upgrades",
      "Console port for advanced troubleshooting"
    ],
    "cons": [
      "SFP+ requires separate transceivers",
      "160Gbps capacity active-fan cooled, not silent"
    ],
...
export const breadcrumbLabel = "Best Layer 3 Network Switches";
