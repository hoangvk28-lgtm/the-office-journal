...
export const guideTitle = "The Best Drawing Tablets for a $100 Budget: One Screen Option and Seven Pen Pads";

export const breadcrumbLabel = "Best Drawing Tablets With Screens Under $100";

export const metaTitle = "Best Drawing Tablets With Screens Under $100: What Fits (2026)";

export const metaDescription = "An entry pen display sits just above $100; screenless tablets fit well below it. We compared both on drawing area, pen, shortcut keys and device compatibility.";

export const mainKeyword = "drawing tablets with screens under $100";

export const introParagraphs = [
  "A $100 budget gets close to a drawing tablet with a screen, but not quite there in this guide. The 11.6-inch VEIKK VK1200 V2, the only pen display here, was listed at about $143 at the time of writing, and larger brand-name pen displays cost more again.",
  "Everything else here is a screenless pen tablet, and all of them cost well under $100. You draw on a pad and watch the monitor, which takes some adjustment, but it leaves room in the budget for a larger pad or a better-known brand.",
  "The practical question is whether a screen is worth stretching roughly $40 to $45 beyond budget, or whether a screenless tablet covers what you need. Our comparison is based on published specifications and listed compatibility, not hands-on testing."
];
...
export const products: GuideProduct[] = [
  {
    ...
    "rank": 1,
    "badge": "The Screen Option (Just Over Budget)",
    ...
    "cons": [
      "Above the $100 budget at the time of writing",
      "Needs cable connections and more desk space",
      "Listing gives few display details beyond size"
    ],
    "bestFor": "Anyone set on drawing directly on a screen who can stretch past $100.",
    "summary": "The only tablet here with a built-in screen: 11.6 inches, laminated, with a tilt-capable pen, at about $143.",
    "skipIf": "Your $100 limit is firm; a screenless tablet such as the Wacom Intuos Small or the 10 x 6-inch Graphics Drawing Tablet fits it with room to spare."
  },
  {
...
export const howWeEvaluated = [
  ...
  },
  {
    ...
    "description": "We compared prices at the time of writing and flagged anything above the $100 budget."
  }
];
...
export const buyingCriteria = [
  {
    ...
    "explanation": "A pen display lets you draw on the image; a screenless tablet asks you to look at the monitor while drawing on the pad. In this guide, the one screen tablet sits above $100 at the time of writing, while every screenless tablet costs less than $50."
  },
  {
...
export const faq = [
  {
    "q": "Can you buy a drawing tablet with a screen for under $100?",
    "a": "Not among the tablets in this guide. The only screen tablet here, the VEIKK VK1200 V2, was about $143 at the time of writing. Under $100, the options here are screenless pen tablets."
  },
  {
...
export const bottomLine = [
  "If you want to draw directly on a screen, the VEIKK VK1200 V2 is the option here, at roughly $40 to $45 over a $100 budget at the time of writing. If the budget is firm, a screenless tablet is the practical choice, and every one here leaves money to spare.",
  "Among those, the 10 x 6-inch Graphics Drawing Tablet listing offers the largest area and the fullest kit, the Wacom Intuos Small the most established drivers, and the HUION H640P shortcut keys on a compact pad. The HUION H420X is the lowest-cost way to try pen input at all."
];

export const sectionHeadings = {
  "howWeChose": "How We Chose These Tablets",
  "whatToLookFor": "What to Look for in a Drawing Tablet Under $100",
  "howToChoose": "How to Choose Within a $100 Budget"
};
