...
export const guideTitle = "The Best Tower Space Heaters for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "AUBKN X-Large 1500W Electric Space Heaters for Indoor Use)",
...
export const metaDescription = "How 8 tower space heaters compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Tower Space Heaters for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "1500W ceramic fast heating: this electric space heater",
      "1-12 Hour smart timer: equipped with a 1-12 hour programmable timer",
  ...
  },
  {
    ...
    "specs": [
      "Portable heater",
      "Fast and uniform indoor heating",
      "Quiet and gentle"
    ],
    "pros": [
      "Portable heater",
  ...
  },
  {
    ...
    "specs": [
      ...
      "Electric heater features a built-in thermostat system that automatically"
    ],
    "pros": [
      "Fast heating",
      "Multiple heat settings",
...
export const breadcrumbLabel = "Best Tower Space Heaters";
