...
export const guideTitle = "The Best Wireless Power Banks for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 wireless power banks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Wireless Power Banks for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Wireless Power Banks";
