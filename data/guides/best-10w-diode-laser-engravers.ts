...
export const guideTitle = "The Best 10W Diode Laser Engravers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 7 10W diode laser engravers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 10W Diode Laser Engravers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 10W Diode Laser Engravers";
