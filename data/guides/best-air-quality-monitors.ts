...
export const guideTitle = "The Best Air Quality Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 air quality monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Air Quality Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Air Quality Monitors";
