...
export const guideTitle = "5 Best Ceramic Space Heaters in 2026";
export const metaTitle = "Best Ceramic Space Heaters";
export const metaDescription = "We compared space heater ceramic models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
