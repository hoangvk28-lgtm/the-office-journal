...
export const guideTitle = "The Best Dehumidifiers for Mold Control: Our Picks";
...
export const metaDescription = "How 8 dehumidifiers for mold control compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Dehumidifiers for Mold Control (2026)";
...
export const breadcrumbLabel = "Best Dehumidifiers for Mold Control";
