...
export const metadata: Metadata = buildMetadata({
  title: "Privacy Policy - The Office Journal",
  description:
    "The Office Journal privacy policy. How we collect, use, and protect your information, including cookies, analytics, affiliate links, and contact data.",
  path: "/privacy-policy",
});
  ...
  return (
    <Container narrow className="py-14">
      ...
      <div className="mb-10 p-4 bg-bg rounded-lg border border-border text-sm text-ink-secondary leading-relaxed">
        <strong className="text-ink">Summary:</strong> The Office Journal does not sell your data. We use anonymized analytics to understand what content is useful, and contact form submissions only to respond to your inquiry. Affiliate links go to Amazon, which has its own privacy policy.
      </div>
      ...
      <div className="space-y-10 text-sm text-ink-secondary leading-relaxed">
        ...
        <section>
          ...
          <p>
            The Office Journal (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;the site&rdquo;) operates at workcocoon.com. This policy explains what information we collect from visitors, how we use it, and your rights regarding that information. If you have questions, see the{" "}
        ...
        <section>
          ...
          <p className="mb-3">
            As an Amazon Associate, we earn a small commission on qualifying purchases made through our links at no additional cost to you. Our affiliate tag (<code className="font-mono text-xs bg-bg px-1.5 py-0.5 rounded border border-border text-ink">theofficejournal-20</code>) is embedded in product links.
          </p>
          <p>
        ...
        <section>
          ...
          <p className="mb-3">
            The Office Journal uses the minimum cookies necessary for the site to function (session management) and analytics cookies to understand visitor behavior in aggregate. We do not use advertising cookies, retargeting cookies, or cookies that track you across other websites.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            Our site contains links to Amazon.com and other external sites. Once you leave The Office Journal, you are subject to the privacy policies of those sites. We are not responsible for the content or privacy practices of third-party websites. We recommend reviewing the privacy policy of any site you visit.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            The Office Journal is not directed to children under the age of 13. We do not knowingly collect personal information from children. If we become aware that we have inadvertently received personal information from a child under 13, we will delete it promptly.
          </p>
        </section>
