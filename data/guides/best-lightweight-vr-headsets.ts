...
export const guideTitle = "The Best Lightweight VR Headsets for a Better Desk Setup";
...
export const metaDescription = "We compared 6 lightweight VR headsets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Lightweight VR Headsets for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-vr-headsets-under-50",
    "title": "Best VR Headsets Under $50 in 2026"
  }
];

export const breadcrumbLabel = "Best Lightweight VR Headsets";
