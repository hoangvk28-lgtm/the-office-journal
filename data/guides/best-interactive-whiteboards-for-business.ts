...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    specs: ["75in 4K, 8GB RAM, 128GB ROM","13MP camera, 8-array mic","4-source split-screen sharing"],
    pros: ["Same all-in-one design as the 55-inch model at larger scale","OPS slot available for future Windows expansion","4-source split-screen for boardroom comparison work"],
    cons: ["OPS Windows module sold separately","Larger size requires more installation planning"],
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "Fleet Management Checklist",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-interactive-whiteboards-for-office","title":"7 Best Interactive Whiteboards for Office"},{"href":"/guide/best-interactive-whiteboards-for-teams","title":"6 Best Interactive Whiteboards for Teams"},{"href":"/guide/best-interactive-whiteboards-for-zoom","title":"7 Best Interactive Whiteboards for Zoom"}];
