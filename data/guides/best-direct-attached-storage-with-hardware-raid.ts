...
export const guideTitle = "The Best DAS With Hardware RAID, Compared";
...
export const metaDescription = "We compared 8 DAS with hardware RAID on compatibility, build, features and price to help you choose the right one for your space.";
...
export const breadcrumbLabel = "Best DAS With Hardware RAID";
