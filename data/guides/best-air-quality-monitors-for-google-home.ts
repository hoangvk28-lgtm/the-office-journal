...
export const guideTitle = "The Best Air Quality Monitors for Google Home, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Sainlogic Air Quality Monitor Indoor)",
...
export const metaDescription = "We compared 8 air quality monitors for google home on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Air Quality Monitors for Google Home (2026)";
...
export const breadcrumbLabel = "Best Air Quality Monitors for Google Home";
