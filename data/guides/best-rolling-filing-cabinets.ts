...
export const faq = [
  {
    "q": "Do all filing cabinets marketed for home offices actually roll?",
    "a": "Not every cabinet that shows up in a rolling filing cabinet search ships with casters. Check the specific listing for the words 'mobile,' 'rolling,' or 'casters' rather than assuming. In this guide, several strong picks are stationary and included as honest alternatives, not substitutes for a rolling cabinet."
  },
  {
    "q": "What caster material is best for hardwood floors?",
    "a": "Rubber or polyurethane casters are generally safer for hardwood since they roll quietly and are less likely to scratch the finish. Hard nylon casters can mark hardwood and tend to be noisier on hard flooring, though they hold up well under load on carpet or tile."
  },
  {
    "q": "Is a 5-caster base actually more stable than 4 casters?",
    "a": "A 5-caster layout, with one wheel centered underneath the cabinet, resists tipping better on uneven floors or rug edges than a standard 4-caster arrangement. Most budget rolling cabinets use 4 casters, so a 5-caster design is worth prioritizing if the cabinet will be moved often."
  },
  {
    "q": "Can a filing cabinet's casters fail before the cabinet itself wears out?",
    "a": "A cabinet's stated overall weight capacity doesn't guarantee each individual caster is rated to match. Casters bear only a fraction of the total load each, and on a heavily loaded cabinet they're often the first component to fail, especially under-rated budget hardware."
  },
  {
    "q": "Does a lock on a rolling filing cabinet make it more secure than a stationary one?",
    "a": "Lock security is unrelated to whether a cabinet has casters. A basic cam lock included on either a rolling or stationary cabinet functions the same way and mainly deters casual access rather than providing real security. Don't factor rolling ability into your security expectations."
  }
];

export const guideSlug = "best-rolling-filing-cabinets";

export const guideTitle = "The Best Rolling Filing Cabinets for a Cleaner, More Useful Desk";

export const heroImage = "/images/guides/best-rolling-filing-cabinets/hero.webp";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to VASAGLE CUSTOS Small Rolling Filing Cabinet unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We checked each listing's title and description for explicit 'mobile,' 'rolling,' or 'caster' language rather than assuming all filing cabinets in this category ship with wheels, and flagged any that did not."
  },
  {
    "title": "Caster material and floor compatibility",
    "description": "Where stated, caster material was weighed against hardwood, tile, and carpet compatibility."
  },
  {
    "title": "",
    "description": "We factored typical loaded cabinet weight (60-100+ lbs for a full 2-3 drawer cabinet) against the practicality of rolling it once loaded."
  },
  {
    "title": "",
    "description": "Fabric drawer construction and lock presence were compared across verified buyer feedback."
  },
  {
    "title": "Value for confirmed rolling capability",
    "description": "Price was weighed specifically against confirmed mobility rather than against filing capacity alone."
  }
];

export const lastUpdated = "2026-07-25";

export const metaDescription = "A practical comparison of 8 rolling filing cabinets, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Rolling Filing Cabinets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "imageUrl": "/images/guides/best-rolling-filing-cabinets/letaya-3-drawer-mobile.jpg",
    ...
    "pros": [
      "rolls, ships with casters",
      "3 drawers of capacity",
      "Locking",
      "Fully assembled"
    ],
    "cons": [
      "Standard casters less stable on thick carpet",
      "No stated 5-caster stability upgrade",
      "Loaded weight makes rolling on carpet harder"
    ],
  ...
  },
  {
    ...
    "pros": [
      ...
      "Fully assembled",
      "Locking drawers",
      "Fits under-desk clearance"
    ],
    "cons": [
      "Not shipped with casters, stationary as listed",
      "Would need an aftermarket caster kit for mobility",
      "Heavier to reposition without wheels"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-rolling-filing-cabinets/gyiiyuo-2-drawer-desktop.jpg",
    ...
    "specs": [
      "2 drawers",
      "Rolling casters",
      "24 in extended desktop",
      "Fabric drawers"
    ],
    "pros": [
      "rolls, lighter frame moves easily",
      "Doubles as printer stand",
      "Included side storage bag",
      "Budget price"
    ],
    "cons": [
      "Fabric drawers less durable under heavy loads",
      "No lock",
      "Lower weight capacity than steel cabinets"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-rolling-filing-cabinets/letaya-2-drawer-lateral.jpg",
    ...
    "pros": [
      "Locking lateral design",
      "Compact depth",
      "Solid review count"
    ],
    "cons": [
      "Not shipped with casters, stationary as listed",
      "Requires an add-on caster kit for mobility",
      "Side-to-side file orientation only"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Most capacity among the rolling picks here",
      "mobile design",
      "Distinct finish option",
      "Strong review count"
    ],
    "cons": [
      "Loaded weight strains standard casters",
      "Best moved before fully loading",
      "No stated lock"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-rolling-filing-cabinets/vasagle-custos-small-rolling.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0BQJ5WL24?tag=theofficejournal-20",
    "description": "VASAGLE's small rolling cabinet has the highest verified review count of any rolling pick in this guide, which gives more confidence in real-world caster durability than newer or lower-volume listings. Its lighter, more compact build also means less loaded weight riding on the wheels compared to a full 3-drawer cabinet.\n\n6 inches it's easy to roll one-handed even loaded, and its small size makes it a natural fit next to a desk where it needs to move in and out of a tight gap regularly.",
    "specs": [
      "2 drawers",
      "Rolling casters",
      "15.7 x 16.5 x 27.6 in",
      "Matte black"
    ],
    "pros": [
      "Highest review count among rolling picks",
      "Light enough to roll easily loaded",
      "Compact footprint",
      "Doubles as printer stand"
    ],
    "cons": [
      "Smaller capacity than 3-drawer options",
      "Lighter build than all-steel cabinets",
      "Basic caster hardware, not upgraded 5-wheel"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-rolling-filing-cabinets/bynsoe-2-drawer-vertical.jpg",
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-rolling-filing-cabinets/fluted-mobile-oak.jpg",
    ...
    "pros": [
      "mobile design",
      "Distinct oak wood finish",
      "Locking drawers",
      "Doubles as printer stand"
    ],
    "cons": [
      "Smaller review count than other picks",
      "Wood finish may show wear differently than metal",
      "Higher price than similar metal options"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-lateral-filing-cabinets",
    "title": "Best Lateral Filing Cabinets (2026)"
  }
];

export const breadcrumbLabel = "Best Rolling Filing Cabinets";
