...
export const faq = [
  {
    "q": "What's the best safe for hanging file folders specifically?",
    "a": "The SentrySafe Black Fireproof and Waterproof Safe, with an interior specifically sized for hanging file folders."
  },
  {
    "q": "Is there a soft, portable fireproof document organizer?",
    "a": "Yes, the DocSafe 5200°F Fireproof Document Organizer Box is a soft bag with extensive internal organization, lighter than a steel safe."
  },
  {
    "q": "Are all these picks actually fireproof?",
    "a": "No, three picks here explicitly don't document fire protection, they're security-focused document boxes. Check our comparison table for which picks have a genuine UL or ETL fire rating."
  },
  {
    "q": "Is there an option that also fits a laptop alongside documents?",
    "a": "Yes, the SentrySafe Shelf Safe with Digital Keypad Lock has the widest interior in this comparison, though it's explicitly not fireproof."
  },
  {
    "q": "Which pick has the highest claimed fire temperature resistance?",
    "a": "The DocSafe 5200°F Fireproof Document Organizer Box, though as a soft bag it offers less physical impact resistance than a steel safe."
  }
];

export const guideSlug = "best-small-safes-for-documents";

export const guideTitle = "The Best Small Safes for Documents, Compared";
...
export const howWeEvaluated = [
  {
    "title": "Required a fireproof interior geometry check, not just cubic feet",
    "description": "We looked at whether hanging file folders, passports, and letter-size paper fit flat without bending, a genuine organizational factor a raw capacity number doesn't capture."
  },
  {
    "title": "Separated fireproof document safes from basic steel security boxes honestly",
    "description": "Three picks here explicitly document no fire rating; we labeled these as security-only rather than blending them into a fireproof-document ranking."
  },
  {
    "title": "Compared soft fireproof organizers against rigid steel safes",
    "description": "The DocSafe soft organizer claims a higher temperature rating with extensive internal organization but offers less physical impact resistance than a steel box. We flagged that genuine tradeoff."
  },
  {
    "title": "Noted digital media protection separately from paper document protection",
    "description": "Several picks separately certify CD/DVD/USB protection alongside paper documents, since digital media has different heat sensitivity."
  }
];
...
export const introParagraphs = [
  ...
  "We also separated fireproof document storage from basic steel security boxes without a fire rating, since a document safe's core job (surviving a fire) differs from a general valuables safe's job (deterring theft)."
];
...
export const metaDescription = "We compared 8 small safes for documents on compatibility, build, features and price to help you choose the right one for your space.";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Only pick here specifically organized for hanging file folders",
  ...
  },
  {
    ...
    "pros": [
      "Most explicitly documented fire certification in this comparison",
      "Lifetime after-fire replacement guarantee"
    ],
    "cons": [
      "No confirmed hanging-folder organization like the top pick"
    ],
  ...
  },
  {
    ...
    "description": "This is a soft fireproof organizer rather than a steel safe, made of thickened silicone-coated fireproof cotton with 8 layers and an aluminum foil lining, claimed to withstand up to 5200°F. The large-capacity interior includes 8 passport mesh bags, 16 card slots, 4 USB drive pockets, and 7 folder layers, deep organization a steel box doesn't offer.\n\nA combination lock secures the bag closed, and waterproof zippers are rated to withstand a high-speed fire hose spray. Lighter and easier to carry than a steel safe, though it's a soft bag rather than a rigid box, worth weighing against your specific durability needs.",
    "specs": [
      "Soft fireproof organizer, claimed 5200°F resistance",
      "8 passport bags, 16 card slots, 4 USB pockets, 7 folder layers",
      "Combination lock, waterproof zippers"
    ],
    "pros": [
      "Highest claimed temperature resistance in this comparison",
      "Extensive dedicated organization (passport bags, card slots, folder layers) unmatched by steel safes"
    ],
    "cons": [
      "Soft bag construction, not a rigid steel box, offers less physical impact resistance"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Bolt-down hardware included for at-home document security",
      "Carrying handle supports genuine travel document portability"
    ],
    "cons": [
      "No hanging-folder organization"
    ],
  ...
  },
  {
    ...
    "cons": [
      "No documented fire protection, security-only design"
    ],
  ...
  },
  {
    ...
    "description": "A magnetic auto-locking door and reinforced solid steel construction with dual door locking bolts provide basic security for documents, though this listing doesn't document fire protection either. 12\" fit standard documents without hanging-folder organization.\n\nTwo emergency keys back up the keypad if you forget your code, and pre-drilled mounting holes with included bolts let you anchor it, at the lowest price in this comparison for a mountable steel option.\n\nLowest price among the mountable steel options here. Both are worth keeping in mind before deciding.",
    "specs": [
      "0.2 cu ft, mountable, no documented fire resistance",
      "6.29×8.9×5.12 in interior",
  ...
  },
  {
    ...
    "description": "A USB-C interface supporting an external power bank means you're not locked out of an urgently needed document, like a passport before a flight, over a dead battery. 71-inch steel reinforcement bolts and hidden hinges back the mounting, though this listing doesn't document fire protection.\n\n61 inches of usable interior.",
    "specs": [
      "0.23 cu ft, mountable, no documented fire resistance",
      "USB-C emergency power backup",
      "Pre-drilled installation holes"
    ],
    "pros": [
      "USB-C emergency power backup ensures access to urgently needed documents"
    ],
    "cons": [
      "No documented fire protection, security-only design"
    ],
...
export const breadcrumbLabel = "Best Small Safes for Documents";
