export const guideSlug = "best-ring-lights-with-stand";
export const guideTitle = "7 Best Ring Lights with Stand in 2026";
export const metaTitle = "Best Ring Lights with Stand";
export const metaDescription = "We compared ring light with stand models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "ring light with stand";
export const introParagraphs = [
  "Best Ring Lights with Stand carry very different real lux output, which is exactly why a lux spec rarely tells the story.",
  "We compared this lineup on true size versus your actual distance, since this is where the decision gets made."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-ring-lights-with-stand-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-ring-lights-with-stand-2",
    rank: 2,
  ...
  {
    id: "best-ring-lights-with-stand-3",
    rank: 3,
    badge: "Best Value",
  ...
  {
    id: "best-ring-lights-with-stand-4",
    rank: 4,
  ...
  {
    id: "best-ring-lights-with-stand-5",
    rank: 5,
  ...
  {
    id: "best-ring-lights-with-stand-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-ring-lights-with-stand-7",
    rank: 7,
