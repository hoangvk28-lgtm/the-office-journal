...
export const faq = [
  {
    "q": "Will a Gigabit PoE extender always deliver full 1000Mbps at its maximum rated distance?",
    "a": "Generally yes for the picks in this comparison, but it's not universal across all Gigabit-labeled extenders, so checking a listing's specific speed claims at your actual planned distance is worth doing rather than assuming any 'Gigabit' label guarantees full speed throughout."
  },
  {
    "q": "What's the most common mistake buyers make when choosing a Gigabit PoE extender?",
    "a": "Assuming a 'Gigabit' label alone guarantees full 1000Mbps across every port and at every distance, when speed and port-specific capability can vary between extenders that both carry the same general Gigabit marketing label."
  },
  {
    "q": "Is the TRENDnet extender worth the higher price over the VIMIN pick?",
    "a": "If you specifically want the longest warranty coverage and NDAA compliance for institutional use, the TRENDnet's higher price is justified, but for a standard home installation needing to power multiple devices, the VIMIN pick's lower price and multi-device support likely offer better value."
  },
  {
    "q": "Can I power a PTZ camera at full Gigabit speed with any of these extenders?",
    "a": "The Davuaz pick specifically maintains full Gigabit speed on its dedicated 60W port, making it the strongest choice in this comparison for powering a higher-wattage PTZ camera without sacrificing bandwidth."
  },
  {
    "q": "Do I need a local power outlet for any of these Gigabit PoE extenders?",
    "a": "No, all four picks in this comparison draw their power directly from the upstream PoE source, though the Gigabit PoE Passthrough Switch specifically emphasizes this zero-local-power design as a key feature."
  },
  {
    "q": "How many devices can I power from a single Gigabit PoE extender?",
    "a": "It varies by pick; the VIMIN and Gigabit PoE Passthrough Switch both power up to three devices from one unit at full Gigabit speed, while the TRENDnet extender is a single-port design intended for one device per unit."
  }
];

export const guideSlug = "best-gigabit-poe-extender";

export const guideTitle = "The Best Gigabit PoE Extenders for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Full Gigabit speed across three powered devices at the lowest price",
          "VIMIN 4-Port Gigabit PoE Extender"
        ],
        [
          "A dedicated high-power port while maintaining Gigabit speed",
          "Davuaz PoE Gigabit Extender, 1 in 4 Out"
        ],
        [
          "The longest warranty and established brand support",
          "TRENDnet Gigabit PoE+ Extender (TPE-E100)"
        ],
        [
          "Zero local power with full Gigabit speed",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Both deliver full Gigabit speed and multi-device power at under $23, ideal for a straightforward home or small-business installation without extended warranty needs."
      },
      {
        "label": "",
        "text": "A 3-year manufacturer warranty and NDAA compliance target buyers who want institutional-grade backing, at a meaningfully higher price than the budget picks."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "A higher-power device like a PTZ camera",
          "Davuaz PoE Gigabit Extender, 1 in 4 Out"
        ],
        [
          "No local power outlet available at all",
          "Gigabit PoE Passthrough Switch, 1 in 3 Out Extender"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "An extender that maintains full Gigabit speed across all its ports simultaneously, not just a single port, since modern 4K cameras benefit from more than the 100Mbps ceiling of Fast Ethernet extenders."
      },
      {
        "label": "",
        "text": "The VIMIN pick specifically maintains full Gigabit speed across three simultaneously powered devices, making it a strong fit for a multi-camera installation needing full bandwidth throughout."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "01 price is justified by its 3-year coverage."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared whether full 1000Mbps holds across the extender's full rated distance and port count."
  },
  {
    "title": "",
    "description": "Compared standard versus dedicated high-power ports while maintaining Gigabit speed."
  },
  {
    "title": "",
    "description": "Compared warranty length and stated ongoing support commitment."
  },
  {
    "title": "",
    "description": "Compared whether each extender requires a local outlet or draws entirely from the upstream PoE source."
  },
  {
    "title": "",
    "description": "Compared how many devices each extender can power simultaneously at full Gigabit speed."
  }
];
...
export const metaDescription = "We compared 4 gigabit PoE extenders on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Gigabit PoE Extenders for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GX3K1CBS?tag=theofficejournal-20",
    ...
    "specs": [
      "1 in 3 out, full 1000Mbps Gigabit speed",
      "IEEE 802.3af/at, 100m (328ft) extension",
      "Wall and DIN-rail mount, compact design"
    ],
    "pros": [
      "Lowest price in this comparison at $22.09",
      "Powers three devices simultaneously at full Gigabit speed",
      "Compact design fits into tight installation spaces"
    ],
    "cons": [
      "No outdoor waterproof rating unlike some competing extenders",
      "Standard per-port wattage, no dedicated high-power port"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GFTLQLVR?tag=theofficejournal-20",
    ...
    "specs": [
      "1 in 4 out, one 60W port + three 30W ports, all Gigabit",
      "90W total input, IEEE 802.3af/at",
      "24-hour refund/replacement guarantee"
    ],
    "pros": [
      "Lowest price in this comparison at $19.99",
      "Dedicated 60W port maintains Gigabit speed for a higher-power device",
      "24-hour worry-free guarantee for any product issue"
    ],
    "cons": [
      "No outdoor waterproof rating for exposed installations",
      "Total 90W input is shared across all four ports simultaneously"
    ],
...
export const breadcrumbLabel = "Best Gigabit PoE Extenders";
