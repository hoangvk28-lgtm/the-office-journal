...
export const guideTitle = "The Best Dual 4K Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "SANSUI 27\" 4K Gaming Monitor)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "6\" 3840x2160P 4K 100% SRGB justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 6 dual 4K monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Dual 4K Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Dual-mode monitor",
      "Tear-free & responsive gameplay",
      "Vibrant ips panel with rich colors"
    ],
    "pros": [
      "Dual-mode monitor",
      "Tear-free & responsive gameplay",
  ...
  },
  {
    ...
    "specs": [
      "Boasts dual display modes with 4K uhd@160hz for vivid",
      "& Hdr300 visuals: built with a high-performance fast ips",
      "Flawless game sync experience"
    ],
    "pros": [
      "Boasts dual display modes with 4K uhd@160hz for vivid",
      "& Hdr300 visuals: built with a high-performance fast ips",
...
export const breadcrumbLabel = "Best Dual 4K Monitors";
