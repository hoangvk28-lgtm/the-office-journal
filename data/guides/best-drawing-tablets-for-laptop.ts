...
export const guideTitle = "The Best Drawing Tablets for Laptop: Our Picks";
...
export const metaDescription = "How 6 drawing tablets for laptop compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const breadcrumbLabel = "Best Drawing Tablets for Laptop";
