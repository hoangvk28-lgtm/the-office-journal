...
export const authors: Author[] = [
  ...
  },
  {
    ...
    name: "The Office Journal Editors",
    ...
    social: [
      {
        ...
        label: "The Office Journal on LinkedIn",
      },
    ],
    editorial: {
      process:
