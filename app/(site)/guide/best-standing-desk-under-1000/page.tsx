...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-standing-desk-under-1000";
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-standing-desk-under-1000` },
    about: [{"@type":"Thing","name":"Standing Desk"},{"@type":"Thing","name":"Electric Height Adjustable Desk"},{"@type":"Thing","name":"Bamboo Standing Desk"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Standing Desks Under $1000", item: `${SITE_URL}/guide/best-standing-desk-under-1000` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-standing-desk-under-1000#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Standing Desks Under $1000</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Standing Desks Under $1000" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>The under $1000 range covers everything from reliable budget desks under $250 to commercial-grade BIFMA-certified options and premium bamboo frames approaching the $1000 ceiling.</p>
          <p>This guide covers eight standing desks under $1000 ranked by warranty, motor quality, surface material, and certification, starting at $208 and ending just under $1000.</p>
          <p>For the best value desks in a specific narrow range, see our <a href='/guide/best-standing-desk-under-200' className='text-brand hover:underline'>best standing desks under $200</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=best+standing+desk+under+1000&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
