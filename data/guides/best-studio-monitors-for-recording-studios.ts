export const guideSlug = "best-studio-monitors-for-recording-studios";
export const guideTitle = "8 Best Studio Monitors for Recording Studios in 2026";
export const metaTitle = "Best Studio Monitors for Recording Studios";
export const metaDescription = "We compared recording studio monitor models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "recording studio monitor";
export const introParagraphs = [
  "Best Studio Monitors for Recording Studios differ once you check the numbers, which is exactly why a watts number rarely tells much.",
...
export const products: GuideProduct[] = [
  {
    id: "best-studio-monitors-for-recording-studios-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-studio-monitors-for-recording-studios-2",
    rank: 2,
  ...
  {
    id: "best-studio-monitors-for-recording-studios-3",
    rank: 3,
  ...
  {
    id: "best-studio-monitors-for-recording-studios-4",
    rank: 4,
  ...
  {
    id: "best-studio-monitors-for-recording-studios-5",
    rank: 5,
  ...
  {
    id: "best-studio-monitors-for-recording-studios-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-studio-monitors-for-recording-studios-7",
    rank: 7,
  ...
  {
    id: "best-studio-monitors-for-recording-studios-8",
    rank: 8,
    badge: "Best Value",
