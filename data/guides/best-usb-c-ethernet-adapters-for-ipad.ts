...
export const guideTitle = "The Best USB-C Ethernet Adapters for iPad: Picks and Trade-offs";
...
export const introParagraphs = [
  "5GbE adapter specifically validated for iPad, iPhone, and Mac compatibility together.",
...
export const metaDescription = "A practical comparison of 7 USB-C ethernet adapters for iPad, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best USB-C Ethernet Adapters for iPad (2026)";
...
export const breadcrumbLabel = "Best USB-C Ethernet Adapters for iPad";
