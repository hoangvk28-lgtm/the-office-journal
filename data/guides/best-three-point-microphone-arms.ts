...
export const guideTitle = "8 Best Three-Point Microphone Arms in 2026";
export const metaTitle = "Best Three-Point Microphone Arms";
export const metaDescription = "We compared microphone arm three section models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
...
export const products: GuideProduct[] = [
  {
    ...
    description: "NEEWER NW-7000 Microphone Boom Arm is our overall pick in this lineup. Standard 5/8\"-27 threads with solid brass male end and internal 3/8\"-16 threads. Ergonomically spaced and comfortable eva rubber hand grips.\n\nWeighing this against Handheld Boom Pole for Shotgun Mic, three telescopic rods extend the boom length from 3.1-8.1' ends up being the detail that matters most for most buyers.\n\nThis one is the right call if you want the strongest all-around pick in this comparison and would rather not keep shopping around. Most clamps handle roughly 15 to 60mm of desk thickness, so measure your desk's edge before assuming any arm's included clamp will actually fit.",
    specs: ["Standard 5/8\"-27 threads with solid brass male end", "Ergonomically spaced and comfortable eva rubber hand grips", "Three telescopic rods extend the boom length from 3.1-8.1'"],
    pros: ["Standard 5/8\"-27 threads with solid brass male end", "Ergonomically spaced and comfortable eva rubber hand grips", "Three telescopic rods extend the boom length from 3.1-8.1'", "Made out of aluminum alloy, it is lightweight"],
  ...
  },
  {
    ...
    description: "RGB Low Profile Microphone Boom Arm is the top-tier pick in this comparison. Break free from the limits of traditional 2-section mic arms. Built with durable aluminum alloy, this low profile mic arm supports microphones and accessories up to 4.4 lb / 2 kg.\n\nBring more personality to your gaming or streaming desk with integrated RGB lighting, which is the main thing that distinguishes this pick from NEEWER NW-7000 Microphone Boom Arm.\n\nGo with this pick if you are willing to spend the most in this comparison for the fuller feature set that comes with it. A cheaper internal spring can sag under a heavier microphone over time, so check that the arm's rated weight limit exceeds your mic's actual weight by a real margin, not just barely clears it.",
    specs: ["3-Section detachable & fully adjustable", "4.4 Lb heavy-duty aluminum support", "20 RGB lighting effects for your setup"],
    pros: ["3-Section detachable & fully adjustable", "4.4 Lb heavy-duty aluminum support", "20 RGB lighting effects for your setup", "Hidden cable management, cleaner desktop"],
    cons: ["Cheaper springs can sag over time with heavier microphones", "Requires a desk edge thin enough for the included clamp"],
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Clamp mount (e.g. Andoer Handheld Microphone Boom Arm 5-Section Extendable Mic Arm Aluminum Alloy)",
