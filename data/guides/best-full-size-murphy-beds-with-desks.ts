...
export const faq = [
  {
    ...
    "a": "The Create-A-Bed Queen Size Deluxe Kit and the Queen Size Murphy Bed Hardware Kit are both explicitly labeled queen in their listing titles. They appear in this guide's underlying research data because they are commonly cross-shopped with full-size searches, but if you specifically need full-size, choose from the other 6 confirmed full-size picks instead."
  },
  {
    "q": "Is the desk smaller on a full-size murphy bed compared to queen?",
    "a": "Desk panel depth in product lines like MERITLINE is typically sized consistently across full and queen variants, so a narrower full-size cabinet does not automatically mean a narrower desk. Check the specific desk depth dimension in the current listing to confirm."
  },
  {
  ...
  },
  {
    ...
    "a": "Read current buyer reviews and photos closely before ordering any pick with a very small review sample rather than relying on price or specs alone."
  }
];

export const guideSlug = "best-full-size-murphy-beds-with-desks";

export const guideTitle = "The Best Full-Size Murphy Beds with Desks: Our Picks";
...
export const howWeEvaluated = [
  {
    ...
    "description": "Checked every listing title against the stated dimensions before including it as a full-size pick, and flagged 2 of the 8 products in this guide's underlying data as queen-size mismatches rather than silently presenting them as full-size options."
  },
  {
    "title": "Confirmed desk integration vs bed-only design",
    "description": "Verified which listings actually state a built-in desk surface, since 5 of 8 picks confirm a desk while the rest are bed-only cabinets or size-mismatched hardware kits."
  },
  {
    "title": "Desk depth parity with queen-size alternatives",
    "description": "Compared desk panel depth across the confirmed desk picks against equivalent queen-size desk units, since a narrower full-size cabinet does not automatically mean a narrower desk surface."
  },
  {
    "title": "",
    "description": "Considered whether upgrading from a thinner included mattress (like the AFI's 6 inch pad) to a thicker 10-12 inch mattress is safe for the calibrated mechanism, or whether that requires manufacturer verification first."
  },
  {
    "title": "Assembly time and crew size for full vs queen",
    "description": "Weighed the lighter 180-280 lb full-size cabinet weight range against queen units, which more often require professional installers, since full-size assembly is more realistically a two-person job."
  }
];
...
export const metaDescription = "How 8 full-size murphy beds with desks compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Full-Size Murphy Beds with Desks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FLJ8MKRW?tag=theofficejournal-20",
    "description": "This listing directly confirms a built-in desk on a full-size cabinet, and the desk depth is comparable to what queen units offer since desk panels in this product line are typically sized to the same standard, not scaled down to match the narrower full-size cabinet width. That means you are not necessarily sacrificing usable desk surface by choosing full over queen., this sits well below the price of most desk-confirmed queen picks. Desk depth comparable to queen-size units.",
    "specs": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GQ95QCV6?tag=theofficejournal-20",
    "description": "This full-size cabinet confirms a built-in desk plus a top cabinet and storage shelves, giving it the most storage density among the desk-confirmed picks in this guide. The wooden bed frame construction matches the design language of other Merax cabinets across this guide series.\n\n0 stars, which is a meaningful red flag given how small the sample is, so treat this pick with caution and read current buyer reviews closely before ordering rather than relying on this guide's assessment alone.\n\nMost storage density among desk-confirmed full-size picks. 0 stars, a significant caution flag.",
    "specs": [
      "Full size cabinet with fold-down desk",
  ...
  },
  {
    ...
    "description": "This is MERITLINE's grey variant with a confirmed desk plus a storage bookcase, aimed at a full-size room that also needs book or bin storage nearby. The desk panel design follows the same line as the white MERITLINE pick above, giving comparable desk depth to queen alternatives.\n\nPrice was not listed at time of research, so check the current Amazon listing directly.",
    "specs": [
      "Full size cabinet with fold-down desk",
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FK9SYSVB?tag=theofficejournal-20",
    "description": "THINK 30 confirms a foldable desk built into this full-size cabinet, with a walnut and gray finish that differentiates it visually from the white and grey MERITLINE picks above. The foldable desk mechanism is a separate hinge system from the bed's own fold, which is worth understanding before ordering since it adds an extra moving part. Distinct walnut and gray finish option.",
    "specs": [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0GH134WWH?tag=theofficejournal-20",
    "description": "Unlike the other Merax pick in this guide, this listing title makes no desk claim at all, describing 3 cabinet shelves for storage instead. This is a bed-only full-size cabinet best paired with a separate desk placed nearby, not a genuine desk combo, despite home office marketing on the listing.\n\nSolid wood construction and a rustic finish give it a different look from the painted MERITLINE and AFI cabinets. 0 stars, feedback is limited and middling, so weigh this against the desk-confirmed picks above if desk integration matters.",
    "specs": [
  ...
  },
  {
    ...
    "description": "Flagging this honestly: this listing title explicitly says Queen Size, not full, so it does not match this guide's full-size focus despite appearing in the underlying product data. We include it here only because it is a common cross-listed hardware kit buyers encounter while shopping full-size options, not as a genuine full-size recommendation.\n\nIt is also a bare gas piston mechanism with no desk surface included, aimed at DIY builders who construct their own cabinet. If you specifically want full-size, skip this pick and choose one of the confirmed full-size products above instead.\n\nLowest price in this guide.",
    "specs": [
  ...
  },
  {
    ...
    "description": "Flagging this honestly as well: this is another queen-size hardware kit, not full size, appearing in this guide's underlying data because it is frequently cross-shopped with full-size searches. It should not be treated as a full-size recommendation.\n\nIf queen size fits your room better than full, this is a well-regarded mechanism, but it is not the full-size product this guide is centered on.",
    "specs": [
      "Vertical queen size mechanism (not full)",
      "Gas piston operation",
      "Hardware kit, cabinet not included",
...
export const relatedGuides = [
  {
    "href": "/guide/best-queen-murphy-beds-with-desks",
    "title": "Best Queen Murphy Beds with Desks (2026)"
  },
  {
  ...
  {
    "href": "/guide/best-cabinet-beds-with-desks",
    "title": "Best Cabinet Beds with Desks (2026)"
  }
];

export const breadcrumbLabel = "Best Full-Size Murphy Beds with Desks";
