...
export const introParagraphs = [
  "Best Desk Pad Protectors look similar but differ in practice, so the surface material hides real gaps.",
  "Every pick here was judged on real material and backing grip, because this predicts real day-to-day durability."
];
...
export const products: GuideProduct[] = [
  ...
  {
    id: "best-desk-pad-protectors-7",
    rank: 7,
    badge: "Great Alternative",
    name: "LBJFYHJN Clear Desk Mat",
    price: "$13.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41mDFhHn2pL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0D1YFS87B?tag=theofficejournal-20",
    description: "LBJFYHJN Clear Desk Mat is a strong alternative worth comparing directly against the top pick. The transparent design lets you keep the original look of the tabletop or furniture top. Our clear desk cover mat is made of durable and anti-static high quality PVC material.\n\nSet next to Aothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
    specs: ["Transparent desk pad", "Clear table protector", "Round edge design"],
    pros: ["Transparent desk pad", "Clear table protector", "Round edge design", "Buy with confidence"],
    cons: ["Cloth tops show wear faster than a wipeable leather or PU surface", "A too-small size still leaves your mouse hand off the pad"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-desk-pad-protectors-8",
    rank: 8,
    badge: "Best Premium Pick",
    name: "LovePads Clear Desk Mat 16x36 in",
    price: "$18.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/51d4AOe1B8S._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B086HFPS52?tag=theofficejournal-20",
    description: "LovePads Clear Desk Mat 16x36 in is the priciest pick in this lineup. Crafted with high quality PVC material, this practical table protector is bpa-free, no harmful chemicals near your meals! We have 1.5mm and 2mm thickness mats for you to choose.\n\nAothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse lands in a similar spot overall, but the deciding factor between the two is this scratch resistant table protector is highly recommended as a furniture surface protection.\n\nReach for this pick if you are willing to spend the most in this comparison for the fuller feature set that comes with it. A desk pad sized just for your keyboard still leaves your mouse hand working off the bare desk, so measure your keyboard and mouse side by side before picking a size.",
    specs: ["Safe PVC material", "Thick and heavy duty", "Versatile applications"],
    pros: ["Safe PVC material", "Thick and heavy duty", "Versatile applications", "Cut to fit"],
    cons: ["A too-small size still leaves your mouse hand off the pad", "Cloth tops show wear faster than a wipeable leather or PU surface"],
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "LovePads Clear Desk Mat 16x36 in"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Cloth (e.g. Leather Desk Pad Protector, Non-Slip Desk Pad(Black, 23.6\" x 13.7\"))",
        "text": "Softer feel, absorbs spills, shows staining faster."
      },
      {
        "label": "Leather/PU (e.g. LovePads Clear Desk Mat 16x36 in)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You want a wipeable, longer-lasting surface with a more polished look, where LovePads Clear Desk Mat 16x36 in justifies the extra cost."
      },
      {
        "label": "Save if",
        "text": "You want straightforward daily protection and comfort, where Leather Desk Pad Protector, Non-Slip Desk Pad(Black, 23.6\" x 13.7\") already covers the job at the lowest price here."
      }
    ]
  }
];
