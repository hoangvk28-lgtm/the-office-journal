...
export const guideTitle = "3 Best Standing Desk Converters Under $300 in 2026";
export const metaTitle = "Best Standing Desk Converters Under $300 in 2026";
export const metaDescription = "We compared best standing desk converters under $300 by verified current price and real capability, not just the price ceiling alone.";
export const mainKeyword = "standing desk converters under $300";
export const introParagraphs = [
  "Best Standing Desk Converters Under $300 listings span a wide range of real capability even within the same price ceiling, and comparing them on price alone misses which picks actually meet the core use case.",
...
export const products: GuideProduct[] = [
  {
    id: "best-standing-desk-converters-under-300-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-standing-desk-converters-under-300-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-standing-desk-converters-under-300-3",
    rank: 3,
...
export const howWeEvaluated = [
  ...
  },
  {
    ...
    "description": "explicitly show what changes between the next-lower tier, the mainstream manual converter tier, and the next-higher tier so this page is not a cloned generic ranking."
  },
  {
  ...
  },
  {
    ...
    "description": "judge lift effort/desk footprint, warranty/support, replacement accessories and the chance that a buyer should save money or step up a tier instead of spending the full $300."
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  {
    "subheading": "JOY worker Standing vs VERSADESK PowerPro 36",
    "cards": [
      {
      ...
      {
        "label": "VERSADESK PowerPro 36 Inch Electric Standing Desk Converter,  Push-Button",
    ...
    "note": "Most buyers should default to JOY worker Standing Desk Converter unless your specific use case points toward VERSADESK PowerPro 36 Inch Electric Standing Desk Converter,  Push-Button's particular tradeoffs."
  },
  {
...
export const buyingCriteria = [
  ...
  {
    "criterion": "Define the mainstream manual converter capability floor",
    "explanation": "Define the mainstream manual converter capability floor: The tier should buy materially better surface area, load handling and lift mechanism than entry models. Reject products that meet the price ceiling but fail the core use-case minimum. This matters directly when comparing the picks in this guide, since two products near the same price point often differ meaningfully on this exact point once you look past the headline spec. Check the specific listing for this detail rather than assuming parity across similarly priced options, and weigh it against your actual use case before deciding between two close picks in this price tier."
  },
  {
