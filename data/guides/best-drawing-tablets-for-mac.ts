...
export const guideTitle = "The Best Drawing Tablets for Mac: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 drawing tablets for mac, focused on compatibility, build, features and price, and the trade-offs between them.";
...
export const breadcrumbLabel = "Best Drawing Tablets for Mac";
