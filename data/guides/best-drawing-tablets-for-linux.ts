...
export const guideTitle = "The Best Drawing Tablets for Linux: Our Picks";
...
export const introParagraphs = [
  ...
  "We leaned on documented pen behavior and driver support plus verifying current driver support and connection requirements for this exact host OS to separate capable tablets from well-marketed ones."
];
...
export const metaDescription = "How 6 drawing tablets for linux compare on compatibility, build, features and price, with clear notes on who each one suits.";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07DQK7H15?tag=theofficejournal-20",
    "description": "A distinct touch pad with four customizable touch keys and a gesture pad sets this apart from standard button-only layouts, aimed at younger artists wanting a modern, intuitive control scheme. The battery-free stylus delivers 8192 pressure levels for smooth, natural strokes.\n\nThe 10x6 inch active area is spacious for detailed work, and the reversible Type-C port ensures a stable connection either way it's plugged in. VEIKK backs it with a 1-year hardware warranty, lifetime free driver updates, and includes 8 replacement nibs, an OTG connector, artist glove, and pen pocket.",
    "specs": [
      "10x6in area, touch pad + 4 touch keys",
      "8192 pressure levels",
      "Reversible Type-C, lifetime driver updates"
    ],
    "pros": [
      "Gesture touch pad is a distinct control beyond button keys",
      "Reversible Type-C port connects correctly either way",
      "Lifetime free driver updates back the 1-year warranty"
    ],
    "cons": [
      "No screen, maps to a separate connected display",
      "iPhone/iPad not supported even with OTG connector"
    ],
...
export const breadcrumbLabel = "Best Drawing Tablets for Linux";
