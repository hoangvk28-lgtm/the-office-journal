...
export const faq = [
  {
    ...
    "a": "Only 4 do: the Merax, Softa, KEIKI, and MERITLINE picks each state a fold-down desk or work surface directly on the listing. The two LUXOAK listings and two AMERLIFE listings focus on storage drawers and charging stations, with no desk or work surface mentioned, so treat those 4 as storage-focused murphy beds rather than desk beds."
  },
  {
...
export const guideTitle = "The Best Cabinet Beds with Desks, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to Merax Queen Size Murphy Bed with Desk and Lights unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const metaDescription = "We compared 8 cabinet beds with desks on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Cabinet Beds with Desks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "The Merax queen cabinet bed names a desk directly on the listing and pairs it with built-in lights and a power outlet, which covers the two things a home office desk needs beyond a flat surface. Open storage shelves and drawers give it more organized storage than most murphy beds in this guide, useful for a guest room that doubles as an office.\n\n4 star rating comes from only 4 Amazon ratings, so treat that as an early signal rather than a large sample size. It's also the most expensive pick here, a tradeoff for the combination of confirmed desk, lighting, power outlet, and storage in one unit.",
    "specs": [
    ...
    "cons": [
      ...
      "Queen footprint needs a spacious room"
    ],
  ...
  },
  {
    ...
    "cons": [
      ...
      "Not a fit if a desk is a useful feature"
    ],
  ...
  },
  {
    ...
    "description": "MERITLINE's full-size murphy bed states a desk directly on the listing and adds storage shelves built into a bookcase-style cabinet, which gives it more shelving than most desk-equipped cabinet beds in this guide. The grey finish and full-size footprint suit a smaller guest room or home office better than a queen would.\n\n2 star rating is based on only 4 Amazon ratings, so treat it as an early signal. Pricing was not consistently listed at the time of research, so confirm the current price directly on Amazon before comparing it against the other picks here.\n\nBookcase-style shelving adds more storage than most desk picks here.",
    "specs": [
...
export const breadcrumbLabel = "Best Cabinet Beds with Desks";
