...
export const guideTitle = "The Best Budget Air Quality Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5 PM10 Particle Counter already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "A practical comparison of 8 budget air quality monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Budget Air Quality Monitors for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-air-quality-monitors-for-confined-spaces",
    "title": "Best Air Quality Monitors for Confined Spaces in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Budget Air Quality Monitors";
