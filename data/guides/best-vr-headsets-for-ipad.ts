...
export const guideTitle = "The Best VR Headsets for iPad, Compared";
...
export const metaDescription = "We compared 6 VR headsets for iPad on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best VR Headsets for iPad (2026)";
...
export const breadcrumbLabel = "Best VR Headsets for iPad";
