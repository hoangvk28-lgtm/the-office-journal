...
export const guideTitle = "The Best AOC 4K Monitors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "AOC 27 Inch Computer Monitor 4K UHD IPS HDR Built-in Speakers)",
...
export const metaDescription = "We compared 6 AOC 4K monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best AOC 4K Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Witness virtual worlds come to life on a stunning",
      "Panel resolution 2560x1440",
      "Lightning-fast 180hz"
    ],
    "pros": [
      "Witness virtual worlds come to life on a stunning",
      "Panel resolution 2560x1440",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-thunderbolt-4k-monitors",
    "title": "Best Thunderbolt 4K Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best AOC 4K Monitors";
