...
export const faq = [
  {
    "q": "Does USB-C always mean fast transfer speeds?",
    "a": "No, USB-C is just a connector shape. The actual speed depends on the USB spec implemented behind it, which varies significantly between drives."
  },
  {
    "q": "Can any USB-C cable work with any USB-C drive?",
    "a": "Physically yes, but a cheap or non-compliant cable can bottleneck a fast drive well below its rated speed. Use a cable rated for the same speed tier."
  },
  {
    "q": "Why do two USB-C drives have such different prices?",
    "a": "Often due to different underlying USB speed tiers, durability features like IP ratings, or brand reputation, not the connector itself."
  }
];

export const guideSlug = "best-usb-c-portable-ssds";

export const guideTitle = "The Best USB-C Portable SSDs for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "SANDISK 1TB Extreme Portable SSD fits this specifically: faster USB-C speed tier than standard Gen 2."
      }
    ]
  },
  {
...
export const howWeEvaluated = [
  {
    "title": "Verified actual speed tier behind USB-C",
    "description": "Checked the real USB spec, Gen 2, Gen 2x2, or faster, implemented behind each drive's USB-C connector rather than assuming speed from the connector shape."
  },
  {
    "title": "",
    "description": "Noted that cable quality matters as much as port capability, a non-compliant cable can bottleneck even a fast USB-C drive."
  },
  {
    "title": "",
    "description": "Weighed whether a drive's rated speed requires a specific USB-C host port tier that not every laptop or console has."
  },
  {
    "title": "",
    "description": "Compared IP ratings and build quality as a genuine complement to USB-C speed claims, not a substitute for verified performance."
  }
];
...
export const metaDescription = "We compared 4 USB-C portable SSDs on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best USB-C Portable SSDs for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "2 Gen 2 speed, rated up to 1050MB/s, with IP65 water and dust resistance layered on top.\n\n2 Gen 2 speed tier behind the USB-C connector. On price, it's actually priced above Samsung T7 Portable SSD 1TB Titan Gray, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Sustained speed can dip after cache exhaustion.",
    "specs": [
      "2TB capacity",
    ...
    "pros": [
      "Genuine USB 3.2 Gen 2 speed tier behind the USB-C connector",
      "IP65 rating adds real everyday durability",
      "Large 2TB capacity",
      "Broad compatibility across modern devices"
    ],
    "cons": [
      "Rated speed still requires a matching USB 3.2 Gen 2 host port",
  ...
  },
  {
    ...
    "pros": [
      "Confirmed real USB 3.2 Gen 2 speed tier",
    ...
    "cons": [
      ...
      "1050MB/s ceiling is not the fastest USB-C tier available",
      "Usable capacity reads below the advertised 1TB"
    ],
    "bestFor": "Buyers who want a slim, fast USB-C drive for daily use"
  },
  {
    "id": "b0gmwyyrql-p3",
    "rank": 3,
    ...
    "description": "SanDisk's newer Extreme model steps the USB-C implementation up to 2000MB/s, a faster tier than standard Gen 2, though it still requires a matching host port to deliver that number.\n\nOn the other side, Not every laptop's USB-C port supports this tier.",
    "specs": [
      "1TB capacity",
    ...
    "pros": [
      "faster USB-C speed tier than standard Gen 2",
      "Compact, travel-friendly design",
      "Modern connector with broad device compatibility",
      "Competitive price for the speed tier"
    ],
    "cons": [
      "Needs a fast USB-C host port to hit rated speed",
  ...
  },
  {
    ...
    "description": "2 Gen 2 tier rated up to 800MB/s.\n\nThe real tradeoff against that pick: Lowest speed ceiling of this group despite the same connector. 2 Gen 2 speed at a budget price.\n\nOn the other side, Best suited to everyday files, not large video work.",
    "specs": [
      "1TB capacity",
      "Up to 800MB/s rated",
      "USB-C, USB 3.2 Gen 2",
    ...
    "pros": [
      "Genuine USB 3.2 Gen 2 speed at a budget price",
      "Same USB-C connector as pricier drives",
      "Compact and lightweight"
    ],
    "cons": [
      "Lowest speed ceiling of this group despite the same connector",
      "No official IP rating",
...
export const relatedGuides = [
  {
    "href": "/guide/best-usb-3-2-gen-2-portable-ssds",
    "title": "Best USB 3.2 Gen 2 Portable SSDs in 2026"
  },
  {
...
export const breadcrumbLabel = "Best USB-C Portable SSDs";
