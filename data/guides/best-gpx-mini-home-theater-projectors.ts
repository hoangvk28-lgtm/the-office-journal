...
export const guideTitle = "The Best Gpx Mini Home Theater Projectors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "GPX The Max 1080p Projector with Bluetooth Transmitter)",
...
export const metaDescription = "A practical comparison of 8 gpx mini home theater projectors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Gpx Mini Home Theater Projectors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Up to 140-inch viewable screen size",
      "Projector supports",
      "120 ANSI lumens provides visibility in both"
    ],
    "pros": [
      "Up to 140-inch viewable screen size",
      "Projector supports",
      "120 ANSI lumens provides visibility in both",
      "1280 x 720 native resolution provides"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best Gpx Mini Home Theater Projectors";
