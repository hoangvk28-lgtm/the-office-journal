...
export const guideTitle = "The Best Jackery Portable Power Stations for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Jackery HomePower 3600 Plus Portable Power Station with 2X 200W Solar Panels)",
...
export const metaDescription = "A practical comparison of 8 jackery portable power stations, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Jackery Portable Power Stations for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Effortlessly switch between different charging modes with Jackery’s app",
      "To enjoy the 1-hour super charging",
      "Please provide an actual address for any of your orders"
    ],
    "pros": [
      "Effortlessly switch between different charging modes with Jackery’s app",
      "To enjoy the 1-hour super charging",
  ...
  },
  {
    ...
    "description": "Jackery HomePower 3600 Plus Portable Power Station with 2X 200W Solar Panels is the priciest pick in this lineup. 3% lighter than other models. The homepower 3600 plus and solar panels are shipped separately, and may arrive in separate packages.\n\nAgainst Jackery Explorer 300 Portable Power Station, 292Wh, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nChoose this if you are willing to spend the most in this comparison for the fuller feature set that comes with it. Airlines cap carry-on power banks at 100 watt-hours without prior approval, and 160Wh is the hard ceiling even with permission, so check the Wh rating, not just the mAh number, before flying with one.",
    "specs": [
      "Essential home backup",
      "Safe power that lasts",
      "Easy plug-and-play design"
  ...
  },
  {
    ...
    "specs": [
      ...
      "Charge directly from the sun or via wall outlet",
      "2Kwh - 24kwh flexible expansion"
    ],
    "pros": [
      "Magnificent performance",
      "Charge directly from the sun or via wall outlet",
...
export const breadcrumbLabel = "Best Jackery Portable Power Stations";
