...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-glass-standing-desk";
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-glass-standing-desk` },
    about: [{"@type":"Thing","name":"Glass Standing Desk"},{"@type":"Thing","name":"Tempered Glass Desk"},{"@type":"Thing","name":"Electric Height Adjustable Desk"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Glass Standing Desks", item: `${SITE_URL}/guide/best-glass-standing-desk` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-glass-standing-desk#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Glass Standing Desks</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Glass Standing Desks" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A glass standing desk adds a clean, open aesthetic to a home office while providing a smooth working surface. Tempered safety glass is the standard for all desks in this category.</p>
          <p>This guide covers eight glass standing desks ranked by glass type (clear, frosted, dry-erase white), built-in features (drawer, USB charging, monitor riser, RGB), and price.</p>
          <p>For a solid wood alternative to glass, see our <a href='/guide/best-walnut-standing-desk' className='text-brand hover:underline'>best walnut standing desks</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=glass+standing+desk+electric+tempered&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
