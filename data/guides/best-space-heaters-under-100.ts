...
export const guideTitle = "The Best Space Heaters Under $100, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Small Portable Space Heater for Indoor Use)",
...
export const metaDescription = "We compared 8 space heaters under $100 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Space Heaters Under $100 (2026)";
...
export const breadcrumbLabel = "Best Space Heaters Under $100";
