...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "WHATOOK Small Desk Fan Personal Fans: 5000mah 25 Hours Battery Office Quiet is the best-value option in this roundup, priced lowest without a real capability gap. 100 Wind speeds to meet a variety of needs.silent gears l1-20,to meet the office, sleep.large air volume l50-100,for outdoor camping cooling, personal travel essentials. Battery 2000mah for 10 hours.5000mah for 25 hours.LED display shows remaining power after airflow adjustment.small desk fans can be used when charging.\n\nDesk Fan, Rechargeable Battery Operated, 3 Speeds Ultra Quiet Strong Wind covers similar ground, though whatook adhering to the purpose of quality products and services is what tips the choice one way or the other.\n\nThis fits best if you want a genuinely capable pick without paying for headroom you won't use. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    specs: ["Portable desktop fan", "Long life & battery display", "Pure material & safety"],
    pros: ["Portable desktop fan", "Long life & battery display", "Pure material & safety", "Suitable for bedroom"],
    cons: ["USB-powered models cap out at lower airflow than AC-plugged fans", "Noise rating usually reflects the lowest speed, not daily use"],
  ...
  },
  {
    ...
    specs: ["Viniper brand rechargeable small desk fan operates with 3600mah", "Viniper small desk fan has a strong and stable wind that keeps you cool", "Used high-quality ABS and brushless copper motor"],
    pros: ["Viniper brand rechargeable small desk fan operates with 3600mah", "Viniper small desk fan has a strong and stable wind that keeps you cool", "Used high-quality ABS and brushless copper motor", "Package content"],
    cons: ["Noise rating usually reflects the lowest speed, not daily use", "USB-powered models cap out at lower airflow than AC-plugged fans"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    specs: ["Customizable comfort", "31H long-lasting runtime", "Well-designed fan for bedroom"],
    pros: ["Customizable comfort", "31H long-lasting runtime", "Well-designed fan for bedroom", "No more battery anxiety"],
    cons: ["USB-powered models cap out at lower airflow than AC-plugged fans", "Noise rating usually reflects the lowest speed, not daily use"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "USB-powered (e.g. WHATOOK Small Desk Fan Personal Fans: 5000mah 25 Hours Battery Office Quiet)",
