...
export const guideTitle = "The Best 4K Monitors for Movies, Compared";
...
export const metaDescription = "We compared 6 4K monitors for movies on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 4K Monitors for Movies (2026)";
...
export const breadcrumbLabel = "Best 4K Monitors for Movies";
