export const guideSlug = "best-video-switchers";
export const guideTitle = "8 Best Video Switchers in 2026";
export const metaTitle = "Best Video Switchers";
export const metaDescription = "We compared video switcher models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage floor.";
export const mainKeyword = "video switcher";
export const introParagraphs = [
  "Best Video Switchers span basic to broadcast-grade rigs, which is exactly why connection type changes real performance.",
  "We compared this lineup on documented latency and connectivity, since this is the real gap to watch."
];
