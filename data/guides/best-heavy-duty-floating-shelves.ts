...
export const guideTitle = "The Best Heavy-Duty Floating Shelves for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 heavy-duty floating shelves, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Heavy-Duty Floating Shelves for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Heavy-Duty Floating Shelves";
