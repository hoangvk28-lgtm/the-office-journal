...
export const guideTitle = "The Best 20W Laser Engravers for a Better Desk Setup";
...
export const metaDescription = "We compared 7 20W laser engravers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 20W Laser Engravers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "What sold us on LONGER RAY5 20000mW Laser Engraver 130W CNC Cutter is simple.\n\nIt doesn't stop there either. Longer ray5 20000mw laser engraving and cutting machine is configured with a 400*400mm working area and features an upgraded 240mhz esp32 chipset. 5-inch touchscreen allows for quick and convenient monitoring of engraving progress, adjustment of engraving speed, and other operations. That combination alone makes it worth a second look.",
    "specs": [
      "Longer ray5 20000mw laser engraving machine is equipped with a robust",
      "Longer ray5 laser engraver is paired with advanced built-in 256-color palette,",
      "Longer ray5 20000mw laser engraving and cutting machine is configured"
    ],
    "pros": [
      "Longer ray5 20000mw laser engraving machine is equipped with a robust",
      "Longer ray5 laser engraver is paired with advanced built-in 256-color palette,",
  ...
  },
  {
    ...
    "description": "Dig into the spec sheet and Twotrees TTS-20 Max 20000mW Laser Engraver and Cutter Machine holds up. 5w optical power, forming uniform rectangular tiny spot to deliver clear carving texture. As a practical offline laser engraver, this wood engraving machine supports 3 flexible operation ways, wi-fi wireless transmission, USB wired connection and 4gb TF card offline carving.",
    "specs": [
      "Twotrees tts-20 max desktop laser engraver adopts 450±5nm blue diode laser",
      "As a practical offline laser engraver, this wood engraving machine supports"
    ],
    "pros": [
      "Twotrees tts-20 max desktop laser engraver adopts 450±5nm blue diode laser",
      "As a practical offline laser engraver, this wood engraving machine supports",
...
export const breadcrumbLabel = "Best 20W Laser Engravers";
