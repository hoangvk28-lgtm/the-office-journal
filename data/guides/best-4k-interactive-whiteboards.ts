...
export const faq = [
  {
    ...
    "a": "Many wireless casting protocols compress video to save bandwidth, so content cast from a phone or laptop may not display at the panel's full native 4K resolution even though the panel itself supports it. Wired HDMI or USB-C connections generally preserve full resolution more reliably."
  },
  {
    "q": "7 billion colors noticeable in practice?",
    "a": "It matters more for color-critical work like design review or photo/video content than for typical text and diagram annotation."
  },
  {
...
export const guideTitle = "The Best 4K Interactive Whiteboards for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 4K interactive whiteboards, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4K Interactive Whiteboards for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-interactive-whiteboards",
    "title": "8 Best Interactive Whiteboards in 2026"
  },
  {
  ...
  {
    "href": "/guide/best-display-interactive-whiteboards",
    "title": "8 Best Display Interactive Whiteboards"
  }
];

export const breadcrumbLabel = "Best 4K Interactive Whiteboards";
