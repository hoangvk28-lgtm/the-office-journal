...
export const faq = [
  {
    "q": "Does Plex need hardware transcoding?",
    "a": "For multiple simultaneous streams, yes, software-only transcoding can overwhelm even a fast CPU, verify explicit hardware transcode support like Quick Sync."
  },
  {
    "q": "How many simultaneous Plex streams can a mini PC handle?",
    "a": "This varies meaningfully by chip generation and resolution target, check realistic stream counts rather than assuming unlimited capacity."
  },
  {
    "q": "Do AMD chips support Plex hardware transcoding as well as Intel?",
    "a": "Generally AMD chips have less mature hardware transcode support than Intel Quick Sync, verify this specifically for your chosen chip."
  },
  {
    "q": "How much RAM does a Plex server need?",
    "a": "16GB covers typical single-purpose Plex use, 32GB gives more headroom if you're running other services alongside it."
  }
];

export const guideSlug = "best-mini-pcs-for-plex-servers";

export const guideTitle = "The Best Mini PCs for Plex Servers, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "2 SSD already covers the essentials: low-power embedded chip suited to always-on Plex operation. The main thing you'd be paying extra for elsewhere in this list is headroom you may not need."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Hardware transcode capability weighted over raw CPU benchmarks",
    "description": "Weighted explicit hardware transcode support (like Intel Quick Sync) more heavily than raw CPU benchmark scores, since software-only transcoding can overwhelm even a fast CPU."
  },
  {
    "title": "Realistic simultaneous stream counts considered per chip generation",
    "description": "Considered realistic 1080p and 4K simultaneous stream counts per chip generation rather than assuming unlimited transcoding capacity."
  },
  {
    "title": "RAM headroom weighted for multi-service Plex-plus-server setups",
    "description": "Weighted RAM headroom for buyers wanting to run Plex alongside other services like NAS or home automation simultaneously."
  },
  {
    "title": "Idle power draw considered for always-on media server operation",
    "description": "Considered idle power draw for buyers prioritizing minimal 24/7 energy cost for an always-on Plex server."
  }
];
...
export const metaDescription = "We compared 4 mini PCs for plex servers on compatibility, build, features and price to help you choose the right one for your space.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A well-reviewed build with a large 1TB SSD for media library caching, appropriate for buyers wanting solid all-around Plex server performance.\n\nOn price, it comes in below GMKtec M5 Ultra Gaming Mini PC Ryzen 7 7730U, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Gaming branding suggests this isn't purpose-built for media server use.",
    "specs": [
      "AMD Ryzen 7 7730U",
      "16GB RAM",
      "1TB PCIe SSD",
    ...
    "pros": [
      "1TB SSD for genuine media library caching headroom",
      "16GB RAM covers typical Plex server needs",
      "Efficient U-class chip for always-on operation"
    ],
    "cons": [
      "Verify hardware transcode capability and simultaneous stream counts specifically",
      "AMD chips generally have less mature hardware transcode support than Intel Quick Sync",
      "Gaming branding suggests this isn't purpose-built for media server use"
    ],
  ...
  },
  {
    ...
    "pros": [
      "32GB RAM for running Plex alongside other services simultaneously",
      "Dual NIC networking for combined media and storage server duties",
      "Efficient U-class chip for always-on operation"
    ],
    "cons": [
      "Verify hardware transcode capability and simultaneous stream counts specifically",
      "AMD chips generally have less mature hardware transcode support than Intel",
      "512GB SSD may need expansion for a large media library"
    ],
  ...
  },
  {
    ...
    "description": "On the other side, 256GB SSD is modest for a large local media library.",
    "specs": [
    ...
    "pros": [
      "low-power embedded chip suited to always-on Plex operation",
      "16GB RAM covers typical Plex library indexing needs",
      "low-cost price for a dedicated media server build"
    ],
    "cons": [
      "Verify hardware transcode capability specifically for this chip generation",
      "Limited simultaneous transcode capacity for a lower-power chip",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Fast DDR5 RAM and NVMe storage for responsive library operations",
      "Dual NIC networking for combined media and storage duties"
    ],
    "cons": [
      "Verify hardware transcode capability and simultaneous stream counts specifically",
...
export const relatedGuides = [
  {
    "href": "/guide/best-mini-pcs-for-streaming",
    "title": "Best Mini PCs for Streaming (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Mini PCs for Plex Servers";
