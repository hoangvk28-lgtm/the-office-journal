...
export const guideTitle = "The Best Space Heaters With Thermostat: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 space heaters with thermostat, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Space Heaters With Thermostat (2026)";
...
export const breadcrumbLabel = "Best Space Heaters With Thermostat";
