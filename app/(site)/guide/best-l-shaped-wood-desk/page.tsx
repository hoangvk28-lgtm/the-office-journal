    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best L-shaped wood desks for home office" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>
            ...
            <Link prefetch={false} href="/guide/best-solid-wood-desk" className="text-brand hover:underline">solid wood desk guide</Link>{" "}
            covers the verified hardwood options. For standing desk configurations, the{" "}
            <Link prefetch={false} href="/guide/best-solid-wood-standing-desk" className="text-brand hover:underline">solid wood standing desk guide</Link>{" "}
            covers motorized L-shaped options with real wood tops.
            For rooms too small for an L-shaped desk, the{" "}
            <Link prefetch={false} href="/guide/best-wall-mounted-desks-small-spaces" className="text-brand hover:underline">wall-mounted desks for small spaces</Link>{" "}
            guide covers fold-down and floating wall desk options.
          </p>
        </section>
