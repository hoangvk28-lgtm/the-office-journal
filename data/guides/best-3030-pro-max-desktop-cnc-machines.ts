...
export const guideTitle = "The Best 3030 Pro Max Desktop CNC Machines for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  ...
  "We leaned on documented rigidity and spindle evidence plus verifying exact model generation and travel, since the size-class name alone isn't a technical spec to separate capable machines from well-marketed ones."
];
...
export const metaDescription = "A practical comparison of 3 3030 pro max desktop CNC machines, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 3030 Pro Max Desktop CNC Machines for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0H8DH7B9K?tag=theofficejournal-20",
    "description": "8-inch controllers common on comparable machines. HG15 dual linear rails and 1204 ball screws carry over from the base model.\n\nTrue offline operation lets G-code run directly from the controller, keeping a laptop out of the dusty workshop environment entirely rather than just supplementing PC control. The controller also supports 4-axis operation, worth confirming against your specific rotary accessory before assuming full compatibility.",
    "specs": [
      "7in IPS touchscreen, 1024x600 resolution",
      "710W spindle, ±0.03mm precision",
      "True offline G-code operation"
    ],
    "pros": [
      "7-inch 1024x600 touchscreen is far larger than typical controllers",
      "Runs G-code fully offline, no laptop needed in the workshop",
      "Same 710W spindle and ±0.03mm precision as the base Ultra"
    ],
    "cons": [
      "Touchscreen controller adds real cost over the base model",
      "4-axis support needs confirming against your specific rotary hardware"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D6W7TX1P?tag=theofficejournal-20",
    "description": "03mm precision 3030-PROVer Ultra frame with a 360 x 300 x 12mm MDF grid spoilboard rather than requiring it as a separate purchase later. The spoilboard is explicitly a disposable protective layer, meant to be replaced rather than repaired.\n\nHG15 dual linear rails and 1204 ball screws carry over from the base machine, and the same all-metal chassis targets wobble and vibration under load. Installation is a genuine 2-step process, attach the spoilboard using pre-drilled holes and screws, with no additional configuration required.",
    "specs": [
      "MDF grid spoilboard, 360x300x12mm, included",
      "710W spindle, ±0.03mm precision",
      "2-step spoilboard installation"
    ],
    "pros": [
      "MDF grid spoilboard ships included, not a later purchase",
      "Spoilboard is explicitly disposable, protecting the real machine bed",
      "2-step installation with pre-drilled holes, no extra hardware needed"
    ],
    "cons": [
      "Spoilboard is a consumable that needs periodic replacement",
      "Same core precision as the base Ultra, no additional accuracy gain"
    ],
...
export const breadcrumbLabel = "Best 3030 Pro Max Desktop CNC Machines";
