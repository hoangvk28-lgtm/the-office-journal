...
export const guideTitle = "The Best 2-Channel USB Audio Interfaces for a Better Desk Setup";
...
export const metaDescription = "We compared 8 2-channel USB audio interfaces on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 2-Channel USB Audio Interfaces for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 2-Channel USB Audio Interfaces";
