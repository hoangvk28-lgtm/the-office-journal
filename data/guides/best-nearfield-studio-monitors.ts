...
export const introParagraphs = [
  "Across best nearfield studio monitors, aren't all built the same way, given that differences show up in the fine print.",
...
export const products: GuideProduct[] = [
  {
    id: "best-nearfield-studio-monitors-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-nearfield-studio-monitors-2",
    rank: 2,
  ...
  {
    id: "best-nearfield-studio-monitors-3",
    rank: 3,
  ...
  {
    id: "best-nearfield-studio-monitors-4",
    rank: 4,
  ...
  {
    id: "best-nearfield-studio-monitors-5",
    rank: 5,
  ...
  {
    id: "best-nearfield-studio-monitors-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-nearfield-studio-monitors-7",
    rank: 7,
  ...
  {
    id: "best-nearfield-studio-monitors-8",
    rank: 8,
    badge: "Best Value",
