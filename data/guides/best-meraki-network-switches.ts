...
export const guideTitle = "The Best Cisco Meraki Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 5 cisco meraki network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cisco Meraki Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CH53KS25?tag=theofficejournal-20",
    ...
    "specs": [
      "8-port Gigabit + 2 SFP switch hardware",
      "Renewed condition, unclaimed/no license",
      "Requires separate Meraki license to activate"
    ],
    "pros": [
      "Lowest-cost entry point into Meraki hardware",
      "Smaller commitment for testing the ecosystem"
    ],
    "cons": [
      "Non-functional as a managed switch without a license",
      "Renewed condition, not new hardware"
    ],
...
export const breadcrumbLabel = "Best Cisco Meraki Network Switches";
