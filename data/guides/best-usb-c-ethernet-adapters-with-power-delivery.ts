...
export const faq = [
  ...
  },
  {
    ...
    "a": "The adapter's PD rating is the maximum it can pass through, but you still need a charger and cable both rated for that wattage. A 65W charger plugged into a 140W-rated adapter will only deliver 65W."
  }
];

export const guideSlug = "best-usb-c-ethernet-adapters-with-power-delivery";

export const guideTitle = "The Best USB-C Ethernet Adapters With Power Delivery Worth Considering";
...
export const introParagraphs = [
  "Power Delivery passthrough lets a single USB-C port handle both wired networking and charging at once, a useful workflow for thin laptops and tablets with limited ports, but the PD wattage printed on the box is a ceiling, not a guarantee without a matching charger.",
...
export const metaDescription = "How 7 USB-C ethernet adapters with power delivery compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best USB-C Ethernet Adapters With Power Delivery (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "5Gbps Ethernet with 100W USB-C Power Delivery passthrough for simultaneous charging and networking.\n\nWorks with Thunderbolt, USB4, and USB-C hosts running Windows 10+, M1-M5 and Neo MacBooks with macOS 11+, and ChromeOS, plus mobile devices like iPhone 15/16 Pro/Pro Max.",
    "specs": [
      "2.5Gbps + 100W PD passthrough",
      "MacWorld-recognized budget pick",
      "Windows 10+/macOS 11+/ChromeOS"
    ],
    "pros": [
      "MacWorld-recognized as a top budget 2.5GbE adapter",
      "100W Power Delivery passthrough alongside 2.5Gbps networking",
      "Broad Mac compatibility from M1 through M5 chips",
      "Plugable's 2-year warranty with lifetime support"
    ],
    "cons": [
      "2.5Gbps ceiling, not a multi-gig upgrade path to 5G/10G",
      "Requires a separate PD charger to use the 100W passthrough"
    ],
    "bestFor": "5gbps + 100w pd passthrough"
  },
  {
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D3GZMN8X?tag=theofficejournal-20",
    ...
    "pros": [
      ...
      "Simultaneous 100W charging and Gigabit Ethernet",
      "18-month unconditional warranty",
      "Braided cable and aluminum casing for durability"
    ],
    "cons": [
      "Note if charging isn't reaching maximum rate, host protocol support should be checked first",
      "Requires CAT6+ cable for full Gigabit speed"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D2RHMDTP?tag=theofficejournal-20",
    ...
    "specs": [
      "10/100/1000Mbps + 100W PD",
      "LED network status indicator",
      "Chromecast with Google TV compatible"
    ],
    "pros": [
      "Lowest price among the 100W PD Ethernet adapters in this cluster",
      "LED indicator shows network status at a glance",
      "Explicit Chromecast with Google TV compatibility",
      "Durable nylon cable and aluminum exterior"
    ],
    "cons": [
      "Explicitly not compatible with Nintendo Switch",
      "Fewer brand-warranty details published than Cable Matters or Belkin"
    ],
...
export const breadcrumbLabel = "Best USB-C Ethernet Adapters With Power Delivery";
