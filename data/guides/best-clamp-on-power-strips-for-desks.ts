...
export const faq = [
  {
    "q": "Will a clamp-on power strip fit any desk?",
    "a": "No, clamp mounts are rated for a specific desk edge thickness range. Measure your desk's edge and compare it against the clamp's stated range, glass, thin folding tables, and thick industrial desks all differ."
  },
  {
    "q": "Can I use a clamp-on power strip with a monitor arm at the same desk edge?",
    "a": "Check for space conflicts first. Clamp-mounted power strips compete for the same desk-edge space as monitor arms and keyboard trays, a desk already using clamped accessories may not have room for another."
  },
  {
    "q": "Does a clamp-on power strip damage the desk?",
    "a": "The clamp torque needed for secure mounting can mark or dent softer desk surfaces like laminate or painted wood, check reviews for damage reports on your specific desk material."
  },
  {
    "q": "How much USB charging wattage do I need from a clamp-on strip?",
    "a": "It depends on how many devices you charge simultaneously. For multiple laptops or tablets, look for combined wattage of 40W or more, like the top two picks in this guide."
  }
];

export const guideSlug = "best-clamp-on-power-strips-for-desks";

export const guideTitle = "The Best Clamp-On Power Strips for Desks: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    "title": "Desk edge thickness compatibility explicitly disclosed",
    "description": "Prioritized picks that state their exact desk edge thickness range upfront, since clamp mounts are rated for a specific range that doesn't universally fit every desk type."
  },
  {
    "title": "Combined USB wattage and port count for real charging needs",
    "description": "Compared total USB wattage and port count across picks, since a clamp-on strip's value often comes from charging multiple devices from a single mounted position."
  },
  {
    "title": "Clamp mounting conflict awareness with other desk accessories",
    "description": "Noted that clamp-mounted power strips compete for the same desk-edge space as monitor arms and keyboard trays, a real installation consideration for buyers with existing clamped accessories."
  }
];
...
export const metaDescription = "A practical comparison of 5 clamp-on power strips for desks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Clamp-On Power Strips for Desks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "96 inch tabletop edge, useful for verifying your specific desk's thickness before ordering rather than guessing. 5 outlets plus 4 USB-C PD ports for a well-rounded desk clamp setup.\n\nExplicit desk edge thickness rating stated upfront. On price, it comes in below Jgstkcity Desk Clamp Power Strip, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Clamp torque needed may mark softer desk finishes.",
    "specs": [
      "Fits up to 1.96in desk edge",
      "5 outlets, 4 USB-C PD ports (40W total)",
      "ETL listed",
      "Desk edge clamp mount"
    ],
    "pros": [
      "Explicit desk edge thickness rating stated upfront",
      "5 outlets plus 4 USB-C PD ports",
      "ETL listed",
      "Solid rating base"
    ],
    "cons": [
      "May conflict with other clamp-mounted accessories at the same edge",
      "Higher price than basic clamp strips",
      "Clamp torque needed may mark softer desk finishes"
    ],
  ...
  },
  {
    ...
    "pros": [
      ...
      "8 total USB ports for multi-device charging",
      "ETL listed",
      "Genuine desk mount clamp design"
    ],
    "cons": [
      "Higher price",
      "Verify desk edge thickness compatibility separately"
    ],
  ...
  },
  {
    ...
    "description": "A more affordable clamp-on option with 30W PD charging, appropriate if you don't need the higher-wattage multi-port capacity of the premium picks. Surge protector included for real electrical safety.\n\nOn the other side, Verify desk edge compatibility before ordering.",
    "specs": [
      "30W PD charging",
    ...
    "pros": [
      "More affordable than the premium clamp picks",
      "Surge protector included",
      "Solid early rating",
  ...
  },
  {
    ...
    "description": "3 outlets and 4 USB ports cover basic desk needs.\n\nThe real tradeoff against that pick: Fewer outlets than dedicated clamp picks.\n\nOn the other side, Verify mount mechanism fits your desk edge.",
    "specs": [
    ...
    "pros": [
      "Very affordable",
      "4 USB ports for basic charging needs",
      "Compact design"
    ],
    "cons": [
      "Fewer outlets than dedicated clamp picks",
      "No USB-C PD fast charging",
      "Verify mount mechanism fits your desk edge"
    ],
  ...
  },
  {
    ...
    "description": "Not a true clamp-mount design, but worth considering if you need 12 outlets and a heavy-duty 3,780 joule rating more than a desk-edge clamp specifically. UL listed from an established brand.\n\nOn the other side, Higher price than basic clamp picks.",
    "specs": [
    ...
    "cons": [
      ...
      "Higher price than basic clamp picks"
    ],
...
export const breadcrumbLabel = "Best Clamp-On Power Strips for Desks";
