...
export const guideTitle = "8 Best Toshiba Dehumidifiers in 2026";
export const metaTitle = "Best Toshiba Dehumidifiers";
export const metaDescription = "We compared toshiba dehumidifier models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    pros: ["Quickly removes excess moisture from basements, bathrooms, bedrooms, rvs", "90° auto swing airflow for even coverage", "Unlike many standard dehumidifiers limited to a minimum of 40%", "Intelligent sensing technology, this dehumidifier detects frost buildup"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Mid-range pick",
          "Dehumidifier, 4500 Sq.Ft Dehumidifier for Basement, with Drain Hose, Humidity"
        ],
        [
          "Higher budget",
          "Waykar 80 Pints 5000 Sq. Ft 2025 Energy Star Dehumidifier for Basement"
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Manual tank emptying (e.g. Waykar 34 Pints 2000 Sq. Ft. 2025 Energy Star Dehumidifier for Home)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "You're covering a small, moderately damp room, where Waykar 34 Pints 2000 Sq. Ft. 2025 Energy Star Dehumidifier for Home already covers the job at the lowest price here."
      }
    ]
  }
];
