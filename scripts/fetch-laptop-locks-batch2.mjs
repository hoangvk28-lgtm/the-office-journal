...
const raw = readFileSync(resolve(ROOT, "scripts", "unique_asins_laptop-locks-batch2.txt"), "utf-8");
...
writeFileSync(resolve(ROOT, "scripts", "data-laptop-locks-batch2.json"), JSON.stringify(allItems, null, 2), "utf8");
...
for (const a of missing) {
  lookup[a] = { title: null, price: null, image: null, rating: null, reviewCount: null, MISSING: true };
}
writeFileSync(resolve(ROOT, "scripts", "lookup-laptop-locks-batch2.json"), JSON.stringify(lookup, null, 2), "utf8");
console.log("Saved to scripts/data-laptop-locks-batch2.json and scripts/lookup-laptop-locks-batch2.json");
