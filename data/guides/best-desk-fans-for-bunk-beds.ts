...
export const guideTitle = "The Best Desk Fans for Bunk Beds: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Genesis 6-Inch Clip Convertible Table-Top & Clip Fan Two Quiet Speeds)",
...
export const metaDescription = "A practical comparison of 8 desk fans for bunk beds, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Desk Fans for Bunk Beds (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Adjustable wind speed and light modes",
      "Quiet operation"
    ],
    "pros": [
      "Rechargeable battery",
  ...
  },
  {
    ...
    "specs": [
      "Diminutive yet strong",
      "Mount anywhere",
      "Customizable inclination"
    ],
    "pros": [
      "Diminutive yet strong",
      "Mount anywhere",
      "Customizable inclination",
      "Pair of speed options"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
...
export const breadcrumbLabel = "Best Desk Fans for Bunk Beds";
