...
export const guideTitle = "The Best VR Headsets for Linux, Compared";
...
export const metaDescription = "We compared 6 VR headsets for linux on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best VR Headsets for Linux (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-meta-vr-headsets",
    "title": "Best Meta VR Headsets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best VR Headsets for Linux";
