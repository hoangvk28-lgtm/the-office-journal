...
export const introParagraphs = [
  "Best Refurbished VR Headsets aren't always interchangeable, so refurbished vr headsets, one spec isn't enough.",
  "refurbished vr headsets picks split on true IPD fit, since weight distribution matters more than total weight."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-refurbished-vr-headsets-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-refurbished-vr-headsets-2",
    rank: 2,
  ...
  {
    id: "best-refurbished-vr-headsets-3",
    rank: 3,
  ...
  {
    id: "best-refurbished-vr-headsets-4",
    rank: 4,
  ...
  {
    id: "best-refurbished-vr-headsets-5",
    rank: 5,
  ...
  {
    id: "best-refurbished-vr-headsets-6",
    rank: 6,
    badge: "Worth a Look",
