...
export const guideTitle = "The Best QIDI 3D Printers for a Better Desk Setup";
...
export const metaDescription = "We compared 6 QIDI 3D printers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best QIDI 3D Printers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Unlock multi-colorl, multi-material creations with the qidi q2 combo and its high-performance qidi box",
  ...
  },
  {
    ...
    "specs": [
      "Massive build volume for large-scale 3D printing",
      "Effortless for engineering-grade filaments",
      "Qidi plus 5 3D printer is rigid corexy structure"
    ],
    "pros": [
      "Massive build volume for large-scale 3D printing",
      "Effortless for engineering-grade filaments",
  ...
  },
  {
    ...
    "specs": [
      "Why choose qidi q2?",
      "Q2 nozzle acts as the leveling sensor",
      "Q2 all-in-one performance, speed & quality"
    ],
    "pros": [
      "Why choose qidi q2?",
      "Q2 nozzle acts as the leveling sensor",
      "Q2 all-in-one performance, speed & quality",
      "Unlock multi-color & multi-material"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "specs": [
      ...
      "Rapid 15-minute setup"
    ],
    "pros": [
      "High precision & high stability",
      "Outstanding performance",
      "Rapid 15-minute setup",
      "Open-source foundation, the q2c empowers you to tailor both features and settings"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-dual-nozzle-3d-printers",
    "title": "Best Dual-Nozzle 3D Printers in 2026"
  },
  {
    "href": "/guide/best-3d-printers-for-beginners",
    "title": "Best 3D Printers for Beginners in 2026"
  }
];

export const breadcrumbLabel = "Best QIDI 3D Printers";
