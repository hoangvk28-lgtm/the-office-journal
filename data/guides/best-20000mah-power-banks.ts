...
export const guideTitle = "The Best 20000mAh Power Banks for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "RONEGN Portable Charger with Built in Cable 20000mAh Fast Charging)",
...
export const metaDescription = "We compared 8 20000mAh power banks on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 20000mAh Power Banks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "30% Smaller, effortlessly portable",
      "15 Mins faster with 45w charging",
      "2-Day power, zero battery anxiety"
    ],
    "pros": [
      "30% Smaller, effortlessly portable",
      "15 Mins faster with 45w charging",
  ...
  },
  {
    ...
    "specs": [
      "Wallet-sized laptop power packs a massive",
      "65W triple-port charging fuel your entire setup",
      "Detachable lanyard cable features a 100% detachable"
    ],
    "pros": [
      "Wallet-sized laptop power packs a massive",
      "65W triple-port charging fuel your entire setup",
      "Detachable lanyard cable features a 100% detachable",
      "All-weekend energy core high-capacity"
    ],
    "cons": [
      "Capacity above 100Wh needs airline approval or can't fly at all",
      "Real-world output is usually lower than the advertised mAh figure"
  ...
  },
  {
    ...
    "pros": [
      ...
      "USB c and ios fast charging power bank",
      "Charge multiple devices simultaneously",
      "Slim pocket size portable charger"
    ],
    "cons": [
      "Real-world output is usually lower than the advertised mAh figure",
      "Capacity above 100Wh needs airline approval or can't fly at all"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Built-in 4 cables",
      "Charge 6 devices at once",
      "20W pd fast charging & dual USB-C"
    ],
    "cons": [
      "Capacity above 100Wh needs airline approval or can't fly at all",
      "Real-world output is usually lower than the advertised mAh figure"
  ...
  },
  {
    ...
    "description": "5W Power Bank Built in Cable and Wall Plug is a strong alternative worth comparing directly against the top pick. This 20000mAh portable charger with foldable wall plug is essential travel gear. 5w fast charging, hitting 60% power in 30 mins on the move.\n\nSide by side with INIU Portable Charger, the real difference worth noting is compared with conventional 20000mAh power banks, our built-in battery cell pack is 30% more compact.\n\nThis one is the right call if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The mAh figure on the box is measured at the battery's internal voltage, not the 5V your phone actually charges at, so the real usable charge is meaningfully lower than the advertised number suggests.",
    "specs": [
      "20000mAh portable charger with foldable wall plug is essential travel gear",
      "Cp4 power bank offers 22.5w fast charging",
      "Precise LED display & 15-layer safety protection"
    ],
    "pros": [
      "20000mAh portable charger with foldable wall plug is essential travel gear",
      "Cp4 power bank offers 22.5w fast charging",
...
export const breadcrumbLabel = "Best 20000mAh Power Banks";
