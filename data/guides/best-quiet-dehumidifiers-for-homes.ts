export const guideSlug = "best-quiet-dehumidifiers-for-homes";
export const guideTitle = "8 Best Quiet Dehumidifiers for Homes in 2026";
export const metaTitle = "Best Quiet Dehumidifiers for Homes";
export const metaDescription = "We compared quiet dehumidifier for home models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "quiet dehumidifier for home";
export const introParagraphs = [
  "Best Quiet Dehumidifiers for Homes cover a wide capacity range. That means marketing copy alone is risky.",
  "This roundup weighs honest coverage and drain reliability, given that marketing copy tends to obscure this."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-quiet-dehumidifiers-for-homes-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-quiet-dehumidifiers-for-homes-2",
    rank: 2,
  ...
  {
    id: "best-quiet-dehumidifiers-for-homes-3",
    rank: 3,
  ...
  {
    id: "best-quiet-dehumidifiers-for-homes-4",
    rank: 4,
  ...
  {
    id: "best-quiet-dehumidifiers-for-homes-5",
    rank: 5,
  ...
  {
    id: "best-quiet-dehumidifiers-for-homes-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-quiet-dehumidifiers-for-homes-7",
    rank: 7,
  ...
  {
    id: "best-quiet-dehumidifiers-for-homes-8",
    rank: 8,
    badge: "Best Value",
