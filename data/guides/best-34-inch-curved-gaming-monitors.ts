...
export const guideTitle = "The Best 34-Inch Curved Gaming Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "CRUA 34\" WQHD 165Hz Ultrawide Curved Gaming Monitor)",
...
export const metaDescription = "A practical comparison of 6 34-inch curved gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 34-Inch Curved Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Crua 34-inch monitor (3440×1440p) 21:9 1500r design fills",
      "Ultrawide computer monitor combines a refresh rate of 165hz",
      "1500R curved gaming monitor: crua curved monitors boast"
    ],
    "pros": [
      "Crua 34-inch monitor (3440×1440p) 21:9 1500r design fills",
      "Ultrawide computer monitor combines a refresh rate of 165hz",
...
export const breadcrumbLabel = "Best 34-Inch Curved Gaming Monitors";
