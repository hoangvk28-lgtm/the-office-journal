...
export const guideTitle = "The Best Crestron Video Switchers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "RGBlink Mini V3 Video Switcher with Customizable Features via TAO Cloud, 4K)",
...
export const metaDescription = "A practical comparison of 8 crestron video switchers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Crestron Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Crestron Video Switchers";
