...
export const guideTitle = "The Best Ring Lights for Home Offices";
...
export const metaDescription = "How 8 ring lights compare on brightness, color temperature, adjustability and power, with clear notes on who each one suits.";

export const metaTitle = "Best Ring Lights for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Ring Lights";
