...
export const guideTitle = "The Best 8-Port PoE Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 5 8-port PoE network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 8-Port PoE Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07788WK5V?tag=theofficejournal-20",
    ...
    "specs": [
      "8x PoE+ ports @123W total",
      "Desktop, wall, or rack mount",
      "Fanless, unmanaged"
    ],
    "pros": [
      "123W budget among the strongest 8-port options here",
      "Flexible mounting including rack option",
      "Zero-configuration setup"
    ],
    "cons": [
      "No management interface",
      "Higher price than lower-wattage 8-port PoE switches"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07KPLZ5Q2?tag=theofficejournal-20",
    ...
    "specs": [
      ...
      "Automatic PD detection"
    ],
    "pros": [
      "Rack ears included at a budget price point",
      "120W budget solid for 8 PoE+ devices",
      "Automatic PD detection protects non-PoE gear"
    ],
    "cons": [
      "Does not support 24V passive PoE like some Ubiquiti APs",
...
export const breadcrumbLabel = "Best 8-Port PoE Network Switches";
