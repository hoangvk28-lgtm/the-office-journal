...
export const guideTitle = "The Best Microphone Arms for Blue Yeti, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Microphone Stand for Blue Yeti)",
...
export const metaDescription = "We compared 8 microphone arms for blue yeti on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Microphone Arms for Blue Yeti (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Universal compatibility& comprehensive protection",
      "Heavy-duty structure mic stand",
      "Double screen pop filters"
    ],
    "pros": [
      "Universal compatibility& comprehensive protection",
      "Heavy-duty structure mic stand",
  ...
  },
  {
    ...
    "specs": [
      "High quality foam microphone windscreen",
      "Heavy duty construction mic stand",
      "Double layered screen pop filters"
    ],
    "pros": [
      "High quality foam microphone windscreen",
      "Heavy duty construction mic stand",
  ...
  },
  {
    ...
    "description": "Microphone Stand for Blue Yeti is a low-cost pick that doesn't skip the essentials. Professional recording studio equipment with adjustable microphone stand, adjustable shock mount, double layer pop filter, screw adapter, microphone shock mount, table mounting clamp with sponge pad. Strong compatibility and applicability microphone arm: luling arts mic arm could compatible with the blue yeti, snowball or mount most standard-sized microphones.\n\nReach for this pick if you want a capable pick without paying for headroom you won't use. Most clamps handle roughly 15 to 60mm of desk thickness, so measure your desk's edge before assuming any arm's included clamp will actually fit.",
    "specs": [
      "Professional adjustable microphone stand",
      "Strong compatibility and applicability microphone arm",
      "Upgraded table mounting clamp"
    ],
    "pros": [
      "Professional adjustable microphone stand",
      "Strong compatibility and applicability microphone arm",
      "Upgraded table mounting clamp",
      "Excellent shock mount effect"
    ],
    "cons": [
      "Requires a desk edge thin enough for the included clamp",
      "Cheaper springs can sag over time with heavier microphones"
...
export const breadcrumbLabel = "Best Microphone Arms for Blue Yeti";
