export const guideSlug = "best-rolling-storage-carts";
export const guideTitle = "8 Best Rolling Storage Carts in 2026";
export const metaTitle = "Best Rolling Storage Carts";
export const metaDescription = "We compared storage cart rolling models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "storage cart rolling";
export const introParagraphs = [
  "Across best rolling storage carts, vary more than the keyword suggests, given that the real gap is in the details.",
...
export const products: GuideProduct[] = [
  {
    id: "best-rolling-storage-carts-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-rolling-storage-carts-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-rolling-storage-carts-3",
    rank: 3,
  ...
  {
    id: "best-rolling-storage-carts-4",
    rank: 4,
  ...
  {
    id: "best-rolling-storage-carts-5",
    rank: 5,
  ...
  {
    id: "best-rolling-storage-carts-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-rolling-storage-carts-7",
    rank: 7,
  ...
  {
    id: "best-rolling-storage-carts-8",
    rank: 8,
