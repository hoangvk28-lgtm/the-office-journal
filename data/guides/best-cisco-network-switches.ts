...
export const guideTitle = "The Best Cisco Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 5 cisco network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cisco Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B076DDXB2W?tag=theofficejournal-20",
    "description": "Unlike most Meraki listings on Amazon, this MS120-24P bundle includes a 5-year Meraki license, meaning the cloud dashboard, automatic firmware updates, and remote packet capture tools work immediately without a separate licensing purchase.\n\n1X authentication for enterprise-grade access control, positioned as the rare Amazon Meraki listing that's actually plug-and-manage rather than hardware-only.",
    "specs": [
      "24-port PoE+, 5-year license included",
      "SNMP/Syslog, 802.1X authentication",
      "Cloud-managed via Meraki dashboard"
    ],
    "pros": [
      "Rare Amazon Meraki listing with license included",
      "5-year license removes a major hidden cost",
      "802.1X authentication for real access control"
    ],
    "cons": [
      "Still tied to Meraki's cloud dashboard dependency",
      "License expires after 5 years requiring renewal"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B079J6NWX1?tag=theofficejournal-20",
    ...
    "specs": [
      "48 Gigabit PoE ports, 740W (FP model)",
      "Stacks up to 8 units, 80Gbps stacking",
      "Cloud-managed via Meraki dashboard"
    ],
    "pros": [
      "True hardware stacking up to 8 units",
      "Zero-touch provisioning at scale",
      "740W PoE budget covers a full high-draw fleet"
    ],
    "cons": [
      "Requires a separate, recurring Meraki license to function",
      "Hardware-only listing, easy to misjudge total cost"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CH8NLKLF?tag=theofficejournal-20",
    ...
    "specs": [
      "48-port PoE+ switch hardware",
      "Renewed condition, unclaimed/no license",
      "Requires separate Meraki license to activate"
    ],
    "pros": [
      "Lower hardware cost than a new licensed unit",
      "Full 48-port PoE+ capacity once licensed"
    ],
    "cons": [
      "Non-functional as a managed switch without a purchased license",
      "Renewed condition, not new hardware"
    ],
  ...
  },
  {
    ...
    "reviews": null,
    "imageUrl": "https://m.media-amazon.com/images/I/318AC3HtH0L._SL500_.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0CB1KKNK8?tag=theofficejournal-20",
    ...
    "specs": [
      "24-port PoE+ switch hardware",
      "Renewed condition, unclaimed/no license",
      "Requires separate Meraki license to activate"
    ],
    "pros": [
      "Lower upfront cost than the licensed bundle",
      "Same hardware as the licensed MS120-24P"
    ],
    "cons": [
      "Non-functional without a separately purchased license",
      "Renewed condition, not new hardware"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CMY2GT1G?tag=theofficejournal-20",
    ...
    "specs": [
      "32x 40GB QSFP+ + 4x 10GB SFP+, renewed",
      "Back-to-front airflow, rack-mount",
      "Data-center-class switching"
    ],
    "pros": [
      "Massive 40G port density for the price of renewed hardware",
      "Data-center-grade build and airflow design",
      "Genuine Arista EOS software"
    ],
    "cons": [
      "Overkill and power-hungry for typical SMB use",
      "Loud active cooling built for data center noise floors"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-meraki-network-switches",
    "title": "Best Cisco Meraki Network Switches in 2026"
  },
  {
    "href": "/guide/best-arista-network-switches",
    "title": "3 Best Arista Network Switches in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Cisco Network Switches";
