export const guideSlug = "best-storage-carts-under-150";
export const guideTitle = "8 Best Storage Carts Under $150 in 2026";
export const metaTitle = "Best Storage Carts Under $150";
export const metaDescription = "We compared storage cart under $150 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "storage cart under $150";
export const introParagraphs = [
  "Best Storage Carts Under $150 differ more than titles suggest, so price alone misses what matters.",
  "Every pick here was judged on verified capacity, not marketing claims, because this predicts real daily durability."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-storage-carts-under-150-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-storage-carts-under-150-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-storage-carts-under-150-3",
    rank: 3,
  ...
  {
    id: "best-storage-carts-under-150-4",
    rank: 4,
  ...
  {
    id: "best-storage-carts-under-150-5",
    rank: 5,
  ...
  {
    id: "best-storage-carts-under-150-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-storage-carts-under-150-7",
    rank: 7,
  ...
  {
    id: "best-storage-carts-under-150-8",
    rank: 8,
