...
export const faq = [
  {
    "q": "Does a smaller air purifier clean air slower than a larger one?",
    "a": "A small footprint often comes with a smaller fan and less filter surface area, meaning a lower CADR than the compact size alone would suggest, check the disclosed coverage rating."
  },
  {
    "q": "Can a small air purifier cover my whole studio apartment?",
    "a": "Desktop-sized units are appropriate for a single small room or a desk zone specifically, not a whole small apartment, that's a common scope mismatch leading to disappointing results."
  },
  {
    "q": "What should I check before buying a compact air purifier?",
    "a": "Verify it has a genuine disclosed coverage or CADR rating rather than assuming its small size alone implies adequate performance for your specific room."
  },
  {
    "q": "Should I buy one compact unit or several for a small multi-room apartment?",
    "a": "A studio or small apartment with multiple distinct areas typically does better with one compact unit per room than a single unit expected to cover everything."
  }
];

export const guideSlug = "best-small-air-purifiers";

export const guideTitle = "The Best Small Air Purifiers for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "CADR relative to compact footprint",
    "description": "Considered that a small footprint often comes with a smaller fan and less filter surface area, meaning a lower CADR than the compact size alone would suggest."
  },
  {
    "title": "Realistic scope: single room versus whole apartment",
    "description": "Weighed that desktop-sized units are appropriate for a single small room or a desk zone specifically, not a whole small apartment."
  },
  {
    "title": "Disclosed coverage rating verified against claims",
    "description": "Checked whether each pick published a genuine coverage or CADR figure rather than relying on compact size alone to imply adequate performance."
  }
];

export const introParagraphs = [
  "A small footprint often comes with a smaller fan and less filter surface area, meaning a lower CADR (Clean Air Delivery Rate) than the compact size alone would suggest, worth checking the actual coverage rating rather than assuming small equals sufficient.",
...
export const metaDescription = "A practical comparison of 5 small air purifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Small Air Purifiers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Genuine disclosed coverage rating for its compact size",
      "Explicit 0.1-micron removal specification",
      "Marketed for multiple issues (allergies, pets, smoke, odors)",
      "Reasonable price"
    ],
    "cons": [
      "Lower average rating than other picks in this guide",
      "Not intended for a whole small apartment"
    ],
    "bestFor": "Buyers wanting a compact unit with a disclosed coverage rating"
  },
  {
    ...
    "description": "Desktop and small-room units like this are appropriate for a single space specifically, not a whole small apartment, match your expectation to that scope.\n\nCompact footprint fits a small room or desk zone. That said, not rated for a whole small apartment.",
    "specs": [
    ...
    "pros": [
      "Compact footprint fits a small room or desk zone",
      "Certified True HEPA H13 filtration",
      "Very quiet at 24dB"
    ],
    "cons": [
      "Not rated for a whole small apartment",
      "No smart app control",
      "Standard CADR, not the highest airflow pick here"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DCBC8KKV?tag=theofficejournal-20",
    "description": "Check the disclosed coverage rating against your actual room size before buying, a small footprint here does correspond to a smaller-room CADR rather than an oversized promise.",
    "specs": [
      "HEPA filtration",
      "Compact footprint",
      "low-cost"
    ...
    "pros": [
      "Affordable price for a compact unit",
      "Compact footprint fits a small room",
      "Reasonable performance for its size"
    ],
    "cons": [
      "Lower CADR than larger-footprint alternatives",
      "Not intended for an open-plan or larger space",
      "Fewer smart features than premium picks"
    ],
    "bestFor": "Budget-conscious buyers with a small single room"
  },
  {
    "id": "mooka-small2",
    "rank": 4,
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08PJQ3MWB?tag=theofficejournal-20",
    "description": "A small footprint often means a smaller fan and less filter surface area, resulting in a lower CADR, this unit is best matched to a desk-zone scope rather than a full small bedroom.",
    "specs": [
    ...
    "pros": [
      "Lowest price in this guide",
      "Very compact, fits on a desk",
      "Good value for a desk-zone unit"
    ],
    "cons": [
      "Lower CADR appropriate only for a desk zone, not a full room",
      "No smart features",
      "Basic filtration compared to premium picks"
    ],
  ...
  },
  {
    ...
    "description": "Match your expectation of coverage to this unit's actual rated small-room size, not a whole apartment, for realistic results.\n\nThe standout detail is that compact footprint for a small room. Balancing that out, not rated for a whole small apartment.",
    "specs": [
    ...
    "pros": [
      "Compact footprint for a small room",
      "True HEPA filtration",
      "Reasonable price"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best Small Air Purifiers";
