...
export const faq = [
  {
    "q": "Do I need to reformat a new SSD to use it with my Mac?",
    "a": "For Time Machine specifically, yes, reformat to APFS through Disk Utility. For general file transfer, the default exFAT format already works fine on Mac."
  },
  {
    "q": "What speed do I actually need for Time Machine?",
    "a": "Sustained write consistency matters more than peak speed. 2 Gen 2 drive rated around 1050MB/s is sufficient for most Time Machine setups."
  },
  {
    "q": "Can I use the same drive for both Mac and Windows?",
    "a": "Yes, if you keep it formatted in exFAT, though Time Machine specifically requires APFS, which is not natively readable on Windows."
  }
];

export const guideSlug = "best-portable-ssds-for-mac-and-macbook";

export const guideTitle = "The Best Portable SSDs for Mac and MacBook, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Corsair EX400U Survivor 1TB USB4 External SSD fits this specifically: fast USB4 speed for Thunderbolt-equipped MacBooks."
      }
    ]
  },
  {
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Noted that every pick ships pre-formatted for Windows and needs a one-time APFS reformat through Disk Utility for native Time Machine use."
  },
  {
    "title": "Sustained speed for backup consistency",
    "description": "Weighted sustained write consistency over peak burst speed, since Time Machine backups benefit more from steady performance over time."
  },
  {
    "title": "",
    "description": "Compared each drive's required interface tier against typical MacBook USB-C, USB4, and Thunderbolt port capabilities."
  },
  {
    "title": "Everyday durability for mobile Mac use",
    "description": "Weighed build quality and IP or rugged ratings for MacBook users who carry a drive between locations."
  }
];
...
export const metaDescription = "We compared 4 portable SSDs for mac and MacBook on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Portable SSDs for Mac and MacBook (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "2 Gen 2 speed, a reliable everyday companion for MacBook users who want durability alongside solid transfer performance.\n\nRugged shell suits MacBook users on the go. On price, it's actually priced above Corsair EX400U Survivor 1TB USB4 External SSD, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Sustained speed can dip once cache fills.",
    "specs": [
      "1TB capacity",
    ...
    "pros": [
      "Rugged shell suits MacBook users on the go",
      "Reliable, well-reviewed platform",
      "Realistic USB 3.2 Gen 2 speed ceiling",
      "Good sustained-speed reputation among reviewers"
    ],
    "cons": [
      "Ships pre-formatted for Windows, needs APFS reformatting for Time Machine",
  ...
  },
  {
    ...
    "description": "Corsair's EX400U Survivor uses a genuine USB4 bridge rated up to 4000MB/s, a speed tier that MacBooks with Thunderbolt or USB4 ports can take advantage of.\n\nOn the other side, Requires APFS reformatting for native Time Machine use.",
    "specs": [
      "1TB capacity",
    ...
    "pros": [
      "fast USB4 speed for Thunderbolt-equipped MacBooks",
    ...
    "cons": [
      "Needs a genuine Thunderbolt or USB4 MacBook port to matter",
      "Requires APFS reformatting for native Time Machine use"
    ],
  ...
  },
  {
    ...
    "description": "2 Gen 2 speed as the Shield in a slimmer, lighter body better suited to minimalist MacBook setups.\n\nOn the other side, 1050MB/s ceiling is not the fastest tier available.",
    "specs": [
      "1TB capacity",
      "Up to 1050MB/s rated",
      "USB 3.2 Gen 2",
    ...
    "pros": [
      "Slim, lightweight design pairs well with a MacBook",
      "Reliable, widely reviewed platform",
      "Good sustained speed for everyday backup use",
      "Comes in multiple colors"
    ],
    "cons": [
      "No official IP rating",
      "Ships pre-formatted for Windows, needs APFS reformatting",
  ...
  },
  {
    ...
    "description": "2, a genuine step up for MacBook users doing video work who do not have a Thunderbolt or USB4 port.\n\nThe real tradeoff against that pick: Needs a matching high-speed MacBook port to hit rated speed.\n\nOn the other side, Ships pre-formatted for Windows, needs APFS reformatting.",
    "specs": [
      "1TB capacity",
    ...
    "pros": [
      ...
      "Durable casing for mobile MacBook use",
      "Competitive price for the speed tier",
      "Good fit for MacBook video work without Thunderbolt"
    ],
    "cons": [
      "Needs a matching high-speed MacBook port to hit rated speed",
      "Ships pre-formatted for Windows, needs APFS reformatting"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-portable-ssds-for-macbook-pro",
    "title": "Best Portable SSDs for MacBook Pro in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Portable SSDs for Mac and MacBook";
