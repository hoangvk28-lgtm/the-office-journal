...
export const guideTitle = "The Best 5-Inch Studio Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 8 5-inch studio monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 5-Inch Studio Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 5-Inch Studio Monitors";
