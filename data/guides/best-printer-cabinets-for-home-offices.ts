...
export const guideTitle = "The Best Printer Cabinets for Home Offices, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to SISESOL 2 Drawer File Cabinet with Lock unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    ...
    "description": "Checked whether each pick is an enclosed cabinet with doors or an open-top file cabinet with a flat printer-ready surface, and described each one accurately rather than assuming 'cabinet' means fully sealed."
  },
  {
    "title": "",
...
export const introParagraphs = [
  ...
  "Below are 8 printer cabinets for home offices we compared on enclosure type, ventilation, interior height for scanner lids, and honest labeling, since several of the picks in this category are actually mobile file cabinets with an open top rather than fully enclosed cabinets with doors, and we describe each one exactly as it is."
];
...
export const metaDescription = "We compared 8 printer cabinets for home offices on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Printer Cabinets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "The Letaya is a mobile metal file cabinet with 3 lockable drawers and an open flat top, not an enclosed printer cabinet with doors. It fits letter, legal, and A4 documents, and the lock adds real security for sensitive files, a feature most enclosed printer cabinets don't offer at all.\n\nBecause the top is open rather than sealed, a printer placed on it has full airflow, no ventilation planning required, though it also means the printer stays visible rather than hidden away.\n\nFully assembled out of the box.",
    "specs": [
      "3 lockable drawers",
      "Metal construction",
      "Fully assembled",
  ...
  },
  {
    ...
    "description": "Another Letaya lateral file cabinet, this 2-drawer version is again an open-top metal file cabinet rather than an enclosed cabinet with doors. Its slightly smaller 2-drawer footprint suits a home office with less document volume than the 3-drawer version above.\n\nThe lockable drawers keep files secure, and the flat metal top gives a printer a stable, ventilated surface since nothing about the design traps heat or air around the unit.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The VASAGLE CUSTOS is explicitly marketed as both a small rolling file cabinet and a printer stand, making it one of the more honestly dual-purpose picks in this list. It is an open-top design rather than a fully enclosed cabinet, sized for A4 and letter-size documents in its 2 drawers.\n\nRolling casters make it easy to reposition, and the matte black finish gives it a clean, modern look that fits most home office styles without drawing attention to itself.\n\nRolling casters for easy repositioning.",
    "specs": [
  ...
  },
  {
    ...
    "description": "DUMOS built this as an open-top wood file cabinet explicitly positioned as an under-desk printer stand, with 3 drawers for document and supply storage beneath a flat wood-finish top. It is not an enclosed cabinet with doors, so a printer placed on top has open airflow by default.\n\nThe wood finish gives it a warmer look than the metal file cabinets in this list, and its under-desk sizing means it tucks into a knee space rather than sitting out as a standalone piece.\n\n3 drawers of storage below an open top.",
    "specs": [
      "3 drawers",
      "Wood construction",
      "Under-desk sizing",
  ...
  },
  {
    ...
    "description": "The GYIIYUO is an open-top mobile file cabinet with a 24-inch extended desktop surface, larger than a standard file cabinet lid, giving a printer more room than most of the compact drawer units in this list. Fabric-lined drawers hold documents and supplies, and a side bag adds extra catch-all storage.\n\nAs with the other file-cabinet-style picks here, there is no enclosure or door, so ventilation is a non-issue, though the printer sits exposed on top rather than hidden.",
    "specs": [
      "2 drawers, fits A4/letter size",
  ...
  },
  {
    ...
    "description": "The SISESOL is a narrow, open-top vertical metal file cabinet with a lock, the most low-cost locking option in this list. Its slim vertical footprint suits tight home offices better than the wider lateral cabinets above, though that also means less top surface area for a larger printer.\n\nEasy assembly and a straightforward metal build make it a low-fuss pick for buyers who mainly want secure document storage with a flat printer-ready surface on top.",
    "specs": [
      "2 lockable drawers",
...
export const breadcrumbLabel = "Best Printer Cabinets for Home Offices";
