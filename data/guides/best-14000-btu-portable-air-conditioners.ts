...
export const guideTitle = "The Best 14,000 BTU Portable Air Conditioners for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "HOMCOM 14000 BTU Portable Air Conditioner 5-in-1 for Room up to 700 Sq."
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "HOMCOM 14000 BTU Portable Air Conditioner 5-in-1 for Room up to 700 Sq.",
      ...
      {
        "label": "DREO Portable Air Conditioner 516S)",
...
export const metaDescription = "A practical comparison of 8 14,000 BTU portable air conditioners, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 14,000 BTU Portable Air Conditioners for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Beat the heat instantly without sky-high electric bills",
      "5 modes in 1 machine, our air conditioner",
      "Breathe fresher air while you chill, our air conditioner"
    ],
    "pros": [
      "Beat the heat instantly without sky-high electric bills",
      "5 modes in 1 machine, our air conditioner",
  ...
  },
  {
    ...
    "specs": [
      "Powerful 14000 BTU cooling: cool your space efficiently with this 14,000 BTU",
      "5-in-1 versatility",
      "24h timer & quiet cooling"
    ],
    "pros": [
      "Powerful 14000 BTU cooling: cool your space efficiently with this 14,000 BTU",
      "5-in-1 versatility",
      "24h timer & quiet cooling",
      "Dual LED display & child lock"
    ],
    "cons": [
      "SACC cooling is usually lower than the headline BTU number",
      "Single-hose models lose efficiency from negative room pressure"
...
export const breadcrumbLabel = "Best 14,000 BTU Portable Air Conditioners";
