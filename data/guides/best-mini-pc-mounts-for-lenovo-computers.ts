...
export const faq = [
  {
    "q": "Does Lenovo make its own official mounting bracket?",
    "a": "Yes, Lenovo's VESA Mount and VESA Mount II accessories are documented directly for the ThinkCentre Tiny lineup, offering guaranteed fit."
  },
  {
    "q": "Are the products here Lenovo-branded?",
    "a": "No, these are third-party universal VESA brackets, not official Lenovo accessories."
  },
  {
  ...
  {
    "q": "Should I use a third-party bracket or Lenovo's official accessory?",
    "a": "Lenovo's official accessory guarantees fit for the ThinkCentre Tiny lineup; third-party brackets may cost less but require verifying your specific model's dimensions."
  }
];

export const guideSlug = "best-mini-pc-mounts-for-lenovo-computers";

export const guideTitle = "The Best Mini PC Mounts for Lenovo Computers: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    "title": "Honest disclosure: universal brackets, not Lenovo-exclusive",
    "description": "We verified none of these are official Lenovo accessories with a confirmed ThinkCentre Tiny generation fit matrix, and flagged Lenovo's own official VESA Mount options as a cross-reference."
  },
  {
    "title": "Compatibility claims checked, not assumed",
    "description": "We noted where a listing names specific brands versus offering only general VESA compatibility."
  },
  {
    "title": "Device depth/width range against typical ThinkCentre Tiny dimensions",
    "description": "We compared each bracket's stated compatible range, recommending buyers verify their specific Lenovo model's exact dimensions."
  },
  {
    "title": "Review volume as general reliability evidence",
    "description": "Since Lenovo-specific fit data isn't independently verifiable from these listings, we weighted general review history for overall build quality."
  }
];
...
export const metaDescription = "A practical comparison of 5 mini PC mounts for lenovo computers, focused on compatibility, build, features and price, and the trade-offs between them.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "On price, it's actually priced above Monzlteck Adjustable Small Device Wall Mount Or VESA Mount Behind the Monitor, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Not marketed specifically for Lenovo, verify depth compatibility with your model.",
    "specs": [
    ...
    "cons": [
      "Not marketed specifically for Lenovo, verify depth compatibility with your model"
    ],
  ...
  },
  {
    ...
    "cons": [
      "Not marketed specifically for Lenovo devices"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Wide device width range and weight capacity"
    ],
    "cons": [
      "Lenovo not specifically named in compatibility list, verify dimensions",
  ...
  },
  {
    ...
    "cons": [
      ...
      "Not marketed specifically for Lenovo"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-mini-pc-mounts-for-dell-computers",
    "title": "Best Mini PC Mounts for Dell Computers (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Mini PC Mounts for Lenovo Computers";
