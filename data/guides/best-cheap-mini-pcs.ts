...
export const faq = [
  {
    "q": "What do you give up with the cheapest mini PCs?",
    "a": "Usually RAM, storage, or processor tier, know specifically which trade-off a cheap option makes rather than assuming it wins on every spec."
  },
  {
    "q": "Is a cheap mini PC good enough for basic tasks?",
    "a": "Yes, for light use cases like web browsing, streaming, or a simple home server, a cheap entry-level mini PC works well."
  },
  {
    "q": "Does an included Windows license make a mini PC cheaper overall?",
    "a": "It can, factor in total cost of ownership, since buying a separate Windows license adds real cost to an otherwise cheaper bare-bones option."
  },
  {
    "q": "Should I buy the absolute cheapest mini PC available?",
    "a": "Only if it matches your actual light use case, otherwise a slightly pricier option with better specs may serve you better long-term."
  }
];

export const guideSlug = "best-cheap-mini-pcs";

export const guideTitle = "The Best Cheap Mini PCs for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "Specific trade-off identified for each cheap pick",
    "description": "Identified specifically which spec each cheap mini PC trades off, whether RAM, storage, or processor tier, rather than assuming any cheap option wins on everything."
  },
  {
    "title": "Use case matched honestly to the cheapest processor tiers",
    "description": "Matched the cheapest processor tiers honestly to light use cases like browsing, streaming, or a home server, rather than assuming they suit any workload."
  },
  {
    "title": "Total cost of ownership considered including OS licensing",
    "description": "Considered total cost of ownership including whether a Windows license is included, which affects genuine cheapness beyond just the sticker price."
  },
  {
    "title": "Value assessed relative to the absolute lowest price in the category",
    "description": "Assessed each pick's value specifically relative to the absolute lowest price options in this guide, not against the broader mini PC market."
  }
];
...
export const introParagraphs = [
  ...
  "A cheap mini PC can still be a good value if it matches your actual use case, like basic web browsing, streaming, or a simple home server, worth being honest about matching the cheapest option to a light workload rather than an inappropriately demanding one."
];
...
export const metaDescription = "How 5 cheap mini PCs compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cheap Mini PCs for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "The lowest price in this guide while still offering a genuine Intel Core i3 processor, the trade-off here is 8GB RAM rather than a lower-tier chip.\n\nGenuine Core i3 processor tier at the lowest price in this guide. On price, it comes in below GMKtec Mini PC Computers Intel N95 Processor, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Not suited for demanding multitasking.",
    "specs": [
    ...
    "pros": [
      ...
      "Good value for buyers prioritizing processor capability",
      "Very low-cost overall"
    ],
    "cons": [
      "8GB RAM is the trade-off for this low price, verify it suits your needs",
      "Check whether RAM and storage are user-upgradable",
      "Not suited for demanding multitasking"
    ],
  ...
  },
  {
    ...
    "pros": [
      ...
      "Good match for basic web browsing, streaming, or home server use",
    ...
    "cons": [
      ...
      "Only appropriate for light use cases"
    ],
    "bestFor": "Buyers wanting the cheapest option for light use cases like browsing or a home server"
  },
  {
    ...
    "pros": [
      "Windows 11 Pro included avoids a separate license purchase cost",
      "16GB RAM, more generous than the absolute cheapest picks",
      "cheap in total cost of ownership including the OS",
      "Low 28W power draw for energy efficiency"
    ],
    "cons": [
      "Higher upfront price than the absolute cheapest options in this guide",
      "256GB SSD may feel tight for buyers with large storage needs",
  ...
  },
  {
    ...
    "description": "The trade-off here is a slightly higher price than the absolute cheapest picks for more processing capability via a 6-core, 12-thread Ryzen 5 chip.\n\nThe real tradeoff against that pick: Higher price than the absolute cheapest picks in this guide.\n\nOn the other side, Check whether RAM and storage are user-upgradable.",
    "specs": [
    ...
    "pros": [
      "capable 6-core processor while still staying in the cheap price tier",
      "Good multitasking capability beyond basic browsing",
      "Solid value for the processor performance offered",
      "Still low-cost relative to mid-range options"
    ],
    "cons": [
      "Higher price than the absolute cheapest picks in this guide",
  ...
  },
  {
    ...
    "pros": [
      "Generous 512GB SSD avoids the storage limitations of the cheapest picks",
      "16GB RAM covers typical everyday productivity needs",
      "Efficient N150 processor for everyday use",
      "Still within the cheap price tier overall"
    ],
    "cons": [
      "Higher price than the absolute cheapest picks in this guide",
      "Entry-level processor tier, not suited for demanding workloads",
...
export const breadcrumbLabel = "Best Cheap Mini PCs";
