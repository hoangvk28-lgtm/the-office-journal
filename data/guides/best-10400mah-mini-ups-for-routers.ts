...
export const guideTitle = "The Best 10,400mAh Mini UPS for Routers: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 5 10,400mAh mini UPS for routers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 10,400mAh Mini UPS for Routers (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "10,400mAh / 18Wh battery",
      "Dual input: 9V/12V DC or 5V USB",
      "USB 5V/2A, DC 9V/2A, DC 12V/2A"
    ],
    "pros": [
      "Dual charging input flexibility",
      "Compact design for shelf or cabinet placement",
      "Multiple intelligent protection circuits",
      "Can double as a standard USB charging bank"
    ],
    "cons": [
      "18Wh actual energy is lower than some same-mAh competitors",
...
export const relatedGuides = [
  {
    "href": "/guide/best-8800mah-mini-ups-for-routers",
...
export const breadcrumbLabel = "Best 10,400mAh Mini UPS for Routers";
