...
export const faq = [
  {
    ...
    "a": "Every RAID-capable enclosure in this list, and RAID generally, can lose data during a mode switch since reconfiguring the array typically wipes existing data structures. Back up first, every time."
  },
  {
