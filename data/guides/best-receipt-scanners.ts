...
export const faq = [
  {
    "q": "Will scanning old receipts recover data that's already faded?",
    "a": "Thermal receipt paper fades within months due to heat, light, and friction exposure regardless of when you eventually scan it. Digitize receipts promptly rather than letting a pile accumulate for later."
  },
  {
    "q": "Do dedicated receipt scanners jam less than general document scanners on crumpled receipts?",
    "a": "Narrow-path receipt scanners actually have less mechanical tolerance for curled or folded receipts than standard-width ADF document scanners, which can accommodate more physical deformity."
  },
  {
    "q": "Can these scanners automatically extract the total and date into my expense app?",
    "a": "Not confirmed for any pick in this guide. Basic OCR export is standard, but genuine structured data extraction (merchant, date, total, category) directly into expense platforms is a deeper, separately-verified capability."
  },
  {
    "q": "Should I use a single-sheet feed or ADF hopper scanner for receipts?",
    "a": "Single-sheet feed works fine for occasional receipts; an ADF hopper (like the Canon R10 or ScanSnap iX1300) lets you batch several receipts at once for a regular expense-tracking routine."
  }
];

export const guideSlug = "best-receipt-scanners";

export const guideTitle = "The Best Receipt Scanners for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Thermal receipt fading urgency framing",
    "description": "Emphasized that thermal receipts fade within months regardless of scanner quality, a scanner purchased for 'someday' batch scanning does nothing to recover data that's already faded before it reaches the machine."
  },
  {
    "title": "",
    "description": "Noted that narrow-path dedicated receipt scanners generally have less mechanical tolerance for the physical deformities common to pocket-stored receipts than a standard-width ADF scanner."
  },
  {
    "title": "Expense software integration depth disclosure",
    "description": "Distinguished basic image/OCR export from deeper structured-data extraction (merchant, date, total, category) directly into expense platforms, none of the picks here confirm the deeper structured extraction."
  }
];
...
export const metaDescription = "We compared 6 receipt scanners on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Receipt Scanners for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Compact and portable, this handles standard-size receipts well through its scanning path, with the free iPrint&Scan app supporting scan-to-multiple-destinations for expense tracking. Since it's single-sheet-fed rather than a narrow dedicated receipt slot, crumpled or curled receipts have a bit more mechanical tolerance here than a narrow-width dedicated receipt scanner.\n\nScan your receipts promptly, thermal fading happens regardless of whether your scanner performs well, waiting to batch-scan a pile of months-old receipts won't recover data that's already faded.",
    "specs": [
      "Single-sheet feed, handles standard receipt sizes",
      "Free iPrint&Scan app for expense destinations",
      "Compact, portable"
    ],
    "pros": [
      "Single-sheet feed tolerates curled receipts reasonably well",
      "Free app supports multiple expense destinations",
      "compact and portable"
    ],
    "cons": [
      "Not a dedicated narrow receipt scanner, less specialized for thin receipt widths",
      "No specific expense-software data extraction disclosed beyond image/OCR",
      "No auto-crop accuracy testing on varied receipt lengths confirmed"
    ],
  ...
  },
  {
    ...
    "description": "A portable, single-sided sheetfed design specifically marketed for home/office digital scanning including receipts, with HP WorkScan software included. Smaller review count reflects a more niche listing, weigh that against the dedicated portable design.\n\nAs with any receipt scanner, prompt scanning matters more than the scanner's own capability, thermal paper fades on its own timeline independent of your scanning schedule.\n\nThat said, smaller review count than the compact document scanner alternatives.",
    "specs": [
      "Portable 1-sided sheetfed scanning",
      "HP WorkScan software included",
      "PC and Mac compatible",
      "Compact for home/office use"
    ],
    "pros": [
      "Dedicated portable sheetfed design",
      "HP WorkScan software included",
      "PC and Mac compatible",
      "Compact for frequent use"
    ],
    "cons": [
      "Smaller review count than the compact document scanner alternatives",
      "1-sided only, no duplex",
      "No auto-crop or expense-integration depth confirmed"
    ],
  ...
  },
  {
    ...
    "description": "Explicitly handles receipts and plastic cards alongside standard documents, with a real 20-sheet ADF hopper letting you batch several receipts at once rather than feeding one at a time. Its explicit 500 scans/day suggested volume is a useful disclosure for planning a receipt-digitization routine.\n\nCrumpled or curled receipts may still jam more than flat samples, an ADF hopper's narrower tolerance applies here as with any feeder design, smooth out receipts before batch-feeding when possible.",
    "specs": [
      "20-sheet ADF hopper, explicitly handles receipts and cards",
      "Explicit 500 scans/day rating",
      "Duplex scanning",
      "1.7 lb, portable"
    ],
    "pros": [
      "Real ADF hopper lets you batch multiple receipts at once",
      "Explicitly marketed for receipts and cards",
      "Explicit daily volume disclosure for planning a routine",
      "portable"
    ],
    "cons": [
      "ADF hopper still less tolerant of crumpled/curled receipts than manual single-sheet feeding",
      "Lower rating than the top document scanner picks",
  ...
  },
  {
    ...
    "description": "Handles receipts explicitly alongside documents and cards, with auto de-skew and color optimization useful for varied receipt lengths and printed content placement. Standalone scan-to-cloud lets you file digitized receipts to an expense-tracking cloud service without a computer on.\n\nAuto-crop accuracy on unusually long or short receipts isn't independently verified here, watch for clipped totals or dates on non-standard receipt lengths and re-scan if needed.\n\nAuto de-skew and color optimization for varied receipt content.",
    "specs": [
      "Explicitly handles receipts, cards, and documents",
      "Auto de-skew, color optimization",
      "Standalone scan-to-cloud",
      "30ppm duplex"
    ],
    "pros": [
      "Explicitly marketed for receipts alongside documents",
      "Auto de-skew and color optimization for varied receipt content",
      "Standalone cloud filing for expense workflows",
      "Real ADF hopper"
    ],
    "cons": [
      "Auto-crop accuracy on unusual receipt lengths not independently verified",
      "Higher price than the dedicated compact picks",
      "Same thermal-fading risk applies regardless of scanner quality"
    ],
  ...
  },
  {
    ...
    "description": "Identical receipt-handling capability to the rank-4 pick in a black finish, same auto de-skew, color optimization, and standalone cloud filing for expense workflows.",
    "specs": [
      "Explicitly handles receipts, cards, and documents",
      "Auto de-skew, color optimization",
      "Standalone scan-to-cloud",
    ...
    "pros": [
      "Same receipt-handling capability as the white version",
      "Auto de-skew and color optimization",
      "Standalone cloud filing",
      "Black finish option"
    ],
    "cons": [
      "Same unverified auto-crop accuracy on unusual lengths",
      "Same higher price tier",
      "Same thermal-fading risk regardless of scanner"
    ],
  ...
  },
  {
    ...
    "description": "5x72 inches, useful for unusually long grocery or CVS-style receipts that shorter-path scanners struggle with. 5-second per-page scan for quick individual receipt jobs.\n\nAt the lowest price in this guide, includes Nuance OCR for searchable receipt PDFs, useful for expense report text extraction.\n\nThe standout detail is that fast per-page scan time for quick individual jobs. Balancing that out, single-sheet feed, no batch hopper for multiple receipts at once.",
    "specs": [
      "Handles documents/receipts up to 8.5x72 inches",
      "5.5-second per-page scan time",
      "Includes Nuance OCR for searchable PDFs",
      "Lowest price in this guide"
    ],
    "pros": [
      "Handles unusually long receipts up to 72 inches",
      "Fast per-page scan time for quick individual jobs",
      "Includes OCR for searchable receipt PDFs",
      "Lowest price in this guide"
    ],
    "cons": [
      "Single-sheet feed, no batch hopper for multiple receipts at once",
      "No explicit expense-software data extraction beyond OCR"
    ],
...
export const breadcrumbLabel = "Best Receipt Scanners";
