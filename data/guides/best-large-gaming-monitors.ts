...
export const guideTitle = "The Best Large Gaming Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "SANSUI 34 Inch Curved Monitor 240Hz UWQHD 3440×1440 Gaming Monitor)",
...
export const metaDescription = "How 6 large gaming monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Large Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      ...
      "34-inch ultra-wide gaming monitor (resolution 3440×1440) features a 1500r curvature design and 21:9 aspect ratio",
      "Beyond vivid, true-to-life color"
    ],
    "pros": [
      "Smooth gaming performance",
      "34-inch ultra-wide gaming monitor (resolution 3440×1440) features a 1500r curvature design and 21:9 aspect ratio",
  ...
  },
  {
    ...
    "pros": [
      ...
      "HDMI up to 240hz",
      "Display colors",
      "1500R curved, -5°~15°, vesa compatible (100 x 100mm), 178°"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
  ...
  },
  {
    ...
    "specs": [
      "Immersive 49inch ultra-wide curved monitor: the 49-inch curved gaming",
      "144Hz/165hz refresh rate with amd freesync: enjoy ultra-smooth gameplay with a fast 144hz/165hz refresh rate",
      "120% Srgb wide color: with 120% srgb color coverage"
    ],
    "pros": [
      "Immersive 49inch ultra-wide curved monitor: the 49-inch curved gaming",
      "144Hz/165hz refresh rate with amd freesync: enjoy ultra-smooth gameplay with a fast 144hz/165hz refresh rate",
      "120% Srgb wide color: with 120% srgb color coverage",
      "Flexible setup with adjustable stand & ports"
    ],
    "cons": [
      "Marketed specs and real-world specs often differ",
      "Check compatibility with your exact setup before buying"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-zowie-gaming-monitors",
    "title": "Best ZOWIE Gaming Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Large Gaming Monitors";
