...
export const guideTitle = "The Best Humidifiers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 humidifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Humidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Humidifiers";
