...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-tv-stand-for-65-inch-tv";
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-tv-stand-for-65-inch-tv` },
    about: [{"@type":"Thing","name":"TV Stand"},{"@type":"Thing","name":"65 Inch TV"},{"@type":"Thing","name":"Entertainment Center"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best TV Stands for 65 Inch TVs", item: `${SITE_URL}/guide/best-tv-stand-for-65-inch-tv` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-tv-stand-for-65-inch-tv#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best TV Stands for 65 Inch TVs</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best TV Stands for 65 Inch TVs" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A 65 inch TV sits between the compact 55 inch class and the largest 75 inch and up sets, which means the right stand needs enough top width and weight capacity for a heavier panel without oversizing your wall run.</p>
          <p>This guide covers seven TV stands sized for 65 inch TVs, ranked by base fit, storage style, weight capacity, and price, from a budget LED console under $65 to a fireplace-equipped stand near $320.</p>
          <p>For a smaller or larger screen, see our <a href='/guide/best-tv-stand-for-55-inch-tv' className='text-brand hover:underline'>best TV stands for 55 inch TVs</a> or <a href='/guide/best-tv-stand-for-75-inch-tv' className='text-brand hover:underline'>best TV stands for 75 inch TVs</a> guides.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=tv+stand+for+65+inch+tv&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
