...
export const guideTitle = "The Best Portable Video Switchers for a Better Desk Setup";
...
export const metaDescription = "We compared 8 portable video switchers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Portable Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Portable Video Switchers";
