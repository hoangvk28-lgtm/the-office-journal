...
export const faq = [
  {
    "q": "Does Google Classroom integration require a specific brand of board?",
    "a": "Any Google EDLA-certified board provides access to Google Classroom through the Play Store the same way a Chromebook does, it's not brand-locked to any single manufacturer, just to genuine EDLA certification status."
  },
  {
    "q": "How should a school district plan for fleet refresh on interactive whiteboards?",
    "a": "Budget for a 5-7 year refresh cycle typical of this hardware category, keep 1-2 spare units per building for rapid swap during repairs, and standardize on boards from brands offering institutional-scale onsite support contracts like Promethean's 3-year onsite coverage."
  },
  {
...
export const guideTitle = "The Best Interactive Whiteboards for Education Worth Considering";
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "",
          "75-86in boards with strong wireless casting"
        ]
      ]
    }
  }
...
export const introParagraphs = [
  "Education panels compete on EDLA certification, lesson software depth, and student multi-touch capability, but K-12 and higher education have real differences in room size, account systems, and software needs that a generic comparison misses.",
  "We separated K-12 and higher-ed scenarios explicitly, compared Google/Microsoft/proprietary ecosystem fit, verified moderated student sharing capability, and calculated fleet refresh and spare-unit strategy for institutional-scale deployment."
];
...
export const metaDescription = "How 8 interactive whiteboards for education compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Interactive Whiteboards for Education (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-interactive-whiteboards-for-education-1",
    "rank": 1,
    "badge": "Best Overall Education Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-education-2",
    "rank": 2,
    "badge": "Best EDLA-Certified for Google Classroom",
  ...
  {
    "id": "best-interactive-whiteboards-for-education-3",
    "rank": 3,
    "badge": "Best Large-Room Education Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-education-4",
    "rank": 4,
    "badge": "Best High-Storage Education Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-education-5",
    "rank": 5,
    "badge": "Best Value Education Board",
  ...
  {
    "id": "best-interactive-whiteboards-for-education-6",
    "rank": 6,
    "badge": "Best for Institutional Onsite Support",
  ...
  {
    "id": "best-interactive-whiteboards-for-education-7",
    "rank": 7,
    "badge": "Best Samsung Education Board",
    ...
    "specs": [
      "75in, EDLA-certified Android 14",
      "OPS slot for Windows conversion",
      "Compatible with other Android devices"
    ],
    "pros": [
      "OPS slot converts to Windows without separate hardware",
      "Genuine EDLA certification for stable Google service access",
      "Samsung's broader enterprise support ecosystem"
    ],
    "cons": [
  ...
  {
    "id": "best-interactive-whiteboards-for-education-8",
    "rank": 8,
    "badge": "Best Security for Shared Classroom Use",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-interactive-whiteboards-for-school",
    "title": "8 Best Interactive Whiteboards for School"
  }
];

export const breadcrumbLabel = "Best Interactive Whiteboards for Education";
