...
export const guideTitle = "8 Best Honeywell Space Heaters in 2026";
export const metaTitle = "Best Honeywell Space Heaters";
export const metaDescription = "We compared space heater honeywell models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
...
export const products: GuideProduct[] = [
  {
    ...
    specs: ["Use the Honeywell 360 degree surround heater in small to mid-sized rooms for additional comfort", "Safety matters", "Always be comfortable, no matter what season"],
    pros: ["Use the Honeywell 360 degree surround heater in small to mid-sized rooms for additional comfort", "Safety matters", "Always be comfortable, no matter what season", "Worried about heating costs"],
  ...
  },
  {
    ...
    specs: ["Honeywell heatgenius ceramic heater provides 6 customized heat settings to give you control of your comfort", "Safety matters", "Always be comfortable, no matter what season"],
    pros: ["Honeywell heatgenius ceramic heater provides 6 customized heat settings to give you control of your comfort", "Safety matters", "Always be comfortable, no matter what season", "Worried about heating costs"],
    cons: ["Coverage claims assume a well-insulated, average-height room", "Running at full wattage all day adds up on the electric bill"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    specs: ["Honeywell thermawave 6 ceramic space heater uses ceramic heating technology to provide powerful", "Room heater offers multiple safety options including 2x overheat protection", "Always be comfortable"],
    pros: ["Honeywell thermawave 6 ceramic space heater uses ceramic heating technology to provide powerful", "Room heater offers multiple safety options including 2x overheat protection", "Always be comfortable", "Honeywell quality"],
    cons: ["Running at full wattage all day adds up on the electric bill", "Coverage claims assume a well-insulated, average-height room"],
  ...
  },
  {
    ...
    specs: ["Use the Honeywell heater and fan in any room of your home", "Easy-to-use manual controls and recessed carry handle", "Always be comfortable, no matter what season"],
    pros: ["Use the Honeywell heater and fan in any room of your home", "Easy-to-use manual controls and recessed carry handle", "Always be comfortable, no matter what season", "Worried about heating costs"],
    cons: ["Coverage claims assume a well-insulated, average-height room", "Running at full wattage all day adds up on the electric bill"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    specs: ["Energy efficient heat", "Easy to use", "Increase your comfort"],
    pros: ["Energy efficient heat", "Easy to use", "Increase your comfort"],
    cons: ["Running at full wattage all day adds up on the electric bill", "Coverage claims assume a well-insulated, average-height room"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    specs: ["Honeywell safeguard motion sensor ceramic space heater provides powerful", "Safety matters", "Always be comfortable"],
    pros: ["Honeywell safeguard motion sensor ceramic space heater provides powerful", "Safety matters", "Always be comfortable", "Worried about heating costs"],
    cons: ["Coverage claims assume a well-insulated, average-height room", "Running at full wattage all day adds up on the electric bill"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    specs: ["Increase your comfort", "Honeywell quality", "Energy efficient heat"],
    pros: ["Increase your comfort", "Honeywell quality", "Energy efficient heat", "Easy to use"],
    cons: ["Running at full wattage all day adds up on the electric bill", "Coverage claims assume a well-insulated, average-height room"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Ceramic (e.g. Honeywell HHF360V 360 Degree Surround Fan Forced Heater with Surround Heat)",
