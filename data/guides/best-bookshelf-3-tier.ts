...
export const guideTitle = "The Best 3-Tier Bookshelves for Everyday Use";
export const metaTitle = "Best 3-Tier Bookshelves for Home Offices (2026)";
export const metaDescription =
  "A practical comparison of 9 3-tier bookshelves, focused on features, build and practical fit, and the trade-offs between them.";
...
export const introParagraphs = [
  ...
  "Below are 8 three-tier bookshelves we compared on weight capacity, footprint, and construction, ranging from ultra-compact budget picks under $30 to industrial metal-frame designs that double as an end table or nightstand.",
];
...
export const products: GuideProduct[] = [
  {
    ...
    description:
      "8 stars, built around an X-shaped metal frame with horizontal cross bars and a backboard that together give it real rigidity for its size. 6 inches tall, it's triple-purpose, working as a small bookshelf, an end table, or a nightstand depending on where you place it.\n\nA mix of metal frame and MDF shelving is rated for 50 lbs total, and adjustable feet keep it level on uneven flooring, a small detail that matters when it's doing double duty as bedside furniture.",
    specs: [
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0DMFBXWHZ?tag=theofficejournal-20",
    description:
      "7 inches wide, built around a particleboard and alloy steel frame with X-brace reinforcement for stability. 5 lbs per shelf, plenty for a small book and decor collection. A two-tone Rustic Brown and Ink Black finish, adjustable feet, and an included anti-tip kit round out a build that's also the cheapest VASAGLE 3-tier option available.",
    specs: [
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0CCKS9W18?tag=theofficejournal-20",
    description:
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B01BWZWEAK?tag=theofficejournal-20",
    description:
      "FSC-certified composite wood construction carries over from the LUDER, along with a closed back panel.\n\n5 inches wide, it's the widest pick in this list, giving it the highest total capacity among the Furinno picks at 80 lbs, useful if you want more books per tier than the narrower compact options provide.\n\nHighest total capacity among Furinno picks at 80 lbs.",
    specs: [
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0CMD5Z5J4?tag=theofficejournal-20",
    description:
      "The VASAGLE CUSTOS stands apart with the most adjustable shelving in this list, letting you move both the 2nd and 3rd tiers across 3 different height positions to fit taller items wherever you need the extra clearance. A footless H-shaped design skips the usual leg base for a cleaner, more modern silhouette. A slot-in back panel adds rigidity without extra hardware, and at 88 lbs total, or 22 lbs per shelf, it's the most premium-feeling pick in the CUSTOS collection, priced accordingly above the industrial metal-frame picks in this list.",
    specs: [
...
export const faq: FaqItem[] = [
  {
    ...
    a: "8 stars and genuine triple-purpose use as a bookshelf, end table, or nightstand.",
  },
  {
