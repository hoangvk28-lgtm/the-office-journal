...
export const guideTitle = "The Best Enclosed 3D Printers for Everyday Desk Work";
...
export const metaDescription = "How 6 enclosed 3D printers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Enclosed 3D Printers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Enclosed 3D Printers";
