...
export const guideTitle = "The Best Gaming Monitors for Everyday Desk Work";
...
export const metaDescription = "How 6 gaming monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Gaming Monitors for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-evnia-gaming-monitors",
    "title": "Best Evnia Gaming Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Gaming Monitors";
