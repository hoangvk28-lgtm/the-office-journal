...
export const guideTitle = "The Best Drawing Tablets for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 7 drawing tablets, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Drawing Tablets for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-electronic-drawing-tablets",
    "title": "Best Electronic Drawing Tablets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Drawing Tablets";
