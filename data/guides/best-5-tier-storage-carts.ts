...
export const introParagraphs = [
  "Best 5-Tier Storage Carts span budget to heavy-duty designs, which is exactly why floor type changes what you need.",
  "We compared this lineup on true drawer quality and footprint, since this is where the decision gets made."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-5-tier-storage-carts-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-5-tier-storage-carts-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-5-tier-storage-carts-3",
    rank: 3,
  ...
  {
    id: "best-5-tier-storage-carts-4",
    rank: 4,
  ...
  {
    id: "best-5-tier-storage-carts-5",
    rank: 5,
  ...
  {
    id: "best-5-tier-storage-carts-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-5-tier-storage-carts-7",
    rank: 7,
  ...
  {
    id: "best-5-tier-storage-carts-8",
    rank: 8,
