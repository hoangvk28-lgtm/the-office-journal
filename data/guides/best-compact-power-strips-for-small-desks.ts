...
export const faq = [
  {
    "q": "How much desk space do I actually save with a compact power strip?",
    "a": "Less than you might expect relative to the outlet count you sacrifice. Compact size almost always means reduced outlet count or tighter spacing, calculate whether the space savings justifies the reduced capacity for your specific desk."
  },
  {
    "q": "Does a compact power strip have weaker surge protection?",
    "a": "Not necessarily, but verify explicitly. Compact strips sometimes sacrifice surge protection components or reduce joule rating compared to full-size strips at a similar price point, check the specific joule rating rather than assuming."
  },
  {
    "q": "What cord length should I get for a small desk?",
    "a": "It depends on your desk's distance from the wall outlet. If your desk sits directly against the wall, a short cord (like a 1ft option) eliminates excess cable clutter entirely, small desks have less placement flexibility, making cord length more constraining than on a larger desk."
  },
  {
    "q": "Should I consider a clamp-on strip instead of a compact surface strip for a small desk?",
    "a": "If desk surface area is your primary constraint, yes. Clamp-on or under-desk mounting options free up surface space entirely, worth considering over simply choosing the smallest surface-sitting strip available."
  }
];

export const guideSlug = "best-compact-power-strips-for-small-desks";

export const guideTitle = "The Best Compact Power Strips for Small Desks: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "TESSAN Small Flat Plug Power Strip fits this specifically: the smallest footprint in this guide."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want what TESSAN Small Flat Plug Power Strip offers: the smallest footprint in this guide. That's a real functional upgrade over the budget picks here, not just a brand markup."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared each pick's compact footprint against how much outlet count or spacing it sacrifices, rather than treating 'compact' as a blanket positive without a tradeoff."
  },
  {
    "title": "Cord exit angle and length matched to constrained small-desk placement",
    "description": "Considered cord length and exit direction specifically for small-desk scenarios like corners or beside a monitor stand, where placement flexibility is more limited than on a standard desk."
  },
  {
    "title": "Surge protection verified explicitly, not assumed from compact size",
    "description": "Checked that compact size doesn't correlate with reduced or absent surge protection compared to full-size strips at a similar price point."
  }
];
...
export const metaDescription = "A practical comparison of 5 compact power strips for small desks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Compact Power Strips for Small Desks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A compact 3-sided design with 6 outlets and 3 USB ports (including 1 USB-C), a solid balance of small footprint and real capacity. Flat plug for tight wall clearance on a small desk.\n\n3-sided design fits wider adapters despite compact size. On price, it comes in below TESSAN Small Flat Plug Power Strip, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Flat plug still requires strip-body placement space.",
    "specs": [
      "6 outlets, 3 USB ports (1 USB-C)",
      "3-sided outlet design",
      "5ft cord, flat plug",
      "Compact, low-cost"
    ],
    "pros": [
      "3-sided design fits wider adapters despite compact size",
      "Includes a USB-C port",
      "Very affordable"
    ],
    "cons": [
      "Fewer outlets than full-size strips",
      "Not the smallest footprint in this guide",
      "Flat plug still requires strip-body placement space"
    ],
  ...
  },
  {
    ...
    "description": "A ultra-thin, small design for the tightest desk corners or beside a monitor stand, with a strong rating base. Flat plug for wall clearance.\n\nOn the other side, Verify outlet count matches your actual device needs.",
    "specs": [
      "Ultra-thin, small design",
      "5ft cord, flat plug",
      "Strong rating base",
      "Compact for tight desk corners"
    ],
    "pros": [
      "the smallest footprint in this guide",
      "Strong rating base",
      "Flat plug for tight clearance",
      "Fits tucked beside a monitor stand"
    ],
    "cons": [
      "Fewer outlets than the 6-outlet alternatives",
      "Higher price relative to outlet count",
      "Verify outlet count matches your actual device needs"
    ],
  ...
  },
  {
    ...
    "description": "A short 1ft cord, ideal if your small desk sits directly against or very close to a wall outlet, avoiding excess cord to manage in a tight space.\n\nOn the other side, No USB ports confirmed.",
    "specs": [
    ...
    "cons": [
      ...
      "Outlet count not as high as larger strips",
  ...
  },
  {
    ...
    "description": "The real tradeoff against that pick: Only 3 AC outlets.\n\nOn the other side, Shared USB power budget across 4 ports.",
    "specs": [
      "3 outlets, 4 USB ports (incl. USB-C)",
      "22.5W total USB output",
      "6ft cord"
    ],
    "pros": [
    ...
    "cons": [
      "Only 3 AC outlets",
      "6ft cord longer than needed for very small desks",
      "Shared USB power budget across 4 ports"
    ],
  ...
  },
  {
    ...
    "description": "8 outlets and 4 USB ports (2 USB-C) at a low price, more capacity than the truly compact picks in this guide if you're willing to accept a slightly larger footprint.\n\nOn the other side, Not the smallest option here.",
    "specs": [
      "8 outlets, 4 USB ports (2 USB-C)",
      "5ft braided cord, flat plug",
      "ETL listed",
      "Very affordable"
    ],
    "pros": [
      "Highest outlet count among these compact-adjacent picks",
      "Very affordable for the capacity offered",
      "Braided cord for durability",
      "ETL listed"
    ],
    "cons": [
      "Larger footprint than the truly compact picks in this guide",
      "Verify it actually fits your specific small-desk space",
      "Not the smallest option here"
    ],
...
export const breadcrumbLabel = "Best Compact Power Strips for Small Desks";
