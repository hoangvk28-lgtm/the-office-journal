...
export const faq = [
  {
    "q": "How many time zones can these clocks show?",
    "a": "The Design Factory desktop clock shows 3 fixed zones. The Multiple World Clock shows several zones per its listing, check the specific product for exact zone count."
  },
  {
    "q": "Is this the same as a world time desk clock?",
    "a": "Essentially the same two products, yes. This guide frames them around tracking specific named cities, while our world time desk clocks guide frames them more broadly around seeing time anywhere in the world."
  },
  {
    "q": "Do these clocks sync automatically over the internet?",
    "a": "No, both are physical clocks without app or WiFi connectivity. Zones are set manually or come with fixed factory labeling."
  }
];

export const guideSlug = "best-multi-time-zone-desk-clocks";

export const guideTitle = "The Best Multi-Time Zone Desk Clocks for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "Verified genuine multi-zone functionality from each listing",
    "description": "Confirmed each pick explicitly displays more than one time zone simultaneously, rather than assuming from a generic \"world clock\" product name."
  },
  {
    "title": "Checked desktop suitability versus wall-first design",
    "description": "Considered whether each clock is sized and designed for a desk, or primarily a wall clock that could sit on a desk as a secondary use."
  },
  {
    "title": "Kept the list honest at two picks rather than padding it",
    "description": "Limited this guide to the two products in our verified pool that fit the multi-zone category, rather than stretching unrelated clocks to fill out a longer list."
  },
  {
    "title": "Cross-checked against the world time desk clocks guide",
...
export const metaDescription = "A practical comparison of 2 multi-time zone desk clocks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Multi-Time Zone Desk Clocks for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      ...
      "Compact footprint",
      "Fixed zone count per listing"
    ],
    "pros": [
      "True desktop design, not a wall clock repurposed for a desk",
      "Compact size fits well on a desk",
      "Covers a practical number of zones for most needs",
      "Simple, dedicated purpose"
    ],
    "cons": [
      "Price not consistently listed, check current Amazon price",
      "Fixed to 3 zones, less flexible than a larger multi-zone display",
      "Verify current review data on the listing"
    ],
...
export const breadcrumbLabel = "Best Multi-Time Zone Desk Clocks";
