...
export const guideTitle = "The Best Heated Mug Systems for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 heated mug systems, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Heated Mug Systems for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Longer lasting battery coffee mug",
      "Always the well suited temperature",
      "App controlled"
    ],
    "pros": [
      "Longer lasting battery coffee mug",
...
export const breadcrumbLabel = "Best Heated Mug Systems";
