...
export const guideTitle = "The Best Filing Cabinets with Bookshelves: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    ...
    "description": "Checked each listing's exact wording to separate multi-tier open bookshelving from a single adjustable interior shelf, since the two are often blurred together in search results for this category."
  },
  {
  ...
  {
    "title": "",
    "description": "Noted whether each unit was steel, wood, or a mixed build, since wood and wood-composite combo units are more vulnerable to warping in humid environments than all-metal cabinets."
  },
  {
    "title": "Top-heavy stability and anti-tip anchoring need",
    "description": "Flagged tall combo units, especially the 72-inch NORTHSKY tower, where loaded upper shelves raise tipping risk and anti-tip wall anchoring becomes a mandatory rather than optional safety step."
  },
  {
    "title": "Value for price across shelf capability and filing capacity",
    "description": "Weighed price against both stated shelf genuineness and drawer count, since a higher price does not always buy more of either feature in this category."
  }
];
...
export const introParagraphs = [
  ...
  "This guide compares 6 units we compared based on product specs and buyer feedback, and we verified from each listing whether it includes open shelving or only a single internal storage shelf marketed loosely as bookshelf-adjacent. 99 for a tall combo tower with three tiers of open shelving. Tall units in this category are also top-heavy by design, so anti-tip anchoring is a safety step worth taking seriously rather than skipping."
];
...
export const metaDescription = "A practical comparison of 6 filing cabinets with bookshelves, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Filing Cabinets with Bookshelves (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "SISESOL's listing explicitly calls out open storage shelves as an organizer feature alongside its two locking drawers, a genuine shelf-plus-filing layout rather than a single internal cubby. It fits legal, letter, and A4 files in its drawer section, and the open shelf portion suits books, binders, or supplies you want visible and within reach.\n\nAs with any open shelf design, check the stated per-shelf weight limit against a full run of hardcover books before loading it, since open shelves in this price range commonly cap out between 25 and 50 pounds.",
    "specs": [
      "2 drawers with lock",
    ...
    "bestFor": "Buyers who want a compact, open-shelved combo without a tall tower footprint"
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DTH9XM7F?tag=theofficejournal-20",
    "description": "Honesty check: this listing describes a single adjustable storage shelf, not multi-tier open bookshelving, so treat it as a filing cabinet with one flexible internal shelf rather than a genuine bookshelf combo like the NORTHSKY or SISESOL picks above. It fits letter, legal, and A4 hanging files and uses a farmhouse-style wood finish that suits a more decorative home office.\n\nWood-finish combo units like this are also worth checking against humidity exposure, since a wood or wood-composite body can warp or swell over time in damp conditions in a way a steel cabinet will not.\n\nFarmhouse wood finish suits decorative home offices.",
    "specs": [
  ...
  },
  {
    ...
    "description": "Honesty check: this listing also describes a single adjustable shelf rather than multi-tier open bookshelving, so it is included here as a high-capacity filing option with modest added shelf storage, not a dedicated bookshelf combo. Its five drawers give it the most filing capacity in this entire list, a real advantage if books were never the priority and extra storage volume was.\n\nWheels make it repositionable, and the flat top doubles as a printer stand, though buyers wanting genuine open shelving for a visible book collection should look to the NORTHSKY or SISESOL picks instead.\n\nBalancing that out, only one adjustable shelf, not genuine open bookshelving.",
    "specs": [
  ...
  },
  {
    ...
    "description": "Honesty check: this listing does not mention any open shelving or bookshelf feature, so it is included here as a filing-forward alternative for buyers who decide the shelf trade-off in the combo units above is not worth the reduced drawer count. Its four lateral drawers fit letter, legal, and A4 hanging files and give considerably more filing capacity than any of the genuine combo picks in this list.\n\nIf books were a secondary want rather than a real need, a dedicated stand-alone bookshelf paired with this cabinet may serve both purposes better than a combo unit that compromises on both fronts.",
    "specs": [
  ...
  },
  {
    ...
    "description": "Honesty check: like the pick above, this listing does not mention any shelving feature, so it is the budget filing-only alternative in this list rather than a combo unit. It is the most affordable pick in this guide. If a bookshelf feature turns out to be a nice-to-have rather than a requirement once you weigh the reduced filing capacity of the genuine combo units above, this is a reasonable standalone filing option to pair with separate shelving. Most affordable pick in this guide. Both are worth keeping in mind before deciding.",
    "specs": [
...
export const relatedGuides = [
  ...
  },
  {
    ...
    "title": "Best Filing Cabinets with Printer Stands (2026)"
  }
];

export const breadcrumbLabel = "Best Filing Cabinets with Bookshelves";
