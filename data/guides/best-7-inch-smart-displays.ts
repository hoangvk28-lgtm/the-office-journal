...
export const faq = [
  {
    "q": "Is the Google Nest Hub the only 7 inch smart display available?",
    "a": "It's the only one we could verify in our research pool this pass. Amazon's current Echo Show lineup has no model at this exact 7 inch size class."
  },
  {
    "q": "Does the 7 inch Nest Hub have a camera?",
    "a": "No, this specific 2nd generation model has no built-in camera at all, an important distinction from other smart displays and even other Nest Hub generations."
  },
  {
    "q": "Can I use Alexa skills on the Nest Hub?",
    "a": "No, the Nest Hub runs Google Assistant exclusively and does not support Alexa skills or routines."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Applied a strict 7 inch class size definition",
    "description": "Only counted displays at or near 7 inches, rather than rounding an 8 inch or larger display down to fit this guide's search term."
  },
  {
    "title": "Checked for a competing 7 inch Echo Show model",
    "description": ""
  },
  {
    "title": "Camera absence verified and treated as a defining trait",
    "description": "Confirmed directly that this specific model has no built-in camera, an important, easy-to-miss distinction from other Nest Hub generations."
  },
  {
    "title": "Reviewed the single confirmed pick in depth",
    "description": "Chose a thorough single-product writeup over padding the list with a rounded-up or rounded-down size match."
  }
];

export const introParagraphs = [
  "Our verified research pool contains exactly one genuine 7 inch class smart display, the Google Nest Hub 2nd generation. 7 inch and larger models, with no verified genuine 7 inch Echo Show in current production.",
...
export const metaDescription = "The Google Nest Hub is the only verified genuine 7 inch smart display we found this pass. Here is a detailed, honest look at it.";
