...
export const guideTitle = "The Best VR Headsets With Face Tracking: Our Picks";
...
export const metaDescription = "How 6 VR headsets with face tracking compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best VR Headsets With Face Tracking (2026)";
...
export const breadcrumbLabel = "Best VR Headsets With Face Tracking";
