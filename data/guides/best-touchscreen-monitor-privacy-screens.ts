...
export const faq = [
  {
    "q": "Are there privacy filters confirmed for touchscreen monitors?",
    "a": "We found no well-reviewed filter in our research that explicitly confirms touch compatibility in its listing. This is a genuine gap in the current market."
  },
  {
    "q": "Will a standard privacy filter work on a touchscreen?",
    "a": "It's unclear from available listings. Verify directly with the seller about tap accuracy and gesture responsiveness before ordering."
  },
  {
    "q": "Does mount type affect touch performance?",
    "a": "A magnetic mount may apply less direct pressure to the touch layer than some adhesive designs, but this isn't independently verified for touch performance specifically."
  },
  {
    "q": "What should I ask a seller before buying?",
    "a": "Ask about tap accuracy, multi-touch gesture support, and stylus compatibility if relevant, since none of these are addressed in standard listings."
  },
  {
    "q": "Should I contact filter manufacturers directly?",
    "a": "Established brands like 3M or Kensington may have current touch-rated products not surfaced in our specific research."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Disclosed the lack of confirmed touch-compatible products honestly",
    "description": "We found no well-reviewed filter in our research that explicitly confirms touch compatibility, and said so directly rather than assuming standard filters work fine on touch panels."
  },
  {
    "title": "Distinguished mount type as a possible touch-performance factor",
    "description": "We noted where a magnetic mount might apply less pressure directly to the touch layer than some adhesive designs, though this isn't independently verified for touch performance."
  },
  {
    "title": "Recommended direct seller verification for touch-specific questions",
    "description": "Since listings don't address touch performance, we recommended buyers contact sellers directly about tap accuracy and gesture responsiveness before ordering."
  },
  {
    "title": "Did not fabricate touch compatibility claims",
    "description": "Rather than assume or imply touch compatibility to make this guide feel more complete, we disclosed the actual state of available information."
  }
];
...
export const metaDescription = "Honest finding: none of the well-reviewed filters we verified explicitly confirm touch compatibility. Here's what to check before buying for a touchscreen monitor.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "On price, it comes in below GUDTEKE 2Pack Magnetic 24 Inch Privacy Screen for Computer Monitor, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Touch compatibility not confirmed, verify with the seller before ordering for a touchscreen monitor.",
    "specs": [
      "24 inch, 16:9 aspect ratio",
      "Touch compatibility not stated"
    ],
    "pros": [
      "Largest review base of any 24 inch filter in our research"
    ],
    "cons": [
      "Touch compatibility not confirmed, verify with the seller before ordering for a touchscreen monitor"
    ],
  ...
  },
  {
    ...
    "description": "A magnetic hanging mount, which at least avoids a hard-pressed adhesive layer directly against the touch panel, though touch performance itself is not addressed in the listing.\n\nOn the other side, Touch compatibility not confirmed in the listing.",
    "specs": [
      "24 inch, 16:9 aspect ratio",
      "Magnetic mount, touch compatibility not stated"
    ],
    "pros": [
      "Magnetic mount design may reduce pressure directly on the touch panel compared to some adhesive designs"
    ],
    "cons": [
      "Touch compatibility not confirmed in the listing"
    ],
  ...
  },
  {
    ...
    "description": "On the other side, Touch compatibility not confirmed in the listing.",
    "specs": [
      "24 inch, 16:9 aspect ratio",
      "Single unit, touch compatibility not stated"
    ],
    "pros": [
      "Lower price for testing touch performance yourself"
    ],
    "cons": [
      "Touch compatibility not confirmed in the listing"
    ],
  ...
  },
  {
    ...
    "description": "The real tradeoff against that pick: Touch compatibility not confirmed in the listing.\n\nOn the other side, Touch compatibility not confirmed in the listing.",
    "specs": [
      "27 inch, 16:9 aspect ratio",
      "Single unit, touch compatibility not stated"
    ],
    "pros": [
      "Strong review base for a 27 inch single-unit filter"
    ],
    "cons": [
      "Touch compatibility not confirmed in the listing"
    ],
