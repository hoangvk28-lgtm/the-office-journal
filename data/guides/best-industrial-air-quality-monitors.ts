...
export const guideTitle = "The Best Industrial Air Quality Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Kidde Carbon Monoxide + Explosive Gas)",
        "text": "Connects directly to your router and app, no extra hardware needed."
      },
      {
        "label": "MSA 10178557 ALTAIR 4XR Multigas Detector)",
...
export const metaDescription = "A practical comparison of 8 industrial air quality monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Industrial Air Quality Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "pros": [
      ...
      "Easy time adjustment",
      "Quick °f/°c switching",
      "°F/°c selector & precision sensors"
    ],
    "cons": [
      "Laser PM2.5 sensors drift and may need recalibration after a year or two",
      "A single VOC number can't identify the specific chemical involved"
...
export const breadcrumbLabel = "Best Industrial Air Quality Monitors";
