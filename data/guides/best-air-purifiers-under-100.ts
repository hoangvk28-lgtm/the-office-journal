...
export const faq = [
  {
    "q": "Is a budget air purifier under $100 actually worth it?",
    "a": "Often yes for core filtration. The price cut is more often in smart features and app control than in core HEPA filtration quality, a genuine True HEPA budget unit can be a reasonable choice."
  },
  {
    "q": "What's the real cost of owning a cheap air purifier over time?",
    "a": "More than the sticker price suggests. Ongoing filter replacement cost over a year of regular use can rival or exceed the unit's original purchase price, factor that into your comparison."
  },
  {
    "q": "How do I know if a budget air purifier can cover my room?",
    "a": "Check for a specific disclosed square-footage or CADR rating rather than trusting vague 'large room' marketing language, which doesn't tell you much about actual capacity."
  },
  {
    "q": "Is the cheapest air purifier under $50 good enough for a bedroom?",
    "a": "It's best matched to a desk zone or small personal space rather than a full bedroom, expect a lower CADR at that price point."
  }
];

export const guideSlug = "best-air-purifiers-under-100";

export const guideTitle = "The Best Air Purifiers Under $100: Our Picks";
...
export const howWeEvaluated = [
  {
    "title": "True cost of ownership beyond the sticker price",
    "description": "Considered that ongoing filter replacement cost over a year of regular use can rival or exceed the unit's original purchase price, not just the upfront number."
  },
  {
    "title": "What the budget price cut actually sacrifices",
    "description": "Weighed that the price cut on a budget unit is more often in smart features and app control than in core filtration quality, evaluating each pick's actual HEPA and carbon filtration honestly."
  },
  {
    "title": "Coverage claims verified against price point",
    "description": "Checked whether each pick's disclosed coverage rating was reasonable for its price, rather than assuming a low price automatically means reduced coverage."
  }
];
...
export const introParagraphs = [
  ...
  "A budget unit under $100 can still be capable for a small-to-medium room, the price cut is more often in smart features and app control than in core filtration quality, worth knowing before assuming cheaper means meaningfully worse performance."
];
...
export const metaDescription = "How 5 air purifiers under $100 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Air Purifiers Under $100 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "The price cut here is in smart features and app control, not core filtration, factor in the replacement filter cost over a year when comparing this to pricier alternatives. Genuine True HEPA H13 filtration despite budget price.",
    "specs": [
      "True HEPA H13, 99.97% particulate removal",
      "24dB quoted noise level",
      "Under $90 at time of writing"
    ],
    "pros": [
      "Genuine True HEPA H13 filtration despite budget price",
      "Very quiet at 24dB",
    ...
    "cons": [
      ...
      "Standard CADR, not the highest airflow pick"
    ],
  ...
  },
  {
    ...
    "description": "Check the manufacturer's stated filter lifespan and current replacement filter price before buying, since ongoing cost over a year can rival the unit's original purchase price.\n\nThe standout detail is that low upfront price. Balancing that out, no filter indicator to track replacement timing.",
    "specs": [
    ...
    "pros": [
      "Low upfront price",
      "True HEPA filtration plus a carbon component",
      "Compact footprint"
    ],
    "cons": [
      "No filter indicator to track replacement timing",
      "No smart features",
      "No air quality sensor"
    ],
  ...
  },
  {
    ...
    "description": "A budget unit can still be capable for a small-to-medium room, this pick's disclosed coverage rating supports that at its price point.",
    "specs": [
      "HEPA filtration",
      "Larger-room marketing at a budget price",
      "Under $80 at time of writing"
    ],
    "pros": [
      "Affordable price for a larger-room-marketed unit",
      "Genuine HEPA filtration",
      "Good value for the coverage claimed"
    ],
    "cons": [
      "No smart app control",
      "No air quality sensor",
  ...
  },
  {
    ...
    "description": "Compare the manufacturer's filter lifespan claim against your actual usage before buying, cooking or pet-heavy homes will need more frequent replacement than the standard estimate.\n\nBoth are worth keeping in mind before deciding.",
    "specs": [
    ...
    "pros": [
      ...
      "True HEPA captures particulate effectively",
  ...
  },
  {
    ...
    "description": "At this price point, the ongoing filter replacement cost matters even more proportionally, factor that into your true cost of ownership over a year.",
    "specs": [
      "Compact desktop footprint",
      "Lowest price in this guide",
      "Under $50 at time of writing"
    ],
    "pros": [
...
export const relatedGuides = [
  {
    "href": "/guide/best-air-purifiers-under-200",
    "title": "Best Air Purifiers Under $200 (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Air Purifiers Under $100";
