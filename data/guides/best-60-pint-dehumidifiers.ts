...
export const guideTitle = "The Best 60-Pint Dehumidifiers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 60-pint dehumidifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 60-Pint Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 60-Pint Dehumidifiers";
