...
export const guideTitle = "The Best 5-Tier Storage Carts for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 5-tier storage carts, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 5-Tier Storage Carts for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 5-Tier Storage Carts";
