...
export const guideTitle = "The Best Outdoor Network Switches for Everyday Desk Work";
...
export const metaDescription = "How 7 outdoor network switches compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Outdoor Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BZGXQRQC?tag=theofficejournal-20",
    "description": "This IP65-rated outdoor switch packs 8 PoE ports with a 120W budget into a one-piece molded, waterproof enclosure built to withstand harsh weather, with 12Gbps backplane bandwidth for useful outdoor camera or AP deployments.\n\nAll 8 ports support PoE and can serve as uplinks, and 4KV lightning protection adds real resilience for exposed outdoor installation locations prone to electrical surges.",
    "specs": [
      "8x PoE ports @120W total, IP65 rated",
      "12Gbps backplane bandwidth",
      "4KV lightning protection"
    ],
    "pros": [
      "Genuine IP65 waterproof rating for outdoor use",
      "120W budget solid for 8 outdoor PoE devices",
      "4KV lightning protection for exposed installs"
    ],
    "cons": [
      "Unmanaged, no VLAN or QoS",
      "Wall/pole mount only, no rack option"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CQ2H55FY?tag=theofficejournal-20",
    "description": "3bt Type 4, passing through up to 64W across 4 output ports, extending PoE transmission distance to 200 meters for long-range camera or AP runs.\n\nIP55 weatherproofing and 4KV lightning protection handle outdoor conditions, while integration into TP-Link's Omada SDN platform adds cloud access and remote multi-site management for larger deployments.",
    "specs": [
      "1x PoE in, 4x PoE out, up to 200m range",
      "IP55 rated, 4KV lightning protection",
      "Omada SDN integration"
    ],
    "pros": [
      "PoE passthrough eliminates need for local power at the switch",
      "200m PoE reach doubles the standard 100m limit",
      "Omada SDN integration for remote multi-site management"
    ],
    "cons": [
      "Requires an existing 802.3bt-capable PoE source",
      "Only 4 output ports"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D1XZJQ19?tag=theofficejournal-20",
    "description": "Intellinet's outdoor switch runs on PoE++ input (up to 90W) and outputs an 85W PoE budget across 4 ports, extending reach from 100m to 200m, in an IP65 enclosure rated for dustproof and waterproof operation.\n\n44 Mpps forwarding rate round out solid performance specs, backed by a 3-year manufacturer warranty and built-in surge/overload protection.",
    "specs": [
      "4x PoE output @85W, 1 PoE++ input",
      "IP65 rated, extends to 200m",
      "3-year warranty"
    ],
    "pros": [
      "85W output budget solid for 4 outdoor PoE devices",
      "3-year warranty on outdoor-rated hardware",
      "9216-byte jumbo frame support"
    ],
    "cons": [
      "Requires an 802.3bt PoE source for full power",
      "Only 4 output ports"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BZH2W195?tag=theofficejournal-20",
    ...
    "specs": [
      "4x PoE ports @78W total, IP65 rated",
      "One-key VLAN isolation",
      "4KV lightning protection"
    ],
    "pros": [
      "Same IP65/lightning protection as the larger 8-port model",
      "One-key VLAN isolation for outdoor security",
      "Wall and pole mount kits included"
    ],
    "cons": [
      "Only 4 ports for smaller deployments",
      "Unmanaged, no true VLAN tagging"
    ],
...
export const breadcrumbLabel = "Best Outdoor Network Switches";
