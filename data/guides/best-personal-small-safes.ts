...
export const faq = [
  {
    "q": "What's the best personal safe for a dorm room?",
    "a": "The Master Lock Small Travel Safe with Cable, which tethers to a fixed object without needing to drill into dorm walls."
  },
  {
    "q": "Is there a self-locking option so I don't forget to lock it?",
    "a": "Yes, the Yuanshikj Small Steel Security Safe Box uses a magnetic auto-locking door that secures itself the moment you close it."
  },
  {
    "q": "Which pick best fits a passport without folding it?",
    "a": ""
  },
  {
    "q": "Is there an option for occasional trusted access by someone else?",
    "a": "Yes, the Digital Electronic Money Safe supports two independent access codes."
  },
  {
    "q": "Do these safes resist a determined break-in?",
    "a": "These are built primarily for privacy from roommates or family, not forced entry. For genuine high-security needs, look toward a heavier bolt-down safe."
  }
];

export const guideSlug = "best-personal-small-safes";

export const guideTitle = "The Best Personal Small Safes for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You're storing valuable or irreplaceable items, where KYODOLED Safe Box with Digital Keypad Lock's higher price buys real security or fire-protection headroom over the cheaper picks."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "Prioritized privacy from roommates or family over institutional theft resistance",
    "description": "Personal safes are usually about discretion in a shared living space, not defending against a break-in. We weighted self-locking design, lockout deterrents, and discreet fit accordingly."
  },
  {
    "title": "Checked portability for dorm, rental, and moving scenarios",
    "description": "The Master Lock and Amazon Basics picks are portable via tether or carry design; the mountable steel options assume a more permanent personal storage location."
  },
  {
    "title": "Verified interior dimensions against realistic personal items",
    "description": "We checked confirmed interior measurements against passports, wallets, medication, and small jewelry rather than assuming any small safe fits a personal item set equally well."
  },
  {
    "title": "Passed through manufacturer force-resistance disclosures honestly",
    "description": "One listing directly states its thin casing has limits under pry tools. We flagged this since a personal safe's threat model (roommate curiosity) differs from a high-security threat model."
  }
];
...
export const metaDescription = "A practical comparison of 8 personal small safes, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Personal Small Safes for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A tether cable secures this to a bed frame, desk, or radiator rather than requiring permanent mounting, useful for a dorm room or rental where you can't drill into a wall. A set-your-own four-digit combination avoids carrying a key that could be lost or borrowed.\n\nA dedicated ear bud or charging cable access port lets you charge a phone while it stays locked inside, and shock-absorbing foam construction is designed to be water-resistant for a bag or backpack.",
    "specs": [
      "Travel safe with tether cable",
      "4-digit combination, no key needed",
      "Charging cable access port, water-resistant"
    ],
    "pros": [
      "Tether cable specifically fits dorm/rental settings without drilling",
  ...
  },
  {
    ...
    "description": "Anti-pry steel construction with a foam-padded interior is explicitly rated for cash, jewelry, documents, and firearms together, a broad personal-item scope. A zinc alloy combination lock avoids managing a physical key.\n\nSmall enough to store discreetly in a closet or under a bed, and portable enough to relocate between a dorm room, apartment, or office desk drawer as your living situation changes.\n\nPortable between living situations.",
    "specs": [
    ...
    "pros": [
      "Explicitly rated for a broad range of personal item types",
      "portable between living situations"
    ],
    "cons": [
  ...
  },
  {
    ...
    "pros": [
      "Self-locking door removes the risk of accidentally leaving personal items exposed"
    ],
    "cons": [
      "Compact interior, verify your specific personal items fit"
    ],
  ...
  },
  {
    ...
    "description": "An automatic interior light switches on for 30 seconds when opened via keypad, useful if this lives in a dim closet where you're accessing personal items like medication or documents without fumbling. The keypad confirms correct entries with an indicator light.\n\nAn included waterproof and fireproof document bag protects paper items like passports specifically, and a three-wrong-entries lockout adds a real deterrent if a roommate or family member tries guessing your code.\n\nLockout deters roommates or family members guessing your code.",
    "specs": [
    ...
    "pros": [
      "Auto interior light helps with personal items in a dim closet",
      "Lockout deters roommates or family members guessing your code"
    ],
    "cons": [
      "Compact interior similar to other budget options"
    ],
  ...
  },
  {
    ...
    "description": "Two separate access codes work simultaneously, useful for a personal safe that also needs occasional trusted access, a partner, roommate, or parent, without sharing your primary code.\n\nHidden pry-resistant hinges reinforce privacy, and the package includes an anti-scratch carpet liner plus a full manual walking through the two-code setup.\n\nTwo independent codes support occasional trusted access without sharing your primary code. Both are worth keeping in mind before deciding.",
    "specs": [
    ...
    "pros": [
      "Two independent codes support occasional trusted access without sharing your primary code"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "The listing carries an explicit, useful warning for personal safe use specifically: never store the emergency keys inside the box itself, a common mistake that defeats a safe's purpose. Two solid anti-pry bolts and a corrosion-resistant coating back the physical construction.\n\n7 inches for a drawer, cabinet, or nightstand.",
    "specs": [
    ...
    "pros": [
      "Explicit key-storage warning, useful for a first personal safe"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "A USB-C interface supporting an external power bank means you're never locked out of your own personal items over a dead battery, useful if you need something like medication urgently. 71-inch steel reinforcement bolts and hidden hinges back the mounting.\n\nPersonal password or emergency key both work for access, with pre-drilled installation holes to fix it under a closet, drawer, or table.\n\nUSB-C emergency power backup ensures reliable access to personal items like medication. That said, no confirmed usage history for this specific listing yet.",
    "specs": [
    ...
    "pros": [
      "USB-C emergency power backup ensures reliable access to personal items like medication"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "75\" give a wide, flat layout suited to personal documents like a passport, checkbook, or watch without folding or stacking awkwardly. A customizable 3-8 digit code plus 2 emergency keys cover daily and backup access.\n\nA soft sponge-lined interior protects delicate personal items like jewelry or a watch from scratches, though the manufacturer directly states the thin metal casing has limits under pry tools or blunt force, worth weighing for a personal rather than high-security use case.",
    "specs": [
      "11.7×9.12×2.75 in wide flat interior",
      "3-8 digit customizable code + 2 emergency keys",
      "Sponge-lined interior for delicate items"
    ],
    "pros": [
      "Wide flat interior specifically suits passports and personal documents without folding"
    ],
    "cons": [
      "Manufacturer discloses thin casing has limited force resistance"
    ],
...
export const breadcrumbLabel = "Best Personal Small Safes";
