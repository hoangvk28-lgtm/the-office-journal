...
export const guideTitle = "The Best Misting Desk Fans for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Otlonpe Mini Handheld Misting Fan Portable)",
...
export const metaDescription = "A practical comparison of 7 misting desk fans, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Misting Desk Fans for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Cool misting fan",
      "Work time limit",
      "Portable fan is fitted with a 6-blade fan"
    ],
    "pros": [
      "Cool misting fan",
      "Work time limit",
      "Portable fan is fitted with a 6-blade fan",
      "Turn on the brightness setting"
    ],
    "cons": [
      "USB-powered models cap out at lower airflow than AC-plugged fans",
      "Noise rating usually reflects the lowest speed, not daily use"
  ...
  },
  {
    ...
    "specs": [
      "Enhanced mist cooling in seconds",
      "4-Speed turbo airflow",
      "10-Hour marathon battery life"
    ],
    "pros": [
      "Enhanced mist cooling in seconds",
      "4-Speed turbo airflow",
      "10-Hour marathon battery life",
      "Unleash hands-free convenience"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
  ...
  },
  {
    ...
    "description": "Otlonpe Portable Desk Misting Fan is a strong alternative worth comparing directly against the top pick. Strong airflow + ultrafine mist rapidly lowers body surface temperature by 20°f, delivering a personal ac feel. 5 hours per charge (varies by fan speed).\n\nDREO TurboCool Misting Fan 516 lands in a similar spot overall, but the deciding factor between the two is feel the fine mist cooling your skin while adding moisture.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    "specs": [
      "Instant cooling, up to 20°f temperature drop",
      "Built‐in 5000mah battery runs 3.5 to 13.5 hours per charge (varies by fan speed)",
      "Feel the fine mist cooling your skin while adding moisture"
    ],
    "pros": [
      "Instant cooling, up to 20°f temperature drop",
      "Built‐in 5000mah battery runs 3.5 to 13.5 hours per charge (varies by fan speed)",
      "Feel the fine mist cooling your skin while adding moisture",
      "Air circulator design, strong, smooth & 5 speeds"
    ],
    "cons": [
      "USB-powered models cap out at lower airflow than AC-plugged fans",
      "Noise rating usually reflects the lowest speed, not daily use"
  ...
  },
  {
    ...
    "specs": [
      "Dual-mode mist",
      "Give summer a reason to break free from charging cables",
      "Small cooling fans for bedroom features an imported high-performance motor paired with 7 curved"
    ],
    "pros": [
      "Dual-mode mist",
      "Give summer a reason to break free from charging cables",
  ...
  },
  {
    ...
    "description": "Otlonpe Mini Handheld Misting Fan Portable is a low-cost pick that doesn't skip the essentials. High‐pressure atomization creates an ultra‐fine mist that evaporates instantly on your skin, fast cooling without wetness or sticky residue. Don’t let the slim size fool you.\n\nDREO TurboCool Misting Fan 516 lands in a similar spot overall, but the deciding factor between the two is the LED display shows battery level and fan speed at a glance.\n\nIt's worth picking this one if you want a capable pick without paying for headroom you won't use. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    "specs": [
      "High‐pressure atomization creates an ultra‐fine mist that evaporates instantly on your skin",
      "Don’t let the slim size fool",
      "Weighing just 3.9 oz and as slim as a phone"
    ],
    "pros": [
      "High‐pressure atomization creates an ultra‐fine mist that evaporates instantly on your skin",
      "Don’t let the slim size fool",
      "Weighing just 3.9 oz and as slim as a phone",
      "LED display shows battery level and fan speed at a glance"
    ],
    "cons": [
      "USB-powered models cap out at lower airflow than AC-plugged fans",
      "Noise rating usually reflects the lowest speed, not daily use"
  ...
  },
  {
    ...
    "specs": [
      "All-day cooling without constant refills",
      "Need reliable cooling where wall outlets are unavailable",
      "Customizable 5-speed airflow & 4 mist modes"
    ],
    "pros": [
      "All-day cooling without constant refills",
      "Need reliable cooling where wall outlets are unavailable",
      "Customizable 5-speed airflow & 4 mist modes",
      "Engineered with an upgraded"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
...
export const breadcrumbLabel = "Best Misting Desk Fans";
