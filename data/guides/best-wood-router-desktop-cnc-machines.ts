...
export const buyingCriteria = [
  {
    ...
    "explanation": "Check wood router desktop cnc machines's usable Z-height and cutting area after the spoilboard and clamps are installed, not the nominal axis travel alone."
  },
  {
...
export const faq = [
  {
    "q": "Do I need a separate dust collector for wood router desktop cnc machines?",
...
export const guideTitle = "The Best Wood Router Desktop CNC Machines for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Check wood router desktop cnc machines's usable Z-height and cutting area after the spoilboard and clamps are installed, not the nominal axis travel alone."
  },
  {
...
export const introParagraphs = [
  "A quick scan of wood router desktop cnc machines listings rarely settles the question of checking work area, dust control, and spindle ecosystem for wood-specific routing, so that's where we started.",
  "We compared this lineup on documented rigidity and spindle evidence plus checking work area, dust control, and spindle ecosystem for wood-specific routing, since specs alone regularly overstate real-world cutting performance."
];
...
export const metaDescription = "A practical comparison of 8 wood router desktop CNC machines, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Wood Router Desktop CNC Machines for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-wood-router-desktop-cnc-machines-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-wood-router-desktop-cnc-machines-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-wood-router-desktop-cnc-machines-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-wood-router-desktop-cnc-machines-4",
    "rank": 4,
  ...
  {
    "id": "best-wood-router-desktop-cnc-machines-5",
    "rank": 5,
  ...
  {
    "id": "best-wood-router-desktop-cnc-machines-6",
    "rank": 6,
    "badge": "Solid Option",
  ...
  {
    "id": "best-wood-router-desktop-cnc-machines-7",
    "rank": 7,
    "badge": "Another Pick",
  ...
  {
    "id": "best-wood-router-desktop-cnc-machines-8",
    "rank": 8,
    "badge": "Budget Pick",
...
export const breadcrumbLabel = "Best Wood Router Desktop CNC Machines";
