...
export const guideTitle = "The Best Air Quality Monitors Under $50, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Antonki 2 Pack Room Thermometer Indoor Hygrometer)",
...
export const metaDescription = "We compared 8 air quality monitors under $50 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Air Quality Monitors Under $50 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "2-pack indoor hygrometer thermometer helps monitoring room temperature and humidity in real time",
      "Separate temperature and humidity sensors ensure a more accurate reading over time",
      "Bigger digital letters on the larger lcd screen"
    ],
    "pros": [
      "2-pack indoor hygrometer thermometer helps monitoring room temperature and humidity in real time",
      "Separate temperature and humidity sensors ensure a more accurate reading over time",
      "Bigger digital letters on the larger lcd screen",
      "Features durable kickstand and strong magnets"
    ],
    "cons": [
      "A single VOC number can't identify the specific chemical involved",
      "Laser PM2.5 sensors drift and may need recalibration after a year or two"
...
export const breadcrumbLabel = "Best Air Quality Monitors Under $50";
