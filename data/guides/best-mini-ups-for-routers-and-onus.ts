...
export const guideTitle = "The Best Mini UPS for Routers and ONUs: Picks and Trade-offs";
...
export const introParagraphs = [
  "Router-plus-ONU is one of the most well-supported combinations in this category, several brands explicitly market products for exactly this pairing, rather than it being an edge case retrofitted onto a single-device design.",
...
export const metaDescription = "A practical comparison of 6 mini UPS for routers and ONUs, focused on compatibility, build, features and price, and the trade-offs between them.";
...
export const breadcrumbLabel = "Best Mini UPS for Routers and ONUs";
