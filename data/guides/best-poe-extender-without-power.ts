...
export const buyingCriteria = [
  ...
  {
    "criterion": "An Industrial-Grade Metal Enclosure With a Wide Temperature Range Matters More for Harsh Deployment Environments",
    "explanation": "The LINOVISION pick's specifically stated IP53 metal enclosure and -22F to 149F operating range, combined with 4kV surge protection, target harsh industrial or outdoor environments more robustly than a standard plastic-enclosure extender rated for typical indoor or moderate outdoor use. This matters if your installation faces real temperature extremes, dust, or electrical surge risk, and matters less for a climate-controlled indoor network closet where a standard enclosure performs adequately. Check a passthrough extender's specific enclosure material, temperature range, and any stated surge protection rating if your deployment environment is demanding, rather than assuming any 'industrial' label means the same protection level."
  },
  {
    "criterion": "",
    "explanation": "3bt standards, simply won't receive power through these particular passthrough extenders. This matters significantly if you're not certain which PoE standard your existing device uses, since connecting an unsupported 24V passive device could result in it not powering on at all despite the extender otherwise functioning correctly for other devices. Verify your specific device's exact PoE standard against a passthrough extender's explicitly stated compatibility before purchasing, rather than assuming all PoE-labeled devices work interchangeably."
  }
];

export const faq = [
  {
    "q": "Do passthrough PoE extenders really need zero local power at all?",
    "a": "Yes, all four picks in this comparison specifically confirm they draw their entire operating power from the upstream PoE cable, requiring no local AC power adapter or outlet at the extender's own installation location."
  },
  {
    "q": "What's the most common mistake buyers make when choosing a passthrough PoE extender?",
    "a": ""
  },
  {
    "q": "Is the LINOVISION passthrough switch worth the higher price over the basic YuanLey extender?",
    "a": "If you're installing in a harsh industrial or outdoor environment and need surge protection and a wide temperature range, the LINOVISION's higher price is justified, but for a standard indoor installation, the YuanLey pick's lower price and similar core functionality make it the better value."
  },
  {
    "q": "Can I power a higher-wattage device like a PTZ camera through a passthrough extender with no local power?",
    "a": "Yes, but only through a pick with a dedicated higher-wattage port like the 100Mbps PoE Passthrough Switch's 60W output, since a standard 30W-only passthrough extender may not adequately power a higher-draw device."
  },
  {
    "q": "Will a passthrough extender work if my upstream switch doesn't provide enough total PoE power?",
    "a": "No, since a passthrough extender has no independent power source, its total available output wattage is limited by whatever your upstream PoE switch or injector can actually supply, so checking your switch's total power budget against your connected devices' combined draw is important."
  },
  {
    "q": "Do I need VLAN isolation for a simple home network with just a couple of security cameras?",
    "a": "VLAN isolation matters more in shared or multi-tenant installations where different devices need to be kept from seeing each other's traffic; for a simple home network with trusted devices, it's a nice-to-have feature rather than a strict requirement."
  }
];

export const guideSlug = "best-poe-extender-without-power";

export const guideTitle = "The Best PoE Extenders That Need No Local Power for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "To power three devices with VLAN isolation, no local power",
          "YuanLey 4 Port PoE Extender Gigabit"
        ],
        [
          "No local power in a harsh, industrial setting",
          "LINOVISION 2 Ports Gigabit PoE Passthrough Switch"
        ],
        [
          "The lowest price with a dedicated high-power port",
          "PoE Passthrough Switch, 1 in 4 Out Extender"
        ],
        [
          "Gigabit speed with zero local power anywhere in the chain",
          "Gigabit PoE Passthrough Switch, 1 in 3 Out Extender"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Gigabit speed (YuanLey, Gigabit Passthrough Switch)",
        "text": "Both maintain full 1000Mbps throughput, better suited to bandwidth-hungry devices like 4K IP cameras, though neither has a dedicated port above standard 30W."
      },
      {
        "label": "Dedicated high-power port (100Mbps Passthrough Switch)",
        "text": "Trades Gigabit speed for a dedicated 60W output port, better suited to a single higher-wattage device like a PTZ camera alongside standard ones."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Indoor office or home network closet",
          "YuanLey 4 Port PoE Extender or PoE Passthrough Switch"
        ],
        [
          "Harsh industrial or outdoor enclosure",
          "LINOVISION 2 Ports Gigabit PoE Passthrough Switch"
        ],
        [
          "",
          "Any of the four picks support DIN-rail mounting"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "An extender explicitly described as passthrough or requiring no AC power supply, confirming it draws 100% of its operating power from the upstream PoE cable rather than needing a separate local outlet."
      },
      {
        "label": "",
        "text": "All four picks specifically confirm no local power requirement, making any of them suitable for a location with no nearby electrical outlet."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "99 price is justified by its industrial-grade build."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared whether each unit draws 100% of its power from the upstream PoE source with no local outlet needed."
  },
  {
    "title": "Per-Port Wattage and Standard Support",
    "description": "3af/at/bt support and per-port wattage for different device power needs."
  },
  {
    "title": "VLAN and Network Security Features",
    "description": "Compared VLAN isolation availability across output ports."
  },
  {
    "title": "Physical Build for Installation Flexibility",
    "description": "Compared enclosure material, size, and mounting options for different installation environments."
  },
  {
    "title": "",
    "description": "Compared Gigabit versus Fast Ethernet speeds and multi-unit cascading distance."
  }
];
...
export const metaDescription = "We compared 4 PoE extenders that need no local power on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best PoE Extenders That Need No Local Power for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "No local power required, draws from upstream PoE only",
      "1 in 3 out, VLAN isolation on all ports",
      "3-level cascade for up to 1312ft total distance"
    ],
    "pros": [
      "no local power needed at any point in the extension chain",
      "VLAN isolation on all output ports improves network security",
      "Powers three separate devices from a single upstream input"
    ],
    "cons": [
      "Max output per port is limited to standard 30W, not higher-wattage devices",
      "Compact size means fewer total ports than some passthrough switch alternatives"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0FMK1TTS3?tag=theofficejournal-20",
    "description": "This extender's listing specifically states an IP53 metal enclosure with a wide operating temperature range of -22F to 149F, designed for harsh environments while still requiring no local power connection. 09-inch size fits into wall-mount brackets, junction boxes, and other outdoor waterproof enclosures for flexible installation.\n\nCompared to the YuanLey pick above, this one's specifically stated 4kV surge protection and enhanced metal casing with heat dissipation give it a more industrial-grade build quality aimed at DIN-rail mounted installations in demanding settings.\n\nBest for buyers who need no local power in a harsh or industrial-grade installation environment.",
    "specs": [
      "No local power required, IP53 metal enclosure",
      "-22F to 149F wide operating temperature range",
      "4kV surge protection, DIN-rail mounting"
    ],
    "pros": [
      "4kV surge protection is a concrete industrial-grade safeguard",
      "IP53 metal enclosure with wide temperature tolerance suits harsh settings",
      "Compact size fits into junction boxes and outdoor enclosures"
    ],
    "cons": [
      "Only splits to 2 outputs, fewer than the YuanLey or passthrough switch picks",
      "Higher price than the 4-port PoE Passthrough Switch pick below"
    ],
    "bestFor": "Buyers who need no local power in a harsh or industrial-grade environment"
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CRB3THFS?tag=theofficejournal-20",
    "description": "3bt input into one dedicated 60W output port and three standard 30W output ports. Its VLAN mode, controlled by a dipswitch, isolates output ports 2 through 5 from each other for improved network security.\n\nCompared to the YuanLey and LINOVISION picks above, this one's lowest price in this comparison and dedicated 60W output port together deliver genuine value for buyers needing to power one higher-wattage device alongside standard ones, all without local power.\n\nBest for buyers who want the lowest price with a dedicated high-power port and zero local power requirement.",
    "specs": [
      "No local power required, 90W input to 4 outputs",
      "One 60W port + three 30W ports (IEEE 802.3bt/at)",
      "VLAN mode via dipswitch, 3-level cascading"
    ],
    "pros": [
      "Lowest price in this comparison at $19.99",
      "Dedicated 60W output port supports one higher-power device",
      "VLAN mode isolates ports for improved network security"
    ],
    "cons": [
      "Explicitly does not support 24V passive PoE devices",
      "100Mbps port speed is lower than the Gigabit-rated picks above"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BWMSPLLF?tag=theofficejournal-20",
    ...
    "specs": [
      "No local power required, Gigabit 1000Mbps rate",
      "1 in 3 out, LED port status display",
      "3-level cascading, wall or DIN-rail mount"
    ],
    "pros": [
      "Maintains full Gigabit speed unlike the 100Mbps passthrough switch pick",
      "LED port status display helps with quick troubleshooting",
      "3-level cascading extends coverage at low cost, no local power anywhere"
    ],
    "cons": [
      "Explicitly does not support 24V passive PoE devices",
      "Average 8W per port output is lower than the dedicated 60W port on other picks"
    ],
...
export const breadcrumbLabel = "Best PoE Extenders That Need No Local Power";
