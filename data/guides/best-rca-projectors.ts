...
export const guideTitle = "The Best RCA Projectors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "RCA RPJ136 Home Theater Projector)",
...
export const metaDescription = "How 8 RCA projectors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best RCA Projectors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Streaming stick, this WiFi home movie projector",
      "Experience high-definition picture quality with the proscan",
      "150 ANSI lumens, this portable video projector"
    ],
    "pros": [
      "Streaming stick, this WiFi home movie projector",
      "Experience high-definition picture quality with the proscan",
      "150 ANSI lumens, this portable video projector",
      "Bluetooth projector lets you connect wirelessly"
    ],
    "cons": [
      "Throw ratio needs checking against your room distance",
      "Marketed lumens and true ANSI lumens often differ"
...
export const breadcrumbLabel = "Best RCA Projectors";
