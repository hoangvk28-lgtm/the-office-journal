...
export const buyingCriteria = [
  {
    ...
    "explanation": "Look for documented feeds, tooling, and cut depth specific to steel desktop cnc machines rather than a generic material-compatibility badge."
  },
  {
...
export const guideTitle = "The Best Steel Desktop CNC Machines for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Look for documented feeds, tooling, and cut depth specific to steel desktop cnc machines rather than a generic material-compatibility badge."
  },
  {
...
export const introParagraphs = [
  "The real test for steel desktop cnc machines comes down to requiring real cut evidence for steel and stainless, the highest-risk material claim in this category, not a glance at the listing photo.",
  "Rather than trust manufacturer claims, we checked documented rigidity and spindle evidence plus requiring real cut evidence for steel and stainless, the highest-risk material claim in this category for every machine on this list."
];
...
export const metaDescription = "We compared 5 steel desktop CNC machines on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Steel Desktop CNC Machines for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-steel-desktop-cnc-machines-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-steel-desktop-cnc-machines-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-steel-desktop-cnc-machines-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-steel-desktop-cnc-machines-4",
    "rank": 4,
  ...
  {
    "id": "best-steel-desktop-cnc-machines-5",
    "rank": 5,
    "badge": "Budget Pick",
...
export const breadcrumbLabel = "Best Steel Desktop CNC Machines";
