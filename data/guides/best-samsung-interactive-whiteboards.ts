...
export const guideTitle = "The Best Samsung Interactive Whiteboards for a Better Desk Setup";
...
export const metaDescription = "We compared 5 samsung interactive whiteboards on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Samsung Interactive Whiteboards for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DT4QMCT2?tag=theofficejournal-20",
    ...
    "specs": [
      "75in, EDLA-certified, 40-point touch",
      "Dual pen, 3-in-1 USB-C (65W)",
      "9-device screen mirroring"
    ],
    "pros": [
      "Dual pen function switches colors with no settings change",
      "3-in-1 USB-C handles video, touch, and 65W charging in one cable",
      "Device management solution built in for IT admins"
    ],
    "cons": [
      "OPS Windows module sold separately",
      "Higher price tier than Samsung's WAF series"
    ],
  ...
  },
  {
    ...
    "reviews": null,
    "imageUrl": "https://m.media-amazon.com/images/I/41cczJ33FSL._SL500_.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0FCMYZBD5?tag=theofficejournal-20",
    ...
    "specs": [
      "86in, EDLA-certified, 40-point touch",
      "Dual pen, 3-in-1 USB-C (65W)",
      "9-device screen mirroring"
    ],
    "pros": [
      "Same advanced feature set as the 75-inch WAD at larger scale",
      "Dual pen and 40-point touch for serious collaboration",
      "Centralized device management for IT"
    ],
    "cons": [
      "OPS Windows module sold separately",
      "Premium pricing versus Samsung's WAF series"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0D6XDQG6W?tag=theofficejournal-20",
    ...
    "specs": [
      "55in 4K, universal casting",
      "20 touchpoints, SmartView Plus (6 screens)",
      "Family-friendly durable design"
    ],
    "pros": [
      "Universal pairing works across Apple, Google, and other ecosystems",
      "SmartView Plus displays up to 6 screens from 50 paired devices",
      "Built specifically for family/home durability"
    ],
    "cons": [
      "Positioned for home use, not classroom-grade EDLA management",
      "20 touchpoints lower than Samsung's education-focused WAD series"
    ],
...
export const breadcrumbLabel = "Best Samsung Interactive Whiteboards";
