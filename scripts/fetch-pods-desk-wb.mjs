...
const PARTNER_TAG = process.env.AMAZON_PAAPI_PARTNER_TAG ?? "theofficejournal-20";
...
const allAsins = [
"B0D4K6VT83","B0F3W1S3ST","B0D5C1H18W","B0F1JNYJJM","B0H372ZYVL","B0CW1VSGHG","B0DSBLCYZX","B0DRNJWS8Q","B0F62Z8CFF","B0H4412Y7J",
"B0FG52KXT9","B07F7BHWC1","B07F7LTZ44","B07S8DRKHC","B00P1AJ9N8","B07VBGG5QJ","B07Y3ZCDTF","B07S7FP1YK","B07S7FP6CC","B0B4JZCR89","B0DDB8BMCM","B07F7GHGJ1",
"B0B3QDBPQH","B08R3V1YTB","B0BVM9YJCS","B089NL8QMN","B08V4QSPFD","B0CFLB1LPN","B01MFGICQT","B0CL42YP8H","B01M2DADUX","B0774Y814B","B09C1VT7X8","B09W5P5C5N","B09LSDSG52","B09VL1QL8F",
];
...
writeFileSync(resolve(ROOT, "scripts", "data-pods-desk-wb.json"), JSON.stringify(allItems, null, 2), "utf8");
...
writeFileSync(resolve(ROOT, "scripts", "lookup-pods-desk-wb.json"), JSON.stringify(lookup, null, 2), "utf8");
console.log("Saved to scripts/data-pods-desk-wb.json and scripts/lookup-pods-desk-wb.json");
