...
export const faq = [
  {
    ...
    "a": "Size for your actual use case. A one-time multi-year backlog project benefits from high ADF capacity and sustained duty cycle (like the ScanSnap iX2400); ongoing annual scanning is a much lighter need better matched to a moderate-capacity pick."
  },
  {
    "q": "Why does archival tax document scanning take so much longer than a normal scan?",
    "a": "600 DPI archival-quality scanning, recommended for the 3-7 year legibility window most tax retention guidance suggests, takes considerably longer per page than standard 300 DPI scanning."
  },
  {
    "q": "Is it safe to store scanned tax documents with SSNs in cloud storage?",
    "a": "Only if your cloud provider uses appropriate encryption, and none of the scanners in this guide confirm a specific encryption standard themselves. Verify your chosen cloud storage provider's security practices separately."
  },
  {
    "q": "Do any of these scanners automatically recognize and label W-2s or 1099s?",
    "a": "Tax form auto-recognition is a specialized feature some tax-prep software offers, none of the picks in this guide confirm this capability, expect to organize scanned tax forms manually."
  }
];

export const guideSlug = "best-document-scanners-for-tax-documents";

export const guideTitle = "The Best Document Scanners for Tax Documents: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    "title": "Ongoing annual scanning, sized separately",
    "description": "Distinguished picks suited to a one-time large multi-year backlog project (high ADF capacity, sustained duty cycle) from ones better matched to lighter ongoing annual scanning, since these are different use cases with different sizing needs."
  },
  {
    "title": "Sensitive data encryption verification for SSN/account-number content",
    "description": "Checked whether any listing confirms an encryption standard for cloud storage or wireless transmission, none of the picks in this guide do, a real gap for tax documents containing highly sensitive personal data."
  },
  {
    "title": "Archival DPI speed tradeoff for long-term legibility",
    "description": "Noted that 600 DPI archival scanning, recommended for the 3-7 year retention window tax documents typically need, takes considerably longer per page than standard 300 DPI."
  }
];
...
export const metaDescription = "A practical comparison of 6 document scanners for tax documents, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Document Scanners for Tax Documents (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A 100-sheet feeder with high sustained duty cycle, well-suited to a one-time project digitizing years of accumulated paper tax records, a different need than lighter ongoing annual scanning. Running at higher archival DPI settings will meaningfully slow per-page speed versus this scanner's rated ppm, plan your backlog project timeline accordingly.\n\nNo tax-form auto-recognition (W-2/1099/K-1) or year-based auto-foldering confirmed, this is a strong raw-scanning workhorse, not an automated tax-document organizer.\n\nHigh sustained duty cycle for multi-year archives. Both are worth keeping in mind before deciding.",
    "specs": [
      "100-sheet feeder, high sustained duty cycle",
      "Wired USB, ScanSnap Home software",
      "One-touch scan-drag-drop",
      "Auto de-skew, blank-page removal"
    ],
    "pros": [
      "Well-suited to one-time large backlog digitization projects",
      "High sustained duty cycle for multi-year archives",
      "Wired USB avoids wireless reliability risk during long sessions",
      "Auto image cleanup features"
    ],
    "cons": [
      "No tax form auto-recognition (W-2/1099/K-1)",
      "No year-based auto-foldering/naming confirmed",
      "Higher-DPI archival scanning will be slower than the rated ppm"
    ],
  ...
  },
  {
    ...
    "description": "A 50-sheet ADF is appropriate sizing for ongoing annual tax-document scanning, a much lighter use case than a full multi-year backlog project, don't overspend on the largest-capacity picks if this describes your actual need. Searchable PDF OCR is built in, useful for finding specific documents come filing season.\n\nSensitive tax data (SSNs, account numbers) deserves verified encryption for any cloud storage destination, this scanner doesn't disclose a specific encryption standard, verify separately with your storage provider.",
    "specs": [
      "50-sheet ADF, duplex, appropriately sized for annual use",
      "Searchable PDF OCR",
      "TWAIN driver",
      "Auto crop, blank-page removal"
    ],
    "pros": [
      "Appropriately sized for ongoing annual tax scanning rather than a full backlog project",
      "Searchable PDF OCR for finding documents at filing time",
      "Genuine duplex ADF",
      "Reasonable price for the capability"
    ],
    "cons": [
      "No tax form auto-recognition",
      "No specific encryption standard disclosed for cloud storage",
      "No year-based auto-foldering confirmed"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Explicit daily volume disclosure aids tax-season planning",
      "portable for scanning wherever documents are stored",
      "Real ADF hopper",
      "USB powered, no external adapter"
    ],
    "cons": [
      "Lower capacity than the desktop high-volume picks for a large backlog",
      "No tax form auto-recognition",
      "No specific encryption standard disclosed"
    ],
  ...
  },
  {
    ...
    "description": "A low-cost single-sided sheetfed scanner, appropriate if your tax document volume is modest, a handful of forms scanned individually each year rather than a large batch project. HP WorkScan software is included without tax-specific features.\n\nSame encryption caveat applies, verify your cloud storage destination's security standard separately for sensitive SSN-containing tax documents.\n\nPortable, PC and Mac compatible.",
    "specs": [
    ...
    "pros": [
      "low-cost for modest annual tax document volume",
      "Portable, PC and Mac compatible",
      "Simple single-sheet feeding",
      "Compact"
    ],
    "cons": [
      "1-sided only, no duplex",
      "Not built for a large backlog project",
      "No specific encryption standard disclosed"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Wireless flexibility for document storage location",
      "Searchable PDF OCR for finding tax documents later",
      "TWAIN driver compatibility"
    ],
    "cons": [
      "Highest price in this guide",
      "No specific encryption standard confirmed for wireless transmission",
      "No tax form auto-recognition"
    ],
...
export const breadcrumbLabel = "Best Document Scanners for Tax Documents";
