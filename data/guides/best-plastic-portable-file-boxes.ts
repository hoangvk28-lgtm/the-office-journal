...
export const faq = [
  {
    "q": "Is plastic durable enough for a file box?",
    "a": "Quality high-density plastic, like the top picks in this comparison, offers genuine durability at a significant weight savings over metal. Avoid unverified, low-review-count listings, since thin plastic can crack under handling."
  },
  {
    "q": "Will a clear plastic file box turn yellow over time?",
    "a": "It can with prolonged UV exposure, particularly if stored near a window. If this concerns you, choose an opaque plastic box instead, which avoids this specific issue."
  },
  {
    "q": "How much lighter is plastic than metal?",
    "a": "Significantly lighter, the primary reason to choose plastic over metal for this portable-focused category. See our metal file box guide if you specifically need metal's dent resistance instead."
  },
  {
    "q": "Will the latch on a plastic box wear out?",
    "a": "It's possible with frequent use, since plastic latch mechanisms can wear or crack faster than metal equivalents. Favor picks with strong, proven review histories as evidence of long-term latch reliability."
  },
  {
    "q": "Can I fit legal size documents in a plastic file box?",
    "a": "Only in picks that explicitly support legal size, like the IRIS USA 35 Qt box. Several picks in this comparison are letter size only, so check before ordering."
  }
];

export const guideSlug = "best-plastic-portable-file-boxes";

export const guideTitle = "The Best Plastic Portable File Boxes for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We looked past generic 'plastic' labeling to material quality where disclosed, since thin, brittle plastic can crack under handling despite the same base labeling as high-density plastic."
  },
  {
    "title": "",
    "description": "We noted this specifically for clear plastic picks, since prolonged sun exposure can cause brittleness and yellowing over years of use."
  },
  {
    "title": "Latch and hinge durability under repeated use",
    "description": "We considered plastic-specific latch and hinge wear, since these mechanisms can crack faster on plastic than metal equivalents under repeated cycles."
  },
  {
    "title": "",
    "description": "We highlighted plastic's genuine weight savings over metal as this material's primary benefit for a category centered on portability."
  }
];
...
export const metaDescription = "How 5 plastic portable file boxes compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Plastic Portable File Boxes for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "This plastic box carries the strongest combined rating and review volume of any pick in this comparison, real evidence the material and latch hold up under genuine repeated use rather than cracking or wearing prematurely.\n\nMost proven plastic build by review volume. On price, it's actually priced above IRIS USA File Box Organizer with Lid, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Less dent-resistant than a metal equivalent.",
    "specs": [
    ...
    "pros": [
      "Most proven plastic build by review volume",
      "Significant weight savings over metal",
    ...
    "cons": [
      "Letter size only",
      "No lock",
      "Less dent-resistant than a metal equivalent"
    ],
  ...
  },
  {
    ...
    "description": "This 35-quart clear plastic box offers the largest capacity in this comparison, with a latching lid more secure than a simple friction fit. Being clear, it carries the UV brittleness risk we noted if stored near a window long-term.\n\nOn the other side, Heavier when fully loaded given the larger size.",
    "specs": [
      "35 qt capacity, clear plastic",
      "Latching lid",
    ...
    "cons": [
      "UV exposure can cause clear plastic to yellow and become brittle over years",
  ...
  },
  {
    ...
    "description": "This tote-style plastic box is confirmed hanging-file compatible at the most affordable price point in this comparison, a solid choice if latch durability under repeated use matters more to you than a lock feature.\n\nLetter/Legal File Box with Latching Lid, it's priced lower than IRIS USA 35 Qt. Letter/Legal File Box with Latching Lid. The real tradeoff against that pick: Letter size only.\n\nOn the other side, Standard plastic grade.",
    "specs": [
      "Tote-style plastic design",
    ...
    "cons": [
      "Letter size only",
      "Basic latch durability under repeated cycles",
      "Standard plastic grade"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-clear-portable-file-boxes",
    "title": "Best Clear Portable File Boxes (2026)"
  }
];

export const breadcrumbLabel = "Best Plastic Portable File Boxes";
