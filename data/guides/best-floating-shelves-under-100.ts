export const guideSlug = "best-floating-shelves-under-100";
export const guideTitle = "8 Best Floating Shelves Under $100 in 2026";
export const metaTitle = "Best Floating Shelves Under $100";
export const metaDescription = "We compared floating shelf system models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "floating shelf system";
export const introParagraphs = [
  "Best Floating Shelves Under $100 aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
  "This roundup weighs real weight capacity and mounting hardware, given that marketing copy tends to obscure this."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-floating-shelves-under-100-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-floating-shelves-under-100-2",
    rank: 2,
  ...
  {
    id: "best-floating-shelves-under-100-3",
    rank: 3,
  ...
  {
    id: "best-floating-shelves-under-100-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-floating-shelves-under-100-5",
    rank: 5,
  ...
  {
    id: "best-floating-shelves-under-100-6",
    rank: 6,
  ...
  {
    id: "best-floating-shelves-under-100-7",
    rank: 7,
  ...
  {
    id: "best-floating-shelves-under-100-8",
    rank: 8,
    badge: "Also Worth Considering",
