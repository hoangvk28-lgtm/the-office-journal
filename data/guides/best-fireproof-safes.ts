...
export const faq = [
  {
    "q": "Is a fireproof safes fireproof, or just fire-resistant?",
...
export const guideTitle = "The Best Fireproof Safes for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 fireproof safes, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Fireproof Safes for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-budget-fireproof-safes",
    "title": "Best Budget Fireproof Safes in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Fireproof Safes";
