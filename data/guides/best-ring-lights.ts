...
export const introParagraphs = [
  "Best Ring Lights aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
  "This roundup weighs honest color temperature and mount type, given that this is where the decision gets made."
];
