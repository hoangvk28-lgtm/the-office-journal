...
export const guideTitle = "The Best Wi-Fi Projectors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 wi-fi projectors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Wi-Fi Projectors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Wi-Fi Projectors";
