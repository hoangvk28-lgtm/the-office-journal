...
export const guideTitle = "The Best 4K QLED Gaming Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 6 4K QLED gaming monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 4K QLED Gaming Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 4K QLED Gaming Monitors";
