...
export const guideTitle = "The Best Cutter Desktop CNC Machines for Everyday Desk Work";
...
export const metaDescription = "How 8 cutter desktop CNC machines compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cutter Desktop CNC Machines for Home Offices (2026)";
...
export const relatedGuides = [
  {
    "href": "/guide/best-desktop-cnc-routers",
    "title": "Best Desktop CNC Routers in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Cutter Desktop CNC Machines";
