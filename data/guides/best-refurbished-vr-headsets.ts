...
export const guideTitle = "The Best Refurbished VR Headsets for a Better Desk Setup";
...
export const metaDescription = "We compared 6 refurbished VR headsets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Refurbished VR Headsets for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-playstation-vr-headsets",
    "title": "Best PlayStation VR Headsets in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Refurbished VR Headsets";
