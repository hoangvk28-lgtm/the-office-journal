...
export const guideTitle = "The Best Aprilaire Dehumidifiers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 aprilaire dehumidifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Aprilaire Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Aprilaire Dehumidifiers";
