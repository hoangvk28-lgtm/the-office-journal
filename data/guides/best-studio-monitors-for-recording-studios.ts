...
export const guideTitle = "The Best Studio Monitors for Recording Studios: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "You're just starting out and want capable sound without overspending, where Gemini 5\" Bluetooth Studio Monitors already covers the job."
      }
    ]
  }
];
...
export const metaDescription = "How 8 studio monitors for recording studios compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Studio Monitors for Recording Studios (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Powerful sound built for your space",
      "Bluetooth plus every input you need",
      "One power plug for the pair"
    ],
    "pros": [
      "Powerful sound built for your space",
      "Bluetooth plus every input you need",
      "One power plug for the pair",
      "Tune your sound to your room"
    ],
    "cons": [
      "Stands or isolation pads are usually a separate purchase",
      "Room acoustics affect the sound more than the speaker"
...
export const breadcrumbLabel = "Best Studio Monitors for Recording Studios";
