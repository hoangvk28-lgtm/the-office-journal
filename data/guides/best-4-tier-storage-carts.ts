...
export const guideTitle = "The Best 4-Tier Storage Carts for a Better Desk Setup";
...
export const metaDescription = "We compared 8 4-tier storage carts on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 4-Tier Storage Carts for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 4-Tier Storage Carts";
