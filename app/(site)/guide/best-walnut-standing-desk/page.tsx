...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-walnut-standing-desk";
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-walnut-standing-desk` },
    about: [{"@type":"Thing","name":"Walnut Standing Desk"},{"@type":"Thing","name":"Black Walnut Desk"},{"@type":"Thing","name":"Electric Height Adjustable Desk"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Walnut Standing Desks", item: `${SITE_URL}/guide/best-walnut-standing-desk` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-walnut-standing-desk#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Walnut Standing Desks</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Walnut Standing Desks" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A walnut standing desk adds a warm executive aesthetic to a home office at a fraction of the cost of solid walnut furniture, using walnut-tone laminate over MDF that looks similar at normal viewing distance.</p>
          <p>This guide covers eight walnut standing desks ranked by walnut tone (black, dark, special), size (32 to 79 inches), special features (drawers, L-shaped, 3-stage legs), and value.</p>
          <p>For a glass surface alternative with a different aesthetic, see our <a href='/guide/best-glass-standing-desk' className='text-brand hover:underline'>best glass standing desks</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=walnut+standing+desk+electric+black+walnut&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
