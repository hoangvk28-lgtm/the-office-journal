...
export const guideTitle = "6 Best Cable Sleeves Under $100 in 2026";
export const metaTitle = "Best Cable Sleeves Under $100";
export const metaDescription = "We compared cable sleeves under $100 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Zipper (e.g. Klyeola 2Pcs Spiral Cable Protector)",
