...
export const guideTitle = "The Best 1440p OLED Gaming Monitors for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 6 1440p OLED gaming monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 1440p OLED Gaming Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 1440p OLED Gaming Monitors";
