...
export const guideTitle = "The Best Low-Profile Microphone Arms for Everyday Desk Work";
...
export const metaDescription = "How 8 low-profile microphone arms compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Low-Profile Microphone Arms for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Low-Profile Microphone Arms";
