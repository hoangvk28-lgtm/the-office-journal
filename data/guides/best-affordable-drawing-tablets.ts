...
export const buyingCriteria = [
  {
    "criterion": "",
    "explanation": "Verify affordable drawing tablets's current price and include any required adapters or stand in the total cost before calling it a deal."
  },
  {
...
export const faq = [
  {
    "q": "Are budget affordable drawing tablets usable, or do they cut corners that matter?",
...
export const guideSlug = "best-affordable-drawing-tablets";

export const guideTitle = "The Best Affordable Drawing Tablets for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Verify affordable drawing tablets's current price and include any required adapters or stand in the total cost before calling it a deal."
  },
  {
...
export const introParagraphs = [
  "Most affordable drawing tablets buyers skip straight to pressure levels, when the more useful first step is prioritizing line quality and driver stability over a high pressure-level number.",
...
export const mainKeyword = "affordable drawing tablets";

export const metaDescription = "A practical comparison of 6 affordable drawing tablets, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Affordable Drawing Tablets for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-affordable-drawing-tablets-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-affordable-drawing-tablets-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-affordable-drawing-tablets-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-affordable-drawing-tablets-4",
    "rank": 4,
  ...
  {
    "id": "best-affordable-drawing-tablets-5",
    "rank": 5,
  ...
  {
    "id": "best-affordable-drawing-tablets-6",
    "rank": 6,
    "badge": "Budget Pick",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-drawing-tablets-under-100",
    "title": "Best Drawing Tablets Under $100 in 2026"
  }
];

export const breadcrumbLabel = "Best Affordable Drawing Tablets";
