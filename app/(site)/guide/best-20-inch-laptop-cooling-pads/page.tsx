...
import {
  ...
  howToChoose,
  type GuideProduct,
} from "@/data/guides/best-20-inch-laptop-cooling-pads";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-20-inch-laptop-cooling-pads",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-20-inch-laptop-cooling-pads` },
    about: [{"@type":"Thing","name":"Best 20-Inch Laptop Cooling Pads in 2026 (Honest Category Guide)"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best 20-Inch Laptop Cooling Pads in 2026 (Honest Category Guide)", item: `${SITE_URL}/guide/best-20-inch-laptop-cooling-pads` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-20-inch-laptop-cooling-pads#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best 20-Inch Laptop Cooling Pads in 2026 (Honest Category Guide)</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-white h-56 sm:h-64 md:hidden flex items-center justify-center p-3">
          <Image src={heroImg} alt="Best 20-Inch Laptop Cooling Pads in 2026 (Honest Category Guide)" width={900} height={420} className="w-full h-full object-contain" priority unoptimized />
        </div>
        <div
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Before comparing products, it's worth being direct: very few consumer laptops genuinely use a 20-inch class chassis, and none of the cooling pads in our research pool explicitly state compatibility up to a full 20 inches. The largest verified, explicitly stated range we found tops out at 18 to 19 inches.</p>
          <p>If you're searching for a 20-inch laptop cooling pad, you're most likely either using "20-inch" loosely to mean the largest available desktop-replacement gaming laptop (typically 17 to 18 inches in practice), or you have a genuinely unusual, very large laptop that falls outside what mainstream cooling pads are built for. This guide covers the largest genuinely verified options as a practical fallback, with that gap stated plainly rather than implied.</p>
        </section>

        {buyingCriteria.length > 0 && (
          <section className="mb-12 p-6 rounded-2xl border border-border bg-white">
            <h2 className="text-xl font-bold text-ink mb-1 tracking-tight">{buyingCriteria.length} Criteria to Look For Before Buying a 20-Inch Laptop Cooling Pads in 2026 (Honest Category Guide)</h2>
        ...
        {howWeEvaluated.length > 0 && (
          <section className="mb-12 p-6 rounded-2xl border border-border bg-white">
            <h2 className="text-xl font-bold text-ink mb-1 tracking-tight">How We Evaluated These 20-Inch Laptop Cooling Pads in 2026 (Honest Category Guide)</h2>
        ...
        {howToChoose.length > 0 && (
          <section className="mb-14">
            <h2 className="text-2xl font-bold text-ink mb-6 tracking-tight">How to Choose the Right 20-Inch Laptop Cooling Pads in 2026 (Honest Category Guide)</h2>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=20-inch+laptop+cooling+pads&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
