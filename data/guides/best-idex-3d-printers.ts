...
export const guideTitle = "The Best IDEX 3D Printers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Official IdeaFormer-3D IR3 V2 Conveyor Belt 3D Printer)",
...
export const metaDescription = "How 6 IDEX 3D printers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best IDEX 3D Printers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Ideaformer ir3 v2’s rolling conveyor belt enables continuous z-axis printing",
      "Upgraded metal conveyor belt",
...
export const breadcrumbLabel = "Best IDEX 3D Printers";
