...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-tv-stand-for-85-inch-tv";
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-tv-stand-for-85-inch-tv` },
    about: [{"@type":"Thing","name":"TV Stand"},{"@type":"Thing","name":"85 Inch TV"},{"@type":"Thing","name":"Entertainment Center"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best TV Stands for 85 Inch TVs", item: `${SITE_URL}/guide/best-tv-stand-for-85-inch-tv` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-tv-stand-for-85-inch-tv#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best TV Stands for 85 Inch TVs</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best TV Stands for 85 Inch TVs" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>An 85 inch TV can weigh 80 to 100+ lbs on its own, well beyond what a generic universal TV stand is rated to hold, and its foot spread often exceeds the width many "large screen" consoles were actually designed around.</p>
          <p>This guide covers six extra-wide TV stands ranked by top weight capacity, console width, and storage layout, from a 129 dollar budget pick up to a 118 inch extra-wide console rated for 270 lbs.</p>
          <p>For a slightly smaller screen, see our <a href='/guide/best-tv-stand-for-75-inch-tv' className='text-brand hover:underline'>best TV stands for 75 inch TVs</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl border border-border bg-white">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-ink-secondary pl-5">See the full rankings above for all six picks with pros, cons, and best-for summaries.</p>
          </div>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=TV+stand+for+85+inch+TV&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
