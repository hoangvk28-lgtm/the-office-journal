...
export const guideTitle = "The Best 8-Channel Video Switchers for a Better Desk Setup";
...
export const metaDescription = "We compared 8 8-channel video switchers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best 8-Channel Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 8-Channel Video Switchers";
