...
export const faq = [
  {
    ...
    "a": "A switch only manages traffic between devices on your local network; your internet speed is set by your ISP plan and router. A switch matters for local file transfers, streaming to multiple devices, or connecting more wired gear than your router has ports for."
  },
  {
...
export const guideTitle = "The Best Network Switches for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  {
    "subheading": "",
    "intro": "Every switch in this list is plug-and-play, but only some offer VLANs or port monitoring if you need to diagnose an issue later.",
    "cards": [
      {
        "label": "",
...
export const metaDescription = "We compared 7 network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Network Switches for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Network Switches";
