...
export const faq = [
  {
    "q": "Does speed matter for photo storage the way it does for video editing?",
    "a": "A photo library is typically written once and read occasionally, so long-term endurance and warranty length matter more than raw transfer speed."
  },
  {
    "q": "Should I keep my only photo backup on one portable SSD?",
    "a": "No, keep at least one additional backup copy of an irreplaceable photo library, whether on a second drive, a cloud service, or both."
  },
  {
    "q": "Do RAW files need more storage planning than JPEGs?",
    "a": "Yes, RAW files carry real capacity overhead compared to compressed JPEGs, plan your storage needs around your actual file format."
  }
];

export const guideSlug = "best-portable-ssds-for-photo-storage";

export const guideTitle = "The Best Portable SSDs for Photo Storage: Picks and Trade-offs";
...
export const howWeEvaluated = [
  {
    "title": "Long-term endurance weighted over raw speed",
    "description": "Prioritized TBW endurance and warranty length as reliability signals more heavily than raw transfer speed, appropriate for a written-once, read-occasionally use pattern."
  },
  {
    "title": "Written-once, read-occasionally use pattern recognized",
    "description": "Distinguished photo archival's usage pattern from video editing's continuous read-write cycling when weighing which specs actually matter."
  },
  {
    "title": "RAW file overhead considered in capacity planning",
    "description": "Factored in that RAW file sizes create real capacity overhead compared to compressed JPEGs when planning realistic library size needs."
  },
  {
    "title": "",
    "description": "Recommended not relying on a single drive for irreplaceable photo libraries regardless of which specific pick a buyer chooses."
  }
];

export const introParagraphs = [
  "Photo archival is different from video editing's continuous read-write cycling, a photo library is typically written once and read occasionally, so long-term reliability and endurance matter more for this use case than raw transfer speed.",
...
export const metaDescription = "A practical comparison of 4 portable SSDs for photo storage, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Portable SSDs for Photo Storage (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "SanDisk's Extreme combines reliable 1050MB/s speed with IP65 water and dust resistance, a sensible balance for photographers who want both durability and dependable long-term storage.\n\nIP65 rating adds real durability for field use. On price, it comes in below Samsung T7 Shield Portable SSD 2TB, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Should not be your only backup copy of irreplaceable photos.",
    "specs": [
      "2TB capacity",
    ...
    "pros": [
      "IP65 rating adds real durability for field use",
      "Large 2TB capacity for extensive photo libraries",
      "Realistic everyday speed ceiling for archival use"
    ],
    "cons": [
      "Speed is not the priority for archival, capacity and endurance matter more",
      "Older model, verify current firmware",
      "Should not be your only backup copy of irreplaceable photos"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Large 2TB capacity suited to growing RAW file libraries",
      "Rugged shell adds real protection for field use",
      "Reliable, well-reviewed platform",
      "Good long-term reliability track record"
    ],
    "cons": [
      "RAW file overhead can fill capacity faster than expected",
  ...
  },
  {
    ...
    "pros": [
      "Slim, lightweight design for everyday photo backup",
      "Reliable, widely reviewed platform with strong warranty support",
      "Good value for moderate photo library sizes",
      "Comes in multiple colors"
    ],
    "cons": [
      "No official IP rating",
      "1TB may be limiting for large RAW file libraries",
      "Should not be your only backup copy of irreplaceable photos"
    ],
  ...
  },
  {
    ...
    "description": "SanDisk's standard Portable SSD offers a low-cost way to maintain a second copy of a photo library, rated up to 800MB/s, more than sufficient for the occasional-read pattern typical of photo archival.\n\nThe real tradeoff against that pick: 800MB/s ceiling would matter more for continuous editing than archival.\n\nOn the other side, 1TB may be limiting for large RAW file libraries.",
    "specs": [
      "1TB capacity",
      "Up to 800MB/s rated",
      "USB-C, USB 3.2 Gen 2",
    ...
    "pros": [
      "low-cost way to maintain a second backup copy",
      "Sufficient speed for occasional-read archival use",
      "Good value per gigabyte for a redundant backup"
    ],
    "cons": [
      "800MB/s ceiling would matter more for continuous editing than archival",
      "No official IP rating",
      "1TB may be limiting for large RAW file libraries"
    ],
...
export const breadcrumbLabel = "Best Portable SSDs for Photo Storage";
