...
export const guideTitle = "The Best Projector Tripods for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 projector tripods, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Projector Tripods for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Projector Tripods";
