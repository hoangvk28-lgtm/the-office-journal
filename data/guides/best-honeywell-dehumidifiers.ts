...
export const guideTitle = "The Best Honeywell Dehumidifiers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "Energy Star Smart Dehumidifier for Home Basements &"
        ],
        [
          "Large or wet space",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Energy Star Smart Dehumidifier for Home Basements &)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "Energy Star Smart Dehumidifier for Home Basements & is worth checking against its specific auto-restart and humidistat spec before assuming any unit handles unattended operation well."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You're covering a large or wet space and want a built-in pump and higher capacity, where 2024 NEW! Honeywell 50-Pint ENERGY STAR Dehumidifier with Built-in PUMP, justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 8 honeywell dehumidifiers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Honeywell Dehumidifiers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Honeywell 50-Pint ENERGY STAR Dehumidifier with Built-in PUMP, is the priciest pick in this lineup. Experience the newly launched tp-fit series, energy-efficient and reliable, now with enhanced features! High-capacity 4000 sqft coverage: protects walls and furniture in moisture-prone areas, ideal for basements, cottages, warehouses, and crawl spaces.\n\nThe gap between this and Honeywell 3000 Sq. Energy Star Smart Dehumidifier for Home Basements & isn't in the essentials, it shows up in efficiently dry damp laundry or set the dehumidifier for discreet operation based on room temperature.\n\nThis one is the right call if you are willing to spend the most in this comparison for the fuller feature set that comes with it. Coverage figures assume ideal AHAM test conditions, not always your actual room's humidity and airflow, so treat the pint rating as a starting point.",
    "specs": [
      "Top-rated upgrade",
      "High-capacity 4000 sqft coverage: protects walls and furniture",
      "New laundry & auto-comfort modes"
    ],
    "pros": [
      "Top-rated upgrade",
      "High-capacity 4000 sqft coverage: protects walls and furniture",
...
export const breadcrumbLabel = "Best Honeywell Dehumidifiers";
