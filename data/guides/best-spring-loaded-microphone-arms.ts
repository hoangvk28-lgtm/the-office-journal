...
export const guideTitle = "The Best Spring-Loaded Microphone Arms for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "InnoGear Microphone Stand Mic Boom Arm for Blue Yeti HyperX QuadCast S SoloCast)",
...
export const metaDescription = "A practical comparison of 8 spring-loaded microphone arms, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Spring-Loaded Microphone Arms for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Of mic stand- in comparison to other versions, this",
      "Angle adjustment-the suspension boom arm stand provides 180°",
      "Material-made of sturdy metal, the mic arm stand"
    ],
    "pros": [
      "Of mic stand- in comparison to other versions, this",
      "Angle adjustment-the suspension boom arm stand provides 180°",
      "Material-made of sturdy metal, the mic arm stand",
      "Portable-the arm stand can be folded to save"
    ],
    "cons": [
      "Requires a desk edge thin enough for the included clamp",
      "Cheaper springs can sag over time with heavier microphones"
...
export const breadcrumbLabel = "Best Spring-Loaded Microphone Arms";
