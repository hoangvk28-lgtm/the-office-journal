...
export const guideTitle = "The Best Small Dehumidifiers for Bedrooms: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 small dehumidifiers for bedrooms, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Small Dehumidifiers for Bedrooms (2026)";
...
export const breadcrumbLabel = "Best Small Dehumidifiers for Bedrooms";
