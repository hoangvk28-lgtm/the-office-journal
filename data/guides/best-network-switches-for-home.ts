...
export const faq = [
  ...
  },
  {
    ...
    "a": "A switch only helps devices connected to it by cable. It can indirectly help WiFi performance if it frees up your router to focus on wireless traffic instead of also switching wired devices."
  }
];

export const guideSlug = "best-network-switches-for-home";

export const guideTitle = "The Best Network Switches for Home Use: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5G ports future-proof for multi-gig NAS or gaming gear."
      }
    ]
  }
];
...
export const metaDescription = "How 7 network switches for home use compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Network Switches for Home Use (2026)";
...
export const breadcrumbLabel = "Best Network Switches for Home Use";
