...
export const guideSlug = "best-ultra-short-throw-projectors";

export const guideTitle = "The Best Ultra Short-Throw Projectors for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "Best Ultra Short-Throw Projectors span budget minis to flagships. That means brightness claims don't predict quality.",
  "This roundup weighs verified brightness and throw distance, given that this is where picks really differ."
];

export const lastUpdated = "2026-08-31";

export const mainKeyword = "projector ultra short throw";

export const metaDescription = "A practical comparison of 8 ultra short-throw projectors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Ultra Short-Throw Projectors for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-ultra-short-throw-projectors-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-ultra-short-throw-projectors-2",
    "rank": 2,
  ...
  {
    "id": "best-ultra-short-throw-projectors-3",
    "rank": 3,
  ...
  {
    "id": "best-ultra-short-throw-projectors-4",
    "rank": 4,
    "badge": "Best Value",
  ...
  {
    "id": "best-ultra-short-throw-projectors-5",
    "rank": 5,
  ...
  {
    "id": "best-ultra-short-throw-projectors-6",
    "rank": 6,
    "badge": "Worth a Look",
  ...
  {
    "id": "best-ultra-short-throw-projectors-7",
    "rank": 7,
  ...
  {
    "id": "best-ultra-short-throw-projectors-8",
    "rank": 8,
...
export const breadcrumbLabel = "Best Ultra Short-Throw Projectors";
