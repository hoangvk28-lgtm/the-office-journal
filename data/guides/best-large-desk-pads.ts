...
export const guideTitle = "The Best Large Desk Pads for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "YSAGi Leather Office Desk Pad Protector)",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "6” justifies the extra cost."
      },
      {
        "label": "",
...
export const introParagraphs = [
  "Best Large Desk Pads aren't as interchangeable as they seem. That means a title alone won't tell you enough.",
...
export const metaDescription = "We compared 8 large desk pads on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Large Desk Pads for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-large-desk-pads-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  },
  {
    ...
    "description": "7in, Pink Floral is a strong alternative worth comparing directly against the top pick. More than just a mouse pad, this pink floral desk accessory helps create a coordinated and stylish workspace. The mouse pads for desk with comfortable lycra surface and material to the pads.\n\nThe desk protector mat is flexible enough to be rolled up for easy transport, a detail worth checking closely before choosing between this and AFIING Large Desk Mat 55\" x 24\".\n\nIt's worth picking this one if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
    "specs": [
      "Aesthetic floral desk decor",
      "35.4 X 15.7 inches",
      "Mouse pads for desk with comfortable lycra surface and material to the pads"
    ],
    "pros": [
      "Aesthetic floral desk decor",
      "35.4 X 15.7 inches",
...
export const breadcrumbLabel = "Best Large Desk Pads";
