...
export const guideTitle = "The Best Floating Shelf Sets for Everyday Desk Work";
...
export const metaDescription = "How 8 floating shelf sets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Floating Shelf Sets for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Floating Shelf Sets";
