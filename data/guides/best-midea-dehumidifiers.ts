...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    specs: ["Midea dehumidifier with drain hose collects 50 pints", "Up to 3x larger water tank allows the midea", "Versatile, no-bucket option provides more flexibility to remove moisture"],
    pros: ["Midea dehumidifier with drain hose collects 50 pints", "Up to 3x larger water tank allows the midea", "Versatile, no-bucket option provides more flexibility to remove moisture", "Midea cube dehumidifiers for home are wi-fi enabled"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
  ...
  },
  {
    ...
    specs: ["3x larger water tank allows the midea cube", "Built-in water pump easily drains vertically or horizontally", "Midea cube is wi-fi enabled and can be controlled"],
    pros: ["3x larger water tank allows the midea cube", "Built-in water pump easily drains vertically or horizontally", "Midea cube is wi-fi enabled and can be controlled", "World's first extendable dehumidifier offers unparalleled flexibility - operates"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
  ...
  },
  {
    ...
    pros: ["1,500 sq", "Model has quiet operation as 47 dba", "Unit is energy star certified and saves 31% energy", "Unit was designed with a clean, sleek look"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You're covering a large or genuinely wet space and want a built-in pump and higher capacity, where Midea Cube 50 Pint Dehumidifier for Basement justifies the extra cost."
      },
      {
        "label": "Save if",
