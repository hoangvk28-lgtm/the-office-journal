export const guideSlug = "best-4-tier-storage-carts";
export const guideTitle = "8 Best 4-Tier Storage Carts in 2026";
export const metaTitle = "Best 4-Tier Storage Carts";
export const metaDescription = "We compared 4 storage cart with wheels models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "4 storage cart with wheels";
export const introParagraphs = [
  "Across best 4-tier storage carts, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is documented weight rating and casters, since these separate real capability from claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-4-tier-storage-carts-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-4-tier-storage-carts-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-4-tier-storage-carts-3",
    rank: 3,
  ...
  {
    id: "best-4-tier-storage-carts-4",
    rank: 4,
  ...
  {
    id: "best-4-tier-storage-carts-5",
    rank: 5,
  ...
  {
    id: "best-4-tier-storage-carts-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-4-tier-storage-carts-7",
    rank: 7,
  ...
  {
    id: "best-4-tier-storage-carts-8",
    rank: 8,
