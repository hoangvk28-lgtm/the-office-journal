...
export const faq = [
  {
    "q": "Are these office booths open-front or fully enclosed?",
    "a": "All verified products in this niche are fully enclosed pods with a door, we did not find any open-front, standing-height booth designs in this research pass."
  },
  {
    "q": "What's the largest group-capacity booth available?",
    "a": "The largest verified listing in this pool states a 5 to 7 person capacity, though exterior dimensions are not disclosed for that specific listing."
  },
  {
    "q": "Do these booths have verified soundproofing test data?",
    "a": "No, none of the listings in this niche publish formal STC or NRC sound test numbers despite using \"soundproof\" and \"acoustic\" in their titles."
  },
  {
    "q": "Is a small single-person booth still a large freight delivery?",
    "a": "Yes, even the smallest single-occupant structures in this pool ship as large freight items requiring delivery scheduling and assembly."
  }
];

export const guideSlug = "best-portable-office-booths";

export const guideTitle = "The Best Portable Office Booths for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to Portable Soundproof Office Pod Booth unless your specific needs call for the pricier pick."
  },
  {
    "subheading": "",
...
export const howWeEvaluated = [
  {
    "title": "Enclosure style verified against \"booth\" terminology",
    "description": "Checked each listing's description for door, wall, and enclosure details, confirming all nine verified products in this niche are fully enclosed rather than open-front."
  },
  {
    "title": "Occupancy claims taken directly from listing titles",
    "description": "Used only the occupancy figures explicitly stated in each product's title or description, not inferred from dimensions alone."
  },
  {
    "title": "Acoustic claims flagged as unverified",
    "description": "Noted that no listing in this niche publishes formal STC or NRC sound test data despite \"soundproof\" and \"acoustic\" language throughout."
  },
  {
    "title": "",
...
export const introParagraphs = [
  "\"Booth\" often implies an open-front, standing-height design in furniture retail, but every verified product in this niche is a fully enclosed pod with a door, not an open-front booth. We're framing this guide around the enclosed products actually available rather than a genuine booth-style category, which doesn't currently exist as an Amazon listing here.",
...
export const mainKeyword = "portable office booths";

export const metaDescription = "How 4 portable office booths compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Portable Office Booths for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "b0f3w1s3st-pod",
    "rank": 1,
    "badge": "Best Fully Enclosed Single-Person Booth",
    ...
    "bestFor": "Buyers wanting a fully enclosed single-occupant structure with disclosed dimensions."
  },
  {
    "id": "b0f62z8cff-pod",
    "rank": 2,
    "badge": "Best 1-2 Person Enclosed Booth",
    ...
    "bestFor": "Buyers wanting occasional second-occupant capacity in a fully enclosed structure."
  },
  {
    "id": "b0drnjws8q-pod",
    "rank": 3,
    "badge": "Best Group-Capacity Enclosed Booth",
    ...
    "bestFor": "Teams needing a 4-6 person fully enclosed meeting structure."
  },
  {
    "id": "b0h4412y7j-pod",
    "rank": 4,
    "badge": "Largest Group-Capacity Enclosed Booth",
    ...
    "bestFor": "Larger teams needing a 5-7 person fully enclosed meeting structure."
  }
];
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-acoustic-office-booths",
    "title": "Best Acoustic Office Booths (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Portable Office Booths";
