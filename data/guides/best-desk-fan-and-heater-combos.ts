...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Takywep Fan & Heater Combo)",
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "2 In 1 heater fan combo",
      "Simple one-knob operation",
      "Quiet operation with adjustable angles"
    ],
    "pros": [
      "2 In 1 heater fan combo",
      "Simple one-knob operation",
  ...
  },
  {
    ...
    "specs": [
      "2 In 1 heater fan",
      "Lifeplus desk heater can tilt up and down at 45 degrees",
      "Easy to control by 1 knob"
    ],
    "pros": [
      "2 In 1 heater fan",
      "Lifeplus desk heater can tilt up and down at 45 degrees",
  ...
  },
  {
    ...
    "description": "Takywep Fan & Heater Combo is a low-cost pick that doesn't skip the essentials. This space heater features 1500w/750w heating modes. The non-rotating blades make it safer for households with children or pets, and it is easy to clean, saving time and effort.\n\nWeighing this against 2 in 1 Fan and Heater Fan Combo, this product complies with us voltage standards ends up being the detail that matters most for most buyers.\n\nChoose this if you want a capable pick without paying for headroom you won't use. USB-powered fans are convenient for a laptop-only desk but cap out at lower airflow than an AC-plugged model, so match the power source to how much cooling you actually need.",
    "specs": [
      "2-Second rapid cooling & heating",
      "2-In-1 mode, cool & warm fan",
      "Small heater is lightweight and portable"
    ],
    "pros": [
      "2-Second rapid cooling & heating",
      "2-In-1 mode, cool & warm fan",
      "Small heater is lightweight and portable",
      "Product complies with us voltage standards"
    ],
    "cons": [
      "USB-powered models cap out at lower airflow than AC-plugged fans",
      "Noise rating usually reflects the lowest speed, not daily use"
  ...
  },
  {
    ...
    "specs": [
      "2-In-1 heater & fan combo",
      "Office fan heater features a wide 45-degree tilt range",
  ...
  },
  {
    ...
    "specs": [
      "Feel the difference right away with this powerful heater",
      "Your ideal temperature is always within reach with this heater fan combo for indoor use",
      "Wide-angle airflow & dual control"
    ],
    "pros": [
      "Feel the difference right away with this powerful heater",
      "Your ideal temperature is always within reach with this heater fan combo for indoor use",
      "Wide-angle airflow & dual control",
      "Safety first - peaceful warmth for your home"
    ],
    "cons": [
      "Noise rating usually reflects the lowest speed, not daily use",
      "USB-powered models cap out at lower airflow than AC-plugged fans"
  ...
  },
  {
    ...
    "specs": [
      "Air circulating & heating dual modes for all year",
      "Circulating air for staying comfortable - do you always",
      "Quick & widespread air circulating - feeling hot when arriving home in summer"
    ],
    "pros": [
      "Air circulating & heating dual modes for all year",
      "Circulating air for staying comfortable - do you always",
      "Quick & widespread air circulating - feeling hot when arriving home in summer",
      "Small size & low noise - is your old fan is too large to handle"
    ],
    "cons": [
      "USB-powered models cap out at lower airflow than AC-plugged fans",
      "Noise rating usually reflects the lowest speed, not daily use"
