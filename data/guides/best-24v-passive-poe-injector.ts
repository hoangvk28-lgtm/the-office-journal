...
export const buyingCriteria = [
  {
    "criterion": "3af/at PoE Cannot Be Substituted for Each Other",
    "explanation": "3af/at PoE performs a detection handshake before delivering power at 48V, and every listing in this comparison explicitly warns that it does not work with 48V standard PoE devices. This matters because connecting a passive 24V injector to a device expecting standard PoE negotiation typically results in no power at all, and in some cases connecting the wrong voltage type can risk damaging sensitive equipment. 3af/at standard PoE before purchasing either type."
  },
  {
  ...
  },
  {
    ...
    "explanation": "3af/at injectors, a 24V passive injector can be limited to 100Mbps or support full Gigabit speeds, and this is a completely separate consideration from the voltage and wattage specs that define the passive PoE category. This matters if your specific device, like a higher-bandwidth access point, benefits from Gigabit throughput, and matters less for a basic 100Mbps camera or radio link that never approaches Gigabit speeds anyway. Check the listing's stated port speed specifically rather than assuming all 24V passive injectors share the same data rate."
  },
  {
    "criterion": "An Explicit Incompatibility Warning in a Listing Is a Genuine Safeguard, Not Just Legal Boilerplate",
    "explanation": "3af PoE devices, which is a meaningfully clearer signal than a listing that simply states its own voltage without addressing what it won't work with. This matters because a passive PoE product category has a real, common failure mode of buyers assuming any PoE injector works with any PoE device, and a listing that proactively addresses this reduces the odds of an incompatible purchase. Treat an explicit incompatibility warning as a positive signal of listing accuracy rather than skipping past it as boilerplate."
  }
];

export const faq = [
  {
    "q": "What's the difference between 24V passive PoE and standard PoE?",
    "a": "3af/at PoE performs a detection handshake at 48V, and the two are not interchangeable."
  },
  {
    "q": "Can I use a 24V passive injector with a standard IP camera?",
    "a": "3af/at PoE at 48V and require a different injector type entirely."
  },
  {
    "q": "How do I know if my Ubiquiti device needs a 24V passive injector?",
    "a": ""
  },
  {
    "q": "Can a 24V passive PoE injector run on solar power?",
    "a": "A standard AC-powered passive injector cannot, but a specifically designed DC-input unit, like the PoE Texas pick in this comparison, accepts a wide voltage range from a solar panel or battery source."
  },
  {
    "q": "Is Gigabit speed available for 24V passive PoE injectors?",
    "a": "Yes, though it's less common than at 100Mbps; the EN15G-24-3 pick in this comparison specifically offers Gigabit speed while keeping the 24V passive power delivery method."
  },
  {
    "q": "What happens if I connect a 24V passive device to a 48V standard PoE injector?",
    "a": "It typically won't power on at all since the voltage and negotiation method don't match, though the specific outcome depends on the device's own input protection circuitry."
  }
];

export const guideSlug = "best-24v-passive-poe-injector";

export const guideTitle = "The Best 24V Passive PoE Injectors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Standard AC outlet, basic device",
          "24volt Passive PoE Injector 24W (Ubiquiti replacement)"
        ],
        [
          "Solar panel or battery, remote install",
          "PoE Texas 24V Passive PoE Injector"
        ],
        [
          "Standard AC outlet, Gigabit device",
          "EN15G-24-3 Gigabit PoE Injector 24V 15W"
        ],
        [
          "Lowest cost basic Ubiquiti replacement",
          "24volt Passive PoE Injector Adapter 100Mbps"
        ]
      ]
    }
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "EN15G-24-3 or PoE Texas (both under $20)"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "Passive PoE (this entire comparison)",
        "text": "3af/at devices or vice versa."
      },
      {
        "label": "",
        "text": "Negotiates power with the connected device automatically, common on modern IP cameras, VoIP phones, and newer access points; see our best-poe-injector guide for that category."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "24volt Passive PoE Injector 24W or the budget replacement pick"
        ],
        [
          "Gigabit device, standard AC power",
          ""
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "An injector that explicitly accepts a wide DC input range rather than requiring standard AC power, since remote and solar installations often have variable voltage from a battery or panel."
      },
      {
        "label": "",
        "text": "The PoE Texas pick specifically accepts a 12-60V DC input range and names solar CCTV and RV solar setups as intended use cases."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You're powering a remote solar or DC-based installation, or need Gigabit speed, where the PoE Texas or EN15G-24-3 picks near $20 justify their price with genuine capability differences."
      },
      {
        "label": "",
        "text": "98 budget pick covers that need reliably."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Passive vs Standard PoE Verification",
    "description": ""
  },
  {
    "title": "",
    "description": "Compared listings naming specific compatible brands and part numbers against generic claims."
  },
  {
    "title": "",
    "description": "Compared Gigabit versus 100Mbps port speeds across the 24V passive tier."
  },
  {
    "title": "",
    "description": "Compared standard AC-powered units against DC-input units built for solar or battery power."
  },
  {
    "title": "",
    "description": "Compared how clearly each listing warns against use with incompatible 48V standard PoE devices."
  }
];

export const introParagraphs = [
  "3af/at/bt standards most PoE equipment uses, and it explicitly will not work with standard 48V PoE devices.",
  ""
];
...
export const metaDescription = "How 4 24V passive PoE injectors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 24V Passive PoE Injectors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07DMZ17VB?tag=theofficejournal-20",
    ...
    "specs": [
      "24V 24W 1A, always-on passive PoE",
      "Named compatibility: Ubiquiti, Mikrotik, Tranzeo, Aircam",
      "Up to 328ft over Cat5/5e/6/7"
    ],
    "pros": [
      "Explicit multi-brand compatibility list beyond just Ubiquiti",
      "Clear warning against use with 48V devices prevents a real mismatch",
      "Long 328ft transmission distance"
    ],
    "cons": [
      "100Mbps only, not Gigabit",
      "Does not work with standard 802.3af/at PoE devices"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CBR1ML12?tag=theofficejournal-20",
    ...
    "specs": [
      "24V 15W, Gigabit input/output",
      "Over voltage, over current, short circuit protection",
      "Up to 328ft (100m) range"
    ],
    "pros": [
      "Only standard AC-powered pick with Gigabit speed",
      "Multiple stated electrical protections",
      "Simple plug and play installation"
    ],
    "cons": [
      "Lower 15W power budget than the 24W and 30W picks",
      "No named brand compatibility list unlike the top pick"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B00NRGR7DC?tag=theofficejournal-20",
    "description": "This injector's listing specifically states it's a direct replacement for the Ubiquiti POE-25-5W, POE-24-12W, and POE-24-24W passive adapters at the lowest price in this comparison. 3af/at PoE devices helps prevent a real compatibility mismatch before purchase.\n\nCompared to the pricier picks above, this one delivers the same core 24V 24W passive PoE function for a basic single Ubiquiti or compatible device at the lowest cost in this comparison.\n\nBest for buyers who need a low-cost direct replacement for an original Ubiquiti 24V passive PoE adapter.",
    "specs": [
      "24V 24W, 100Mbps passive PoE",
      "Named Ubiquiti replacement: POE-25-5W, POE-24-12W, POE-24-24W",
      "Explicit 48V incompatibility warning"
    ],
    "pros": [
      "Lowest price in this comparison",
      "Named Ubiquiti part number replacement for easy matching",
      "Clear compatibility warning avoids a real device mismatch"
    ],
    "cons": [
      "100Mbps only, not Gigabit",
      "No stated electrical protection features"
    ],
...
export const breadcrumbLabel = "Best 24V Passive PoE Injectors";
