...
export const guideTitle = "The Best Restaurant Label Printers for a Better Desk Setup";
...
export const metaDescription = "We compared 6 restaurant label printers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Restaurant Label Printers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Restaurant Label Printers";
