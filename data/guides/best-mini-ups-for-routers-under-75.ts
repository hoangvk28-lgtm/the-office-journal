...
export const guideTitle = "The Best Mini UPS for Routers Under $75, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "5mm 9V1A 12V1A Portable unless your specific use case points toward Eujgoov 20800mAh Mini UPS Battery Backup Power Supply with DC Output's particular tradeoffs."
  },
  {
    "subheading": "",
    "table": {
...
export const metaDescription = "We compared 6 mini UPS for routers under $75 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Mini UPS for Routers Under $75 (2026)";
...
export const breadcrumbLabel = "Best Mini UPS for Routers Under $75";
