...
export const faq = [
  {
    "q": "Does a 'heavy-duty' label guarantee a mount actually holds its rated weight?",
    "a": "Not automatically, verify the specific disclosed weight figure and check for buyer feedback near that limit rather than trusting the label alone."
  },
  {
    "q": "Can a heavy-duty PC mount damage my desk?",
    "a": "It's possible if your desk isn't structurally rated for the combined load, a heavy-duty mount's anchor points transfer weight directly into the desk, so check your desk's own capacity too."
  },
  {
    "q": "How much does a fully loaded modern gaming tower actually weigh?",
    "a": "Often more than a generic mid-tower assumption suggests, factor in multiple drives, a discrete GPU, extra cooling hardware, and a full-size power supply when checking capacity."
  },
  {
    "q": "Does a mount with multiple anchor points hold weight better than a single clamp?",
    "a": "Generally yes, multiple anchor points distribute load more reliably and indicate a more reinforced design than a single-point mechanism with a similarly high advertised rating."
  }
];

export const guideSlug = "best-heavy-duty-under-desk-pc-mounts";

export const guideTitle = "The Best Heavy-Duty Under-Desk PC Mounts for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Most buyers with a standard mid-tower should default to VIVO Heavy Duty Adjustable Under unless their case is heavier than average."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "Disclosed capacity weighed against verified buyer feedback near that limit",
    "description": "Weighed each mount's quoted maximum weight against available buyer feedback, rather than trusting a spec-sheet number at face value alone."
  },
  {
    "title": "Desk structural capacity considered alongside mount rating",
    "description": "Considered that heavy-duty mounting hardware also stresses the desk itself through its anchor points, not just the mount, worth checking your desk's own rated capacity too."
  },
  {
    "title": "Realistic large modern tower weight used, not generic mid-tower",
    "description": "Evaluated capacity against large modern towers, multiple drives, a discrete GPU, extra cooling, and a full-size power supply, not the generic mid-tower assumption."
  },
  {
    "title": "Anchor-point design checked for genuine reinforcement",
    "description": "Checked for multiple-anchor-point designs as a signal of genuine reinforcement, distinct from a single-point mechanism simply carrying a higher advertised number."
  }
];
...
export const introParagraphs = [
  ...
  "This tier should specifically account for large modern towers, multiple drives, a discrete GPU, extra cooling hardware, and a full-size power supply, rather than the generic mid-tower assumption most budget mounts are rated against, and multiple-anchor-point designs generally indicate a more reinforced mount than a single-point mechanism carrying a similarly high advertised rating."
];
...
export const metaDescription = "We compared 4 heavy-duty under-desk PC mounts on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Heavy-Duty Under-Desk PC Mounts for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "It leads this comparison on the strength of its balance between price and disclosed capacity, and it's worth weighing directly against the VIVO Heavy Duty Adjustable Under before deciding.",
    "specs": [
      "Max 66 lbs capacity",
      "Height adjustable",
    ...
    "pros": [
      ...
      "66lb capacity suits a loaded modern tower",
      "Height adjustable for varied case sizes",
      "Compact footprint despite the high rating"
    ],
    "cons": [
      "Verify your desk's own structural capacity, not just the mount's rating",
      "Check anchor points for genuine reinforcement versus a single clamp"
    ],
    "bestFor": "Buyers wanting the strongest-rated heavy-duty mount for a loaded tower"
  },
  {
    ...
    "pros": [
      ...
      "Disclosed 66lb capacity appropriate for a loaded modern tower",
      "Adjustable fit for varied case sizes"
    ],
    "cons": [
      "Higher price than the most basic heavy-duty picks",
      "Verify your desk's own structural capacity alongside the mount rating",
      "Locking mechanism adds a small extra installation step"
    ],
  ...
  },
  {
    ...
    "description": "\\n\\nAt this weight class, double-check your desk's own structural rating specifically, a heavy tower stresses the desk itself through the mount's anchor points, not just the mount hardware.\n\nRelative to the VIVO Heavy Duty Adjustable Under, this pick leans toward a different priority, whether that's a higher capacity rating, a lower price, or a mounting method suited to a different install situation.\n\nOn the other side, At this weight class, your desk's own structural capacity matters as much as the mount's rating.",
    "specs": [
    ...
    "pros": [
      "Highest disclosed capacity of any pick in this guide",
      "Adjustable fit for varied case widths",
      "Reasonable price for the stated capacity"
    ],
    "cons": [
      "At this weight class, your desk's own structural capacity matters as much as the mount's rating",
      "Verify anchor-point count for genuine reinforcement",
  ...
  },
  {
    ...
    "specs": [
      ...
      "Lowest price in this weight class",
      "Full/mid-tower compatible"
    ],
    "pros": [
      "High 77lb disclosed capacity at the lowest price in this guide",
      "Vertical or horizontal orientation flexibility",
      "Solid rating for the price point",
      "Fits full and mid-tower cases"
    ],
    "cons": [
      "Verify your desk's structural capacity given the high rated load",
...
export const breadcrumbLabel = "Best Heavy-Duty Under-Desk PC Mounts";
