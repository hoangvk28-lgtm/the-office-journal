...
export const guideTitle = "The Best Wall-Mount Network Switches for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 wall-mount network switches, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Wall-Mount Network Switches for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-quiet-network-switches",
    "title": "8 Best Quiet Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best Wall-Mount Network Switches";
