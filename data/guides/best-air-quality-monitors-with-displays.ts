...
export const guideTitle = "The Best Air Quality Monitors With Displays: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 air quality monitors with displays, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Air Quality Monitors With Displays (2026)";
...
export const breadcrumbLabel = "Best Air Quality Monitors With Displays";
