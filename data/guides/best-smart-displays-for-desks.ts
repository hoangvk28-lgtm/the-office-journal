...
export const faq = [
  {
    "q": "What size smart display fits a standard desk best?",
    "a": "The compact Echo Show 5 or the 7 inch Nest Hub both fit comfortably beside a keyboard without blocking a monitor. Larger 10 and 15 inch models need more spare desk space."
  },
  {
    "q": "Do all smart displays for desks have a camera?",
    "a": "Every Echo Show model here includes a camera, while the Google Nest Hub has none at all, a meaningful difference for privacy-conscious desk placement."
  },
  {
    "q": "Is Alexa or Google Assistant better for a desk display?",
    "a": "Neither is universally better, choose based on which ecosystem you already use for calendars, reminders, and smart home devices to avoid unnecessary friction."
  }
];

export const guideSlug = "best-smart-displays-for-desks";

export const guideTitle = "The Best Smart Displays for Desks, Compared";
...
export const howWeEvaluated = [
  {
    "title": "Desk footprint weighed against screen size",
    "description": "Prioritized how comfortably each display sits on a standard desk without blocking a monitor or keyboard, not just raw screen size on paper."
  },
  {
    "title": "Camera presence and privacy verified per model",
    "description": "Checked which models include a built-in camera and which do not, since this materially affects where someone may want to place a display near their workspace."
  },
  {
    "title": "Voice assistant ecosystem noted honestly",
    "description": "Distinguished between Alexa-based Echo Show models and Google Assistant-based Nest Hub, since switching ecosystems affects calendar and smart home integration."
  },
  {
    "title": "Only verified, price-and-image-confirmed models included",
    "description": "Limited this guide to models with confirmed pricing or imagery from our research pass rather than including unverified listings to inflate the count."
  }
];
...
export const introParagraphs = [
  ...
  "5 inch Echo Show up to the motorized 10 inch Echo Show 10. We were only able to verify pricing and imagery for five genuine desk-appropriate models this pass, and we say so rather than pad the list with unconfirmed products."
];
...
export const metaDescription = "We compared 5 smart displays for desks on compatibility, build, features and price to help you choose the right one for your space.";
...
export const relatedGuides = [
  {
    "href": "/guide/best-smart-displays-for-home-offices",
    "title": "Best Smart Displays for Home Offices (2026)"
  },
  {
    "href": "/guide/best-small-smart-displays-for-desks",
    "title": "Best Small Smart Displays for Desks (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Smart Displays for Desks";
