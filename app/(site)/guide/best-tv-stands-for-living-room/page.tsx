...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-tv-stands-for-living-room";
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-tv-stands-for-living-room` },
    about: [{"@type":"Thing","name":"TV Stand"},{"@type":"Thing","name":"Living Room Furniture"},{"@type":"Thing","name":"Entertainment Center"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best TV Stands for Living Room", item: `${SITE_URL}/guide/best-tv-stands-for-living-room` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-tv-stands-for-living-room#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best TV Stands for Living Room</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best TV Stands for Living Room" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A good living room TV stand does more than hold your screen. Its height, width, and storage layout need to match your sofa's seated eye line and the overall scale of the room, not just the TV's diagonal size.</p>
          <p>This guide covers seven living room TV stands ranked by stand height relative to seated eye level, storage layout, and TV fit, from a budget-friendly console under $60 to furniture-grade farmhouse and mid-century picks.</p>
          <p>If your TV is specifically 55 inches, see our <a href='/guide/best-tv-stand-for-55-inch-tv' className='text-brand hover:underline'>best TV stands for 55 inch TVs</a> guide for size-specific picks.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=tv+stand+for+living+room&tag=theofficejournal-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
