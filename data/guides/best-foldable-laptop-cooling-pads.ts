...
export const faq = [
  {
    ...
    "a": "We checked every cooling pad in our research pool for a genuine folding-hinge mechanism and found only one product whose listing explicitly confirms it. We'd rather report that honestly than pad the list with height-adjustable pads mislabeled as foldable."
  },
  {
    "q": "Does the foldable pick have a fan?",
    "a": "No, it's a passive metal riser that cools through elevation and open ventilation, not active airflow. If you specifically need fan-based cooling, see our portable cooling pads guide instead."
  },
  {
    "q": "What's the difference between foldable and height-adjustable?",
    "a": "A foldable product collapses into a meaningfully flatter shape for storage. Height-adjustable legs, common on most cooling pads, only change the elevation angle without folding flat."
  },
  {
    "q": "Is a foldable stand as good as an active cooling pad?",
    "a": "It provides a more modest cooling benefit since there's no fan. It's a reasonable choice for light use and travel convenience, not for sustained heavy workloads."
  },
  {
    "q": "Should I search for something else if I want active cooling that also folds?",
    "a": "Based on our research, that combination doesn't currently exist as a clearly labeled product. Choose either a genuine fold mechanism with passive cooling, or an active fan pad from our portable guide without a true fold hinge."
  }
];

export const guideSlug = "best-foldable-laptop-cooling-pads";

export const guideTitle = "The Best Foldable Laptop Cooling Pads in 2026 (Honest Category Guide): Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "24: Explicitly and foldable per its own listing. If that's what you're after, the tradeoffs in its cons list probably won't bother you either."
      },
      {
        "label": "",
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We checked every product's real feature list for an explicit fold claim, and found only one product confirming a folding design."
  },
  {
    "title": "",
    "description": "We distinguished genuine folding-hinge stands from height-adjustable pads that merely collapse their legs, a meaningfully different mechanism."
  },
  {
    "title": "",
    "description": "We were explicit that the one genuine match is a passive, fan-free stand, not an active-cooling pad, since buyers searching for a cooling pad may expect a fan."
  },
  {
    "title": "",
    "description": "We set honest expectations about the modest cooling benefit of a fanless, elevation-only design compared to an active fan pad."
  }
];
...
export const metaDescription = "A practical comparison of 1 foldable laptop cooling pads in 2026 (honest category guide), focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Foldable Laptop Cooling Pads in 2026 (Honest Category Guide) (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "Explicitly and foldable per its own listing",
      "Compact for backpack storage when folded",
      "High weight capacity",
      "Anti-skid protection"
    ],
    "cons": [
      "No fan, purely passive elevation cooling",
      "Compatible up to 15.6 inches only",
      "Cooling benefit is more modest than an active fan pad"
    ],
    "bestFor": "Buyers who want a folding laptop stand and are comfortable with passive, fan-free cooling."
  }
];
...
export const breadcrumbLabel = "Best Foldable Laptop Cooling Pads in 2026 (Honest Category Guide)";
