...
export const guideTitle = "The Best VOC / TVOC Air Quality Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 8 VOC / TVOC air quality monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best VOC / TVOC Air Quality Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best VOC / TVOC Air Quality Monitors";
