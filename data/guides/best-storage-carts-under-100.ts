export const guideSlug = "best-storage-carts-under-100";
export const guideTitle = "8 Best Storage Carts Under $100 in 2026";
export const metaTitle = "Best Storage Carts Under $100";
export const metaDescription = "We compared storage cart under $100 models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "storage cart under $100";
export const introParagraphs = [
  "Best Storage Carts Under $100 span budget to heavy-duty designs, which is exactly why floor type changes what you need.",
...
export const products: GuideProduct[] = [
  {
    id: "best-storage-carts-under-100-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-storage-carts-under-100-2",
    rank: 2,
    badge: "Best Value",
  ...
  {
    id: "best-storage-carts-under-100-3",
    rank: 3,
  ...
  {
    id: "best-storage-carts-under-100-4",
    rank: 4,
  ...
  {
    id: "best-storage-carts-under-100-5",
    rank: 5,
  ...
  {
    id: "best-storage-carts-under-100-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-storage-carts-under-100-7",
    rank: 7,
  ...
  {
    id: "best-storage-carts-under-100-8",
    rank: 8,
