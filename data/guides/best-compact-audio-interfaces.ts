...
export const guideTitle = "The Best Compact Audio Interfaces for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 compact audio interfaces, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Compact Audio Interfaces for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Compact Audio Interfaces";
