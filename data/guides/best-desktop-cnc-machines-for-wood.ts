...
export const buyingCriteria = [
  {
    ...
    "explanation": "Check desktop cnc machines for wood's usable Z-height and cutting area after the spoilboard and clamps are installed, not the nominal axis travel alone."
  },
  {
...
export const faq = [
  {
    "q": "Do I need a separate dust collector for desktop cnc machines for wood?",
...
export const guideTitle = "The Best Desktop CNC Machines for Wood: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Check desktop cnc machines for wood's usable Z-height and cutting area after the spoilboard and clamps are installed, not the nominal axis travel alone."
  },
  {
...
export const introParagraphs = [
  "The real test for desktop cnc machines for wood comes down to checking work area, dust control, and spindle ecosystem for wood-specific routing, not a glance at the listing photo.",
  "Rather than trust manufacturer claims, we checked documented rigidity and spindle evidence plus checking work area, dust control, and spindle ecosystem for wood-specific routing for every machine on this list."
];
...
export const metaDescription = "How 8 desktop CNC machines for wood compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Desktop CNC Machines for Wood (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-desktop-cnc-machines-for-wood-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-desktop-cnc-machines-for-wood-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-desktop-cnc-machines-for-wood-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-desktop-cnc-machines-for-wood-4",
    "rank": 4,
  ...
  {
    "id": "best-desktop-cnc-machines-for-wood-5",
    "rank": 5,
  ...
  {
    "id": "best-desktop-cnc-machines-for-wood-6",
    "rank": 6,
    "badge": "Solid Option",
  ...
  {
    "id": "best-desktop-cnc-machines-for-wood-7",
    "rank": 7,
    "badge": "Another Pick",
  ...
  {
    "id": "best-desktop-cnc-machines-for-wood-8",
    "rank": 8,
    "badge": "Budget Pick",
    ...
    "rating": null,
    "reviews": null,
    "imageUrl": "https://m.media-amazon.com/images/I/41KZgGMOj6L._SL500_.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B07T6DPRQW?tag=theofficejournal-20",
    "description": "The aluminum alloy frame and stainless steel screw rods keep it durable despite the compact size.\n\nThe updated GRBL control board adds emergency stop and X/Y/Z limit switch support plus a silent cooling fan, and the board automatically identifies the offline controller. It's rated for wood, plastic, acrylic, PVC, PCB, carbon fiber, and soft metals like copper and aluminum, explicitly not for glass, hard metal, or jade.",
    "specs": [
      "18 x 10 x 4.5cm work area",
      "775 spindle, up to 10,000 RPM at 24V",
      "E-stop + XYZ limit switches"
    ],
    "pros": [
      "Compact enough for a tight desk footprint",
      "E-stop and limit switches ship standard on this budget tier",
      "Silent cooling fan keeps noise down during operation"
    ],
    "cons": [
      "18 x 10cm work area is the smallest in this cluster",
      "Not rated for glass, hard metal, or jade"
    ],
    "bestFor": "buyers prioritizing 18 x 10 x 4.5cm work area"
  }
];
...
export const relatedGuides = [
  {
    "href": "/guide/best-wood-router-desktop-cnc-machines",
    "title": "Best Wood Router Desktop CNC Machines in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Desktop CNC Machines for Wood";
