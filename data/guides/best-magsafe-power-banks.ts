...
export const guideTitle = "The Best MagSafe Power Banks for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Podoru for MagSafe Power Bank 10000 mAh)",
...
export const metaDescription = "A practical comparison of 8 MagSafe power banks, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best MagSafe Power Banks for Home Offices (2026)";
...
export const breadcrumbLabel = "Best MagSafe Power Banks";
