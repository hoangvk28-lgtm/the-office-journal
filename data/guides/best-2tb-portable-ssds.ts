...
export const faq = [
  {
    "q": "How much usable space will a 2TB drive really show?",
    "a": "8TB after formatting overhead and decimal-to-binary conversion, not a full 2000GB."
  },
  {
    "q": "Are 2TB drives more likely to be counterfeit?",
    "a": "Higher-capacity drives are a more common target for fake-capacity firmware scams, buy from verified sellers and check the formatted capacity immediately."
  },
  {
    "q": "Do I need Thunderbolt for a 2TB drive?",
    "a": "Only if you want to approach the fastest rated speeds. 2 Gen 2 drive is sufficient for most game and media library use."
  }
];

export const guideSlug = "best-2tb-portable-ssds";

export const guideTitle = "The Best 2TB Portable SSDs for a Cleaner, More Useful Desk";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Confirmed each pick is rated 2TB by the manufacturer, not padded from a smaller actual capacity."
  },
  {
    "title": "Cache exhaustion point at this capacity",
    "description": "Weighted how a larger 2TB cache generally delays the sustained-speed cliff compared to smaller-capacity siblings."
  },
  {
    "title": "Real usable space after formatting",
    "description": "Accounted for the roughly 7 percent formatting overhead expected on a genuine 2TB drive."
  },
  {
    "title": "",
    "description": "Weighted seller verification and review consistency more heavily at this higher capacity tier, where fake-capacity firmware is a more common risk."
  }
];

export const introParagraphs = [
  "8TB of real usable space rather than a full 2000GB.",
...
export const metaDescription = "A practical comparison of 4 2TB portable SSDs, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 2TB Portable SSDs for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "0, purpose-marketed for console game libraries but equally usable for general media storage.\n\nGenuine 2TB capacity at a reasonable price. On price, it comes in below Samsung T7 Shield Portable SSD 2TB, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Best for capacity-first buyers, not speed-first.",
    "specs": [
      "2TB capacity",
      "USB 3.0",
    ...
    "pros": [
      "Genuine 2TB capacity at a reasonable price",
      "Simple plug-and-play setup",
      "Good fit for large game or media libraries"
    ],
    "cons": [
      "USB 3.0 caps speed below newer USB 3.2 Gen 2 drives",
      "Bulkier design than slim ultraportables",
      "Best for capacity-first buyers, not speed-first"
    ],
  ...
  },
  {
    ...
    "description": "On the other side, Usable space will read below the advertised 2TB.",
    "specs": [
      "2TB capacity",
    ...
    "pros": [
      "Genuine 2TB with rugged everyday protection",
      "Larger cache than the 1TB model delays the speed cliff",
      "Reliable, well-reviewed platform",
      "Realistic USB 3.2 Gen 2 speed ceiling"
    ],
    "cons": [
      "Premium price versus USB 3.0 alternatives",
      "Bulkier than a non-shielded drive",
      "Usable space will read below the advertised 2TB"
    ],
  ...
  },
  {
    ...
    "specs": [
      ...
      "MagSafe compatible, includes 40Gbps cable"
    ],
    "pros": [
      "Genuine high-speed USB4 bridge for a large capacity drive",
      "MagSafe compatibility adds real convenience for iPhone use",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Balanced price for genuine 2TB capacity",
      "Broad USB-C and USB-A compatibility"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best 2TB Portable SSDs";
