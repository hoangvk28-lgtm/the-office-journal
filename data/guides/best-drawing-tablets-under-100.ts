...
export const buyingCriteria = [
  {
    "criterion": "",
    "explanation": "Verify drawing tablets under $100's current price and include any required adapters or stand in the total cost before calling it a deal."
  },
  {
...
export const faq = [
  {
    "q": "Are budget drawing tablets under $100 usable, or do they cut corners that matter?",
...
export const guideTitle = "The Best Drawing Tablets Under $100: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "",
    "note": "Verify drawing tablets under $100's current price and include any required adapters or stand in the total cost before calling it a deal."
  },
  {
...
export const introParagraphs = [
  "Best Drawing Tablets Under $100 deserves architecture-specific scrutiny before ranking, since this category comes down to prioritizing line quality and driver stability over a high pressure-level number.",
...
export const metaDescription = "A practical comparison of 7 drawing tablets under $100, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Drawing Tablets Under $100 (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-drawing-tablets-under-100-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-drawing-tablets-under-100-2",
    "rank": 2,
    "badge": "Runner-Up",
  ...
  {
    "id": "best-drawing-tablets-under-100-3",
    "rank": 3,
    "badge": "Also Great",
  ...
  {
    "id": "best-drawing-tablets-under-100-4",
    "rank": 4,
  ...
  {
    "id": "best-drawing-tablets-under-100-5",
    "rank": 5,
  ...
  {
    "id": "best-drawing-tablets-under-100-6",
    "rank": 6,
    "badge": "Solid Option",
  ...
  {
    "id": "best-drawing-tablets-under-100-7",
    "rank": 7,
    "badge": "Budget Pick",
...
export const breadcrumbLabel = "Best Drawing Tablets Under $100";
