...
export const faq = [
  {
    "q": "What's the real floor space an office chair takes up in a small room?",
    "a": "It's set by the base diameter, not the seat width. Seat width usually runs 18 to 20 inches, but the 5-star swivel base underneath typically spans 24 to 28 inches, and that's the dimension that determines whether the chair actually fits and can swivel freely in your space."
  },
  {
    "q": "Is an armless chair a good idea for a small desk?",
    "a": "It trims several inches of width and helps the chair tuck fully under a desk, but removes shoulder and forearm support. It's a reasonable trade-off for sessions under about two hours. For longer daily use, the strain from missing arm support tends to outweigh the space savings."
  },
  {
    "q": "Why won't my chair's armrests fit under my desk?",
    "a": "Fixed armrests can be as high as the desk's apron clearance, some desks as low as 24 inches from the floor to the underside. If your desk sits low, look for chairs with flip-up or removable arms so you can tuck the chair fully underneath when not in use."
  },
  {
    "q": "How much room does a reclining chair need behind it?",
    "a": "A 20 to 30 degree recline can add 10 to 15 inches of depth behind the chair. Measure the distance from your chair's upright position to the nearest wall before assuming you'll have room to recline without hitting it."
  },
  {
    "q": "Do cheaper compact chairs wear out faster?",
    "a": "Sub-$150 compact mesh chairs commonly show wear within 2 to 3 years of regular use, while more reinforced frames at a similar footprint tend to last considerably longer. If you're keeping the chair for years, factor that into the price comparison."
  }
];

export const guideSlug = "best-office-chairs-for-small-spaces";

export const guideTitle = "The Best Office Chairs for Small Spaces, Compared";

export const heroImage = "/images/guides/best-office-chairs-for-small-spaces/hero.webp";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to Sweetcrispy Home Office Managerial Chair unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We prioritized standard 5-star bases in the 24 to 26 in range and flagged any chair whose armrests meaningfully widened the effective footprint."
  },
  {
    "title": "",
    "description": "Flip-up armrest designs were compared against typical low desk apron heights to flag under-desk tuck issues."
  },
  {
    "title": "",
    "description": "Chairs were assessed on whether their support (lumbar, arms, headrest) suits short study sessions or longer workdays."
  },
  {
    "title": "",
    "description": "Frame material and weight capacity were weighed against price tier to separate short-term dorm chairs from longer-lifespan picks."
  },
  {
    "title": "",
    "description": ""
...
export const metaDescription = "We compared 8 office chairs for small spaces on seat height, adjustment, support and warranty to help you choose the right one for your space.";

export const metaTitle = "Best Office Chairs for Small Spaces (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "imageUrl": "/images/guides/best-office-chairs-for-small-spaces/bestoffice-mid-back.jpg",
    ...
    "pros": [
      "Very small base footprint for the price",
      "Huge verified review count",
    ...
    "cons": [
      ...
      "Fixed, non-flip arms",
      "Basic sponge seat may compress over time"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-office-chairs-for-small-spaces/furmax-mid-back.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B07B7K7N3P?tag=theofficejournal-20",
    ...
    "pros": [
      "Extremely high verified review count",
      "Compact standard base",
      "Breathable mesh back",
      "Budget price"
    ],
    "cons": [
      "Fixed arms can hit low desk aprons",
      "Fixed, non-adjustable lumbar",
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-office-chairs-for-small-spaces/sweetcrispy-managerial.jpg",
    ...
    "pros": [
      ...
      "Compact standard base",
      "Good for study nooks and bedrooms",
      "Affordable"
    ],
    "cons": [
      "Best suited to shorter sitting sessions",
      "Fixed arms increase under-desk footprint"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-office-chairs-for-small-spaces/neo-chair-cushion-seat.jpg",
    ...
    "pros": [
      "Narrower footprint without armrests",
      "Adjustable lumbar support",
      "Rolling casters",
      "Budget price"
    ],
    "cons": [
      "No arm support increases strain on longer sessions",
      "Best for under 2 hours of continuous use",
      "Basic cushion seat"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-office-chairs-for-small-spaces/neo-chair-high-back-flip.jpg",
    ...
    "pros": [
      "Flip-up arms solve low-desk clearance",
      "Adjustable lumbar and height",
      "Compact standard base",
      "Rolling casters"
    ],
    "cons": [
      "Taller profile than mid-back chairs",
      "Costs more than the budget mid-back options",
      "Flip mechanism is plastic, not metal"
    ],
  ...
  },
  {
    ...
    "reviews": "Amazon verified ratings",
    "imageUrl": "/images/guides/best-office-chairs-for-small-spaces/tralt-adjustable-lumbar.jpg",
    "amazonUrl": "https://www.amazon.com/dp/B0CQD3K8PJ?tag=theofficejournal-20",
    "description": "TRALT's executive-style mesh chair steps up in price but adds an adjustable lumbar support rather than a fixed contour, which matters for longer sessions in a small home office. It keeps a standard swivel base so the footprint stays in line with the other picks here.\n\nThe recline mechanism on this chair adds 10 to 15 inches of depth behind the chair at a 20 to 30 degree recline, which is worth checking against wall distance in a small room before reclining fully back.",
    "specs": [
      "Mesh executive style",
      "Adjustable lumbar",
      "Standard base",
      "Recline mechanism"
    ],
    "pros": [
      "adjustable lumbar support",
      "Solid review count",
      "Standard compact base",
      "Comfortable for longer sessions"
    ],
    "cons": [
      "Reclining can hit a nearby wall in tight rooms",
  ...
  },
  {
    ...
    "pros": [
      "Reinforced frame for longer service life",
      "Compact standard base",
      "Higher weight capacity",
      "Strong review count"
    ],
    "cons": [
      "Priced above most compact chairs here",
      "Not ideal for short-term use",
      "Bulkier frame than budget picks"
    ],
  ...
  },
  {
    ...
    "imageUrl": "/images/guides/best-office-chairs-for-small-spaces/marsail-headrest.jpg",
    ...
    "pros": [
      "Headrest support not common at this price",
      "3D adjustable armrests",
      "Compact standard base"
    ],
    "cons": [
      "No review history yet to confirm durability",
      "Higher price without proven track record",
      "Taller profile needs overhead clearance"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-office-chair-for-short-people",
    "title": "Best Office Chairs for Short People (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Office Chairs for Small Spaces";
