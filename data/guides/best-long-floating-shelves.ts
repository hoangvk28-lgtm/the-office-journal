...
export const guideTitle = "The Best Long Floating Shelves for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "RICHFOCUS 72Inch Floating Shelves for Wall 2 Pack Shelves)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "7in already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "We compared 7 long floating shelves on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Long Floating Shelves for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "well suited solution for your walls",
      "Longer & wider & stronger",
      "Versatile & functional & classic"
    ],
    "pros": [
      "well suited solution for your walls",
      "Longer & wider & stronger",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Strong load capacity",
      "Space-saving design",
      "Protection sealing and warp prevention"
    ],
    "cons": [
      "Drywall anchors alone only safely hold up to 20 to 25 lbs",
      "Real weight capacity depends on stud spacing, not the shelf itself"
  ...
  },
  {
    ...
    "description": "2Inch) is a strong alternative worth comparing directly against the top pick. Elegantly designed rustic brown woodgrain wall-mounted shelf: this wall-mounted shelf combines modern design and robust construction, seamlessly blending into any space. 8 cm), this sturdy floating shelf provides ample space for displaying decorative items or organizing lighter essentials.\n\n5in is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    "specs": [
      "Elegantly designed rustic brown woodgrain wall-mounted shelf: this wall-mounted shelf combines modern design and robust construction",
      "Generous storage space",
      "Simple, effortless installation with sturdy brackets"
    ],
    "pros": [
      "Elegantly designed rustic brown woodgrain wall-mounted shelf: this wall-mounted shelf combines modern design and robust construction",
      "Generous storage space",
...
export const breadcrumbLabel = "Best Long Floating Shelves";
