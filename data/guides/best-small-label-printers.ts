...
export const guideTitle = "The Best Small Label Printers for a Better Desk Setup";
...
export const metaDescription = "We compared 6 small label printers on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Small Label Printers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Small Label Printers";
