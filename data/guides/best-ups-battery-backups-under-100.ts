...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "The CyberPower SL700U packs its 700VA capacity, the highest in this comparison, into a slim profile design specifically suited to tighter spaces like a home office desk or entertainment center shelf, a harder engineering balance to achieve than a bulkier tower-style UPS with the same capacity. This matters if your available installation space is limited, since a higher-capacity UPS in a bulky form factor may simply not fit where you need it. Check whether a listing specifically addresses both capacity and physical footprint together if space constraints are a real factor in your decision."
  }
];

export const faq = [
  {
    "q": "Does the APC BE600M1's USB port really keep charging my phone during a power outage?",
    "a": "5A USB port works during outages, drawing from the battery backup to continue charging connected devices even when wall power is completely gone."
  },
  {
    "q": "What's the most common mistake buyers make when comparing outlet counts across these UPS units?",
    "a": "Assuming more total outlets always means more outage protection, when a pick like the Eaton Tripp Lite INTERNET550U splits its extra outlets between battery-backup and surge-only types, so the actual number of outlets that stay powered during an outage may be the same as a competitor with fewer total outlets."
  },
  {
    "q": "Is the CyberPower SL700U worth the price premium over the ST625U?",
    "a": "If you specifically need the highest available capacity at this tier along with slightly faster USB charging, yes, but if you want a matching $100,000 warranty and nearly identical USB charging at a lower price, the ST625U offers strong value instead."
  },
  {
    "q": "How do I know how long my specific devices will run on one of these UPS units?",
    "a": "Check your device's wattage rating (often on the power adapter or in its specifications) and compare it against runtime figures like those the Eaton Tripp Lite INTERNET550U provides for common device types, adjusting proportionally for devices with different wattage draws."
  },
  {
    "q": "Can I replace the battery in the APC BE600M1 myself when it eventually degrades?",
    "a": "Yes, its listing specifically references the APCRBC154 replacement battery, sold separately, designed for easy user replacement without needing to purchase an entirely new UPS unit."
  },
  {
    "q": "Do these UPS units require any special installation or wiring?",
    "a": "No, all four picks in this comparison simply plug into a standard wall outlet like any other power strip, with no special electrical wiring or professional installation required for basic setup."
  }
];

export const guideSlug = "best-ups-battery-backups-under-100";

export const guideTitle = "The Best UPS Battery Backups Under $100: Our Picks";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Maximum capacity with USB charging and warranty",
          ""
        ],
        [
          "Concrete runtime figures and the most outlets",
          ""
        ],
        [
          "USB charging with a matching warranty at a lower price",
          ""
        ],
        [
          "A UPS purpose-built for computer and router protection",
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Highest capacity for demanding setups",
          ""
        ],
        [
          "Moderate capacity with USB charging",
          ""
        ],
        [
          "Computer and router specific sizing",
          ""
        ],
        [
          "",
          "Eaton Tripp Lite INTERNET550U (550VA)"
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "Adds convenient device charging directly from the UPS, useful for keeping a phone charged during setup or an outage."
      },
      {
        "label": "",
        "text": "Prioritizes 10 total outlets over USB ports, better if you have many AC devices to connect rather than needing USB charging."
      }
    ],
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A UPS with both battery-backup AC outlets and a USB port that continues functioning during an actual power outage."
      },
      {
        "label": "",
        "text": "5A USB port specifically continues working during outages, keeping a phone charged alongside the computer."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want the highest capacity with the strongest USB charging and warranty combination, where the CyberPower SL700U delivers the most complete package in this comparison."
      },
      {
        "label": "",
        "text": "You want USB charging with the same $100,000 warranty tier at a lower price, where the CyberPower ST625U covers that for about $10 less."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared stated VA and wattage ratings across the lineup, from 550VA to 700VA."
  },
  {
    "title": "",
    "description": "Checked which picks include USB charging ports and their stated amperage output."
  },
  {
    "title": "Battery-Backup vs Surge-Only Outlet Split",
    "description": "Compared how many outlets provide genuine battery backup versus surge protection alone."
  },
  {
    "title": "",
    "description": "Compared how specifically each listing details expected runtime at different device wattages."
  },
  {
    "title": "",
    "description": "Checked whether each pick supports user-replaceable batteries for long-term serviceability."
  }
];
...
export const metaDescription = "How 4 UPS battery backups under $100 compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best UPS Battery Backups Under $100 (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B000ANF8FO?tag=theofficejournal-20",
    "description": "9 minutes, giving concrete expectations rather than a single generic figure. Its 10 total outlets split into 5 battery-backup-and-surge-protected outlets and 5 surge-only outlets, and EMI/RFI filtering helps prevent hardware damage from electrical noise.\n\nIts internal battery is easily user-replaceable, and bottom keyhole tabs make it both under-desk and wall mountable. Backed by a 3-Year Limited Manufacturer's Warranty and a $100,000 Ultimate Connected Equipment insurance, Eaton's technical team supports the purchase directly.\n\nBest for buyers who want concrete, device-specific runtime figures and 10 total outlets at a lower price than the top pick.",
    "specs": [
      "550VA/300W, 10 outlets (5 battery+surge, 5 surge-only)",
      "Detailed runtime by device type (router/TV/PC)",
      "3-year warranty, $100,000 equipment insurance"
    ],
    "pros": [
      "Concrete, device-specific runtime figures rather than one generic number",
      "10 total outlets, more than the SL700U's 8",
      "User-replaceable internal battery"
    ],
    "cons": [
      "Lower VA rating than the CyberPower SL700U",
  ...
  },
  {
    ...
    "description": "This 625VA/360W UPS sits between the SL700U and the smaller 425VA units, offering a genuine middle-ground capacity with 8 NEMA 5-15R outlets split into 4 battery-backup-and-surge-protected outlets and 4 surge-only outlets. 4 amps but at a lower price.\n\nIts GreenPower UPS design reduces standby power consumption, and free PowerPanel management software adds monitoring capability beyond basic LED status lights. Backed by a 3-year warranty including the battery and a Connected Equipment Guarantee up to $100,000, matching the top pick's documented coverage.\n\nBest for buyers who want USB charging and a matching $100,000 warranty at a lower price than the SL700U.",
    "specs": [
      "625VA/360W, 8 outlets (4 battery+surge, 4 surge-only)",
      "2 USB charging ports (2.1A shared)",
      "3-year warranty, $100,000 connected equipment guarantee"
    ],
    "pros": [
      "Matches the SL700U's $100,000 warranty at a lower price",
      "USB charging ports nearly match the top pick's output",
      "PowerPanel software adds monitoring beyond basic LEDs"
    ],
    "cons": [
      "Lower VA rating than the SL700U's 700VA",
      "Fewer battery-backup outlets than the INTERNET550U's 5"
    ],
  ...
  },
  {
    ...
    "description": "This 600VA/330W UPS is specifically marketed to keep computers, WiFi, and routers running through power outages, delivering 23 minutes of runtime at a 100W load, enough time to safely shut down a computer or maintain internet connectivity briefly. Its 5 well-spaced outlets provide full battery backup and surge protection, plus 2 surge-only outlets for less critical gear.\n\n5A USB port works during outages, keeping a phone charged even when the power is out, and APC's easy battery replacement design lets you swap the internal battery in minutes when it ages out, using the separately sold APCRBC154 replacement battery.\n\nBest for buyers who specifically want a UPS marketed around computer and router protection with easy long-term battery replacement.",
    "specs": [
      "600VA/330W, 7 outlets (5 battery+surge, 2 surge-only)",
      "Built-in 1.5A USB port works during outages",
      "23 min runtime at 100W, easy battery replacement"
    ],
    "pros": [
      "Specifically marketed and sized for computer and router protection",
      "USB port continues working during an actual outage",
      "Easy battery replacement extends the unit's long-term lifespan"
    ],
    "cons": [
      "No detailed device-specific runtime breakdown like the INTERNET550U",
      "Fewer total outlets than the INTERNET550U's 10"
    ],
...
export const breadcrumbLabel = "Best UPS Battery Backups Under $100";
