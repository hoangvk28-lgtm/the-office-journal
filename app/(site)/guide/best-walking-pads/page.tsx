...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-walking-pads";
...
export default async function BestWalkingPadsPage() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-walking-pads` },
    about: [
        {
          "@type": "Thing",
          "name": "Walking Pad"
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Walking Pads", item: `${SITE_URL}/guide/best-walking-pads` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-walking-pads#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Walking Pads</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Walking Pads" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Walking pads are compact under-desk treadmills designed for 1 to 4 mph walking during desk work or light cardio. They fold flat for storage under furniture, operate quietly enough for home and office use, and require minimal maintenance compared to full-size treadmills.</p>
          <p>This guide covers eight top-rated walking pads ranked by buyer feedback, noise level, weight capacity, incline capability, and value across all budgets from $89 to $400.</p>
          <p>For walking pads with specific incline capability, see our <a href='/guide/best-walking-pads-with-incline' className='text-brand hover:underline'>best walking pads with incline</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href="https://www.amazon.com/s?k=best+walking+pad&tag=theofficejournal-20" target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
