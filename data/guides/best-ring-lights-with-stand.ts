...
export const guideTitle = "The Best Ring Lights with Stand Worth Considering";
...
export const metaDescription = "How 7 ring lights with stand compare on brightness, color temperature, adjustability and power, with clear notes on who each one suits.";

export const metaTitle = "Best Ring Lights with Stand (2026)";
...
export const breadcrumbLabel = "Best Ring Lights with Stand";
