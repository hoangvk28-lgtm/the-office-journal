...
export const guideTitle = "The Best 8-Channel USB-C Audio Interfaces for Everyday Desk Work";
...
export const metaDescription = "How 8 8-channel USB-C audio interfaces compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 8-Channel USB-C Audio Interfaces for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 8-Channel USB-C Audio Interfaces";
