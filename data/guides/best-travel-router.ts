...
export const faq = [
  {
    "q": "What's the difference between a travel router and a mobile hotspot?",
    "a": "A travel router needs an existing internet source, like a hotel Ethernet port or public Wi-Fi, to create its own private secured network, while a mobile hotspot has its own built-in cellular data connection and doesn't require an existing network."
  },
  {
    "q": "Do I need OpenWrt support in a travel router?",
    "a": "Only if you want deep customization like custom VPN routing rules or additional installed software; most travelers do fine with a simpler mode-based router that skips OpenWrt entirely for easier setup."
  },
  {
    "q": "Can a travel router improve hotel Wi-Fi speed?",
    "a": "No, a travel router cannot make a slow hotel connection faster; it converts a shared or public connection into your own private, more secure network, which can sometimes reduce congestion from other users sharing the same hotel Wi-Fi."
  },
  {
    "q": "How do I set up a travel router in a hotel room?",
    "a": "Connect the router to the hotel's Ethernet port if available, or use its hotspot/repeater mode to connect to the hotel's Wi-Fi network, then connect your own devices to the router's newly created private network."
  },
  {
    "q": "Is Wi-Fi 6 necessary for a travel router?",
    "a": "Wi-Fi 6 provides better performance for multiple simultaneous devices or high-bandwidth activities like video calls and streaming, but a Wi-Fi 5 or AC-standard router is often sufficient for basic browsing and email while traveling."
  },
  {
    "q": "Can I run a VPN on a travel router instead of installing it on each device?",
    "a": "Yes, most modern travel routers with pre-installed VPN client support let you configure your VPN subscription once at the router level, automatically securing every device that connects to it without individual per-device setup."
  }
];

export const guideSlug = "best-travel-router";

export const guideTitle = "The Best Travel Routers for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Fastest VPN throughput and NAS",
          ""
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "OpenWrt (Beryl AX, Slate AX)",
        "text": "Offers deep customization with thousands of plug-ins, ideal for tech-savvy travelers who want full control over VPN configuration and network behavior."
      },
      {
        "label": "Simplified firmware (Roam 6, Opal)",
        "text": "A mode-based setup that's faster to configure for a non-technical traveler who just needs reliable Wi-Fi security without deep customization."
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Wi-Fi 6 for multiple 4K streams or video calls",
          "INet Beryl AX, Slate AX, or TP-Link Roam 6"
        ],
        [
          "Basic browsing and email, budget priority",
          ""
        ]
      ]
    }
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "A dedicated hotspot or repeater mode that converts a shared public network into your own private, secured network, plus WPA3 support to protect against password brute-force attacks on that private network."
      },
      {
        "label": "",
        "text": "All four picks support converting public or hotel Wi-Fi into a private network, with the Beryl AX and Slate AX specifically adding WPA3 protocol support."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "You want the fastest wired uplink or VPN throughput plus deep OpenWrt customization, where the Beryl AX or Slate AX near $100-120 deliver faster performance and more configuration depth."
      },
      {
        "label": "",
        "text": "99 covers that need without OpenWrt's added complexity."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Compared OpenWrt-based routers offering deep customization against simpler mode-based firmware."
  },
  {
    "title": "",
    "description": "Compared pre-installed VPN client/server support and stated OpenVPN/WireGuard throughput."
  },
  {
    "title": "",
    "description": "5G, Gigabit, and standard wired port speeds across the lineup."
  },
  {
    "title": "",
    "description": "Compared physical size, weight, and power input flexibility including USB-C and power bank compatibility."
  },
  {
    "title": "",
    "description": "Compared straightforward mode-based setup against OpenWrt's deeper but more complex configuration options."
  }
];
...
export const metaDescription = "A practical comparison of 4 travel routers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Travel Routers for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "4GHz and 2402Mbps on 5GHz, a meaningfully faster wired uplink than the Gigabit-only picks below. 02 firmware supports over 5,000 ready-made plug-ins, with OpenVPN and WireGuard pre-installed and compatible with 30+ VPN providers.\n\n5G WAN port for faster wired hotel internet uplinks, at a lower price than the Slate AX despite the faster port.\n\nBest for buyers who want the fastest wired uplink speed alongside full OpenWrt customization and VPN support.",
    "specs": [
      "Wi-Fi 6, 2.5G WAN + 1G LAN port",
      "OpenVPN/WireGuard pre-installed, 30+ providers",
      "OpenWrt 21.02, WPA3, USB 3.0"
    ],
    "pros": [
      "2.5G WAN port outpaces the Gigabit-only alternatives",
      "Full OpenWrt customization with 5,000+ plug-ins",
      "Can run VPN client and server simultaneously"
    ],
    "cons": [
      "Higher price than the basic Roam 6 or Opal picks",
      "OpenWrt's depth may be more than a casual user needs"
    ],
  ...
  },
  {
    ...
    "description": "This router's listing specifically states three distinct operating modes, Router mode for Ethernet or USB phone tethering, Hotspot mode for securing public Wi-Fi, and AP/RE/Client mode for extending Wi-Fi, giving a clear mode for nearly any hotel or travel scenario without OpenWrt's added complexity. 10 inch size and USB-C power input work with any 5V/3A PD power source, including a portable power bank.\n\nINet picks above, this one explicitly doesn't support OpenWrt, trading deep customization for a simpler, more approachable setup at less than half the Beryl AX's price.\n\nBest for buyers who want a straightforward, easy-to-set-up travel router without needing OpenWrt-level customization.",
    "specs": [
      "Wi-Fi 6, 1201Mbps (5GHz) + 300Mbps (2.4GHz)",
      "3 operating modes: Router, Hotspot, AP/RE/Client",
      "USB-C powered, 5V/3A PD compatible"
    ],
    "pros": [
      "Simple mode-based setup without OpenWrt complexity",
      "USB-C power works with any standard power bank",
      "Significantly lower price than the GL.iNet picks"
    ],
    "cons": [
      "No OpenWrt support for advanced customization",
      "Lower stated Wi-Fi speed than the GL.iNet picks"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09N72FMH5?tag=theofficejournal-20",
    ...
    "specs": [
      "AC1200 dual-band, Gigabit LAN/WAN ports",
      "OpenVPN/WireGuard pre-installed, 30+ providers",
      "145g, retractable antennas"
    ],
    "pros": [
      "Full Gigabit wired ports at a budget price",
      "Pre-installed VPN client support matching the pricier picks",
      "Very lightweight and compact for travel"
    ],
    "cons": [
      "AC1200 Wi-Fi standard, a generation behind the Wi-Fi 6 picks",
      "Does not support easy tethering per the listing"
    ],
...
export const breadcrumbLabel = "Best Travel Routers";
