...
export const guideTitle = "The Best Tannoy Studio Monitors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Tannoy Reveal 402 4-inch Powered Studio Monitor)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5\" Wired Studio Monitors Pair already covers the job."
      }
    ]
  }
];
...
export const metaDescription = "We compared 8 tannoy studio monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Tannoy Studio Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Active 2-way studio reference monitors with 4\"",
      "1/4\" TRS aux input (each)",
  ...
  },
  {
    ...
    "specs": [
      "Active 2-way studio reference monitor with 8\"",
      "1/8\" TRS aux input (each)",
      "Front-firing bass port"
    ],
    "pros": [
      "Active 2-way studio reference monitor with 8\"",
  ...
  },
  {
    ...
    "specs": [
      "100w passive install speaker with 5\" woofer"
    ],
    "pros": [
      "100w passive install speaker with 5\" woofer",
  ...
  },
  {
    ...
    "description": "5\" Wired Studio Monitors Pair is the most affordable pick here that still clears the capability floor for this category. Latency free wired connection - engineered for zero-latency audio monitoring, these wired desktop speakers provide a pure, uninterrupted signal well suited to live streaming, gaming, podcasting, and studio work. Studio-grade sound - upgrade your built-in computer speakers with crystal-clear, bi-amplified power that delivers professional studio monitor quality directly to your desktop.\n\n5-inch kevlar woofers - designed for ultimate acoustic performance, the black kevlar low-frequency drivers provide a smooth, punchy bass response tailored for music production and recording.\n\nChoose this if you want a capable pick without paying for headroom you won't use. Stands, isolation pads, and cables are usually sold separately, so factor that into the real total cost before buying.",
    "specs": [
...
export const breadcrumbLabel = "Best Tannoy Studio Monitors";
