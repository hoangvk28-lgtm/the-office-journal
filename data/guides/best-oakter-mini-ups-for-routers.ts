...
export const faq = [
  {
    ...
    "a": "No. Ubiquiti AirFiber radios use point-to-point PoE at voltages and power levels that differ from a typical home router, so a UPS built for AirFiber gear is a distinct product from Oakter's standard router-focused mini UPS line, not a version of the same unit."
  }
];

export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-mini-ups-for-routers","title":"8 Best Mini UPS for Routers in 2026"},{"href":"/guide/best-wgp-mini-ups-for-routers","title":"5 Best WGP Mini UPS for Routers in 2026"},{"href":"/guide/best-cuzor-mini-ups-for-routers","title":"5 Best Cuzor Mini UPS for Routers in 2026"}];
