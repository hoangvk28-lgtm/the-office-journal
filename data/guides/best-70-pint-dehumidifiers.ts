...
export const guideTitle = "The Best 70-Pint Dehumidifiers for Everyday Desk Work";
...
export const metaDescription = "How 8 70-pint dehumidifiers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 70-Pint Dehumidifiers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 70-Pint Dehumidifiers";
