...
const queries = [
  "rectangular conference table office 8 person",
  "racetrack conference table office",
  "round conference table office",
  "u-shaped conference table office",
  "conference table with power outlets grommets",
  "granite look conference table office",
  "walnut conference table office",
  "oak conference table office",
  "adjustable height conference table office",
  "small conference table office 4 person",
  "large conference table office 12 person",
  "budget conference table office under 300",
  "modern conference table black office",
  "white conference table office",
  "d-shaped conference table office",
];
const pool = {};
for (const q of queries) {
  ...
  console.log(`\n=== ${q} (${pool[q].length} with image) ===`);
  pool[q].forEach(x => console.log(x.asin, x.price, x.title));
  await new Promise(r => setTimeout(r, 400));
}
writeFileSync(resolve(ROOT, "/tmp/conftbl_pool.json"), JSON.stringify(pool, null, 2));
