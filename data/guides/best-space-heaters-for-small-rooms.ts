export const guideSlug = "best-space-heaters-for-small-rooms";
export const guideTitle = "6 Best Space Heaters for Small Rooms in 2026";
export const metaTitle = "Best Space Heaters for Small Rooms";
export const metaDescription = "We compared space heater for small room models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real.";
export const mainKeyword = "space heater for small room";
export const introParagraphs = [
  "Best Space Heaters for Small Rooms span basic ceramic models to full-room oil-filled radiators, which is exactly why room size changes what you actually need.",
...
export const products: GuideProduct[] = [
  {
    id: "best-space-heaters-for-small-rooms-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-space-heaters-for-small-rooms-2",
    rank: 2,
  ...
  {
    id: "best-space-heaters-for-small-rooms-3",
    rank: 3,
  ...
  {
    id: "best-space-heaters-for-small-rooms-4",
    rank: 4,
  ...
  {
    id: "best-space-heaters-for-small-rooms-5",
    rank: 5,
    badge: "Best Value",
  ...
  {
    id: "best-space-heaters-for-small-rooms-6",
    rank: 6,
    badge: "Worth a Look",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You're heating a larger room and want a thermostat and multiple heat settings, where JIBUFI Portable Space Heater for Indoor Use with 70° Oscillation and Remote justifies the extra cost."
      },
      {
        "label": "Save if",
