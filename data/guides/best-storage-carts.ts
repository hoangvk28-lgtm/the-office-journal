...
export const guideTitle = "The Best Storage Carts for a Better Desk Setup";
...
export const metaDescription = "We compared 8 storage carts on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Storage Carts for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Storage Carts";
