...
export const guideSlug = "best-desk-pads-under-75";

export const guideTitle = "The Best Desk Pads Under $75, Compared";
...
export const introParagraphs = [
  "Best Desk Pads Under $75 cover a wide range of materials and sizes. That means marketing copy alone is risky.",
  "This roundup weighs true size versus your actual keyboard and mouse, given that marketing copy tends to obscure this."
];
...
export const metaDescription = "We compared 8 desk pads under $75 on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Desk Pads Under $75 (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-desk-pads-under-75-1",
    "rank": 1,
    "badge": "Best Overall",
...
export const breadcrumbLabel = "Best Desk Pads Under $75";
