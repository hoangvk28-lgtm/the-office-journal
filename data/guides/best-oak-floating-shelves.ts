...
export const introParagraphs = [
  "Best Oak Floating Shelves look similar but differ in practice, so the listing hides real mounting gaps.",
...
export const heroImage = "https://m.media-amazon.com/images/I/413uBxbLHdL._SL500_.jpg";
...
export const products: GuideProduct[] = [
  {
    id: "best-oak-floating-shelves-1",
    rank: 1,
    badge: "Best Overall",
    name: "BAYKA Light Oak-Toned Floating Shelves 22.5in",
    price: "$59.98",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/413uBxbLHdL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0DZWS53LP?tag=theofficejournal-20",
    description: "BAYKA Light Oak-Toned Floating Shelves 22.5in is the strongest all-around choice here. Modern & minimalist style - featuring clean lines and a nature wood finish, these wall-mounted shelves bring warm farmhouse charm and modern style to any space. Spacious & functional size - at 6.7\"d x 22.5\"w x 1.1\"t, these long floating shelves provide ample wide display space for organizing or showcasing items without crowding your wall.\n\nSide by side with RICHFOCUS 36Inch Floating Shelves for Wall 2Pack, the real difference worth noting is material and color notice - not solid wood.\n\nReach for this pick if you want the strongest all-around pick in this comparison and would rather not keep shopping around. A standard drywall anchor alone safely holds only 10 to 25 lbs, so anything heavier needs to land on a wall stud or a toggle bolt rated for more weight.",
    specs: ["Modern & minimalist style - featuring clean lines and a nature wood finish", "Spacious & functional size - at 6.7\"d x 22.5\"w x 1.1\"t", "Strong load capacity - made from durable engineered wood and reinforced with sturdy brackets"],
    pros: ["Modern & minimalist style - featuring clean lines and a nature wood finish", "Spacious & functional size - at 6.7\"d x 22.5\"w x 1.1\"t", "Strong load capacity - made from durable engineered wood and reinforced with sturdy brackets", "Protection sealing and warp prevention - each shelf"],
  ...
  {
    id: "best-oak-floating-shelves-2",
    rank: 2,
    badge: "Also Worth Considering",
    name: "RICHFOCUS 36Inch Floating Shelves for Wall 2Pack",
    price: "$59.39",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41qjou-9EyL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0DK1BWQKR?tag=theofficejournal-20",
    description: "RICHFOCUS 36Inch Floating Shelves for Wall 2Pack is a strong alternative worth comparing directly against the top pick. These shelves for room wall are made of premium fsc-certified engineered wood board with PVC wood grain finish. 36 Inch floating shelves for wall (set of 2): each wall shelves are 8 inches in depth and 1.5 inches in thickness.\n\nAgainst BAYKA Light Oak-Toned Floating Shelves 22.5in, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nThis makes sense for anyone who want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    specs: ["Rustic & modern floating shelves", "36 Inch floating shelves for wall (set of 2)", "Free up space in your home"],
    pros: ["Rustic & modern floating shelves", "36 Inch floating shelves for wall (set of 2)", "Free up space in your home", "Easy to assemble"],
  ...
  {
    id: "best-oak-floating-shelves-3",
    rank: 3,
    badge: "Best Premium Pick",
    name: "RICHFOCUS 72Inch Floating Shelves for Wall 2Pack",
    price: "$147.59",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41s-fVBzjHL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0DK1D8MGX?tag=theofficejournal-20",
    description: "RICHFOCUS 72Inch Floating Shelves for Wall 2Pack is the premium option here, positioned above the rest on price. These shelves for room wall are made of premium fsc-certified engineered wood board with PVC wood grain finish. 72 Inch floating shelves for wall (set of 2): each wall shelves are 8 inches in depth and 1.5 inches in thickness.\n\nAgainst BAYKA Light Oak-Toned Floating Shelves 22.5in, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nThis fits best if you are willing to spend the most in this comparison for the fuller feature set that comes with it. A standard drywall anchor alone safely holds only 10 to 25 lbs, so anything heavier needs to land on a wall stud or a toggle bolt rated for more weight.",
  ...
  {
    id: "best-oak-floating-shelves-4",
    rank: 4,
    badge: "Best Value",
    name: "Fun Memories Floating Shelves for Wall",
    price: "$57.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/51g+4Jo8WwL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0DC6RVGXQ?tag=theofficejournal-20",
    description: "Fun Memories Floating Shelves for Wall is a budget-friendly pick that doesn't skip the essentials. These rustic wood floating shelves are the perfect addition to any room, offering ample space to display decor or store essentials. Say goodbye to wobbly shelves!\n\nBAYKA Light Oak-Toned Floating Shelves 22.5in is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nGo with this pick if you want a genuinely capable pick without paying for headroom you won't use. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    specs: ["Elevate your decor", "Say goodbye to wobbly shelves", "Maximize your space"],
    pros: ["Elevate your decor", "Say goodbye to wobbly shelves", "Maximize your space", "Stylish & practical"],
    cons: ["Real weight capacity depends on stud spacing, not the shelf itself", "Drywall anchors alone only safely hold up to 20 to 25 lbs"],
    bestFor: "buyers who want a genuinely capable pick without paying for headroom you won't use",
  },
  {
    id: "best-oak-floating-shelves-5",
    rank: 5,
    badge: "Runner-Up Pick",
    name: "Natural Wood Floating Shelves for Wall 24 inch Oak",
    price: "$69.99",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/51vN1VlumAL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0BYT6LB3F?tag=theofficejournal-20",
    description: "Natural Wood Floating Shelves for Wall 24 inch Oak is a strong alternative worth comparing directly against the top pick. These real wood shelves are handcrafted from 100% solid pine and finished in a warm oak tone that highlights natural grain and knots for a clean farmhouse look. With a natural oak finish and clean floating design, these deep wood shelves provide decorative and functional wall storage for your kitchen, bedroom, bathroom, office, or living room.\n\nAgainst BAYKA Light Oak-Toned Floating Shelves 22.5in, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A standard drywall anchor alone safely holds only 10 to 25 lbs, so anything heavier needs to land on a wall stud or a toggle bolt rated for more weight.",
    specs: ["Solid wood floating shelves", "Heavy-duty floating wood shelf", "Wide wooden wall shelves"],
    pros: ["Solid wood floating shelves", "Heavy-duty floating wood shelf", "Wide wooden wall shelves", "Wall mount floating wall shelves"],
    cons: ["Drywall anchors alone only safely hold up to 20 to 25 lbs", "Real weight capacity depends on stud spacing, not the shelf itself"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  }
];
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        [
          ...
          "Fun Memories Floating Shelves for Wall"
        ],
        [
          "Books, standard decor",
          "BAYKA Light Oak-Toned Floating Shelves 22.5in"
        ],
        [
          "Heavier items, electronics",
          "RICHFOCUS 72Inch Floating Shelves for Wall 2Pack"
        ]
      ]
    }
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Mid-range pick",
          "RICHFOCUS 36Inch Floating Shelves for Wall 2Pack"
        ],
        [
          "Higher budget",
          "RICHFOCUS 72Inch Floating Shelves for Wall 2Pack"
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Stud-mounted (e.g. RICHFOCUS 72Inch Floating Shelves for Wall 2Pack)",
        "text": "Highest weight capacity, but requires drilling into a wall stud."
      },
      {
        "label": "No-drill (e.g. Fun Memories Floating Shelves for Wall)",
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "RICHFOCUS 72Inch Floating Shelves for Wall 2Pack is worth checking against your actual stud spacing before assuming its full rated capacity applies."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You need higher weight capacity and sturdier brackets for real storage, where RICHFOCUS 72Inch Floating Shelves for Wall 2Pack justifies the extra cost."
      },
      {
        "label": "Save if",
        "text": "You're displaying light decorative items only, where Fun Memories Floating Shelves for Wall already covers the job at the lowest price here."
      }
    ]
  }
];
