...
export const guideTitle = "The Best Wood Cable Management Boxes for a Cleaner, More Useful Desk";
export const metaTitle = "Best Wood Cable Management Boxes for Home Offices (2026)";
export const metaDescription =
  "A practical comparison of 9 wood cable management boxes, focused on compatibility, build, features and price, and the trade-offs between them.";
...
export const products: GuideProduct[] = [
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B07WZJL9YL?tag=theofficejournal-20",
    description: "The Luxe Designs Cable Management Box is handcrafted from sustainable mango wood, making each unit slightly unique in grain pattern and tone. 11 inches it is the largest box in this roundup and accommodates long power strips including 8-outlet bars that smaller boxes cannot fit. Dual magnetic lid closures hold the lid securely without a click-lock mechanism, and ventilation holes under the base allow heat escape without compromising the enclosed aesthetic. The included neoprene cable sleeve and padded felt feet complete the premium package. A pending design patent indicates active development and brand investment in product improvement. Largest box, fits 8-outlet power strips.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B0F28LNZLX?tag=theofficejournal-20",
    description: "The LiTY Cable Management Box is constructed from premium acacia wood using mortise-and-tenon joints, a traditional woodworking technique that creates stronger corner connections than glue-only or staple construction. The magnetic lid closes securely, and integrated ventilation slots along the sides prevent heat buildup without visible gaps that detract from the minimalist aesthetic. 8 stars, the LiTY matches the Luxe Designs rating at a lower price point. The compact 12 by 5-inch form factor works on desks, floors, shelves, and bedroom surfaces, providing placement flexibility beyond dedicated desk cable boxes. A real lower than premium alternatives.",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com/dp/B09J887SFP?tag=theofficejournal-20",
    description: "7 inches) box with 10mm thick bamboo lids, the lowest price for genuine bamboo cable management in this roundup. The bamboo lid is thick enough to hold mobile devices for charging while in use, adding vertical storage functionality. Five velcro cable ties are included in the package. 4 stars, the OSPNIEEK provides buyer-verified bamboo quality at a price that undercuts all other real-wood options in this roundup. A 1-year warranty and refund guarantee support the purchase. Bamboo lid holds devices for charging. 5 inch max, shorter than premium options.",
...
export const faq: { q: string; a: string }[] = [
  ...
  { q: "What size power strip fits in a wood cable management box?", a: "94 inches accommodates the longest standard power strips. 17 inches), and Kos Design bamboo box. 4 inches, which excludes some longer strip models. Measure your power strip before ordering." },
];
