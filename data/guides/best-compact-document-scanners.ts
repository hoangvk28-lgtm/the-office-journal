...
export const faq = [
  {
    "q": "Do all compact document scanners have an ADF hopper?",
    "a": "Several compact picks in this guide (Brother DS-640, DS-740D, Epson ES-50) are single-sheet-fed, requiring you to feed each page manually rather than loading a stack."
  },
  {
    "q": "Why does a compact scanner need clearance above it?",
    "a": "Some compact designs achieve their small desk footprint using a vertical paper path rather than horizontal, meaning the scanner needs open space above it (not tucked directly under a shelf) to feed paper properly."
  },
  {
    "q": "Is a flatbed scanner the same as a compact document scanner?",
    "a": "A flatbed scanner like the Canoscan Lide 300 in this guide has no document feeder at all, you scan one page or photo at a time on the glass, a different capability than any ADF-fed compact scanner."
  },
  {
    "q": "Should I buy compact or full-size if I scan large batches regularly?",
    "a": "Compact scanners trade ADF capacity for footprint. If you regularly scan more than a handful of pages unattended, a full-size scanner with a 50-100 sheet hopper will serve you better."
  }
];

export const guideSlug = "best-compact-document-scanners";

export const guideTitle = "The Best Compact Document Scanners for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "Single-sheet feed as the primary compact-size tradeoff",
    "description": "Distinguished picks with a real multi-sheet ADF hopper from single-sheet-fed designs, since compact footprint marketing rarely discloses this capacity reduction directly."
  },
  {
    "title": "",
    "description": "Noted where a compact design's space savings comes from a vertical feed path requiring clearance above the unit, a placement factor distinct from pure desk-surface footprint."
  },
  {
    "title": "",
    "description": "Prioritized listings with a specific disclosed footprint reduction (like the Brother DS-740D's 11-inch claim) over generic space-saving language."
  }
];
...
export const metaDescription = "How 8 compact document scanners compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Compact Document Scanners for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "5 lb, this is compact, but that footprint savings comes with a real ADF-capacity tradeoff versus a full-size desktop scanner, this is a single-sheet-fed design, not a multi-sheet hopper. Color scans run at the same speed as black-and-white, a genuine plus.\n\n0 powered with no external adapter needed, and broad Windows/Mac/Linux driver support via TWAIN/WIA/ICA/SANE, a real compatibility plus for this size class.\n\nUSB-powered, no external adapter needed.",
    "specs": [
      "Single-sheet feed, under 1 ft long, 1.5 lb",
      "Micro USB 3.0 powered, no external adapter",
      "Color scan speed matches black-and-white",
      "TWAIN/WIA/ICA/SANE drivers"
    ],
    "pros": [
      "USB-powered, no external adapter needed",
      "Color scans at full black-and-white speed",
      "Broad OS driver support"
    ],
    "cons": [
      "Single-sheet feed, not a multi-sheet hopper",
      "No duplex on this specific model",
      "Reduced capacity is the real tradeoff for the compact size"
    ],
    "bestFor": "Buyers who want the most proven, portable single-sheet compact scanner"
  },
  {
    ...
    "description": "The duplex version of the rank-1 pick, scanning both sides in one pass, with an explicit Desk Saving Design claimed to reduce desk footprint by roughly 11 inches versus a standard placement, a disclosed space-saving figure rather than a vague marketing claim.\n\nSame single-sheet feed limitation as its simplex sibling, this trades multi-sheet hopper capacity for the compact form factor, expect to feed documents individually rather than loading a stack.\n\nDuplex scanning in a single pass. Both are worth keeping in mind before deciding.",
    "specs": [
      "Duplex, single-sheet feed, ~11 inches less desk space claimed",
      "Micro USB 3.0 powered",
      "Color scan speed matches black-and-white",
      "TWAIN/WIA/ICA/SANE drivers"
    ],
    "pros": [
      "Explicit desk-space-savings figure disclosed (11 inches)",
      "Duplex scanning in a single pass",
      "Color scans at full black-and-white speed",
      "Broad OS driver support"
    ],
    "cons": [
      "Single-sheet feed, no multi-sheet hopper",
      "Higher price than the simplex sibling"
    ],
  ...
  },
  {
    ...
    "description": "This is a space-saving design that still keeps a real ADF hopper (not single-sheet feed), a meaningful step up in unattended batch capacity over the Brother compact picks above, at a real price premium. Up to 30ppm duplex with a single touch to start.\n\nHandles thick items and plastic cards alongside standard paper, and connects via USB or Wi-Fi, though as with any wireless scanner, sustained high-DPI color batches are safer over the wired connection.",
    "specs": [
      "Space-saving ADF hopper design, up to 30ppm duplex",
      "USB or Wi-Fi, works without a computer via cloud",
      "Auto de-skew, color optimization, blank-page removal",
      "Handles thick items and plastic cards"
    ],
    "pros": [
      "Real ADF hopper, not single-sheet feed",
      "30ppm duplex is fast for this size class",
      "Handles thick items and cards",
      "Works standalone without a computer via cloud"
    ],
    "cons": [
      "Highest price among the compact picks in this guide",
      "Lower rating than the Brother compact picks",
      "Still a reduced hopper capacity versus full desktop scanners"
    ],
  ...
  },
  {
    ...
    "description": "Identical specs to the rank-3 pick in a black finish, the same space-saving ADF hopper design with up to 30ppm duplex scanning and USB/Wi-Fi connectivity. Choose based on finish preference, the underlying hardware and tradeoffs are the same.",
    "specs": [
      "Space-saving ADF hopper design, up to 30ppm duplex",
      "USB or Wi-Fi, works without a computer via cloud",
      "Auto de-skew, color optimization, blank-page removal",
    ...
    "pros": [
      "Same real ADF hopper as the white version",
      "30ppm duplex speed",
      "Black finish option",
      "Works standalone via cloud"
    ],
    "cons": [
      "Same price premium as the white version",
      "Same rating as the white version",
      "Reduced capacity versus full desktop scanners"
    ],
  ...
  },
  {
    ...
    "description": "A genuine 20-sheet ADF (a real hopper, larger than the single-sheet Brother picks) in a lightweight, USB-powered body, with an explicit 500 scans/day suggested daily volume, a rare and useful disclosure at this size class. Duplex scanning and built-in software round out a well-equipped compact pick.\n\n7 lb this is take-anywhere portable, a real plus for home offices, classrooms, and remote work.\n\nThat said, lower rating than the ScanSnap picks.",
    "specs": [
      "20-sheet ADF hopper, duplex, USB-powered",
      "Explicit 500 scans/day suggested daily volume",
      "Built-in software, no installation needed",
      "1.7 lb, portable"
    ],
    "pros": [
      "20-sheet ADF hopper, a real step up from single-sheet feed",
      "Explicit daily volume disclosure",
      "USB-powered, no external adapter",
      "Duplex scanning"
    ],
    "cons": [
      "Lower rating than the ScanSnap picks",
      "20 sheets is still modest versus full desktop capacity",
      "Not intended for scanning photographs"
    ],
    "bestFor": "Buyers who want a real 20-sheet ADF hopper in a portable, USB-powered body"
  },
  {
    ...
    "description": "5 seconds, useful for repeated small jobs throughout a day rather than one large batch. 5x72 inches, useful for long receipts.\n\nUSB-powered with no external adapter, and includes Nuance OCR for searchable PDFs, a complete package at the lowest price in this guide.",
    "specs": [
      "Single-sheet feed, 5.5-second per-page scan time",
      "Handles documents up to 8.5x72 inches",
      "USB-powered, no adapter needed",
      "Includes Nuance OCR for searchable PDFs"
    ],
    "pros": [
      "Lowest price in this guide",
      "Fast first-page-out time for repeated small jobs",
      "Handles unusually long documents up to 72 inches",
      "Includes OCR for searchable PDFs"
    ],
    "cons": [
      "Single-sheet feed, no multi-sheet hopper",
      "Not built for large sustained batches"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B07G5XZVLQ?tag=theofficejournal-20",
    "description": "This is a flatbed scanner, not an ADF-fed document scanner, included here as the honest budget alternative for buyers whose real need is occasional single-page scanning rather than batch document digitization. Auto Scan Mode detects what you're scanning automatically.\n\nCompact and the cheapest pick in this guide, but don't buy this expecting ADF batch capability, feed one page at a time on the glass.",
    "specs": [
      "Flatbed scanner, not ADF-fed",
      "Auto Scan Mode detects content type",
      "USB connectivity"
    ],
    "pros": [
      "Cheapest pick in this guide",
      "compact flatbed footprint",
      "Simple USB plug-and-play"
    ],
    "cons": [
      "Flatbed only, not an ADF document scanner",
      "No batch feeding capability at all",
      "Best for single pages, photos, or books, not document stacks"
    ],
  ...
  },
  {
    ...
    "description": "Included as the honest large-capacity reference point: this 100-sheet-feeder model is not compact, it's a high-speed desktop scanner. If your priority shifted from footprint to capacity while reading this guide, this is the pick to consider instead of the true compact options above.\n\nA touchscreen and Wi-Fi 6 plus USB-C round out a well-equipped, but decidedly non-compact, alternative.\n\nThe standout detail is that largest feeder capacity by far. Balancing that out, not compact, this is a full desktop-class scanner.",
    "specs": [
      "100-sheet feeder, up to 45 ppm rated",
      "Wi-Fi 6 + USB-C, touchscreen",
      "Not a compact design",
      "Multi-feed sensor, brake roller system"
    ],
    "pros": [
      "Highest rating in this guide",
      "Largest feeder capacity by far",
      "Touchscreen with customizable profiles",
      "High-speed rated for large batches"
    ],
    "cons": [
      "Not compact, this is a full desktop-class scanner",
      "Included only as an honest capacity-tradeoff reference"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-high-speed-document-scanners",
    "title": "Best High-Speed Document Scanners (2026)"
  },
  {
  ...
  {
    "href": "/guide/best-wireless-document-scanners",
    "title": "Best Wireless Document Scanners (2026)"
  }
];

export const breadcrumbLabel = "Best Compact Document Scanners";
