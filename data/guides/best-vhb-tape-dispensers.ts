...
export const guideTitle = "The Best VHB Tape Dispensers for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "3M Scotch 5952 VHB Tape: 1/2 in."
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "3M Scotch 5952 VHB Tape: 1/2 in.",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "You want straightforward everyday use without paying for headroom you won't need, where 3M Scotch 5952 VHB Tape: 1/2 in. (Black) already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "How 6 VHB tape dispensers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best VHB Tape Dispensers for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-label-protection-tape-dispensers",
    "title": "Best Label-Protection Tape Dispensers in 2026"
  }
];

export const breadcrumbLabel = "Best VHB Tape Dispensers";
