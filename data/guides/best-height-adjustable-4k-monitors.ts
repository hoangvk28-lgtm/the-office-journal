...
export const guideTitle = "6 Best Height-Adjustable 4K Monitors in 2026";
export const metaTitle = "Best Height-Adjustable 4K Monitors";
export const metaDescription = "We compared height-adjustable 4k monitors models by verified specs and real-world tradeoffs, not marketing claims alone.";
...
export const products: GuideProduct[] = [
  {
    ...
    description: "LG 32U700B-B 32-inch Ultrafine 4K UHD 60Hz Tilt/Height Computer Monitor is the strongest all-around choice here. The 32\" 4K uhd (3840x2160) ultrafine display delivers sharp detail and expansive screen space for multitasking, editing, and creative workflows. Versatile connectivity - with HDMI, displayport 1.4 and headphone input connect with confidence knowing your devices will be compatible with this display.\n\n32 Inch 4K Touch Monitor is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nThis makes sense for anyone who want the strongest all-around pick in this comparison and would rather not keep shopping around. Marketed specs and real-world performance can differ, so check independent reviews before assuming the headline number tells the full story.",
    specs: ["32\" 4K uhd (3840x2160) ultrafine display delivers sharp detail and expansive screen space for multitasking", "Versatile connectivity - with HDMI", "Virtually borderless simplicity - experience more screen and less distraction with an ultra-slim bezel and sleek"],
    pros: ["32\" 4K uhd (3840x2160) ultrafine display delivers sharp detail and expansive screen space for multitasking", "Versatile connectivity - with HDMI", "Virtually borderless simplicity - experience more screen and less distraction with an ultra-slim bezel and sleek", "Experience HDR content with up to 99% srgb color gamut coverage for richer color"],
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "IPS (e.g. Acer 27in 4K 3840x2160 IPS 60Hz Office Monitor CB272K bmiprux)",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-4k-monitors","title":"Best 4K Monitors in 2026"},{"href":"/guide/best-msi-4k-monitors","title":"Best MSI 4K Monitors in 2026"},{"href":"/guide/best-4k-monitors-for-gaming","title":"Best 4K Monitors for Gaming in 2026"},{"href":"/guide/best-27-inch-4k-monitors-for-gaming","title":"Best 27-Inch 4K Monitors for Gaming in 2026"}];
