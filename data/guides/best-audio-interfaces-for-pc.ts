...
export const guideTitle = "The Best Audio Interfaces for PC: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 8 audio interfaces for PC, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Audio Interfaces for PC (2026)";
...
export const breadcrumbLabel = "Best Audio Interfaces for PC";
