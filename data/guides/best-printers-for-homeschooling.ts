...
export const faq = [
  ...
  },
  {
    ...
    "a": "Fax is a legacy feature that shows up on a few all-in-ones in this list, including the PIXMA TR4720 and Workforce WF-2930, but it rarely gets used in a homeschool context. Don't let fax sway your decision, focus on cost per page, automatic document feeder support, and color needs instead."
  }
];

export const guideSlug = "best-printers-for-homeschooling";

export const guideTitle = "The Best Printers for Homeschooling, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to HP DeskJet 4355 Wireless All unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const introParagraphs = [
  ...
  "99 ink-tank model built for sustained daily printing."
];
...
export const metaDescription = "We compared 8 printers for homeschooling on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Printers for Homeschooling (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "The DeskJet 4355 keeps things simple with print, scan, and copy in a low-cost package, plus a 3-month Instant Ink trial that softens the early cartridge cost for a new homeschool setup still figuring out its actual print volume. It is one of the most affordable full all-in-ones in this list.\n\nOnce the Instant Ink trial ends, standard cartridge economics apply, so families printing more than light-to-moderate volume should plan to reassess after the trial period or budget for more frequent cartridge purchases.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The Workforce WF-2930 packs an automatic document feeder, fax, duplex printing, and a small color display into a low-cost all-in-one, a fuller feature set than most printers at this price. Duplex printing helps cut paper use on longer reading assignments or multi-page lesson packets.\n\nLike the other cartridge-based picks in this list, cost per page will run higher than an ink-tank printer once volume climbs, making this best suited to a homeschool with moderate rather than heavy daily printing needs.\n\nDuplex printing saves paper on long assignments.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The PIXMA MG3620 emphasizes mobile and tablet printing, a useful trait for homeschool curricula delivered as PDFs or apps on an iPad, letting a parent send a worksheet straight from the tablet a kid is already using for lessons. Wireless setup covers the basics for a shared home network.\n\nIt is a print, scan, copy all-in-one without an automatic document feeder or fax, which keeps the design simple but limits it for anyone needing to scan multi-page stacks regularly.",
    "specs": [
      "Color inkjet all-in-one: print, scan, copy",
  ...
  },
  {
    ...
    "description": "For a homeschool leaning heavily on black-and-white daily worksheets, math drills, spelling lists, reading comprehension pages, a monochrome laser like the DCP-L2640DW brings cost per page down further than even an ink-tank inkjet can manage for pure text. Duplex printing, copy, and scan are all built in.\n\nThe trade-off is no color output at all, so pair it with a color-capable printer if art or science visuals are a regular part of your curriculum.\n\nToner survives summer break without drying out.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The Smart Tank 5101 brings ink-tank economics to a lower price than the EcoTank ET-2400, with 2 years of ink included, a meaningful head start for a homeschool budgeting print costs over an entire school year or more. Print, scan, and copy cover the essentials without extra bulk.\n\n4GHz guest band enabled for this printer to join.\n\n4GHz-only wireless can complicate setup on some routers.",
    "specs": [
...
export const relatedGuides = [
  {
    "href": "/guide/best-printers-for-teachers",
    "title": "Best Printers for Teachers (2026)"
  },
  {
  ...
  },
  {
    ...
    "title": "Best Small Printer Stands (2026)"
  }
];

export const breadcrumbLabel = "Best Printers for Homeschooling";
