...
export const faq = [
  {
    "q": "What is the difference between IP55 and IP65?",
    "a": "IP65 offers full dust protection and resistance to low-pressure water jets, a higher water-resistance tier than IP55, which offers somewhat less water protection despite similar dust resistance."
  },
  {
    "q": "Are rugged portable SSDs waterproof?",
    "a": "Even a high IP rating protects against splashes, jets, and dust, not full submersion. Treat rugged ratings as everyday protection, not a waterproof guarantee."
  },
  {
    "q": "Does a rugged drive run slower under heavy use?",
    "a": "Rugged enclosures generally have less airflow than slim designs, which can affect sustained speed on very long transfers."
  }
];

export const guideSlug = "best-rugged-portable-ssds";

export const guideTitle = "The Best Rugged Portable SSDs for Everyday Desk Work";
...
export const howWeEvaluated = [
  {
    "title": "Decoded actual IP rating numbers",
    "description": "Distinguished IP55 from IP65 specifically rather than treating any 'IP-rated' or 'rugged' claim as equivalent."
  },
  {
    "title": "",
    "description": "Noted that drop-rating test conditions are not independently standardized across brands, and weighed real-world review feedback alongside marketing claims."
  },
  {
    "title": "",
    "description": "Considered that rugged casing generally sacrifices some heat dissipation versus a slim enclosure, relevant for buyers doing long sustained transfers."
  },
  {
    "title": "Weight and bulk versus protection",
    "description": "Weighed the real bulk and weight tradeoff of rugged casing against the actual protection level it provides."
  }
];

export const introParagraphs = [
  "Not all 'rugged' or 'IP-rated' portable SSDs mean the same thing, an IP55 rating and an IP65 rating describe different levels of dust and water resistance, and it is worth decoding the specific number rather than treating any IP rating as an equivalent durability claim.",
...
export const metaDescription = "How 4 rugged portable SSDs compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Rugged Portable SSDs for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "2 Gen 2 speed up to 1050MB/s, though it does not carry a formal IP rating number in its listing, worth confirming directly if a certified rating matters to you.\n\nGenuine drop-resistant rubberized shell design. On price, it comes in below SANDISK 2TB Extreme Portable SSD, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Drop-test conditions are not independently standardized across brands.",
    "specs": [
      "1TB capacity",
      "Up to 1050MB/s rated",
      "USB 3.2 Gen 2",
      "Rugged rubberized shell"
    ],
    "pros": [
      "Genuine drop-resistant rubberized shell design",
      "Reliable, well-reviewed platform",
      "Realistic USB 3.2 Gen 2 speed ceiling",
      "Good balance of toughness and size"
    ],
    "cons": [
      "No formal IP rating number listed, confirm if certification matters to you",
      "Bulkier than non-shielded alternatives",
      "Drop-test conditions are not independently standardized across brands"
    ],
  ...
  },
  {
    ...
    "description": "SanDisk's Extreme carries an explicit IP65 rating, meaning it is fully dust-tight and protected against low-pressure water jets, a higher water-resistance tier than an IP55 rating.\n\nOn the other side, Bulkier than an uncertified slim drive.",
    "specs": [
      "2TB capacity",
      "Up to 1050MB/s rated",
      "USB-C, USB 3.2 Gen 2",
    ...
    "pros": [
      "IP65 is a higher-tier certified water resistance rating",
      "Large 2TB capacity",
      "Realistic everyday speed ceiling"
    ],
    "cons": [
      "IP65 protects against water jets, not submersion, a real distinction",
      "Older model, verify current firmware",
      "Bulkier than an uncertified slim drive"
    ],
  ...
  },
  {
    ...
    "description": "Corsair's EX400U Survivor carries an explicit IP55 rating alongside a fast USB4 bridge rated up to 4000MB/s.",
    "specs": [
      "1TB capacity",
    ...
    "pros": [
      "Fast USB4 bridge combined with a certified IP rating",
      "Genuine everyday dust and splash protection",
      "Compact for the speed and durability tier",
      "Strong option for buyers who also want speed"
    ],
    "cons": [
      "IP55 is a lower water-resistance tier than IP65, understand the real difference",
      "Needs a USB4 host port to reach rated speed"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Genuine drop-resistant design at a larger 2TB capacity",
      "Slightly better heat dissipation than the smallest rugged drives",
      "Reliable, well-reviewed platform",
      "Good fit for larger rugged-use libraries"
    ],
    "cons": [
      "No formal certified IP rating number listed",
      "Bulkier and heavier than 1TB rugged alternatives",
      "Premium price versus non-rugged 2TB drives"
    ],
...
export const relatedGuides = [
  {
    ...
    "title": "Best Waterproof Portable SSDs in 2026"
  },
  {
...
export const breadcrumbLabel = "Best Rugged Portable SSDs";
