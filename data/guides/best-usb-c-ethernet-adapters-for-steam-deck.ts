...
export const guideTitle = "The Best USB-C Ethernet Adapters for Steam Deck: Picks and Trade-offs";
...
export const metaDescription = "A practical comparison of 6 USB-C ethernet adapters for steam deck, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best USB-C Ethernet Adapters for Steam Deck (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0B7HVZNMB?tag=theofficejournal-20",
    "description": "0 ports, and Gigabit Ethernet, now supporting ROG Ally X and Legion Go S alongside Steam Deck.\n\nJSAUX is explicit this does NOT work with ROG Xbox Ally or Xbox Ally X. The 100W charging fully supports ROG Ally's 30W Turbo Mode, though a 100W charger is recommended for best results.",
    "specs": [
      "4K@120Hz HDMI 2.1, Gigabit Ethernet, 100W PD, 3x USB-A",
      "Steam Deck, ROG Ally X, Legion Go S compatible",
      "Not for ROG Xbox Ally/Xbox Ally X"
    ],
    "pros": [
      "4K@120Hz HDMI 2.1, double the refresh rate of most competing docks",
      "Explicit ROG Ally X and Legion Go S compatibility added in this revision",
      "Gigabit Ethernet for lag-free online gaming",
      "Full 100W charging supports ROG Ally's Turbo Mode"
    ],
    "cons": [
      "Explicitly incompatible with ROG Xbox Ally and Xbox Ally X",
      "Higher price than JSAUX's own 5-in-1 model"
    ],
    "bestFor": "1, gigabit ethernet, 100w pd, 3x usb-a"
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0F249TYWY?tag=theofficejournal-20",
    "description": "0 charging with built-in TVS, ESD, and over-current circuit protection.\n\nUGREEN's foldable aluminum alloy and PC+ABS stand design is portable, but explicitly notes it is NOT compatible with Nintendo Switch 2 despite broad handheld support otherwise.",
    "specs": [
      "4K@120Hz HDMI 2.1 with VRR/FreeSync/G-Sync",
      "100W PD 3.0 with TVS/ESD/over-current protection",
      "Foldable aluminum + PC+ABS stand"
    ],
    "pros": [
      "VRR, FreeSync, and G-Sync support for tear-free gaming on compatible displays",
      "Built-in circuit protection (TVS, ESD, over-current) for safety",
      "Foldable stand design doubles as a handheld holder",
      "Plug-and-play across Windows, macOS, Linux, and SteamOS"
    ],
    "cons": [
      "Explicitly not compatible with Nintendo Switch 2",
      "Gigabit Ethernet only, not multi-gig"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0B28PCDM2?tag=theofficejournal-20",
    "description": "1 output, 100W PD charging, and reliable wired Ethernet.\n\nSame handheld compatibility as the 6-in-1 (Steam Deck, ROG Ally/Ally X, Legion Go/Go S), excluding ROG Xbox Ally, at a notably lower price point.",
    "specs": [
      "4K@120Hz HDMI 2.1, Gigabit Ethernet, 100W PD, 2x USB-A 2.0",
      "Same handheld compatibility as JSAUX 6-in-1",
      "Lower price than the 6-in-1 model"
    ],
    "pros": [
      "Same 4K@120Hz HDMI 2.1 output as the pricier 6-in-1 model",
      "Lower price point for buyers who don't need the extra USB-A port speed",
      "Reliable wired Ethernet with low-latency performance",
      "Full 100W PD charging support"
    ],
    "cons": [
      "USB-A ports downgraded to 2.0 speed versus the 6-in-1's 3.0 ports",
      "Explicitly incompatible with ROG Xbox Ally/Xbox Ally X"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CS6BWL4Q?tag=theofficejournal-20",
    ...
    "specs": [
      "4K@60Hz HDMI, 1Gbps Ethernet, 100W PD-IN, 3x 5Gbps USB",
      "Built-in 220mm USB-C cable",
      "18-month warranty"
    ],
    "pros": [
      "Built-in cable means nothing extra to carry for handheld gaming setups",
      "1,000 Mbps Ethernet specifically positioned for competitive online play",
      "Backed by Anker's established warranty and support",
      "All three USB ports run at a full 5Gbps"
    ],
    "cons": [
      "4K@60Hz HDMI, not the 120Hz some competing docks offer",
      "USB-C data port explicitly does not support screen mirroring"
    ],
...
export const breadcrumbLabel = "Best USB-C Ethernet Adapters for Steam Deck";
