...
export const guideTitle = "The Best Floating Shelves for Home Office: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "7 Inch) is worth checking against your actual stud spacing before assuming its full rated capacity applies."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "7 Inch) justifies the extra cost."
      },
      {
        "label": "",
...
export const metaDescription = "A practical comparison of 8 floating shelves for home office, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Floating Shelves for Home Office (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "7 Inch) is the top-tier pick in this comparison. Don't worry about cluttered desktops and floors! Wood grain finish mdf shelves can help make the most of empty walls, save space while making your room look neater and more rustic.\n\n18 inches is what tips the choice one way or the other.\n\nThis fits best if you are willing to spend the most in this comparison for the fuller feature set that comes with it. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    "specs": [
...
export const breadcrumbLabel = "Best Floating Shelves for Home Office";
