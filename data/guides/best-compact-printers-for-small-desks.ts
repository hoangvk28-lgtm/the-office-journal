...
export const faq = [
  ...
  },
  {
    ...
    "a": "Every pick in this list supports Letter and A4 paper sizes only, with no legal or tabloid support. If you occasionally need to print larger documents, plan to use a print shop or a different printer for those jobs rather than expecting a compact printer to cover it."
  },
  {
    "q": "Is first-time wireless setup difficult on these printers?",
    "a": "Canon and HP models pair through their respective mobile apps (Canon PRINT, HP Smart), which typically involves creating an account, connecting to wifi, and running a test print, usually about 10 minutes for a first-time setup. The inkless thermal printer pairs over Bluetooth directly and tends to be the fastest to get running."
  },
  {
...
export const guideTitle = "The Best Compact Printers for Small Desks: Our Picks";
...
export const metaDescription = "How 8 compact printers for small desks compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Compact Printers for Small Desks (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      "compact footprint for a full AIO",
      "Auto duplex printing built in",
  ...
  },
  {
    ...
    "description": "The PIXMA TS3720 strips things down to the basics: print, copy, scan, and wireless connectivity in a small, no-frills body built for basic home printing rather than heavier document workflows. It's the cheapest full all-in-one in this list, which makes it a sensible pick if you print occasionally and don't need an ADF, a screen, or duplex printing.\n\nJust budget for more frequent refills given its small tray, and expect basic single-sided printing rather than automatic duplex.\n\nOne of the smallest footprints here.",
    "specs": [
  ...
  },
  {
    ...
    "pros": [
      ...
      "portable for travel or car use",
...
export const breadcrumbLabel = "Best Compact Printers for Small Desks";
