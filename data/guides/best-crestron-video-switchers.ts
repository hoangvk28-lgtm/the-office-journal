...
export const introParagraphs = [
  "Best Crestron Video Switchers look similar but differ in practice, so the spec sheet hides real gaps.",
...
export const heroImage = "https://m.media-amazon.com/images/I/410TrnYtmtL._SL500_.jpg";
...
export const products: GuideProduct[] = [
  {
    id: "best-crestron-video-switchers-1",
    rank: 1,
    badge: "Best Overall",
    name: "CRESTRON DM-RMC-Scaler-C Digital Media",
    price: "$298.00",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/410TrnYtmtL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B07ZWD715N?tag=theofficejournal-20",
    description: "CRESTRON DM-RMC-Scaler-C Digital Media is the top pick in this comparison. Rcvr & room ctrl w/scaler.\n\nSet next to Crestron DM-RMC-4K-Scaler-C, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nChoose this if you want the strongest all-around pick in this comparison and would rather not keep shopping around. Input count fills up faster than expected once cameras, overlays, and playback sources are all counted, so plan with real margin.",
    specs: ["Rcvr & room ctrl w/scaler"],
    pros: ["Rcvr & room ctrl w/scaler", "Straightforward setup based on the listed specs", "Covers the core feature set for this category"],
  ...
  {
    id: "best-crestron-video-switchers-2",
    rank: 2,
    badge: "Also Worth Considering",
    name: "Crestron DM-RMC-4K-Scaler-C",
    price: "$328.54",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41EgsPGzR2L._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B0F8W8PD3R?tag=theofficejournal-20",
    description: "Crestron DM-RMC-4K-Scaler-C is a strong alternative worth comparing directly against the top pick.\n\nAgainst CRESTRON DM-RMC-Scaler-C Digital Media, neither pick has an obvious edge on paper, so the deciding factor comes down to whichever spec matters most for your specific use case.\n\nThis one is the right call if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. NDI routing adds real network bandwidth and latency considerations, so plan your network setup before assuming NDI just works out of the box.",
    specs: ["Dm-rmc-4K-scaler-c"],
    pros: ["Dm-rmc-4K-scaler-c", "Straightforward setup based on the listed specs", "Covers the core feature set for this category"],
  ...
  {
    id: "best-crestron-video-switchers-3",
    rank: 3,
    badge: "Solid Alternative",
    name: "CRESTRON DM-TX-201-C 10/100 MBPS ETHERNET",
    price: "$317.18",
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/31WmmWVxarL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B07GZG1XQH?tag=theofficejournal-20",
    description: "CRESTRON DM-TX-201-C 10/100 MBPS ETHERNET is a strong alternative worth comparing directly against the top pick.\n\nCRESTRON DM-RMC-Scaler-C Digital Media is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Input count fills up faster than expected once cameras, overlays, and playback sources are all counted, so plan with real margin.",
    specs: ["10/100 mbps ethernet", "2 channel stereo"],
    pros: ["10/100 mbps ethernet", "2 channel stereo", "Straightforward setup based on the listed specs"],
    cons: ["Input count fills up fast with cameras plus overlays", "NDI routing adds real network bandwidth demands"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-crestron-video-switchers-4",
    rank: 4,
    badge: "Best Value",
    ...
    description: "RGBlink Mini V3 Video Switcher with Customizable Features via TAO Cloud, 4K is the most affordable pick here that still clears the capability floor for this category. Flexible tao cloud activation, unlock premium functions via monthly or lifetime plans (not exceeding $100 total lifetime cost). Step for activation, upgrade your mini v3 to the lastest frimware before use.\n\nThe gap between this and CRESTRON DM-RMC-Scaler-C Digital Media isn't in the essentials, it shows up in compact 4K video switcher, mini v3 features 4× HDMI inputs, 2 x1080p HDMI output, a 2.1\" touch screen, and professional t-bar control, making it the ideal video switcher for live streaming and multi-cam productions.\n\nChoose this if you want a genuinely capable pick without paying for headroom you won't use. NDI routing adds real network bandwidth and latency considerations, so plan your network setup before assuming NDI just works out of the box.",
  ...
  {
    id: "best-crestron-video-switchers-5",
    rank: 5,
  ...
  {
    id: "best-crestron-video-switchers-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-crestron-video-switchers-7",
    rank: 7,
  ...
  {
    id: "best-crestron-video-switchers-8",
    rank: 8,
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "CRESTRON DM-RMC-Scaler-C Digital Media"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "HDMI (e.g. RGBlink Mini V3 Video Switcher with Customizable Features via TAO Cloud, 4K)",
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "CRESTRON DM-RMC-Scaler-C Digital Media is worth checking against its specific ISO recording spec before assuming any switcher supports it."
      }
    ]
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "You're running a simple 2-3 camera setup, where RGBlink Mini V3 Video Switcher with Customizable Features via TAO Cloud, 4K already covers the job at the lowest price here."
      }
    ]
  }
];
