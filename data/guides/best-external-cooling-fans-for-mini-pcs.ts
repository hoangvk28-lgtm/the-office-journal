...
export const faq = [
  {
    "q": "Who needs an external cooling fan for a Mini PC?",
    "a": "It's most relevant for a Mini PC that runs hot during sustained workloads and you'd rather not open or modify, often because it's under warranty or the chassis is difficult to service."
  },
  {
    "q": "Is an external fan better than replacing the internal fan?",
    "a": "External cooling is reversible and requires no disassembly, while an internal repair may address the root cause when the built-in fan or heatsink system is failing."
  },
  {
    "q": "Can I point any of these fans anywhere at the Mini PC?",
    "a": "Aim airflow at an intake or help exhaust escape. Blowing onto a closed panel can move a lot of air without meaningfully improving internal cooling."
  },
  {
    "q": "Will an external fan make the setup much louder?",
    "a": "It can, since the Mini PC's own internal fan and the external fan may run at the same time. Picks with a published DBA rating, like the GSCOLER X1 at 18dB, give you a way to estimate the added noise beforehand."
  },
  {
    "q": "How is this different from the general Mini PC cooling fans guide?",
    "a": "The general guide covers standalone fan products broadly. This guide specifically addresses external supplemental cooling for sealed or non-serviceable Mini PCs, and includes one purpose-built mount not covered there."
  }
];

export const guideSlug = "best-external-cooling-fans-for-mini-pcs";

export const guideTitle = "The Best External Cooling Fans for Mini PCs, Compared";
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "We compared whether each product can add useful cooling without opening or modifying the Mini PC chassis."
  },
  {
    "title": "",
    "description": "We compared fan placement and direction against typical Mini PC vent layouts, favoring documented CFM figures where available."
  },
  {
    "title": "Noise for shared or quiet spaces",
    "description": "We compared available DBA figures and prioritized listings that publish a specific number over vague quiet claims."
  },
  {
    "title": "",
    "description": "We considered fan size, mounting options, and whether a product needs open desk space or fits tight gaps around a sealed chassis."
  }
];
...
export const metaDescription = "We compared 7 external cooling fans for mini PCs on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best External Cooling Fans for Mini PCs (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "This is the one product in this guide actually built as an external cooling accessory rather than a repurposed general fan, a wall, under-desk, or monitor-back mount for Mac mini with airflow structure built into the design. It requires no disassembly of the Mac mini itself, exactly the sealed-case use case this guide targets.\n\nPurpose-built external cooling accessory, not a repurposed general fan. On price, it's actually priced above Wathai Cooling Case Fan, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Mounted location may be less convenient to access for cleaning.",
    "specs": [
      "Aluminum alloy, wrap-around design",
      "VESA 75mm and 100mm compatible",
      "Wall, under-desk, or monitor-back mounting",
      "Includes USB 1.1 hub"
    ],
    "pros": [
      "Purpose-built external cooling accessory, not a repurposed general fan",
      "No disassembly of the Mac mini required",
      "VESA compatible for monitor arm integration",
      "Removes the Mini PC from the desk surface entirely"
    ],
    "cons": [
      "Only fits Mac mini 2010-2023 M2 generation",
      "Highest price in this guide",
      "Mounted location may be less convenient to access for cleaning"
    ],
  ...
  },
  {
    ...
    "description": "7 CFM airflow and 23 DBA noise rating. It sits external to any chassis by design, simply placed near the vent you want to target.\n\nOn the other side, Fixed single speed, no adjustment.",
    "specs": [
    ...
    "pros": [
      ...
      "Mounting hardware included for a semi-permanent setup"
    ],
    "cons": [
      "Not purpose-built for external Mini PC mounting specifically",
      "120mm size needs more desk clearance",
      "Fixed single speed, no adjustment"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Adjustable speed for varying workload intensity",
      "Anti-vibration feet reduce desk noise",
      "Metal grille adds physical protection",
      "Highest star rating in this guide"
    ],
    "cons": [
      "Very small review sample size",
      "No published CFM or DBA figures for direct comparison",
      "Long cable can add clutter if not routed carefully"
    ],
  ...
  },
  {
    ...
    "pros": [
      "Two fans for intake and exhaust placement at once",
      "Higher max RPM than several single-fan picks",
      "Anti-vibration feet on each unit",
      "Good value for two fans"
    ],
    "cons": [
      "No specific CFM or DBA figures published",
      "Managing two external fans means more desk cable clutter",
  ...
  },
  {
    ...
    "pros": [
      "Fits tight external gaps a 120mm fan physically can't",
      "Dual fans target two spots at once",
      "3-speed adjustability"
    ],
    "cons": [
      "Lower airflow volume than 120mm alternatives",
      "Audible at higher speeds per the listing",
  ...
  },
  {
    ...
    "pros": [
      ...
      "Specific CFM and DBA figures published",
      "Flexible flat or upright placement"
    ],
    "cons": [
      "Lower total airflow than the 120mm options here",
      "Best suited to smaller Mini PC chassis given its size",
      "Single fan versus dual-fan alternatives at a similar price"
    ],
...
export const breadcrumbLabel = "Best External Cooling Fans for Mini PCs";
