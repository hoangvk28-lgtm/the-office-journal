...
export const guideTitle = "The Best Battery-Powered Space Heaters for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "Heater 9,000 BTU Portable Buddy Radiant Propane Heater"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Odorkle Cordless Space Heater 200W 360° Rotatable not included battery)",
...
export const metaDescription = "We compared 8 battery-powered space heaters on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Battery-Powered Space Heaters for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Immediately heating and silence working",
      "Resist to deformation in high temperature",
      "Rotatable support to get an appropriate supporting angle"
    ],
    "pros": [
      "Immediately heating and silence working",
      "Resist to deformation in high temperature",
      "Rotatable support to get an appropriate supporting angle",
      "Safe disconnect-type power supply"
    ],
    "cons": [
      "Coverage claims assume a well-insulated, average-height room",
      "Running at full wattage all day adds up on the electric bill"
...
export const breadcrumbLabel = "Best Battery-Powered Space Heaters";
