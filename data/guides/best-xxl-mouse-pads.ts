...
export const guideTitle = "The Best XXL Mouse Pads for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "ASUS ROG Sheath II XXL Gaming Mouse Pad)",
...
export const metaDescription = "How 8 XXL mouse pads compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best XXL Mouse Pads for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "Enhanced heat dissipation and improved cooling efficiency",
      "Soft cloth surface",
  ...
  },
  {
    ...
    "specs": [
      "Large mouse pad with size 48\" x 24\"(120x60cm)",
      "Superior materil",
...
export const breadcrumbLabel = "Best XXL Mouse Pads";
