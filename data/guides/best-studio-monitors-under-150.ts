...
export const guideTitle = "6 Best Studio Monitors Under $150 in 2026";
export const metaTitle = "Best Studio Monitors Under $150 in 2026";
export const metaDescription = "We compared best studio monitors under $150 by verified current price and real capability, not just the price ceiling alone.";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  {
    "subheading": "M-AUDIO BX3 3.5\" vs Silver Black 5-Inch",
    "cards": [
      {
    ...
    "note": "Most buyers should default to M-AUDIO BX3 3.5\" Wired Studio Monitors Pair unless your specific use case points toward Silver Black 5-Inch Active Studio Monitor by KRK's particular tradeoffs."
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-studio-monitors-under-100","title":"Best Studio Monitors Under $100"},{"href":"/guide/best-studio-monitors-under-200","title":"Best Studio Monitors Under $200"},{"href":"/guide/best-studio-monitors-under-300","title":"Best Studio Monitors Under $300"}];
