...
export const faq = [
  {
    "q": "How is a PC tower holder different from a general under-desk PC mount?",
    "a": "It's largely the same category, this guide focuses specifically on vertical tower-orientation holders and carries forward the weight-capacity and rear-IO findings from our broader pillar guide rather than re-deriving them."
  },
  {
    "q": "Should I get an adjustable-width or fixed-width tower holder?",
    "a": "Adjustable width offers more flexibility if you might change cases later, fixed width gives a snugger fit but only within its specific dimensions, measure your case first."
  },
  {
    "q": "Does a mounted PC tower get bumped a lot under the desk?",
    "a": "More often than most buyers expect, a vertical tower commonly sits at knee or foot level, favor a holder with secure locking or use height adjustment to reposition it away from your usual leg space."
  },
  {
    "q": "Is this guide different from your horizontal PC mount guide?",
    "a": "Yes, this guide focuses specifically on vertical tower orientation, see our dedicated horizontal-mount guide if you're considering that orientation instead."
  }
];

export const guideSlug = "best-under-desk-pc-tower-holders";

export const guideTitle = "The Best Under-Desk PC Tower Holders for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to VIVO Black Under Desk and Wall Office PC Mount unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "Vertical tower orientation distinguished from our horizontal guide",
    "description": "Focused specifically on vertical tower-orientation holders, carrying forward our pillar guide's weight-capacity, rear-IO access, and thermal findings rather than re-deriving them, and kept distinct from our separate horizontal-mount guide."
  },
  {
    "title": "Tower height and width compatibility verified",
    "description": "Verified specific tower height and width compatibility ranges, since 'tower holder' implies a purpose-built fit for standard upright dimensions rather than the pillar guide's more general-purpose framing."
  },
  {
    "title": "Adjustable-width versus fixed-width flexibility compared",
    "description": "Compared adjustable-width designs against fixed-width holders as a genuine flexibility differentiator for buyers who may change cases later."
  },
  {
    "title": "Bump resistance against incidental contact weighed",
    "description": "Weighed impact resistance against incidental bumping, since a mounted vertical tower in this position gets accidentally contacted by a knee or foot during normal desk use more often than expected."
  }
];
...
export const metaDescription = "A practical comparison of 4 under-desk PC tower holders, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Under-Desk PC Tower Holders for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "As with our broader pillar guide's findings, verify your specific tower's loaded weight against the rated capacity, and check that your case orientation faces rear ports in a reachable direction once mounted vertically.",
    "specs": [
      "Vertical tower orientation",
      "Adjustable width fit",
      "Budget price"
    ],
    "pros": [
      "Adjustable width covers most standard upright mid-towers",
      "low-cost price",
      "Simple, proven bracket design"
    ],
    "cons": [
      "Verify loaded tower weight against rated capacity per our pillar guide's findings",
      "Positioned near knee or foot level, worth checking bump exposure",
      "Rear-IO access still needs planning before installation"
    ],
  ...
  },
  {
    ...
    "description": "A 66-pound rated capacity with adjustable width and secure locking, purpose-built for a heavier vertical tower rather than the horizontal-orientation designs covered in our separate horizontal mount guide.\n\nThe locking mechanism adds real resistance against incidental bumps, a genuine benefit for a vertical holder positioned where a knee or foot commonly makes accidental contact during normal desk use.\n\nSecure locking adds real bump resistance.",
    "specs": [
      "Vertical tower orientation, up to 66 lbs",
      "Secure locking mechanism",
      "Adjustable width",
      "Mid-range price"
    ],
    "pros": [
      "66lb capacity for a heavier upright tower",
      "Secure locking adds real bump resistance",
      "Adjustable width fits varied vertical tower sizes"
    ],
    "cons": [
      "Higher price than the most basic holders",
      "Locking mechanism adds a small extra installation step",
      "Verify rear-IO reach for your specific vertical orientation"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0C98RW5D7?tag=theofficejournal-20",
    "description": "A fixed-width 17-inch design purpose-built for small form factor vertical towers, appropriate for buyers wanting a holder specifically sized rather than a general adjustable range that may fit loosely on a smaller case.\n\nFixed-width compatibility is more restrictive than an adjustable design, verify your case's exact height and width fall within this holder's dimensions before ordering, since it won't accommodate a full-tower case.",
    "specs": [
      "Fixed 17-inch design",
      "Small form factor specific",
      "Mid-range price"
    ],
    "pros": [
      "Purpose-built fixed-width fit for small form factor towers",
      "Snugger, more secure fit than an oversized adjustable holder",
      "Compact footprint under the desk"
    ],
    "cons": [
      "Fixed width is more restrictive than an adjustable design, verify exact case dimensions first",
      "Not appropriate for a full-tower or mid-tower case",
      "Adjustable-width picks in this guide offer more flexibility if you might change cases"
    ],
  ...
  },
  {
    ...
    "description": "The highest average rating in this guide, this height-adjustable vertical tower holder carries a 66-pound capacity in a compact footprint, appropriate for buyers wanting the strongest available rating on a standard upright tower.\n\nHeight adjustment lets you position the tower to minimize accidental knee or foot contact during normal desk use, a genuine bump-resistance consideration worth using deliberately rather than mounting at a fixed default height.\n\nHeight adjustment allows positioning to reduce bump exposure.",
    "specs": [
      "Height adjustable, up to 66 lbs",
    ...
    "pros": [
      ...
      "Height adjustment allows positioning to reduce bump exposure",
      "66lb capacity suits most standard vertical towers",
      "Compact footprint despite the adjustability"
    ],
    "cons": [
      "Verify rear-IO access for your specific mounted height",
      "Not sized for the largest full-tower cases"
    ],
...
export const breadcrumbLabel = "Best Under-Desk PC Tower Holders";
