...
export const guideTitle = "The Best Varjo VR Headsets for Everyday Desk Work";
...
export const metaDescription = "How 6 varjo VR headsets compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Varjo VR Headsets for Home Offices (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-4k-vr-headsets",
    "title": "Best 4K VR Headsets in 2026"
  }
];

export const breadcrumbLabel = "Best Varjo VR Headsets";
