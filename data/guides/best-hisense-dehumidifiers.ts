...
export const products: GuideProduct[] = [
  {
    ...
    description: "Hisense 50-Pint Portable Dehumidifier. 4500 Sq. Ft. is the top pick in this comparison. Three modes, auto, continuous, and manual, give you precise control over moisture removal to match the exact needs of your space. Three fan speeds, high, low, and auto, let you balance moisture removal intensity with noise preference for maximum everyday comfort.\n\nHeld up against Hisense 50-Pint Lift-Up Portable Dehumidifier with Built-In Pump, both cover the basics equally well, what actually separates them is low-temperature operation down to 38°f keeps this unit running effectively in basements and crawl spaces where moisture tends to linger.\n\nGo with this pick if you want the strongest all-around pick in this comparison and would rather not keep shopping around. The tank needs regular emptying unless you're running a continuous drain hose or pump, so factor that into daily upkeep before buying.",
    specs: ["Tackle whole-home humidity on your terms", "Fine-tune airflow to suit your environment", "Protect cooler spaces all year round"],
    pros: ["Tackle whole-home humidity on your terms", "Fine-tune airflow to suit your environment", "Protect cooler spaces all year round", "Avoid overflow without the worry"],
  ...
  },
  {
    ...
    description: "Hisense 35 Pint 3,000 sq. ft. Portable Dehumidifier is a strong alternative worth comparing directly against the top pick. Hisense 35 pint portable dehumidifier designed for areas up to 3,000 sq. Operates efficiently at low temperatures, effective in environments as cool as 38f.\n\nThe gap between this and Hisense 50-Pint Portable Dehumidifier. 4500 Sq. Ft. isn't in the essentials, it shows up in features an easy slide-out bucket for hassle-free emptying - (note: the optional \"drainage hose\" is not included with this specific model dehumidifier.).\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The tank needs regular emptying unless you're running a continuous drain hose or pump, so factor that into daily upkeep before buying.",
    specs: ["Restored product", "Low temperature operation", "Easy-empty bucket"],
    pros: ["Restored product", "Low temperature operation", "Easy-empty bucket", "Washable filter"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
  ...
  },
  {
    ...
    description: "Hisense 25-Pint Compact Portable Dehumidifier is a strong alternative worth comparing directly against the top pick. Straightforward manual controls make this 25 pint dehumidifier easy for anyone to operate without a learning curve or complicated setup. Press the minus button until 'co' flashes and the unit runs uninterrupted, giving you hands-free moisture control whenever you need it.\n\nHisense 50-Pint Portable Dehumidifier. 4500 Sq. Ft. covers similar ground, though low-temperature operation down to 38°f keeps this unit effective in basements and crawl spaces where moisture is most persistent is what tips the choice one way or the other.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The tank needs regular emptying unless you're running a continuous drain hose or pump, so factor that into daily upkeep before buying.",
    specs: ["Manage humidity simply and reliably", "Run continuously without the hassle", "Protect your home in cooler spaces too"],
    pros: ["Manage humidity simply and reliably", "Run continuously without the hassle", "Protect your home in cooler spaces too", "Operate quietly in any room"],
    cons: ["Tank needs regular emptying unless drained continuously", "Coverage claims assume ideal conditions, not always real rooms"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          ...
          "Hisense 50-Pint Portable Dehumidifier. 4500 Sq. Ft."
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Continuous drain (e.g. Hisense 50-Pint Portable Dehumidifier. 4500 Sq. Ft.)",
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "Hisense 50-Pint Portable Dehumidifier. 4500 Sq. Ft. is worth checking against its specific auto-restart and humidistat spec before assuming any unit handles unattended operation well."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        "label": "Spend more if",
        "text": "You're covering a large or genuinely wet space and want a built-in pump and higher capacity, where Hisense 50-Pint Lift-Up Portable Dehumidifier with Built-In Pump justifies the extra cost."
      },
      {
        "label": "Save if",
