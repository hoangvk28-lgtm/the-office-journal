...
export const guideSlug = "best-cinema-projectors";

export const guideTitle = "The Best Cinema Projectors for Everyday Desk Work";
...
export const introParagraphs = [
  "Best Cinema Projectors aren't all built the same way, so a glance won't reveal the gap.",
  "Every pick here was judged on real contrast and lumens data, because this predicts real picture quality."
];

export const lastUpdated = "2026-08-31";

export const mainKeyword = "cinema projector";

export const metaDescription = "How 8 cinema projectors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Cinema Projectors for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-cinema-projectors-1",
    "rank": 1,
    "badge": "Best Overall",
...
export const breadcrumbLabel = "Best Cinema Projectors";
