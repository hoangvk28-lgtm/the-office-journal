...
export const products: GuideProduct[] = [
  {
    ...
    description: "QEEIG Bathroom Floating Shelves for Wall (Brown, Set of 2, 15.7\") is our overall pick in this lineup. Medium density fiberboard (mdf). Enhanced steel brackets, up to 25 lbs capacity, 2.5° upward angle keeps items steady and sag-free.\n\nBring farmhouse charm to unused wall areas above toilet, desks, fireplaces, or vanities, a detail worth checking closely before choosing between this and QEEIG Bathroom Shelves Over Toilet Wall Mounted (Brown, Set of 3, 15.7\").\n\nThis fits best if you want the strongest all-around pick in this comparison and would rather not keep shopping around. A standard drywall anchor alone safely holds only 10 to 25 lbs, so anything heavier needs to land on a wall stud or a toggle bolt rated for more weight.",
  ...
  },
  {
    ...
    description: "QEEIG Bathroom Shelves Over Toilet Wall Mounted (Brown, Set of 3, 15.7\") is a strong alternative worth comparing directly against the top pick. Medium density fiberboard, outlasts wood in damp bathroom environments. Holds 25 lbs without wobbling or sagging, thanks to strong steel brackets.\n\nFarmhouse charm for any room, show off plants, collectibles and knick-knacks, a detail worth checking closely before choosing between this and QEEIG Bathroom Floating Shelves for Wall (Brown, Set of 2, 15.7\").\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    specs: ["Medium density fiberboard, outlasts wood in damp bathroom environments", "Ample depth", "Sturdy support"],
    pros: ["Medium density fiberboard, outlasts wood in damp bathroom environments", "Ample depth", "Sturdy support", "Easy assembly"],
  ...
  },
  {
    ...
    description: "Amada Bathroom Shelves with Storage Basket is a strong alternative worth comparing directly against the top pick. Our floating shelves are crafted from 100% paulownia wood with a fine wood grain and attractive finish. The amada bathroom shelves features a 16.5′′ l x 5.9′′ w x 5.5′′ h storage basket on the bottom that can hold up to 22 lbs.\n\nQEEIG Bathroom Floating Shelves for Wall (Brown, Set of 2, 15.7\") lands in a similar spot overall, but the deciding factor between the two is with heavy-duty metal brackets, each wood bathroom shelf can hold up to 22 lbs.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. The shelf's own build quality matters less than what it's anchored into, a beautiful solid shelf on drywall anchors alone is a common cause of shelf failure according to mounting-hardware guides.",
    specs: ["Solid paulownia wood", "Wire storage basket", "Maximize bathroom space"],
    pros: ["Solid paulownia wood", "Wire storage basket", "Maximize bathroom space", "Set of 3 wall shelves"],
    cons: ["Real weight capacity depends on stud spacing, not the shelf itself", "Drywall anchors alone only safely hold up to 20 to 25 lbs"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    ...
    description: "Meangood Floating Shelves Wall Mounted Set of 2 is a strong alternative worth comparing directly against the top pick. Made of real solid wood and metal, the industrial look is simple and modern. In the bathroom, the storage shelf can hold skincare items such as shampoo, conditioner, shower gel, lotions, and perfumes.\n\nHeld up against QEEIG Bathroom Floating Shelves for Wall (Brown, Set of 2, 15.7\"), both cover the basics equally well, what actually separates them is the overall structure is very stable and durable.\n\nGo with this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A standard drywall anchor alone safely holds only 10 to 25 lbs, so anything heavier needs to land on a wall stud or a toggle bolt rated for more weight.",
    specs: ["Rustic wood shelves", "Versatile wall shelf", "Sturdy & durable"],
    pros: ["Rustic wood shelves", "Versatile wall shelf", "Sturdy & durable", "Easy installation"],
    cons: ["Drywall anchors alone only safely hold up to 20 to 25 lbs", "Real weight capacity depends on stud spacing, not the shelf itself"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
...
export const howToChoose: HowToChooseSection[] = [
    ...
    "table": {
      ...
      "rows": [
        [
          ...
          "QEEIG Bathroom Shelves Over Toilet Wall Mounted (Brown, Set of 3, 15.7\")"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Stud-mounted (e.g. WOPITUES Floating Shelves for Wall with Cube Shelf)",
        "text": "Highest weight capacity, but requires drilling into a wall stud."
      },
      {
        "label": "No-drill (e.g. QEEIG Bathroom Shelves Over Toilet Wall Mounted (Brown, Set of 3, 15.7\"))",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "Save if",
        "text": "You're displaying light decorative items only, where QEEIG Bathroom Shelves Over Toilet Wall Mounted (Brown, Set of 3, 15.7\") already covers the job at the lowest price here."
      }
    ]
  }
];
