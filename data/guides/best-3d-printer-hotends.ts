...
export const guideTitle = "The Best 3D Printer Hotends for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Creality Ender 3 Hotend Kit with Capricorn PTFE Tube and Nozzles)",
...
export const metaDescription = "A practical comparison of 6 3D printer hotends, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 3D Printer Hotends for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "1: 100% Creality original upgraded kit: includes a pre-assembled",
      "2: Wide compatibility with creality models: fully compatible with creality ender 3 series",
      "3: Premium materials and optimized design: the capricorn bowden ptfe tube features high lubricity additives"
    ],
    "pros": [
      "1: 100% Creality original upgraded kit: includes a pre-assembled",
      "2: Wide compatibility with creality models: fully compatible with creality ender 3 series",
      "3: Premium materials and optimized design: the capricorn bowden ptfe tube features high lubricity additives",
      "4: Comprehensive accessories for enhanced performance: this kit"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "specs": [
      "Official hotend kit for ender 3 v3 se/ke",
      "Up to 600 mm/s high-speed printing: ender 3 v3",
      "Updated quick-swap nozzle kit"
    ],
    "pros": [
      "Official hotend kit for ender 3 v3 se/ke",
      "Up to 600 mm/s high-speed printing: ender 3 v3",
  ...
  },
  {
    ...
    "specs": [
      "Compatible for creality ender 3 v2 neo",
      "Heating tube and temperature thermistor that from control box",
    ...
    "pros": [
      ...
      "Heating tube and temperature thermistor that from control box",
      "Mk8 extruder hot end kit",
      "Upgrade extruder assembled mk8 hot end kit with capricorn ptfe bowden tubing"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const breadcrumbLabel = "Best 3D Printer Hotends";
