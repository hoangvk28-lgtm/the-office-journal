...
export const guideTitle = "The Best Inkjet Printers for Home Use: Picks and Trade-offs";
...
export const introParagraphs = [
  "Inkjet covers a wider range of products than most guides admit, from basic cartridge printers under $70 to ink-tank supertanks built for households that print several hundred pages a month. We compared 8 inkjet printers across both categories, since the right one depends heavily on how often you print, not just the sticker price.",
...
export const metaDescription = "A practical comparison of 8 inkjet printers for home use, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Inkjet Printers for Home Use (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "A compact cartridge inkjet built for homes without a dedicated office nook, with duplex printing that flips pages automatically instead of requiring a manual reload. Built-in copier and scanner cover the basics without adding a second device.\n\nIt's a standard dye-based cartridge printer, so the same nozzle-drying maintenance applies as any inkjet in this list: a weekly test page or a nozzle check after 2+ weeks idle keeps print quality consistent.",
    "specs": [
  ...
  },
  {
    ...
    "description": "42-inch OLED display and a more intuitive control panel, useful when more than one person in the household uses the printer and needs a quick, legible menu. Duplex printing and a compact design carry over from the rest of the PIXMA lineup.\n\nIt remains a standard cartridge inkjet, so the same idle-ink math applies as the rest of this list: it's most cost-effective printing well under 100 pages a month rather than sustained daily use.",
    "specs": [
  ...
  },
  {
    ...
    "description": "The PIXMA TR4720 pairs a budget price with an auto document feeder and built-in fax, features usually reserved for pricier office printers. That combination suits households that occasionally scan or fax multi-page documents, like signed forms or school paperwork.\n\nAs a standard cartridge inkjet, it carries the same idle-ink drying consideration as any dye-based printer: expect the occasional wasted cleaning cycle if it sits unused for weeks between print jobs.",
    "specs": [
  ...
  },
  {
    ...
    "description": "Identical hardware and ink-tank engine to the black ET-2800 above, offered here in a white finish for households that prefer it to match their desk or home office decor. The cost-per-page and maintenance profile are the same as the black version.\n\nWe list both finishes separately since color choice is a genuine factor for some buyers, but the underlying printer, ink system, and idle-ink guidance are identical to the black model.",
    "specs": [
      "Cartridge-free ink-tank engine",
      "Wireless print, scan, copy",
      "Bottle refill system",
  ...
  },
  {
    ...
    "description": "A slightly cheaper ink-tank model than the ET-2800, aimed at everyday home printing rather than heavier document scanning needs, with print, scan, and copy but a simpler feature set overall. It's still a genuine ink-tank printer, not a cartridge model.\n\nFor households comparing a budget laser against an ink-tank printer at low-to-moderate volume, this is one of the more accessible ink-tank entry points, and it avoids the cartridge idle-drying issue that affects every non-tank pick in this list.\n\nNo cartridges to buy or replace.",
    "specs": [
      "Cartridge-free ink-tank engine",
      "Wireless print, scan, copy",
  ...
  },
  {
    ...
    "description": "It's the lowest-priced genuine ink-tank printer in this roundup.\n\n4GHz only, worth checking against your router setup before buying if you rely on a 5GHz network band.\n\n4GHz-only wireless, no 5GHz band.",
    "specs": [
      "Cartridge-free ink-tank engine",
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-color-laser-printers-for-home-offices",
    "title": "Best Color Laser Printers for Home Offices (2026)"
  },
  {
    "href": "/guide/best-printers-for-small-spaces",
    "title": "Best Printers for Small Spaces (2026)"
  }
];

export const breadcrumbLabel = "Best Inkjet Printers for Home Use";
