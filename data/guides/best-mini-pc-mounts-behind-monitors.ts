...
export const faq = [
  {
    "q": "Will this conflict with my monitor arm?",
    "a": "Check the specific product, several here are designed to coexist with a monitor arm or stand sharing the same VESA holes, but verify before assuming compatibility."
  },
  {
    "q": "Is there a Dell-specific behind-monitor mount?",
    "a": "Yes, the VIVO Behind Monitor Mini PC VESA Mount is explicitly designed for Dell OptiPlex Micro."
  },
  {
    "q": "Is there an Intel NUC-specific option?",
    "a": ""
  },
  {
...
export const guideTitle = "The Best Mini PC Mounts Behind Monitors for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Confirmed behind-monitor placement as a stated design purpose",
    "description": "We required each pick to explicitly support behind-monitor or behind-display mounting, not just general VESA compatibility adapted after the fact."
  },
  {
    "title": "VESA-hole conflict with monitor stands or arms considered",
    "description": "We noted where a product's design specifically addresses coexisting with a monitor arm or stand sharing the same VESA holes."
  },
  {
    "title": "Brand-specific options included where they exist",
    "description": "We included Dell OptiPlex Micro and Intel NUC-specific mounts alongside universal options, since purpose-built products often fit more precisely."
  },
  {
...
export const metaDescription = "We compared 5 mini PC mounts behind monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Mini PC Mounts Behind Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "On price, it's actually priced above VIVO Behind Monitor Mini PC VESA Mount Designed for Dell OptiPlex Micro, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Higher price than the budget options.",
    "specs": [
      "Fits 0.65-2.55 in device depth",
      "75x75 and 100x100mm VESA"
    ],
    "pros": [
      "Explicitly supports monitor-arm compatibility"
    ],
    "cons": [
  ...
  },
  {
    ...
    "specs": [
      "Designed for Dell OptiPlex Micro",
      "Behind-monitor VESA mount"
    ],
    "pros": [
      "Highest rating in this comparison",
      "Explicitly designed for Dell OptiPlex Micro"
    ],
    "cons": [
      "Smaller review base, though the rating is strong"
    ],
  ...
  },
  {
    ...
    "description": "The real tradeoff against that pick: Intel NUC-specific, not a universal fit for other brands.\n\nOn the other side, Intel NUC-specific, not a universal fit for other brands.",
    "specs": [
      "75x75mm VESA, designed for Intel NUC"
    ],
    "pros": [
      "Lowest price in this comparison"
    ],
    "cons": [
      "Intel NUC-specific, not a universal fit for other brands"
    ],
  ...
  },
  {
    ...
    "specs": [
      "Under-desk, wall, monitor-arm, or behind-monitor mount"
    ],
    "pros": [
      "Most mounting-location flexibility in this comparison"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best Mini PC Mounts Behind Monitors";
