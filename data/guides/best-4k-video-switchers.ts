...
export const guideTitle = "The Best 4K Video Switchers for Everyday Desk Work";
...
export const metaDescription = "How 8 4K video switchers compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 4K Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 4K Video Switchers";
