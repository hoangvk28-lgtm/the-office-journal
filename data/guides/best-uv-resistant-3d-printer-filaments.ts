...
export const guideTitle = "The Best UV-Resistant 3D Printer Filaments for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "75mm Deep Black 4KG justifies the extra cost."
      },
      {
        "label": "",
        "text": "75mm Deep Black 1KG already covers the job at the lowest price here."
      }
    ]
  }
];
...
export const metaDescription = "A practical comparison of 6 UV-resistant 3D printer filaments, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best UV-Resistant 3D Printer Filaments for Home Offices (2026)";
...
export const breadcrumbLabel = "Best UV-Resistant 3D Printer Filaments";
