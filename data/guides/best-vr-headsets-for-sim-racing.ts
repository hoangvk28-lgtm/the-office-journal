...
export const guideTitle = "The Best VR Headsets for Sim Racing, Compared";
...
export const metaDescription = "We compared 6 VR headsets for sim racing on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best VR Headsets for Sim Racing (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Immerse yourself deeper into the world of sim racing",
      "Engineered with precision",
      "Tailor your experience with two arm size options"
    ],
    "pros": [
      "Immerse yourself deeper into the world of sim racing",
      "Engineered with precision",
      "Tailor your experience with two arm size options",
      "Embrace a clutter-free environment and discover newfound freedom with our mount's flexible mounting solutions"
    ],
    "cons": [
...
export const breadcrumbLabel = "Best VR Headsets for Sim Racing";
