...
export const guideTitle = "The Best Tascam Audio Interfaces for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Tascam SERIES 102i 10 IN/2 OUT USB Audio Interface with MIDI)",
...
export const metaDescription = "How 8 tascam audio interfaces compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Tascam Audio Interfaces for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "specs": [
      "Two transparent, natural-sounding, ultra-low noise tascam ultra-hdda",
      "One optical s/mux expansion port that accepts",
      "2 ¼-inch analog outputs and dual headphone"
    ],
    "pros": [
      "Two transparent, natural-sounding, ultra-low noise tascam ultra-hdda",
      "One optical s/mux expansion port that accepts",
...
export const breadcrumbLabel = "Best Tascam Audio Interfaces";
