...
export const introParagraphs = [
  "Office-chair comfort starts with dimensions, not cushioning. If the seat can't drop low enough for your feet to rest flat, or rise high enough for your elbows to meet the desk, no amount of mesh or padding will fix the posture that follows.",
...
export const products: GuideProduct[] = [
  {
    ...
    description:
      "The BestOffice chair is here for one reason: it is the lowest-cost way in this guide to get a mesh-back chair with adjustable height, armrests and some lumbar support.\n\nIts seat height range of 15.7 to 19.3 inches runs lower than most chairs in this roundup, which is useful if you are on the shorter side or working at a desk below the usual 29 to 30 inches. The mesh back should stay cooler than a padded one, and BestOffice lists a 250 lb weight capacity.\n\nWhat you give up is adjustment. Lumbar support comes from a cushion rather than an adjustable mechanism, tilt is basic, and there is no headrest. For a few hours a day at a secondary desk, that may be enough. For a full workday, the SIHOO M18 or Hbada gives you considerably more to work with.",
    specs: [
    ...
    cons: [
      ...
      "Build is basic for full-day use",
    ],
    bestFor:
      "A spare or occasional-use desk, or anyone who needs a functional chair for as little money as possible.",
    skipIf:
      "You sit for six or more hours a day; the adjustable lumbar on the SIHOO M18 or Hbada is worth the extra cost.",
  },
  {
    ...
    skipIf:
      "You rest your forearms on the armrests while typing; you'll want height-adjustable arms, like those on the SIHOO M57 or Marsail.",
  },
  {
    ...
    bestFor:
      "People who work long stretches at home and want to recline with their feet up between calls or tasks.",
    skipIf:
      "You sit upright all day and never recline; the SIHOO M18 gives similar back support with fewer moving parts.",
  },
  {
    ...
    description:
      "For most home offices, the SIHOO M18 is the sensible middle ground: adjustable lumbar support, an adjustable headrest and a stated three-year warranty, at less than half the price of the most expensive chair here.\n\nThose three features cover the adjustments that matter most for a full workday. Adjustable lumbar lets you place support where your lower back actually curves, and a headrest helps when you lean back to read or take calls. The warranty is one of only three stated in this guide.\n\nThe armrests are the compromise. They are 2D, with fewer directions of adjustment than the 3D arms on the SIHOO M57 and Marsail. If you type with your forearms resting on the arms, or work at an angle to your desk, that difference is worth paying for.",
    specs: [
      "Seat height: 17.5–21\"",
      "Back: high-back mesh",
      "Lumbar: adjustable",
    ...
    bestFor:
      "Someone setting up a primary home-office chair for full workdays who wants adjustable lumbar support without spending near $300.",
    skipIf:
...
export const buyingCriteria: BuyingCriterion[] = [
  {
    ...
    explanation:
      "Seat height only matters relative to your desk. With your feet flat on the floor, your thighs should be roughly level and your elbows close to desk height. Most chairs here cover roughly 17 to 21 inches, which suits many people at a standard desk of about 29 to 30 inches.\n\nShorter people, or anyone at a lower desk, should look at minimum height: the NEO CHAIR and BestOffice go down to about 15.5 and 15.7 inches. Taller people, or anyone at a higher desk, should look at the maximum, where the GABRYLLY reaches 22 inches.",
  },
  {
    criterion: "Check seat depth, even though few budget chairs adjust it",
    explanation:
      "Seat depth is the distance from the backrest to the front edge of the seat. Too deep, and the edge presses behind your knees when your back is against the lumbar support; too shallow, and your thighs lose support.\n\nNone of the chairs in this guide list an adjustable seat depth, and most listings don't give a depth figure at all. If you are notably shorter or taller than average, check the manufacturer's dimensions and compare them with your thigh length while seated.",
  },
  {
    criterion: "Leave a margin on weight capacity",
    explanation:
      "A chair used every day at the very top of its rating is working harder than one with room to spare, so it makes sense to choose a capacity comfortably above your body weight.\n\nOnly three chairs here state a capacity: the BestOffice (250 lb), GABRYLLY (280 lb) and Marsail (300 lb). For the others, check the manufacturer's documentation before relying on them.",
  },
  {
    criterion: "Know what each material trades off",
    explanation:
      "Every chair in this guide uses a mesh back, which breathes better than padding, a real advantage in warm rooms or for long sessions. Mesh tends to give a less contoured feel than a shaped, padded back, which is why adjustable lumbar support matters more on a mesh chair.\n\nPadded seats and bonded or PU leather can look more substantial but are more likely to show wear on the surface over time. If you work in a warm room, mesh is usually the more comfortable choice.",
  },
  {
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["A full workday on a mid-range budget", "SIHOO M18", "Adjustable lumbar, headrest and a three-year warranty"],
    ...
    cards: [
      {
        ...
        text: "Prioritize the basics, seat height that fits your desk, adjustable lumbar and adjustable armrests, over extras like footrests. You're still learning what your body needs.",
      },
      {
...
export const faq: { q: string; a: string }[] = [
  {
    ...
    a: "Yes, if you focus on adjustment rather than branding. In this price range you can find adjustable lumbar support, headrests, 3D armrests and, on some chairs, a three-year warranty. What you usually give up compared with premium chairs is warranty length, adjustable seat depth and the manufacturer's published ergonomics research.",
  },
  {
    q: "What does a much more expensive chair add?",
    a: "Premium office chairs typically offer longer warranties, often 10 years or more, adjustable seat depth, more refined lumbar systems and more consistent materials. Those differences matter most if you sit for most of the day for many years. For a few hours a day, a well-fitted chair under $300 covers the essentials.",
  },
  {
    q: "How long should an office chair under $300 last?",
    a: "The clearest guide is the warranty. Three chairs here, the SIHOO M18, SIHOO M57 and Duramont, list three years; the others don't state one. Lifespan beyond that depends heavily on daily hours, body weight relative to the chair's capacity and how the chair is used.",
  },
  {
    q: "Should I buy an office chair online without trying it?",
    a: "Most people do. The most useful thing to check remotely is seat height: sit with your feet flat and measure from the floor to the back of your knee, then compare that with the chair's minimum and maximum. Check the return policy too, since fit is personal and hard to judge from photos.",
  },
  {
    q: "Is it worth spending close to $300 for occasional use?",
    a: "Usually not. For an hour or two a day, a chair with adjustable height and some lumbar support is enough, and the budget picks here cover that. The case for spending more grows with the number of hours you sit, when adjustable lumbar and better armrests make a more noticeable difference.",
  },
];

export const bottomLine: string[] = [
  "For most home offices, the SIHOO M18 is the sensible choice under $300: adjustable lumbar, an adjustable headrest and a three-year warranty cover what a full workday needs, at a mid-range price.",
  "Spend more on the SIHOO M57 if you rely on armrests while typing, or on the Duramont if you need precise lumbar placement. The NEO CHAIR makes more sense for a compact desk, and the GABRYLLY is the one to look at if you're tall.",
];
