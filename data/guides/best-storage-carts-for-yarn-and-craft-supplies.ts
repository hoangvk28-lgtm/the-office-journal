...
export const guideSlug = "best-storage-carts-for-yarn-and-craft-supplies";

export const guideTitle = "The Best Storage Carts for Yarn and Craft Supplies: Our Picks";
...
export const introParagraphs = [
  "Across best storage carts for yarn and craft supplies, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is real load capacity and caster material, since these details matter more than claims."
];

export const lastUpdated = "2026-08-31";

export const mainKeyword = "storage cart craft supplies";

export const metaDescription = "How 8 storage carts for yarn and craft supplies compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Storage Carts for Yarn and Craft Supplies (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-1",
    "rank": 1,
    "badge": "Best Overall",
  ...
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-2",
    "rank": 2,
  ...
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-3",
    "rank": 3,
  ...
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-4",
    "rank": 4,
  ...
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-5",
    "rank": 5,
    "badge": "Best Value",
  ...
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-6",
    "rank": 6,
    "badge": "Worth a Look",
    "name": "YASONIC 3 Tier Metal Rolling Cart",
    "price": "$32.99",
  ...
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-7",
    "rank": 7,
  ...
  {
    "id": "best-storage-carts-for-yarn-and-craft-supplies-8",
    "rank": 8,
    "badge": "Also Worth Considering",
...
export const breadcrumbLabel = "Best Storage Carts for Yarn and Craft Supplies";
