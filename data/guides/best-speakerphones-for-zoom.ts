...
export const faq = [
  {
    "q": "What does 'Zoom certified' actually mean for a speakerphone?",
    "a": "It means the device has passed Zoom's own hardware testing program, confirming its audio driver and echo/noise handling work correctly with Zoom's specific audio pipeline, a stronger guarantee than general USB or Bluetooth plug-and-play compatibility."
  },
  {
    "q": "Is Zoom Rooms certification the same as Zoom certification?",
    "a": "Zoom Rooms certification is a separate, stricter tier that applies to dedicated conference room hardware. Basic Zoom-certified peripheral compatibility is a different, less rigorous testing level."
  },
  {
    "q": "Can I use a non-Zoom-certified speakerphone with Zoom?",
    "a": "Yes, most speakerphones work with Zoom over standard USB or Bluetooth audio without formal certification. It's fine for casual or occasional use, but a certified device offers more tested reliability for daily calls."
  },
  {
    "q": "How many microphones do I need for Zoom calls with multiple people?",
    "a": "More physical microphones with a wider pickup radius improve voice isolation. A 6-mic design like the Anker PowerConf handles a larger table better than a single-mic speakerphone."
  }
];

export const guideSlug = "best-speakerphones-for-zoom";

export const guideTitle = "The Best Speakerphones for Zoom: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Default to Yealink SP92 Conference Speaker and Microphone with AI Noise Cancellation unless your specific need calls for the pricier pick's extra headroom."
  },
  {
    "subheading": "",
    "table": {
...
export const howWeEvaluated = [
  {
    "title": "",
    "description": "Distinguished picks that have passed Zoom's own hardware testing program from those offering general plug-and-play compatibility, since these represent different levels of tested confidence."
  },
  {
    "title": "",
    "description": ""
  ...
  {
    "title": "Mic count and pickup radius for real conference-table performance",
    "description": "Compared physical mic count and pickup radius across picks, since these drive real voice isolation on a Zoom call more than certification alone."
  }
];
...
export const metaDescription = "A practical comparison of 5 speakerphones for zoom, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Speakerphones for Zoom (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "Explicitly Zoom certified, meaning it's passed Zoom's own hardware testing program, not just general USB plug-and-play compatibility. 6 microphones improve voice isolation for Zoom calls with several people around a table.\n\n6 mics for strong voice isolation on Zoom calls.",
    "specs": [
    ...
    "pros": [
      "Genuine Zoom certification, not just general compatibility",
      "6 mics for strong voice isolation on Zoom calls",
      "Both echo and background noise handling"
    ],
    "cons": [
      "Not certified for Zoom Rooms specifically, the stricter dedicated-hardware tier",
  ...
  },
  {
    ...
    "description": "Certified for both Zoom and Google Meet specifically, useful if your team occasionally uses both platforms rather than exclusively Zoom. 4 noise-cancelling mics with wideband audio for clear call quality.",
    "specs": [
    ...
    "pros": [
      "Certified for Zoom and Google Meet, useful if you use both",
  ...
  },
  {
    ...
    "description": "Portable wireless form factor suits moving between a desk and a meeting room.\n\nAn older but proven design, the large review count reflects years of real-world Zoom call usage.",
    "specs": [
      "Wireless Bluetooth, certified for Zoom and Google Meet",
      "Portable conference speaker",
      "Outstanding sound quality per established reputation",
      "Long track record"
    ],
    "pros": [
      "Highest rating of any pick in this guide",
      "Certified for both Zoom and Google Meet",
      "Portable, easy to move between spaces"
    ],
    "cons": [
      "Older design than the 2025-edition alternatives",
      "Fewer physical mics than the Anker 6-mic pick",
  ...
  },
  {
    ...
    "description": "The most affordable pick in this guide, works over standard USB/Bluetooth with Zoom without carrying explicit Zoom certification, general compatibility that's fine for most everyday calls but not the same tested guarantee as a certified device.\n\nAI noise cancellation and full-duplex audio help call clarity, even without formal Zoom certification.\n\nAI noise cancellation and full-duplex audio.",
    "specs": [
      "AI noise cancellation, full-duplex, general USB/Bluetooth compatibility",
      "13ft pickup radius, 360° omni mic",
      "20H call time",
      "Marketed primarily for Teams, works with Zoom generally"
    ],
    "pros": [
    ...
    "cons": [
      "No explicit Zoom certification, general compatibility only",
      "Marketed primarily toward Teams rather than Zoom specifically"
    ],
  ...
  },
  {
    ...
    "description": "A simple USB plug-and-play design, works with Zoom over standard USB audio without any specific setup, a reasonable option if you just need reliable basic call audio rather than certified premium features.\n\nSolid rating base for the price, though it lacks the explicit platform certification of the top picks in this guide.",
    "specs": [
    ...
    "pros": [
      ...
      "Works with Zoom over standard USB audio"
    ],
    "cons": [
      "No specific Zoom certification",
      "Fewer premium features than the certified picks",
      "360° pickup less directional for narrow tables"
    ],
...
export const breadcrumbLabel = "Best Speakerphones for Zoom";
