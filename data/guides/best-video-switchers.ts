...
export const guideTitle = "The Best Video Switchers for a Cleaner, More Useful Desk";
...
export const metaDescription = "A practical comparison of 8 video switchers, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Video Switchers for Home Offices (2026)";
...
export const breadcrumbLabel = "Best Video Switchers";
