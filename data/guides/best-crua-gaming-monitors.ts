...
export const guideTitle = "The Best CRUA Gaming Monitors for a Better Desk Setup";
...
export const metaDescription = "We compared 6 CRUA gaming monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best CRUA Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "specs": [
      "32Inch monitor",
      "1800R curvature: 32-inch curved monitor with 1800r curvature",
      "Excellent color"
    ],
    "pros": [
      "32Inch monitor",
  ...
  },
  {
    ...
    "specs": [
      "200Hz gaming monitor: enjoy fluid visuals with up to 200hz refresh rate and amd freesync",
      "27Inch curved monitor",
      "120% Srgb color: with 120% srgb color gamut"
    ],
    "pros": [
      "200Hz gaming monitor: enjoy fluid visuals with up to 200hz refresh rate and amd freesync",
      "27Inch curved monitor",
      "120% Srgb color: with 120% srgb color gamut",
      "Flexible white monitor"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "specs": [
      "260Hz curved gaming monitor: outpace your opponents with this",
      "Enjoy ultra-sharp detail with 2560×1440 (2k) resolution, delivering 77% more pixels than 1080p",
      "Lifelike visuals"
    ],
    "pros": [
      "260Hz curved gaming monitor: outpace your opponents with this",
  ...
  },
  {
    ...
    "specs": [
      "100Hz monitor refresh rate: 27 inch fhd white curved monitor",
      "1800R curvature: the curved design of the 1800r professional curved monitor surrounds your field of vision",
      "Vivid image quality"
    ],
    "pros": [
      "100Hz monitor refresh rate: 27 inch fhd white curved monitor",
...
export const breadcrumbLabel = "Best CRUA Gaming Monitors";
