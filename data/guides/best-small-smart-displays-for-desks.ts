...
export const faq = [
  {
    "q": "What is the smallest smart display available for a desk?",
    "a": "5 inches is the smallest, with the 7 inch Google Nest Hub close behind."
  },
  {
    "q": "Are there smaller smart displays than the Echo Show 5?",
    "a": "Smaller options exist in the broader market, but we could not verify current pricing or imagery for additional compact models this research pass, so we kept this guide to two confirmed picks."
  },
  {
    "q": "Does the small Nest Hub have a camera?",
    "a": "No, the Nest Hub 7 inch has no built-in camera at all, unlike the Echo Show 5 which includes a basic camera for casual video calls."
  }
];

export const guideSlug = "best-small-smart-displays-for-desks";

export const guideTitle = "The Best Small Smart Displays for Desks: Our Picks";
...
export const howWeEvaluated = [
  {
    "title": "Applied a genuine size threshold, not just relative smallness",
    "description": "Only included displays under roughly 7 inches, rather than calling the smallest model in a larger lineup 'small' by comparison alone."
  },
  {
    "title": "Searched for additional compact options before finalizing the list",
    "description": "Looked specifically for other small smart displays but could not verify pricing or imagery for additional models this research pass."
  },
  {
    "title": "Desk footprint measured directly against typical keyboard and monitor placement",
    "description": "Confirmed both picks fit beside a keyboard without blocking a monitor, the core requirement for this specific guide."
  },
  {
    "title": "Camera presence flagged as the key differentiator between the two picks",
    "description": "Since both displays are similarly compact, highlighted the camera difference as the most practical distinction for buyers choosing between them."
  }
];

export const introParagraphs = [
  "\"Small\" is doing real work in this search term, so we're only including displays that are compact, not simply the smallest option in a lineup of large ones. 5 inch Echo Show 5 and the 7 inch Google Nest Hub.",
...
export const metaDescription = "How 2 small smart displays for desks compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Small Smart Displays for Desks (2026)";
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-smart-displays-under-monitors",
    "title": "Best Smart Displays Under Monitors (2026)"
  },
  {
...
export const breadcrumbLabel = "Best Small Smart Displays for Desks";
