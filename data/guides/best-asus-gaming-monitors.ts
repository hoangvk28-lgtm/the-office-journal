...
export const guideTitle = "The Best ASUS Gaming Monitors for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "",
          "8” viewable) 1080P Monitor (VG249QE5A)"
        ],
        [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "ASUS TUF Gaming VG32WQ3B 32 Inch 1440p 180Hz HDR Curved Gaming Monitor)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "8” viewable) 1080P Monitor (VG249QE5A) is worth checking against its specific spec sheet before assuming any pick here covers your exact need."
      }
    ]
  },
  {
...
export const metaDescription = "How 6 ASUS gaming monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best ASUS Gaming Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "pros": [
      ...
      "Asus extreme low motion blur sync (elmb sync) technology",
      "Displaywidget center enables easy monitor settings adjustments with a mouse",
      "Shadow boost enhances image details in dark areas"
    ],
    "cons": [
  ...
  },
  {
    ...
    "description": "ASUS TUF Gaming VG32WQ3B 32 Inch 1440p 180Hz HDR Curved Gaming Monitor is a strong alternative worth comparing directly against the top pick. 5-Inch qhd 1500r curved gaming monitor: features ultra-fast 180hz refresh rate designed for professional gamers and immersive gameplay with 2560 x 1440 resolution. 5Ms (gtg) response time delivers smooth gameplay, and asus extreme low motion blur (elmb ) technology further reduces ghosting and motion blur.\n\n8” viewable) 1080P Monitor (VG249QE5A), the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nReach for this pick if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Compatibility with your exact setup matters more than the spec sheet alone, so confirm it works with your specific gear before buying.",
    "specs": [
      "31.5-Inch qhd 1500r curved gaming monitor: features ultra-fast 180hz",
    ...
    "pros": [
      ...
      "0.5Ms (gtg) response time delivers smooth gameplay",
      "Delivers a seamless",
      "Enhances image details in dark areas"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "pros": [
      ...
      "Asus fast ips technology enables a 1ms response time",
      "Displaywidget center enables easy osd access and monitor settings adjustments with a mouse",
      "USB type-c hub supports video transmission in displayport signal; can serve as a USB hub"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
  ...
  },
  {
    ...
    "specs": [
      "Features ultra-fast 180hz refresh rate designed for professional gamers",
      "Fast response time and motion blur reduction",
      "Package contents"
    ],
    "pros": [
      "Features ultra-fast 180hz refresh rate designed for professional gamers",
      "Fast response time and motion blur reduction",
      "Package contents",
      "Flicker-free technology and low blue light filters to reduce eye strain during extended gaming sessions"
    ],
    "cons": [
      "Check compatibility with your exact setup before buying",
      "Marketed specs and real-world specs often differ"
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-32-inch-curved-gaming-monitors",
    "title": "Best 32-Inch Curved Gaming Monitors in 2026"
  },
  {
    "href": "/guide/best-pink-gaming-monitors",
    "title": "Best Pink Gaming Monitors in 2026"
  },
  {
...
export const breadcrumbLabel = "Best ASUS Gaming Monitors";
