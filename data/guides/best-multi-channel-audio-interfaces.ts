...
export const introParagraphs = [
  "Across best multi-channel audio interfaces, vary more than the keyword suggests, given that the real gap is in the details.",
  "What separates these picks is real input count and preamp gain, since these separate real capability from claims."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-multi-channel-audio-interfaces-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-multi-channel-audio-interfaces-2",
    rank: 2,
  ...
  {
    id: "best-multi-channel-audio-interfaces-3",
    rank: 3,
  ...
  {
    id: "best-multi-channel-audio-interfaces-4",
    rank: 4,
  ...
  {
    id: "best-multi-channel-audio-interfaces-5",
    rank: 5,
  ...
  {
    id: "best-multi-channel-audio-interfaces-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-multi-channel-audio-interfaces-7",
    rank: 7,
    badge: "Best Value",
  ...
  {
    id: "best-multi-channel-audio-interfaces-8",
    rank: 8,
    badge: "Also Worth Considering",
