...
export const guideTitle = "The Best Laser Engravers for Metal, Compared";
...
export const metaDescription = "We compared 8 laser engravers for metal on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Laser Engravers for Metal (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "What sold us on ACMER S2 Laser Engraver is simple. Hate complicated software, confusing settings, or messy workflows?\n\nOn top of that, Equipped with a true 12w laser head and 72w total system power, the s2 can engrave over 100 different materials. With an advanced 32-bit chip, engraving speed reaches up to 10,000 mm/min. A strong contender once you look past the headline spec.",
    "specs": [
      "Hate complicated software, confusing settings, or messy workflows",
      "Laser engraver features a 0.08×0.08 mm ultra-fine laser spot, achieving up",
      "True 12w laser head and 72w total system power, the s2"
    ],
    "pros": [
      "Hate complicated software, confusing settings, or messy workflows",
      "Laser engraver features a 0.08×0.08 mm ultra-fine laser spot, achieving up",
...
export const breadcrumbLabel = "Best Laser Engravers for Metal";
