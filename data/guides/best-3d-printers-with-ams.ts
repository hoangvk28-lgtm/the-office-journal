...
export const guideTitle = "The Best 3D Printers With AMS: Our Picks";
...
export const metaDescription = "How 6 3D printers with AMS compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 3D Printers With AMS (2026)";
...
export const breadcrumbLabel = "Best 3D Printers With AMS";
