export const guideSlug = "best-automatic-video-switchers";
export const guideTitle = "8 Best Automatic Video Switchers in 2026";
export const metaTitle = "Best Automatic Video Switchers";
export const metaDescription = "We compared automatic video switcher models by verified specs and real-world tradeoffs, not marketing claims alone. Every pick is checked against a real usage.";
export const mainKeyword = "automatic video switcher";
export const introParagraphs = [
  "Best Automatic Video Switchers cover a wide input-count range. That means marketing copy alone is risky.",
  "This roundup weighs true latency and NDI support, given that this is the real gap to watch."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-automatic-video-switchers-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-automatic-video-switchers-2",
    rank: 2,
  ...
  {
    id: "best-automatic-video-switchers-3",
    rank: 3,
    badge: "Best Value",
  ...
  {
    id: "best-automatic-video-switchers-4",
    rank: 4,
  ...
  {
    id: "best-automatic-video-switchers-5",
    rank: 5,
  ...
  {
    id: "best-automatic-video-switchers-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-automatic-video-switchers-7",
    rank: 7,
  ...
  {
    id: "best-automatic-video-switchers-8",
    rank: 8,
