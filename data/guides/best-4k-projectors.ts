...
export const guideTitle = "The Best 4K Projectors for a Cleaner, More Useful Desk";
...
export const introParagraphs = [
  "Across best 4k projectors, aren't identical under the hood, given that differences show up in the fine print.",
...
export const metaDescription = "A practical comparison of 8 4K projectors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 4K Projectors for Home Offices (2026)";

export const products: GuideProduct[] = [
  {
    "id": "best-4k-projectors-1",
    "rank": 1,
    "badge": "Best Overall",
...
export const breadcrumbLabel = "Best 4K Projectors";
