...
export const guideTitle = "The Best uHoo Air Quality Monitors for Everyday Desk Work";
...
export const metaDescription = "How 7 uHoo air quality monitors compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best uHoo Air Quality Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best uHoo Air Quality Monitors";
