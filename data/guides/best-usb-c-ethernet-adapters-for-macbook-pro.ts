...
export const guideTitle = "The Best USB-C Ethernet Adapters for MacBook Pro, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "",
          "5G adapter in this list except the 5Gb UGREEN"
        ],
        [
          "",
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "text": "5G adapter if your NAS and network support it."
      }
    ]
  }
];
...
export const metaDescription = "We compared 8 USB-C ethernet adapters for MacBook pro on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best USB-C Ethernet Adapters for MacBook Pro (2026)";
...
export const breadcrumbLabel = "Best USB-C Ethernet Adapters for MacBook Pro";
