...
export const buyingCriteria = [
  {
    ...
    "explanation": "\" A mini UPS that only outputs 9V won't properly power a router that expects 12V, even if the physical connector plug happens to fit, since running equipment on the wrong voltage can either fail to power it or damage it over time. Before buying, check your router's power brick for its exact output voltage and confirm the UPS you're considering lists that same voltage among its outputs, not just a general \"multiple voltage\" claim."
  },
  {
...
export const faq = [
  ...
  },
  {
    ...
    "a": "MAh figures are only directly comparable between batteries built around the same internal voltage, so watt-hours (Wh) is the more reliable number when a listing provides it. A stated runtime figure at a specific load is even more useful than either number alone."
  },
  {
...
export const guideTitle = "The Best Mini DC UPS for WiFi Routers Under $40: Picks and Trade-offs";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "The lowest price with standard voltage coverage",
          "Luqeeg 10400mAh Mini UPS Battery Backup"
        ],
        [
          "",
          "Mini UPS Battery Backup, 6000mAh (5-hour rated)"
        ],
        [
          "The most raw battery capacity",
          "VISLONE Mini UPS Battery Backup 13500mAh"
        ],
        [
          "Flexible charging via DC or USB",
          "Mini UPS Battery Backup 10400mAh (dual input)"
        ]
      ]
    }
  },
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "Single DC charging method is fine",
          "Luqeeg, Mini UPS 6000mAh, or VISLONE"
        ],
        [
          "Want the option of USB charging as a backup",
          "Mini UPS Battery Backup 10400mAh (dual input)"
        ]
      ]
    }
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "",
        "text": "99) outlasts the cheaper Luqeeg pick by roughly 30 percent for a few dollars more."
      },
      {
        "label": "",
        "text": "61) covers the same core voltages as pricier picks here."
      }
    ]
  }
];
...
export const howWeEvaluated = [
  ...
  {
    "title": "",
    "description": "We confirmed each pick includes basic protections (short-circuit, overcharge, over-discharge) as standard, since these are inexpensive to include but protect connected networking equipment."
  },
  {
    "title": "",
...
export const metaDescription = "A practical comparison of 4 mini DC UPS for WiFi routers under $40, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best Mini DC UPS for WiFi Routers Under $40 (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CLVSQY5S?tag=theofficejournal-20",
    ...
    "specs": [
      "9V and 12V DC dual inputs",
      "10400mAh, 18Wh capacity",
      "USB 5V 2A output"
    ],
    "pros": [
      "Cheapest pick with dual 9V/12V input support",
      "Compact enough for a shelf or cabinet",
      "Multiple protection circuits (short circuit, overcharge)"
    ],
    "cons": [
      "Lower Wh capacity than pricier picks here",
      "No LCD or status display beyond basic indicators"
    ],
  ...
  },
  {
    ...
    "specs": [
      "5V, 9V, and 12V DC outputs",
      "Stated 5-hour runtime at 6000mAh",
      "Compact 4.72 x 3.54 x 0.98 inch body"
    ],
    "pros": [
      "States an actual runtime figure, not just capacity",
      "Covers three output voltages in one unit",
      "Small enough to tuck behind a router"
    ],
    "cons": [
      "Only one 12V port versus two on some competitors",
      "No passive PoE output option"
    ],
  ...
  },
  {
    ...
    "specs": [
      "13500mAh battery, largest in this tier",
      "5V, 9V, and 12V DC outputs",
      "Power indicator for battery status"
    ],
    "pros": [
      "Largest battery capacity under $40 in this comparison",
      "Covers all three common router output voltages",
      "Portable enough to bring along when traveling"
    ],
    "cons": [
      "No stated hours-of-runtime figure",
      "No USB-C output, only DC ports"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0CGVZBCKH?tag=theofficejournal-20",
    ...
    "specs": [
      "Dual charging: 9V/12V DC or 5V USB",
      "10400mAh, 18Wh built-in battery",
      "Doubles as a standard USB power bank"
    ],
    "pros": [
      "Two separate charging input options",
      "Doubles as a phone power bank when idle",
      "Same core voltage coverage as cheaper picks"
    ],
    "cons": [
      "Priciest pick in this tier for similar capacity to cheaper options",
      "USB charging input is noted as the slower of the two methods"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-mini-dc-ups-for-wifi-routers-under-90",
    "title": "Best Mini DC UPS for WiFi Routers Under $90"
  },
  {
...
export const breadcrumbLabel = "Best Mini DC UPS for WiFi Routers Under $40";
