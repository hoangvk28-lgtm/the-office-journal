...
export const guideTitle = "The Best Aruba Network Switches for a Better Desk Setup";
...
export const introParagraphs = [
  "Aruba's Instant On line, now under HPE Networking, offers smart-managed switches from 8 to 48 ports with subscription-free management through a mobile app or web browser, a real differentiator against cloud-managed competitors that charge ongoing licensing fees.",
...
export const metaDescription = "We compared 6 aruba network switches on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Aruba Network Switches for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08BZFJTRV?tag=theofficejournal-20",
    ...
    "specs": [
      "24 Gigabit PoE ports, 195W budget",
      "4x 1G/10G SFP+ uplinks",
      "App-managed, no subscription fee"
    ],
    "pros": [
      "No recurring licensing cost unlike some cloud-managed switches",
      "10G SFP+ uplinks future-proof the backbone",
      "Two-factor authentication built in"
    ],
    "cons": [
      "195W budget can run tight across 24 PoE ports",
      "App-first setup less flexible than pure CLI for power users"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08CC8S1RM?tag=theofficejournal-20",
    ...
    "specs": [
      "48 Gigabit ports, fanless",
      "4x 1G/10G SFP+ uplinks",
      "Built-in DDoS mitigation"
    ],
    "pros": [
      "Fanless at 48 ports is rare",
      "Built-in DDoS/unauthorized-access protection",
      "No subscription cost for app management"
    ],
    "cons": [
      "No PoE on this specific model",
      "Significant investment for a 48-port switch"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09NLCNGC7?tag=theofficejournal-20",
    "description": "The Instant On 1830 8-port is a compact, fanless Layer 2 smart switch designed for acoustically sensitive environments, non-PoE itself but able to be powered by an upstream PoE switch when no line power is available at its install location.\n\nIt shares the mobile app and web GUI management of the wider 1830/1930 family, giving small businesses a quiet, low-cost entry into Aruba's managed switch ecosystem.",
    "specs": [
      "8 Gigabit ports, fanless",
      "Powerable via upstream PoE",
      "App/web GUI managed"
    ],
    "pros": [
      "Fanless design suits quiet office spaces",
      "Can run off upstream PoE with no local outlet",
      "Entry point into Aruba's managed ecosystem"
    ],
    "cons": [
      "No PoE output of its own",
      "Smaller feature set than the 1930 series"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B08CC7WNYQ?tag=theofficejournal-20",
    ...
    "specs": [
      "8 Gigabit PoE ports, 124W budget",
      "2x SFP uplinks",
      "Fanless, app-managed"
    ],
    "pros": [
      "124W budget generous for an 8-port PoE switch",
      "Compact form factor for tight installs",
      "Built-in security features carry over from larger models"
    ],
    "cons": [
      "Fewer uplink options than the 24/48-port models",
      "Requires app or web setup, not zero-touch"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09NN4ZNR7?tag=theofficejournal-20",
    ...
    "specs": [
      ...
      "2x SFP uplinks",
      "Flexible table/wall/under-table mounting"
    ],
    "pros": [
      "Fanless at 24 ports for quiet office deployment",
      "Flexible mounting orientation options",
      "No-subscription app management"
    ],
    "cons": [
      "No PoE on this model",
      "Smart-managed only, not full Layer 3"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BFG73H7G?tag=theofficejournal-20",
    ...
    "specs": [
      "24 Gigabit PoE ports, 370W budget (Class 4)",
      "4x 1G/10G SFP+ uplinks",
      "Improved acoustics over A-model"
    ],
    "pros": [
      "370W budget comfortably covers a full 24-port PoE fleet",
      "Lifetime warranty backs the hardware",
      "Quieter operation than the standard A-model"
    ],
    "cons": [
      "Premium price over the standard 195W A-model",
      "Still requires app or web setup, not zero-touch"
    ],
...
export const relatedGuides = [
  {
    "href": "/guide/best-hp-network-switches",
    "title": "best-hp-network-switches"
  },
  {
  ...
  {
    "href": "/guide/best-cisco-network-switches",
    "title": "5 Best Cisco Network Switches in 2026"
  }
];

export const breadcrumbLabel = "Best Aruba Network Switches";
