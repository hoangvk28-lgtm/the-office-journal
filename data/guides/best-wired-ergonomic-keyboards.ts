...
export const faq = [
  {
    "q": "Can I position a split wired keyboard's halves far apart?",
    "a": "It depends on the inter-half cable length, which is often fixed and proprietary, check the current listing before assuming you can position the halves shoulder-width or further apart."
  },
  {
    "q": "Does a wired ergonomic keyboard need any cable management?",
    "a": "Yes, especially a split model with both a main USB cable and an inter-half cable, worth planning cable routing before you buy if your desk setup is tight."
  },
  {
    "q": "Are USB pass-through ports on ergonomic keyboards full-speed?",
    "a": "Not always, verify the specific listing since some pass-through ports only carry charging power rather than full data speed."
  },
  {
    "q": "Is a wired keyboard more reliable than wireless for typing speed?",
    "a": "4G latency variability, which can matter for very fast touch typists, though most casual typists won't notice a difference."
  }
];

export const guideSlug = "best-wired-ergonomic-keyboards";

export const guideTitle = "The Best Wired Ergonomic Keyboards for a Better Desk Setup";
...
export const howWeEvaluated = [
  {
    "title": "Inter-half cable flexibility on split designs",
    "description": "Noted that a fixed, non-standard inter-half cable limits how far apart the two halves can be placed, a real constraint on desk layout."
  },
  {
    "title": "Cable exit direction and desk cable management",
    "description": "Considered whether the main USB cable exits from the rear or side, since rear-exiting cables tend to tuck away more cleanly."
  },
  {
    "title": "USB pass-through port speed where disclosed",
    "description": "Verified whether any pass-through hub port on a keyboard actually carries full-speed data versus charging power alone, rather than assuming full speed by default."
  },
  {
    "title": "Build quality and review consistency",
    "description": "Weighed verified buyer feedback on build quality and long-term reliability across each wired keyboard's review history."
  }
];

export const introParagraphs = [
  "A wired ergonomic keyboard removes battery anxiety entirely, but on a split design the cable connecting the two halves is often a fixed, non-standard length, which limits how far apart you can actually place them, a real flexibility constraint that rarely shows up in product photos. Worth checking cable exit direction too, since a rear-exiting cable tucks away more cleanly on most desks than one exiting from the side.",
...
export const metaDescription = "We compared 7 wired ergonomic keyboards on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Wired Ergonomic Keyboards for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "A split, fixed-angle keyboard with a padded wrist rest, plugging in over a single USB cable with no battery to manage.\n\nNo battery to charge or replace. On price, it's actually priced above X9 Wired Ergonomic Keyboard, which is worth weighing if cost is your deciding factor between the two.\n\nOn the other side, Basic build materials at this price.",
    "specs": [
    ...
    "cons": [
      ...
      "Verify inter-half cable length before buying",
  ...
  },
  {
    ...
    "pros": [
      "No inter-half cable to manage",
      "Lowest price in this guide",
      "High rating relative to price",
      "Standard single USB cable"
    ],
    "cons": [
  ...
  },
  {
    ...
    "pros": [
      "Backlighting with no battery-life tradeoff since it's wired",
      "Built-in palm rest",
      "True split, angled layout"
    ],
    "cons": [
      "Verify inter-half cable length on current listing",
      "Fixed split angle, not tenting-adjustable",
      "Backlighting has limited value for touch typists"
    ],
  ...
  },
  {
    ...
    "description": "A premium mechanical ergonomic keyboard using Kailh tactile switches, wired for a consistent, low-latency connection appropriate for buyers who want mechanical feel alongside an ergonomic layout.\n\nThe real tradeoff against that pick: Highest price in this guide.\n\nOn the other side, Larger desk footprint than a compact wired keyboard.",
    "specs": [
      "Wired USB connection",
    ...
    "pros": [
      "Wired mechanical feel with no connection lag",
      "Kailh tactile switches for tactile feedback",
      "Consistent, low-latency wired connection"
    ],
    "cons": [
      "Highest price in this guide",
      "Verify cable exit direction and length before buying",
      "Larger desk footprint than a compact wired keyboard"
    ],
  ...
  },
  {
    ...
    "pros": [
      ...
      "Simple plug-and-play setup",
      "No battery or pairing to manage"
    ],
    "cons": [
      "Basic build materials at this price",
      "No backlighting"
  ...
  },
  {
    ...
    "description": "A wired keyboard combining backlit keys with a built-in wrist rest at a low price point, drawing power directly from the USB port so backlighting carries no battery-life tradeoff.\n\nOn the other side, Basic build materials at this price.",
    "specs": [
      "Wired USB connection",
      "Backlit keys",
      "Attached wrist rest",
    ...
    "cons": [
      "Lower average rating than other wired picks here",
      "Basic build materials at this price"
    ],
  ...
  },
  {
    ...
    "cons": [
      "Flat layout, not curved or split for ergonomic relief",
...
export const breadcrumbLabel = "Best Wired Ergonomic Keyboards";
