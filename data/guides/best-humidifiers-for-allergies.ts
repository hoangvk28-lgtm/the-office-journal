...
export const guideTitle = "The Best Humidifiers for Allergies: Our Picks";
...
export const metaDescription = "How 8 humidifiers for allergies compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Humidifiers for Allergies (2026)";
...
export const breadcrumbLabel = "Best Humidifiers for Allergies";
