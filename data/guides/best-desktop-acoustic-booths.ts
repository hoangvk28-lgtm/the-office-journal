...
export const faq = [
  {
    "q": "Does a genuine desktop acoustic booth exist for general office use?",
    "a": "Not really, as of this research pass, most listings under this search term are vocal or podcast recording booths, a different product built for microphone isolation, not general office desk use."
  },
  {
    "q": "Can a flat acoustic panel work as a booth substitute?",
    "a": "Not for genuine isolation, a flat panel addresses only reflected sound near one side of your desk, it cannot enclose or isolate you the way a real booth structure would."
  },
  {
    "q": "What should I buy instead if I want real sound isolation at my desk?",
    "a": "A full office pod is the category that actually delivers genuine enclosure and isolation, see our office pod guides."
  },
  {
    "q": "What should I buy if I just want to reduce echo on calls?",
    "a": "A flat acoustic panel or divider is the more realistic fit, see our desk acoustic panels or acoustic desk dividers guides."
  }
];
...
export const howWeEvaluated = [
  {
    "title": "Genuine booth-style products searched for and not found",
    "description": "Searched verified Amazon listings specifically for enclosed desktop acoustic booth structures for general office use and did not find genuine matches, most results under similar terms are vocal recording booths, a different use case."
  },
  {
    "title": "No flat panel forced into a booth label",
    "description": "Declined to relabel any flat panel or divider as a booth, the structural mismatch between an open panel and an enclosed booth is too significant to gloss over."
  },
  {
    "title": "One partial alternative included only with heavy caveats",
    "description": "Included a single large flat panel as a partial, lower-cost alternative, explicitly caveated as not an enclosure, rather than omitting product coverage entirely."
  },
  {
    "title": "Redirected to established adjacent categories",
    "description": "Pointed readers toward our established acoustic panel, divider, and office pod guides, the categories that actually deliver on absorption or genuine isolation."
  }
];
...
export const metaDescription = "A desktop acoustic booth, a small enclosed desk-mounted structure, doesn't really exist as a general office product on Amazon yet, here's what to buy instead.";
...
export const products: GuideProduct[] = [
  {
    ...
    "description": "We're including this large clamp-on panel with heavy caveats, it is the widest single-panel product in our broader research pool, but it is still a flat, open divider, not an enclosed booth. It clamps to one edge of your desk and stands upright, it does not surround or enclose you.\n\nIf what you actually want is genuine enclosure and isolation, this panel will disappoint, it addresses only reflected sound near one side of your desk. See our office pod guides for products built for real enclosure instead.",
    "specs": [
      "47.25\" x 23.6\" flat panel, not enclosed",
      "Clamp-on mounting",
      "Ash gray finish",
      "No published NRC rating"
    ],
    "pros": [
      "Largest single flat panel available in this research pass",
      "Secure clamp-on mount",
      "Reduces visual distraction and some reflected sound",
      "Lower cost than a true enclosed pod"
    ],
    "cons": [
      "Not an enclosed booth by any reasonable definition",
      "Provides no meaningful isolation compared to a real pod",
      "Only covers one side of your desk"
    ],
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-acoustic-desk-hoods",
    "title": "Best Acoustic Desk Hood Alternatives (2026)"
  }
];
