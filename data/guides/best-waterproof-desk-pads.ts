...
export const guideTitle = "The Best Waterproof Desk Pads for Everyday Desk Work";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "Non-Slip Desk Pad, Mouse Pad, Waterproof PU Leather Desk Protector, Ultra Thin)",
        "text": "Softer feel, absorbs spills, shows staining faster."
      },
      {
        "label": "Oterri Clear Writing Desk Pad)",
...
export const metaDescription = "How 8 waterproof desk pads compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best Waterproof Desk Pads for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Non-Slip Desk Pad, Mouse Pad, Waterproof PU Leather Desk Protector, Ultra Thin is a low-cost pick that doesn't skip the essentials. Crafted with suede material for a non-slip back, this pad stays put. 6\" x 13\", it accommodates your laptop, mouse, and keyboard.\n\nAothia Non-Slip Waterproof PU Leather Desk Pad Protector for Mouse covers similar ground, though waterproof, oil-proof, protect your glass/wooden desktop from scratches, stains, and spills is what tips the choice one way or the other.\n\nThis one is the right call if you want a capable pick without paying for headroom you won't use. A cloth-top desk pad shows wear and staining faster than a wipeable PU leather or vinyl surface, so factor in how often you're willing to clean or replace it.",
    "specs": [
      "Anti-slip back side",
      "Multifunctional desk pad",
      "Waterproof and easy to clean"
...
export const breadcrumbLabel = "Best Waterproof Desk Pads";
