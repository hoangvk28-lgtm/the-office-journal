...
export const guideTitle = "The Best 27-Inch 144Hz 4K Monitors for a Cleaner, More Useful Desk";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "ASUS TUF Gaming VG27UQ1A 27 Inch 4K 160Hz G-SYNC Gaming Monitor)",
...
export const metaDescription = "A practical comparison of 6 27-inch 144Hz 4K monitors, focused on compatibility, build, features and price, and the trade-offs between them.";

export const metaTitle = "Best 27-Inch 144Hz 4K Monitors for Home Offices (2026)";
...
export const breadcrumbLabel = "Best 27-Inch 144Hz 4K Monitors";
