...
export const buyingCriteria = [
  ...
  },
  {
    ...
    "explanation": "Confirm stand stability and VESA mount compatibility for a stable drawing angle at this size."
  },
  {
...
export const guideTitle = "The Best Large Drawing Tablets for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "note": "Confirm stand stability and VESA mount compatibility for a stable drawing angle at this size."
  },
  {
...
export const metaDescription = "We compared 5 large drawing tablets on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Large Drawing Tablets for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B09TVR3BHG?tag=theofficejournal-20",
    "description": "Two quick dials switch between four functions each, paired with 8 customizable shortcut keys.\n\nTwo P05 battery-free pens ship in the box alongside 28 extra nibs, delivering 16384 pressure levels, 60-degree tilt, and a 290 PPS report rate. At just 17mm thick with dual USB-C to C ports for plug-and-play connectivity, the adjustable stand tilts from 15 to 85 degrees for a wide comfort range.",
    "specs": [
      "21.5in full-laminated, 16384 pressure",
      "290 PPS report rate",
      "Dual USB-C, adjustable 15-85° stand"
    ],
    "pros": [
      "Ships with two full pens plus 28 replacement nibs",
      "290 PPS report rate is fast for this size",
      "15-85° adjustable stand covers a wide comfort range"
    ],
    "cons": [
      "Requires a computer or laptop, not standalone",
      "21.5in screen needs significant desk depth"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0BTLWRG2J?tag=theofficejournal-20",
    "description": "0, delivering noticeably less lag and wobble for a more standard-pen-like feel. The redesigned PW110 stylus uses a slimmer body with soft silicone grip and accessible side buttons for improved ergonomics.\n\nA programmable scroll wheel plus three separate sets of 8 press keys (24 total shortcuts) is deep customization for a screenless tablet. 0+ phones and tablets in addition to Mac, PC, and Linux, and the slim, compact design is easy to pack for travel between home, work, and school.",
    "specs": [
      "Large active area, PenTech 3.0",
      "3 sets of 8 ExpressKeys (24 total)",
      "Android 6.0+, Mac/PC/Linux compatible"
    ],
    "pros": [
      "24 total programmable shortcuts across 3 key sets",
      "PenTech 3.0 noticeably reduces lag and wobble",
      "Slim, compact design packs easily for travel"
    ],
    "cons": [
      "Requires a connected host, not standalone",
      "No internal power source, must stay tethered to work"
    ],
  ...
  },
  {
    ...
    "amazonUrl": "https://www.amazon.com/dp/B0DHKJRW6M?tag=theofficejournal-20",
    "description": "6-inch full-laminated anti-glare screen delivers vivid, accurate colors for graphic design and photo editing. The anti-fingerprint coating cuts down on cleaning interruptions during long sessions.\n\nTwo pens ship in the box, one slim and one thicker, specifically sized for different hand grips, both delivering 16384 pressure levels and 60-degree tilt recognition. Five shortcut keys plus one Quick Dial cover common controls, and the S100 stand offers three height settings to reduce neck and shoulder strain during extended work.",
    "specs": [
      "15.6in full-laminated, 125% SRGB",
      "Two pens (slim + thick) included",
      "S100 stand, 3 height settings"
    ],
    "pros": [
      "Two differently-sized pens fit different hand grips",
      "Anti-fingerprint coating cuts down cleaning interruptions",
      "S100 stand offers 3 distinct height settings"
    ],
    "cons": [
      "Requires a computer or laptop, not standalone",
      "Only 5 shortcut keys plus 1 dial is modest at this size"
    ],
...
export const breadcrumbLabel = "Best Large Drawing Tablets";
