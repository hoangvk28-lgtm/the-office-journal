...
export const guideTitle = "The Best Outdoor Air Quality Monitors for a Better Desk Setup";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "AirVisual Outdoor, Outdoor Air Quality Monitor)",
        "text": "Connects directly to your router and app, no extra hardware needed."
      },
      {
        "label": "CF-60PP SMART Air Quality Monitor Detector with CSV Report for Home)",
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "label": "",
        "text": "5 PM10 Particle Counter is worth checking against its specific spec sheet before assuming any pick here covers your exact concern."
      }
    ]
  },
  {
...
export const metaDescription = "We compared 8 outdoor air quality monitors on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best Outdoor Air Quality Monitors for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "description": "Atmotube PRO 2 Battery Powered Portable Outdoor and Indoor Professional Air is a strong alternative worth comparing directly against the top pick. 5, pm10, including dust, soot, and smoke particles, and total volatile organic compounds (tvoc) and nox. The atmotube app shows real-time air quality and your personalized air balance score, helping you make smarter choices for better sleep, faster recovery, and sharper focus.\n\n5 PM10 Particle Counter is a reasonable point of comparison here, close enough that the actual listing details are worth checking before deciding between them.\n\nChoose this if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. A VOC or TVOC reading tells you total volatile compound levels rose or fell, not which specific chemical caused it, so don't expect it to identify the actual source the way a dedicated formaldehyde or CO sensor can.",
    "specs": [
...
export const relatedGuides = [
  ...
  {
    "href": "/guide/best-multi-sensor-air-quality-monitors",
    "title": "Best Multi-Sensor Air Quality Monitors in 2026"
  },
  {
    "href": "/guide/best-air-quality-monitors-for-google-home",
    "title": "Best Air Quality Monitors for Google Home in 2026"
  }
];

export const breadcrumbLabel = "Best Outdoor Air Quality Monitors";
