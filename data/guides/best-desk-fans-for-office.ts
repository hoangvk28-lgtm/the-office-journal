...
export const introParagraphs = [
  "Best Desk Fans for Office differ more than titles suggest, so price alone misses what matters.",
...
export const products: GuideProduct[] = [
  {
    id: "best-desk-fans-for-office-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-desk-fans-for-office-2",
    rank: 2,
  ...
  {
    id: "best-desk-fans-for-office-3",
    rank: 3,
  ...
  {
    id: "best-desk-fans-for-office-4",
    rank: 4,
    badge: "Best Value",
  ...
  {
    id: "best-desk-fans-for-office-5",
    rank: 5,
  ...
  {
    id: "best-desk-fans-for-office-6",
    rank: 6,
    badge: "Worth a Look",
  ...
  {
    id: "best-desk-fans-for-office-7",
    rank: 7,
    ...
    description: "Gaiatop USB Desk Fan is a strong alternative worth comparing directly against the top pick. The table fan cover can be easily removed for cleaning; silicone pads are designed at the 4 positions of the base for better anti-skid effect, so the small fan will not crawl on the desktop or tip itself over. Pink travel fan with 5.5 inch body and 0.6 lb weight is compact; 5-feet cord help move the mini fan around your desk; perfect for home, office, car, desktop, night stand, bedroom, baseball games, camping and travelling.\n\nSet next to Amazon Basics Air Circulator Desk Fan for Bedroom, the two land close enough on paper that it's worth comparing both listings directly on the spec that matters most for your setup.\n\nThis fits best if you want a genuine alternative to the top pick with a different tradeoff worth comparing directly. Many listings only quote the dB rating at the lowest speed, so check the noise level at the speed you'll actually run daily before assuming it stays that quiet.",
    specs: ["USB desk fan comes with a upgraded motor", "3 Speed airflow", "Detachable cover and stable base"],
    pros: ["USB desk fan comes with a upgraded motor", "3 Speed airflow", "Detachable cover and stable base", "Small size and lightweight"],
    cons: ["Noise rating usually reflects the lowest speed, not daily use", "USB-powered models cap out at lower airflow than AC-plugged fans"],
    bestFor: "buyers who want a genuine alternative to the top pick with a different tradeoff worth comparing directly",
  },
  {
    id: "best-desk-fans-for-office-8",
    rank: 8,
    badge: "Also Worth Considering",
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "USB-powered (e.g. TriPole USB Desk Fan Small Portable)",
