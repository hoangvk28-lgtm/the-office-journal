...
export const guideTitle = "The Best VR Headsets for Drawing and Painting, Compared";
...
export const howToChoose: HowToChooseSection[] = [
  ...
  },
  {
    ...
    "cards": [
      {
        "label": "3D VR Headset for Kids + Android Remote)",
...
export const metaDescription = "We compared 6 VR headsets for drawing and painting on compatibility, build, features and price to help you choose the right one for your space.";

export const metaTitle = "Best VR Headsets for Drawing and Painting (2026)";
...
export const breadcrumbLabel = "Best VR Headsets for Drawing and Painting";
