...
export const guideTitle = "The Best 40Gbps NVMe Enclosures for Everyday Desk Work";
...
export const metaDescription = "How 7 40Gbps NVMe enclosures compare on compatibility, build, features and price, with clear notes on who each one suits.";

export const metaTitle = "Best 40Gbps NVMe Enclosures for Home Offices (2026)";
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    "cons": [
      "2,700MB/s is on the lower end of 40Gbps-class enclosures",
      "No SATA support"
    ],
...
export const breadcrumbLabel = "Best 40Gbps NVMe Enclosures";
